; ModuleID = 'dataset/s6n_256_mul_4.c'
source_filename = "dataset/s6n_256_mul_4.c"
...
@result = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %19 = getelementptr inbounds [256 x i32], ptr @result, i64 0, i64 %18, !dbg !49
  ...
  %33 = getelementptr inbounds [256 x i32], ptr @result, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([256 x i32], ptr @result, i64 1, i64 0)), !dbg !77
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([256 x i32], ptr @result, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "dataset/s6n_256_mul_4.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "c23204c328891e42e1938d47ea0eb99a")
!4 = !{!5, !11, !0, !17}
