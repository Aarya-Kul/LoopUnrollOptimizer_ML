; ModuleID = 'dataset/s1_64_add_4.c'
source_filename = "dataset/s1_64_add_4.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([64 x i32], ptr @result, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([64 x i32], ptr @in1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([64 x i32], ptr @in2, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([64 x i32], ptr @result, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_64_add_4.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "49b60402639ee39575a2fb11f8cb3ce7")
!4 = !{!5, !11, !0, !17}
...
!43 = !DILocation(line: 35, column: 29, scope: !41)
!44 = !DILocation(line: 35, column: 25, scope: !41)
