; ModuleID = 'dataset/s1_128_add_3.c'
source_filename = "dataset/s1_128_add_3.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([128 x i32], ptr @o, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @i1, ptr noundef getelementptr inbounds ([128 x i32], ptr @i1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @i2, ptr noundef getelementptr inbounds ([128 x i32], ptr @i2, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([128 x i32], ptr @o, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_128_add_3.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "6e38e3b86617ad3ab02738d9f4dda9e2")
!4 = !{!5, !11, !0, !17}
