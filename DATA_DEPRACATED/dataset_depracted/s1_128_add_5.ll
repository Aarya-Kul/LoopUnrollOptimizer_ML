; ModuleID = 'dataset/s1_128_add_5.c'
source_filename = "dataset/s1_128_add_5.c"
...
5:                                                ; preds = %2
  ...
  %17 = getelementptr inbounds [128 x i32], ptr @sum, i64 0, i64 %16, !dbg !47
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([128 x i32], ptr @sum, i64 1, i64 0)), !dbg !65
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([128 x i32], ptr @sum, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_128_add_5.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "601fd8f3e715409988f31af113974603")
!4 = !{!5, !11, !0, !17}
