; ModuleID = 'dataset/s2_256_2_4_x_b.c'
source_filename = "dataset/s2_256_2_4_x_b.c"
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [256 x i32], ptr @b, i64 0, i64 %10, !dbg !41
  ...
  %17 = getelementptr inbounds [256 x i32], ptr @b, i64 0, i64 %16, !dbg !47
  ...
  %28 = getelementptr inbounds [256 x i32], ptr @b, i64 0, i64 %27, !dbg !58
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([256 x i32], ptr @b, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([256 x i32], ptr @b, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "dataset/s2_256_2_4_x_b.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "1229da0cae7411ae652216408e49bc38")
!4 = !{!5, !0}
