; ModuleID = 'dataset/s1_64_sub_0.c'
source_filename = "dataset/s1_64_sub_0.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([64 x i32], ptr @a, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([64 x i32], ptr @b, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @c, ptr noundef getelementptr inbounds ([64 x i32], ptr @c, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([64 x i32], ptr @a, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_64_sub_0.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "a7208ed4046770aa1164a82bf0638393")
!4 = !{!5, !11, !0, !17}
...
!40 = !DILocation(line: 35, column: 14, scope: !41)
!41 = distinct !DILexicalBlock(scope: !37, file: !3, line: 34, column: 23)
!42 = !DILocation(line: 35, column: 12, scope: !41)
!43 = !DILocation(line: 35, column: 20, scope: !41)
!44 = !DILocation(line: 35, column: 18, scope: !41)
!45 = !DILocation(line: 35, column: 17, scope: !41)
!46 = !DILocation(line: 35, column: 7, scope: !41)
!47 = !DILocation(line: 35, column: 5, scope: !41)
!48 = !DILocation(line: 35, column: 10, scope: !41)
!49 = !DILocation(line: 36, column: 3, scope: !41)
!50 = !DILocation(line: 34, column: 20, scope: !37)
