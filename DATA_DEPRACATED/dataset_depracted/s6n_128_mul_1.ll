; ModuleID = 'dataset/s6n_128_mul_1.c'
source_filename = "dataset/s6n_128_mul_1.c"
...
5:                                                ; preds = %2
  ...
  %19 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %18, !dbg !49
  ...
  %33 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([128 x i32], ptr @out, i64 1, i64 0)), !dbg !77
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([128 x i32], ptr @out, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "dataset/s6n_128_mul_1.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "087d3ca4b14335bf39a6ca9551e47eef")
!4 = !{!5, !11, !0, !17}
