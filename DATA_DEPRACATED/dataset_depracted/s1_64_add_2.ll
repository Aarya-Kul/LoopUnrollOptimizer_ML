; ModuleID = 'dataset/s1_64_add_2.c'
source_filename = "dataset/s1_64_add_2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@input1 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !0
@input2 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !17
@output = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([64 x i32], ptr @output, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([64 x i32], ptr @input1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([64 x i32], ptr @input2, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([64 x i32], ptr @output, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_64_add_2.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "4b1d7df5ff5b616c693984393be4626b")
!4 = !{!5, !11, !0, !17}
...
!40 = !DILocation(line: 35, column: 24, scope: !41)
!41 = distinct !DILexicalBlock(scope: !37, file: !3, line: 34, column: 23)
!42 = !DILocation(line: 35, column: 17, scope: !41)
!43 = !DILocation(line: 35, column: 35, scope: !41)
!44 = !DILocation(line: 35, column: 28, scope: !41)
!45 = !DILocation(line: 35, column: 27, scope: !41)
!46 = !DILocation(line: 35, column: 12, scope: !41)
!47 = !DILocation(line: 35, column: 5, scope: !41)
!48 = !DILocation(line: 35, column: 15, scope: !41)
