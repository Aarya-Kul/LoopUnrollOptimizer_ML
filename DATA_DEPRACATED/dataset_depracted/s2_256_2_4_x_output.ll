; ModuleID = 'dataset/s2_256_2_4_x_output.c'
source_filename = "dataset/s2_256_2_4_x_output.c"
...
7:                                                ; preds = %4
  ...
  %22 = getelementptr inbounds [256 x i32], ptr @output, i64 0, i64 %21, !dbg !52
  ...
  %28 = getelementptr inbounds [256 x i32], ptr @output, i64 0, i64 %27, !dbg !58
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([256 x i32], ptr @output, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([256 x i32], ptr @output, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "dataset/s2_256_2_4_x_output.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "6a23e9618aea0c9283fa63cf1a47cfd9")
!4 = !{!5, !0}
