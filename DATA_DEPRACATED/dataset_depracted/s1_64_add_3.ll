; ModuleID = 'dataset/s1_64_add_3.c'
source_filename = "dataset/s1_64_add_3.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([64 x i32], ptr @o, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @i1, ptr noundef getelementptr inbounds ([64 x i32], ptr @i1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @i2, ptr noundef getelementptr inbounds ([64 x i32], ptr @i2, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([64 x i32], ptr @o, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_64_add_3.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "984fb0b0fb0697bcc078e945e6c2662b")
!4 = !{!5, !11, !0, !17}
...
!40 = !DILocation(line: 35, column: 15, scope: !41)
!41 = distinct !DILexicalBlock(scope: !37, file: !3, line: 34, column: 23)
!42 = !DILocation(line: 35, column: 12, scope: !41)
!43 = !DILocation(line: 35, column: 22, scope: !41)
!44 = !DILocation(line: 35, column: 19, scope: !41)
