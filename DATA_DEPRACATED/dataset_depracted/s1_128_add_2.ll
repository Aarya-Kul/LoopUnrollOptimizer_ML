; ModuleID = 'dataset/s1_128_add_2.c'
source_filename = "dataset/s1_128_add_2.c"
...
5:                                                ; preds = %2
  ...
  %8 = getelementptr inbounds [128 x i32], ptr @input1, i64 0, i64 %7, !dbg !42
  %9 = load i32, ptr %8, align 4, !dbg !42
  %10 = load i32, ptr %1, align 4, !dbg !43
  %11 = sext i32 %10 to i64, !dbg !44
  %12 = getelementptr inbounds [128 x i32], ptr @input2, i64 0, i64 %11, !dbg !44
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([128 x i32], ptr @output, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([128 x i32], ptr @input1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([128 x i32], ptr @input2, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([128 x i32], ptr @output, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_128_add_2.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "36eef612372903746f95405deeaedc14")
!4 = !{!5, !11, !0, !17}
