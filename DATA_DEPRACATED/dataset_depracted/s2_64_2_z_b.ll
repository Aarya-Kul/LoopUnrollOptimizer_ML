; ModuleID = 'dataset/s2_64_2_z_b.c'
source_filename = "dataset/s2_64_2_z_b.c"
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [64 x i32], ptr @b, i64 0, i64 %10, !dbg !41
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([64 x i32], ptr @b, i64 1, i64 0)), !dbg !59
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([64 x i32], ptr @b, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "dataset/s2_64_2_z_b.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "83fdbd5b50cec5a906399986b019dc1c")
!4 = !{!5, !0}
