; ModuleID = 'dataset/s2_128_2_4_x_out.c'
source_filename = "dataset/s2_128_2_4_x_out.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !0
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %10, !dbg !41
  ...
  %22 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %21, !dbg !52
  ...
  %28 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %27, !dbg !58
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([128 x i32], ptr @out, i64 1, i64 0)), !dbg !76
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !93
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([128 x i32], ptr @out, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "dataset/s2_128_2_4_x_out.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "bd0f6883f5fcdf072cea27325e91e8f9")
!4 = !{!5, !0}
