; ModuleID = 'dataset/s2_64_2_z_out.c'
source_filename = "dataset/s2_64_2_z_out.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !0
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [64 x i32], ptr @out, i64 0, i64 %10, !dbg !41
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([64 x i32], ptr @out, i64 1, i64 0)), !dbg !59
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 33554432, !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([64 x i32], ptr @out, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "dataset/s2_64_2_z_out.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "203ee8b3139406175dabcd7ef2a5a273")
!4 = !{!5, !0}
...
!39 = distinct !DILexicalBlock(scope: !35, file: !3, line: 34, column: 28)
...
!44 = !DILocation(line: 34, column: 23, scope: !35)
