; ModuleID = 'dataset/s15_8192_4096_add_0.c'
source_filename = "dataset/s15_8192_4096_add_0.c"
...
@A = dso_local global [8192 x [4096 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [8192 x [4096 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([4096 x i32], ptr @A, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([4096 x i32], ptr @B, i64 1, i64 0)), !dbg !99
...
!3 = !DIFile(filename: "dataset/s15_8192_4096_add_0.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "02fa6d6f26f97eb4aef618880a54713a")
!4 = !{!5, !0, !11, !18}
...
!53 = !DILocalVariable(name: "add", scope: !54, file: !3, line: 35, type: !14)
