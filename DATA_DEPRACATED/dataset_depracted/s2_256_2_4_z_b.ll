; ModuleID = 'dataset/s2_256_2_4_z_b.c'
source_filename = "dataset/s2_256_2_4_z_b.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([256 x i32], ptr @b, i64 1, i64 0)), !dbg !59
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([256 x i32], ptr @b, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "dataset/s2_256_2_4_z_b.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "0da112c206f25191ae4462424a00102a")
!4 = !{!5, !0}
