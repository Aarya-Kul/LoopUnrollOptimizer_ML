; ModuleID = 'dataset/s1_64_add_1.c'
source_filename = "dataset/s1_64_add_1.c"
...
5:                                                ; preds = %2
  ...
  %17 = getelementptr inbounds [64 x i32], ptr @out, i64 0, i64 %16, !dbg !47
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([64 x i32], ptr @out, i64 1, i64 0)), !dbg !65
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([64 x i32], ptr @out, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "dataset/s1_64_add_1.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "be552954662ab4b36cf57ec825f74023")
!4 = !{!5, !11, !0, !17}
