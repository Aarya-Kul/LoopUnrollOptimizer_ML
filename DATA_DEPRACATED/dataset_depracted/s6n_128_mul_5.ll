; ModuleID = 'dataset/s6n_128_mul_5.c'
source_filename = "dataset/s6n_128_mul_5.c"
...
@sum = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [128 x i32], ptr @sum, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([128 x i32], ptr @sum, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i32], ptr @in1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i32], ptr @in2, i64 1, i64 0)), !dbg !79
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([128 x i32], ptr @sum, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "dataset/s6n_128_mul_5.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "be9e1c187b34ba76ac0e6527a3bc8589")
!4 = !{!5, !11, !0, !17}
