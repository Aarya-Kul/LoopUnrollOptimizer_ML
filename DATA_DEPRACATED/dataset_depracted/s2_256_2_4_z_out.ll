; ModuleID = 'dataset/s2_256_2_4_z_out.c'
source_filename = "dataset/s2_256_2_4_z_out.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([256 x i32], ptr @out, i64 1, i64 0)), !dbg !59
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([256 x i32], ptr @out, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "dataset/s2_256_2_4_z_out.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "7c63842a6768f820fd0b96db3fc9657d")
!4 = !{!5, !0}
