; ModuleID = 'dataset/s6n_256_mul_5.c'
source_filename = "dataset/s6n_256_mul_5.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@in1 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@in2 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !17
@sum = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [256 x i32], ptr @sum, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([256 x i32], ptr @sum, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([256 x i32], ptr @in1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([256 x i32], ptr @in2, i64 1, i64 0)), !dbg !79
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([256 x i32], ptr @sum, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "dataset/s6n_256_mul_5.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "d6f4fbd87042164b7c3faaf2493ab81c")
!4 = !{!5, !11, !0, !17}
