; ModuleID = 'dataset/s6n_128_mul_2.c'
source_filename = "dataset/s6n_128_mul_2.c"
...
5:                                                ; preds = %2
  ...
  %22 = getelementptr inbounds [128 x i32], ptr @input1, i64 0, i64 %21, !dbg !52
  %23 = load i32, ptr %22, align 4, !dbg !52
  %24 = load i32, ptr %1, align 4, !dbg !53
  %25 = add nsw i32 %24, 2, !dbg !54
  %26 = sext i32 %25 to i64, !dbg !55
  %27 = getelementptr inbounds [128 x i32], ptr @input2, i64 0, i64 %26, !dbg !55
  ...
  %33 = getelementptr inbounds [128 x i32], ptr @output, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([128 x i32], ptr @output, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([128 x i32], ptr @input1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([128 x i32], ptr @input2, i64 1, i64 0)), !dbg !79
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([128 x i32], ptr @output, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "dataset/s6n_128_mul_2.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "dd186debe36acabe76f5931c83fc58ab")
!4 = !{!5, !11, !0, !17}
