; ModuleID = 'dataset/s6n_256_mul_0.c'
source_filename = "dataset/s6n_256_mul_0.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@b = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@c = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !17
@a = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [256 x i32], ptr @a, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([256 x i32], ptr @a, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([256 x i32], ptr @b, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @c, ptr noundef getelementptr inbounds ([256 x i32], ptr @c, i64 1, i64 0)), !dbg !79
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([256 x i32], ptr @a, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "dataset/s6n_256_mul_0.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "ffa349c8205e0566ad0275f5dfe091de")
!4 = !{!5, !11, !0, !17}
