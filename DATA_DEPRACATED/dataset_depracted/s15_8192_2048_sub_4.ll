; ModuleID = 'dataset/s15_8192_2048_sub_4.c'
source_filename = "dataset/s15_8192_2048_sub_4.c"
...
@op1 = dso_local global [8192 x [2048 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [8192 x [2048 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @op1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @op2, i64 1, i64 0)), !dbg !99
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 128, !dbg !116
...
!3 = !DIFile(filename: "dataset/s15_8192_2048_sub_4.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "1aea93d5958966a3db932ed1905184e1")
!4 = !{!5, !0, !11, !18}
