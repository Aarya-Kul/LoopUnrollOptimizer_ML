...
17:                                               ; preds = %20, %0
  ...
  br i1 %19, label %20, label %31, !dbg !56
...
31:                                               ; preds = %17
  ...
  %33 = load i32, ptr %3, align 4, !dbg !77
  %34 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef %32, i64 noundef 100, ptr noundef @.str, i32 noundef %33) #7, !dbg !78
  %35 = load ptr, ptr %12, align 8, !dbg !79
  %36 = call i64 @strlen(ptr noundef %35) #8, !dbg !81
  %37 = load i32, ptr %2, align 4, !dbg !82
  %38 = sext i32 %37 to i64, !dbg !82
  %39 = icmp ne i64 %36, %38, !dbg !83
...
42:                                               ; preds = %83, %41
  ...
  %44 = load i32, ptr %5, align 4, !dbg !92
  %45 = add nsw i32 %44, 1, !dbg !93
  %46 = icmp slt i32 %43, %45, !dbg !94
  br i1 %46, label %47, label %86, !dbg !95

47:                                               ; preds = %42
  %48 = load i32, ptr %6, align 4, !dbg !96
  store i32 %48, ptr %8, align 4, !dbg !98
  store i32 0, ptr %10, align 4, !dbg !99
  br label %49, !dbg !101

49:                                               ; preds = %76, %47
  %50 = load i32, ptr %7, align 4, !dbg !102
  %51 = load i32, ptr %6, align 4, !dbg !104
  %52 = icmp ne i32 %50, %51, !dbg !105
  br i1 %52, label %53, label %79, !dbg !106

53:                                               ; preds = %49
  %54 = load i32, ptr %10, align 4, !dbg !107
  %55 = icmp ne i32 %54, 0, !dbg !110
  br i1 %55, label %56, label %58, !dbg !111

56:                                               ; preds = %53
  %57 = load i32, ptr %7, align 4, !dbg !112
  store i32 %57, ptr %8, align 4, !dbg !114
  br label %58, !dbg !115

58:                                               ; preds = %56, %53
  %59 = load i32, ptr %8, align 4, !dbg !116
  %60 = srem i32 %59, 2, !dbg !118
  %61 = icmp ne i32 %60, 0, !dbg !119
  br i1 %61, label %62, label %66, !dbg !120

62:                                               ; preds = %58
  %63 = load i32, ptr %8, align 4, !dbg !121
  %64 = sub nsw i32 %63, 1, !dbg !123
  %65 = sdiv i32 %64, 2, !dbg !124
  store i32 %65, ptr %7, align 4, !dbg !125
  br label %75, !dbg !126

66:                                               ; preds = %58
  %67 = load i32, ptr %8, align 4, !dbg !127
  %68 = sdiv i32 %67, 2, !dbg !129
  %69 = load i32, ptr %2, align 4, !dbg !130
  %70 = sub nsw i32 %69, 1, !dbg !131
  %71 = sitofp i32 %70 to double, !dbg !130
  %72 = call double @pow(double noundef 2.000000e+00, double noundef %71) #7, !dbg !132
  %73 = fptosi double %72 to i32, !dbg !133
  %74 = add nsw i32 %68, %73, !dbg !134
  store i32 %74, ptr %7, align 4, !dbg !135
  br label %75
...
76:                                               ; preds = %75
  %77 = load i32, ptr %10, align 4, !dbg !137
  %78 = add nsw i32 %77, 1, !dbg !137
  store i32 %78, ptr %10, align 4, !dbg !137
  br label %49, !dbg !138, !llvm.loop !139

79:                                               ; preds = %49
  %80 = load i32, ptr %10, align 4, !dbg !141
  %81 = load i32, ptr %11, align 4, !dbg !142
  %82 = add nsw i32 %81, %80, !dbg !142
  store i32 %82, ptr %11, align 4, !dbg !142
  br label %83, !dbg !143

83:                                               ; preds = %79
  %84 = load i32, ptr %6, align 4, !dbg !144
  %85 = add nsw i32 %84, 1, !dbg !144
  store i32 %85, ptr %6, align 4, !dbg !144
  br label %42, !dbg !145, !llvm.loop !146

86:                                               ; preds = %42
  %87 = load i32, ptr %11, align 4, !dbg !148
  %88 = srem i32 %87, 998244353, !dbg !149
  %89 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %88), !dbg !150
  store i32 0, ptr %1, align 4, !dbg !151
  br label %90, !dbg !151

90:                                               ; preds = %86, %40
  %91 = load i32, ptr %1, align 4, !dbg !152
  ret i32 %91, !dbg !152
}
