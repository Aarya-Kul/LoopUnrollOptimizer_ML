...
4757:                                             ; preds = %4756
  ...
  br i1 %4761, label %4762, label %4891, !dbg !93
...
4891:                                             ; preds = %4757, %4628
  %4892 = load i32, ptr %2, align 4, !dbg !214
  %4893 = icmp sgt i32 %4892, 0, !dbg !216
  br i1 %4893, label %4894, label %4917, !dbg !217

4894:                                             ; preds = %4891
  %4895 = load i32, ptr %3, align 4, !dbg !218
  %4896 = icmp sgt i32 %4895, 0, !dbg !219
  br i1 %4896, label %4897, label %4917, !dbg !220

4897:                                             ; preds = %4894
  %4898 = load i32, ptr %4, align 4, !dbg !221
  %4899 = icmp sgt i32 %4898, 0, !dbg !222
  br i1 %4899, label %4900, label %4917, !dbg !223

4900:                                             ; preds = %4897
  %4901 = load i32, ptr %5, align 4, !dbg !224
  %4902 = icmp sgt i32 %4901, 0, !dbg !225
  br i1 %4902, label %4903, label %4917, !dbg !226

4903:                                             ; preds = %4900
  %4904 = load i32, ptr %6, align 4, !dbg !227
  %4905 = icmp sgt i32 %4904, 0, !dbg !228
  br i1 %4905, label %4906, label %4917, !dbg !229

4906:                                             ; preds = %4903
  %4907 = load i32, ptr %7, align 4, !dbg !230
  %4908 = icmp sgt i32 %4907, 0, !dbg !231
  br i1 %4908, label %4909, label %4917, !dbg !232

4909:                                             ; preds = %4906
  %4910 = load i32, ptr %8, align 4, !dbg !233
  %4911 = icmp sgt i32 %4910, 0, !dbg !234
  br i1 %4911, label %4912, label %4917, !dbg !235

4912:                                             ; preds = %4909
  %4913 = load i32, ptr %9, align 4, !dbg !236
  %4914 = icmp slt i32 %4913, 2, !dbg !237
  br i1 %4914, label %4915, label %4917, !dbg !238

4915:                                             ; preds = %4912
  %4916 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !239
  br label %4919, !dbg !241

4917:                                             ; preds = %4912, %4909, %4906, %4903, %4900, %4897, %4894, %4891
  %4918 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !242
  br label %4919

4919:                                             ; preds = %4917, %4915
  ret i32 0, !dbg !244
}
