...
20:                                               ; preds = %92, %3
  ...
  br i1 %23, label %24, label %95, !dbg !39
...
55:                                               ; preds = %54
  ...
  br i1 %60, label %61, label %95, !dbg !39
...
95:                                               ; preds = %55, %20
  ...
  %96 = load ptr, ptr %4, align 8, !dbg !71
  %97 = load i32, ptr %8, align 4, !dbg !72
  %98 = add nsw i32 %97, 1, !dbg !73
  %99 = sext i32 %98 to i64, !dbg !71
  %100 = getelementptr inbounds i32, ptr %96, i64 %99, !dbg !71
  %101 = load i32, ptr %100, align 4, !dbg !71
  store i32 %101, ptr %11, align 4, !dbg !70
  %102 = load ptr, ptr %4, align 8, !dbg !74
  %103 = load i32, ptr %6, align 4, !dbg !75
  %104 = sext i32 %103 to i64, !dbg !74
  %105 = getelementptr inbounds i32, ptr %102, i64 %104, !dbg !74
  %106 = load i32, ptr %105, align 4, !dbg !74
  %107 = load ptr, ptr %4, align 8, !dbg !76
  %108 = load i32, ptr %8, align 4, !dbg !77
  %109 = add nsw i32 %108, 1, !dbg !78
  %110 = sext i32 %109 to i64, !dbg !76
  %111 = getelementptr inbounds i32, ptr %107, i64 %110, !dbg !76
  store i32 %106, ptr %111, align 4, !dbg !79
  %112 = load i32, ptr %11, align 4, !dbg !80
  %113 = load ptr, ptr %4, align 8, !dbg !81
  %114 = load i32, ptr %6, align 4, !dbg !82
  %115 = sext i32 %114 to i64, !dbg !81
  %116 = getelementptr inbounds i32, ptr %113, i64 %115, !dbg !81
  store i32 %112, ptr %116, align 4, !dbg !83
  %117 = load i32, ptr %8, align 4, !dbg !84
  %118 = add nsw i32 %117, 1, !dbg !85
  ret i32 %118, !dbg !86
}
