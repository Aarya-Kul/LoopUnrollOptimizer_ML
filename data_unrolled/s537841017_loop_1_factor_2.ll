...
2445:                                             ; preds = %2442
  ...
  br label %2455, !dbg !196

2448:                                             ; preds = %2442, %2439, %2432
  %2449 = load i32, ptr %10, align 4, !dbg !197
  %2450 = icmp eq i32 %2449, 1, !dbg !200
  br i1 %2450, label %2451, label %2454, !dbg !201

2451:                                             ; preds = %2448
  %2452 = load i32, ptr %9, align 4, !dbg !202
  %2453 = add nsw i32 %2452, 1, !dbg !202
  store i32 %2453, ptr %9, align 4, !dbg !202
  br label %2454, !dbg !204
...
2461:                                             ; preds = %2460, %2349
  br label %2462, !dbg !206

2462:                                             ; preds = %2461
  %2463 = load i32, ptr %12, align 4, !dbg !207
  %2464 = add nsw i32 %2463, 1, !dbg !207
  store i32 %2464, ptr %12, align 4, !dbg !207
  br label %2336, !dbg !208, !llvm.loop !209

2465:                                             ; preds = %2336
  %2466 = load i32, ptr %2, align 4, !dbg !211
  %2467 = icmp sgt i32 %2466, 0, !dbg !213
  br i1 %2467, label %2468, label %2491, !dbg !214

2468:                                             ; preds = %2465
  %2469 = load i32, ptr %3, align 4, !dbg !215
  %2470 = icmp sgt i32 %2469, 0, !dbg !216
  br i1 %2470, label %2471, label %2491, !dbg !217

2471:                                             ; preds = %2468
  %2472 = load i32, ptr %4, align 4, !dbg !218
  %2473 = icmp sgt i32 %2472, 0, !dbg !219
  br i1 %2473, label %2474, label %2491, !dbg !220

2474:                                             ; preds = %2471
  %2475 = load i32, ptr %5, align 4, !dbg !221
  %2476 = icmp sgt i32 %2475, 0, !dbg !222
  br i1 %2476, label %2477, label %2491, !dbg !223

2477:                                             ; preds = %2474
  %2478 = load i32, ptr %6, align 4, !dbg !224
  %2479 = icmp sgt i32 %2478, 0, !dbg !225
  br i1 %2479, label %2480, label %2491, !dbg !226

2480:                                             ; preds = %2477
  %2481 = load i32, ptr %7, align 4, !dbg !227
  %2482 = icmp sgt i32 %2481, 0, !dbg !228
  br i1 %2482, label %2483, label %2491, !dbg !229

2483:                                             ; preds = %2480
  %2484 = load i32, ptr %8, align 4, !dbg !230
  %2485 = icmp sgt i32 %2484, 0, !dbg !231
  br i1 %2485, label %2486, label %2491, !dbg !232

2486:                                             ; preds = %2483
  %2487 = load i32, ptr %9, align 4, !dbg !233
  %2488 = icmp slt i32 %2487, 2, !dbg !234
  br i1 %2488, label %2489, label %2491, !dbg !235

2489:                                             ; preds = %2486
  %2490 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %2493, !dbg !238

2491:                                             ; preds = %2486, %2483, %2480, %2477, %2474, %2471, %2468, %2465
  %2492 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %2493
