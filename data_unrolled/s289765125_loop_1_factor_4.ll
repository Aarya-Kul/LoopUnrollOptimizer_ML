...
63:                                               ; preds = %258, %229, %200, %171, %142, %113, %84, %54
  store i8 1, ptr %4, align 1, !dbg !101
  br label %271, !dbg !103
...
.loopexit:                                        ; preds = %239, %210, %181, %152, %123, %94, %65, %37
  br label %271

271:                                              ; preds = %.loopexit, %63
  br label %272
...
.loopexit1:                                       ; preds = %9
  br label %273, !dbg !108

273:                                              ; preds = %.loopexit1, %34
  %274 = load i8, ptr %4, align 1, !dbg !108
  %275 = trunc i8 %274 to i1, !dbg !108
  %276 = zext i1 %275 to i32, !dbg !108
  %277 = icmp eq i32 %276, 1, !dbg !110
  br i1 %277, label %278, label %280, !dbg !111

278:                                              ; preds = %273
  %279 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !112
  br label %282, !dbg !112

280:                                              ; preds = %273
  %281 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !113
  br label %282

282:                                              ; preds = %280, %278
  %283 = load i32, ptr %1, align 4, !dbg !114
  ret i32 %283, !dbg !114
}
