...
15:                                               ; preds = %78, %0
  ...
  br i1 %18, label %19, label %118, !dbg !56
...
52:                                               ; preds = %26
  ...
  br i1 %57, label %.loopexit, label %60, !dbg !111
...
65:                                               ; preds = %64
  ...
  br i1 %70, label %71, label %118, !dbg !56
...
73:                                               ; preds = %93, %71
  ...
  br i1 %76, label %81, label %77, !dbg !67
...
82:                                               ; preds = %115, %81
  %83 = load i32, ptr %9, align 4, !dbg !77
  %84 = load i32, ptr %4, align 4, !dbg !79
  %85 = icmp slt i32 %83, %84, !dbg !80
  br i1 %85, label %96, label %86, !dbg !81

86:                                               ; preds = %82
  %87 = load i32, ptr %8, align 4, !dbg !105
  %88 = sext i32 %87 to i64, !dbg !106
  %89 = getelementptr inbounds [101 x i8], ptr %7, i64 0, i64 %88, !dbg !106
  store i8 0, ptr %89, align 1, !dbg !107
  %90 = call i32 @strcmp(ptr noundef %7, ptr noundef %3) #5, !dbg !108
  %91 = icmp eq i32 %90, 0, !dbg !110
  br i1 %91, label %.loopexit1, label %92, !dbg !111

92:                                               ; preds = %86
  br label %93, !dbg !115

93:                                               ; preds = %92
  %94 = load i32, ptr %6, align 4, !dbg !116
  %95 = add nsw i32 %94, 1, !dbg !116
  store i32 %95, ptr %6, align 4, !dbg !116
  br label %73, !dbg !117, !llvm.loop !118

96:                                               ; preds = %82
  %97 = load i32, ptr %5, align 4, !dbg !82
  %98 = load i32, ptr %9, align 4, !dbg !85
  %99 = icmp sle i32 %97, %98, !dbg !86
  br i1 %99, label %100, label %104, !dbg !87

100:                                              ; preds = %96
  %101 = load i32, ptr %9, align 4, !dbg !88
  %102 = load i32, ptr %6, align 4, !dbg !89
  %103 = icmp slt i32 %101, %102, !dbg !90
  br i1 %103, label %114, label %104, !dbg !91

104:                                              ; preds = %100, %96
  %105 = load i32, ptr %9, align 4, !dbg !93
  %106 = sext i32 %105 to i64, !dbg !94
  %107 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %106, !dbg !94
  %108 = load i8, ptr %107, align 1, !dbg !94
  %109 = load i32, ptr %8, align 4, !dbg !95
  %110 = sext i32 %109 to i64, !dbg !96
  %111 = getelementptr inbounds [101 x i8], ptr %7, i64 0, i64 %110, !dbg !96
  store i8 %108, ptr %111, align 1, !dbg !97
  %112 = load i32, ptr %8, align 4, !dbg !98
  %113 = add nsw i32 %112, 1, !dbg !98
  store i32 %113, ptr %8, align 4, !dbg !98
  br label %115, !dbg !99
...
115:                                              ; preds = %114, %104
  %116 = load i32, ptr %9, align 4, !dbg !100
  %117 = add nsw i32 %116, 1, !dbg !100
  store i32 %117, ptr %9, align 4, !dbg !100
  br label %82, !dbg !101, !llvm.loop !102

118:                                              ; preds = %65, %15
  %119 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !125
  store i32 0, ptr %1, align 4, !dbg !126
  br label %120, !dbg !126

120:                                              ; preds = %118, %58
  %121 = load i32, ptr %1, align 4, !dbg !127
  ret i32 %121, !dbg !127
}
