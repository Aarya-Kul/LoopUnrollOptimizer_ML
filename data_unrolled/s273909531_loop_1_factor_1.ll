...
12335:                                            ; preds = %12313
  %12336 = load i32, ptr %3, align 4, !dbg !122
  %12337 = icmp sge i32 %12336, 7, !dbg !124
  br i1 %12337, label %12338, label %12343, !dbg !125

12338:                                            ; preds = %12335
  %12339 = load i32, ptr %4, align 4, !dbg !126
  %12340 = icmp sle i32 %12339, 1, !dbg !127
  br i1 %12340, label %12341, label %12343, !dbg !128

12341:                                            ; preds = %12338
  %12342 = call i32 @puts(ptr noundef @.str.1), !dbg !129
  br label %12345, !dbg !131

12343:                                            ; preds = %12338, %12335
  %12344 = call i32 @puts(ptr noundef @.str.2), !dbg !132
  br label %12345

12345:                                            ; preds = %12343, %12341
  ret i32 0, !dbg !133
}
