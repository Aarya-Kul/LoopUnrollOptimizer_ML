...
3:                                                ; preds = %121, %0
  ...
  br i1 %6, label %7, label %124, !dbg !199
...
16:                                               ; preds = %7
  ...
  br i1 %21, label %22, label %124, !dbg !199
...
31:                                               ; preds = %22
  ...
  br i1 %36, label %37, label %124, !dbg !199
...
46:                                               ; preds = %37
  ...
  br i1 %51, label %52, label %124, !dbg !199
...
61:                                               ; preds = %52
  ...
  br i1 %66, label %67, label %124, !dbg !199
...
76:                                               ; preds = %67
  ...
  br i1 %81, label %82, label %124, !dbg !199
...
91:                                               ; preds = %82
  ...
  br i1 %96, label %97, label %124, !dbg !199
...
106:                                              ; preds = %97
  ...
  br i1 %111, label %112, label %124, !dbg !199
...
124:                                              ; preds = %106, %91, %76, %61, %46, %31, %16, %3
  store i64 0, ptr @i, align 8, !dbg !216
  br label %125, !dbg !218

125:                                              ; preds = %141, %124
  %126 = load i64, ptr @i, align 8, !dbg !219
  %127 = icmp slt i64 %126, 2048, !dbg !221
  br i1 %127, label %128, label %144, !dbg !222

128:                                              ; preds = %125
  store i64 0, ptr @j, align 8, !dbg !223
  br label %129, !dbg !225

129:                                              ; preds = %137, %128
  %130 = load i64, ptr @j, align 8, !dbg !226
  %131 = icmp slt i64 %130, 2048, !dbg !228
  br i1 %131, label %132, label %140, !dbg !229

132:                                              ; preds = %129
  %133 = load i64, ptr @i, align 8, !dbg !230
  %134 = getelementptr inbounds [2048 x [2048 x i64]], ptr @dp, i64 0, i64 %133, !dbg !231
  %135 = load i64, ptr @j, align 8, !dbg !232
  %136 = getelementptr inbounds [2048 x i64], ptr %134, i64 0, i64 %135, !dbg !231
  store i64 -1, ptr %136, align 8, !dbg !233
  br label %137, !dbg !231

137:                                              ; preds = %132
  %138 = load i64, ptr @j, align 8, !dbg !234
  %139 = add nsw i64 %138, 1, !dbg !234
  store i64 %139, ptr @j, align 8, !dbg !234
  br label %129, !dbg !235, !llvm.loop !236

140:                                              ; preds = %129
  br label %141, !dbg !237

141:                                              ; preds = %140
  %142 = load i64, ptr @i, align 8, !dbg !238
  %143 = add nsw i64 %142, 1, !dbg !238
  store i64 %143, ptr @i, align 8, !dbg !238
  br label %125, !dbg !239, !llvm.loop !240

144:                                              ; preds = %125
  %145 = load i64, ptr @n, align 8, !dbg !242
  call void @qsort(ptr noundef @a, i64 noundef %145, i64 noundef 16, ptr noundef @cmp), !dbg !243
  %146 = load i64, ptr @n, align 8, !dbg !244
  %147 = call i64 @search(i64 noundef 1, i64 noundef %146), !dbg !245
  %148 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %147), !dbg !246
  ret i32 0, !dbg !247
}
