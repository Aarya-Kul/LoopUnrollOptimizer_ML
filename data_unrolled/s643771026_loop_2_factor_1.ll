...
4757:                                             ; preds = %4737, %4628
  %4758 = load i32, ptr %2, align 4, !dbg !210
  %4759 = icmp sgt i32 %4758, 0, !dbg !212
  br i1 %4759, label %4760, label %4783, !dbg !213

4760:                                             ; preds = %4757
  %4761 = load i32, ptr %3, align 4, !dbg !214
  %4762 = icmp sgt i32 %4761, 0, !dbg !215
  br i1 %4762, label %4763, label %4783, !dbg !216

4763:                                             ; preds = %4760
  %4764 = load i32, ptr %4, align 4, !dbg !217
  %4765 = icmp sgt i32 %4764, 0, !dbg !218
  br i1 %4765, label %4766, label %4783, !dbg !219

4766:                                             ; preds = %4763
  %4767 = load i32, ptr %5, align 4, !dbg !220
  %4768 = icmp sgt i32 %4767, 0, !dbg !221
  br i1 %4768, label %4769, label %4783, !dbg !222

4769:                                             ; preds = %4766
  %4770 = load i32, ptr %6, align 4, !dbg !223
  %4771 = icmp sgt i32 %4770, 0, !dbg !224
  br i1 %4771, label %4772, label %4783, !dbg !225

4772:                                             ; preds = %4769
  %4773 = load i32, ptr %7, align 4, !dbg !226
  %4774 = icmp sgt i32 %4773, 0, !dbg !227
  br i1 %4774, label %4775, label %4783, !dbg !228

4775:                                             ; preds = %4772
  %4776 = load i32, ptr %8, align 4, !dbg !229
  %4777 = icmp sgt i32 %4776, 0, !dbg !230
  br i1 %4777, label %4778, label %4783, !dbg !231

4778:                                             ; preds = %4775
  %4779 = load i32, ptr %9, align 4, !dbg !232
  %4780 = icmp slt i32 %4779, 2, !dbg !233
  br i1 %4780, label %4781, label %4783, !dbg !234

4781:                                             ; preds = %4778
  %4782 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %4785, !dbg !237

4783:                                             ; preds = %4778, %4775, %4772, %4769, %4766, %4763, %4760, %4757
  %4784 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %4785
