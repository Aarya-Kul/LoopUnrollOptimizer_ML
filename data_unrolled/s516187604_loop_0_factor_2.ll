...
197:                                              ; preds = %363, %191
  ...
  br i1 %200, label %357, label %201, !dbg !66
...
202:                                              ; preds = %344, %201
  ...
  br i1 %206, label %337, label %207, !dbg !83
...
210:                                              ; preds = %228, %207
  ...
  br i1 %212, label %220, label %213, !dbg !113
...
220:                                              ; preds = %210
  %221 = load i32, ptr %5, align 4, !dbg !114
  %222 = add nsw i32 %221, 1, !dbg !117
  store i32 %222, ptr %6, align 4, !dbg !118
  br label %223, !dbg !119

223:                                              ; preds = %284, %220
  %224 = load i32, ptr %6, align 4, !dbg !120
  %225 = load i32, ptr %2, align 4, !dbg !122
  %226 = icmp sle i32 %224, %225, !dbg !123
  br i1 %226, label %231, label %227, !dbg !124
...
228:                                              ; preds = %227
  ...
  store i32 %230, ptr %5, align 4, !dbg !205
  br label %210, !dbg !206, !llvm.loop !207

231:                                              ; preds = %223
  %232 = load i32, ptr %5, align 4, !dbg !125
  %233 = add nsw i32 %232, 1, !dbg !128
  %234 = load i32, ptr %6, align 4, !dbg !129
  %235 = icmp slt i32 %233, %234, !dbg !130
  br i1 %235, label %236, label %276, !dbg !131

236:                                              ; preds = %231
  %237 = load ptr, ptr %3, align 8, !dbg !132
  %238 = load i32, ptr %5, align 4, !dbg !133
  %239 = sext i32 %238 to i64, !dbg !132
  %240 = getelementptr inbounds i32, ptr %237, i64 %239, !dbg !132
  %241 = load i32, ptr %240, align 4, !dbg !132
  %242 = load ptr, ptr %3, align 8, !dbg !134
  %243 = load i32, ptr %6, align 4, !dbg !135
  %244 = sub nsw i32 %243, 1, !dbg !136
  %245 = sext i32 %244 to i64, !dbg !134
  %246 = getelementptr inbounds i32, ptr %242, i64 %245, !dbg !134
  %247 = load i32, ptr %246, align 4, !dbg !134
  %248 = sub nsw i32 %241, %247, !dbg !137
  %249 = call i32 @llvm.abs.i32(i32 %248, i1 true), !dbg !138
  %250 = icmp sle i32 %249, 1, !dbg !139
  br i1 %250, label %251, label %276, !dbg !140

251:                                              ; preds = %236
  %252 = load i32, ptr %5, align 4, !dbg !141
  %253 = add nsw i32 %252, 1, !dbg !142
  %254 = sext i32 %253 to i64, !dbg !143
  %255 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %254, !dbg !143
  %256 = load i32, ptr %6, align 4, !dbg !144
  %257 = sub nsw i32 %256, 1, !dbg !145
  %258 = sext i32 %257 to i64, !dbg !143
  %259 = getelementptr inbounds [301 x i32], ptr %255, i64 0, i64 %258, !dbg !143
  %260 = load i32, ptr %259, align 4, !dbg !143
  %261 = load i32, ptr %6, align 4, !dbg !146
  %262 = load i32, ptr %5, align 4, !dbg !147
  %263 = sub nsw i32 %261, %262, !dbg !148
  %264 = sub nsw i32 %263, 2, !dbg !149
  %265 = icmp eq i32 %260, %264, !dbg !150
  br i1 %265, label %266, label %276, !dbg !151

266:                                              ; preds = %251
  %267 = load i32, ptr %6, align 4, !dbg !152
  %268 = load i32, ptr %5, align 4, !dbg !153
  %269 = sub nsw i32 %267, %268, !dbg !154
  %270 = load i32, ptr %5, align 4, !dbg !155
  %271 = sext i32 %270 to i64, !dbg !156
  %272 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %271, !dbg !156
  %273 = load i32, ptr %6, align 4, !dbg !157
  %274 = sext i32 %273 to i64, !dbg !156
  %275 = getelementptr inbounds [301 x i32], ptr %272, i64 0, i64 %274, !dbg !156
  store i32 %269, ptr %275, align 4, !dbg !158
  br label %276, !dbg !156

276:                                              ; preds = %266, %251, %236, %231
  %277 = load i32, ptr %6, align 4, !dbg !159
  %278 = add nsw i32 %277, 1, !dbg !161
  store i32 %278, ptr %7, align 4, !dbg !162
  br label %279, !dbg !163

279:                                              ; preds = %334, %276
  %280 = load i32, ptr %7, align 4, !dbg !164
  %281 = load i32, ptr %2, align 4, !dbg !166
  %282 = icmp sle i32 %280, %281, !dbg !167
  br i1 %282, label %287, label %283, !dbg !168

283:                                              ; preds = %279
  br label %284, !dbg !199

284:                                              ; preds = %283
  %285 = load i32, ptr %6, align 4, !dbg !200
  %286 = add nsw i32 %285, 1, !dbg !200
  store i32 %286, ptr %6, align 4, !dbg !200
  br label %223, !dbg !201, !llvm.loop !202

287:                                              ; preds = %279
  %288 = load i32, ptr %5, align 4, !dbg !169
  %289 = sext i32 %288 to i64, !dbg !172
  %290 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %289, !dbg !172
  %291 = load i32, ptr %7, align 4, !dbg !173
  %292 = sext i32 %291 to i64, !dbg !172
  %293 = getelementptr inbounds [301 x i32], ptr %290, i64 0, i64 %292, !dbg !172
  %294 = load i32, ptr %293, align 4, !dbg !172
  %295 = load i32, ptr %5, align 4, !dbg !174
  %296 = sext i32 %295 to i64, !dbg !175
  %297 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %296, !dbg !175
  %298 = load i32, ptr %6, align 4, !dbg !176
  %299 = sext i32 %298 to i64, !dbg !175
  %300 = getelementptr inbounds [301 x i32], ptr %297, i64 0, i64 %299, !dbg !175
  %301 = load i32, ptr %300, align 4, !dbg !175
  %302 = load i32, ptr %6, align 4, !dbg !177
  %303 = sext i32 %302 to i64, !dbg !178
  %304 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %303, !dbg !178
  %305 = load i32, ptr %7, align 4, !dbg !179
  %306 = sext i32 %305 to i64, !dbg !178
  %307 = getelementptr inbounds [301 x i32], ptr %304, i64 0, i64 %306, !dbg !178
  %308 = load i32, ptr %307, align 4, !dbg !178
  %309 = add nsw i32 %301, %308, !dbg !180
  %310 = icmp slt i32 %294, %309, !dbg !181
  br i1 %310, label %311, label %333, !dbg !182

311:                                              ; preds = %287
  %312 = load i32, ptr %5, align 4, !dbg !183
  %313 = sext i32 %312 to i64, !dbg !184
  %314 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %313, !dbg !184
  %315 = load i32, ptr %6, align 4, !dbg !185
  %316 = sext i32 %315 to i64, !dbg !184
  %317 = getelementptr inbounds [301 x i32], ptr %314, i64 0, i64 %316, !dbg !184
  %318 = load i32, ptr %317, align 4, !dbg !184
  %319 = load i32, ptr %6, align 4, !dbg !186
  %320 = sext i32 %319 to i64, !dbg !187
  %321 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %320, !dbg !187
  %322 = load i32, ptr %7, align 4, !dbg !188
  %323 = sext i32 %322 to i64, !dbg !187
  %324 = getelementptr inbounds [301 x i32], ptr %321, i64 0, i64 %323, !dbg !187
  %325 = load i32, ptr %324, align 4, !dbg !187
  %326 = add nsw i32 %318, %325, !dbg !189
  %327 = load i32, ptr %5, align 4, !dbg !190
  %328 = sext i32 %327 to i64, !dbg !191
  %329 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %328, !dbg !191
  %330 = load i32, ptr %7, align 4, !dbg !192
  %331 = sext i32 %330 to i64, !dbg !191
  %332 = getelementptr inbounds [301 x i32], ptr %329, i64 0, i64 %331, !dbg !191
  store i32 %326, ptr %332, align 4, !dbg !193
  br label %333, !dbg !191

333:                                              ; preds = %311, %287
  br label %334, !dbg !194

334:                                              ; preds = %333
  %335 = load i32, ptr %7, align 4, !dbg !195
  %336 = add nsw i32 %335, 1, !dbg !195
  store i32 %336, ptr %7, align 4, !dbg !195
  br label %279, !dbg !196, !llvm.loop !197
...
338:                                              ; preds = %354, %337
  %339 = load i32, ptr %6, align 4, !dbg !87
  %340 = load i32, ptr %2, align 4, !dbg !89
  %341 = add nsw i32 %340, 1, !dbg !90
  %342 = icmp slt i32 %339, %341, !dbg !91
  br i1 %342, label %347, label %343, !dbg !92

343:                                              ; preds = %338
  br label %344, !dbg !100

344:                                              ; preds = %343
  %345 = load i32, ptr %5, align 4, !dbg !101
  %346 = add nsw i32 %345, 1, !dbg !101
  store i32 %346, ptr %5, align 4, !dbg !101
  br label %202, !dbg !102, !llvm.loop !103

347:                                              ; preds = %338
  %348 = load i32, ptr %5, align 4, !dbg !93
  %349 = sext i32 %348 to i64, !dbg !94
  %350 = getelementptr inbounds [301 x [301 x i32]], ptr %4, i64 0, i64 %349, !dbg !94
  %351 = load i32, ptr %6, align 4, !dbg !95
  %352 = sext i32 %351 to i64, !dbg !94
  %353 = getelementptr inbounds [301 x i32], ptr %350, i64 0, i64 %352, !dbg !94
  store i32 0, ptr %353, align 4, !dbg !96
  br label %354, !dbg !94

354:                                              ; preds = %347
  %355 = load i32, ptr %6, align 4, !dbg !97
  %356 = add nsw i32 %355, 1, !dbg !97
  store i32 %356, ptr %6, align 4, !dbg !97
  br label %338, !dbg !98, !llvm.loop !99

357:                                              ; preds = %197
  %358 = load ptr, ptr %3, align 8, !dbg !67
  %359 = load i32, ptr %5, align 4, !dbg !68
  %360 = sext i32 %359 to i64, !dbg !67
  %361 = getelementptr inbounds i32, ptr %358, i64 %360, !dbg !67
  %362 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %361), !dbg !69
  br label %363, !dbg !69

363:                                              ; preds = %357
  %364 = load i32, ptr %5, align 4, !dbg !70
  %365 = add nsw i32 %364, 1, !dbg !70
  store i32 %365, ptr %5, align 4, !dbg !70
