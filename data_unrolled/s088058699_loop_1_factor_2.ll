...
54:                                               ; preds = %42, %37
  ...
  br i1 %55, label %56, label %80, !dbg !80
...
75:                                               ; preds = %63, %56
  ...
  br i1 %76, label %77, label %80, !dbg !80
...
80:                                               ; preds = %75, %54
  %81 = getelementptr inbounds [105 x i8], ptr %2, i64 0, i64 0, !dbg !96
  %82 = load i32, ptr %5, align 4, !dbg !98
  %83 = sext i32 %82 to i64, !dbg !99
  %84 = getelementptr inbounds i8, ptr %81, i64 %83, !dbg !99
  %85 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 0, !dbg !100
  %86 = load i32, ptr %6, align 4, !dbg !101
  %87 = sext i32 %86 to i64, !dbg !102
  %88 = getelementptr inbounds i8, ptr %85, i64 %87, !dbg !102
  %89 = call i32 @strcmp(ptr noundef %84, ptr noundef %88) #5, !dbg !103
  %90 = icmp eq i32 %89, 0, !dbg !104
  br i1 %90, label %91, label %92, !dbg !105
...
95:                                               ; preds = %.loopexit, %92, %34
  %96 = load i8, ptr %4, align 1, !dbg !111
  %97 = trunc i8 %96 to i1, !dbg !111
  %98 = zext i1 %97 to i32, !dbg !111
  %99 = icmp eq i32 %98, 1, !dbg !113
  br i1 %99, label %100, label %102, !dbg !114

100:                                              ; preds = %95
  %101 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !115
  br label %104, !dbg !115

102:                                              ; preds = %95
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !116
  br label %104

104:                                              ; preds = %102, %100
  %105 = load i32, ptr %1, align 4, !dbg !117
  ret i32 %105, !dbg !117
}
