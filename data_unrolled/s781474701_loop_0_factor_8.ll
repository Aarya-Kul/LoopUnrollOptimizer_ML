...
8849:                                             ; preds = %8869, %8841
  ...
  br i1 %8860, label %8861, label %8867, !dbg !79

8861:                                             ; preds = %8849
  %8862 = load i32, ptr %3, align 4, !dbg !80
  %8863 = sext i32 %8862 to i64, !dbg !80
  %8864 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !81
  %8865 = call i64 @strlen(ptr noundef %8864) #5, !dbg !82
  %8866 = icmp ult i64 %8863, %8865, !dbg !83
  br label %8867

8867:                                             ; preds = %8861, %8849
  %8868 = phi i1 [ false, %8849 ], [ %8866, %8861 ], !dbg !60
  br i1 %8868, label %8869, label %8874, !dbg !73

8869:                                             ; preds = %8867
  %8870 = load i32, ptr %3, align 4, !dbg !84
  %8871 = add nsw i32 %8870, 1, !dbg !84
  store i32 %8871, ptr %3, align 4, !dbg !84
  %8872 = load i32, ptr %4, align 4, !dbg !86
  %8873 = add nsw i32 %8872, 1, !dbg !86
  store i32 %8873, ptr %4, align 4, !dbg !86
  br label %8849, !dbg !73, !llvm.loop !87

8874:                                             ; preds = %8867
  %8875 = load i32, ptr %3, align 4, !dbg !89
  %8876 = sext i32 %8875 to i64, !dbg !89
  %8877 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !91
  %8878 = call i64 @strlen(ptr noundef %8877) #5, !dbg !92
  %8879 = icmp eq i64 %8876, %8878, !dbg !93
  br i1 %8879, label %8880, label %8882, !dbg !94

8880:                                             ; preds = %8874
  %8881 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !95
  br label %8884, !dbg !95

8882:                                             ; preds = %8874
  %8883 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !96
  br label %8884

8884:                                             ; preds = %8882, %8880
  ret i32 0, !dbg !97
}
