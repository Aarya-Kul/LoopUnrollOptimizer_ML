...
12402:                                            ; preds = %12324
  %12403 = load i64, ptr %5, align 8, !dbg !231
  %12404 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %12403), !dbg !232
  store i32 0, ptr %1, align 4, !dbg !233
  %12405 = load ptr, ptr %6, align 8, !dbg !234
  call void @llvm.stackrestore.p0(ptr %12405), !dbg !234
  %12406 = load i32, ptr %1, align 4, !dbg !234
  ret i32 %12406, !dbg !234
}
