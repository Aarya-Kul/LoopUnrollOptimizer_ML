...
4760:                                             ; preds = %4628
  %4761 = load i32, ptr %2, align 4, !dbg !214
  %4762 = icmp sgt i32 %4761, 0, !dbg !216
  br i1 %4762, label %4763, label %4786, !dbg !217

4763:                                             ; preds = %4760
  %4764 = load i32, ptr %3, align 4, !dbg !218
  %4765 = icmp sgt i32 %4764, 0, !dbg !219
  br i1 %4765, label %4766, label %4786, !dbg !220

4766:                                             ; preds = %4763
  %4767 = load i32, ptr %4, align 4, !dbg !221
  %4768 = icmp sgt i32 %4767, 0, !dbg !222
  br i1 %4768, label %4769, label %4786, !dbg !223

4769:                                             ; preds = %4766
  %4770 = load i32, ptr %5, align 4, !dbg !224
  %4771 = icmp sgt i32 %4770, 0, !dbg !225
  br i1 %4771, label %4772, label %4786, !dbg !226

4772:                                             ; preds = %4769
  %4773 = load i32, ptr %6, align 4, !dbg !227
  %4774 = icmp sgt i32 %4773, 0, !dbg !228
  br i1 %4774, label %4775, label %4786, !dbg !229

4775:                                             ; preds = %4772
  %4776 = load i32, ptr %7, align 4, !dbg !230
  %4777 = icmp sgt i32 %4776, 0, !dbg !231
  br i1 %4777, label %4778, label %4786, !dbg !232

4778:                                             ; preds = %4775
  %4779 = load i32, ptr %8, align 4, !dbg !233
  %4780 = icmp sgt i32 %4779, 0, !dbg !234
  br i1 %4780, label %4781, label %4786, !dbg !235

4781:                                             ; preds = %4778
  %4782 = load i32, ptr %9, align 4, !dbg !236
  %4783 = icmp slt i32 %4782, 2, !dbg !237
  br i1 %4783, label %4784, label %4786, !dbg !238

4784:                                             ; preds = %4781
  %4785 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !239
  br label %4788, !dbg !241

4786:                                             ; preds = %4781, %4778, %4775, %4772, %4769, %4766, %4763, %4760
  %4787 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !242
  br label %4788

4788:                                             ; preds = %4786, %4784
  ret i32 0, !dbg !244
}
