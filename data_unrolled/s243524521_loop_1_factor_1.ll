...
6545:                                             ; preds = %6728, %6540
  ...
  br i1 %6549, label %6550, label %6731, !dbg !98
...
6731:                                             ; preds = %6545
  ...
  br label %6732, !dbg !138

6732:                                             ; preds = %6763, %6731
  %6733 = load i32, ptr %9, align 4, !dbg !139
  %6734 = sext i32 %6733 to i64, !dbg !139
  %6735 = load i64, ptr %2, align 8, !dbg !141
  %6736 = icmp sle i64 %6734, %6735, !dbg !142
  br i1 %6736, label %6737, label %6766, !dbg !143

6737:                                             ; preds = %6732
  %6738 = load i64, ptr %3, align 8, !dbg !144
  %6739 = load i32, ptr %9, align 4, !dbg !144
  %6740 = sext i32 %6739 to i64, !dbg !144
  %6741 = getelementptr inbounds [2001 x [2001 x i64]], ptr %6, i64 0, i64 %6740, !dbg !144
  %6742 = load i64, ptr %2, align 8, !dbg !144
  %6743 = load i32, ptr %9, align 4, !dbg !144
  %6744 = sext i32 %6743 to i64, !dbg !144
  %6745 = sub nsw i64 %6742, %6744, !dbg !144
  %6746 = getelementptr inbounds [2001 x i64], ptr %6741, i64 0, i64 %6745, !dbg !144
  %6747 = load i64, ptr %6746, align 8, !dbg !144
  %6748 = icmp slt i64 %6738, %6747, !dbg !144
  br i1 %6748, label %6749, label %6759, !dbg !144

6749:                                             ; preds = %6737
  %6750 = load i32, ptr %9, align 4, !dbg !144
  %6751 = sext i32 %6750 to i64, !dbg !144
  %6752 = getelementptr inbounds [2001 x [2001 x i64]], ptr %6, i64 0, i64 %6751, !dbg !144
  %6753 = load i64, ptr %2, align 8, !dbg !144
  %6754 = load i32, ptr %9, align 4, !dbg !144
  %6755 = sext i32 %6754 to i64, !dbg !144
  %6756 = sub nsw i64 %6753, %6755, !dbg !144
  %6757 = getelementptr inbounds [2001 x i64], ptr %6752, i64 0, i64 %6756, !dbg !144
  %6758 = load i64, ptr %6757, align 8, !dbg !144
  br label %6761, !dbg !144

6759:                                             ; preds = %6737
  %6760 = load i64, ptr %3, align 8, !dbg !144
  br label %6761, !dbg !144

6761:                                             ; preds = %6759, %6749
  %6762 = phi i64 [ %6758, %6749 ], [ %6760, %6759 ], !dbg !144
  store i64 %6762, ptr %3, align 8, !dbg !146
  br label %6763, !dbg !147

6763:                                             ; preds = %6761
  %6764 = load i32, ptr %9, align 4, !dbg !148
  %6765 = add nsw i32 %6764, 1, !dbg !148
  store i32 %6765, ptr %9, align 4, !dbg !148
  br label %6732, !dbg !149, !llvm.loop !150

6766:                                             ; preds = %6732
  %6767 = load i64, ptr %3, align 8, !dbg !152
  %6768 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %6767), !dbg !153
  ret i32 0, !dbg !154
}
