...
19:                                               ; preds = %73, %2
  ...
  br i1 %22, label %23, label %76, !dbg !61
...
24:                                               ; preds = %23
  ...
  br i1 %29, label %30, label %76, !dbg !61
...
31:                                               ; preds = %30
  ...
  br i1 %36, label %37, label %76, !dbg !61
...
38:                                               ; preds = %37
  ...
  br i1 %43, label %44, label %76, !dbg !61
...
45:                                               ; preds = %44
  ...
  br i1 %50, label %51, label %76, !dbg !61
...
52:                                               ; preds = %51
  ...
  br i1 %57, label %58, label %76, !dbg !61
...
59:                                               ; preds = %58
  ...
  br i1 %64, label %65, label %76, !dbg !61
...
66:                                               ; preds = %65
  ...
  br i1 %71, label %72, label %76, !dbg !61
...
77:                                               ; preds = %157, %76
  %78 = load i32, ptr %8, align 4, !dbg !70
  %79 = load i32, ptr %9, align 4, !dbg !71
  %80 = icmp sle i32 %78, %79, !dbg !72
  br i1 %80, label %81, label %158, !dbg !69

81:                                               ; preds = %77
  call void @llvm.dbg.declare(metadata ptr %11, metadata !73, metadata !DIExpression()), !dbg !75
  %82 = load ptr, ptr %4, align 8, !dbg !76
  %83 = getelementptr inbounds i32, ptr %82, i64 0, !dbg !76
  %84 = load i32, ptr %83, align 4, !dbg !76
  store i32 %84, ptr %11, align 4, !dbg !75
...
85:                                               ; preds = %105, %81
  ...
  %87 = load i32, ptr %3, align 4, !dbg !84
  %88 = icmp slt i32 %86, %87, !dbg !85
  br i1 %88, label %89, label %108, !dbg !86

89:                                               ; preds = %85
  %90 = load i32, ptr %11, align 4, !dbg !87
  %91 = load ptr, ptr %4, align 8, !dbg !90
  %92 = load i32, ptr %5, align 4, !dbg !91
  %93 = sext i32 %92 to i64, !dbg !90
  %94 = getelementptr inbounds i32, ptr %91, i64 %93, !dbg !90
  %95 = load i32, ptr %94, align 4, !dbg !90
  %96 = icmp slt i32 %90, %95, !dbg !92
  br i1 %96, label %97, label %104, !dbg !93

97:                                               ; preds = %89
  %98 = load ptr, ptr %4, align 8, !dbg !94
  %99 = load i32, ptr %5, align 4, !dbg !96
  %100 = sext i32 %99 to i64, !dbg !94
  %101 = getelementptr inbounds i32, ptr %98, i64 %100, !dbg !94
  %102 = load i32, ptr %101, align 4, !dbg !94
  store i32 %102, ptr %11, align 4, !dbg !97
  %103 = load i32, ptr %5, align 4, !dbg !98
  store i32 %103, ptr %12, align 4, !dbg !99
  br label %104, !dbg !100

104:                                              ; preds = %97, %89
  br label %105, !dbg !101

105:                                              ; preds = %104
  %106 = load i32, ptr %5, align 4, !dbg !102
  %107 = add nsw i32 %106, 1, !dbg !102
  store i32 %107, ptr %5, align 4, !dbg !102
  br label %85, !dbg !103, !llvm.loop !104

108:                                              ; preds = %85
  %109 = load i32, ptr %12, align 4, !dbg !106
  %110 = load i32, ptr %8, align 4, !dbg !108
  %111 = load i32, ptr %9, align 4, !dbg !109
  %112 = add nsw i32 %110, %111, !dbg !110
  %113 = sdiv i32 %112, 2, !dbg !111
  %114 = icmp slt i32 %109, %113, !dbg !112
  br i1 %114, label %115, label %136, !dbg !113

115:                                              ; preds = %108
  %116 = load i32, ptr %11, align 4, !dbg !114
  %117 = load i32, ptr %9, align 4, !dbg !116
  %118 = sext i32 %117 to i64, !dbg !117
  %119 = getelementptr inbounds i32, ptr %16, i64 %118, !dbg !117
  store i32 %116, ptr %119, align 4, !dbg !118
  %120 = load i32, ptr %11, align 4, !dbg !119
  %121 = sext i32 %120 to i64, !dbg !120
  %122 = load i32, ptr %9, align 4, !dbg !121
  %123 = load i32, ptr %12, align 4, !dbg !122
  %124 = sub nsw i32 %122, %123, !dbg !123
  %125 = call i32 @llvm.abs.i32(i32 %124, i1 true), !dbg !124
  %126 = sext i32 %125 to i64, !dbg !124
  %127 = mul nsw i64 %121, %126, !dbg !125
  %128 = load i64, ptr %10, align 8, !dbg !126
  %129 = add nsw i64 %128, %127, !dbg !126
  store i64 %129, ptr %10, align 8, !dbg !126
  %130 = load i32, ptr %9, align 4, !dbg !127
  %131 = add nsw i32 %130, -1, !dbg !127
  store i32 %131, ptr %9, align 4, !dbg !127
  %132 = load ptr, ptr %4, align 8, !dbg !128
  %133 = load i32, ptr %12, align 4, !dbg !129
  %134 = sext i32 %133 to i64, !dbg !128
  %135 = getelementptr inbounds i32, ptr %132, i64 %134, !dbg !128
  store i32 0, ptr %135, align 4, !dbg !130
  br label %157, !dbg !131

136:                                              ; preds = %108
  %137 = load i32, ptr %11, align 4, !dbg !132
  %138 = load i32, ptr %8, align 4, !dbg !134
  %139 = sext i32 %138 to i64, !dbg !135
  %140 = getelementptr inbounds i32, ptr %16, i64 %139, !dbg !135
  store i32 %137, ptr %140, align 4, !dbg !136
  %141 = load i32, ptr %11, align 4, !dbg !137
  %142 = sext i32 %141 to i64, !dbg !138
  %143 = load i32, ptr %12, align 4, !dbg !139
  %144 = load i32, ptr %8, align 4, !dbg !140
  %145 = sub nsw i32 %143, %144, !dbg !141
  %146 = call i32 @llvm.abs.i32(i32 %145, i1 true), !dbg !142
  %147 = sext i32 %146 to i64, !dbg !142
  %148 = mul nsw i64 %142, %147, !dbg !143
  %149 = load i64, ptr %10, align 8, !dbg !144
  %150 = add nsw i64 %149, %148, !dbg !144
  store i64 %150, ptr %10, align 8, !dbg !144
  %151 = load i32, ptr %8, align 4, !dbg !145
  %152 = add nsw i32 %151, 1, !dbg !145
  store i32 %152, ptr %8, align 4, !dbg !145
  %153 = load ptr, ptr %4, align 8, !dbg !146
  %154 = load i32, ptr %12, align 4, !dbg !147
  %155 = sext i32 %154 to i64, !dbg !146
  %156 = getelementptr inbounds i32, ptr %153, i64 %155, !dbg !146
  store i32 0, ptr %156, align 4, !dbg !148
  br label %157

157:                                              ; preds = %136, %115
  br label %77, !dbg !69, !llvm.loop !149

158:                                              ; preds = %77
  %159 = load i64, ptr %10, align 8, !dbg !151
  %160 = trunc i64 %159 to i32, !dbg !151
  %161 = load ptr, ptr %6, align 8, !dbg !152
  call void @llvm.stackrestore.p0(ptr %161), !dbg !152
  ret i32 %160, !dbg !152
}
