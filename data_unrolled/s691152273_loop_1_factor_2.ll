...
8885:                                             ; preds = %8892, %8870
  br label %8911, !dbg !120
...
8887:                                             ; preds = %8886
  ...
  br i1 %8891, label %8892, label %8911, !dbg !108
...
8911:                                             ; preds = %8887, %8885, %8867
  %8912 = load i32, ptr %4, align 4, !dbg !127
  %8913 = sub nsw i32 %8912, 1, !dbg !129
  %8914 = load i32, ptr %5, align 4, !dbg !130
  %8915 = icmp eq i32 %8913, %8914, !dbg !131
  br i1 %8915, label %8916, label %8918, !dbg !132

8916:                                             ; preds = %8911
  %8917 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !133
  br label %8920, !dbg !135

8918:                                             ; preds = %8911
  %8919 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !136
  br label %8920

8920:                                             ; preds = %8918, %8916
  store i32 0, ptr %1, align 4, !dbg !138
  br label %8921, !dbg !138

8921:                                             ; preds = %8920, %25, %14
  %8922 = load i32, ptr %1, align 4, !dbg !139
  ret i32 %8922, !dbg !139
}
