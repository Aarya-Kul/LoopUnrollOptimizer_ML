...
9:                                                ; preds = %75, %0
  ...
  br i1 %15, label %16, label %78, !dbg !216
...
42:                                               ; preds = %41
  ...
  br i1 %50, label %51, label %78, !dbg !216
...
78:                                               ; preds = %42, %9
  %79 = load i32, ptr %4, align 4, !dbg !250
  %80 = sext i32 %79 to i64, !dbg !251
  %81 = getelementptr inbounds [100 x i8], ptr %3, i64 0, i64 %80, !dbg !251
  %82 = load i8, ptr %81, align 1, !dbg !251
  %83 = sext i8 %82 to i32, !dbg !251
  %84 = icmp eq i32 %83, 0, !dbg !252
  %85 = zext i1 %84 to i64, !dbg !251
  %86 = select i1 %84, ptr @.str.3, ptr @.str.4, !dbg !251
  %87 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %86), !dbg !253
  store i32 0, ptr %1, align 4, !dbg !254
  br label %88, !dbg !254

88:                                               ; preds = %78, %31
  %89 = load i32, ptr %1, align 4, !dbg !255
  ret i32 %89, !dbg !255
}
