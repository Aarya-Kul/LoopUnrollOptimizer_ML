...
88:                                               ; preds = %.loopexit, %61
  %89 = load i8, ptr %4, align 1, !dbg !106
  %90 = trunc i8 %89 to i1, !dbg !106
  %91 = zext i1 %90 to i32, !dbg !106
  %92 = icmp eq i32 %91, 1, !dbg !108
  br i1 %92, label %93, label %94, !dbg !109
...
97:                                               ; preds = %.loopexit1, %96
  %98 = load i8, ptr %5, align 1, !dbg !114
  %99 = trunc i8 %98 to i1, !dbg !114
  %100 = zext i1 %99 to i32, !dbg !114
  %101 = icmp eq i32 %100, 1, !dbg !116
  br i1 %101, label %102, label %104, !dbg !117

102:                                              ; preds = %97
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !118
  br label %106, !dbg !118

104:                                              ; preds = %97
  %105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !119
  br label %106

106:                                              ; preds = %104, %102
  %107 = load i32, ptr %1, align 4, !dbg !120
  ret i32 %107, !dbg !120
}
