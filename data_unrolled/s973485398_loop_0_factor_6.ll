...
617:                                              ; preds = %769, %616
  ...
  br i1 %619, label %620, label %772, !dbg !124
...
768:                                              ; preds = %653
  br label %769, !dbg !273

769:                                              ; preds = %768
  %770 = load i32, ptr %2, align 4, !dbg !274
  %771 = add nsw i32 %770, 1, !dbg !274
  store i32 %771, ptr %2, align 4, !dbg !274
  br label %617, !dbg !275, !llvm.loop !276

772:                                              ; preds = %617
  %773 = load i32, ptr %10, align 4, !dbg !278
  %774 = icmp sgt i32 %773, 0, !dbg !280
  br i1 %774, label %775, label %777, !dbg !281

775:                                              ; preds = %772
  %776 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !282
  br label %779, !dbg !284

777:                                              ; preds = %772
  %778 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !285
  br label %779
