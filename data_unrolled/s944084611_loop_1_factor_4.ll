...
11:                                               ; preds = %277, %202, %183, %108, %89, %70, %51, %7
  ret i32 0, !dbg !167
...
60:                                               ; preds = %382, %59
  ...
  br i1 %63, label %377, label %64, !dbg !177
...
65:                                               ; preds = %364, %64
  ...
  br i1 %69, label %357, label %70, !dbg !196
...
267:                                              ; preds = %354, %266
  ...
  br i1 %270, label %349, label %271, !dbg !177
...
272:                                              ; preds = %336, %271
  ...
  br i1 %276, label %329, label %277, !dbg !196
...
286:                                              ; preds = %326, %285
  ...
  br i1 %289, label %321, label %290, !dbg !177
...
291:                                              ; preds = %308, %290
  ...
  br i1 %295, label %301, label %296, !dbg !196
...
301:                                              ; preds = %291
  call void @llvm.dbg.declare(metadata ptr %5, metadata !197, metadata !DIExpression()), !dbg !200
  store i32 0, ptr %5, align 4, !dbg !200
  br label %302, !dbg !201

302:                                              ; preds = %318, %301
  %303 = load i32, ptr %5, align 4, !dbg !202
  %304 = load i32, ptr %2, align 4, !dbg !204
  %305 = add nsw i32 %304, 1, !dbg !205
  %306 = icmp slt i32 %303, %305, !dbg !206
  br i1 %306, label %311, label %307, !dbg !207

307:                                              ; preds = %302
  br label %308, !dbg !218

308:                                              ; preds = %307
  %309 = load i32, ptr %4, align 4, !dbg !219
  %310 = add nsw i32 %309, 1, !dbg !219
  store i32 %310, ptr %4, align 4, !dbg !219
  br label %291, !dbg !220, !llvm.loop !221

311:                                              ; preds = %302
  %312 = load i32, ptr %4, align 4, !dbg !208
  %313 = sext i32 %312 to i64, !dbg !210
  %314 = getelementptr inbounds [301 x [301 x i32]], ptr @dp, i64 0, i64 %313, !dbg !210
  %315 = load i32, ptr %5, align 4, !dbg !211
  %316 = sext i32 %315 to i64, !dbg !210
  %317 = getelementptr inbounds [301 x i32], ptr %314, i64 0, i64 %316, !dbg !210
  store i32 -1, ptr %317, align 4, !dbg !212
  br label %318, !dbg !213

318:                                              ; preds = %311
  %319 = load i32, ptr %5, align 4, !dbg !214
  %320 = add nsw i32 %319, 1, !dbg !214
  store i32 %320, ptr %5, align 4, !dbg !214
  br label %302, !dbg !215, !llvm.loop !216

321:                                              ; preds = %286
  %322 = load i32, ptr %3, align 4, !dbg !178
  %323 = sext i32 %322 to i64, !dbg !180
  %324 = getelementptr inbounds [301 x i32], ptr @w, i64 0, i64 %323, !dbg !180
  %325 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %324), !dbg !181
  br label %326, !dbg !182

326:                                              ; preds = %321
  %327 = load i32, ptr %3, align 4, !dbg !183
  %328 = add nsw i32 %327, 1, !dbg !183
  store i32 %328, ptr %3, align 4, !dbg !183
  br label %286, !dbg !184, !llvm.loop !185

329:                                              ; preds = %272
  call void @llvm.dbg.declare(metadata ptr %5, metadata !197, metadata !DIExpression()), !dbg !200
  store i32 0, ptr %5, align 4, !dbg !200
  br label %330, !dbg !201

330:                                              ; preds = %346, %329
  %331 = load i32, ptr %5, align 4, !dbg !202
  %332 = load i32, ptr %2, align 4, !dbg !204
  %333 = add nsw i32 %332, 1, !dbg !205
  %334 = icmp slt i32 %331, %333, !dbg !206
  br i1 %334, label %339, label %335, !dbg !207

335:                                              ; preds = %330
  br label %336, !dbg !218

336:                                              ; preds = %335
  %337 = load i32, ptr %4, align 4, !dbg !219
  %338 = add nsw i32 %337, 1, !dbg !219
  store i32 %338, ptr %4, align 4, !dbg !219
  br label %272, !dbg !220, !llvm.loop !221

339:                                              ; preds = %330
  %340 = load i32, ptr %4, align 4, !dbg !208
  %341 = sext i32 %340 to i64, !dbg !210
  %342 = getelementptr inbounds [301 x [301 x i32]], ptr @dp, i64 0, i64 %341, !dbg !210
  %343 = load i32, ptr %5, align 4, !dbg !211
  %344 = sext i32 %343 to i64, !dbg !210
  %345 = getelementptr inbounds [301 x i32], ptr %342, i64 0, i64 %344, !dbg !210
  store i32 -1, ptr %345, align 4, !dbg !212
  br label %346, !dbg !213

346:                                              ; preds = %339
  %347 = load i32, ptr %5, align 4, !dbg !214
  %348 = add nsw i32 %347, 1, !dbg !214
  store i32 %348, ptr %5, align 4, !dbg !214
  br label %330, !dbg !215, !llvm.loop !216

349:                                              ; preds = %267
  %350 = load i32, ptr %3, align 4, !dbg !178
  %351 = sext i32 %350 to i64, !dbg !180
  %352 = getelementptr inbounds [301 x i32], ptr @w, i64 0, i64 %351, !dbg !180
  %353 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %352), !dbg !181
  br label %354, !dbg !182

354:                                              ; preds = %349
  %355 = load i32, ptr %3, align 4, !dbg !183
  %356 = add nsw i32 %355, 1, !dbg !183
  store i32 %356, ptr %3, align 4, !dbg !183
  br label %267, !dbg !184, !llvm.loop !185

357:                                              ; preds = %65
  call void @llvm.dbg.declare(metadata ptr %5, metadata !197, metadata !DIExpression()), !dbg !200
  store i32 0, ptr %5, align 4, !dbg !200
  br label %358, !dbg !201

358:                                              ; preds = %374, %357
  %359 = load i32, ptr %5, align 4, !dbg !202
  %360 = load i32, ptr %2, align 4, !dbg !204
  %361 = add nsw i32 %360, 1, !dbg !205
  %362 = icmp slt i32 %359, %361, !dbg !206
  br i1 %362, label %367, label %363, !dbg !207

363:                                              ; preds = %358
  br label %364, !dbg !218

364:                                              ; preds = %363
  %365 = load i32, ptr %4, align 4, !dbg !219
  %366 = add nsw i32 %365, 1, !dbg !219
  store i32 %366, ptr %4, align 4, !dbg !219
  br label %65, !dbg !220, !llvm.loop !221

367:                                              ; preds = %358
  %368 = load i32, ptr %4, align 4, !dbg !208
  %369 = sext i32 %368 to i64, !dbg !210
  %370 = getelementptr inbounds [301 x [301 x i32]], ptr @dp, i64 0, i64 %369, !dbg !210
  %371 = load i32, ptr %5, align 4, !dbg !211
  %372 = sext i32 %371 to i64, !dbg !210
  %373 = getelementptr inbounds [301 x i32], ptr %370, i64 0, i64 %372, !dbg !210
  store i32 -1, ptr %373, align 4, !dbg !212
  br label %374, !dbg !213

374:                                              ; preds = %367
  %375 = load i32, ptr %5, align 4, !dbg !214
  %376 = add nsw i32 %375, 1, !dbg !214
  store i32 %376, ptr %5, align 4, !dbg !214
  br label %358, !dbg !215, !llvm.loop !216

377:                                              ; preds = %60
  %378 = load i32, ptr %3, align 4, !dbg !178
  %379 = sext i32 %378 to i64, !dbg !180
  %380 = getelementptr inbounds [301 x i32], ptr @w, i64 0, i64 %379, !dbg !180
  %381 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %380), !dbg !181
  br label %382, !dbg !182

382:                                              ; preds = %377
  %383 = load i32, ptr %3, align 4, !dbg !183
  %384 = add nsw i32 %383, 1, !dbg !183
  store i32 %384, ptr %3, align 4, !dbg !183
