...
4649:                                             ; preds = %4805, %4648
  ...
  br i1 %4651, label %4652, label %4808, !dbg !124
...
4808:                                             ; preds = %4649
  %4809 = load i32, ptr %10, align 4, !dbg !290
  %4810 = icmp sgt i32 %4809, 0, !dbg !292
  br i1 %4810, label %4811, label %4813, !dbg !293

4811:                                             ; preds = %4808
  %4812 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !294
  br label %4815, !dbg !296

4813:                                             ; preds = %4808
  %4814 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !297
  br label %4815
