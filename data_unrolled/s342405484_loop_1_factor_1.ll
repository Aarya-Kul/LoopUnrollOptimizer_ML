...
8566:                                             ; preds = %8508
  %8567 = load i64, ptr %15, align 8, !dbg !297
  %8568 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i64 noundef %8567), !dbg !298
  %8569 = load i64, ptr %13, align 8, !dbg !299
  %8570 = load i64, ptr %14, align 8, !dbg !300
  %8571 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %8569, i64 noundef %8570), !dbg !301
  ret i32 0, !dbg !302
}
