...
5446:                                             ; preds = %5397
  ...
  br label %5447, !dbg !139

5447:                                             ; preds = %5504, %5446
  %5448 = load i64, ptr %7, align 8, !dbg !140
  %5449 = load i64, ptr %2, align 8, !dbg !142
  %5450 = icmp ult i64 %5448, %5449, !dbg !143
  br i1 %5450, label %5451, label %5507, !dbg !144

5451:                                             ; preds = %5447
  %5452 = load i64, ptr %7, align 8, !dbg !145
  %5453 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %5452, !dbg !148
  %5454 = load i32, ptr %5453, align 4, !dbg !148
  %5455 = load i32, ptr %13, align 4, !dbg !149
  %5456 = sub nsw i32 %5454, %5455, !dbg !150
  %5457 = call i32 @llvm.abs.i32(i32 %5456, i1 true), !dbg !151
  %5458 = load i32, ptr %12, align 4, !dbg !152
  %5459 = load i64, ptr %7, align 8, !dbg !153
  %5460 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %5459, !dbg !154
  %5461 = load i32, ptr %5460, align 4, !dbg !154
  %5462 = sub nsw i32 %5458, %5461, !dbg !155
  %5463 = call i32 @llvm.abs.i32(i32 %5462, i1 true), !dbg !156
  %5464 = icmp sgt i32 %5457, %5463, !dbg !157
  br i1 %5464, label %5465, label %5484, !dbg !158

5465:                                             ; preds = %5451
  %5466 = load i64, ptr %9, align 8, !dbg !159
  %5467 = load i64, ptr %7, align 8, !dbg !161
  %5468 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %5467, !dbg !162
  %5469 = load i32, ptr %5468, align 4, !dbg !162
  %5470 = load i32, ptr %13, align 4, !dbg !163
  %5471 = sub nsw i32 %5469, %5470, !dbg !164
  %5472 = call i32 @llvm.abs.i32(i32 %5471, i1 true), !dbg !165
  %5473 = sext i32 %5472 to i64, !dbg !165
  %5474 = load i64, ptr %7, align 8, !dbg !166
  %5475 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %5474, !dbg !167
  %5476 = load i32, ptr %5475, align 4, !dbg !167
  %5477 = sext i32 %5476 to i64, !dbg !168
  %5478 = getelementptr inbounds [2000 x i64], ptr %10, i64 0, i64 %5477, !dbg !168
  %5479 = load i64, ptr %5478, align 8, !dbg !168
  %5480 = mul i64 %5473, %5479, !dbg !169
  %5481 = add i64 %5466, %5480, !dbg !170
  store i64 %5481, ptr %9, align 8, !dbg !171
  %5482 = load i32, ptr %13, align 4, !dbg !172
  %5483 = add nsw i32 %5482, 1, !dbg !172
  store i32 %5483, ptr %13, align 4, !dbg !172
  br label %5503, !dbg !173

5484:                                             ; preds = %5451
  %5485 = load i64, ptr %9, align 8, !dbg !174
  %5486 = load i32, ptr %12, align 4, !dbg !176
  ...
  %5490 = sub nsw i32 %5486, %5489, !dbg !179
  %5491 = call i32 @llvm.abs.i32(i32 %5490, i1 true), !dbg !180
  %5492 = sext i32 %5491 to i64, !dbg !180
  %5493 = load i64, ptr %7, align 8, !dbg !181
  %5494 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %5493, !dbg !182
  %5495 = load i32, ptr %5494, align 4, !dbg !182
  %5496 = sext i32 %5495 to i64, !dbg !183
  %5497 = getelementptr inbounds [2000 x i64], ptr %10, i64 0, i64 %5496, !dbg !183
  %5498 = load i64, ptr %5497, align 8, !dbg !183
  %5499 = mul i64 %5492, %5498, !dbg !184
  %5500 = add i64 %5485, %5499, !dbg !185
  store i64 %5500, ptr %9, align 8, !dbg !186
  %5501 = load i32, ptr %12, align 4, !dbg !187
  %5502 = add nsw i32 %5501, -1, !dbg !187
  store i32 %5502, ptr %12, align 4, !dbg !187
  br label %5503

5503:                                             ; preds = %5484, %5465
  br label %5504, !dbg !188

5504:                                             ; preds = %5503
  %5505 = load i64, ptr %7, align 8, !dbg !189
  %5506 = add i64 %5505, 1, !dbg !189
  store i64 %5506, ptr %7, align 8, !dbg !189
  br label %5447, !dbg !190, !llvm.loop !191

5507:                                             ; preds = %5447
  %5508 = load i64, ptr %9, align 8, !dbg !193
  %5509 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %5508), !dbg !194
  ret i32 0, !dbg !195
}
