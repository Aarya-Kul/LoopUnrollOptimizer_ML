...
38:                                               ; preds = %167, %37
  ...
  br i1 %40, label %41, label %170, !dbg !93
...
150:                                              ; preds = %144, %141, %134
  ...
  br i1 %152, label %156, label %153, !dbg !201

153:                                              ; preds = %150
  %154 = load i32, ptr %12, align 4, !dbg !202
  %155 = icmp eq i32 %154, 0, !dbg !203
  br i1 %155, label %156, label %159, !dbg !204

156:                                              ; preds = %153, %150
  %157 = load i32, ptr %9, align 4, !dbg !205
  %158 = add nsw i32 %157, 1, !dbg !205
  store i32 %158, ptr %9, align 4, !dbg !205
  br label %159, !dbg !207
...
166:                                              ; preds = %165, %51
  br label %167, !dbg !209

167:                                              ; preds = %166
  %168 = load i32, ptr %12, align 4, !dbg !210
  %169 = add nsw i32 %168, 1, !dbg !210
  store i32 %169, ptr %12, align 4, !dbg !210
  br label %38, !dbg !211, !llvm.loop !212

170:                                              ; preds = %38
  %171 = load i32, ptr %2, align 4, !dbg !214
  %172 = icmp sgt i32 %171, 0, !dbg !216
  br i1 %172, label %173, label %196, !dbg !217

173:                                              ; preds = %170
  %174 = load i32, ptr %3, align 4, !dbg !218
  %175 = icmp sgt i32 %174, 0, !dbg !219
  br i1 %175, label %176, label %196, !dbg !220

176:                                              ; preds = %173
  %177 = load i32, ptr %4, align 4, !dbg !221
  %178 = icmp sgt i32 %177, 0, !dbg !222
  br i1 %178, label %179, label %196, !dbg !223

179:                                              ; preds = %176
  %180 = load i32, ptr %5, align 4, !dbg !224
  %181 = icmp sgt i32 %180, 0, !dbg !225
  br i1 %181, label %182, label %196, !dbg !226

182:                                              ; preds = %179
  %183 = load i32, ptr %6, align 4, !dbg !227
  %184 = icmp sgt i32 %183, 0, !dbg !228
  br i1 %184, label %185, label %196, !dbg !229

185:                                              ; preds = %182
  %186 = load i32, ptr %7, align 4, !dbg !230
  %187 = icmp sgt i32 %186, 0, !dbg !231
  br i1 %187, label %188, label %196, !dbg !232

188:                                              ; preds = %185
  %189 = load i32, ptr %8, align 4, !dbg !233
  %190 = icmp sgt i32 %189, 0, !dbg !234
  br i1 %190, label %191, label %196, !dbg !235

191:                                              ; preds = %188
  %192 = load i32, ptr %9, align 4, !dbg !236
  %193 = icmp slt i32 %192, 2, !dbg !237
  br i1 %193, label %194, label %196, !dbg !238

194:                                              ; preds = %191
  %195 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !239
  br label %198, !dbg !241

196:                                              ; preds = %191, %188, %185, %182, %179, %176, %173, %170
  %197 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !242
  br label %198
