...
6:                                                ; preds = %34, %0
  ...
  br i1 %8, label %9, label %47, !dbg !152
...
24:                                               ; preds = %23
  ...
  br i1 %28, label %29, label %47, !dbg !152
...
30:                                               ; preds = %44, %29
  ...
  br i1 %32, label %37, label %33, !dbg !160
...
48:                                               ; preds = %65, %47
  %49 = load i32, ptr %4, align 4, !dbg !178
  %50 = load i32, ptr @N, align 4, !dbg !180
  %51 = icmp slt i32 %49, %50, !dbg !181
  br i1 %51, label %52, label %68, !dbg !182

52:                                               ; preds = %48
  %53 = load i32, ptr %4, align 4, !dbg !183
  %54 = sext i32 %53 to i64, !dbg !185
  %55 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %54, !dbg !185
  %56 = getelementptr inbounds %struct.Child, ptr %55, i32 0, i32 0, !dbg !186
  %57 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.1, ptr noundef %56), !dbg !187
  %58 = load i32, ptr %4, align 4, !dbg !188
  %59 = add nsw i32 %58, 1, !dbg !189
  %60 = sext i32 %59 to i64, !dbg !188
  %61 = load i32, ptr %4, align 4, !dbg !190
  %62 = sext i32 %61 to i64, !dbg !191
  %63 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %62, !dbg !191
  %64 = getelementptr inbounds %struct.Child, ptr %63, i32 0, i32 1, !dbg !192
  store i64 %60, ptr %64, align 8, !dbg !193
  br label %65, !dbg !194

65:                                               ; preds = %52
  %66 = load i32, ptr %4, align 4, !dbg !195
  %67 = add nsw i32 %66, 1, !dbg !195
  store i32 %67, ptr %4, align 4, !dbg !195
  br label %48, !dbg !196, !llvm.loop !197

68:                                               ; preds = %48
  %69 = load i32, ptr @N, align 4, !dbg !199
  %70 = sext i32 %69 to i64, !dbg !199
  call void @qsort(ptr noundef @A, i64 noundef %70, i64 noundef 16, ptr noundef @ascend), !dbg !200
  %71 = load i32, ptr @N, align 4, !dbg !201
  %72 = sext i32 %71 to i64, !dbg !201
  %73 = call i64 @assign(i64 noundef 1, i64 noundef %72), !dbg !202
  %74 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %73), !dbg !203
  ret i32 0, !dbg !204
}
