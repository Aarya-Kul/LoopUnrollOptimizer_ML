...
147:                                              ; preds = %144
  ...
  br label %157, !dbg !195

150:                                              ; preds = %144, %141, %134
  %151 = load i32, ptr %10, align 4, !dbg !196
  %152 = icmp eq i32 %151, 1, !dbg !199
  br i1 %152, label %153, label %156, !dbg !200

153:                                              ; preds = %150
  %154 = load i32, ptr %9, align 4, !dbg !201
  %155 = add nsw i32 %154, 1, !dbg !201
  store i32 %155, ptr %9, align 4, !dbg !201
  br label %156, !dbg !203
...
163:                                              ; preds = %162, %51
  br label %164, !dbg !205

164:                                              ; preds = %163
  %165 = load i32, ptr %12, align 4, !dbg !206
  %166 = add nsw i32 %165, 1, !dbg !206
  store i32 %166, ptr %12, align 4, !dbg !206
  br label %38, !dbg !207, !llvm.loop !208

167:                                              ; preds = %38
  %168 = load i32, ptr %2, align 4, !dbg !210
  %169 = icmp sgt i32 %168, 0, !dbg !212
  br i1 %169, label %170, label %193, !dbg !213

170:                                              ; preds = %167
  %171 = load i32, ptr %3, align 4, !dbg !214
  %172 = icmp sgt i32 %171, 0, !dbg !215
  br i1 %172, label %173, label %193, !dbg !216

173:                                              ; preds = %170
  %174 = load i32, ptr %4, align 4, !dbg !217
  %175 = icmp sgt i32 %174, 0, !dbg !218
  br i1 %175, label %176, label %193, !dbg !219

176:                                              ; preds = %173
  %177 = load i32, ptr %5, align 4, !dbg !220
  %178 = icmp sgt i32 %177, 0, !dbg !221
  br i1 %178, label %179, label %193, !dbg !222

179:                                              ; preds = %176
  %180 = load i32, ptr %6, align 4, !dbg !223
  %181 = icmp sgt i32 %180, 0, !dbg !224
  br i1 %181, label %182, label %193, !dbg !225

182:                                              ; preds = %179
  %183 = load i32, ptr %7, align 4, !dbg !226
  %184 = icmp sgt i32 %183, 0, !dbg !227
  br i1 %184, label %185, label %193, !dbg !228

185:                                              ; preds = %182
  %186 = load i32, ptr %8, align 4, !dbg !229
  %187 = icmp sgt i32 %186, 0, !dbg !230
  br i1 %187, label %188, label %193, !dbg !231

188:                                              ; preds = %185
  %189 = load i32, ptr %9, align 4, !dbg !232
  %190 = icmp slt i32 %189, 2, !dbg !233
  br i1 %190, label %191, label %193, !dbg !234

191:                                              ; preds = %188
  %192 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %195, !dbg !237

193:                                              ; preds = %188, %185, %182, %179, %176, %173, %170, %167
  %194 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %195
