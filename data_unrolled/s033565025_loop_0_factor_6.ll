...
423:                                              ; preds = %420
  ...
  br label %433, !dbg !195

426:                                              ; preds = %420, %417, %410
  %427 = load i32, ptr %10, align 4, !dbg !196
  %428 = icmp eq i32 %427, 1, !dbg !199
  br i1 %428, label %429, label %432, !dbg !200

429:                                              ; preds = %426
  %430 = load i32, ptr %9, align 4, !dbg !201
  %431 = add nsw i32 %430, 1, !dbg !201
  store i32 %431, ptr %9, align 4, !dbg !201
  br label %432, !dbg !203
...
439:                                              ; preds = %438, %327
  br label %440, !dbg !205

440:                                              ; preds = %439
  %441 = load i32, ptr %12, align 4, !dbg !206
  %442 = add nsw i32 %441, 1, !dbg !206
  store i32 %442, ptr %12, align 4, !dbg !206
  br label %314, !dbg !207, !llvm.loop !208

443:                                              ; preds = %314
  %444 = load i32, ptr %2, align 4, !dbg !210
  %445 = icmp sgt i32 %444, 0, !dbg !212
  br i1 %445, label %446, label %469, !dbg !213

446:                                              ; preds = %443
  %447 = load i32, ptr %3, align 4, !dbg !214
  %448 = icmp sgt i32 %447, 0, !dbg !215
  br i1 %448, label %449, label %469, !dbg !216

449:                                              ; preds = %446
  %450 = load i32, ptr %4, align 4, !dbg !217
  %451 = icmp sgt i32 %450, 0, !dbg !218
  br i1 %451, label %452, label %469, !dbg !219

452:                                              ; preds = %449
  %453 = load i32, ptr %5, align 4, !dbg !220
  %454 = icmp sgt i32 %453, 0, !dbg !221
  br i1 %454, label %455, label %469, !dbg !222

455:                                              ; preds = %452
  %456 = load i32, ptr %6, align 4, !dbg !223
  %457 = icmp sgt i32 %456, 0, !dbg !224
  br i1 %457, label %458, label %469, !dbg !225

458:                                              ; preds = %455
  %459 = load i32, ptr %7, align 4, !dbg !226
  %460 = icmp sgt i32 %459, 0, !dbg !227
  br i1 %460, label %461, label %469, !dbg !228

461:                                              ; preds = %458
  %462 = load i32, ptr %8, align 4, !dbg !229
  %463 = icmp sgt i32 %462, 0, !dbg !230
  br i1 %463, label %464, label %469, !dbg !231

464:                                              ; preds = %461
  %465 = load i32, ptr %9, align 4, !dbg !232
  %466 = icmp slt i32 %465, 2, !dbg !233
  br i1 %466, label %467, label %469, !dbg !234

467:                                              ; preds = %464
  %468 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %471, !dbg !237

469:                                              ; preds = %464, %461, %458, %455, %452, %449, %446, %443
  %470 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %471
