...
4:                                                ; preds = %18, %0
  ...
  br i1 %6, label %7, label %21, !dbg !38
...
21:                                               ; preds = %4
  %22 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 1, !dbg !56
  %23 = load i32, ptr %22, align 4, !dbg !56
  %24 = mul nsw i32 %23, 100, !dbg !57
  %25 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !58
  %26 = load i32, ptr %25, align 4, !dbg !58
  %27 = mul nsw i32 %26, 10, !dbg !59
  %28 = add nsw i32 %24, %27, !dbg !60
  %29 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 3, !dbg !61
  %30 = load i32, ptr %29, align 4, !dbg !61
  %31 = add nsw i32 %28, %30, !dbg !62
  %32 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %31), !dbg !63
  ret i32 0, !dbg !64
}
