...
137:                                              ; preds = %289, %136
  ...
  br i1 %139, label %140, label %292, !dbg !124
...
173:                                              ; preds = %285, %172
  ...
  br i1 %177, label %178, label %288, !dbg !174
...
285:                                              ; preds = %284
  %286 = load i32, ptr %3, align 4, !dbg !269
  %287 = add nsw i32 %286, 1, !dbg !269
  store i32 %287, ptr %3, align 4, !dbg !269
  br label %173, !dbg !270, !llvm.loop !271

288:                                              ; preds = %173
  br label %289, !dbg !273

289:                                              ; preds = %288
  %290 = load i32, ptr %2, align 4, !dbg !274
  %291 = add nsw i32 %290, 1, !dbg !274
  store i32 %291, ptr %2, align 4, !dbg !274
  br label %137, !dbg !275, !llvm.loop !276

292:                                              ; preds = %137
  %293 = load i32, ptr %10, align 4, !dbg !278
  %294 = icmp sgt i32 %293, 0, !dbg !280
  br i1 %294, label %295, label %297, !dbg !281

295:                                              ; preds = %292
  %296 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !282
  br label %299, !dbg !284

297:                                              ; preds = %292
  %298 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !285
  br label %299
