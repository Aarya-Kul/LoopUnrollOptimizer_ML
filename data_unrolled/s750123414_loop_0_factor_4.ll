...
133:                                              ; preds = %114, %98, %82, %66, %50, %34, %18, %4
  ...
  %136 = mul nsw i32 %135, 100, !dbg !57
  %137 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !58
  %138 = load i32, ptr %137, align 4, !dbg !58
  %139 = mul nsw i32 %138, 10, !dbg !59
  %140 = add nsw i32 %136, %139, !dbg !60
  %141 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 3, !dbg !61
  %142 = load i32, ptr %141, align 4, !dbg !61
  %143 = add nsw i32 %140, %142, !dbg !62
  %144 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %143), !dbg !63
  ret i32 0, !dbg !64
}
