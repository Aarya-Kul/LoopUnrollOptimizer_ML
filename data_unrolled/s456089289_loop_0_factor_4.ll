...
343:                                              ; preds = %281, %274
  ...
  br i1 %349, label %350, label %797, !dbg !332
...
353:                                              ; preds = %793, %350
  ...
  br i1 %357, label %358, label %796, !dbg !344
...
408:                                              ; preds = %407
  ...
  br i1 %414, label %415, label %796, !dbg !344
...
463:                                              ; preds = %462
  ...
  br i1 %469, label %470, label %796, !dbg !344
...
518:                                              ; preds = %517
  ...
  br i1 %524, label %525, label %796, !dbg !344
...
573:                                              ; preds = %572
  ...
  br i1 %579, label %580, label %796, !dbg !344
...
628:                                              ; preds = %627
  ...
  br i1 %634, label %635, label %796, !dbg !344
...
683:                                              ; preds = %682
  ...
  br i1 %689, label %690, label %796, !dbg !344
...
738:                                              ; preds = %737
  ...
  br i1 %744, label %745, label %796, !dbg !344
...
796:                                              ; preds = %738, %683, %628, %573, %518, %463, %408, %353
  br label %797, !dbg !384
...
802:                                              ; preds = %801, %66
  %803 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !385
  store i32 0, ptr %1, align 4, !dbg !386
  br label %804, !dbg !386

804:                                              ; preds = %802, %405, %336, %267, %198, %129, %60, %16
  %805 = load i32, ptr %1, align 4, !dbg !387
  ret i32 %805, !dbg !387
}
