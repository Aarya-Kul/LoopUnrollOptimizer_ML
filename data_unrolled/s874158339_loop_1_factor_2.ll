...
6682:                                             ; preds = %6681
  ...
  br i1 %6687, label %6688, label %6796, !dbg !138
...
6796:                                             ; preds = %6682, %6573
  %6797 = load i64, ptr %10, align 8, !dbg !231
  %6798 = load i64, ptr %13, align 8, !dbg !233
  %6799 = icmp sgt i64 %6797, %6798, !dbg !234
  br i1 %6799, label %6800, label %6803, !dbg !235

6800:                                             ; preds = %6796
  %6801 = load i64, ptr %10, align 8, !dbg !236
  %6802 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %6801), !dbg !237
  br label %6806, !dbg !237

6803:                                             ; preds = %6796
  %6804 = load i64, ptr %13, align 8, !dbg !238
  %6805 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %6804), !dbg !239
  br label %6806

6806:                                             ; preds = %6803, %6800
  %6807 = load i32, ptr %3, align 4, !dbg !240
  ret i32 %6807, !dbg !240
}
