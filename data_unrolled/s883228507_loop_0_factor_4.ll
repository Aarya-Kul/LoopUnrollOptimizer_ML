...
16:                                               ; preds = %152, %15
  ...
  br i1 %20, label %21, label %155, !dbg !68
...
30:                                               ; preds = %142, %125, %108, %91, %74, %57, %40, %21
...
33:                                               ; preds = %32
  ...
  br i1 %39, label %40, label %155, !dbg !68
...
50:                                               ; preds = %49
  ...
  br i1 %56, label %57, label %155, !dbg !68
...
67:                                               ; preds = %66
  ...
  br i1 %73, label %74, label %155, !dbg !68
...
84:                                               ; preds = %83
  ...
  br i1 %90, label %91, label %155, !dbg !68
...
101:                                              ; preds = %100
  ...
  br i1 %107, label %108, label %155, !dbg !68
...
118:                                              ; preds = %117
  ...
  br i1 %124, label %125, label %155, !dbg !68
...
135:                                              ; preds = %134
  ...
  br i1 %141, label %142, label %155, !dbg !68
...
155:                                              ; preds = %135, %118, %101, %84, %67, %50, %33, %30, %16
  store i32 0, ptr %4, align 4, !dbg !86
  br label %156, !dbg !88

156:                                              ; preds = %172, %155
  %157 = load i32, ptr %3, align 4, !dbg !89
  %158 = sext i32 %157 to i64, !dbg !93
  %159 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %158, !dbg !93
  %160 = load i8, ptr %159, align 1, !dbg !93
  %161 = sext i8 %160 to i32, !dbg !93
  %162 = load i32, ptr %4, align 4, !dbg !94
  %163 = sext i32 %162 to i64, !dbg !95
  %164 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %163, !dbg !95
  %165 = load i8, ptr %164, align 1, !dbg !95
  %166 = sext i8 %165 to i32, !dbg !95
  %167 = icmp eq i32 %161, %166, !dbg !96
  br i1 %167, label %168, label %171, !dbg !97

168:                                              ; preds = %156
  %169 = load i32, ptr %3, align 4, !dbg !98
  %170 = add nsw i32 %169, 1, !dbg !98
  store i32 %170, ptr %3, align 4, !dbg !98
...
172:                                              ; preds = %168
  %173 = load i32, ptr %4, align 4, !dbg !102
  %174 = add nsw i32 %173, 1, !dbg !102
  store i32 %174, ptr %4, align 4, !dbg !102
  br label %156, !dbg !103, !llvm.loop !104

175:                                              ; preds = %171
  %176 = load i32, ptr %3, align 4, !dbg !107
  %177 = sext i32 %176 to i64, !dbg !109
  %178 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %177, !dbg !109
  %179 = load i32, ptr %4, align 4, !dbg !110
  %180 = add nsw i32 %179, 1, !dbg !111
  %181 = sext i32 %180 to i64, !dbg !112
  %182 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %181, !dbg !112
  %183 = call ptr @strstr(ptr noundef %178, ptr noundef %182) #5, !dbg !113
  store ptr %183, ptr %7, align 8, !dbg !114
  %184 = icmp ne ptr %183, null, !dbg !115
  br i1 %184, label %185, label %186, !dbg !116

185:                                              ; preds = %175
  store i32 1, ptr %2, align 4, !dbg !117
  br label %186, !dbg !118

186:                                              ; preds = %185, %175
  %187 = load i32, ptr %2, align 4, !dbg !119
  %188 = icmp ne i32 %187, 0, !dbg !119
  br i1 %188, label %189, label %191, !dbg !121

189:                                              ; preds = %186
  %190 = call i32 @puts(ptr noundef @.str.1), !dbg !122
  br label %193, !dbg !122

191:                                              ; preds = %186
  %192 = call i32 @puts(ptr noundef @.str.2), !dbg !123
  br label %193
