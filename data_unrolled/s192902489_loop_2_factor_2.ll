...
12735:                                            ; preds = %12704
  br label %12736, !dbg !124

12736:                                            ; preds = %12757, %12735
  %12737 = load i32, ptr %3, align 4, !dbg !125
  %12738 = sext i32 %12737 to i64, !dbg !128
  %12739 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %12738, !dbg !128
  %12740 = load i8, ptr %12739, align 1, !dbg !128
  %12741 = sext i8 %12740 to i32, !dbg !128
  %12742 = icmp eq i32 101, %12741, !dbg !129
  br i1 %12742, label %12743, label %12748, !dbg !130

12743:                                            ; preds = %12736
  %12744 = load i32, ptr %3, align 4, !dbg !131
  %12745 = icmp sgt i32 %12744, 4, !dbg !134
  br i1 %12745, label %12746, label %12747, !dbg !135

12746:                                            ; preds = %12743
  store i32 1, ptr %4, align 4, !dbg !136
  br label %12747, !dbg !138

12747:                                            ; preds = %12746, %12743
  br label %12760, !dbg !139

12748:                                            ; preds = %12736
  %12749 = load i32, ptr %3, align 4, !dbg !140
  %12750 = icmp sgt i32 %12749, 97, !dbg !142
  br i1 %12750, label %12754, label %12751, !dbg !143

12751:                                            ; preds = %12748
  %12752 = load i32, ptr %4, align 4, !dbg !144
  %12753 = icmp eq i32 %12752, 1, !dbg !145
  br i1 %12753, label %12754, label %12756, !dbg !146

12754:                                            ; preds = %12751, %12748
  %12755 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !147
  br label %12756, !dbg !149

12756:                                            ; preds = %12754, %12751
  br label %12757

12757:                                            ; preds = %12756
  %12758 = load i32, ptr %3, align 4, !dbg !150
  %12759 = add nsw i32 %12758, 1, !dbg !150
  store i32 %12759, ptr %3, align 4, !dbg !150
  br label %12736, !dbg !124, !llvm.loop !151

12760:                                            ; preds = %12747
  br label %12761, !dbg !153

12761:                                            ; preds = %12782, %12760
  %12762 = load i32, ptr %3, align 4, !dbg !154
  %12763 = sext i32 %12762 to i64, !dbg !157
  %12764 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %12763, !dbg !157
  %12765 = load i8, ptr %12764, align 1, !dbg !157
  %12766 = sext i8 %12765 to i32, !dbg !157
  %12767 = icmp eq i32 110, %12766, !dbg !158
  br i1 %12767, label %12768, label %12773, !dbg !159

12768:                                            ; preds = %12761
  %12769 = load i32, ptr %3, align 4, !dbg !160
  %12770 = icmp sgt i32 %12769, 5, !dbg !163
  br i1 %12770, label %12771, label %12772, !dbg !164

12771:                                            ; preds = %12768
  store i32 1, ptr %4, align 4, !dbg !165
  br label %12772, !dbg !167

12772:                                            ; preds = %12771, %12768
  br label %12785, !dbg !168

12773:                                            ; preds = %12761
  %12774 = load i32, ptr %3, align 4, !dbg !169
  %12775 = icmp sgt i32 %12774, 98, !dbg !171
  br i1 %12775, label %12779, label %12776, !dbg !172

12776:                                            ; preds = %12773
  %12777 = load i32, ptr %4, align 4, !dbg !173
  %12778 = icmp eq i32 %12777, 1, !dbg !174
  br i1 %12778, label %12779, label %12781, !dbg !175

12779:                                            ; preds = %12776, %12773
  %12780 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !176
  br label %12781, !dbg !178

12781:                                            ; preds = %12779, %12776
  br label %12782

12782:                                            ; preds = %12781
  %12783 = load i32, ptr %3, align 4, !dbg !179
  %12784 = add nsw i32 %12783, 1, !dbg !179
  store i32 %12784, ptr %3, align 4, !dbg !179
  br label %12761, !dbg !153, !llvm.loop !180

12785:                                            ; preds = %12772
  br label %12786, !dbg !182

12786:                                            ; preds = %12807, %12785
  %12787 = load i32, ptr %3, align 4, !dbg !183
  %12788 = sext i32 %12787 to i64, !dbg !186
  %12789 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %12788, !dbg !186
  %12790 = load i8, ptr %12789, align 1, !dbg !186
  %12791 = sext i8 %12790 to i32, !dbg !186
  %12792 = icmp eq i32 99, %12791, !dbg !187
  br i1 %12792, label %12793, label %12798, !dbg !188

12793:                                            ; preds = %12786
  %12794 = load i32, ptr %3, align 4, !dbg !189
  %12795 = icmp sgt i32 %12794, 6, !dbg !192
  br i1 %12795, label %12796, label %12797, !dbg !193

12796:                                            ; preds = %12793
  store i32 1, ptr %4, align 4, !dbg !194
  br label %12797, !dbg !196

12797:                                            ; preds = %12796, %12793
  br label %12810, !dbg !197

12798:                                            ; preds = %12786
  %12799 = load i32, ptr %3, align 4, !dbg !198
  %12800 = icmp sgt i32 %12799, 99, !dbg !200
  br i1 %12800, label %12804, label %12801, !dbg !201

12801:                                            ; preds = %12798
  %12802 = load i32, ptr %4, align 4, !dbg !202
  %12803 = icmp eq i32 %12802, 1, !dbg !203
  br i1 %12803, label %12804, label %12806, !dbg !204

12804:                                            ; preds = %12801, %12798
  %12805 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !205
  br label %12806, !dbg !207

12806:                                            ; preds = %12804, %12801
  br label %12807

12807:                                            ; preds = %12806
  %12808 = load i32, ptr %3, align 4, !dbg !208
  %12809 = add nsw i32 %12808, 1, !dbg !208
  store i32 %12809, ptr %3, align 4, !dbg !208
  br label %12786, !dbg !182, !llvm.loop !209

12810:                                            ; preds = %12797
  br label %12811, !dbg !211

12811:                                            ; preds = %12832, %12810
  %12812 = load i32, ptr %3, align 4, !dbg !212
  %12813 = sext i32 %12812 to i64, !dbg !215
  %12814 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %12813, !dbg !215
  %12815 = load i8, ptr %12814, align 1, !dbg !215
  %12816 = sext i8 %12815 to i32, !dbg !215
  %12817 = icmp eq i32 101, %12816, !dbg !216
  br i1 %12817, label %12818, label %12823, !dbg !217

12818:                                            ; preds = %12811
  %12819 = load i32, ptr %3, align 4, !dbg !218
  %12820 = icmp sgt i32 %12819, 7, !dbg !221
  br i1 %12820, label %12821, label %12822, !dbg !222

12821:                                            ; preds = %12818
  store i32 1, ptr %4, align 4, !dbg !223
  br label %12822, !dbg !225

12822:                                            ; preds = %12821, %12818
  br label %12835, !dbg !226

12823:                                            ; preds = %12811
  %12824 = load i32, ptr %3, align 4, !dbg !227
  %12825 = icmp sgt i32 %12824, 100, !dbg !229
  br i1 %12825, label %12829, label %12826, !dbg !230

12826:                                            ; preds = %12823
  %12827 = load i32, ptr %4, align 4, !dbg !231
  %12828 = icmp eq i32 %12827, 1, !dbg !232
  br i1 %12828, label %12829, label %12831, !dbg !233

12829:                                            ; preds = %12826, %12823
  %12830 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !234
  br label %12831, !dbg !236

12831:                                            ; preds = %12829, %12826
  br label %12832

12832:                                            ; preds = %12831
  %12833 = load i32, ptr %3, align 4, !dbg !237
  %12834 = add nsw i32 %12833, 1, !dbg !237
  store i32 %12834, ptr %3, align 4, !dbg !237
  br label %12811, !dbg !211, !llvm.loop !238

12835:                                            ; preds = %12822
  %12836 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !240
  ret i32 0, !dbg !241
}
