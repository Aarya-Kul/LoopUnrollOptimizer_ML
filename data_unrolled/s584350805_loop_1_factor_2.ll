...
9641:                                             ; preds = %9652, %9629
  store i32 0, ptr %7, align 4, !dbg !110
  br label %9671, !dbg !112
...
9646:                                             ; preds = %9645
  ...
  br i1 %9651, label %9652, label %9671, !dbg !101
...
9671:                                             ; preds = %9646, %9641, %9625
  %9672 = load i32, ptr %7, align 4, !dbg !120
  %9673 = icmp eq i32 %9672, 1, !dbg !122
  br i1 %9673, label %9674, label %9676, !dbg !123

9674:                                             ; preds = %9671
  %9675 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !124
  br label %9678, !dbg !126

9676:                                             ; preds = %9671
  %9677 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !127
  br label %9678

9678:                                             ; preds = %9676, %9674
  ret i32 0, !dbg !129
}
