...
13:                                               ; preds = %40, %0
  ...
  br i1 %15, label %16, label %43, !dbg !51
...
43:                                               ; preds = %13
  %44 = getelementptr inbounds [4 x i8], ptr %10, i64 0, i64 0, !dbg !79
  %45 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %44), !dbg !80
  ret i32 0, !dbg !81
}
