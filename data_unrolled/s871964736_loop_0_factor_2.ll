...
10:                                               ; preds = %79, %0
  ...
  br i1 %16, label %17, label %80, !dbg !52
...
45:                                               ; preds = %39
  ...
  br i1 %51, label %52, label %80, !dbg !52
...
80:                                               ; preds = %45, %44, %10
  %81 = load i32, ptr %5, align 4, !dbg !85
  %82 = icmp eq i32 %81, 1, !dbg !87
  br i1 %82, label %83, label %95, !dbg !88

83:                                               ; preds = %80
  %84 = load i32, ptr %6, align 4, !dbg !89
  %85 = icmp eq i32 %84, 7, !dbg !90
  br i1 %85, label %86, label %95, !dbg !91

86:                                               ; preds = %83
  %87 = load i32, ptr %7, align 4, !dbg !92
  %88 = sext i32 %87 to i64, !dbg !93
  %89 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %88, !dbg !93
  %90 = load i8, ptr %89, align 1, !dbg !93
  %91 = sext i8 %90 to i32, !dbg !93
  %92 = icmp eq i32 %91, 0, !dbg !94
  br i1 %92, label %93, label %95, !dbg !95

93:                                               ; preds = %86
  %94 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !96
  br label %106, !dbg !96

95:                                               ; preds = %86, %83, %80
  %96 = load i32, ptr %5, align 4, !dbg !97
  %97 = icmp eq i32 %96, 0, !dbg !99
  br i1 %97, label %98, label %103, !dbg !100

98:                                               ; preds = %95
  %99 = load i32, ptr %6, align 4, !dbg !101
  %100 = icmp eq i32 %99, 7, !dbg !102
  br i1 %100, label %101, label %103, !dbg !103

101:                                              ; preds = %98
  %102 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !104
  br label %105, !dbg !104

103:                                              ; preds = %98, %95
  %104 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !105
  br label %105
