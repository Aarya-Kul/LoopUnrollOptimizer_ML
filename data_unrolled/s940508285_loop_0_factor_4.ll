...
1450:                                             ; preds = %1270, %1091, %912, %733, %554, %375, %196, %195, %189, %164, %139, %114, %89, %64, %39, %9
  ...
  br i1 %1453, label %1454, label %1456, !dbg !259

1454:                                             ; preds = %1450
  %1455 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !260
  br label %1458, !dbg !260

1456:                                             ; preds = %1450
  %1457 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !261
  br label %1458
