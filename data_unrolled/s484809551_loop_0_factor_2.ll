...
16:                                               ; preds = %133, %0
  ...
  br i1 %18, label %19, label %136, !dbg !83
...
74:                                               ; preds = %73
  ...
  br i1 %78, label %79, label %136, !dbg !83
...
136:                                              ; preds = %74, %70, %16
  %137 = load i8, ptr %7, align 1, !dbg !159
  %138 = trunc i8 %137 to i1, !dbg !159
  %139 = zext i1 %138 to i64, !dbg !159
  %140 = select i1 %138, ptr @.str.1, ptr @.str.2, !dbg !159
  %141 = call i32 @puts(ptr noundef %140), !dbg !160
  ret i32 0, !dbg !161
}
