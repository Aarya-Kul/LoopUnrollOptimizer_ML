...
104:                                              ; preds = %63, %27
  ...
  br i1 %106, label %107, label %428, !dbg !279
...
155:                                              ; preds = %424, %153
  ...
  br i1 %158, label %159, label %427, !dbg !331
...
293:                                              ; preds = %419, %292
  ...
  br i1 %295, label %296, label %422, !dbg !455
...
296:                                              ; preds = %293
  ...
  %338 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %337, !dbg !485
  %339 = load i32, ptr %338, align 4, !dbg !485
  %340 = load i32, ptr %3, align 4, !dbg !486
  %341 = sext i32 %340 to i64, !dbg !487
  %342 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %341, !dbg !487
  %343 = load i32, ptr %342, align 4, !dbg !487
  %344 = add nsw i32 %339, %343, !dbg !488
  %345 = load i32, ptr %3, align 4, !dbg !489
  %346 = sext i32 %345 to i64, !dbg !490
  %347 = getelementptr inbounds [32 x i32], ptr %17, i64 0, i64 %346, !dbg !490
  store i32 %344, ptr %347, align 4, !dbg !491
  %348 = load i32, ptr %3, align 4, !dbg !492
  %349 = sext i32 %348 to i64, !dbg !493
  %350 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %349, !dbg !493
  %351 = load i32, ptr %350, align 4, !dbg !493
  %352 = load i32, ptr %3, align 4, !dbg !494
  %353 = sext i32 %352 to i64, !dbg !495
  %354 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %353, !dbg !495
  %355 = load i32, ptr %354, align 4, !dbg !495
  %356 = sub nsw i32 %351, %355, !dbg !496
  %357 = load i32, ptr %3, align 4, !dbg !497
  %358 = sext i32 %357 to i64, !dbg !498
  %359 = getelementptr inbounds [32 x i32], ptr %18, i64 0, i64 %358, !dbg !498
  store i32 %356, ptr %359, align 4, !dbg !499
  %360 = load i32, ptr %3, align 4, !dbg !500
  %361 = sext i32 %360 to i64, !dbg !502
  %362 = getelementptr inbounds [32 x i32], ptr %17, i64 0, i64 %361, !dbg !502
  ...
  %367 = getelementptr inbounds [32 x i32], ptr %17, i64 0, i64 %366, !dbg !505
  %368 = load i32, ptr %367, align 4, !dbg !505
  %369 = sub nsw i32 %363, %368, !dbg !506
  %370 = icmp slt i32 %369, 0, !dbg !507
  br i1 %370, label %371, label %373, !dbg !508

371:                                              ; preds = %296
  %372 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !509
  br label %418, !dbg !509

373:                                              ; preds = %296
  %374 = load i32, ptr %3, align 4, !dbg !510
  %375 = sext i32 %374 to i64, !dbg !512
  %376 = getelementptr inbounds [32 x i32], ptr %17, i64 0, i64 %375, !dbg !512
  %377 = load i32, ptr %376, align 4, !dbg !512
  %378 = load i32, ptr %3, align 4, !dbg !513
  %379 = sub nsw i32 %378, 1, !dbg !514
  %380 = sext i32 %379 to i64, !dbg !515
  %381 = getelementptr inbounds [32 x i32], ptr %17, i64 0, i64 %380, !dbg !515
  %382 = load i32, ptr %381, align 4, !dbg !515
  %383 = sub nsw i32 %377, %382, !dbg !516
  %384 = icmp sgt i32 %383, 0, !dbg !517
  br i1 %384, label %385, label %387, !dbg !518

385:                                              ; preds = %373
  %386 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !519
  br label %417, !dbg !519

387:                                              ; preds = %373
  %388 = load i32, ptr %3, align 4, !dbg !520
  %389 = sext i32 %388 to i64, !dbg !522
  %390 = getelementptr inbounds [32 x i32], ptr %18, i64 0, i64 %389, !dbg !522
  %391 = load i32, ptr %390, align 4, !dbg !522
  %392 = load i32, ptr %3, align 4, !dbg !523
  %393 = sub nsw i32 %392, 1, !dbg !524
  %394 = sext i32 %393 to i64, !dbg !525
  %395 = getelementptr inbounds [32 x i32], ptr %18, i64 0, i64 %394, !dbg !525
  %396 = load i32, ptr %395, align 4, !dbg !525
  %397 = sub nsw i32 %391, %396, !dbg !526
  %398 = icmp slt i32 %397, 0, !dbg !527
  br i1 %398, label %399, label %401, !dbg !528

399:                                              ; preds = %387
  %400 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !529
  br label %416, !dbg !529

401:                                              ; preds = %387
  %402 = load i32, ptr %3, align 4, !dbg !530
  %403 = sext i32 %402 to i64, !dbg !532
  %404 = getelementptr inbounds [32 x i32], ptr %18, i64 0, i64 %403, !dbg !532
  %405 = load i32, ptr %404, align 4, !dbg !532
  %406 = load i32, ptr %3, align 4, !dbg !533
  %407 = sub nsw i32 %406, 1, !dbg !534
  %408 = sext i32 %407 to i64, !dbg !535
  %409 = getelementptr inbounds [32 x i32], ptr %18, i64 0, i64 %408, !dbg !535
  %410 = load i32, ptr %409, align 4, !dbg !535
  %411 = sub nsw i32 %405, %410, !dbg !536
  %412 = icmp sgt i32 %411, 0, !dbg !537
  br i1 %412, label %413, label %415, !dbg !538

413:                                              ; preds = %401
  %414 = call i32 (ptr, ...) @printf(ptr noundef @.str.12), !dbg !539
  br label %415, !dbg !539
...
418:                                              ; preds = %417, %371
  br label %419, !dbg !540

419:                                              ; preds = %418
  %420 = load i32, ptr %3, align 4, !dbg !541
  %421 = add nsw i32 %420, 1, !dbg !541
  store i32 %421, ptr %3, align 4, !dbg !541
  br label %293, !dbg !542, !llvm.loop !543

422:                                              ; preds = %293
  %423 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !545
  br label %424, !dbg !546

424:                                              ; preds = %422
  %425 = load i32, ptr %2, align 4, !dbg !333
  %426 = add nsw i32 %425, 1, !dbg !333
  store i32 %426, ptr %2, align 4, !dbg !333
  br label %155, !dbg !333, !llvm.loop !547

427:                                              ; preds = %155
  br label %428, !dbg !549

428:                                              ; preds = %427, %104
  %429 = load i32, ptr %8, align 4, !dbg !550
  %430 = icmp eq i32 %429, 1, !dbg !552
  br i1 %430, label %431, label %433, !dbg !553

431:                                              ; preds = %428
  %432 = load i32, ptr %6, align 4, !dbg !554
  call void @print(i32 noundef %432), !dbg !555
  br label %433, !dbg !555

433:                                              ; preds = %431, %428
  store i32 0, ptr %1, align 4, !dbg !556
  %434 = load ptr, ptr %9, align 8, !dbg !557
  call void @llvm.stackrestore.p0(ptr %434), !dbg !557
  %435 = load i32, ptr %1, align 4, !dbg !557
  ret i32 %435, !dbg !557
}
