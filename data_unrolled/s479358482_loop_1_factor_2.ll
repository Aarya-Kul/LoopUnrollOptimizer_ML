...
5019:                                             ; preds = %5011
  ...
  br i1 %5023, label %5024, label %5035, !dbg !83
...
5035:                                             ; preds = %5019, %5008
  %5036 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !95
  %5037 = call i32 @strcmp(ptr noundef %5036, ptr noundef @.str) #4, !dbg !97
  %5038 = icmp eq i32 %5037, 0, !dbg !98
  br i1 %5038, label %5039, label %5040, !dbg !99

5039:                                             ; preds = %5035
  store i32 1, ptr %5, align 4, !dbg !100
  br label %5040, !dbg !101

5040:                                             ; preds = %5039, %5035
  %5041 = load i32, ptr %4, align 4, !dbg !102
  %5042 = sub nsw i32 %5041, 1, !dbg !103
  %5043 = sext i32 %5042 to i64, !dbg !104
  %5044 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5043, !dbg !104
  %5045 = load i8, ptr %5044, align 1, !dbg !104
  %5046 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 6, !dbg !105
  store i8 %5045, ptr %5046, align 1, !dbg !106
  %5047 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !107
  %5048 = call i32 @strcmp(ptr noundef %5047, ptr noundef @.str) #4, !dbg !109
  %5049 = icmp eq i32 %5048, 0, !dbg !110
  br i1 %5049, label %5050, label %5051, !dbg !111

5050:                                             ; preds = %5040
  store i32 1, ptr %5, align 4, !dbg !112
  br label %5051, !dbg !113

5051:                                             ; preds = %5050, %5040
  %5052 = load i32, ptr %4, align 4, !dbg !114
  %5053 = sub nsw i32 %5052, 2, !dbg !115
  %5054 = sext i32 %5053 to i64, !dbg !116
  %5055 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5054, !dbg !116
  %5056 = load i8, ptr %5055, align 1, !dbg !116
  %5057 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 5, !dbg !117
  store i8 %5056, ptr %5057, align 1, !dbg !118
  %5058 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !119
  %5059 = call i32 @strcmp(ptr noundef %5058, ptr noundef @.str) #4, !dbg !121
  %5060 = icmp eq i32 %5059, 0, !dbg !122
  br i1 %5060, label %5061, label %5062, !dbg !123

5061:                                             ; preds = %5051
  store i32 1, ptr %5, align 4, !dbg !124
  br label %5062, !dbg !125

5062:                                             ; preds = %5061, %5051
  %5063 = load i32, ptr %4, align 4, !dbg !126
  %5064 = sub nsw i32 %5063, 3, !dbg !127
  %5065 = sext i32 %5064 to i64, !dbg !128
  %5066 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5065, !dbg !128
  %5067 = load i8, ptr %5066, align 1, !dbg !128
  %5068 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 4, !dbg !129
  store i8 %5067, ptr %5068, align 1, !dbg !130
  %5069 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !131
  %5070 = call i32 @strcmp(ptr noundef %5069, ptr noundef @.str) #4, !dbg !133
  %5071 = icmp eq i32 %5070, 0, !dbg !134
  br i1 %5071, label %5072, label %5073, !dbg !135

5072:                                             ; preds = %5062
  store i32 1, ptr %5, align 4, !dbg !136
  br label %5073, !dbg !137

5073:                                             ; preds = %5072, %5062
  %5074 = load i32, ptr %4, align 4, !dbg !138
  %5075 = sub nsw i32 %5074, 4, !dbg !139
  %5076 = sext i32 %5075 to i64, !dbg !140
  %5077 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5076, !dbg !140
  %5078 = load i8, ptr %5077, align 1, !dbg !140
  %5079 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 3, !dbg !141
  store i8 %5078, ptr %5079, align 1, !dbg !142
  %5080 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !143
  %5081 = call i32 @strcmp(ptr noundef %5080, ptr noundef @.str) #4, !dbg !145
  %5082 = icmp eq i32 %5081, 0, !dbg !146
  br i1 %5082, label %5083, label %5084, !dbg !147

5083:                                             ; preds = %5073
  store i32 1, ptr %5, align 4, !dbg !148
  br label %5084, !dbg !149

5084:                                             ; preds = %5083, %5073
  %5085 = load i32, ptr %4, align 4, !dbg !150
  %5086 = sub nsw i32 %5085, 5, !dbg !151
  %5087 = sext i32 %5086 to i64, !dbg !152
  %5088 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5087, !dbg !152
  %5089 = load i8, ptr %5088, align 1, !dbg !152
  %5090 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 2, !dbg !153
  store i8 %5089, ptr %5090, align 1, !dbg !154
  %5091 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !155
  %5092 = call i32 @strcmp(ptr noundef %5091, ptr noundef @.str) #4, !dbg !157
  %5093 = icmp eq i32 %5092, 0, !dbg !158
  br i1 %5093, label %5094, label %5095, !dbg !159

5094:                                             ; preds = %5084
  store i32 1, ptr %5, align 4, !dbg !160
  br label %5095, !dbg !161

5095:                                             ; preds = %5094, %5084
  %5096 = load i32, ptr %4, align 4, !dbg !162
  %5097 = sub nsw i32 %5096, 6, !dbg !163
  %5098 = sext i32 %5097 to i64, !dbg !164
  %5099 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5098, !dbg !164
  %5100 = load i8, ptr %5099, align 1, !dbg !164
  %5101 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 1, !dbg !165
  store i8 %5100, ptr %5101, align 1, !dbg !166
  %5102 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !167
  %5103 = call i32 @strcmp(ptr noundef %5102, ptr noundef @.str) #4, !dbg !169
  %5104 = icmp eq i32 %5103, 0, !dbg !170
  br i1 %5104, label %5105, label %5106, !dbg !171

5105:                                             ; preds = %5095
  store i32 1, ptr %5, align 4, !dbg !172
  br label %5106, !dbg !173

5106:                                             ; preds = %5105, %5095
  %5107 = load i32, ptr %4, align 4, !dbg !174
  %5108 = sub nsw i32 %5107, 7, !dbg !175
  %5109 = sext i32 %5108 to i64, !dbg !176
  %5110 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5109, !dbg !176
  %5111 = load i8, ptr %5110, align 1, !dbg !176
  %5112 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !177
  store i8 %5111, ptr %5112, align 1, !dbg !178
  %5113 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !179
  %5114 = call i32 @strcmp(ptr noundef %5113, ptr noundef @.str) #4, !dbg !181
  %5115 = icmp eq i32 %5114, 0, !dbg !182
  br i1 %5115, label %5116, label %5117, !dbg !183

5116:                                             ; preds = %5106
  store i32 1, ptr %5, align 4, !dbg !184
  br label %5117, !dbg !185

5117:                                             ; preds = %5116, %5106
  %5118 = load i32, ptr %5, align 4, !dbg !186
  %5119 = icmp eq i32 %5118, 1, !dbg !188
  br i1 %5119, label %5120, label %5122, !dbg !189

5120:                                             ; preds = %5117
  %5121 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef @.str.2), !dbg !190
  br label %5124, !dbg !190

5122:                                             ; preds = %5117
  %5123 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef @.str.3), !dbg !191
  br label %5124
