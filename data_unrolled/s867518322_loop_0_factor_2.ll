...
65:                                               ; preds = %221, %64
  ...
  br i1 %67, label %68, label %224, !dbg !124
...
101:                                              ; preds = %217, %100
  ...
  br i1 %105, label %106, label %220, !dbg !174
...
212:                                              ; preds = %209, %206, %203, %196
  ...
  %214 = icmp eq i32 %213, 0, !dbg !270
  br i1 %214, label %215, label %216, !dbg !271
...
215:                                              ; preds = %212
  ...
  br label %216, !dbg !279

216:                                              ; preds = %215, %212
  br label %217, !dbg !280

217:                                              ; preds = %216
  %218 = load i32, ptr %3, align 4, !dbg !281
  %219 = add nsw i32 %218, 1, !dbg !281
  store i32 %219, ptr %3, align 4, !dbg !281
  br label %101, !dbg !282, !llvm.loop !283

220:                                              ; preds = %101
  br label %221, !dbg !285

221:                                              ; preds = %220
  %222 = load i32, ptr %2, align 4, !dbg !286
  %223 = add nsw i32 %222, 1, !dbg !286
  store i32 %223, ptr %2, align 4, !dbg !286
  br label %65, !dbg !287, !llvm.loop !288

224:                                              ; preds = %65
  %225 = load i32, ptr %10, align 4, !dbg !290
  %226 = icmp sgt i32 %225, 0, !dbg !292
  br i1 %226, label %227, label %229, !dbg !293

227:                                              ; preds = %224
  %228 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !294
  br label %231, !dbg !296

229:                                              ; preds = %224
  %230 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !297
  br label %231
