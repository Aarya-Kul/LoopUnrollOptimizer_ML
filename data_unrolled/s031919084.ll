...
11:                                               ; preds = %23, %0
  ...
  br i1 %14, label %15, label %26, !dbg !143
...
26:                                               ; preds = %11
  ...
  %27 = load i32, ptr %5, align 4, !dbg !158
  %28 = sext i32 %27 to i64, !dbg !158
  call void @qsort(ptr noundef @main.hx, i64 noundef %28, i64 noundef 4, ptr noundef @comp), !dbg !159
  %29 = load i32, ptr %5, align 4, !dbg !160
  %30 = sext i32 %29 to i64, !dbg !160
  call void @qsort(ptr noundef @main.hy, i64 noundef %30, i64 noundef 4, ptr noundef @comp), !dbg !161
  %31 = load i32, ptr %5, align 4, !dbg !162
  %32 = sub nsw i32 %31, 1, !dbg !163
  %33 = sdiv i32 %32, 2, !dbg !164
  %34 = sext i32 %33 to i64, !dbg !165
  %35 = getelementptr inbounds [100000 x i32], ptr @main.hx, i64 0, i64 %34, !dbg !165
  %36 = load i32, ptr %35, align 4, !dbg !165
  store i32 %36, ptr %6, align 4, !dbg !166
  %37 = load i32, ptr %5, align 4, !dbg !167
  %38 = sub nsw i32 %37, 1, !dbg !168
  %39 = sdiv i32 %38, 2, !dbg !169
  %40 = sext i32 %39 to i64, !dbg !170
  %41 = getelementptr inbounds [100000 x i32], ptr @main.hy, i64 0, i64 %40, !dbg !170
  %42 = load i32, ptr %41, align 4, !dbg !170
  store i32 %42, ptr %7, align 4, !dbg !171
  store i64 0, ptr %8, align 8, !dbg !172
  store i32 0, ptr %2, align 4, !dbg !173
  br label %43, !dbg !175

43:                                               ; preds = %61, %26
  %44 = load i32, ptr %2, align 4, !dbg !176
  %45 = load i32, ptr %5, align 4, !dbg !178
  %46 = icmp slt i32 %44, %45, !dbg !179
  br i1 %46, label %47, label %64, !dbg !180

47:                                               ; preds = %43
  %48 = load i32, ptr %6, align 4, !dbg !181
  %49 = load i32, ptr %7, align 4, !dbg !183
  %50 = load i32, ptr %2, align 4, !dbg !184
  %51 = sext i32 %50 to i64, !dbg !185
  %52 = getelementptr inbounds [100000 x i32], ptr @main.mx, i64 0, i64 %51, !dbg !185
  %53 = load i32, ptr %52, align 4, !dbg !185
  %54 = load i32, ptr %2, align 4, !dbg !186
  %55 = sext i32 %54 to i64, !dbg !187
  %56 = getelementptr inbounds [100000 x i32], ptr @main.my, i64 0, i64 %55, !dbg !187
  %57 = load i32, ptr %56, align 4, !dbg !187
  %58 = call i64 @dist(i32 noundef %48, i32 noundef %49, i32 noundef %53, i32 noundef %57), !dbg !188
  %59 = load i64, ptr %8, align 8, !dbg !189
  %60 = add nsw i64 %59, %58, !dbg !189
  store i64 %60, ptr %8, align 8, !dbg !189
  br label %61, !dbg !190

61:                                               ; preds = %47
  %62 = load i32, ptr %2, align 4, !dbg !191
  %63 = add nsw i32 %62, 1, !dbg !191
  store i32 %63, ptr %2, align 4, !dbg !191
  br label %43, !dbg !192, !llvm.loop !193

64:                                               ; preds = %43
  %65 = load i32, ptr @max, align 4, !dbg !195
  %66 = sext i32 %65 to i64, !dbg !195
  %67 = load i64, ptr %8, align 8, !dbg !196
  %68 = sub nsw i64 %67, %66, !dbg !196
  store i64 %68, ptr %8, align 8, !dbg !196
  %69 = load i64, ptr %8, align 8, !dbg !197
  %70 = load i32, ptr %6, align 4, !dbg !198
  %71 = load i32, ptr %7, align 4, !dbg !199
  %72 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %69, i32 noundef %70, i32 noundef %71), !dbg !200
  ret i32 0, !dbg !201
}
