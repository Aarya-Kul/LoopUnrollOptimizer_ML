...
6567:                                             ; preds = %6563
  %6568 = load i32, ptr %3, align 4, !dbg !107
  %6569 = sext i32 %6568 to i64, !dbg !109
  %6570 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %6569, !dbg !109
  %6571 = load i32, ptr %4, align 4, !dbg !110
  %6572 = add nsw i32 %6571, 1, !dbg !111
  %6573 = sext i32 %6572 to i64, !dbg !112
  %6574 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %6573, !dbg !112
  %6575 = call ptr @strstr(ptr noundef %6570, ptr noundef %6574) #5, !dbg !113
  store ptr %6575, ptr %7, align 8, !dbg !114
  %6576 = icmp ne ptr %6575, null, !dbg !115
  br i1 %6576, label %6577, label %6578, !dbg !116

6577:                                             ; preds = %6567
  store i32 1, ptr %2, align 4, !dbg !117
  br label %6578, !dbg !118

6578:                                             ; preds = %6577, %6567
  %6579 = load i32, ptr %2, align 4, !dbg !119
  %6580 = icmp ne i32 %6579, 0, !dbg !119
  br i1 %6580, label %6581, label %6583, !dbg !121

6581:                                             ; preds = %6578
  %6582 = call i32 @puts(ptr noundef @.str.1), !dbg !122
  br label %6585, !dbg !122

6583:                                             ; preds = %6578
  %6584 = call i32 @puts(ptr noundef @.str.2), !dbg !123
  br label %6585

6585:                                             ; preds = %6583, %6581
  ret i32 0, !dbg !124
}
