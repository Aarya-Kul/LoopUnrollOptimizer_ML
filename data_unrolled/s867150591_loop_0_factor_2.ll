...
78:                                               ; preds = %149, %75
  ...
  br i1 %81, label %82, label %152, !dbg !151
...
83:                                               ; preds = %145, %82
  ...
  br i1 %86, label %87, label %148, !dbg !160
...
87:                                               ; preds = %83
  ...
  br i1 %97, label %98, label %144, !dbg !171
...
98:                                               ; preds = %87
  ...
  br i1 %102, label %103, label %144, !dbg !175

103:                                              ; preds = %98
  call void @llvm.dbg.declare(metadata ptr %13, metadata !176, metadata !DIExpression()), !dbg !178
  %104 = load i64, ptr %4, align 8, !dbg !179
  %105 = load i64, ptr %12, align 8, !dbg !180
  %106 = sub nsw i64 %104, %105, !dbg !181
  store i64 %106, ptr %13, align 8, !dbg !178
  call void @llvm.dbg.declare(metadata ptr %14, metadata !182, metadata !DIExpression()), !dbg !183
  %107 = load i64, ptr %11, align 8, !dbg !184
  %108 = load i64, ptr %4, align 8, !dbg !185
  %109 = sub nsw i64 %107, %108, !dbg !186
  store i64 %109, ptr %14, align 8, !dbg !183
  %110 = load i64, ptr %13, align 8, !dbg !187
  %111 = load i64, ptr %14, align 8, !dbg !189
  %112 = icmp slt i64 %110, %111, !dbg !190
  br i1 %112, label %113, label %128, !dbg !191

113:                                              ; preds = %103
  %114 = load i64, ptr %4, align 8, !dbg !192
  %115 = getelementptr inbounds i64, ptr %19, i64 %114, !dbg !194
  %116 = load i64, ptr %115, align 8, !dbg !194
  %117 = load i64, ptr %14, align 8, !dbg !195
  %118 = mul nsw i64 %116, %117, !dbg !196
  %119 = load i64, ptr %5, align 8, !dbg !197
  %120 = add nsw i64 %119, %118, !dbg !197
  store i64 %120, ptr %5, align 8, !dbg !197
  %121 = load i64, ptr %4, align 8, !dbg !198
  %122 = getelementptr inbounds i64, ptr %19, i64 %121, !dbg !199
  %123 = load i64, ptr %122, align 8, !dbg !199
  %124 = load i64, ptr %11, align 8, !dbg !200
  %125 = getelementptr inbounds i64, ptr %27, i64 %124, !dbg !201
  store i64 %123, ptr %125, align 8, !dbg !202
  %126 = load i64, ptr %11, align 8, !dbg !203
  %127 = add nsw i64 %126, -1, !dbg !203
  store i64 %127, ptr %11, align 8, !dbg !203
  br label %143, !dbg !204

128:                                              ; preds = %103
  %129 = load i64, ptr %4, align 8, !dbg !205
  %130 = getelementptr inbounds i64, ptr %19, i64 %129, !dbg !207
  %131 = load i64, ptr %130, align 8, !dbg !207
  %132 = load i64, ptr %13, align 8, !dbg !208
  %133 = mul nsw i64 %131, %132, !dbg !209
  %134 = load i64, ptr %5, align 8, !dbg !210
  %135 = add nsw i64 %134, %133, !dbg !210
  store i64 %135, ptr %5, align 8, !dbg !210
  %136 = load i64, ptr %4, align 8, !dbg !211
  %137 = getelementptr inbounds i64, ptr %19, i64 %136, !dbg !212
  %138 = load i64, ptr %137, align 8, !dbg !212
  %139 = load i64, ptr %12, align 8, !dbg !213
  %140 = getelementptr inbounds i64, ptr %27, i64 %139, !dbg !214
  store i64 %138, ptr %140, align 8, !dbg !215
  %141 = load i64, ptr %12, align 8, !dbg !216
  %142 = add nsw i64 %141, 1, !dbg !216
  store i64 %142, ptr %12, align 8, !dbg !216
  br label %143

143:                                              ; preds = %128, %113
  br label %144, !dbg !217

144:                                              ; preds = %143, %98, %87
  br label %145, !dbg !218

145:                                              ; preds = %144
  %146 = load i64, ptr %4, align 8, !dbg !219
  %147 = add nsw i64 %146, 1, !dbg !219
  store i64 %147, ptr %4, align 8, !dbg !219
  br label %83, !dbg !220, !llvm.loop !221

148:                                              ; preds = %83
  br label %149, !dbg !223

149:                                              ; preds = %148
  %150 = load i64, ptr %3, align 8, !dbg !224
  %151 = add nsw i64 %150, 1, !dbg !224
  store i64 %151, ptr %3, align 8, !dbg !224
  br label %78, !dbg !225, !llvm.loop !226

152:                                              ; preds = %78
  %153 = load i64, ptr %5, align 8, !dbg !228
  %154 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %153), !dbg !229
  store i32 0, ptr %1, align 4, !dbg !230
  %155 = load ptr, ptr %6, align 8, !dbg !231
  call void @llvm.stackrestore.p0(ptr %155), !dbg !231
  %156 = load i32, ptr %1, align 4, !dbg !231
  ret i32 %156, !dbg !231
}
