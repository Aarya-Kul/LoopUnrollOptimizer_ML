...
13:                                               ; preds = %49, %0
  ...
  br i1 %15, label %16, label %52, !dbg !47
...
52:                                               ; preds = %13
  %53 = getelementptr inbounds [3 x i32], ptr %2, i64 0, i64 0, !dbg !81
  %54 = load i32, ptr %53, align 4, !dbg !81
  %55 = getelementptr inbounds [3 x i32], ptr %2, i64 0, i64 1, !dbg !82
  %56 = load i32, ptr %55, align 4, !dbg !82
  %57 = getelementptr inbounds [3 x i32], ptr %2, i64 0, i64 2, !dbg !83
  %58 = load i32, ptr %57, align 4, !dbg !83
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %54, i32 noundef %56, i32 noundef %58), !dbg !84
  ret i32 0, !dbg !85
}
