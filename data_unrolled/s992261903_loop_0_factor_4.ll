...
14:                                               ; preds = %189, %0
  ...
  br i1 %19, label %20, label %192, !dbg !68
...
33:                                               ; preds = %175, %153, %131, %109, %87, %65, %43, %20
  br label %192, !dbg !77
...
35:                                               ; preds = %34
  ...
  br i1 %42, label %43, label %192, !dbg !68
...
57:                                               ; preds = %56
  ...
  br i1 %64, label %65, label %192, !dbg !68
...
79:                                               ; preds = %78
  ...
  br i1 %86, label %87, label %192, !dbg !68
...
101:                                              ; preds = %100
  ...
  br i1 %108, label %109, label %192, !dbg !68
...
123:                                              ; preds = %122
  ...
  br i1 %130, label %131, label %192, !dbg !68
...
145:                                              ; preds = %144
  ...
  br i1 %152, label %153, label %192, !dbg !68
...
167:                                              ; preds = %166
  ...
  br i1 %174, label %175, label %192, !dbg !68
...
192:                                              ; preds = %167, %145, %123, %101, %79, %57, %35, %33, %14
  %193 = load i32, ptr %2, align 4, !dbg !84
  store i32 %193, ptr %3, align 4, !dbg !86
  br label %194, !dbg !87

194:                                              ; preds = %210, %192
  %195 = load i32, ptr %3, align 4, !dbg !88
  %196 = sext i32 %195 to i64, !dbg !88
  %197 = load ptr, ptr %6, align 8, !dbg !90
  %198 = call i64 @strlen(ptr noundef %197) #5, !dbg !91
  %199 = icmp ult i64 %196, %198, !dbg !92
  br i1 %199, label %200, label %213, !dbg !93

200:                                              ; preds = %194
  %201 = load ptr, ptr %6, align 8, !dbg !94
  %202 = load i32, ptr %3, align 4, !dbg !96
  %203 = sext i32 %202 to i64, !dbg !94
  %204 = getelementptr inbounds i8, ptr %201, i64 %203, !dbg !94
  %205 = load i8, ptr %204, align 1, !dbg !94
  %206 = load i32, ptr %5, align 4, !dbg !97
  %207 = add nsw i32 %206, 1, !dbg !97
  store i32 %207, ptr %5, align 4, !dbg !97
  %208 = sext i32 %206 to i64, !dbg !98
  %209 = getelementptr inbounds [100 x i8], ptr %8, i64 0, i64 %208, !dbg !98
  store i8 %205, ptr %209, align 1, !dbg !99
  br label %210, !dbg !100

210:                                              ; preds = %200
  %211 = load i32, ptr %3, align 4, !dbg !101
  %212 = add nsw i32 %211, 1, !dbg !101
  store i32 %212, ptr %3, align 4, !dbg !101
  br label %194, !dbg !102, !llvm.loop !103

213:                                              ; preds = %194
  %214 = load i32, ptr %2, align 4, !dbg !105
  store i32 %214, ptr %5, align 4, !dbg !106
  %215 = load ptr, ptr %6, align 8, !dbg !107
  %216 = call i64 @strlen(ptr noundef %215) #5, !dbg !109
  %217 = load i32, ptr %2, align 4, !dbg !110
  %218 = sext i32 %217 to i64, !dbg !110
  %219 = sub i64 %216, %218, !dbg !111
  %220 = trunc i64 %219 to i32, !dbg !109
  store i32 %220, ptr %3, align 4, !dbg !112
  br label %221, !dbg !113

221:                                              ; preds = %243, %213
  %222 = load i32, ptr %3, align 4, !dbg !114
  %223 = icmp sge i32 %222, 1, !dbg !116
  br i1 %223, label %224, label %246, !dbg !117

224:                                              ; preds = %221
  %225 = load i32, ptr %4, align 4, !dbg !118
  %226 = load i32, ptr %3, align 4, !dbg !121
  %227 = sub nsw i32 %225, %226, !dbg !122
  %228 = sext i32 %227 to i64, !dbg !123
  %229 = getelementptr inbounds [100 x i8], ptr %7, i64 0, i64 %228, !dbg !123
  %230 = load i8, ptr %229, align 1, !dbg !123
  %231 = sext i8 %230 to i32, !dbg !123
  %232 = load ptr, ptr %6, align 8, !dbg !124
  %233 = load i32, ptr %5, align 4, !dbg !125
  %234 = add nsw i32 %233, 1, !dbg !125
  store i32 %234, ptr %5, align 4, !dbg !125
  %235 = sext i32 %233 to i64, !dbg !124
  %236 = getelementptr inbounds i8, ptr %232, i64 %235, !dbg !124
  %237 = load i8, ptr %236, align 1, !dbg !124
  %238 = sext i8 %237 to i32, !dbg !124
  %239 = icmp ne i32 %231, %238, !dbg !126
  br i1 %239, label %240, label %242, !dbg !127

240:                                              ; preds = %224
  %241 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !128
  store i32 0, ptr %1, align 4, !dbg !130
  br label %248, !dbg !130

242:                                              ; preds = %224
  br label %243, !dbg !131

243:                                              ; preds = %242
  %244 = load i32, ptr %3, align 4, !dbg !132
  %245 = add nsw i32 %244, -1, !dbg !132
  store i32 %245, ptr %3, align 4, !dbg !132
  br label %221, !dbg !133, !llvm.loop !134

246:                                              ; preds = %221
  %247 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %248, !dbg !137

248:                                              ; preds = %246, %240
  %249 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %249, !dbg !138
}
