...
20:                                               ; preds = %98, %0
  ...
  br i1 %23, label %24, label %101, !dbg !89
...
58:                                               ; preds = %57
  ...
  br i1 %63, label %64, label %101, !dbg !89
...
101:                                              ; preds = %58, %20
  %102 = load i32, ptr %13, align 4, !dbg !140
  %103 = icmp ne i32 %102, 0, !dbg !140
  br i1 %103, label %104, label %106, !dbg !142

104:                                              ; preds = %101
  %105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !143
  store i32 0, ptr %1, align 4, !dbg !145
  br label %208, !dbg !145

106:                                              ; preds = %101
  %107 = load i32, ptr %16, align 4, !dbg !146
  %108 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %107), !dbg !147
  store i32 0, ptr %14, align 4, !dbg !148
  br label %109, !dbg !150

109:                                              ; preds = %115, %106
  %110 = load i32, ptr %14, align 4, !dbg !151
  %111 = load i32, ptr %16, align 4, !dbg !153
  %112 = icmp slt i32 %110, %111, !dbg !154
  br i1 %112, label %113, label %118, !dbg !155

113:                                              ; preds = %109
  %114 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !156
  br label %115, !dbg !158

115:                                              ; preds = %113
  %116 = load i32, ptr %14, align 4, !dbg !159
  %117 = add nsw i32 %116, 1, !dbg !159
  store i32 %117, ptr %14, align 4, !dbg !159
  br label %109, !dbg !160, !llvm.loop !161

118:                                              ; preds = %109
  %119 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !163
  store i32 0, ptr %14, align 4, !dbg !164
  br label %120, !dbg !166

120:                                              ; preds = %205, %118
  %121 = load i32, ptr %14, align 4, !dbg !167
  %122 = load i32, ptr %2, align 4, !dbg !169
  %123 = icmp slt i32 %121, %122, !dbg !170
  br i1 %123, label %124, label %208, !dbg !171

124:                                              ; preds = %120
  store i32 0, ptr %5, align 4, !dbg !172
  store i32 0, ptr %6, align 4, !dbg !174
  %125 = load i32, ptr %16, align 4, !dbg !175
  store i32 %125, ptr %17, align 4, !dbg !176
  %126 = load i32, ptr %14, align 4, !dbg !177
  %127 = sext i32 %126 to i64, !dbg !178
  %128 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %127, !dbg !178
  %129 = load i32, ptr %128, align 4, !dbg !178
  %130 = icmp sgt i32 %129, 0, !dbg !179
  %131 = zext i1 %130 to i32, !dbg !179
  store i32 %131, ptr %10, align 4, !dbg !180
  %132 = load i32, ptr %10, align 4, !dbg !181
  %133 = icmp ne i32 %132, 0, !dbg !181
  %134 = zext i1 %133 to i64, !dbg !181
  %135 = select i1 %133, i32 82, i32 76, !dbg !181
  %136 = trunc i32 %135 to i8, !dbg !181
  store i8 %136, ptr %18, align 1, !dbg !182
  %137 = load i32, ptr %14, align 4, !dbg !183
  %138 = sext i32 %137 to i64, !dbg !184
  %139 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %138, !dbg !184
  %140 = load i32, ptr %139, align 4, !dbg !184
  %141 = call i32 @llvm.abs.i32(i32 %140, i1 true), !dbg !185
  store i32 %141, ptr %7, align 4, !dbg !186
  store i32 0, ptr %15, align 4, !dbg !187
  br label %142, !dbg !189

142:                                              ; preds = %152, %124
  %143 = load i32, ptr %15, align 4, !dbg !190
  %144 = load i32, ptr %7, align 4, !dbg !192
  %145 = icmp slt i32 %143, %144, !dbg !193
  br i1 %145, label %146, label %155, !dbg !194

146:                                              ; preds = %142
  %147 = load i32, ptr %17, align 4, !dbg !195
  %148 = add nsw i32 %147, -1, !dbg !195
  store i32 %148, ptr %17, align 4, !dbg !195
  %149 = load i8, ptr %18, align 1, !dbg !197
  %150 = sext i8 %149 to i32, !dbg !197
  %151 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %150), !dbg !198
  br label %152, !dbg !199

152:                                              ; preds = %146
  %153 = load i32, ptr %15, align 4, !dbg !200
  %154 = add nsw i32 %153, 1, !dbg !200
  store i32 %154, ptr %15, align 4, !dbg !200
  br label %142, !dbg !201, !llvm.loop !202

155:                                              ; preds = %142
  %156 = load i32, ptr %14, align 4, !dbg !204
  %157 = sext i32 %156 to i64, !dbg !205
  %158 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %157, !dbg !205
  %159 = load i32, ptr %158, align 4, !dbg !205
  %160 = icmp sgt i32 %159, 0, !dbg !206
  %161 = zext i1 %160 to i32, !dbg !206
  store i32 %161, ptr %10, align 4, !dbg !207
  %162 = load i32, ptr %10, align 4, !dbg !208
  %163 = icmp ne i32 %162, 0, !dbg !208
  %164 = zext i1 %163 to i64, !dbg !208
  %165 = select i1 %163, i32 85, i32 68, !dbg !208
  %166 = trunc i32 %165 to i8, !dbg !208
  store i8 %166, ptr %18, align 1, !dbg !209
  %167 = load i32, ptr %14, align 4, !dbg !210
  %168 = sext i32 %167 to i64, !dbg !211
  %169 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %168, !dbg !211
  %170 = load i32, ptr %169, align 4, !dbg !211
  %171 = call i32 @llvm.abs.i32(i32 %170, i1 true), !dbg !212
  store i32 %171, ptr %8, align 4, !dbg !213
  store i32 0, ptr %15, align 4, !dbg !214
  br label %172, !dbg !216

172:                                              ; preds = %182, %155
  %173 = load i32, ptr %15, align 4, !dbg !217
  %174 = load i32, ptr %8, align 4, !dbg !219
  %175 = icmp slt i32 %173, %174, !dbg !220
  br i1 %175, label %176, label %185, !dbg !221

176:                                              ; preds = %172
  %177 = load i32, ptr %17, align 4, !dbg !222
  %178 = add nsw i32 %177, -1, !dbg !222
  store i32 %178, ptr %17, align 4, !dbg !222
  %179 = load i8, ptr %18, align 1, !dbg !224
  %180 = sext i8 %179 to i32, !dbg !224
  %181 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %180), !dbg !225
  br label %182, !dbg !226

182:                                              ; preds = %176
  %183 = load i32, ptr %15, align 4, !dbg !227
  %184 = add nsw i32 %183, 1, !dbg !227
  store i32 %184, ptr %15, align 4, !dbg !227
  br label %172, !dbg !228, !llvm.loop !229

185:                                              ; preds = %172
  store i32 0, ptr %15, align 4, !dbg !231
  br label %186, !dbg !233

186:                                              ; preds = %200, %185
  %187 = load i32, ptr %15, align 4, !dbg !234
  %188 = load i32, ptr %17, align 4, !dbg !236
  %189 = icmp slt i32 %187, %188, !dbg !237
  br i1 %189, label %190, label %203, !dbg !238

190:                                              ; preds = %186
  %191 = load i8, ptr %18, align 1, !dbg !239
  %192 = sext i8 %191 to i32, !dbg !239
  %193 = icmp eq i32 %192, 85, !dbg !241
  %194 = zext i1 %193 to i64, !dbg !239
  %195 = select i1 %193, i32 68, i32 85, !dbg !239
  %196 = trunc i32 %195 to i8, !dbg !239
  store i8 %196, ptr %18, align 1, !dbg !242
  %197 = load i8, ptr %18, align 1, !dbg !243
  %198 = sext i8 %197 to i32, !dbg !243
  %199 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %198), !dbg !244
  br label %200, !dbg !245

200:                                              ; preds = %190
  %201 = load i32, ptr %15, align 4, !dbg !246
  %202 = add nsw i32 %201, 1, !dbg !246
  store i32 %202, ptr %15, align 4, !dbg !246
  br label %186, !dbg !247, !llvm.loop !248

203:                                              ; preds = %186
  %204 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !250
  br label %205, !dbg !251

205:                                              ; preds = %203
  %206 = load i32, ptr %14, align 4, !dbg !252
  %207 = add nsw i32 %206, 1, !dbg !252
  store i32 %207, ptr %14, align 4, !dbg !252
  br label %120, !dbg !253, !llvm.loop !254

208:                                              ; preds = %120, %104
  %209 = load i32, ptr %1, align 4, !dbg !256
  ret i32 %209, !dbg !256
}
