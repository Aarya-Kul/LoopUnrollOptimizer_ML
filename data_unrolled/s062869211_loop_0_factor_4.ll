...
17:                                               ; preds = %175, %0
  ...
  br i1 %19, label %20, label %178, !dbg !55
...
35:                                               ; preds = %20
  ...
  br i1 %39, label %40, label %178, !dbg !55
...
55:                                               ; preds = %40
  ...
  br i1 %59, label %60, label %178, !dbg !55
...
75:                                               ; preds = %60
  ...
  br i1 %79, label %80, label %178, !dbg !55
...
95:                                               ; preds = %80
  ...
  br i1 %99, label %100, label %178, !dbg !55
...
115:                                              ; preds = %100
  ...
  br i1 %119, label %120, label %178, !dbg !55
...
135:                                              ; preds = %120
  ...
  br i1 %139, label %140, label %178, !dbg !55
...
155:                                              ; preds = %140
  ...
  br i1 %159, label %160, label %178, !dbg !55
...
178:                                              ; preds = %155, %135, %115, %95, %75, %55, %35, %17
  %179 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %2), !dbg !77
  store i32 0, ptr %3, align 4, !dbg !78
  br label %180, !dbg !80

180:                                              ; preds = %197, %178
  %181 = load i32, ptr %3, align 4, !dbg !81
  %182 = load i32, ptr %2, align 4, !dbg !83
  %183 = sdiv i32 %182, 2, !dbg !84
  %184 = icmp slt i32 %181, %183, !dbg !85
  br i1 %184, label %185, label %200, !dbg !86

185:                                              ; preds = %180
  %186 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.1, ptr noundef %7, ptr noundef %8), !dbg !87
  %187 = load i32, ptr %7, align 4, !dbg !89
  %188 = sext i32 %187 to i64, !dbg !90
  %189 = getelementptr inbounds [100001 x i32], ptr %4, i64 0, i64 %188, !dbg !90
  %190 = load i32, ptr %189, align 4, !dbg !91
  %191 = add nsw i32 %190, 1, !dbg !91
  store i32 %191, ptr %189, align 4, !dbg !91
  %192 = load i32, ptr %8, align 4, !dbg !92
  %193 = sext i32 %192 to i64, !dbg !93
  %194 = getelementptr inbounds [100001 x i32], ptr %5, i64 0, i64 %193, !dbg !93
  %195 = load i32, ptr %194, align 4, !dbg !94
  %196 = add nsw i32 %195, 1, !dbg !94
  store i32 %196, ptr %194, align 4, !dbg !94
  br label %197, !dbg !95

197:                                              ; preds = %185
  %198 = load i32, ptr %3, align 4, !dbg !96
  %199 = add nsw i32 %198, 1, !dbg !96
  store i32 %199, ptr %3, align 4, !dbg !96
  br label %180, !dbg !97, !llvm.loop !98
...
200:                                              ; preds = %180
  ...
  br label %201, !dbg !126

201:                                              ; preds = %263, %200
  %202 = load i32, ptr %3, align 4, !dbg !127
  %203 = icmp slt i32 %202, 100001, !dbg !129
  br i1 %203, label %204, label %266, !dbg !130

204:                                              ; preds = %201
  %205 = load i32, ptr %14, align 4, !dbg !131
  %206 = load i32, ptr %3, align 4, !dbg !134
  %207 = sext i32 %206 to i64, !dbg !135
  %208 = getelementptr inbounds [100001 x i32], ptr %4, i64 0, i64 %207, !dbg !135
  %209 = load i32, ptr %208, align 4, !dbg !135
  %210 = icmp slt i32 %205, %209, !dbg !136
  br i1 %210, label %211, label %219, !dbg !137

211:                                              ; preds = %204
  %212 = load i32, ptr %14, align 4, !dbg !138
  store i32 %212, ptr %16, align 4, !dbg !140
  %213 = load i32, ptr %11, align 4, !dbg !141
  store i32 %213, ptr %12, align 4, !dbg !142
  %214 = load i32, ptr %3, align 4, !dbg !143
  %215 = sext i32 %214 to i64, !dbg !144
  %216 = getelementptr inbounds [100001 x i32], ptr %4, i64 0, i64 %215, !dbg !144
  %217 = load i32, ptr %216, align 4, !dbg !144
  store i32 %217, ptr %14, align 4, !dbg !145
  %218 = load i32, ptr %3, align 4, !dbg !146
  store i32 %218, ptr %11, align 4, !dbg !147
  br label %233, !dbg !148

219:                                              ; preds = %204
  %220 = load i32, ptr %16, align 4, !dbg !149
  %221 = load i32, ptr %3, align 4, !dbg !151
  %222 = sext i32 %221 to i64, !dbg !152
  %223 = getelementptr inbounds [100001 x i32], ptr %4, i64 0, i64 %222, !dbg !152
  %224 = load i32, ptr %223, align 4, !dbg !152
  %225 = icmp slt i32 %220, %224, !dbg !153
  br i1 %225, label %226, label %232, !dbg !154

226:                                              ; preds = %219
  %227 = load i32, ptr %3, align 4, !dbg !155
  %228 = sext i32 %227 to i64, !dbg !157
  %229 = getelementptr inbounds [100001 x i32], ptr %4, i64 0, i64 %228, !dbg !157
  %230 = load i32, ptr %229, align 4, !dbg !157
  store i32 %230, ptr %16, align 4, !dbg !158
  %231 = load i32, ptr %3, align 4, !dbg !159
  store i32 %231, ptr %12, align 4, !dbg !160
  br label %232, !dbg !161

232:                                              ; preds = %226, %219
  br label %233

233:                                              ; preds = %232, %211
  %234 = load i32, ptr %13, align 4, !dbg !162
  %235 = load i32, ptr %3, align 4, !dbg !164
  %236 = sext i32 %235 to i64, !dbg !165
  %237 = getelementptr inbounds [100001 x i32], ptr %5, i64 0, i64 %236, !dbg !165
  %238 = load i32, ptr %237, align 4, !dbg !165
  %239 = icmp slt i32 %234, %238, !dbg !166
  br i1 %239, label %240, label %248, !dbg !167

240:                                              ; preds = %233
  %241 = load i32, ptr %13, align 4, !dbg !168
  store i32 %241, ptr %15, align 4, !dbg !170
  %242 = load i32, ptr %9, align 4, !dbg !171
  store i32 %242, ptr %10, align 4, !dbg !172
  %243 = load i32, ptr %3, align 4, !dbg !173
  %244 = sext i32 %243 to i64, !dbg !174
  %245 = getelementptr inbounds [100001 x i32], ptr %5, i64 0, i64 %244, !dbg !174
  %246 = load i32, ptr %245, align 4, !dbg !174
  store i32 %246, ptr %13, align 4, !dbg !175
  %247 = load i32, ptr %3, align 4, !dbg !176
  store i32 %247, ptr %9, align 4, !dbg !177
  br label %262, !dbg !178

248:                                              ; preds = %233
  %249 = load i32, ptr %15, align 4, !dbg !179
  %250 = load i32, ptr %3, align 4, !dbg !181
  %251 = sext i32 %250 to i64, !dbg !182
  %252 = getelementptr inbounds [100001 x i32], ptr %5, i64 0, i64 %251, !dbg !182
  %253 = load i32, ptr %252, align 4, !dbg !182
  %254 = icmp slt i32 %249, %253, !dbg !183
  br i1 %254, label %255, label %261, !dbg !184

255:                                              ; preds = %248
  %256 = load i32, ptr %3, align 4, !dbg !185
  %257 = sext i32 %256 to i64, !dbg !187
  %258 = getelementptr inbounds [100001 x i32], ptr %5, i64 0, i64 %257, !dbg !187
  %259 = load i32, ptr %258, align 4, !dbg !187
  store i32 %259, ptr %15, align 4, !dbg !188
  %260 = load i32, ptr %3, align 4, !dbg !189
  store i32 %260, ptr %10, align 4, !dbg !190
  br label %261, !dbg !191

261:                                              ; preds = %255, %248
  br label %262

262:                                              ; preds = %261, %240
  br label %263, !dbg !192

263:                                              ; preds = %262
  %264 = load i32, ptr %3, align 4, !dbg !193
  %265 = add nsw i32 %264, 1, !dbg !193
  store i32 %265, ptr %3, align 4, !dbg !193
  br label %201, !dbg !194, !llvm.loop !195

266:                                              ; preds = %201
  store i32 0, ptr %6, align 4, !dbg !197
  %267 = load i32, ptr %11, align 4, !dbg !198
  %268 = load i32, ptr %9, align 4, !dbg !200
  %269 = icmp ne i32 %267, %268, !dbg !201
  br i1 %269, label %270, label %276, !dbg !202

270:                                              ; preds = %266
  %271 = load i32, ptr %2, align 4, !dbg !203
  %272 = load i32, ptr %14, align 4, !dbg !204
  %273 = sub nsw i32 %271, %272, !dbg !205
  %274 = load i32, ptr %13, align 4, !dbg !206
  %275 = sub nsw i32 %273, %274, !dbg !207
  store i32 %275, ptr %6, align 4, !dbg !208
  br label %297, !dbg !209

276:                                              ; preds = %266
  %277 = load i32, ptr %14, align 4, !dbg !210
  %278 = load i32, ptr %15, align 4, !dbg !212
  %279 = add nsw i32 %277, %278, !dbg !213
  %280 = load i32, ptr %16, align 4, !dbg !214
  %281 = load i32, ptr %13, align 4, !dbg !215
  %282 = add nsw i32 %280, %281, !dbg !216
  %283 = icmp sgt i32 %279, %282, !dbg !217
  br i1 %283, label %284, label %290, !dbg !218

284:                                              ; preds = %276
  %285 = load i32, ptr %2, align 4, !dbg !219
  %286 = load i32, ptr %14, align 4, !dbg !220
  %287 = sub nsw i32 %285, %286, !dbg !221
  %288 = load i32, ptr %15, align 4, !dbg !222
  %289 = sub nsw i32 %287, %288, !dbg !223
  store i32 %289, ptr %6, align 4, !dbg !224
  br label %296, !dbg !225

290:                                              ; preds = %276
  %291 = load i32, ptr %2, align 4, !dbg !226
  %292 = load i32, ptr %16, align 4, !dbg !227
  %293 = sub nsw i32 %291, %292, !dbg !228
  %294 = load i32, ptr %13, align 4, !dbg !229
  %295 = sub nsw i32 %293, %294, !dbg !230
  store i32 %295, ptr %6, align 4, !dbg !231
  br label %296
...
297:                                              ; preds = %296, %270
  %298 = load i32, ptr %6, align 4, !dbg !232
  %299 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %298), !dbg !233
  ret i32 0, !dbg !234
}
