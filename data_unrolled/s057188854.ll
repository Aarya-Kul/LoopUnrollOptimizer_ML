...
9:                                                ; preds = %196, %0
  ...
  br i1 %15, label %16, label %197, !dbg !47
...
197:                                              ; preds = %195, %189, %164, %139, %114, %89, %64, %39, %9
  %198 = load i8, ptr %3, align 1, !dbg !256
  %199 = sext i8 %198 to i32, !dbg !256
  %200 = icmp sle i32 %199, 1, !dbg !258
  br i1 %200, label %201, label %207, !dbg !259

201:                                              ; preds = %197
  %202 = load i8, ptr %5, align 1, !dbg !260
  %203 = sext i8 %202 to i32, !dbg !260
  %204 = icmp eq i32 %203, 7, !dbg !261
  br i1 %204, label %205, label %207, !dbg !262

205:                                              ; preds = %201
  %206 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !263
  br label %209, !dbg !263

207:                                              ; preds = %201, %197
  %208 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !264
  br label %209
