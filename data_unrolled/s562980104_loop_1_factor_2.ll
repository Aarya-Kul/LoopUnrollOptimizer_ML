...
4254:                                             ; preds = %4245
  ...
  br i1 %4259, label %4260, label %4272, !dbg !68
...
4272:                                             ; preds = %4254, %4241
  %4273 = load i32, ptr %7, align 4, !dbg !82
  %4274 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4273), !dbg !83
  %4275 = load ptr, ptr %3, align 8, !dbg !84
  call void @llvm.stackrestore.p0(ptr %4275), !dbg !84
  %4276 = load i32, ptr %1, align 4, !dbg !84
  ret i32 %4276, !dbg !84
}
