...
50:                                               ; preds = %44, %10
  ...
  br i1 %54, label %55, label %60, !dbg !98

55:                                               ; preds = %50
  %56 = load i32, ptr %3, align 4, !dbg !99
  %57 = icmp ne i32 %56, 2, !dbg !100
  br i1 %57, label %58, label %60, !dbg !101

58:                                               ; preds = %55
  %59 = call i32 @puts(ptr noundef @.str.1), !dbg !102
  br label %62, !dbg !104

60:                                               ; preds = %55, %50
  %61 = call i32 @puts(ptr noundef @.str.2), !dbg !105
  br label %62
...
!98 = !DILocation(line: 27, column: 23, scope: !94)
!99 = !DILocation(line: 27, column: 25, scope: !94)
!100 = !DILocation(line: 27, column: 28, scope: !94)
!101 = !DILocation(line: 27, column: 8, scope: !24)
!102 = !DILocation(line: 29, column: 9, scope: !103)
!103 = distinct !DILexicalBlock(scope: !94, file: !2, line: 28, column: 5)
!104 = !DILocation(line: 30, column: 5, scope: !103)
!105 = !DILocation(line: 31, column: 9, scope: !106)
!106 = distinct !DILexicalBlock(scope: !94, file: !2, line: 30, column: 10)
!107 = !DILocation(line: 33, column: 5, scope: !24)
