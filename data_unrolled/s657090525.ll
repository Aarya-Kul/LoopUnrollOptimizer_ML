...
15:                                               ; preds = %67, %0
  ...
  br i1 %18, label %19, label %70, !dbg !56
...
21:                                               ; preds = %63, %19
  ...
  br i1 %24, label %25, label %66, !dbg !67
...
52:                                               ; preds = %26
  ...
  %56 = getelementptr inbounds [101 x i8], ptr %7, i64 0, i64 0, !dbg !108
  %57 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 0, !dbg !110
  %58 = call i32 @strcmp(ptr noundef %56, ptr noundef %57) #5, !dbg !111
  %59 = icmp eq i32 %58, 0, !dbg !112
  br i1 %59, label %60, label %62, !dbg !113

60:                                               ; preds = %52
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !114
...
63:                                               ; preds = %62
  %64 = load i32, ptr %6, align 4, !dbg !118
  %65 = add nsw i32 %64, 1, !dbg !118
  store i32 %65, ptr %6, align 4, !dbg !118
  br label %21, !dbg !119, !llvm.loop !120

66:                                               ; preds = %21
  br label %67, !dbg !122

67:                                               ; preds = %66
  %68 = load i32, ptr %5, align 4, !dbg !123
  %69 = add nsw i32 %68, 1, !dbg !123
  store i32 %69, ptr %5, align 4, !dbg !123
  br label %15, !dbg !124, !llvm.loop !125

70:                                               ; preds = %15
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !127
  store i32 0, ptr %1, align 4, !dbg !128
  br label %72, !dbg !128

72:                                               ; preds = %70, %60
  %73 = load i32, ptr %1, align 4, !dbg !129
  ret i32 %73, !dbg !129
}
...
!108 = !DILocation(line: 20, column: 14, scope: !109)
!109 = distinct !DILexicalBlock(scope: !69, file: !2, line: 20, column: 7)
!110 = !DILocation(line: 20, column: 16, scope: !109)
!111 = !DILocation(line: 20, column: 7, scope: !109)
!112 = !DILocation(line: 20, column: 20, scope: !109)
!113 = !DILocation(line: 20, column: 7, scope: !69)
!114 = !DILocation(line: 21, column: 5, scope: !115)
!115 = distinct !DILexicalBlock(scope: !109, file: !2, line: 20, column: 24)
!116 = !DILocation(line: 22, column: 5, scope: !115)
!117 = !DILocation(line: 24, column: 3, scope: !69)
!118 = !DILocation(line: 11, column: 20, scope: !64)
!119 = !DILocation(line: 11, column: 3, scope: !64)
!120 = distinct !{!120, !67, !121, !104}
!121 = !DILocation(line: 24, column: 3, scope: !58)
!122 = !DILocation(line: 25, column: 2, scope: !59)
!123 = !DILocation(line: 10, column: 19, scope: !53)
!124 = !DILocation(line: 10, column: 2, scope: !53)
!125 = distinct !{!125, !56, !126, !104}
!126 = !DILocation(line: 25, column: 2, scope: !49)
!127 = !DILocation(line: 27, column: 2, scope: !27)
!128 = !DILocation(line: 28, column: 2, scope: !27)
!129 = !DILocation(line: 29, column: 1, scope: !27)
