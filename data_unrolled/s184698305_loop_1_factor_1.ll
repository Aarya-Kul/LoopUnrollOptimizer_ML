...
4644:                                             ; preds = %4616
  ...
  br label %4645, !dbg !82

4645:                                             ; preds = %4654, %4644
  %4646 = load i32, ptr %3, align 4, !dbg !83
  %4647 = icmp slt i32 %4646, 3, !dbg !85
  br i1 %4647, label %4648, label %4657, !dbg !86

4648:                                             ; preds = %4645
  %4649 = load i32, ptr %3, align 4, !dbg !87
  %4650 = sext i32 %4649 to i64, !dbg !89
  %4651 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %4650, !dbg !89
  %4652 = load i32, ptr %4651, align 4, !dbg !89
  %4653 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4652), !dbg !90
  br label %4654, !dbg !91

4654:                                             ; preds = %4648
  %4655 = load i32, ptr %3, align 4, !dbg !92
  %4656 = add nsw i32 %4655, 1, !dbg !92
  store i32 %4656, ptr %3, align 4, !dbg !92
  br label %4645, !dbg !93, !llvm.loop !94

4657:                                             ; preds = %4645
  %4658 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !96
  ret i32 0, !dbg !97
}
