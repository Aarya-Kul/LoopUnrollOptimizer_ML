...
3:                                                ; preds = %17, %0
  ...
  br i1 %6, label %7, label %20, !dbg !199

7:                                                ; preds = %3
  %8 = load i64, ptr @i, align 8, !dbg !200
  %9 = getelementptr inbounds [2048 x %struct.child], ptr @a, i64 0, i64 %8, !dbg !202
  %10 = getelementptr inbounds %struct.child, ptr %9, i32 0, i32 0, !dbg !203
  %11 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %10), !dbg !204
  %12 = load i64, ptr @i, align 8, !dbg !205
  %13 = add nsw i64 %12, 1, !dbg !206
  %14 = load i64, ptr @i, align 8, !dbg !207
  %15 = getelementptr inbounds [2048 x %struct.child], ptr @a, i64 0, i64 %14, !dbg !208
  %16 = getelementptr inbounds %struct.child, ptr %15, i32 0, i32 1, !dbg !209
  store i64 %13, ptr %16, align 8, !dbg !210
  br label %17, !dbg !211

17:                                               ; preds = %7
  %18 = load i64, ptr @i, align 8, !dbg !212
  %19 = add nsw i64 %18, 1, !dbg !212
  store i64 %19, ptr @i, align 8, !dbg !212
...
21:                                               ; preds = %37, %20
  %22 = load i64, ptr @i, align 8, !dbg !220
  %23 = icmp slt i64 %22, 2048, !dbg !222
  br i1 %23, label %24, label %40, !dbg !223

24:                                               ; preds = %21
  store i64 0, ptr @j, align 8, !dbg !224
  br label %25, !dbg !226

25:                                               ; preds = %33, %24
  %26 = load i64, ptr @j, align 8, !dbg !227
  %27 = icmp slt i64 %26, 2048, !dbg !229
  br i1 %27, label %28, label %36, !dbg !230

28:                                               ; preds = %25
  %29 = load i64, ptr @i, align 8, !dbg !231
  %30 = getelementptr inbounds [2048 x [2048 x i64]], ptr @dp, i64 0, i64 %29, !dbg !232
  %31 = load i64, ptr @j, align 8, !dbg !233
  %32 = getelementptr inbounds [2048 x i64], ptr %30, i64 0, i64 %31, !dbg !232
  store i64 -1, ptr %32, align 8, !dbg !234
  br label %33, !dbg !232

33:                                               ; preds = %28
  %34 = load i64, ptr @j, align 8, !dbg !235
  %35 = add nsw i64 %34, 1, !dbg !235
  store i64 %35, ptr @j, align 8, !dbg !235
  br label %25, !dbg !236, !llvm.loop !237

36:                                               ; preds = %25
  br label %37, !dbg !238

37:                                               ; preds = %36
  %38 = load i64, ptr @i, align 8, !dbg !239
  %39 = add nsw i64 %38, 1, !dbg !239
  store i64 %39, ptr @i, align 8, !dbg !239
  br label %21, !dbg !240, !llvm.loop !241

40:                                               ; preds = %21
  %41 = load i64, ptr @n, align 8, !dbg !243
  call void @qsort(ptr noundef @a, i64 noundef %41, i64 noundef 16, ptr noundef @cmp), !dbg !244
  %42 = load i64, ptr @n, align 8, !dbg !245
  %43 = call i64 @search(i64 noundef 1, i64 noundef %42), !dbg !246
  %44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %43), !dbg !247
  ret i32 0, !dbg !248
}
...
!204 = !DILocation(line: 27, column: 9, scope: !201)
!205 = !DILocation(line: 28, column: 18, scope: !201)
!206 = !DILocation(line: 28, column: 20, scope: !201)
!207 = !DILocation(line: 28, column: 11, scope: !201)
!208 = !DILocation(line: 28, column: 9, scope: !201)
!209 = !DILocation(line: 28, column: 14, scope: !201)
!210 = !DILocation(line: 28, column: 16, scope: !201)
!211 = !DILocation(line: 29, column: 5, scope: !201)
!212 = !DILocation(line: 26, column: 24, scope: !196)
!213 = !DILocation(line: 26, column: 5, scope: !196)
!214 = distinct !{!214, !199, !215, !216}
!215 = !DILocation(line: 29, column: 5, scope: !193)
!216 = !{!"llvm.loop.mustprogress"}
!217 = !DILocation(line: 30, column: 11, scope: !218)
!218 = distinct !DILexicalBlock(scope: !188, file: !3, line: 30, column: 5)
!219 = !DILocation(line: 30, column: 9, scope: !218)
!220 = !DILocation(line: 30, column: 16, scope: !221)
!221 = distinct !DILexicalBlock(scope: !218, file: !3, line: 30, column: 5)
!222 = !DILocation(line: 30, column: 18, scope: !221)
!223 = !DILocation(line: 30, column: 5, scope: !218)
!224 = !DILocation(line: 31, column: 15, scope: !225)
!225 = distinct !DILexicalBlock(scope: !221, file: !3, line: 31, column: 9)
!226 = !DILocation(line: 31, column: 13, scope: !225)
!227 = !DILocation(line: 31, column: 20, scope: !228)
!228 = distinct !DILexicalBlock(scope: !225, file: !3, line: 31, column: 9)
!229 = !DILocation(line: 31, column: 22, scope: !228)
!230 = !DILocation(line: 31, column: 9, scope: !225)
!231 = !DILocation(line: 32, column: 16, scope: !228)
!232 = !DILocation(line: 32, column: 13, scope: !228)
!233 = !DILocation(line: 32, column: 19, scope: !228)
!234 = !DILocation(line: 32, column: 22, scope: !228)
!235 = !DILocation(line: 31, column: 30, scope: !228)
!236 = !DILocation(line: 31, column: 9, scope: !228)
!237 = distinct !{!237, !230, !238, !216}
!238 = !DILocation(line: 32, column: 25, scope: !225)
!239 = !DILocation(line: 30, column: 27, scope: !221)
!240 = !DILocation(line: 30, column: 5, scope: !221)
!241 = distinct !{!241, !223, !242, !216}
!242 = !DILocation(line: 32, column: 25, scope: !218)
!243 = !DILocation(line: 33, column: 13, scope: !188)
!244 = !DILocation(line: 33, column: 5, scope: !188)
!245 = !DILocation(line: 34, column: 31, scope: !188)
!246 = !DILocation(line: 34, column: 21, scope: !188)
!247 = !DILocation(line: 34, column: 5, scope: !188)
!248 = !DILocation(line: 35, column: 5, scope: !188)
