...
141:                                              ; preds = %137
  ...
  %151 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !237
  %152 = fptosi double %151 to i64, !dbg !238
  %153 = add nsw i64 %150, %152, !dbg !239
  %154 = sub nsw i64 %153, 1, !dbg !240
  %155 = sdiv i64 %154, 2, !dbg !241
  ...
  %165 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !248
  %166 = fptosi double %165 to i64, !dbg !249
  %167 = add nsw i64 %164, %166, !dbg !250
  %168 = sub nsw i64 %167, 1, !dbg !251
  %169 = sdiv i64 %168, 2, !dbg !252
