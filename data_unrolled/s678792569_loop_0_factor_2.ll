...
23:                                               ; preds = %15, %7
  ...
  br i1 %24, label %25, label %110, !dbg !51
...
75:                                               ; preds = %67, %57
  ...
  br i1 %76, label %77, label %110, !dbg !51
...
110:                                              ; preds = %75, %23
  %111 = load ptr, ptr %4, align 8, !dbg !75
  %112 = load i32, ptr %6, align 4, !dbg !77
  %113 = sext i32 %112 to i64, !dbg !75
  %114 = getelementptr inbounds i8, ptr %111, i64 %113, !dbg !75
  %115 = load i8, ptr %114, align 1, !dbg !75
  %116 = sext i8 %115 to i32, !dbg !75
  %117 = load ptr, ptr %5, align 8, !dbg !78
  %118 = load i32, ptr %6, align 4, !dbg !79
  %119 = sext i32 %118 to i64, !dbg !78
  %120 = getelementptr inbounds i8, ptr %117, i64 %119, !dbg !78
  %121 = load i8, ptr %120, align 1, !dbg !78
  %122 = sext i8 %121 to i32, !dbg !78
  %123 = icmp eq i32 %116, %122, !dbg !80
  br i1 %123, label %124, label %125, !dbg !81
...
125:                                              ; preds = %110
  %126 = load ptr, ptr %4, align 8, !dbg !83
  %127 = load i32, ptr %6, align 4, !dbg !85
  %128 = sext i32 %127 to i64, !dbg !83
  %129 = getelementptr inbounds i8, ptr %126, i64 %128, !dbg !83
  %130 = load i8, ptr %129, align 1, !dbg !83
  %131 = sext i8 %130 to i32, !dbg !83
  %132 = icmp eq i32 %131, 0, !dbg !86
  br i1 %132, label %133, label %134, !dbg !87
...
135:                                              ; preds = %134, %133, %124, %54, %39
  %136 = load i32, ptr %3, align 4, !dbg !90
  ret i32 %136, !dbg !90
}
