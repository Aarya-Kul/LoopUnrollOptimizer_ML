...
8483:                                             ; preds = %8467, %8463
  ...
  br i1 %8484, label %8485, label %8516, !dbg !69
...
8509:                                             ; preds = %8493, %8485
  ...
  br i1 %8510, label %8511, label %8516, !dbg !69
...
8516:                                             ; preds = %8509, %8483
  %8517 = load i32, ptr %5, align 4, !dbg !88
  %8518 = load i32, ptr %6, align 4, !dbg !90
  %8519 = add nsw i32 %8517, %8518, !dbg !91
  %8520 = icmp sge i32 %8519, 7, !dbg !92
  br i1 %8520, label %8521, label %8523, !dbg !93

8521:                                             ; preds = %8516
  %8522 = call i32 @puts(ptr noundef @.str.1), !dbg !94
  br label %8525, !dbg !96

8523:                                             ; preds = %8516
  %8524 = call i32 @puts(ptr noundef @.str.2), !dbg !97
  br label %8525

8525:                                             ; preds = %8523, %8521
  ret i32 0, !dbg !99
}
