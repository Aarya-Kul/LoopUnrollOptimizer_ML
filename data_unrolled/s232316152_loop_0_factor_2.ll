...
19:                                               ; preds = %846, %18
  ...
  br i1 %23, label %24, label %860, !dbg !64
...
215:                                              ; preds = %207
  ...
  br i1 %222, label %.loopexit3, label %225, !dbg !227
...
284:                                              ; preds = %276
  ...
  br i1 %291, label %.loopexit2, label %294, !dbg !284
...
353:                                              ; preds = %345
  ...
  br i1 %360, label %.loopexit1, label %363, !dbg !341
...
422:                                              ; preds = %414
  ...
  br i1 %429, label %.loopexit, label %432, !dbg !398
...
443:                                              ; preds = %442
  ...
  br i1 %449, label %450, label %860, !dbg !64
...
661:                                              ; preds = %653
  ...
  br i1 %668, label %.loopexit6, label %669, !dbg !398
...
714:                                              ; preds = %706
  ...
  br i1 %721, label %.loopexit7, label %722, !dbg !341
...
759:                                              ; preds = %751
  ...
  br i1 %766, label %.loopexit8, label %767, !dbg !284
...
796:                                              ; preds = %788
  ...
  br i1 %803, label %.loopexit9, label %804, !dbg !227
...
825:                                              ; preds = %818
  ...
  br i1 %832, label %.loopexit10, label %833, !dbg !170
...
840:                                              ; preds = %857, %837
  ...
  br i1 %843, label %849, label %844, !dbg !106
...
849:                                              ; preds = %840
  %850 = load i32, ptr %3, align 4, !dbg !107
  %851 = sext i32 %850 to i64, !dbg !110
  %852 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %851, !dbg !110
  %853 = load i8, ptr %852, align 1, !dbg !110
  %854 = sext i8 %853 to i32, !dbg !110
  %855 = icmp eq i32 %854, 101, !dbg !111
  br i1 %855, label %.loopexit11, label %856, !dbg !112

856:                                              ; preds = %849
  br label %857, !dbg !116

857:                                              ; preds = %856
  %858 = load i32, ptr %3, align 4, !dbg !117
  %859 = add nsw i32 %858, 1, !dbg !117
  store i32 %859, ptr %3, align 4, !dbg !117
  br label %840, !dbg !118, !llvm.loop !119

860:                                              ; preds = %443, %19
  %861 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !413
  store i32 0, ptr %1, align 4, !dbg !414
  br label %862, !dbg !414

862:                                              ; preds = %860, %430, %361, %292, %223, %154, %85, %16
  %863 = load i32, ptr %1, align 4, !dbg !415
  ret i32 %863, !dbg !415
}
