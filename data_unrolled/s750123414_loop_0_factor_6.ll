...
773:                                              ; preds = %754, %738, %722, %706, %690, %674, %658, %642, %626, %610, %594, %578, %562, %546, %530, %514, %498, %482, %466, %450, %434, %418, %402, %386, %370, %354, %338, %322, %306, %290, %274, %258, %242, %226, %210, %194, %178, %162, %146, %130, %114, %98, %82, %66, %50, %34, %18, %4
  ...
  %776 = mul nsw i32 %775, 100, !dbg !57
  %777 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !58
  %778 = load i32, ptr %777, align 4, !dbg !58
  %779 = mul nsw i32 %778, 10, !dbg !59
  %780 = add nsw i32 %776, %779, !dbg !60
  %781 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 3, !dbg !61
  %782 = load i32, ptr %781, align 4, !dbg !61
  %783 = add nsw i32 %780, %782, !dbg !62
  %784 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %783), !dbg !63
  ret i32 0, !dbg !64
}
