...
4885:                                             ; preds = %4754, %4628
  %4886 = load i32, ptr %2, align 4, !dbg !210
  %4887 = icmp sgt i32 %4886, 0, !dbg !212
  br i1 %4887, label %4888, label %4911, !dbg !213

4888:                                             ; preds = %4885
  %4889 = load i32, ptr %3, align 4, !dbg !214
  %4890 = icmp sgt i32 %4889, 0, !dbg !215
  br i1 %4890, label %4891, label %4911, !dbg !216

4891:                                             ; preds = %4888
  %4892 = load i32, ptr %4, align 4, !dbg !217
  %4893 = icmp sgt i32 %4892, 0, !dbg !218
  br i1 %4893, label %4894, label %4911, !dbg !219

4894:                                             ; preds = %4891
  %4895 = load i32, ptr %5, align 4, !dbg !220
  %4896 = icmp sgt i32 %4895, 0, !dbg !221
  br i1 %4896, label %4897, label %4911, !dbg !222

4897:                                             ; preds = %4894
  %4898 = load i32, ptr %6, align 4, !dbg !223
  %4899 = icmp sgt i32 %4898, 0, !dbg !224
  br i1 %4899, label %4900, label %4911, !dbg !225

4900:                                             ; preds = %4897
  %4901 = load i32, ptr %7, align 4, !dbg !226
  %4902 = icmp sgt i32 %4901, 0, !dbg !227
  br i1 %4902, label %4903, label %4911, !dbg !228

4903:                                             ; preds = %4900
  %4904 = load i32, ptr %8, align 4, !dbg !229
  %4905 = icmp sgt i32 %4904, 0, !dbg !230
  br i1 %4905, label %4906, label %4911, !dbg !231

4906:                                             ; preds = %4903
  %4907 = load i32, ptr %9, align 4, !dbg !232
  %4908 = icmp slt i32 %4907, 2, !dbg !233
  br i1 %4908, label %4909, label %4911, !dbg !234

4909:                                             ; preds = %4906
  %4910 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %4913, !dbg !237

4911:                                             ; preds = %4906, %4903, %4900, %4897, %4894, %4891, %4888, %4885
  %4912 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %4913
