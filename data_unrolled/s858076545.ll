...
9:                                                ; preds = %196, %0
  ...
  br i1 %15, label %16, label %199, !dbg !47
...
199:                                              ; preds = %195, %189, %164, %139, %114, %89, %64, %39, %9
  %200 = load i8, ptr %3, align 1, !dbg !257
  %201 = sext i8 %200 to i32, !dbg !257
  %202 = icmp sle i32 %201, 1, !dbg !259
  br i1 %202, label %203, label %209, !dbg !260

203:                                              ; preds = %199
  %204 = load i8, ptr %5, align 1, !dbg !261
  %205 = sext i8 %204 to i32, !dbg !261
  %206 = icmp eq i32 %205, 7, !dbg !262
  br i1 %206, label %207, label %209, !dbg !263

207:                                              ; preds = %203
  %208 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !264
  br label %211, !dbg !264

209:                                              ; preds = %203, %199
  %210 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !265
  br label %211
