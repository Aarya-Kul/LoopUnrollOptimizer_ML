...
1636:                                             ; preds = %1654, %1635
  ...
  %1643 = load i32, ptr %10, align 4, !dbg !409
  %1644 = sext i32 %1643 to i64, !dbg !410
  %1645 = getelementptr inbounds i32, ptr %21, i64 %1644, !dbg !410
  %1646 = load i32, ptr %1645, align 4, !dbg !410
  %1647 = add nsw i32 %1642, %1646, !dbg !411
  %1648 = call i32 @llvm.abs.i32(i32 %1647, i1 true), !dbg !412
  %1649 = sub nsw i32 %1638, %1648, !dbg !413
  %1650 = sdiv i32 %1649, 2, !dbg !414
  %1651 = icmp slt i32 %1637, %1650, !dbg !415
  br i1 %1651, label %1652, label %1657, !dbg !416

1652:                                             ; preds = %1636
  %1653 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %1654, !dbg !419

1654:                                             ; preds = %1652
  %1655 = load i32, ptr %13, align 4, !dbg !420
  %1656 = add nsw i32 %1655, 1, !dbg !420
  store i32 %1656, ptr %13, align 4, !dbg !420
  br label %1636, !dbg !421, !llvm.loop !422

1657:                                             ; preds = %1636
  %1658 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %1659, !dbg !425

1659:                                             ; preds = %1657
  %1660 = load i32, ptr %10, align 4, !dbg !426
  %1661 = add nsw i32 %1660, 1, !dbg !426
  store i32 %1661, ptr %10, align 4, !dbg !426
  br label %1585, !dbg !427, !llvm.loop !428

1662:                                             ; preds = %1585
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %1663, !dbg !430

1663:                                             ; preds = %1662, %51
  %1664 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %1664), !dbg !431
  %1665 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %1665, !dbg !431
}
