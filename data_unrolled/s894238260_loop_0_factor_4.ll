...
163:                                              ; preds = %142, %124, %106, %88, %70, %52, %34, %18
  %164 = load i64, ptr %7, align 8, !dbg !90
  %165 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %164), !dbg !91
  store i64 0, ptr %9, align 8, !dbg !92
  store i64 0, ptr %12, align 8, !dbg !93
  br label %166, !dbg !94

166:                                              ; preds = %185, %163
  %167 = load i64, ptr %12, align 8, !dbg !95
  store i64 %167, ptr %13, align 8, !dbg !97
  %168 = load i64, ptr %12, align 8, !dbg !98
  %169 = and i64 %168, 1, !dbg !100
  %170 = icmp ne i64 %169, 0, !dbg !100
  br i1 %170, label %171, label %175, !dbg !101

171:                                              ; preds = %166
  %172 = load i64, ptr %12, align 8, !dbg !102
  %173 = sub nsw i64 %172, 1, !dbg !104
  %174 = ashr i64 %173, 1, !dbg !105
  store i64 %174, ptr %12, align 8, !dbg !106
  br label %182, !dbg !107

175:                                              ; preds = %166
  %176 = load i64, ptr %12, align 8, !dbg !108
  %177 = ashr i64 %176, 1, !dbg !110
  %178 = load i64, ptr %6, align 8, !dbg !111
  %179 = sub nsw i64 %178, 1, !dbg !112
  %180 = shl i64 1, %179, !dbg !113
  %181 = add nsw i64 %177, %180, !dbg !114
  store i64 %181, ptr %12, align 8, !dbg !115
  br label %182

182:                                              ; preds = %175, %171
  %183 = load i64, ptr %9, align 8, !dbg !116
  %184 = add nsw i64 %183, 1, !dbg !116
  store i64 %184, ptr %9, align 8, !dbg !116
  br label %185, !dbg !117

185:                                              ; preds = %182
  %186 = load i64, ptr %12, align 8, !dbg !118
  %187 = icmp ne i64 %186, 0, !dbg !119
  br i1 %187, label %166, label %188, !dbg !117, !llvm.loop !120

188:                                              ; preds = %185
  %189 = load i64, ptr %9, align 8, !dbg !122
  store i64 %189, ptr %11, align 8, !dbg !123
  store i64 0, ptr %14, align 8, !dbg !124
  br label %190, !dbg !126

190:                                              ; preds = %236, %188
  %191 = load i64, ptr %14, align 8, !dbg !127
  %192 = load i64, ptr %7, align 8, !dbg !129
  %193 = icmp sle i64 %191, %192, !dbg !130
  br i1 %193, label %194, label %239, !dbg !131

194:                                              ; preds = %190
  store i64 0, ptr %9, align 8, !dbg !132
  %195 = load i64, ptr %14, align 8, !dbg !134
  store i64 %195, ptr %12, align 8, !dbg !135
  br label %196, !dbg !136

196:                                              ; preds = %223, %194
  %197 = load i64, ptr %12, align 8, !dbg !137
  store i64 %197, ptr %13, align 8, !dbg !139
  %198 = load i64, ptr %12, align 8, !dbg !140
  %199 = and i64 %198, 1, !dbg !142
  %200 = icmp ne i64 %199, 0, !dbg !142
  br i1 %200, label %201, label %205, !dbg !143

201:                                              ; preds = %196
  %202 = load i64, ptr %12, align 8, !dbg !144
  %203 = sub nsw i64 %202, 1, !dbg !146
  %204 = ashr i64 %203, 1, !dbg !147
  store i64 %204, ptr %12, align 8, !dbg !148
  br label %212, !dbg !149

205:                                              ; preds = %196
  %206 = load i64, ptr %12, align 8, !dbg !150
  %207 = ashr i64 %206, 1, !dbg !152
  %208 = load i64, ptr %6, align 8, !dbg !153
  %209 = sub nsw i64 %208, 1, !dbg !154
  %210 = shl i64 1, %209, !dbg !155
  %211 = add nsw i64 %207, %210, !dbg !156
  store i64 %211, ptr %12, align 8, !dbg !157
  br label %212

212:                                              ; preds = %205, %201
  %213 = load i64, ptr %9, align 8, !dbg !158
  %214 = add nsw i64 %213, 1, !dbg !158
  store i64 %214, ptr %9, align 8, !dbg !158
  br label %215, !dbg !159

215:                                              ; preds = %212
  %216 = load i64, ptr %12, align 8, !dbg !160
  %217 = load i64, ptr %14, align 8, !dbg !161
  %218 = icmp ne i64 %216, %217, !dbg !162
  br i1 %218, label %219, label %223, !dbg !163

219:                                              ; preds = %215
  %220 = load i64, ptr %13, align 8, !dbg !164
  %221 = load i64, ptr %12, align 8, !dbg !165
  %222 = icmp ne i64 %220, %221, !dbg !166
  br label %223

223:                                              ; preds = %219, %215
  %224 = phi i1 [ false, %215 ], [ %222, %219 ], !dbg !167
  br i1 %224, label %196, label %225, !dbg !159, !llvm.loop !168

225:                                              ; preds = %223
  %226 = load i64, ptr %13, align 8, !dbg !170
  %227 = load i64, ptr %12, align 8, !dbg !172
  %228 = icmp ne i64 %226, %227, !dbg !173
  br i1 %228, label %229, label %235, !dbg !174

229:                                              ; preds = %225
  %230 = load i64, ptr %11, align 8, !dbg !175
  %231 = load i64, ptr %9, align 8, !dbg !178
  %232 = icmp ne i64 %230, %231, !dbg !179
  br i1 %232, label %233, label %234, !dbg !180

233:                                              ; preds = %229
  br label %239, !dbg !181

234:                                              ; preds = %229
  br label %235, !dbg !182

235:                                              ; preds = %234, %225
  br label %236, !dbg !183

236:                                              ; preds = %235
  %237 = load i64, ptr %14, align 8, !dbg !184
  %238 = add nsw i64 %237, 1, !dbg !184
  store i64 %238, ptr %14, align 8, !dbg !184
  br label %190, !dbg !185, !llvm.loop !186

239:                                              ; preds = %233, %190
  %240 = load i64, ptr %11, align 8, !dbg !188
  %241 = load i64, ptr %14, align 8, !dbg !189
  %242 = mul nsw i64 %240, %241, !dbg !190
  %243 = load i64, ptr %9, align 8, !dbg !191
  %244 = add nsw i64 %242, %243, !dbg !192
  %245 = load i64, ptr %7, align 8, !dbg !193
  %246 = load i64, ptr %14, align 8, !dbg !194
  %247 = add nsw i64 %246, 1, !dbg !195
  %248 = sdiv i64 %245, %247, !dbg !196
  %249 = mul nsw i64 %244, %248, !dbg !197
  %250 = load i64, ptr %11, align 8, !dbg !198
  %251 = load i64, ptr %7, align 8, !dbg !199
  %252 = add nsw i64 %251, 1, !dbg !200
  %253 = load i64, ptr %7, align 8, !dbg !201
  %254 = load i64, ptr %14, align 8, !dbg !202
  %255 = add nsw i64 %254, 1, !dbg !203
  %256 = sdiv i64 %253, %255, !dbg !204
  %257 = load i64, ptr %14, align 8, !dbg !205
  %258 = add nsw i64 %257, 1, !dbg !206
  %259 = mul nsw i64 %256, %258, !dbg !207
  %260 = sub nsw i64 %252, %259, !dbg !208
  %261 = mul nsw i64 %250, %260, !dbg !209
  %262 = add nsw i64 %249, %261, !dbg !210
  store i64 %262, ptr %10, align 8, !dbg !211
  %263 = load i64, ptr %10, align 8, !dbg !212
  %264 = srem i64 %263, 998244353, !dbg !213
  %265 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %264), !dbg !214
  ret i32 0, !dbg !215
}
