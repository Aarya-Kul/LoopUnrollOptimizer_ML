...
12:                                               ; preds = %436, %0
  ...
  br i1 %16, label %17, label %439, !dbg !57
...
139:                                              ; preds = %132
  ...
  br i1 %146, label %147, label %149, !dbg !163
...
208:                                              ; preds = %200
  ...
  br i1 %215, label %216, label %218, !dbg !220
...
346:                                              ; preds = %338
  ...
  br i1 %353, label %354, label %356, !dbg !334
...
439:                                              ; preds = %12
  %440 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !406
  store i32 0, ptr %1, align 4, !dbg !407
  br label %441, !dbg !407

441:                                              ; preds = %439, %423, %354, %285, %216, %147, %78
  %442 = load i32, ptr %1, align 4, !dbg !408
  ret i32 %442, !dbg !408
}
