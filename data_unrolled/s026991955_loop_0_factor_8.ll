...
4267:                                             ; preds = %4249
  ...
  br label %4268, !dbg !106

4268:                                             ; preds = %4291, %4267
  %4269 = load i32, ptr %16, align 4, !dbg !107
  %4270 = load i32, ptr %9, align 4, !dbg !109
  %4271 = icmp sle i32 %4269, %4270, !dbg !110
  br i1 %4271, label %4272, label %4294, !dbg !111

4272:                                             ; preds = %4268
  %4273 = load ptr, ptr %12, align 8, !dbg !112
  %4274 = load i32, ptr %4273, align 4, !dbg !115
  %4275 = load ptr, ptr %13, align 8, !dbg !116
  %4276 = load i32, ptr %16, align 4, !dbg !117
  %4277 = sext i32 %4276 to i64, !dbg !116
  %4278 = getelementptr inbounds i32, ptr %4275, i64 %4277, !dbg !116
  %4279 = load i32, ptr %4278, align 4, !dbg !116
  %4280 = icmp slt i32 %4274, %4279, !dbg !118
  br i1 %4280, label %4281, label %4290, !dbg !119

4281:                                             ; preds = %4272
  %4282 = load ptr, ptr %13, align 8, !dbg !120
  %4283 = load i32, ptr %16, align 4, !dbg !122
  %4284 = sext i32 %4283 to i64, !dbg !120
  %4285 = getelementptr inbounds i32, ptr %4282, i64 %4284, !dbg !120
  %4286 = load i32, ptr %4285, align 4, !dbg !120
  %4287 = load ptr, ptr %12, align 8, !dbg !123
  store i32 %4286, ptr %4287, align 4, !dbg !124
  %4288 = load i32, ptr %16, align 4, !dbg !125
  %4289 = load ptr, ptr %11, align 8, !dbg !126
  store i32 %4288, ptr %4289, align 4, !dbg !127
  br label %4290, !dbg !128

4290:                                             ; preds = %4281, %4272
  br label %4291, !dbg !129

4291:                                             ; preds = %4290
  %4292 = load i32, ptr %16, align 4, !dbg !130
  %4293 = add nsw i32 %4292, 1, !dbg !130
  store i32 %4293, ptr %16, align 4, !dbg !130
  br label %4268, !dbg !131, !llvm.loop !132

4294:                                             ; preds = %4268
  %4295 = load ptr, ptr %13, align 8, !dbg !134
  call void @free(ptr noundef %4295) #6, !dbg !135
  ret void, !dbg !136
}
