...
5423:                                             ; preds = %5409
  ...
  br i1 %5428, label %5429, label %5446, !dbg !180
...
5446:                                             ; preds = %5423, %5405
  %5447 = load i32, ptr @max, align 4, !dbg !195
  %5448 = sext i32 %5447 to i64, !dbg !195
  %5449 = load i64, ptr %8, align 8, !dbg !196
  %5450 = sub nsw i64 %5449, %5448, !dbg !196
  store i64 %5450, ptr %8, align 8, !dbg !196
  %5451 = load i64, ptr %8, align 8, !dbg !197
  %5452 = load i32, ptr %6, align 4, !dbg !198
  %5453 = load i32, ptr %7, align 4, !dbg !199
  %5454 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %5451, i32 noundef %5452, i32 noundef %5453), !dbg !200
  ret i32 0, !dbg !201
}
