...
3844:                                             ; preds = %3881, %3843
  ...
  br i1 %3855, label %3856, label %3882, !dbg !57
...
3862:                                             ; preds = %3875, %3856
  br label %3882, !dbg !70
...
3863:                                             ; preds = %3856
  ...
  br i1 %3874, label %3875, label %3882, !dbg !57
...
3882:                                             ; preds = %3863, %3862, %3844
  %3883 = load i32, ptr @s, align 4, !dbg !74
  %3884 = add nsw i32 %3883, -1, !dbg !74
  store i32 %3884, ptr @s, align 4, !dbg !74
  br label %3885, !dbg !75

3885:                                             ; preds = %3909, %3882
  %3886 = load i32, ptr @s, align 4, !dbg !76
  %3887 = load i32, ptr @r, align 4, !dbg !77
  %3888 = sub nsw i32 %3886, %3887, !dbg !78
  %3889 = sext i32 %3888 to i64, !dbg !79
  %3890 = getelementptr inbounds [101 x i8], ptr @S, i64 0, i64 %3889, !dbg !79
  %3891 = load i8, ptr %3890, align 1, !dbg !79
  %3892 = sext i8 %3891 to i32, !dbg !79
  %3893 = load i32, ptr @r, align 4, !dbg !80
  %3894 = sub nsw i32 6, %3893, !dbg !81
  %3895 = sext i32 %3894 to i64, !dbg !82
  %3896 = getelementptr inbounds [7 x i8], ptr @T, i64 0, i64 %3895, !dbg !82
  %3897 = load i8, ptr %3896, align 1, !dbg !82
  %3898 = sext i8 %3897 to i32, !dbg !82
  %3899 = icmp eq i32 %3892, %3898, !dbg !83
  br i1 %3899, label %3900, label %3910, !dbg !75

3900:                                             ; preds = %3885
  %3901 = load i32, ptr @r, align 4, !dbg !84
  %3902 = add nsw i32 %3901, 1, !dbg !84
  store i32 %3902, ptr @r, align 4, !dbg !84
  %3903 = load i32, ptr @l, align 4, !dbg !86
  %3904 = load i32, ptr @r, align 4, !dbg !88
  %3905 = add nsw i32 %3903, %3904, !dbg !89
  %3906 = load i32, ptr @s, align 4, !dbg !90
  %3907 = icmp sge i32 %3905, %3906, !dbg !91
  br i1 %3907, label %3908, label %3909, !dbg !92

3908:                                             ; preds = %3900
  br label %3910, !dbg !93

3909:                                             ; preds = %3900
  br label %3885, !dbg !75, !llvm.loop !95

3910:                                             ; preds = %3908, %3885
  %3911 = load i32, ptr @l, align 4, !dbg !97
  %3912 = load i32, ptr @r, align 4, !dbg !99
  %3913 = add nsw i32 %3911, %3912, !dbg !100
  %3914 = icmp sge i32 %3913, 7, !dbg !101
  br i1 %3914, label %3915, label %3917, !dbg !102

3915:                                             ; preds = %3910
  %3916 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !103
  br label %3919, !dbg !105

3917:                                             ; preds = %3910
  %3918 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !106
  br label %3919
