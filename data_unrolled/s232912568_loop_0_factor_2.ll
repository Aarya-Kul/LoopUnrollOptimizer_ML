...
10:                                               ; preds = %107, %0
  ...
  br i1 %14, label %15, label %110, !dbg !58
...
58:                                               ; preds = %57
  ...
  br i1 %64, label %65, label %110, !dbg !58
...
110:                                              ; preds = %58, %54, %10
  %111 = load i32, ptr %5, align 4, !dbg !100
  %112 = icmp sle i32 %111, 1, !dbg !102
  br i1 %112, label %113, label %121, !dbg !103

113:                                              ; preds = %110
  %114 = load i32, ptr %4, align 4, !dbg !104
  %115 = sext i32 %114 to i64, !dbg !104
  %116 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 0, !dbg !105
  %117 = call i64 @strlen(ptr noundef %116) #5, !dbg !106
  %118 = icmp eq i64 %115, %117, !dbg !107
  br i1 %118, label %119, label %121, !dbg !108

119:                                              ; preds = %113
  %120 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !109
  br label %123, !dbg !109

121:                                              ; preds = %113, %110
  %122 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !110
  br label %123
