...
134:                                              ; preds = %115, %99, %83, %67, %51, %35, %19, %5
  %135 = getelementptr inbounds [2 x i32], ptr %4, i64 0, i64 0, !dbg !59
  %136 = load i32, ptr %135, align 4, !dbg !59
  %137 = mul nsw i32 %136, 100, !dbg !60
  %138 = getelementptr inbounds [2 x i32], ptr %4, i64 0, i64 1, !dbg !61
  %139 = load i32, ptr %138, align 4, !dbg !61
  %140 = mul nsw i32 %139, 10, !dbg !62
  %141 = add nsw i32 %137, %140, !dbg !63
  %142 = getelementptr inbounds [2 x i32], ptr %4, i64 0, i64 2, !dbg !64
  %143 = load i32, ptr %142, align 4, !dbg !64
  %144 = add nsw i32 %141, %143, !dbg !65
  store i32 %144, ptr %2, align 4, !dbg !66
  %145 = load i32, ptr %2, align 4, !dbg !67
  %146 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %145), !dbg !68
  ret i32 0, !dbg !69
}
