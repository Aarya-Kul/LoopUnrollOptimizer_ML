...
4754:                                             ; preds = %4753
  ...
  br i1 %4758, label %4759, label %5632, !dbg !93
...
4879:                                             ; preds = %4878
  ...
  br i1 %4883, label %4884, label %5632, !dbg !93
...
5004:                                             ; preds = %5003
  ...
  br i1 %5008, label %5009, label %5632, !dbg !93
...
5129:                                             ; preds = %5128
  ...
  br i1 %5133, label %5134, label %5632, !dbg !93
...
5254:                                             ; preds = %5253
  ...
  br i1 %5258, label %5259, label %5632, !dbg !93
...
5379:                                             ; preds = %5378
  ...
  br i1 %5383, label %5384, label %5632, !dbg !93
...
5504:                                             ; preds = %5503
  ...
  br i1 %5508, label %5509, label %5632, !dbg !93
...
5632:                                             ; preds = %5504, %5379, %5254, %5129, %5004, %4879, %4754, %4737, %4628
  %5633 = load i32, ptr %2, align 4, !dbg !210
  %5634 = icmp sgt i32 %5633, 0, !dbg !212
  br i1 %5634, label %5635, label %5658, !dbg !213

5635:                                             ; preds = %5632
  %5636 = load i32, ptr %3, align 4, !dbg !214
  %5637 = icmp sgt i32 %5636, 0, !dbg !215
  br i1 %5637, label %5638, label %5658, !dbg !216

5638:                                             ; preds = %5635
  %5639 = load i32, ptr %4, align 4, !dbg !217
  %5640 = icmp sgt i32 %5639, 0, !dbg !218
  br i1 %5640, label %5641, label %5658, !dbg !219

5641:                                             ; preds = %5638
  %5642 = load i32, ptr %5, align 4, !dbg !220
  %5643 = icmp sgt i32 %5642, 0, !dbg !221
  br i1 %5643, label %5644, label %5658, !dbg !222

5644:                                             ; preds = %5641
  %5645 = load i32, ptr %6, align 4, !dbg !223
  %5646 = icmp sgt i32 %5645, 0, !dbg !224
  br i1 %5646, label %5647, label %5658, !dbg !225

5647:                                             ; preds = %5644
  %5648 = load i32, ptr %7, align 4, !dbg !226
  %5649 = icmp sgt i32 %5648, 0, !dbg !227
  br i1 %5649, label %5650, label %5658, !dbg !228

5650:                                             ; preds = %5647
  %5651 = load i32, ptr %8, align 4, !dbg !229
  %5652 = icmp sgt i32 %5651, 0, !dbg !230
  br i1 %5652, label %5653, label %5658, !dbg !231

5653:                                             ; preds = %5650
  %5654 = load i32, ptr %9, align 4, !dbg !232
  %5655 = icmp slt i32 %5654, 2, !dbg !233
  br i1 %5655, label %5656, label %5658, !dbg !234

5656:                                             ; preds = %5653
  %5657 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %5660, !dbg !237

5658:                                             ; preds = %5653, %5650, %5647, %5644, %5641, %5638, %5635, %5632
  %5659 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %5660

5660:                                             ; preds = %5658, %5656
  ret i32 0, !dbg !240
}
