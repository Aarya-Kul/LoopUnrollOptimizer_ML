...
5798:                                             ; preds = %5785
  br label %5799, !dbg !95

5799:                                             ; preds = %5820, %5798
  %5800 = load i32, ptr %3, align 4, !dbg !96
  %5801 = sext i32 %5800 to i64, !dbg !99
  %5802 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5801, !dbg !99
  %5803 = load i8, ptr %5802, align 1, !dbg !99
  %5804 = sext i8 %5803 to i32, !dbg !99
  %5805 = icmp eq i32 121, %5804, !dbg !100
  br i1 %5805, label %5806, label %5811, !dbg !101

5806:                                             ; preds = %5799
  %5807 = load i32, ptr %3, align 4, !dbg !102
  %5808 = icmp sgt i32 %5807, 3, !dbg !105
  br i1 %5808, label %5809, label %5810, !dbg !106

5809:                                             ; preds = %5806
  store i32 1, ptr %4, align 4, !dbg !107
  br label %5810, !dbg !109

5810:                                             ; preds = %5809, %5806
  br label %5823, !dbg !110

5811:                                             ; preds = %5799
  %5812 = load i32, ptr %3, align 4, !dbg !111
  %5813 = icmp sgt i32 %5812, 96, !dbg !113
  br i1 %5813, label %5817, label %5814, !dbg !114

5814:                                             ; preds = %5811
  %5815 = load i32, ptr %4, align 4, !dbg !115
  %5816 = icmp eq i32 %5815, 1, !dbg !116
  br i1 %5816, label %5817, label %5819, !dbg !117

5817:                                             ; preds = %5814, %5811
  %5818 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !118
  br label %5819, !dbg !120

5819:                                             ; preds = %5817, %5814
  br label %5820

5820:                                             ; preds = %5819
  %5821 = load i32, ptr %3, align 4, !dbg !121
  %5822 = add nsw i32 %5821, 1, !dbg !121
  store i32 %5822, ptr %3, align 4, !dbg !121
  br label %5799, !dbg !95, !llvm.loop !122

5823:                                             ; preds = %5810
  br label %5824, !dbg !124

5824:                                             ; preds = %5845, %5823
  %5825 = load i32, ptr %3, align 4, !dbg !125
  %5826 = sext i32 %5825 to i64, !dbg !128
  %5827 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5826, !dbg !128
  %5828 = load i8, ptr %5827, align 1, !dbg !128
  %5829 = sext i8 %5828 to i32, !dbg !128
  %5830 = icmp eq i32 101, %5829, !dbg !129
  br i1 %5830, label %5831, label %5836, !dbg !130

5831:                                             ; preds = %5824
  %5832 = load i32, ptr %3, align 4, !dbg !131
  %5833 = icmp sgt i32 %5832, 4, !dbg !134
  br i1 %5833, label %5834, label %5835, !dbg !135

5834:                                             ; preds = %5831
  store i32 1, ptr %4, align 4, !dbg !136
  br label %5835, !dbg !138

5835:                                             ; preds = %5834, %5831
  br label %5848, !dbg !139

5836:                                             ; preds = %5824
  %5837 = load i32, ptr %3, align 4, !dbg !140
  %5838 = icmp sgt i32 %5837, 97, !dbg !142
  br i1 %5838, label %5842, label %5839, !dbg !143

5839:                                             ; preds = %5836
  %5840 = load i32, ptr %4, align 4, !dbg !144
  %5841 = icmp eq i32 %5840, 1, !dbg !145
  br i1 %5841, label %5842, label %5844, !dbg !146

5842:                                             ; preds = %5839, %5836
  %5843 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !147
  br label %5844, !dbg !149

5844:                                             ; preds = %5842, %5839
  br label %5845

5845:                                             ; preds = %5844
  %5846 = load i32, ptr %3, align 4, !dbg !150
  %5847 = add nsw i32 %5846, 1, !dbg !150
  store i32 %5847, ptr %3, align 4, !dbg !150
  br label %5824, !dbg !124, !llvm.loop !151

5848:                                             ; preds = %5835
  br label %5849, !dbg !153

5849:                                             ; preds = %5870, %5848
  %5850 = load i32, ptr %3, align 4, !dbg !154
  %5851 = sext i32 %5850 to i64, !dbg !157
  %5852 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5851, !dbg !157
  %5853 = load i8, ptr %5852, align 1, !dbg !157
  %5854 = sext i8 %5853 to i32, !dbg !157
  %5855 = icmp eq i32 110, %5854, !dbg !158
  br i1 %5855, label %5856, label %5861, !dbg !159

5856:                                             ; preds = %5849
  %5857 = load i32, ptr %3, align 4, !dbg !160
  %5858 = icmp sgt i32 %5857, 5, !dbg !163
  br i1 %5858, label %5859, label %5860, !dbg !164

5859:                                             ; preds = %5856
  store i32 1, ptr %4, align 4, !dbg !165
  br label %5860, !dbg !167

5860:                                             ; preds = %5859, %5856
  br label %5873, !dbg !168

5861:                                             ; preds = %5849
  %5862 = load i32, ptr %3, align 4, !dbg !169
  %5863 = icmp sgt i32 %5862, 98, !dbg !171
  br i1 %5863, label %5867, label %5864, !dbg !172

5864:                                             ; preds = %5861
  %5865 = load i32, ptr %4, align 4, !dbg !173
  %5866 = icmp eq i32 %5865, 1, !dbg !174
  br i1 %5866, label %5867, label %5869, !dbg !175

5867:                                             ; preds = %5864, %5861
  %5868 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !176
  br label %5869, !dbg !178

5869:                                             ; preds = %5867, %5864
  br label %5870

5870:                                             ; preds = %5869
  %5871 = load i32, ptr %3, align 4, !dbg !179
  %5872 = add nsw i32 %5871, 1, !dbg !179
  store i32 %5872, ptr %3, align 4, !dbg !179
  br label %5849, !dbg !153, !llvm.loop !180

5873:                                             ; preds = %5860
  br label %5874, !dbg !182

5874:                                             ; preds = %5895, %5873
  %5875 = load i32, ptr %3, align 4, !dbg !183
  %5876 = sext i32 %5875 to i64, !dbg !186
  %5877 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5876, !dbg !186
  %5878 = load i8, ptr %5877, align 1, !dbg !186
  %5879 = sext i8 %5878 to i32, !dbg !186
  %5880 = icmp eq i32 99, %5879, !dbg !187
  br i1 %5880, label %5881, label %5886, !dbg !188

5881:                                             ; preds = %5874
  %5882 = load i32, ptr %3, align 4, !dbg !189
  %5883 = icmp sgt i32 %5882, 6, !dbg !192
  br i1 %5883, label %5884, label %5885, !dbg !193

5884:                                             ; preds = %5881
  store i32 1, ptr %4, align 4, !dbg !194
  br label %5885, !dbg !196

5885:                                             ; preds = %5884, %5881
  br label %5898, !dbg !197

5886:                                             ; preds = %5874
  %5887 = load i32, ptr %3, align 4, !dbg !198
  %5888 = icmp sgt i32 %5887, 99, !dbg !200
  br i1 %5888, label %5892, label %5889, !dbg !201

5889:                                             ; preds = %5886
  %5890 = load i32, ptr %4, align 4, !dbg !202
  %5891 = icmp eq i32 %5890, 1, !dbg !203
  br i1 %5891, label %5892, label %5894, !dbg !204

5892:                                             ; preds = %5889, %5886
  %5893 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !205
  br label %5894, !dbg !207

5894:                                             ; preds = %5892, %5889
  br label %5895

5895:                                             ; preds = %5894
  %5896 = load i32, ptr %3, align 4, !dbg !208
  %5897 = add nsw i32 %5896, 1, !dbg !208
  store i32 %5897, ptr %3, align 4, !dbg !208
  br label %5874, !dbg !182, !llvm.loop !209

5898:                                             ; preds = %5885
  br label %5899, !dbg !211

5899:                                             ; preds = %5920, %5898
  %5900 = load i32, ptr %3, align 4, !dbg !212
  %5901 = sext i32 %5900 to i64, !dbg !215
  %5902 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5901, !dbg !215
  %5903 = load i8, ptr %5902, align 1, !dbg !215
  %5904 = sext i8 %5903 to i32, !dbg !215
  %5905 = icmp eq i32 101, %5904, !dbg !216
  br i1 %5905, label %5906, label %5911, !dbg !217

5906:                                             ; preds = %5899
  %5907 = load i32, ptr %3, align 4, !dbg !218
  %5908 = icmp sgt i32 %5907, 7, !dbg !221
  br i1 %5908, label %5909, label %5910, !dbg !222

5909:                                             ; preds = %5906
  store i32 1, ptr %4, align 4, !dbg !223
  br label %5910, !dbg !225

5910:                                             ; preds = %5909, %5906
  br label %5923, !dbg !226

5911:                                             ; preds = %5899
  %5912 = load i32, ptr %3, align 4, !dbg !227
  %5913 = icmp sgt i32 %5912, 100, !dbg !229
  br i1 %5913, label %5917, label %5914, !dbg !230

5914:                                             ; preds = %5911
  %5915 = load i32, ptr %4, align 4, !dbg !231
  %5916 = icmp eq i32 %5915, 1, !dbg !232
  br i1 %5916, label %5917, label %5919, !dbg !233

5917:                                             ; preds = %5914, %5911
  %5918 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !234
  br label %5919, !dbg !236

5919:                                             ; preds = %5917, %5914
  br label %5920

5920:                                             ; preds = %5919
  %5921 = load i32, ptr %3, align 4, !dbg !237
  %5922 = add nsw i32 %5921, 1, !dbg !237
  store i32 %5922, ptr %3, align 4, !dbg !237
  br label %5899, !dbg !211, !llvm.loop !238

5923:                                             ; preds = %5910
  %5924 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !240
  ret i32 0, !dbg !241
}
