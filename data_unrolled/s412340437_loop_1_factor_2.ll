...
5431:                                             ; preds = %5430
  ...
  br i1 %5436, label %5437, label %5457, !dbg !338
...
5457:                                             ; preds = %5431, %5409
  store i32 0, ptr %10, align 4, !dbg !361
  br label %5458, !dbg !363

5458:                                             ; preds = %5562, %5457
  %5459 = load i32, ptr %10, align 4, !dbg !364
  %5460 = load i32, ptr %8, align 4, !dbg !366
  %5461 = icmp slt i32 %5459, %5460, !dbg !367
  br i1 %5461, label %5462, label %5565, !dbg !368

5462:                                             ; preds = %5458
  %5463 = load i32, ptr %10, align 4, !dbg !369
  %5464 = sext i32 %5463 to i64, !dbg !371
  %5465 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5464, !dbg !371
  %5466 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !372
  %5467 = load double, ptr %5466, align 8, !dbg !372
  %5468 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !372
  %5469 = load double, ptr %5468, align 8, !dbg !372
  %5470 = getelementptr inbounds { double, double }, ptr %5465, i32 0, i32 0, !dbg !372
  %5471 = load double, ptr %5470, align 16, !dbg !372
  %5472 = getelementptr inbounds { double, double }, ptr %5465, i32 0, i32 1, !dbg !372
  %5473 = load double, ptr %5472, align 8, !dbg !372
  %5474 = call { double, double } @make_vec(double %5467, double %5469, double %5471, double %5473), !dbg !372
  %5475 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !372
  %5476 = extractvalue { double, double } %5474, 0, !dbg !372
  store double %5476, ptr %5475, align 8, !dbg !372
  %5477 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !372
  %5478 = extractvalue { double, double } %5474, 1, !dbg !372
  store double %5478, ptr %5477, align 8, !dbg !372
  %5479 = load i32, ptr %10, align 4, !dbg !373
  %5480 = add nsw i32 %5479, 1, !dbg !374
  %5481 = sext i32 %5480 to i64, !dbg !375
  %5482 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5481, !dbg !375
  %5483 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !376
  %5484 = load double, ptr %5483, align 8, !dbg !376
  %5485 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !376
  %5486 = load double, ptr %5485, align 8, !dbg !376
  %5487 = getelementptr inbounds { double, double }, ptr %5482, i32 0, i32 0, !dbg !376
  %5488 = load double, ptr %5487, align 16, !dbg !376
  %5489 = getelementptr inbounds { double, double }, ptr %5482, i32 0, i32 1, !dbg !376
  %5490 = load double, ptr %5489, align 8, !dbg !376
  %5491 = call { double, double } @make_vec(double %5484, double %5486, double %5488, double %5490), !dbg !376
  %5492 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !376
  %5493 = extractvalue { double, double } %5491, 0, !dbg !376
  store double %5493, ptr %5492, align 8, !dbg !376
  %5494 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !376
  %5495 = extractvalue { double, double } %5491, 1, !dbg !376
  store double %5495, ptr %5494, align 8, !dbg !376
  %5496 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !377
  %5497 = load double, ptr %5496, align 8, !dbg !377
  %5498 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !377
  %5499 = load double, ptr %5498, align 8, !dbg !377
  %5500 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !377
  %5501 = load double, ptr %5500, align 8, !dbg !377
  %5502 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !377
  %5503 = load double, ptr %5502, align 8, !dbg !377
  %5504 = call double @cross(double %5497, double %5499, double %5501, double %5503), !dbg !377
  %5505 = load i32, ptr %10, align 4, !dbg !378
  %5506 = sext i32 %5505 to i64, !dbg !379
  %5507 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5506, !dbg !379
  %5508 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !380
  %5509 = load double, ptr %5508, align 8, !dbg !380
  %5510 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !380
  %5511 = load double, ptr %5510, align 8, !dbg !380
  %5512 = getelementptr inbounds { double, double }, ptr %5507, i32 0, i32 0, !dbg !380
  %5513 = load double, ptr %5512, align 16, !dbg !380
  %5514 = getelementptr inbounds { double, double }, ptr %5507, i32 0, i32 1, !dbg !380
  %5515 = load double, ptr %5514, align 8, !dbg !380
  %5516 = call { double, double } @make_vec(double %5509, double %5511, double %5513, double %5515), !dbg !380
  %5517 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !380
  %5518 = extractvalue { double, double } %5516, 0, !dbg !380
  store double %5518, ptr %5517, align 8, !dbg !380
  %5519 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !380
  %5520 = extractvalue { double, double } %5516, 1, !dbg !380
  store double %5520, ptr %5519, align 8, !dbg !380
  %5521 = load i32, ptr %10, align 4, !dbg !381
  %5522 = add nsw i32 %5521, 1, !dbg !382
  %5523 = sext i32 %5522 to i64, !dbg !383
  %5524 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5523, !dbg !383
  %5525 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !384
  %5526 = load double, ptr %5525, align 8, !dbg !384
  %5527 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !384
  %5528 = load double, ptr %5527, align 8, !dbg !384
  %5529 = getelementptr inbounds { double, double }, ptr %5524, i32 0, i32 0, !dbg !384
  %5530 = load double, ptr %5529, align 16, !dbg !384
  %5531 = getelementptr inbounds { double, double }, ptr %5524, i32 0, i32 1, !dbg !384
  %5532 = load double, ptr %5531, align 8, !dbg !384
  %5533 = call { double, double } @make_vec(double %5526, double %5528, double %5530, double %5532), !dbg !384
  %5534 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !384
  %5535 = extractvalue { double, double } %5533, 0, !dbg !384
  store double %5535, ptr %5534, align 8, !dbg !384
  %5536 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !384
  %5537 = extractvalue { double, double } %5533, 1, !dbg !384
  store double %5537, ptr %5536, align 8, !dbg !384
  %5538 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !385
  %5539 = load double, ptr %5538, align 8, !dbg !385
  %5540 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !385
  %5541 = load double, ptr %5540, align 8, !dbg !385
  %5542 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !385
  %5543 = load double, ptr %5542, align 8, !dbg !385
  %5544 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !385
  %5545 = load double, ptr %5544, align 8, !dbg !385
  %5546 = call double @dot(double %5539, double %5541, double %5543, double %5545), !dbg !385
  %5547 = call double @atan2(double noundef %5504, double noundef %5546) #6, !dbg !386
  store double %5547, ptr %13, align 8, !dbg !387
  %5548 = load double, ptr %13, align 8, !dbg !388
  %5549 = load double, ptr %14, align 8, !dbg !389
  %5550 = fadd double %5549, %5548, !dbg !389
  store double %5550, ptr %14, align 8, !dbg !389
  %5551 = load double, ptr %13, align 8, !dbg !390
  %5552 = fsub double %5551, 0x400921FB54442D18, !dbg !392
  %5553 = call double @llvm.fabs.f64(double %5552), !dbg !393
  %5554 = fcmp ole double %5553, 0x3EB0C6F7A0B5ED8D, !dbg !394
  br i1 %5554, label %5560, label %5555, !dbg !395

5555:                                             ; preds = %5462
  %5556 = load double, ptr %13, align 8, !dbg !396
  %5557 = fadd double %5556, 0x400921FB54442D18, !dbg !397
  %5558 = call double @llvm.fabs.f64(double %5557), !dbg !398
  %5559 = fcmp ole double %5558, 0x3EB0C6F7A0B5ED8D, !dbg !399
  br i1 %5559, label %5560, label %5561, !dbg !400

5560:                                             ; preds = %5555, %5462
  store i32 1, ptr %9, align 4, !dbg !401
  store i32 1, ptr %5, align 4, !dbg !402
  store i32 1, ptr %15, align 4
  br label %5573, !dbg !402

5561:                                             ; preds = %5555
  br label %5562, !dbg !403

5562:                                             ; preds = %5561
  %5563 = load i32, ptr %10, align 4, !dbg !404
  %5564 = add nsw i32 %5563, 1, !dbg !404
  store i32 %5564, ptr %10, align 4, !dbg !404
  br label %5458, !dbg !405, !llvm.loop !406

5565:                                             ; preds = %5458
  %5566 = load double, ptr %14, align 8, !dbg !408
  %5567 = fsub double %5566, 0x401921FB54442D18, !dbg !410
  %5568 = call double @llvm.fabs.f64(double %5567), !dbg !411
  %5569 = fcmp ole double %5568, 0x3EB0C6F7A0B5ED8D, !dbg !412
  br i1 %5569, label %5570, label %5571, !dbg !413

5570:                                             ; preds = %5565
  store i32 2, ptr %9, align 4, !dbg !414
  store i32 2, ptr %5, align 4, !dbg !416
  store i32 1, ptr %15, align 4
  br label %5573, !dbg !416

5571:                                             ; preds = %5565
  %5572 = load i32, ptr %9, align 4, !dbg !417
  store i32 %5572, ptr %5, align 4, !dbg !418
  store i32 1, ptr %15, align 4
  br label %5573, !dbg !418

5573:                                             ; preds = %5571, %5570, %5560, %5429
  %5574 = load ptr, ptr %11, align 8, !dbg !419
  call void @llvm.stackrestore.p0(ptr %5574), !dbg !419
  %5575 = load i32, ptr %5, align 4, !dbg !419
  ret i32 %5575, !dbg !419
}
