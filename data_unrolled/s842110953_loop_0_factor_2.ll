...
20:                                               ; preds = %80, %16
  ...
  br i1 %23, label %24, label %117, !dbg !61
...
57:                                               ; preds = %31
  ...
  br i1 %59, label %.loopexit, label %62, !dbg !114
...
67:                                               ; preds = %66
  ...
  br i1 %72, label %73, label %117, !dbg !61
...
75:                                               ; preds = %92, %73
  ...
  br i1 %78, label %83, label %79, !dbg !72
...
84:                                               ; preds = %114, %83
  %85 = load i32, ptr %8, align 4, !dbg !82
  %86 = load i32, ptr %3, align 4, !dbg !84
  %87 = icmp slt i32 %85, %86, !dbg !85
  br i1 %87, label %95, label %88, !dbg !86

88:                                               ; preds = %84
  %89 = call i32 @strcmp(ptr noundef %6, ptr noundef @.str.1) #5, !dbg !111
  %90 = icmp eq i32 %89, 0, !dbg !113
  br i1 %90, label %.loopexit1, label %91, !dbg !114
...
92:                                               ; preds = %91
  ...
  store i32 %94, ptr %5, align 4, !dbg !119
  br label %75, !dbg !120, !llvm.loop !121

95:                                               ; preds = %84
  %96 = load i32, ptr %4, align 4, !dbg !87
  %97 = load i32, ptr %8, align 4, !dbg !90
  %98 = icmp sgt i32 %96, %97, !dbg !91
  br i1 %98, label %103, label %99, !dbg !92

99:                                               ; preds = %95
  %100 = load i32, ptr %8, align 4, !dbg !93
  %101 = load i32, ptr %5, align 4, !dbg !94
  %102 = icmp sgt i32 %100, %101, !dbg !95
  br i1 %102, label %103, label %113, !dbg !96

103:                                              ; preds = %99, %95
  %104 = load i32, ptr %8, align 4, !dbg !97
  %105 = sext i32 %104 to i64, !dbg !99
  %106 = getelementptr inbounds [128 x i8], ptr %2, i64 0, i64 %105, !dbg !99
  %107 = load i8, ptr %106, align 1, !dbg !99
  %108 = load i32, ptr %7, align 4, !dbg !100
  %109 = sext i32 %108 to i64, !dbg !101
  %110 = getelementptr inbounds [128 x i8], ptr %6, i64 0, i64 %109, !dbg !101
  store i8 %107, ptr %110, align 1, !dbg !102
  %111 = load i32, ptr %7, align 4, !dbg !103
  %112 = add nsw i32 %111, 1, !dbg !103
  store i32 %112, ptr %7, align 4, !dbg !103
  br label %113, !dbg !104

113:                                              ; preds = %103, %99
  br label %114, !dbg !105

114:                                              ; preds = %113
  %115 = load i32, ptr %8, align 4, !dbg !106
  %116 = add nsw i32 %115, 1, !dbg !106
  store i32 %116, ptr %8, align 4, !dbg !106
  br label %84, !dbg !107, !llvm.loop !108

117:                                              ; preds = %67, %20
  %118 = call i32 @puts(ptr noundef @.str.3), !dbg !128
  store i32 0, ptr %1, align 4, !dbg !129
  br label %119, !dbg !129

119:                                              ; preds = %117, %60, %14
  %120 = load i32, ptr %1, align 4, !dbg !130
  ret i32 %120, !dbg !130
}
