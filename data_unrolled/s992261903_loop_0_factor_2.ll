...
14:                                               ; preds = %57, %0
  ...
  br i1 %19, label %20, label %60, !dbg !68
...
35:                                               ; preds = %34
  ...
  br i1 %42, label %43, label %60, !dbg !68
...
60:                                               ; preds = %35, %33, %14
  ...
  store i32 %61, ptr %3, align 4, !dbg !86
  br label %62, !dbg !87

62:                                               ; preds = %78, %60
  %63 = load i32, ptr %3, align 4, !dbg !88
  %64 = sext i32 %63 to i64, !dbg !88
  %65 = load ptr, ptr %6, align 8, !dbg !90
  %66 = call i64 @strlen(ptr noundef %65) #5, !dbg !91
  %67 = icmp ult i64 %64, %66, !dbg !92
  br i1 %67, label %68, label %81, !dbg !93

68:                                               ; preds = %62
  %69 = load ptr, ptr %6, align 8, !dbg !94
  %70 = load i32, ptr %3, align 4, !dbg !96
  %71 = sext i32 %70 to i64, !dbg !94
  %72 = getelementptr inbounds i8, ptr %69, i64 %71, !dbg !94
  %73 = load i8, ptr %72, align 1, !dbg !94
  %74 = load i32, ptr %5, align 4, !dbg !97
  %75 = add nsw i32 %74, 1, !dbg !97
  store i32 %75, ptr %5, align 4, !dbg !97
  %76 = sext i32 %74 to i64, !dbg !98
  %77 = getelementptr inbounds [100 x i8], ptr %8, i64 0, i64 %76, !dbg !98
  store i8 %73, ptr %77, align 1, !dbg !99
  br label %78, !dbg !100

78:                                               ; preds = %68
  %79 = load i32, ptr %3, align 4, !dbg !101
  %80 = add nsw i32 %79, 1, !dbg !101
  store i32 %80, ptr %3, align 4, !dbg !101
  br label %62, !dbg !102, !llvm.loop !103

81:                                               ; preds = %62
  %82 = load i32, ptr %2, align 4, !dbg !105
  store i32 %82, ptr %5, align 4, !dbg !106
  %83 = load ptr, ptr %6, align 8, !dbg !107
  %84 = call i64 @strlen(ptr noundef %83) #5, !dbg !109
  %85 = load i32, ptr %2, align 4, !dbg !110
  %86 = sext i32 %85 to i64, !dbg !110
  %87 = sub i64 %84, %86, !dbg !111
  %88 = trunc i64 %87 to i32, !dbg !109
  store i32 %88, ptr %3, align 4, !dbg !112
  br label %89, !dbg !113

89:                                               ; preds = %111, %81
  %90 = load i32, ptr %3, align 4, !dbg !114
  %91 = icmp sge i32 %90, 1, !dbg !116
  br i1 %91, label %92, label %114, !dbg !117

92:                                               ; preds = %89
  %93 = load i32, ptr %4, align 4, !dbg !118
  %94 = load i32, ptr %3, align 4, !dbg !121
  %95 = sub nsw i32 %93, %94, !dbg !122
  %96 = sext i32 %95 to i64, !dbg !123
  %97 = getelementptr inbounds [100 x i8], ptr %7, i64 0, i64 %96, !dbg !123
  %98 = load i8, ptr %97, align 1, !dbg !123
  %99 = sext i8 %98 to i32, !dbg !123
  %100 = load ptr, ptr %6, align 8, !dbg !124
  %101 = load i32, ptr %5, align 4, !dbg !125
  %102 = add nsw i32 %101, 1, !dbg !125
  store i32 %102, ptr %5, align 4, !dbg !125
  %103 = sext i32 %101 to i64, !dbg !124
  %104 = getelementptr inbounds i8, ptr %100, i64 %103, !dbg !124
  %105 = load i8, ptr %104, align 1, !dbg !124
  %106 = sext i8 %105 to i32, !dbg !124
  %107 = icmp ne i32 %99, %106, !dbg !126
  br i1 %107, label %108, label %110, !dbg !127

108:                                              ; preds = %92
  %109 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !128
  store i32 0, ptr %1, align 4, !dbg !130
  br label %116, !dbg !130

110:                                              ; preds = %92
  br label %111, !dbg !131

111:                                              ; preds = %110
  %112 = load i32, ptr %3, align 4, !dbg !132
  %113 = add nsw i32 %112, -1, !dbg !132
  store i32 %113, ptr %3, align 4, !dbg !132
  br label %89, !dbg !133, !llvm.loop !134

114:                                              ; preds = %89
  %115 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %116, !dbg !137

116:                                              ; preds = %114, %108
  %117 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %117, !dbg !138
}
