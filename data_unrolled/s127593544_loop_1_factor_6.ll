...
6067:                                             ; preds = %6063
  ...
  %6077 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !237
  %6078 = fptosi double %6077 to i64, !dbg !238
  %6079 = add nsw i64 %6076, %6078, !dbg !239
  %6080 = sub nsw i64 %6079, 1, !dbg !240
  %6081 = sdiv i64 %6080, 2, !dbg !241
  ...
  %6091 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !248
  %6092 = fptosi double %6091 to i64, !dbg !249
  %6093 = add nsw i64 %6090, %6092, !dbg !250
  %6094 = sub nsw i64 %6093, 1, !dbg !251
  %6095 = sdiv i64 %6094, 2, !dbg !252
...
6181:                                             ; preds = %6171, %6165
  ...
  %6186 = icmp eq i32 %6185, 1, !dbg !340
