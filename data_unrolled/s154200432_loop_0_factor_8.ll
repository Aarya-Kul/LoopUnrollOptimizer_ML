...
3876:                                             ; preds = %3846
  ...
  br label %3877, !dbg !78

3877:                                             ; preds = %3887, %3876
  %3878 = load i32, ptr %3, align 4, !dbg !79
  %3879 = icmp slt i32 %3878, 3, !dbg !81
  br i1 %3879, label %3880, label %3890, !dbg !82

3880:                                             ; preds = %3877
  %3881 = load i32, ptr %3, align 4, !dbg !83
  %3882 = sext i32 %3881 to i64, !dbg !85
  %3883 = getelementptr inbounds [3 x i8], ptr %2, i64 0, i64 %3882, !dbg !85
  %3884 = load i8, ptr %3883, align 1, !dbg !85
  %3885 = sext i8 %3884 to i32, !dbg !85
  %3886 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3885), !dbg !86
  br label %3887, !dbg !87

3887:                                             ; preds = %3880
  %3888 = load i32, ptr %3, align 4, !dbg !88
  %3889 = add nsw i32 %3888, 1, !dbg !88
  store i32 %3889, ptr %3, align 4, !dbg !88
  br label %3877, !dbg !89, !llvm.loop !90
