...
40:                                               ; preds = %106, %0
  ...
  br i1 %43, label %44, label %109, !dbg !89
...
73:                                               ; preds = %72
  ...
  br i1 %78, label %79, label %109, !dbg !89
...
109:                                              ; preds = %73, %40
  ...
  %110 = load i32, ptr %5, align 4, !dbg !122
  %111 = icmp ne i32 %110, 0, !dbg !122
  br i1 %111, label %112, label %113, !dbg !124
...
114:                                              ; preds = %113, %112
  %115 = load i32, ptr %8, align 4, !dbg !130
  %116 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %115), !dbg !131
...
117:                                              ; preds = %123, %114
  %118 = load i32, ptr %10, align 4, !dbg !136
  %119 = load i32, ptr %8, align 4, !dbg !138
  %120 = icmp slt i32 %118, %119, !dbg !139
  br i1 %120, label %121, label %126, !dbg !140

121:                                              ; preds = %117
  %122 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !141
  br label %123, !dbg !143

123:                                              ; preds = %121
  %124 = load i32, ptr %10, align 4, !dbg !144
  %125 = add nsw i32 %124, 1, !dbg !144
  store i32 %125, ptr %10, align 4, !dbg !144
  br label %117, !dbg !145, !llvm.loop !146

126:                                              ; preds = %117
  %127 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !148
...
128:                                              ; preds = %252, %126
  %129 = load i32, ptr %11, align 4, !dbg !153
  %130 = load i32, ptr %2, align 4, !dbg !155
  %131 = icmp slt i32 %129, %130, !dbg !156
  br i1 %131, label %132, label %255, !dbg !157

132:                                              ; preds = %128
  store i32 0, ptr %9, align 4, !dbg !158
  %133 = load ptr, ptr %3, align 8, !dbg !160
  %134 = load i32, ptr %11, align 4, !dbg !162
  %135 = sext i32 %134 to i64, !dbg !160
  %136 = getelementptr inbounds i32, ptr %133, i64 %135, !dbg !160
  %137 = load i32, ptr %136, align 4, !dbg !160
  %138 = icmp sgt i32 %137, 0, !dbg !163
  br i1 %138, label %139, label %161, !dbg !164

139:                                              ; preds = %132
  call void @llvm.dbg.declare(metadata ptr %12, metadata !165, metadata !DIExpression()), !dbg !168
  store i32 0, ptr %12, align 4, !dbg !168
  br label %140, !dbg !169

140:                                              ; preds = %150, %139
  %141 = load i32, ptr %12, align 4, !dbg !170
  %142 = load ptr, ptr %3, align 8, !dbg !172
  %143 = load i32, ptr %11, align 4, !dbg !173
  %144 = sext i32 %143 to i64, !dbg !172
  %145 = getelementptr inbounds i32, ptr %142, i64 %144, !dbg !172
  %146 = load i32, ptr %145, align 4, !dbg !172
  %147 = icmp slt i32 %141, %146, !dbg !174
  br i1 %147, label %148, label %153, !dbg !175

148:                                              ; preds = %140
  %149 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !176
  br label %150, !dbg !178

150:                                              ; preds = %148
  %151 = load i32, ptr %12, align 4, !dbg !179
  %152 = add nsw i32 %151, 1, !dbg !179
  store i32 %152, ptr %12, align 4, !dbg !179
  br label %140, !dbg !180, !llvm.loop !181

153:                                              ; preds = %140
  %154 = load ptr, ptr %3, align 8, !dbg !183
  %155 = load i32, ptr %11, align 4, !dbg !184
  %156 = sext i32 %155 to i64, !dbg !183
  %157 = getelementptr inbounds i32, ptr %154, i64 %156, !dbg !183
  %158 = load i32, ptr %157, align 4, !dbg !183
  %159 = load i32, ptr %9, align 4, !dbg !185
  %160 = add nsw i32 %159, %158, !dbg !185
  store i32 %160, ptr %9, align 4, !dbg !185
  br label %184, !dbg !186
...
162:                                              ; preds = %173, %161
  %163 = load i32, ptr %13, align 4, !dbg !192
  %164 = load ptr, ptr %3, align 8, !dbg !194
  %165 = load i32, ptr %11, align 4, !dbg !195
  %166 = sext i32 %165 to i64, !dbg !194
  %167 = getelementptr inbounds i32, ptr %164, i64 %166, !dbg !194
  %168 = load i32, ptr %167, align 4, !dbg !194
  %169 = sub nsw i32 0, %168, !dbg !196
  %170 = icmp slt i32 %163, %169, !dbg !197
  br i1 %170, label %171, label %176, !dbg !198

171:                                              ; preds = %162
  %172 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !199
  br label %173, !dbg !201

173:                                              ; preds = %171
  %174 = load i32, ptr %13, align 4, !dbg !202
  %175 = add nsw i32 %174, 1, !dbg !202
  store i32 %175, ptr %13, align 4, !dbg !202
  br label %162, !dbg !203, !llvm.loop !204

176:                                              ; preds = %162
  %177 = load ptr, ptr %3, align 8, !dbg !206
  %178 = load i32, ptr %11, align 4, !dbg !207
  %179 = sext i32 %178 to i64, !dbg !206
  %180 = getelementptr inbounds i32, ptr %177, i64 %179, !dbg !206
  %181 = load i32, ptr %180, align 4, !dbg !206
  %182 = load i32, ptr %9, align 4, !dbg !208
  %183 = sub nsw i32 %182, %181, !dbg !208
  store i32 %183, ptr %9, align 4, !dbg !208
  br label %184

184:                                              ; preds = %176, %153
  %185 = load ptr, ptr %4, align 8, !dbg !209
  %186 = load i32, ptr %11, align 4, !dbg !211
  %187 = sext i32 %186 to i64, !dbg !209
  %188 = getelementptr inbounds i32, ptr %185, i64 %187, !dbg !209
  %189 = load i32, ptr %188, align 4, !dbg !209
  %190 = icmp sgt i32 %189, 0, !dbg !212
  br i1 %190, label %191, label %213, !dbg !213

191:                                              ; preds = %184
  call void @llvm.dbg.declare(metadata ptr %14, metadata !214, metadata !DIExpression()), !dbg !217
  store i32 0, ptr %14, align 4, !dbg !217
  br label %192, !dbg !218

192:                                              ; preds = %202, %191
  %193 = load i32, ptr %14, align 4, !dbg !219
  %194 = load ptr, ptr %4, align 8, !dbg !221
  %195 = load i32, ptr %11, align 4, !dbg !222
  %196 = sext i32 %195 to i64, !dbg !221
  %197 = getelementptr inbounds i32, ptr %194, i64 %196, !dbg !221
  %198 = load i32, ptr %197, align 4, !dbg !221
  %199 = icmp slt i32 %193, %198, !dbg !223
  br i1 %199, label %200, label %205, !dbg !224

200:                                              ; preds = %192
  %201 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !225
  br label %202, !dbg !227

202:                                              ; preds = %200
  %203 = load i32, ptr %14, align 4, !dbg !228
  %204 = add nsw i32 %203, 1, !dbg !228
  store i32 %204, ptr %14, align 4, !dbg !228
  br label %192, !dbg !229, !llvm.loop !230

205:                                              ; preds = %192
  %206 = load ptr, ptr %4, align 8, !dbg !232
  %207 = load i32, ptr %11, align 4, !dbg !233
  %208 = sext i32 %207 to i64, !dbg !232
  %209 = getelementptr inbounds i32, ptr %206, i64 %208, !dbg !232
  %210 = load i32, ptr %209, align 4, !dbg !232
  %211 = load i32, ptr %9, align 4, !dbg !234
  %212 = add nsw i32 %211, %210, !dbg !234
  store i32 %212, ptr %9, align 4, !dbg !234
  br label %236, !dbg !235

213:                                              ; preds = %184
  call void @llvm.dbg.declare(metadata ptr %15, metadata !236, metadata !DIExpression()), !dbg !239
  store i32 0, ptr %15, align 4, !dbg !239
  br label %214, !dbg !240

214:                                              ; preds = %225, %213
  %215 = load i32, ptr %15, align 4, !dbg !241
  %216 = load ptr, ptr %4, align 8, !dbg !243
  %217 = load i32, ptr %11, align 4, !dbg !244
  %218 = sext i32 %217 to i64, !dbg !243
  %219 = getelementptr inbounds i32, ptr %216, i64 %218, !dbg !243
  %220 = load i32, ptr %219, align 4, !dbg !243
  %221 = sub nsw i32 0, %220, !dbg !245
  %222 = icmp slt i32 %215, %221, !dbg !246
  br i1 %222, label %223, label %228, !dbg !247

223:                                              ; preds = %214
  %224 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !248
  br label %225, !dbg !250

225:                                              ; preds = %223
  %226 = load i32, ptr %15, align 4, !dbg !251
  %227 = add nsw i32 %226, 1, !dbg !251
  store i32 %227, ptr %15, align 4, !dbg !251
  br label %214, !dbg !252, !llvm.loop !253

228:                                              ; preds = %214
  %229 = load ptr, ptr %4, align 8, !dbg !255
  %230 = load i32, ptr %11, align 4, !dbg !256
  %231 = sext i32 %230 to i64, !dbg !255
  %232 = getelementptr inbounds i32, ptr %229, i64 %231, !dbg !255
  %233 = load i32, ptr %232, align 4, !dbg !255
  %234 = load i32, ptr %9, align 4, !dbg !257
  %235 = sub nsw i32 %234, %233, !dbg !257
  store i32 %235, ptr %9, align 4, !dbg !257
  br label %236

236:                                              ; preds = %228, %205
  %237 = load i32, ptr %8, align 4, !dbg !258
  %238 = load i32, ptr %9, align 4, !dbg !259
  %239 = sub nsw i32 %237, %238, !dbg !260
  %240 = sdiv i32 %239, 2, !dbg !261
  store i32 %240, ptr %9, align 4, !dbg !262
  call void @llvm.dbg.declare(metadata ptr %16, metadata !263, metadata !DIExpression()), !dbg !265
  store i32 0, ptr %16, align 4, !dbg !265
  br label %241, !dbg !266

241:                                              ; preds = %247, %236
  %242 = load i32, ptr %16, align 4, !dbg !267
  %243 = load i32, ptr %9, align 4, !dbg !269
  %244 = icmp slt i32 %242, %243, !dbg !270
  br i1 %244, label %245, label %250, !dbg !271

245:                                              ; preds = %241
  %246 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !272
  br label %247, !dbg !274

247:                                              ; preds = %245
  %248 = load i32, ptr %16, align 4, !dbg !275
  %249 = add nsw i32 %248, 1, !dbg !275
  store i32 %249, ptr %16, align 4, !dbg !275
  br label %241, !dbg !276, !llvm.loop !277

250:                                              ; preds = %241
  %251 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !279
  br label %252, !dbg !280

252:                                              ; preds = %250
  %253 = load i32, ptr %11, align 4, !dbg !281
  %254 = add nsw i32 %253, 1, !dbg !281
  store i32 %254, ptr %11, align 4, !dbg !281
  br label %128, !dbg !282, !llvm.loop !283

255:                                              ; preds = %128
  store i32 0, ptr %1, align 4, !dbg !285
  br label %256, !dbg !285

256:                                              ; preds = %255, %70
  %257 = load i32, ptr %1, align 4, !dbg !286
  ret i32 %257, !dbg !286
}
