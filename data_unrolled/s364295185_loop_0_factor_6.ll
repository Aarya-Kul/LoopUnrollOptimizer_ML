...
774:                                              ; preds = %755, %739, %723, %707, %691, %675, %659, %643, %627, %611, %595, %579, %563, %547, %531, %515, %499, %483, %467, %451, %435, %419, %403, %387, %371, %355, %339, %323, %307, %291, %275, %259, %243, %227, %211, %195, %179, %163, %147, %131, %115, %99, %83, %67, %51, %35, %19, %5
  %775 = getelementptr inbounds [2 x i32], ptr %4, i64 0, i64 0, !dbg !59
  %776 = load i32, ptr %775, align 4, !dbg !59
  %777 = mul nsw i32 %776, 100, !dbg !60
  %778 = getelementptr inbounds [2 x i32], ptr %4, i64 0, i64 1, !dbg !61
  %779 = load i32, ptr %778, align 4, !dbg !61
  %780 = mul nsw i32 %779, 10, !dbg !62
  %781 = add nsw i32 %777, %780, !dbg !63
  %782 = getelementptr inbounds [2 x i32], ptr %4, i64 0, i64 2, !dbg !64
  %783 = load i32, ptr %782, align 4, !dbg !64
  %784 = add nsw i32 %781, %783, !dbg !65
  store i32 %784, ptr %2, align 4, !dbg !66
  %785 = load i32, ptr %2, align 4, !dbg !67
  %786 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %785), !dbg !68
  ret i32 0, !dbg !69
}
