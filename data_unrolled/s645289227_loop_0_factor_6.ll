...
314:                                              ; preds = %443, %313
  ...
  br i1 %316, label %317, label %446, !dbg !93
...
423:                                              ; preds = %420
  ...
  br label %436, !dbg !196

426:                                              ; preds = %420, %417, %410
  %427 = load i32, ptr %10, align 4, !dbg !197
  %428 = icmp eq i32 %427, 1, !dbg !200
  br i1 %428, label %432, label %429, !dbg !201

429:                                              ; preds = %426
  %430 = load i32, ptr %12, align 4, !dbg !202
  %431 = icmp eq i32 %430, 0, !dbg !203
  br i1 %431, label %432, label %435, !dbg !204

432:                                              ; preds = %429, %426
  %433 = load i32, ptr %9, align 4, !dbg !205
  %434 = add nsw i32 %433, 1, !dbg !205
  store i32 %434, ptr %9, align 4, !dbg !205
  br label %435, !dbg !207
...
442:                                              ; preds = %441, %327
  br label %443, !dbg !209

443:                                              ; preds = %442
  %444 = load i32, ptr %12, align 4, !dbg !210
  %445 = add nsw i32 %444, 1, !dbg !210
  store i32 %445, ptr %12, align 4, !dbg !210
  br label %314, !dbg !211, !llvm.loop !212

446:                                              ; preds = %314
  %447 = load i32, ptr %2, align 4, !dbg !214
  %448 = icmp sgt i32 %447, 0, !dbg !216
  br i1 %448, label %449, label %472, !dbg !217

449:                                              ; preds = %446
  %450 = load i32, ptr %3, align 4, !dbg !218
  %451 = icmp sgt i32 %450, 0, !dbg !219
  br i1 %451, label %452, label %472, !dbg !220

452:                                              ; preds = %449
  %453 = load i32, ptr %4, align 4, !dbg !221
  %454 = icmp sgt i32 %453, 0, !dbg !222
  br i1 %454, label %455, label %472, !dbg !223

455:                                              ; preds = %452
  %456 = load i32, ptr %5, align 4, !dbg !224
  %457 = icmp sgt i32 %456, 0, !dbg !225
  br i1 %457, label %458, label %472, !dbg !226

458:                                              ; preds = %455
  %459 = load i32, ptr %6, align 4, !dbg !227
  %460 = icmp sgt i32 %459, 0, !dbg !228
  br i1 %460, label %461, label %472, !dbg !229

461:                                              ; preds = %458
  %462 = load i32, ptr %7, align 4, !dbg !230
  %463 = icmp sgt i32 %462, 0, !dbg !231
  br i1 %463, label %464, label %472, !dbg !232

464:                                              ; preds = %461
  %465 = load i32, ptr %8, align 4, !dbg !233
  %466 = icmp sgt i32 %465, 0, !dbg !234
  br i1 %466, label %467, label %472, !dbg !235

467:                                              ; preds = %464
  %468 = load i32, ptr %9, align 4, !dbg !236
  %469 = icmp slt i32 %468, 2, !dbg !237
  br i1 %469, label %470, label %472, !dbg !238

470:                                              ; preds = %467
  %471 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !239
  br label %474, !dbg !241

472:                                              ; preds = %467, %464, %461, %458, %455, %452, %449, %446
  %473 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !242
  br label %474
