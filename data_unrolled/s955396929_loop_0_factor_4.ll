...
69:                                               ; preds = %259, %67
  ...
  br i1 %72, label %73, label %262, !dbg !104
...
91:                                               ; preds = %89
  ...
  br i1 %96, label %97, label %262, !dbg !104
...
115:                                              ; preds = %113
  ...
  br i1 %120, label %121, label %262, !dbg !104
...
139:                                              ; preds = %137
  ...
  br i1 %144, label %145, label %262, !dbg !104
...
163:                                              ; preds = %161
  ...
  br i1 %168, label %169, label %262, !dbg !104
...
187:                                              ; preds = %185
  ...
  br i1 %192, label %193, label %262, !dbg !104
...
211:                                              ; preds = %209
  ...
  br i1 %216, label %217, label %262, !dbg !104
...
235:                                              ; preds = %233
  ...
  br i1 %240, label %241, label %262, !dbg !104
...
262:                                              ; preds = %235, %211, %187, %163, %139, %115, %91, %69
  %263 = load i32, ptr %6, align 4, !dbg !127
  %264 = load i32, ptr %4, align 4, !dbg !128
  %265 = sext i32 %264 to i64, !dbg !129
  %266 = getelementptr inbounds [300 x [300 x i32]], ptr @T, i64 0, i64 %265, !dbg !129
  %267 = load i32, ptr %5, align 4, !dbg !130
  %268 = sext i32 %267 to i64, !dbg !129
  %269 = getelementptr inbounds [300 x i32], ptr %266, i64 0, i64 %268, !dbg !129
  store i32 %263, ptr %269, align 4, !dbg !131
  store i32 %263, ptr %3, align 4, !dbg !132
  br label %270, !dbg !132

270:                                              ; preds = %262, %55, %43, %18
  %271 = load i32, ptr %3, align 4, !dbg !133
  ret i32 %271, !dbg !133
}
