; ModuleID = 'dataset/s378479559.c'
source_filename = "dataset/s378479559.c"
...
define dso_local i32 @main() #0 !dbg !27 {
  ...
  %12 = alloca [100000000 x i8], align 16
  ...
  %14 = getelementptr inbounds [100000000 x i8], ptr %12, i64 0, i64 0, !dbg !56
  %15 = load ptr, ptr @stdin, align 8, !dbg !57
  %16 = call ptr @fgets(ptr noundef %14, i32 noundef 100000000, ptr noundef %15), !dbg !58
  %17 = getelementptr inbounds [100000000 x i8], ptr %12, i64 0, i64 0, !dbg !59
  ...
  %31 = getelementptr inbounds [100000000 x i8], ptr %12, i64 0, i64 0, !dbg !75
  %32 = load ptr, ptr @stdin, align 8, !dbg !76
  %33 = call ptr @fgets(ptr noundef %31, i32 noundef 100000000, ptr noundef %32), !dbg !77
  %34 = getelementptr inbounds [100000000 x i8], ptr %12, i64 0, i64 0, !dbg !78
...
!2 = !DIFile(filename: "dataset/s378479559.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "d6e79e5ead0fd49470ba4b6edbb73017")
...
!52 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 800000000, elements: !53)
!53 = !{!54}
!54 = !DISubrange(count: 100000000)
