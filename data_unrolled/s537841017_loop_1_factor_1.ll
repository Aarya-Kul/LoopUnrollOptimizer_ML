...
2439:                                             ; preds = %2436
  ...
  br label %2449, !dbg !196

2442:                                             ; preds = %2436, %2433, %2426
  %2443 = load i32, ptr %10, align 4, !dbg !197
  %2444 = icmp eq i32 %2443, 1, !dbg !200
  br i1 %2444, label %2445, label %2448, !dbg !201

2445:                                             ; preds = %2442
  %2446 = load i32, ptr %9, align 4, !dbg !202
  %2447 = add nsw i32 %2446, 1, !dbg !202
  store i32 %2447, ptr %9, align 4, !dbg !202
  br label %2448, !dbg !204
...
2455:                                             ; preds = %2454, %2343
  br label %2456, !dbg !206

2456:                                             ; preds = %2455
  %2457 = load i32, ptr %12, align 4, !dbg !207
  %2458 = add nsw i32 %2457, 1, !dbg !207
  store i32 %2458, ptr %12, align 4, !dbg !207
  br label %2330, !dbg !208, !llvm.loop !209

2459:                                             ; preds = %2330
  %2460 = load i32, ptr %2, align 4, !dbg !211
  %2461 = icmp sgt i32 %2460, 0, !dbg !213
  br i1 %2461, label %2462, label %2485, !dbg !214

2462:                                             ; preds = %2459
  %2463 = load i32, ptr %3, align 4, !dbg !215
  %2464 = icmp sgt i32 %2463, 0, !dbg !216
  br i1 %2464, label %2465, label %2485, !dbg !217

2465:                                             ; preds = %2462
  %2466 = load i32, ptr %4, align 4, !dbg !218
  %2467 = icmp sgt i32 %2466, 0, !dbg !219
  br i1 %2467, label %2468, label %2485, !dbg !220

2468:                                             ; preds = %2465
  %2469 = load i32, ptr %5, align 4, !dbg !221
  %2470 = icmp sgt i32 %2469, 0, !dbg !222
  br i1 %2470, label %2471, label %2485, !dbg !223

2471:                                             ; preds = %2468
  %2472 = load i32, ptr %6, align 4, !dbg !224
  %2473 = icmp sgt i32 %2472, 0, !dbg !225
  br i1 %2473, label %2474, label %2485, !dbg !226

2474:                                             ; preds = %2471
  %2475 = load i32, ptr %7, align 4, !dbg !227
  %2476 = icmp sgt i32 %2475, 0, !dbg !228
  br i1 %2476, label %2477, label %2485, !dbg !229

2477:                                             ; preds = %2474
  %2478 = load i32, ptr %8, align 4, !dbg !230
  %2479 = icmp sgt i32 %2478, 0, !dbg !231
  br i1 %2479, label %2480, label %2485, !dbg !232

2480:                                             ; preds = %2477
  %2481 = load i32, ptr %9, align 4, !dbg !233
  %2482 = icmp slt i32 %2481, 2, !dbg !234
  br i1 %2482, label %2483, label %2485, !dbg !235

2483:                                             ; preds = %2480
  %2484 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %2487, !dbg !238

2485:                                             ; preds = %2480, %2477, %2474, %2471, %2468, %2465, %2462, %2459
  %2486 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %2487
