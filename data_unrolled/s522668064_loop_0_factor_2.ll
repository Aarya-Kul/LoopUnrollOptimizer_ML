; ModuleID = 'data_unrolled/s522668064.ll'
source_filename = "dataset/s522668064.c"
...
41:                                               ; preds = %313, %38
  ...
  br i1 %44, label %45, label %316, !dbg !77
...
177:                                              ; preds = %175
  ...
  br i1 %182, label %183, label %316, !dbg !77
...
316:                                              ; preds = %177, %41
  %317 = load i64, ptr %5, align 8, !dbg !103
  %318 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i64 noundef %317), !dbg !104
...
319:                                              ; preds = %326, %316
  %320 = load i32, ptr %7, align 4, !dbg !109
  %321 = sext i32 %320 to i64, !dbg !109
  %322 = load i64, ptr %5, align 8, !dbg !111
  %323 = icmp slt i64 %321, %322, !dbg !112
  br i1 %323, label %324, label %329, !dbg !113

324:                                              ; preds = %319
  %325 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef 1), !dbg !114
  br label %326, !dbg !116

326:                                              ; preds = %324
  %327 = load i32, ptr %7, align 4, !dbg !117
  %328 = add nsw i32 %327, 1, !dbg !117
  store i32 %328, ptr %7, align 4, !dbg !117
  br label %319, !dbg !118, !llvm.loop !119

329:                                              ; preds = %319
  %330 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !121
  ...
  br label %331, !dbg !129

331:                                              ; preds = %398, %329
  %332 = load i32, ptr %10, align 4, !dbg !130
  %333 = load i32, ptr %2, align 4, !dbg !132
  %334 = icmp slt i32 %332, %333, !dbg !133
  br i1 %334, label %335, label %401, !dbg !134

335:                                              ; preds = %331
  call void @llvm.dbg.declare(metadata ptr %11, metadata !135, metadata !DIExpression()), !dbg !138
  store i32 0, ptr %11, align 4, !dbg !138
  br label %336, !dbg !139

336:                                              ; preds = %393, %335
  %337 = load i32, ptr %11, align 4, !dbg !140
  %338 = sext i32 %337 to i64, !dbg !140
  %339 = load i64, ptr %5, align 8, !dbg !142
  %340 = icmp slt i64 %338, %339, !dbg !143
  br i1 %340, label %341, label %396, !dbg !144

341:                                              ; preds = %336
  %342 = load i32, ptr %8, align 4, !dbg !145
  %343 = sext i32 %342 to i64, !dbg !145
  %344 = load i32, ptr %10, align 4, !dbg !148
  %345 = sext i32 %344 to i64, !dbg !149
  %346 = getelementptr inbounds [1010 x i64], ptr %3, i64 0, i64 %345, !dbg !149
  %347 = load i64, ptr %346, align 8, !dbg !149
  %348 = icmp slt i64 %343, %347, !dbg !150
  br i1 %348, label %349, label %353, !dbg !151

349:                                              ; preds = %341
  %350 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !152
  %351 = load i32, ptr %8, align 4, !dbg !154
  %352 = add nsw i32 %351, 1, !dbg !154
  store i32 %352, ptr %8, align 4, !dbg !154
  br label %392, !dbg !155

353:                                              ; preds = %341
  %354 = load i32, ptr %8, align 4, !dbg !156
  %355 = sext i32 %354 to i64, !dbg !156
  %356 = load i32, ptr %10, align 4, !dbg !158
  %357 = sext i32 %356 to i64, !dbg !159
  %358 = getelementptr inbounds [1010 x i64], ptr %3, i64 0, i64 %357, !dbg !159
  %359 = load i64, ptr %358, align 8, !dbg !159
  %360 = icmp sgt i64 %355, %359, !dbg !160
  br i1 %360, label %361, label %365, !dbg !161

361:                                              ; preds = %353
  %362 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !162
  %363 = load i32, ptr %8, align 4, !dbg !164
  %364 = add nsw i32 %363, -1, !dbg !164
  store i32 %364, ptr %8, align 4, !dbg !164
  br label %391, !dbg !165

365:                                              ; preds = %353
  %366 = load i32, ptr %8, align 4, !dbg !166
  %367 = sext i32 %366 to i64, !dbg !166
  %368 = load i32, ptr %10, align 4, !dbg !168
  %369 = sext i32 %368 to i64, !dbg !169
  %370 = getelementptr inbounds [1010 x i64], ptr %3, i64 0, i64 %369, !dbg !169
  %371 = load i64, ptr %370, align 8, !dbg !169
  %372 = icmp eq i64 %367, %371, !dbg !170
  br i1 %372, label %373, label %390, !dbg !171

373:                                              ; preds = %365
  %374 = load i32, ptr %9, align 4, !dbg !172
  %375 = sext i32 %374 to i64, !dbg !172
  %376 = load i32, ptr %10, align 4, !dbg !175
  %377 = sext i32 %376 to i64, !dbg !176
  %378 = getelementptr inbounds [1010 x i64], ptr %4, i64 0, i64 %377, !dbg !176
  %379 = load i64, ptr %378, align 8, !dbg !176
  %380 = icmp slt i64 %375, %379, !dbg !177
  br i1 %380, label %381, label %385, !dbg !178

381:                                              ; preds = %373
  %382 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !179
  %383 = load i32, ptr %9, align 4, !dbg !181
  %384 = add nsw i32 %383, 1, !dbg !181
  store i32 %384, ptr %9, align 4, !dbg !181
  br label %389, !dbg !182

385:                                              ; preds = %373
  %386 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !183
  %387 = load i32, ptr %9, align 4, !dbg !185
  %388 = add nsw i32 %387, -1, !dbg !185
  store i32 %388, ptr %9, align 4, !dbg !185
  br label %389

389:                                              ; preds = %385, %381
  br label %390, !dbg !186
...
392:                                              ; preds = %391, %349
  br label %393, !dbg !187

393:                                              ; preds = %392
  %394 = load i32, ptr %11, align 4, !dbg !188
  %395 = add nsw i32 %394, 1, !dbg !188
  store i32 %395, ptr %11, align 4, !dbg !188
  br label %336, !dbg !189, !llvm.loop !190

396:                                              ; preds = %336
  %397 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !192
  br label %398, !dbg !193

398:                                              ; preds = %396
  %399 = load i32, ptr %10, align 4, !dbg !194
  %400 = add nsw i32 %399, 1, !dbg !194
  store i32 %400, ptr %10, align 4, !dbg !194
  br label %331, !dbg !195, !llvm.loop !196

401:                                              ; preds = %331
  store i32 0, ptr %1, align 4, !dbg !198
  br label %402, !dbg !198

402:                                              ; preds = %401, %93
  %403 = load i32, ptr %1, align 4, !dbg !199
  ret i32 %403, !dbg !199
}
...
!2 = !DIFile(filename: "dataset/s522668064.c", directory: "/n/eecs583a/home/akulshre/LoopUnrollOptimizer_ML", checksumkind: CSK_MD5, checksum: "ff8b26a8f2a12589fa44235604ee5971")
