...
85:                                               ; preds = %142, %84
  ...
  br i1 %88, label %89, label %145, !dbg !144
...
89:                                               ; preds = %85
  ...
  %95 = call i32 @llvm.abs.i32(i32 %94, i1 true), !dbg !151
  %96 = load i32, ptr %12, align 4, !dbg !152
  %97 = load i64, ptr %7, align 8, !dbg !153
  %98 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %97, !dbg !154
  %99 = load i32, ptr %98, align 4, !dbg !154
  %100 = sub nsw i32 %96, %99, !dbg !155
  %101 = call i32 @llvm.abs.i32(i32 %100, i1 true), !dbg !156
  %102 = icmp sgt i32 %95, %101, !dbg !157
  br i1 %102, label %103, label %122, !dbg !158

103:                                              ; preds = %89
  %104 = load i64, ptr %9, align 8, !dbg !159
  %105 = load i64, ptr %7, align 8, !dbg !161
  %106 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %105, !dbg !162
  %107 = load i32, ptr %106, align 4, !dbg !162
  %108 = load i32, ptr %13, align 4, !dbg !163
  %109 = sub nsw i32 %107, %108, !dbg !164
  %110 = call i32 @llvm.abs.i32(i32 %109, i1 true), !dbg !165
  %111 = sext i32 %110 to i64, !dbg !165
  %112 = load i64, ptr %7, align 8, !dbg !166
  %113 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %112, !dbg !167
  %114 = load i32, ptr %113, align 4, !dbg !167
  %115 = sext i32 %114 to i64, !dbg !168
  %116 = getelementptr inbounds [2000 x i64], ptr %10, i64 0, i64 %115, !dbg !168
  %117 = load i64, ptr %116, align 8, !dbg !168
  %118 = mul i64 %111, %117, !dbg !169
  %119 = add i64 %104, %118, !dbg !170
  store i64 %119, ptr %9, align 8, !dbg !171
  %120 = load i32, ptr %13, align 4, !dbg !172
  %121 = add nsw i32 %120, 1, !dbg !172
  store i32 %121, ptr %13, align 4, !dbg !172
  br label %141, !dbg !173

122:                                              ; preds = %89
  %123 = load i64, ptr %9, align 8, !dbg !174
  %124 = load i32, ptr %12, align 4, !dbg !176
  %125 = load i64, ptr %7, align 8, !dbg !177
  %126 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %125, !dbg !178
  %127 = load i32, ptr %126, align 4, !dbg !178
  %128 = sub nsw i32 %124, %127, !dbg !179
  %129 = call i32 @llvm.abs.i32(i32 %128, i1 true), !dbg !180
  %130 = sext i32 %129 to i64, !dbg !180
  %131 = load i64, ptr %7, align 8, !dbg !181
  %132 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %131, !dbg !182
  %133 = load i32, ptr %132, align 4, !dbg !182
  %134 = sext i32 %133 to i64, !dbg !183
  %135 = getelementptr inbounds [2000 x i64], ptr %10, i64 0, i64 %134, !dbg !183
  %136 = load i64, ptr %135, align 8, !dbg !183
  %137 = mul i64 %130, %136, !dbg !184
  %138 = add i64 %123, %137, !dbg !185
  store i64 %138, ptr %9, align 8, !dbg !186
  %139 = load i32, ptr %12, align 4, !dbg !187
  %140 = add nsw i32 %139, -1, !dbg !187
  store i32 %140, ptr %12, align 4, !dbg !187
  br label %141

141:                                              ; preds = %122, %103
  br label %142, !dbg !188

142:                                              ; preds = %141
  %143 = load i64, ptr %7, align 8, !dbg !189
  %144 = add i64 %143, 1, !dbg !189
  store i64 %144, ptr %7, align 8, !dbg !189
  br label %85, !dbg !190, !llvm.loop !191

145:                                              ; preds = %85
  %146 = load i64, ptr %9, align 8, !dbg !193
  %147 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %146), !dbg !194
  ret i32 0, !dbg !195
}
