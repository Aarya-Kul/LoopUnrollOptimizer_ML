...
32:                                               ; preds = %25
  %33 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !67
  %34 = call i64 @strlen(ptr noundef %33) #5, !dbg !68
  %35 = sub i64 %34, 7, !dbg !69
  %36 = load i32, ptr %4, align 4, !dbg !70
  %37 = sext i32 %36 to i64, !dbg !70
  %38 = add i64 %35, %37, !dbg !71
  %39 = trunc i64 %38 to i32, !dbg !68
  store i32 %39, ptr %3, align 4, !dbg !72
  br label %40, !dbg !73

40:                                               ; preds = %60, %32
  %41 = load i32, ptr %3, align 4, !dbg !74
  %42 = sext i32 %41 to i64, !dbg !75
  %43 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 %42, !dbg !75
  %44 = load i8, ptr %43, align 1, !dbg !75
  %45 = sext i8 %44 to i32, !dbg !75
  %46 = load i32, ptr %4, align 4, !dbg !76
  %47 = sext i32 %46 to i64, !dbg !77
  %48 = getelementptr inbounds [8 x i8], ptr %5, i64 0, i64 %47, !dbg !77
  %49 = load i8, ptr %48, align 1, !dbg !77
  %50 = sext i8 %49 to i32, !dbg !77
  %51 = icmp eq i32 %45, %50, !dbg !78
  br i1 %51, label %52, label %58, !dbg !79

52:                                               ; preds = %40
  %53 = load i32, ptr %3, align 4, !dbg !80
  %54 = sext i32 %53 to i64, !dbg !80
  %55 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !81
  %56 = call i64 @strlen(ptr noundef %55) #5, !dbg !82
  %57 = icmp ult i64 %54, %56, !dbg !83
  br label %58

58:                                               ; preds = %52, %40
  %59 = phi i1 [ false, %40 ], [ %57, %52 ], !dbg !60
  br i1 %59, label %60, label %65, !dbg !73

60:                                               ; preds = %58
  %61 = load i32, ptr %3, align 4, !dbg !84
  %62 = add nsw i32 %61, 1, !dbg !84
  store i32 %62, ptr %3, align 4, !dbg !84
  %63 = load i32, ptr %4, align 4, !dbg !86
  %64 = add nsw i32 %63, 1, !dbg !86
  store i32 %64, ptr %4, align 4, !dbg !86
  br label %40, !dbg !73, !llvm.loop !87

65:                                               ; preds = %58
  %66 = load i32, ptr %3, align 4, !dbg !89
  %67 = sext i32 %66 to i64, !dbg !89
  %68 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !91
  %69 = call i64 @strlen(ptr noundef %68) #5, !dbg !92
  %70 = icmp eq i64 %67, %69, !dbg !93
  br i1 %70, label %71, label %73, !dbg !94

71:                                               ; preds = %65
  %72 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !95
  br label %75, !dbg !95

73:                                               ; preds = %65
  %74 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !96
  br label %75
