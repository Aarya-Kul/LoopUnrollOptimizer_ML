...
27:                                               ; preds = %95, %0
  ...
  br i1 %29, label %30, label %98, !dbg !63
...
60:                                               ; preds = %59
  ...
  br i1 %64, label %65, label %98, !dbg !63
...
99:                                               ; preds = %109, %98
  %100 = load i32, ptr %5, align 4, !dbg !100
  %101 = icmp slt i32 %100, 3, !dbg !102
  br i1 %101, label %102, label %112, !dbg !103

102:                                              ; preds = %99
  %103 = load i32, ptr %5, align 4, !dbg !104
  %104 = sub nsw i32 2, %103, !dbg !105
  %105 = sext i32 %104 to i64, !dbg !106
  %106 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %105, !dbg !106
  %107 = load i32, ptr %106, align 4, !dbg !106
  %108 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %107), !dbg !107
  br label %109, !dbg !107

109:                                              ; preds = %102
  %110 = load i32, ptr %5, align 4, !dbg !108
  %111 = add nsw i32 %110, 1, !dbg !108
  store i32 %111, ptr %5, align 4, !dbg !108
  br label %99, !dbg !109, !llvm.loop !110

112:                                              ; preds = %99
  %113 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !112
  ret i32 0, !dbg !113
}
