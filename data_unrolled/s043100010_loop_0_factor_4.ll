...
123:                                              ; preds = %119
  ...
  %126 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %125, !dbg !80
...
131:                                              ; preds = %123
  ...
  %134 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %133, !dbg !88
  %135 = load i32, ptr %134, align 4, !dbg !88
  %136 = sext i32 %135 to i64, !dbg !89
  %137 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %136, !dbg !89
...
140:                                              ; preds = %123
  ...
  %143 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %142, !dbg !92
  %144 = load i32, ptr %143, align 4, !dbg !92
  %145 = sext i32 %144 to i64, !dbg !93
  %146 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %145, !dbg !93
...
158:                                              ; preds = %155
  ...
  %162 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %161, !dbg !113
  %163 = load i32, ptr %162, align 4, !dbg !113
  %164 = icmp slt i32 %159, %163, !dbg !114
  br i1 %164, label %165, label %171, !dbg !115

165:                                              ; preds = %158
  %166 = load i32, ptr %3, align 4, !dbg !116
  %167 = sext i32 %166 to i64, !dbg !118
  %168 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %167, !dbg !118
...
171:                                              ; preds = %165, %158
  ...
  %175 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %174, !dbg !126
  %176 = load i32, ptr %175, align 4, !dbg !126
  %177 = icmp slt i32 %172, %176, !dbg !127
  br i1 %177, label %178, label %184, !dbg !128

178:                                              ; preds = %171
  %179 = load i32, ptr %3, align 4, !dbg !129
  %180 = sext i32 %179 to i64, !dbg !131
  %181 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %180, !dbg !131
...
197:                                              ; preds = %193
  ...
  %200 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %199, !dbg !154
...
201:                                              ; preds = %193
  ...
  %204 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %203, !dbg !157
...
206:                                              ; preds = %205
  br label %154, !dbg !100, !llvm.loop !161

207:                                              ; preds = %192
  call void @llvm.dbg.declare(metadata ptr %11, metadata !163, metadata !DIExpression()), !dbg !164
  %208 = load i32, ptr %2, align 4, !dbg !165
  %209 = load i32, ptr %8, align 4, !dbg !166
  %210 = sub nsw i32 %208, %209, !dbg !167
  %211 = load i32, ptr %7, align 4, !dbg !168
  %212 = sub nsw i32 %210, %211, !dbg !169
  store i32 %212, ptr %11, align 4, !dbg !164
  %213 = load i32, ptr %11, align 4, !dbg !170
  %214 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %213), !dbg !171
  ret i32 0, !dbg !172
}
