...
6064:                                             ; preds = %6047, %6033, %6019, %6005, %5991, %5977, %5963, %5949, %5935, %5921, %5907, %5893, %5879, %5865, %5851, %5837, %5823, %5809, %5795, %5781, %5767, %5753, %5739, %5725, %5711, %5697, %5683, %5669, %5655, %5641, %5627, %5613, %5599, %5585, %5571, %5557, %5543, %5529, %5515, %5501, %5487, %5473, %5459, %5445, %5431, %5417, %5403, %5391
  ...
  %6068 = srem i32 %6067, 2, !dbg !141
  %6069 = icmp eq i32 %6068, 0, !dbg !142
  br i1 %6069, label %6070, label %6074, !dbg !143

6070:                                             ; preds = %6064
  %6071 = load i32, ptr %4, align 4, !dbg !144
  %6072 = sdiv i32 %6071, 2, !dbg !145
  %6073 = sub nsw i32 %6072, 1, !dbg !146
  br label %6077, !dbg !143

6074:                                             ; preds = %6064
  %6075 = load i32, ptr %4, align 4, !dbg !147
  %6076 = sdiv i32 %6075, 2, !dbg !148
  br label %6077, !dbg !143

6077:                                             ; preds = %6074, %6070
  %6078 = phi i32 [ %6073, %6070 ], [ %6076, %6074 ], !dbg !143
  %6079 = sext i32 %6078 to i64, !dbg !149
  %6080 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %6079, !dbg !149
  %6081 = load i32, ptr %6080, align 4, !dbg !149
  store i32 %6081, ptr %9, align 4, !dbg !150
  store i32 0, ptr %5, align 4, !dbg !151
  br label %6082, !dbg !153

6082:                                             ; preds = %6094, %6077
  %6083 = load i32, ptr %5, align 4, !dbg !154
  %6084 = load i32, ptr %4, align 4, !dbg !156
  %6085 = icmp slt i32 %6083, %6084, !dbg !157
  br i1 %6085, label %6086, label %6097, !dbg !158

6086:                                             ; preds = %6082
  %6087 = load i32, ptr %5, align 4, !dbg !159
  %6088 = sext i32 %6087 to i64, !dbg !161
  %6089 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %6088, !dbg !161
  %6090 = load i32, ptr %6089, align 4, !dbg !161
  %6091 = load i32, ptr %5, align 4, !dbg !162
  %6092 = sext i32 %6091 to i64, !dbg !163
  %6093 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %6092, !dbg !163
  store i32 %6090, ptr %6093, align 4, !dbg !164
  br label %6094, !dbg !165

6094:                                             ; preds = %6086
  %6095 = load i32, ptr %5, align 4, !dbg !166
  %6096 = add nsw i32 %6095, 1, !dbg !166
  store i32 %6096, ptr %5, align 4, !dbg !166
  br label %6082, !dbg !167, !llvm.loop !168

6097:                                             ; preds = %6082
  %6098 = load i32, ptr %4, align 4, !dbg !170
  %6099 = sext i32 %6098 to i64, !dbg !170
  call void @qsort(ptr noundef @house_sort, i64 noundef %6099, i64 noundef 4, ptr noundef @qsort_comp), !dbg !171
  %6100 = load i32, ptr %4, align 4, !dbg !172
  %6101 = srem i32 %6100, 2, !dbg !173
  %6102 = icmp eq i32 %6101, 0, !dbg !174
  br i1 %6102, label %6103, label %6107, !dbg !175

6103:                                             ; preds = %6097
  %6104 = load i32, ptr %4, align 4, !dbg !176
  %6105 = sdiv i32 %6104, 2, !dbg !177
  %6106 = sub nsw i32 %6105, 1, !dbg !178
  br label %6110, !dbg !175

6107:                                             ; preds = %6097
  %6108 = load i32, ptr %4, align 4, !dbg !179
  %6109 = sdiv i32 %6108, 2, !dbg !180
  br label %6110, !dbg !175

6110:                                             ; preds = %6107, %6103
  %6111 = phi i32 [ %6106, %6103 ], [ %6109, %6107 ], !dbg !175
  %6112 = sext i32 %6111 to i64, !dbg !181
  %6113 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %6112, !dbg !181
  %6114 = load i32, ptr %6113, align 4, !dbg !181
  store i32 %6114, ptr %10, align 4, !dbg !182
  store i64 0, ptr %7, align 8, !dbg !183
  store i64 0, ptr %8, align 8, !dbg !184
  store i32 0, ptr %5, align 4, !dbg !185
  br label %6115, !dbg !187

6115:                                             ; preds = %6146, %6110
  %6116 = load i32, ptr %5, align 4, !dbg !188
  %6117 = load i32, ptr %4, align 4, !dbg !190
  %6118 = icmp slt i32 %6116, %6117, !dbg !191
  br i1 %6118, label %6119, label %6149, !dbg !192

6119:                                             ; preds = %6115
  %6120 = load i32, ptr %5, align 4, !dbg !193
  %6121 = sext i32 %6120 to i64, !dbg !195
  %6122 = getelementptr inbounds [100000 x i32], ptr @house_x, i64 0, i64 %6121, !dbg !195
  %6123 = load i32, ptr %6122, align 4, !dbg !195
  %6124 = load i32, ptr %9, align 4, !dbg !196
  %6125 = sub nsw i32 %6123, %6124, !dbg !197
  %6126 = call i32 @llvm.abs.i32(i32 %6125, i1 true), !dbg !198
  %6127 = load i32, ptr %5, align 4, !dbg !199
  %6128 = sext i32 %6127 to i64, !dbg !200
  %6129 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %6128, !dbg !200
  %6130 = load i32, ptr %6129, align 4, !dbg !200
  %6131 = load i32, ptr %10, align 4, !dbg !201
  %6132 = sub nsw i32 %6130, %6131, !dbg !202
  %6133 = call i32 @llvm.abs.i32(i32 %6132, i1 true), !dbg !203
  %6134 = add nsw i32 %6126, %6133, !dbg !204
  %6135 = sext i32 %6134 to i64, !dbg !198
  store i64 %6135, ptr %6, align 8, !dbg !205
  %6136 = load i64, ptr %6, align 8, !dbg !206
  %6137 = mul nsw i64 %6136, 2, !dbg !207
  %6138 = load i64, ptr %7, align 8, !dbg !208
  %6139 = add nsw i64 %6138, %6137, !dbg !208
  store i64 %6139, ptr %7, align 8, !dbg !208
  %6140 = load i64, ptr %6, align 8, !dbg !209
  %6141 = load i64, ptr %8, align 8, !dbg !211
  %6142 = icmp sgt i64 %6140, %6141, !dbg !212
  br i1 %6142, label %6143, label %6145, !dbg !213

6143:                                             ; preds = %6119
  %6144 = load i64, ptr %6, align 8, !dbg !214
  store i64 %6144, ptr %8, align 8, !dbg !215
  br label %6145, !dbg !216

6145:                                             ; preds = %6143, %6119
  br label %6146, !dbg !217

6146:                                             ; preds = %6145
  %6147 = load i32, ptr %5, align 4, !dbg !218
  %6148 = add nsw i32 %6147, 1, !dbg !218
  store i32 %6148, ptr %5, align 4, !dbg !218
  br label %6115, !dbg !219, !llvm.loop !220

6149:                                             ; preds = %6115
  %6150 = load i64, ptr %8, align 8, !dbg !222
  %6151 = load i64, ptr %7, align 8, !dbg !223
  %6152 = sub nsw i64 %6151, %6150, !dbg !223
  store i64 %6152, ptr %7, align 8, !dbg !223
  %6153 = load i64, ptr %7, align 8, !dbg !224
  %6154 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %6153), !dbg !225
  %6155 = load i32, ptr %9, align 4, !dbg !226
  %6156 = load i32, ptr %10, align 4, !dbg !227
  %6157 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %6155, i32 noundef %6156), !dbg !228
  %6158 = load i32, ptr %1, align 4, !dbg !229
  ret i32 %6158, !dbg !229
}
