...
6946:                                             ; preds = %6945
  ...
  br i1 %6950, label %6951, label %6976, !dbg !65
...
6976:                                             ; preds = %6946, %6921
  %6977 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 0, !dbg !92
  %6978 = load i32, ptr %6977, align 4, !dbg !92
  %6979 = mul nsw i32 %6978, 100, !dbg !93
  %6980 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 1, !dbg !94
  %6981 = load i32, ptr %6980, align 4, !dbg !94
  %6982 = mul nsw i32 %6981, 10, !dbg !95
  %6983 = add nsw i32 %6979, %6982, !dbg !96
  %6984 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !97
  %6985 = load i32, ptr %6984, align 4, !dbg !97
  %6986 = add nsw i32 %6983, %6985, !dbg !98
  store i32 %6986, ptr %2, align 4, !dbg !99
  %6987 = load i32, ptr %2, align 4, !dbg !100
  %6988 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %6987), !dbg !101
  ret i32 0, !dbg !102
}
