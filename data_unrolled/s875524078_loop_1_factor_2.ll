...
6543:                                             ; preds = %6895, %6540
  ...
  br i1 %6547, label %6548, label %6898, !dbg !98
...
6718:                                             ; preds = %6717
  ...
  br i1 %6724, label %6725, label %6898, !dbg !98
...
6898:                                             ; preds = %6718, %6543
  %6899 = load i64, ptr %3, align 8, !dbg !254
  %6900 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %6899), !dbg !255
  %6901 = load i32, ptr %1, align 4, !dbg !256
  ret i32 %6901, !dbg !256
}
