...
4754:                                             ; preds = %4753
  ...
  br i1 %4758, label %4759, label %4885, !dbg !93
...
4885:                                             ; preds = %4754, %4628
  %4886 = load i32, ptr %2, align 4, !dbg !211
  %4887 = icmp sgt i32 %4886, 0, !dbg !213
  br i1 %4887, label %4888, label %4911, !dbg !214

4888:                                             ; preds = %4885
  %4889 = load i32, ptr %3, align 4, !dbg !215
  %4890 = icmp sgt i32 %4889, 0, !dbg !216
  br i1 %4890, label %4891, label %4911, !dbg !217

4891:                                             ; preds = %4888
  %4892 = load i32, ptr %4, align 4, !dbg !218
  %4893 = icmp sgt i32 %4892, 0, !dbg !219
  br i1 %4893, label %4894, label %4911, !dbg !220

4894:                                             ; preds = %4891
  %4895 = load i32, ptr %5, align 4, !dbg !221
  %4896 = icmp sgt i32 %4895, 0, !dbg !222
  br i1 %4896, label %4897, label %4911, !dbg !223

4897:                                             ; preds = %4894
  %4898 = load i32, ptr %6, align 4, !dbg !224
  %4899 = icmp sgt i32 %4898, 0, !dbg !225
  br i1 %4899, label %4900, label %4911, !dbg !226

4900:                                             ; preds = %4897
  %4901 = load i32, ptr %7, align 4, !dbg !227
  %4902 = icmp sgt i32 %4901, 0, !dbg !228
  br i1 %4902, label %4903, label %4911, !dbg !229

4903:                                             ; preds = %4900
  %4904 = load i32, ptr %8, align 4, !dbg !230
  %4905 = icmp sgt i32 %4904, 0, !dbg !231
  br i1 %4905, label %4906, label %4911, !dbg !232

4906:                                             ; preds = %4903
  %4907 = load i32, ptr %9, align 4, !dbg !233
  %4908 = icmp slt i32 %4907, 2, !dbg !234
  br i1 %4908, label %4909, label %4911, !dbg !235

4909:                                             ; preds = %4906
  %4910 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %4913, !dbg !238

4911:                                             ; preds = %4906, %4903, %4900, %4897, %4894, %4891, %4888, %4885
  %4912 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %4913
