...
3866:                                             ; preds = %3854, %3851
  ...
  br i1 %3867, label %3868, label %3892, !dbg !76
...
3886:                                             ; preds = %3874, %3869
  ...
  br i1 %3887, label %3888, label %3892, !dbg !76
...
3892:                                             ; preds = %3886, %3866
  store i32 0, ptr %4, align 4, !dbg !81
  br label %3893, !dbg !83

3893:                                             ; preds = %3915, %3892
  %3894 = load i32, ptr %4, align 4, !dbg !84
  %3895 = icmp slt i32 %3894, 7, !dbg !86
  br i1 %3895, label %3896, label %3912, !dbg !87

3896:                                             ; preds = %3893
  %3897 = load i32, ptr %2, align 4, !dbg !88
  %3898 = sub nsw i32 %3897, 1, !dbg !89
  %3899 = load i32, ptr %4, align 4, !dbg !90
  %3900 = sub nsw i32 %3898, %3899, !dbg !91
  %3901 = sext i32 %3900 to i64, !dbg !92
  %3902 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %3901, !dbg !92
  %3903 = load i8, ptr %3902, align 1, !dbg !92
  %3904 = sext i8 %3903 to i32, !dbg !92
  %3905 = load i32, ptr %4, align 4, !dbg !93
  %3906 = sub nsw i32 6, %3905, !dbg !94
  %3907 = sext i32 %3906 to i64, !dbg !95
  %3908 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %3907, !dbg !95
  %3909 = load i8, ptr %3908, align 1, !dbg !95
  %3910 = sext i8 %3909 to i32, !dbg !95
  %3911 = icmp eq i32 %3904, %3910, !dbg !96
  br label %3912

3912:                                             ; preds = %3896, %3893
  %3913 = phi i1 [ false, %3893 ], [ %3911, %3896 ], !dbg !97
  br i1 %3913, label %3914, label %3918, !dbg !98

3914:                                             ; preds = %3912
  br label %3915, !dbg !98

3915:                                             ; preds = %3914
  %3916 = load i32, ptr %4, align 4, !dbg !99
  %3917 = add nsw i32 %3916, 1, !dbg !99
  store i32 %3917, ptr %4, align 4, !dbg !99
  br label %3893, !dbg !100, !llvm.loop !101

3918:                                             ; preds = %3912
  %3919 = load i32, ptr %3, align 4, !dbg !103
  %3920 = load i32, ptr %4, align 4, !dbg !105
  %3921 = add nsw i32 %3919, %3920, !dbg !106
  %3922 = icmp sge i32 %3921, 7, !dbg !107
  br i1 %3922, label %3923, label %3925, !dbg !108

3923:                                             ; preds = %3918
  %3924 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !109
  br label %3927, !dbg !111

3925:                                             ; preds = %3918
  %3926 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !112
  br label %3927
