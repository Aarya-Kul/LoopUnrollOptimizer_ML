...
5504:                                             ; preds = %5487, %5473, %5459, %5445, %5431, %5417, %5403, %5391
  ...
  %5508 = srem i32 %5507, 2, !dbg !141
  %5509 = icmp eq i32 %5508, 0, !dbg !142
  br i1 %5509, label %5510, label %5514, !dbg !143

5510:                                             ; preds = %5504
  %5511 = load i32, ptr %4, align 4, !dbg !144
  %5512 = sdiv i32 %5511, 2, !dbg !145
  %5513 = sub nsw i32 %5512, 1, !dbg !146
  br label %5517, !dbg !143

5514:                                             ; preds = %5504
  %5515 = load i32, ptr %4, align 4, !dbg !147
  %5516 = sdiv i32 %5515, 2, !dbg !148
  br label %5517, !dbg !143

5517:                                             ; preds = %5514, %5510
  %5518 = phi i32 [ %5513, %5510 ], [ %5516, %5514 ], !dbg !143
  %5519 = sext i32 %5518 to i64, !dbg !149
  %5520 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %5519, !dbg !149
  %5521 = load i32, ptr %5520, align 4, !dbg !149
  store i32 %5521, ptr %9, align 4, !dbg !150
  store i32 0, ptr %5, align 4, !dbg !151
  br label %5522, !dbg !153

5522:                                             ; preds = %5534, %5517
  %5523 = load i32, ptr %5, align 4, !dbg !154
  %5524 = load i32, ptr %4, align 4, !dbg !156
  %5525 = icmp slt i32 %5523, %5524, !dbg !157
  br i1 %5525, label %5526, label %5537, !dbg !158

5526:                                             ; preds = %5522
  %5527 = load i32, ptr %5, align 4, !dbg !159
  %5528 = sext i32 %5527 to i64, !dbg !161
  %5529 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %5528, !dbg !161
  %5530 = load i32, ptr %5529, align 4, !dbg !161
  %5531 = load i32, ptr %5, align 4, !dbg !162
  %5532 = sext i32 %5531 to i64, !dbg !163
  %5533 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %5532, !dbg !163
  store i32 %5530, ptr %5533, align 4, !dbg !164
  br label %5534, !dbg !165

5534:                                             ; preds = %5526
  %5535 = load i32, ptr %5, align 4, !dbg !166
  %5536 = add nsw i32 %5535, 1, !dbg !166
  store i32 %5536, ptr %5, align 4, !dbg !166
  br label %5522, !dbg !167, !llvm.loop !168

5537:                                             ; preds = %5522
  %5538 = load i32, ptr %4, align 4, !dbg !170
  %5539 = sext i32 %5538 to i64, !dbg !170
  call void @qsort(ptr noundef @house_sort, i64 noundef %5539, i64 noundef 4, ptr noundef @qsort_comp), !dbg !171
  %5540 = load i32, ptr %4, align 4, !dbg !172
  %5541 = srem i32 %5540, 2, !dbg !173
  %5542 = icmp eq i32 %5541, 0, !dbg !174
  br i1 %5542, label %5543, label %5547, !dbg !175

5543:                                             ; preds = %5537
  %5544 = load i32, ptr %4, align 4, !dbg !176
  %5545 = sdiv i32 %5544, 2, !dbg !177
  %5546 = sub nsw i32 %5545, 1, !dbg !178
  br label %5550, !dbg !175

5547:                                             ; preds = %5537
  %5548 = load i32, ptr %4, align 4, !dbg !179
  %5549 = sdiv i32 %5548, 2, !dbg !180
  br label %5550, !dbg !175

5550:                                             ; preds = %5547, %5543
  %5551 = phi i32 [ %5546, %5543 ], [ %5549, %5547 ], !dbg !175
  %5552 = sext i32 %5551 to i64, !dbg !181
  %5553 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %5552, !dbg !181
  %5554 = load i32, ptr %5553, align 4, !dbg !181
  store i32 %5554, ptr %10, align 4, !dbg !182
  store i64 0, ptr %7, align 8, !dbg !183
  store i64 0, ptr %8, align 8, !dbg !184
  store i32 0, ptr %5, align 4, !dbg !185
  br label %5555, !dbg !187

5555:                                             ; preds = %5586, %5550
  %5556 = load i32, ptr %5, align 4, !dbg !188
  %5557 = load i32, ptr %4, align 4, !dbg !190
  %5558 = icmp slt i32 %5556, %5557, !dbg !191
  br i1 %5558, label %5559, label %5589, !dbg !192

5559:                                             ; preds = %5555
  %5560 = load i32, ptr %5, align 4, !dbg !193
  %5561 = sext i32 %5560 to i64, !dbg !195
  %5562 = getelementptr inbounds [100000 x i32], ptr @house_x, i64 0, i64 %5561, !dbg !195
  %5563 = load i32, ptr %5562, align 4, !dbg !195
  %5564 = load i32, ptr %9, align 4, !dbg !196
  %5565 = sub nsw i32 %5563, %5564, !dbg !197
  %5566 = call i32 @llvm.abs.i32(i32 %5565, i1 true), !dbg !198
  %5567 = load i32, ptr %5, align 4, !dbg !199
  %5568 = sext i32 %5567 to i64, !dbg !200
  %5569 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %5568, !dbg !200
  %5570 = load i32, ptr %5569, align 4, !dbg !200
  %5571 = load i32, ptr %10, align 4, !dbg !201
  %5572 = sub nsw i32 %5570, %5571, !dbg !202
  %5573 = call i32 @llvm.abs.i32(i32 %5572, i1 true), !dbg !203
  %5574 = add nsw i32 %5566, %5573, !dbg !204
  %5575 = sext i32 %5574 to i64, !dbg !198
  store i64 %5575, ptr %6, align 8, !dbg !205
  %5576 = load i64, ptr %6, align 8, !dbg !206
  %5577 = mul nsw i64 %5576, 2, !dbg !207
  %5578 = load i64, ptr %7, align 8, !dbg !208
  %5579 = add nsw i64 %5578, %5577, !dbg !208
  store i64 %5579, ptr %7, align 8, !dbg !208
  %5580 = load i64, ptr %6, align 8, !dbg !209
  %5581 = load i64, ptr %8, align 8, !dbg !211
  %5582 = icmp sgt i64 %5580, %5581, !dbg !212
  br i1 %5582, label %5583, label %5585, !dbg !213

5583:                                             ; preds = %5559
  %5584 = load i64, ptr %6, align 8, !dbg !214
  store i64 %5584, ptr %8, align 8, !dbg !215
  br label %5585, !dbg !216

5585:                                             ; preds = %5583, %5559
  br label %5586, !dbg !217

5586:                                             ; preds = %5585
  %5587 = load i32, ptr %5, align 4, !dbg !218
  %5588 = add nsw i32 %5587, 1, !dbg !218
  store i32 %5588, ptr %5, align 4, !dbg !218
  br label %5555, !dbg !219, !llvm.loop !220

5589:                                             ; preds = %5555
  %5590 = load i64, ptr %8, align 8, !dbg !222
  %5591 = load i64, ptr %7, align 8, !dbg !223
  %5592 = sub nsw i64 %5591, %5590, !dbg !223
  store i64 %5592, ptr %7, align 8, !dbg !223
  %5593 = load i64, ptr %7, align 8, !dbg !224
  %5594 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %5593), !dbg !225
  %5595 = load i32, ptr %9, align 4, !dbg !226
  %5596 = load i32, ptr %10, align 4, !dbg !227
  %5597 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %5595, i32 noundef %5596), !dbg !228
  %5598 = load i32, ptr %1, align 4, !dbg !229
  ret i32 %5598, !dbg !229
}
