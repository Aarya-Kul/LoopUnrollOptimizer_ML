...
4326:                                             ; preds = %4241
  %4327 = load i64, ptr %12, align 8, !dbg !162
  %4328 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %4327), !dbg !163
  %4329 = load ptr, ptr @stdout, align 8, !dbg !164
  %4330 = call i32 @fflush(ptr noundef %4329), !dbg !165
  ret i32 0, !dbg !166
}
