...
2721:                                             ; preds = %2718
  ...
  br label %2731, !dbg !196

2724:                                             ; preds = %2718, %2715, %2708
  %2725 = load i32, ptr %10, align 4, !dbg !197
  %2726 = icmp eq i32 %2725, 1, !dbg !200
  br i1 %2726, label %2727, label %2730, !dbg !201

2727:                                             ; preds = %2724
  %2728 = load i32, ptr %9, align 4, !dbg !202
  %2729 = add nsw i32 %2728, 1, !dbg !202
  store i32 %2729, ptr %9, align 4, !dbg !202
  br label %2730, !dbg !204

2730:                                             ; preds = %2727, %2724
  store i32 0, ptr %10, align 4, !dbg !205
  br label %2731

2731:                                             ; preds = %2730, %2721
  br label %2732

2732:                                             ; preds = %2731, %2705
  br label %2733

2733:                                             ; preds = %2732, %2689
  br label %2734

2734:                                             ; preds = %2733, %2673
  br label %2735

2735:                                             ; preds = %2734, %2657
  br label %2736

2736:                                             ; preds = %2735, %2641
  br label %2737

2737:                                             ; preds = %2736, %2625
  br label %2738, !dbg !206

2738:                                             ; preds = %2737
  %2739 = load i32, ptr %12, align 4, !dbg !207
  %2740 = add nsw i32 %2739, 1, !dbg !207
  store i32 %2740, ptr %12, align 4, !dbg !207
  br label %2612, !dbg !208, !llvm.loop !209

2741:                                             ; preds = %2612
  %2742 = load i32, ptr %2, align 4, !dbg !211
  %2743 = icmp sgt i32 %2742, 0, !dbg !213
  br i1 %2743, label %2744, label %2767, !dbg !214

2744:                                             ; preds = %2741
  %2745 = load i32, ptr %3, align 4, !dbg !215
  %2746 = icmp sgt i32 %2745, 0, !dbg !216
  br i1 %2746, label %2747, label %2767, !dbg !217

2747:                                             ; preds = %2744
  %2748 = load i32, ptr %4, align 4, !dbg !218
  %2749 = icmp sgt i32 %2748, 0, !dbg !219
  br i1 %2749, label %2750, label %2767, !dbg !220

2750:                                             ; preds = %2747
  %2751 = load i32, ptr %5, align 4, !dbg !221
  %2752 = icmp sgt i32 %2751, 0, !dbg !222
  br i1 %2752, label %2753, label %2767, !dbg !223

2753:                                             ; preds = %2750
  %2754 = load i32, ptr %6, align 4, !dbg !224
  %2755 = icmp sgt i32 %2754, 0, !dbg !225
  br i1 %2755, label %2756, label %2767, !dbg !226

2756:                                             ; preds = %2753
  %2757 = load i32, ptr %7, align 4, !dbg !227
  %2758 = icmp sgt i32 %2757, 0, !dbg !228
  br i1 %2758, label %2759, label %2767, !dbg !229

2759:                                             ; preds = %2756
  %2760 = load i32, ptr %8, align 4, !dbg !230
  %2761 = icmp sgt i32 %2760, 0, !dbg !231
  br i1 %2761, label %2762, label %2767, !dbg !232

2762:                                             ; preds = %2759
  %2763 = load i32, ptr %9, align 4, !dbg !233
  %2764 = icmp slt i32 %2763, 2, !dbg !234
  br i1 %2764, label %2765, label %2767, !dbg !235

2765:                                             ; preds = %2762
  %2766 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %2769, !dbg !238

2767:                                             ; preds = %2762, %2759, %2756, %2753, %2750, %2747, %2744, %2741
  %2768 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %2769
