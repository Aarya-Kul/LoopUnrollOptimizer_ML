...
8848:                                             ; preds = %8889, %8845
  ...
  br i1 %8852, label %8853, label %8892, !dbg !90
...
8892:                                             ; preds = %8848
  ...
  br label %8893, !dbg !139

8893:                                             ; preds = %8936, %8892
  %8894 = load i32, ptr %7, align 4, !dbg !140
  %8895 = load i32, ptr %2, align 4, !dbg !142
  %8896 = sdiv i32 %8895, 2, !dbg !143
  %8897 = icmp slt i32 %8894, %8896, !dbg !144
  br i1 %8897, label %8898, label %8939, !dbg !145

8898:                                             ; preds = %8893
  store i32 1, ptr %5, align 4, !dbg !146
  store i32 0, ptr %8, align 4, !dbg !148
  br label %8899, !dbg !150

8899:                                             ; preds = %8932, %8898
  %8900 = load i32, ptr %8, align 4, !dbg !151
  %8901 = load i32, ptr %2, align 4, !dbg !153
  %8902 = sdiv i32 %8901, 2, !dbg !154
  %8903 = icmp slt i32 %8900, %8902, !dbg !155
  br i1 %8903, label %8904, label %8935, !dbg !156

8904:                                             ; preds = %8899
  %8905 = load i32, ptr %7, align 4, !dbg !157
  %8906 = sext i32 %8905 to i64, !dbg !160
  %8907 = getelementptr inbounds [100000 x i32], ptr %4, i64 0, i64 %8906, !dbg !160
  %8908 = load i32, ptr %8907, align 4, !dbg !160
  %8909 = load i32, ptr %8, align 4, !dbg !161
  %8910 = sext i32 %8909 to i64, !dbg !162
  %8911 = getelementptr inbounds [100000 x i32], ptr %4, i64 0, i64 %8910, !dbg !162
  %8912 = load i32, ptr %8911, align 4, !dbg !162
  %8913 = icmp eq i32 %8908, %8912, !dbg !163
  br i1 %8913, label %8914, label %8917, !dbg !164

8914:                                             ; preds = %8904
  %8915 = load i32, ptr %5, align 4, !dbg !165
  %8916 = add nsw i32 %8915, 1, !dbg !165
  store i32 %8916, ptr %5, align 4, !dbg !165
  br label %8917, !dbg !167

8917:                                             ; preds = %8914, %8904
  %8918 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 1, !dbg !168
  %8919 = load i32, ptr %8918, align 4, !dbg !168
  %8920 = load i32, ptr %5, align 4, !dbg !170
  %8921 = sub nsw i32 %8920, 1, !dbg !171
  %8922 = icmp slt i32 %8919, %8921, !dbg !172
  br i1 %8922, label %8923, label %8931, !dbg !173

8923:                                             ; preds = %8917
  %8924 = load i32, ptr %5, align 4, !dbg !174
  %8925 = sub nsw i32 %8924, 1, !dbg !176
  %8926 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 1, !dbg !177
  store i32 %8925, ptr %8926, align 4, !dbg !178
  %8927 = load i32, ptr %7, align 4, !dbg !179
  %8928 = sext i32 %8927 to i64, !dbg !180
  %8929 = getelementptr inbounds [100000 x i32], ptr %4, i64 0, i64 %8928, !dbg !180
  %8930 = load i32, ptr %8929, align 4, !dbg !180
  store i32 %8930, ptr %9, align 4, !dbg !181
  br label %8931, !dbg !182

8931:                                             ; preds = %8923, %8917
  br label %8932, !dbg !183

8932:                                             ; preds = %8931
  %8933 = load i32, ptr %8, align 4, !dbg !184
  %8934 = add nsw i32 %8933, 1, !dbg !184
  store i32 %8934, ptr %8, align 4, !dbg !184
  br label %8899, !dbg !185, !llvm.loop !186

8935:                                             ; preds = %8899
  br label %8936, !dbg !188

8936:                                             ; preds = %8935
  %8937 = load i32, ptr %7, align 4, !dbg !189
  %8938 = add nsw i32 %8937, 1, !dbg !189
  store i32 %8938, ptr %7, align 4, !dbg !189
  br label %8893, !dbg !190, !llvm.loop !191

8939:                                             ; preds = %8893
  %8940 = load i32, ptr %9, align 4, !dbg !193
  %8941 = load i32, ptr %6, align 4, !dbg !195
  %8942 = icmp ne i32 %8940, %8941, !dbg !196
  br i1 %8942, label %8943, label %8952, !dbg !197

8943:                                             ; preds = %8939
  %8944 = load i32, ptr %2, align 4, !dbg !198
  %8945 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 1, !dbg !200
  %8946 = load i32, ptr %8945, align 4, !dbg !200
  %8947 = sub nsw i32 %8944, %8946, !dbg !201
  %8948 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 0, !dbg !202
  %8949 = load i32, ptr %8948, align 4, !dbg !202
  %8950 = sub nsw i32 %8947, %8949, !dbg !203
  %8951 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %8950), !dbg !204
  br label %8971, !dbg !205

8952:                                             ; preds = %8939
  %8953 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 0, !dbg !206
  %8954 = load i32, ptr %8953, align 4, !dbg !206
  %8955 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 1, !dbg !209
  %8956 = load i32, ptr %8955, align 4, !dbg !209
  %8957 = icmp slt i32 %8954, %8956, !dbg !210
  br i1 %8957, label %8958, label %8964, !dbg !211

8958:                                             ; preds = %8952
  %8959 = load i32, ptr %2, align 4, !dbg !212
  %8960 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 1, !dbg !214
  %8961 = load i32, ptr %8960, align 4, !dbg !214
  %8962 = sub nsw i32 %8959, %8961, !dbg !215
  %8963 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %8962), !dbg !216
  br label %8970, !dbg !217

8964:                                             ; preds = %8952
  %8965 = load i32, ptr %2, align 4, !dbg !218
  %8966 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 0, !dbg !220
  %8967 = load i32, ptr %8966, align 4, !dbg !220
  %8968 = sub nsw i32 %8965, %8967, !dbg !221
  %8969 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %8968), !dbg !222
  br label %8970

8970:                                             ; preds = %8964, %8958
  br label %8971

8971:                                             ; preds = %8970, %8943
  ret i32 0, !dbg !223
}
