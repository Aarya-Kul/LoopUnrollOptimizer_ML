...
305:                                              ; preds = %379, %303
  ...
  br i1 %308, label %309, label %382, !dbg !344
...
356:                                              ; preds = %374, %355
  ...
  %363 = load i32, ptr %10, align 4, !dbg !409
  %364 = sext i32 %363 to i64, !dbg !410
  %365 = getelementptr inbounds i32, ptr %21, i64 %364, !dbg !410
  %366 = load i32, ptr %365, align 4, !dbg !410
  %367 = add nsw i32 %362, %366, !dbg !411
  %368 = call i32 @llvm.abs.i32(i32 %367, i1 true), !dbg !412
  %369 = sub nsw i32 %358, %368, !dbg !413
  %370 = sdiv i32 %369, 2, !dbg !414
  %371 = icmp slt i32 %357, %370, !dbg !415
  br i1 %371, label %372, label %377, !dbg !416

372:                                              ; preds = %356
  %373 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %374, !dbg !419

374:                                              ; preds = %372
  %375 = load i32, ptr %13, align 4, !dbg !420
  %376 = add nsw i32 %375, 1, !dbg !420
  store i32 %376, ptr %13, align 4, !dbg !420
  br label %356, !dbg !421, !llvm.loop !422

377:                                              ; preds = %356
  %378 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %379, !dbg !425

379:                                              ; preds = %377
  %380 = load i32, ptr %10, align 4, !dbg !426
  %381 = add nsw i32 %380, 1, !dbg !426
  store i32 %381, ptr %10, align 4, !dbg !426
  br label %305, !dbg !427, !llvm.loop !428

382:                                              ; preds = %305
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %383, !dbg !430

383:                                              ; preds = %382, %51
  %384 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %384), !dbg !431
  %385 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %385, !dbg !431
}
