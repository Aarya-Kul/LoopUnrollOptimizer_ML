...
8897:                                             ; preds = %8885, %8867
  %8898 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %8899, !dbg !137

8899:                                             ; preds = %8897, %8891, %25, %14
  %8900 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %8900, !dbg !138
}
