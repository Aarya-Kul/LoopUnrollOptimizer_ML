...
4314:                                             ; preds = %4246
  %4315 = load i64, ptr %6, align 8, !dbg !147
  %4316 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %4315), !dbg !148
  %4317 = load ptr, ptr %3, align 8, !dbg !149
  call void @llvm.stackrestore.p0(ptr %4317), !dbg !149
  %4318 = load i32, ptr %1, align 4, !dbg !149
  ret i32 %4318, !dbg !149
}
