...
4804:                                             ; preds = %4649
  %4805 = load i32, ptr %10, align 4, !dbg !278
  %4806 = icmp sgt i32 %4805, 0, !dbg !280
  br i1 %4806, label %4807, label %4809, !dbg !281

4807:                                             ; preds = %4804
  %4808 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !282
  br label %4811, !dbg !284

4809:                                             ; preds = %4804
  %4810 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !285
  br label %4811

4811:                                             ; preds = %4809, %4807
  br label %4812

4812:                                             ; preds = %4811, %4647
  ret i32 0, !dbg !287
}
