...
12388:                                            ; preds = %12406, %12387
  ...
  %12395 = load i32, ptr %10, align 4, !dbg !409
  %12396 = sext i32 %12395 to i64, !dbg !410
  %12397 = getelementptr inbounds i32, ptr %21, i64 %12396, !dbg !410
  %12398 = load i32, ptr %12397, align 4, !dbg !410
  %12399 = add nsw i32 %12394, %12398, !dbg !411
  %12400 = call i32 @llvm.abs.i32(i32 %12399, i1 true), !dbg !412
  %12401 = sub nsw i32 %12390, %12400, !dbg !413
  %12402 = sdiv i32 %12401, 2, !dbg !414
  %12403 = icmp slt i32 %12389, %12402, !dbg !415
  br i1 %12403, label %12404, label %12409, !dbg !416

12404:                                            ; preds = %12388
  %12405 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %12406, !dbg !419

12406:                                            ; preds = %12404
  %12407 = load i32, ptr %13, align 4, !dbg !420
  %12408 = add nsw i32 %12407, 1, !dbg !420
  store i32 %12408, ptr %13, align 4, !dbg !420
  br label %12388, !dbg !421, !llvm.loop !422

12409:                                            ; preds = %12388
  %12410 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %12411, !dbg !425

12411:                                            ; preds = %12409
  %12412 = load i32, ptr %10, align 4, !dbg !426
  %12413 = add nsw i32 %12412, 1, !dbg !426
  store i32 %12413, ptr %10, align 4, !dbg !426
  br label %12337, !dbg !427, !llvm.loop !428

12414:                                            ; preds = %12337
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %12415, !dbg !430

12415:                                            ; preds = %12414, %51
  %12416 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %12416), !dbg !431
  %12417 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %12417, !dbg !431
}
