...
5784:                                             ; preds = %5765
  %5785 = load i64, ptr @n, align 8, !dbg !242
  call void @qsort(ptr noundef @a, i64 noundef %5785, i64 noundef 16, ptr noundef @cmp), !dbg !243
  %5786 = load i64, ptr @n, align 8, !dbg !244
  %5787 = call i64 @search(i64 noundef 1, i64 noundef %5786), !dbg !245
  %5788 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %5787), !dbg !246
  ret i32 0, !dbg !247
}
