...
6:                                                ; preds = %19, %0
  ...
  br i1 %8, label %9, label %22, !dbg !46
...
9:                                                ; preds = %6
  ...
  %16 = zext i1 %15 to i64, !dbg !49
  %17 = select i1 %15, ptr @.str.1, ptr @.str.2, !dbg !49
  %18 = call i32 (ptr, ...) @printf(ptr noundef %17), !dbg !51
  br label %19, !dbg !52

19:                                               ; preds = %9
  %20 = load i32, ptr %2, align 4, !dbg !53
  %21 = add nsw i32 %20, 1, !dbg !53
  store i32 %21, ptr %2, align 4, !dbg !53
  br label %6, !dbg !54, !llvm.loop !55

22:                                               ; preds = %6
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !58
  ret i32 0, !dbg !59
}
