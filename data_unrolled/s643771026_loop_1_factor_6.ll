...
2721:                                             ; preds = %2718
  ...
  br label %2741, !dbg !195

2724:                                             ; preds = %2718, %2715, %2708
  %2725 = load i32, ptr %10, align 4, !dbg !196
  %2726 = icmp eq i32 %2725, 1, !dbg !199
  br i1 %2726, label %2727, label %2730, !dbg !200

2727:                                             ; preds = %2724
  %2728 = load i32, ptr %9, align 4, !dbg !201
  %2729 = add nsw i32 %2728, 1, !dbg !201
  store i32 %2729, ptr %9, align 4, !dbg !201
  br label %2730, !dbg !203
...
2737:                                             ; preds = %2736, %2625
  br label %2738, !dbg !205

2738:                                             ; preds = %2737
  %2739 = load i32, ptr %12, align 4, !dbg !206
  %2740 = add nsw i32 %2739, 1, !dbg !206
  store i32 %2740, ptr %12, align 4, !dbg !206
  br label %2612, !dbg !207, !llvm.loop !208

2741:                                             ; preds = %2721, %2612
  %2742 = load i32, ptr %2, align 4, !dbg !210
  %2743 = icmp sgt i32 %2742, 0, !dbg !212
  br i1 %2743, label %2744, label %2767, !dbg !213

2744:                                             ; preds = %2741
  %2745 = load i32, ptr %3, align 4, !dbg !214
  %2746 = icmp sgt i32 %2745, 0, !dbg !215
  br i1 %2746, label %2747, label %2767, !dbg !216

2747:                                             ; preds = %2744
  %2748 = load i32, ptr %4, align 4, !dbg !217
  %2749 = icmp sgt i32 %2748, 0, !dbg !218
  br i1 %2749, label %2750, label %2767, !dbg !219

2750:                                             ; preds = %2747
  %2751 = load i32, ptr %5, align 4, !dbg !220
  %2752 = icmp sgt i32 %2751, 0, !dbg !221
  br i1 %2752, label %2753, label %2767, !dbg !222

2753:                                             ; preds = %2750
  %2754 = load i32, ptr %6, align 4, !dbg !223
  %2755 = icmp sgt i32 %2754, 0, !dbg !224
  br i1 %2755, label %2756, label %2767, !dbg !225

2756:                                             ; preds = %2753
  %2757 = load i32, ptr %7, align 4, !dbg !226
  %2758 = icmp sgt i32 %2757, 0, !dbg !227
  br i1 %2758, label %2759, label %2767, !dbg !228

2759:                                             ; preds = %2756
  %2760 = load i32, ptr %8, align 4, !dbg !229
  %2761 = icmp sgt i32 %2760, 0, !dbg !230
  br i1 %2761, label %2762, label %2767, !dbg !231

2762:                                             ; preds = %2759
  %2763 = load i32, ptr %9, align 4, !dbg !232
  %2764 = icmp slt i32 %2763, 2, !dbg !233
  br i1 %2764, label %2765, label %2767, !dbg !234

2765:                                             ; preds = %2762
  %2766 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %2769, !dbg !237

2767:                                             ; preds = %2762, %2759, %2756, %2753, %2750, %2747, %2744, %2741
  %2768 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %2769
