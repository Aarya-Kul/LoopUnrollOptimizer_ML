...
7:                                                ; preds = %206, %6
  ...
  br i1 %10, label %11, label %209, !dbg !185
...
17:                                               ; preds = %187, %162, %137, %112, %87, %62, %37, %11
  store i32 1, ptr %1, align 4, !dbg !193
  br label %214, !dbg !193
...
31:                                               ; preds = %18
  ...
  br i1 %36, label %37, label %209, !dbg !185
...
56:                                               ; preds = %43
  ...
  br i1 %61, label %62, label %209, !dbg !185
...
81:                                               ; preds = %68
  ...
  br i1 %86, label %87, label %209, !dbg !185
...
106:                                              ; preds = %93
  ...
  br i1 %111, label %112, label %209, !dbg !185
...
131:                                              ; preds = %118
  ...
  br i1 %136, label %137, label %209, !dbg !185
...
156:                                              ; preds = %143
  ...
  br i1 %161, label %162, label %209, !dbg !185
...
181:                                              ; preds = %168
  ...
  br i1 %186, label %187, label %209, !dbg !185
...
209:                                              ; preds = %181, %156, %131, %106, %81, %56, %31, %7
  %210 = load i32, ptr @N, align 4, !dbg !210
  %211 = sext i32 %210 to i64, !dbg !210
  call void @qsort(ptr noundef @h, i64 noundef %211, i64 noundef 8, ptr noundef @cmp), !dbg !211
  %212 = call i64 @search(i32 noundef 0, i32 noundef 0), !dbg !212
  %213 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %212), !dbg !213
  store i32 0, ptr %1, align 4, !dbg !214
  br label %214, !dbg !214

214:                                              ; preds = %209, %17, %5
  %215 = load i32, ptr %1, align 4, !dbg !215
  ret i32 %215, !dbg !215
}
