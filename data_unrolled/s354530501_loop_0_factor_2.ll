...
21:                                               ; preds = %85, %0
  ...
  br i1 %24, label %25, label %88, !dbg !278
...
53:                                               ; preds = %52
  ...
  br i1 %58, label %59, label %88, !dbg !278
...
88:                                               ; preds = %53, %21
  %89 = getelementptr inbounds i32, ptr %17, i64 0, !dbg !309
  %90 = load i32, ptr %89, align 16, !dbg !309
  %91 = getelementptr inbounds i32, ptr %20, i64 0, !dbg !310
  %92 = load i32, ptr %91, align 16, !dbg !310
  %93 = add nsw i32 %90, %92, !dbg !311
  %94 = call i32 @llvm.abs.i32(i32 %93, i1 true), !dbg !312
  %95 = srem i32 %94, 2, !dbg !313
  %96 = load i32, ptr %3, align 4, !dbg !314
  %97 = sub nsw i32 %96, %95, !dbg !314
  store i32 %97, ptr %3, align 4, !dbg !314
  %98 = load i32, ptr %3, align 4, !dbg !315
  %99 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %98, i32 noundef 1, i32 noundef 1), !dbg !316
  call void @llvm.dbg.declare(metadata ptr %9, metadata !317, metadata !DIExpression()), !dbg !319
  store i32 0, ptr %9, align 4, !dbg !319
  br label %100, !dbg !320

100:                                              ; preds = %174, %88
  %101 = load i32, ptr %9, align 4, !dbg !321
  %102 = load i32, ptr %2, align 4, !dbg !323
  %103 = icmp slt i32 %101, %102, !dbg !324
  br i1 %103, label %104, label %177, !dbg !325

104:                                              ; preds = %100
  call void @llvm.dbg.declare(metadata ptr %10, metadata !326, metadata !DIExpression()), !dbg !329
  store i32 0, ptr %10, align 4, !dbg !329
  br label %105, !dbg !330

105:                                              ; preds = %124, %104
  %106 = load i32, ptr %10, align 4, !dbg !331
  %107 = load i32, ptr %9, align 4, !dbg !333
  %108 = sext i32 %107 to i64, !dbg !334
  %109 = getelementptr inbounds i32, ptr %17, i64 %108, !dbg !334
  %110 = load i32, ptr %109, align 4, !dbg !334
  %111 = call i32 @llvm.abs.i32(i32 %110, i1 true), !dbg !335
  %112 = icmp slt i32 %106, %111, !dbg !336
  br i1 %112, label %113, label %127, !dbg !337

113:                                              ; preds = %105
  %114 = load i32, ptr %9, align 4, !dbg !338
  %115 = sext i32 %114 to i64, !dbg !341
  %116 = getelementptr inbounds i32, ptr %17, i64 %115, !dbg !341
  %117 = load i32, ptr %116, align 4, !dbg !341
  %118 = icmp sgt i32 %117, 0, !dbg !342
  br i1 %118, label %119, label %121, !dbg !343

119:                                              ; preds = %113
  %120 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !344
  br label %123, !dbg !346

121:                                              ; preds = %113
  %122 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !347
  br label %123
...
124:                                              ; preds = %123
  %125 = load i32, ptr %10, align 4, !dbg !350
  %126 = add nsw i32 %125, 1, !dbg !350
  store i32 %126, ptr %10, align 4, !dbg !350
  br label %105, !dbg !351, !llvm.loop !352
...
128:                                              ; preds = %147, %127
  %129 = load i32, ptr %11, align 4, !dbg !358
  %130 = load i32, ptr %9, align 4, !dbg !360
  %131 = sext i32 %130 to i64, !dbg !361
  %132 = getelementptr inbounds i32, ptr %20, i64 %131, !dbg !361
  %133 = load i32, ptr %132, align 4, !dbg !361
  %134 = call i32 @llvm.abs.i32(i32 %133, i1 true), !dbg !362
  %135 = icmp slt i32 %129, %134, !dbg !363
  br i1 %135, label %136, label %150, !dbg !364

136:                                              ; preds = %128
  %137 = load i32, ptr %9, align 4, !dbg !365
  %138 = sext i32 %137 to i64, !dbg !368
  %139 = getelementptr inbounds i32, ptr %20, i64 %138, !dbg !368
  %140 = load i32, ptr %139, align 4, !dbg !368
  %141 = icmp sgt i32 %140, 0, !dbg !369
  br i1 %141, label %142, label %144, !dbg !370

142:                                              ; preds = %136
  %143 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !371
  br label %146, !dbg !373

144:                                              ; preds = %136
  %145 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !374
  br label %146

146:                                              ; preds = %144, %142
  br label %147, !dbg !376

147:                                              ; preds = %146
  %148 = load i32, ptr %11, align 4, !dbg !377
  %149 = add nsw i32 %148, 1, !dbg !377
  store i32 %149, ptr %11, align 4, !dbg !377
  br label %128, !dbg !378, !llvm.loop !379

150:                                              ; preds = %128
  call void @llvm.dbg.declare(metadata ptr %12, metadata !381, metadata !DIExpression()), !dbg !383
  store i32 0, ptr %12, align 4, !dbg !383
  br label %151, !dbg !384

151:                                              ; preds = %169, %150
  %152 = load i32, ptr %12, align 4, !dbg !385
  %153 = load i32, ptr %3, align 4, !dbg !387
  %154 = load i32, ptr %9, align 4, !dbg !388
  %155 = sext i32 %154 to i64, !dbg !389
  %156 = getelementptr inbounds i32, ptr %17, i64 %155, !dbg !389
  %157 = load i32, ptr %156, align 4, !dbg !389
  %158 = load i32, ptr %9, align 4, !dbg !390
  %159 = sext i32 %158 to i64, !dbg !391
  %160 = getelementptr inbounds i32, ptr %20, i64 %159, !dbg !391
  %161 = load i32, ptr %160, align 4, !dbg !391
  %162 = add nsw i32 %157, %161, !dbg !392
  %163 = call i32 @llvm.abs.i32(i32 %162, i1 true), !dbg !393
  %164 = sub nsw i32 %153, %163, !dbg !394
  %165 = sdiv i32 %164, 2, !dbg !395
  %166 = icmp slt i32 %152, %165, !dbg !396
  br i1 %166, label %167, label %172, !dbg !397

167:                                              ; preds = %151
  %168 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !398
  br label %169, !dbg !400

169:                                              ; preds = %167
  %170 = load i32, ptr %12, align 4, !dbg !401
  %171 = add nsw i32 %170, 1, !dbg !401
  store i32 %171, ptr %12, align 4, !dbg !401
  br label %151, !dbg !402, !llvm.loop !403

172:                                              ; preds = %151
  %173 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !405
  br label %174, !dbg !406

174:                                              ; preds = %172
  %175 = load i32, ptr %9, align 4, !dbg !407
  %176 = add nsw i32 %175, 1, !dbg !407
  store i32 %176, ptr %9, align 4, !dbg !407
  br label %100, !dbg !408, !llvm.loop !409

177:                                              ; preds = %100
  store i32 0, ptr %1, align 4, !dbg !411
  store i32 1, ptr %8, align 4
  br label %178, !dbg !411

178:                                              ; preds = %177, %50
  %179 = load ptr, ptr %4, align 8, !dbg !412
  call void @llvm.stackrestore.p0(ptr %179), !dbg !412
  %180 = load i32, ptr %1, align 4, !dbg !412
  ret i32 %180, !dbg !412
}
