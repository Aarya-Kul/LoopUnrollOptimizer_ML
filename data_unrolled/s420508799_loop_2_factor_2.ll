...
define dso_local i32 @main() #0 !dbg !110 {
  ...
  br i1 %19, label %20, label %164, !dbg !127
...
106:                                              ; preds = %156, %103
  ...
  br i1 %108, label %109, label %157, !dbg !193
...
132:                                              ; preds = %125
  ...
  br i1 %134, label %135, label %157, !dbg !193
...
157:                                              ; preds = %132, %130, %106
  %158 = load i32, ptr %7, align 4, !dbg !216
  %159 = icmp eq i32 %158, 1, !dbg !218
  br i1 %159, label %160, label %162, !dbg !219

160:                                              ; preds = %157
  %161 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !220
  br label %162, !dbg !222
...
164:                                              ; preds = %0
  %165 = load ptr, ptr %2, align 8, !dbg !224
  %166 = load i32, ptr %4, align 4, !dbg !227
  %167 = sub nsw i32 %166, 7, !dbg !228
  %168 = sext i32 %167 to i64, !dbg !224
  %169 = getelementptr inbounds i8, ptr %165, i64 %168, !dbg !224
  %170 = load i8, ptr %169, align 1, !dbg !224
  %171 = sext i8 %170 to i32, !dbg !224
  %172 = load ptr, ptr %3, align 8, !dbg !229
  %173 = getelementptr inbounds i8, ptr %172, i64 0, !dbg !229
  %174 = load i8, ptr %173, align 1, !dbg !229
  %175 = sext i8 %174 to i32, !dbg !229
  %176 = icmp eq i32 %171, %175, !dbg !230
  br i1 %176, label %177, label %257, !dbg !231

177:                                              ; preds = %164
  %178 = load ptr, ptr %2, align 8, !dbg !232
  %179 = load i32, ptr %4, align 4, !dbg !233
  %180 = sub nsw i32 %179, 6, !dbg !234
  %181 = sext i32 %180 to i64, !dbg !232
  %182 = getelementptr inbounds i8, ptr %178, i64 %181, !dbg !232
  %183 = load i8, ptr %182, align 1, !dbg !232
  %184 = sext i8 %183 to i32, !dbg !232
  %185 = load ptr, ptr %3, align 8, !dbg !235
  %186 = getelementptr inbounds i8, ptr %185, i64 1, !dbg !235
  %187 = load i8, ptr %186, align 1, !dbg !235
  %188 = sext i8 %187 to i32, !dbg !235
  %189 = icmp eq i32 %184, %188, !dbg !236
  br i1 %189, label %190, label %257, !dbg !237

190:                                              ; preds = %177
  %191 = load ptr, ptr %2, align 8, !dbg !238
  %192 = load i32, ptr %4, align 4, !dbg !239
  %193 = sub nsw i32 %192, 5, !dbg !240
  %194 = sext i32 %193 to i64, !dbg !238
  %195 = getelementptr inbounds i8, ptr %191, i64 %194, !dbg !238
  %196 = load i8, ptr %195, align 1, !dbg !238
  %197 = sext i8 %196 to i32, !dbg !238
  %198 = load ptr, ptr %3, align 8, !dbg !241
  %199 = getelementptr inbounds i8, ptr %198, i64 2, !dbg !241
  %200 = load i8, ptr %199, align 1, !dbg !241
  %201 = sext i8 %200 to i32, !dbg !241
  %202 = icmp eq i32 %197, %201, !dbg !242
  br i1 %202, label %203, label %257, !dbg !243

203:                                              ; preds = %190
  %204 = load ptr, ptr %2, align 8, !dbg !244
  %205 = load i32, ptr %4, align 4, !dbg !245
  %206 = sub nsw i32 %205, 4, !dbg !246
  %207 = sext i32 %206 to i64, !dbg !244
  %208 = getelementptr inbounds i8, ptr %204, i64 %207, !dbg !244
  %209 = load i8, ptr %208, align 1, !dbg !244
  %210 = sext i8 %209 to i32, !dbg !244
  %211 = load ptr, ptr %3, align 8, !dbg !247
  %212 = getelementptr inbounds i8, ptr %211, i64 3, !dbg !247
  %213 = load i8, ptr %212, align 1, !dbg !247
  %214 = sext i8 %213 to i32, !dbg !247
  %215 = icmp eq i32 %210, %214, !dbg !248
  br i1 %215, label %216, label %257, !dbg !249

216:                                              ; preds = %203
  %217 = load ptr, ptr %2, align 8, !dbg !250
  %218 = load i32, ptr %4, align 4, !dbg !251
  %219 = sub nsw i32 %218, 3, !dbg !252
  %220 = sext i32 %219 to i64, !dbg !250
  %221 = getelementptr inbounds i8, ptr %217, i64 %220, !dbg !250
  %222 = load i8, ptr %221, align 1, !dbg !250
  %223 = sext i8 %222 to i32, !dbg !250
  %224 = load ptr, ptr %3, align 8, !dbg !253
  %225 = getelementptr inbounds i8, ptr %224, i64 4, !dbg !253
  %226 = load i8, ptr %225, align 1, !dbg !253
  %227 = sext i8 %226 to i32, !dbg !253
  %228 = icmp eq i32 %223, %227, !dbg !254
  br i1 %228, label %229, label %257, !dbg !255

229:                                              ; preds = %216
  %230 = load ptr, ptr %2, align 8, !dbg !256
  %231 = load i32, ptr %4, align 4, !dbg !257
  %232 = sub nsw i32 %231, 2, !dbg !258
  %233 = sext i32 %232 to i64, !dbg !256
  %234 = getelementptr inbounds i8, ptr %230, i64 %233, !dbg !256
  %235 = load i8, ptr %234, align 1, !dbg !256
  %236 = sext i8 %235 to i32, !dbg !256
  %237 = load ptr, ptr %3, align 8, !dbg !259
  %238 = getelementptr inbounds i8, ptr %237, i64 5, !dbg !259
  %239 = load i8, ptr %238, align 1, !dbg !259
  %240 = sext i8 %239 to i32, !dbg !259
  %241 = icmp eq i32 %236, %240, !dbg !260
  br i1 %241, label %242, label %257, !dbg !261

242:                                              ; preds = %229
  %243 = load ptr, ptr %2, align 8, !dbg !262
  %244 = load i32, ptr %4, align 4, !dbg !263
  %245 = sub nsw i32 %244, 1, !dbg !264
  %246 = sext i32 %245 to i64, !dbg !262
  %247 = getelementptr inbounds i8, ptr %243, i64 %246, !dbg !262
  %248 = load i8, ptr %247, align 1, !dbg !262
  %249 = sext i8 %248 to i32, !dbg !262
  %250 = load ptr, ptr %3, align 8, !dbg !265
  %251 = getelementptr inbounds i8, ptr %250, i64 6, !dbg !265
  %252 = load i8, ptr %251, align 1, !dbg !265
  %253 = sext i8 %252 to i32, !dbg !265
  %254 = icmp eq i32 %249, %253, !dbg !266
  br i1 %254, label %255, label %257, !dbg !267

255:                                              ; preds = %242
  %256 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !268
  br label %259, !dbg !270

257:                                              ; preds = %242, %229, %216, %203, %190, %177, %164
  %258 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !271
  br label %259
