...
5426:                                             ; preds = %5405
  %5427 = load i32, ptr @max, align 4, !dbg !195
  %5428 = sext i32 %5427 to i64, !dbg !195
  %5429 = load i64, ptr %8, align 8, !dbg !196
  %5430 = sub nsw i64 %5429, %5428, !dbg !196
  store i64 %5430, ptr %8, align 8, !dbg !196
  %5431 = load i64, ptr %8, align 8, !dbg !197
  %5432 = load i32, ptr %6, align 4, !dbg !198
  %5433 = load i32, ptr %7, align 4, !dbg !199
  %5434 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %5431, i32 noundef %5432, i32 noundef %5433), !dbg !200
  ret i32 0, !dbg !201
}
