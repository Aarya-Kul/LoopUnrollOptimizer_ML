...
5776:                                             ; preds = %5835, %5775
  ...
  br i1 %5780, label %5781, label %5838, !dbg !75
...
5838:                                             ; preds = %5776
  %5839 = load i32, ptr %7, align 4, !dbg !141
  %5840 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5839), !dbg !142
  call void @llvm.dbg.declare(metadata ptr %12, metadata !143, metadata !DIExpression()), !dbg !145
  store i32 0, ptr %12, align 4, !dbg !145
  br label %5841, !dbg !146

5841:                                             ; preds = %5851, %5838
  %5842 = load i32, ptr %12, align 4, !dbg !147
  %5843 = load i32, ptr %2, align 4, !dbg !149
  %5844 = icmp slt i32 %5842, %5843, !dbg !150
  br i1 %5844, label %5845, label %5854, !dbg !151

5845:                                             ; preds = %5841
  %5846 = load i32, ptr %12, align 4, !dbg !152
  %5847 = sext i32 %5846 to i64, !dbg !153
  %5848 = getelementptr inbounds [2000 x i32], ptr %4, i64 0, i64 %5847, !dbg !153
  %5849 = load i32, ptr %5848, align 4, !dbg !153
  %5850 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5849), !dbg !154
  br label %5851, !dbg !154

5851:                                             ; preds = %5845
  %5852 = load i32, ptr %12, align 4, !dbg !155
  %5853 = add nsw i32 %5852, 1, !dbg !155
  store i32 %5853, ptr %12, align 4, !dbg !155
  br label %5841, !dbg !156, !llvm.loop !157
