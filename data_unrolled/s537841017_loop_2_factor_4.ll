...
5653:                                             ; preds = %5522, %5394, %5266, %5138, %5010, %4882, %4754, %4628
  %5654 = load i32, ptr %2, align 4, !dbg !211
  %5655 = icmp sgt i32 %5654, 0, !dbg !213
  br i1 %5655, label %5656, label %5679, !dbg !214

5656:                                             ; preds = %5653
  %5657 = load i32, ptr %3, align 4, !dbg !215
  %5658 = icmp sgt i32 %5657, 0, !dbg !216
  br i1 %5658, label %5659, label %5679, !dbg !217

5659:                                             ; preds = %5656
  %5660 = load i32, ptr %4, align 4, !dbg !218
  %5661 = icmp sgt i32 %5660, 0, !dbg !219
  br i1 %5661, label %5662, label %5679, !dbg !220

5662:                                             ; preds = %5659
  %5663 = load i32, ptr %5, align 4, !dbg !221
  %5664 = icmp sgt i32 %5663, 0, !dbg !222
  br i1 %5664, label %5665, label %5679, !dbg !223

5665:                                             ; preds = %5662
  %5666 = load i32, ptr %6, align 4, !dbg !224
  %5667 = icmp sgt i32 %5666, 0, !dbg !225
  br i1 %5667, label %5668, label %5679, !dbg !226

5668:                                             ; preds = %5665
  %5669 = load i32, ptr %7, align 4, !dbg !227
  %5670 = icmp sgt i32 %5669, 0, !dbg !228
  br i1 %5670, label %5671, label %5679, !dbg !229

5671:                                             ; preds = %5668
  %5672 = load i32, ptr %8, align 4, !dbg !230
  %5673 = icmp sgt i32 %5672, 0, !dbg !231
  br i1 %5673, label %5674, label %5679, !dbg !232

5674:                                             ; preds = %5671
  %5675 = load i32, ptr %9, align 4, !dbg !233
  %5676 = icmp slt i32 %5675, 2, !dbg !234
  br i1 %5676, label %5677, label %5679, !dbg !235

5677:                                             ; preds = %5674
  %5678 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %5681, !dbg !238

5679:                                             ; preds = %5674, %5671, %5668, %5665, %5662, %5659, %5656, %5653
  %5680 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %5681
