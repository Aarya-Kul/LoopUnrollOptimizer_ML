...
2450:                                             ; preds = %2449
  ...
  br i1 %2454, label %2455, label %2581, !dbg !79
...
2581:                                             ; preds = %2450, %2430, %2321
  %2582 = load i32, ptr %2, align 4, !dbg !200
  %2583 = icmp sgt i32 %2582, 0, !dbg !202
  br i1 %2583, label %2584, label %2607, !dbg !203

2584:                                             ; preds = %2581
  %2585 = load i32, ptr %3, align 4, !dbg !204
  %2586 = icmp sgt i32 %2585, 0, !dbg !205
  br i1 %2586, label %2587, label %2607, !dbg !206

2587:                                             ; preds = %2584
  %2588 = load i32, ptr %4, align 4, !dbg !207
  %2589 = icmp sgt i32 %2588, 0, !dbg !208
  br i1 %2589, label %2590, label %2607, !dbg !209

2590:                                             ; preds = %2587
  %2591 = load i32, ptr %5, align 4, !dbg !210
  %2592 = icmp sgt i32 %2591, 0, !dbg !211
  br i1 %2592, label %2593, label %2607, !dbg !212

2593:                                             ; preds = %2590
  %2594 = load i32, ptr %6, align 4, !dbg !213
  %2595 = icmp sgt i32 %2594, 0, !dbg !214
  br i1 %2595, label %2596, label %2607, !dbg !215

2596:                                             ; preds = %2593
  %2597 = load i32, ptr %7, align 4, !dbg !216
  %2598 = icmp sgt i32 %2597, 0, !dbg !217
  br i1 %2598, label %2599, label %2607, !dbg !218

2599:                                             ; preds = %2596
  %2600 = load i32, ptr %8, align 4, !dbg !219
  %2601 = icmp sgt i32 %2600, 0, !dbg !220
  br i1 %2601, label %2602, label %2607, !dbg !221

2602:                                             ; preds = %2599
  %2603 = load i32, ptr %9, align 4, !dbg !222
  %2604 = icmp slt i32 %2603, 2, !dbg !223
  br i1 %2604, label %2605, label %2607, !dbg !224

2605:                                             ; preds = %2602
  %2606 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !225
  br label %2609, !dbg !227

2607:                                             ; preds = %2602, %2599, %2596, %2593, %2590, %2587, %2584, %2581
  %2608 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !228
  br label %2609
