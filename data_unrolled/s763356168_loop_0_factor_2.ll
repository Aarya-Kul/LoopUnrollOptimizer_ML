...
9:                                                ; preds = %421, %0
  ...
  br i1 %15, label %16, label %424, !dbg !47
...
218:                                              ; preds = %217, %43
  ...
  br i1 %226, label %227, label %424, !dbg !47
...
424:                                              ; preds = %218, %210, %195, %182, %154, %126, %98, %70, %42, %9
  %425 = load i8, ptr %3, align 1, !dbg !252
  %426 = sext i8 %425 to i32, !dbg !252
  %427 = icmp sle i32 %426, 1, !dbg !254
  br i1 %427, label %428, label %434, !dbg !255

428:                                              ; preds = %424
  %429 = load i8, ptr %5, align 1, !dbg !256
  %430 = sext i8 %429 to i32, !dbg !256
  %431 = icmp eq i32 %430, 7, !dbg !257
  br i1 %431, label %432, label %434, !dbg !258

432:                                              ; preds = %428
  %433 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !259
  br label %436, !dbg !259

434:                                              ; preds = %428, %424
  %435 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !260
  br label %436
