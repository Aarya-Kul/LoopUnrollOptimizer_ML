...
11:                                               ; preds = %122, %0
  ...
  br i1 %15, label %16, label %125, !dbg !59
...
66:                                               ; preds = %65
  ...
  br i1 %72, label %73, label %125, !dbg !59
...
125:                                              ; preds = %66, %63, %11
  %126 = load i32, ptr %5, align 4, !dbg !114
  %127 = icmp eq i32 %126, 7, !dbg !116
  br i1 %127, label %128, label %130, !dbg !117

128:                                              ; preds = %125
  %129 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !118
  br label %132, !dbg !118

130:                                              ; preds = %125
  %131 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !119
  br label %132

132:                                              ; preds = %130, %128
  %133 = load i32, ptr %1, align 4, !dbg !120
  ret i32 %133, !dbg !120
}
