...
183:                                              ; preds = %180
  ...
  br label %193, !dbg !196

186:                                              ; preds = %180, %177, %170
  %187 = load i32, ptr %10, align 4, !dbg !197
  %188 = icmp eq i32 %187, 1, !dbg !200
  br i1 %188, label %189, label %192, !dbg !201

189:                                              ; preds = %186
  %190 = load i32, ptr %9, align 4, !dbg !202
  %191 = add nsw i32 %190, 1, !dbg !202
  store i32 %191, ptr %9, align 4, !dbg !202
  br label %192, !dbg !204
...
199:                                              ; preds = %198, %87
  br label %200, !dbg !206

200:                                              ; preds = %199
  %201 = load i32, ptr %12, align 4, !dbg !207
  %202 = add nsw i32 %201, 1, !dbg !207
  store i32 %202, ptr %12, align 4, !dbg !207
  br label %74, !dbg !208, !llvm.loop !209

203:                                              ; preds = %74
  %204 = load i32, ptr %2, align 4, !dbg !211
  %205 = icmp sgt i32 %204, 0, !dbg !213
  br i1 %205, label %206, label %229, !dbg !214

206:                                              ; preds = %203
  %207 = load i32, ptr %3, align 4, !dbg !215
  %208 = icmp sgt i32 %207, 0, !dbg !216
  br i1 %208, label %209, label %229, !dbg !217

209:                                              ; preds = %206
  %210 = load i32, ptr %4, align 4, !dbg !218
  %211 = icmp sgt i32 %210, 0, !dbg !219
  br i1 %211, label %212, label %229, !dbg !220

212:                                              ; preds = %209
  %213 = load i32, ptr %5, align 4, !dbg !221
  %214 = icmp sgt i32 %213, 0, !dbg !222
  br i1 %214, label %215, label %229, !dbg !223

215:                                              ; preds = %212
  %216 = load i32, ptr %6, align 4, !dbg !224
  %217 = icmp sgt i32 %216, 0, !dbg !225
  br i1 %217, label %218, label %229, !dbg !226

218:                                              ; preds = %215
  %219 = load i32, ptr %7, align 4, !dbg !227
  %220 = icmp sgt i32 %219, 0, !dbg !228
  br i1 %220, label %221, label %229, !dbg !229

221:                                              ; preds = %218
  %222 = load i32, ptr %8, align 4, !dbg !230
  %223 = icmp sgt i32 %222, 0, !dbg !231
  br i1 %223, label %224, label %229, !dbg !232

224:                                              ; preds = %221
  %225 = load i32, ptr %9, align 4, !dbg !233
  %226 = icmp slt i32 %225, 2, !dbg !234
  br i1 %226, label %227, label %229, !dbg !235

227:                                              ; preds = %224
  %228 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %231, !dbg !238

229:                                              ; preds = %224, %221, %218, %215, %212, %209, %206, %203
  %230 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %231
