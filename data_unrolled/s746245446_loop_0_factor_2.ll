...
72:                                               ; preds = %117, %51
  ...
  br i1 %79, label %117, label %80, !dbg !69
...
81:                                               ; preds = %114, %80
  ...
  br i1 %88, label %114, label %89, !dbg !78
...
114:                                              ; preds = %81
  %115 = load i32, ptr %10, align 4, !dbg !83
  %116 = add nsw i32 %115, -1, !dbg !83
  store i32 %116, ptr %10, align 4, !dbg !83
  br label %81, !dbg !78, !llvm.loop !84

117:                                              ; preds = %72
  %118 = load i32, ptr %9, align 4, !dbg !75
  %119 = add nsw i32 %118, 1, !dbg !75
  store i32 %119, ptr %9, align 4, !dbg !75
  br label %72, !dbg !69, !llvm.loop !76

120:                                              ; preds = %50
  %121 = load i32, ptr %7, align 4, !dbg !105
  %122 = load i32, ptr %9, align 4, !dbg !107
  %123 = sub nsw i32 %122, 1, !dbg !108
  %124 = icmp slt i32 %121, %123, !dbg !109
  br i1 %124, label %125, label %131, !dbg !110

125:                                              ; preds = %120
  %126 = load ptr, ptr %5, align 8, !dbg !111
  %127 = load ptr, ptr %6, align 8, !dbg !112
  %128 = load i32, ptr %7, align 4, !dbg !113
  %129 = load i32, ptr %9, align 4, !dbg !114
  %130 = sub nsw i32 %129, 1, !dbg !115
  call void @QuickSort(ptr noundef %126, ptr noundef %127, i32 noundef %128, i32 noundef %130), !dbg !116
  br label %131, !dbg !116

131:                                              ; preds = %125, %120
  %132 = load i32, ptr %10, align 4, !dbg !117
  %133 = add nsw i32 %132, 1, !dbg !119
  %134 = load i32, ptr %8, align 4, !dbg !120
  %135 = icmp slt i32 %133, %134, !dbg !121
  br i1 %135, label %136, label %142, !dbg !122

136:                                              ; preds = %131
  %137 = load ptr, ptr %5, align 8, !dbg !123
  %138 = load ptr, ptr %6, align 8, !dbg !124
  %139 = load i32, ptr %10, align 4, !dbg !125
  %140 = add nsw i32 %139, 1, !dbg !126
  %141 = load i32, ptr %8, align 4, !dbg !127
  call void @QuickSort(ptr noundef %137, ptr noundef %138, i32 noundef %140, i32 noundef %141), !dbg !128
  br label %142, !dbg !128
