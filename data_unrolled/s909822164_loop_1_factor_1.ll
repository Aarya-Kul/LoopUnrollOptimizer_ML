...
3844:                                             ; preds = %3863, %3843
  ...
  br i1 %3855, label %3856, label %3864, !dbg !57
...
3862:                                             ; preds = %3856
  br label %3864, !dbg !70

3863:                                             ; preds = %3856
  br label %3844, !dbg !57, !llvm.loop !72

3864:                                             ; preds = %3862, %3844
  %3865 = load i32, ptr @s, align 4, !dbg !74
  %3866 = add nsw i32 %3865, -1, !dbg !74
  store i32 %3866, ptr @s, align 4, !dbg !74
  br label %3867, !dbg !75

3867:                                             ; preds = %3891, %3864
  %3868 = load i32, ptr @s, align 4, !dbg !76
  %3869 = load i32, ptr @r, align 4, !dbg !77
  %3870 = sub nsw i32 %3868, %3869, !dbg !78
  %3871 = sext i32 %3870 to i64, !dbg !79
  %3872 = getelementptr inbounds [101 x i8], ptr @S, i64 0, i64 %3871, !dbg !79
  %3873 = load i8, ptr %3872, align 1, !dbg !79
  %3874 = sext i8 %3873 to i32, !dbg !79
  %3875 = load i32, ptr @r, align 4, !dbg !80
  %3876 = sub nsw i32 6, %3875, !dbg !81
  %3877 = sext i32 %3876 to i64, !dbg !82
  %3878 = getelementptr inbounds [7 x i8], ptr @T, i64 0, i64 %3877, !dbg !82
  %3879 = load i8, ptr %3878, align 1, !dbg !82
  %3880 = sext i8 %3879 to i32, !dbg !82
  %3881 = icmp eq i32 %3874, %3880, !dbg !83
  br i1 %3881, label %3882, label %3892, !dbg !75

3882:                                             ; preds = %3867
  %3883 = load i32, ptr @r, align 4, !dbg !84
  %3884 = add nsw i32 %3883, 1, !dbg !84
  store i32 %3884, ptr @r, align 4, !dbg !84
  %3885 = load i32, ptr @l, align 4, !dbg !86
  %3886 = load i32, ptr @r, align 4, !dbg !88
  %3887 = add nsw i32 %3885, %3886, !dbg !89
  %3888 = load i32, ptr @s, align 4, !dbg !90
  %3889 = icmp sge i32 %3887, %3888, !dbg !91
  br i1 %3889, label %3890, label %3891, !dbg !92

3890:                                             ; preds = %3882
  br label %3892, !dbg !93

3891:                                             ; preds = %3882
  br label %3867, !dbg !75, !llvm.loop !95

3892:                                             ; preds = %3890, %3867
  %3893 = load i32, ptr @l, align 4, !dbg !97
  %3894 = load i32, ptr @r, align 4, !dbg !99
  %3895 = add nsw i32 %3893, %3894, !dbg !100
  %3896 = icmp sge i32 %3895, 7, !dbg !101
  br i1 %3896, label %3897, label %3899, !dbg !102

3897:                                             ; preds = %3892
  %3898 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !103
  br label %3901, !dbg !105

3899:                                             ; preds = %3892
  %3900 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !106
  br label %3901
