...
23:                                               ; preds = %93, %0
  ...
  br i1 %26, label %27, label %96, !dbg !62
...
96:                                               ; preds = %23
  %97 = load i32, ptr %5, align 4, !dbg !151
  %98 = icmp ne i32 %97, 0, !dbg !151
  %99 = zext i1 %98 to i64, !dbg !151
  %100 = select i1 %98, ptr @.str.3, ptr @.str.4, !dbg !151
  %101 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %100), !dbg !152
  ret i32 0, !dbg !153
}
