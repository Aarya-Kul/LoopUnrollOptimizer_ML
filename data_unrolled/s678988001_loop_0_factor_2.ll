...
45:                                               ; preds = %139, %0
  ...
  br i1 %48, label %49, label %142, !dbg !74
...
91:                                               ; preds = %90
  ...
  br i1 %96, label %97, label %142, !dbg !74
...
142:                                              ; preds = %91, %45
  %143 = load i32, ptr %2, align 4, !dbg !113
  %144 = load ptr, ptr %3, align 8, !dbg !115
  %145 = call i32 @ar_1kind(i32 noundef %143, ptr noundef %144), !dbg !116
  %146 = icmp ne i32 %145, 0, !dbg !116
  br i1 %146, label %147, label %151, !dbg !117

147:                                              ; preds = %142
  %148 = load i32, ptr %2, align 4, !dbg !118
  %149 = sdiv i32 %148, 2, !dbg !120
  %150 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %149), !dbg !121
  br label %207, !dbg !122
...
151:                                              ; preds = %142
  ...
  %152 = load i32, ptr %2, align 4, !dbg !130
  %153 = sdiv i32 %152, 2, !dbg !131
  store i32 %153, ptr %11, align 4, !dbg !129
  call void @llvm.dbg.declare(metadata ptr %12, metadata !132, metadata !DIExpression()), !dbg !133
  %154 = load i32, ptr %2, align 4, !dbg !134
  %155 = sdiv i32 %154, 2, !dbg !135
  store i32 %155, ptr %12, align 4, !dbg !133
  ...
  %157 = sdiv i32 %156, 2, !dbg !149
  %158 = load ptr, ptr %4, align 8, !dbg !150
  %159 = load ptr, ptr %6, align 8, !dbg !151
  %160 = load ptr, ptr %4, align 8, !dbg !152
  %161 = getelementptr inbounds i32, ptr %160, i64 0, !dbg !152
  %162 = load i32, ptr %161, align 4, !dbg !152
  call void @find_frequent(i32 noundef %157, ptr noundef %9, ptr noundef %11, ptr noundef %158, ptr noundef %159, ptr noundef %13, i32 noundef %162, ptr noundef %15), !dbg !153
  call void @llvm.dbg.declare(metadata ptr %19, metadata !154, metadata !DIExpression()), !dbg !156
  store i32 0, ptr %19, align 4, !dbg !156
  br label %163, !dbg !157

163:                                              ; preds = %192, %151
  %164 = load i32, ptr %19, align 4, !dbg !158
  %165 = load i32, ptr %2, align 4, !dbg !160
  %166 = sdiv i32 %165, 2, !dbg !161
  %167 = icmp slt i32 %164, %166, !dbg !162
  br i1 %167, label %168, label %195, !dbg !163

168:                                              ; preds = %163
  %169 = load ptr, ptr %5, align 8, !dbg !164
  %170 = load i32, ptr %19, align 4, !dbg !167
  %171 = sext i32 %170 to i64, !dbg !164
  %172 = getelementptr inbounds i32, ptr %169, i64 %171, !dbg !164
  %173 = load i32, ptr %172, align 4, !dbg !164
  %174 = load i32, ptr %15, align 4, !dbg !168
  %175 = icmp eq i32 %173, %174, !dbg !169
  br i1 %175, label %176, label %181, !dbg !170

176:                                              ; preds = %168
  %177 = load ptr, ptr %7, align 8, !dbg !171
  %178 = load i32, ptr %19, align 4, !dbg !172
  %179 = sext i32 %178 to i64, !dbg !171
  %180 = getelementptr inbounds i32, ptr %177, i64 %179, !dbg !171
  store i32 1, ptr %180, align 4, !dbg !173
  br label %191, !dbg !171

181:                                              ; preds = %168
  %182 = load i32, ptr %18, align 4, !dbg !174
  %183 = icmp ne i32 %182, 0, !dbg !174
  br i1 %183, label %190, label %184, !dbg !177

184:                                              ; preds = %181
  %185 = load ptr, ptr %5, align 8, !dbg !178
  %186 = load i32, ptr %19, align 4, !dbg !180
  %187 = sext i32 %186 to i64, !dbg !178
  %188 = getelementptr inbounds i32, ptr %185, i64 %187, !dbg !178
  %189 = load i32, ptr %188, align 4, !dbg !178
  store i32 %189, ptr %17, align 4, !dbg !181
  store i32 1, ptr %18, align 4, !dbg !182
  br label %190, !dbg !183

190:                                              ; preds = %184, %181
  br label %191

191:                                              ; preds = %190, %176
  br label %192, !dbg !184

192:                                              ; preds = %191
  %193 = load i32, ptr %19, align 4, !dbg !185
  %194 = add nsw i32 %193, 1, !dbg !185
  store i32 %194, ptr %19, align 4, !dbg !185
  br label %163, !dbg !186, !llvm.loop !187

195:                                              ; preds = %163
  %196 = load i32, ptr %2, align 4, !dbg !189
  %197 = sdiv i32 %196, 2, !dbg !190
  %198 = load ptr, ptr %5, align 8, !dbg !191
  %199 = load ptr, ptr %7, align 8, !dbg !192
  %200 = load i32, ptr %17, align 4, !dbg !193
  call void @find_frequent(i32 noundef %197, ptr noundef %10, ptr noundef %12, ptr noundef %198, ptr noundef %199, ptr noundef %14, i32 noundef %200, ptr noundef %16), !dbg !194
  %201 = load i32, ptr %2, align 4, !dbg !195
  %202 = load i32, ptr %13, align 4, !dbg !196
  %203 = sub nsw i32 %201, %202, !dbg !197
  %204 = load i32, ptr %14, align 4, !dbg !198
  %205 = sub nsw i32 %203, %204, !dbg !199
  %206 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %205), !dbg !200
  br label %207

207:                                              ; preds = %195, %147
  %208 = load ptr, ptr %3, align 8, !dbg !201
  call void @free(ptr noundef %208) #6, !dbg !202
  %209 = load ptr, ptr %4, align 8, !dbg !203
  call void @free(ptr noundef %209) #6, !dbg !204
  %210 = load ptr, ptr %5, align 8, !dbg !205
  call void @free(ptr noundef %210) #6, !dbg !206
  %211 = load ptr, ptr %6, align 8, !dbg !207
  call void @free(ptr noundef %211) #6, !dbg !208
  %212 = load ptr, ptr %7, align 8, !dbg !209
  call void @free(ptr noundef %212) #6, !dbg !210
  ret i32 0, !dbg !211
}
