...
9268:                                             ; preds = %9265
  ...
  br i1 %9280, label %9281, label %9292, !dbg !122
...
9292:                                             ; preds = %9268, %9265
  %9293 = getelementptr inbounds [1000 x i8], ptr %3, i64 0, i64 0, !dbg !141
  %9294 = call i64 @strlen(ptr noundef %9293) #8, !dbg !143
  %9295 = load i32, ptr %2, align 4, !dbg !144
  %9296 = sext i32 %9295 to i64, !dbg !144
  %9297 = icmp ne i64 %9294, %9296, !dbg !145
  br i1 %9297, label %9298, label %9299, !dbg !146

9298:                                             ; preds = %9292
  store i32 0, ptr %1, align 4, !dbg !147
  br label %9348, !dbg !147

9299:                                             ; preds = %9292
  store i32 0, ptr %5, align 4, !dbg !149
  br label %9300, !dbg !151

9300:                                             ; preds = %9341, %9299
  %9301 = load i32, ptr %5, align 4, !dbg !152
  %9302 = load i32, ptr %4, align 4, !dbg !154
  %9303 = add nsw i32 %9302, 1, !dbg !155
  %9304 = icmp slt i32 %9301, %9303, !dbg !156
  br i1 %9304, label %9305, label %9344, !dbg !157

9305:                                             ; preds = %9300
  %9306 = load i32, ptr %5, align 4, !dbg !158
  store i32 %9306, ptr %7, align 4, !dbg !160
  store i32 0, ptr %13, align 4, !dbg !161
  br label %9307, !dbg !163

9307:                                             ; preds = %9334, %9305
  %9308 = load i32, ptr %6, align 4, !dbg !164
  %9309 = load i32, ptr %5, align 4, !dbg !166
  %9310 = icmp ne i32 %9308, %9309, !dbg !167
  br i1 %9310, label %9311, label %9337, !dbg !168

9311:                                             ; preds = %9307
  %9312 = load i32, ptr %13, align 4, !dbg !169
  %9313 = icmp ne i32 %9312, 0, !dbg !172
  br i1 %9313, label %9314, label %9316, !dbg !173

9314:                                             ; preds = %9311
  %9315 = load i32, ptr %6, align 4, !dbg !174
  store i32 %9315, ptr %7, align 4, !dbg !176
  br label %9316, !dbg !177

9316:                                             ; preds = %9314, %9311
  %9317 = load i32, ptr %7, align 4, !dbg !178
  %9318 = srem i32 %9317, 2, !dbg !180
  %9319 = icmp ne i32 %9318, 0, !dbg !181
  br i1 %9319, label %9320, label %9324, !dbg !182

9320:                                             ; preds = %9316
  %9321 = load i32, ptr %7, align 4, !dbg !183
  %9322 = sub nsw i32 %9321, 1, !dbg !185
  %9323 = sdiv i32 %9322, 2, !dbg !186
  store i32 %9323, ptr %6, align 4, !dbg !187
  br label %9333, !dbg !188

9324:                                             ; preds = %9316
  %9325 = load i32, ptr %7, align 4, !dbg !189
  %9326 = sdiv i32 %9325, 2, !dbg !191
  %9327 = load i32, ptr %2, align 4, !dbg !192
  %9328 = sub nsw i32 %9327, 1, !dbg !193
  %9329 = sitofp i32 %9328 to double, !dbg !192
  %9330 = call double @pow(double noundef 2.000000e+00, double noundef %9329) #7, !dbg !194
  %9331 = fptosi double %9330 to i32, !dbg !195
  %9332 = add nsw i32 %9326, %9331, !dbg !196
  store i32 %9332, ptr %6, align 4, !dbg !197
  br label %9333

9333:                                             ; preds = %9324, %9320
  br label %9334, !dbg !198

9334:                                             ; preds = %9333
  %9335 = load i32, ptr %13, align 4, !dbg !199
  %9336 = add nsw i32 %9335, 1, !dbg !199
  store i32 %9336, ptr %13, align 4, !dbg !199
  br label %9307, !dbg !200, !llvm.loop !201

9337:                                             ; preds = %9307
  %9338 = load i32, ptr %13, align 4, !dbg !203
  %9339 = load i32, ptr %14, align 4, !dbg !204
  %9340 = add nsw i32 %9339, %9338, !dbg !204
  store i32 %9340, ptr %14, align 4, !dbg !204
  br label %9341, !dbg !205

9341:                                             ; preds = %9337
  %9342 = load i32, ptr %5, align 4, !dbg !206
  %9343 = add nsw i32 %9342, 1, !dbg !206
  store i32 %9343, ptr %5, align 4, !dbg !206
  br label %9300, !dbg !207, !llvm.loop !208

9344:                                             ; preds = %9300
  %9345 = load i32, ptr %14, align 4, !dbg !210
  %9346 = srem i32 %9345, 998244353, !dbg !211
  %9347 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %9346), !dbg !212
  store i32 0, ptr %1, align 4, !dbg !213
  br label %9348, !dbg !213

9348:                                             ; preds = %9344, %9298
  %9349 = load i32, ptr %1, align 4, !dbg !214
  ret i32 %9349, !dbg !214
}
