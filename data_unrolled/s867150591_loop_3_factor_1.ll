...
12324:                                            ; preds = %12395, %12321
  ...
  br i1 %12327, label %12328, label %12398, !dbg !151
...
12398:                                            ; preds = %12324
  %12399 = load i64, ptr %5, align 8, !dbg !228
  %12400 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %12399), !dbg !229
  store i32 0, ptr %1, align 4, !dbg !230
  %12401 = load ptr, ptr %6, align 8, !dbg !231
  call void @llvm.stackrestore.p0(ptr %12401), !dbg !231
  %12402 = load i32, ptr %1, align 4, !dbg !231
  ret i32 %12402, !dbg !231
}
