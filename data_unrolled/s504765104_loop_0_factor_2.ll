...
28:                                               ; preds = %73, %27
  ...
  br i1 %32, label %33, label %76, !dbg !78
...
50:                                               ; preds = %49
  ...
  br i1 %56, label %57, label %76, !dbg !78
...
76:                                               ; preds = %50, %48, %28
  ...
  %77 = getelementptr inbounds [120 x i8], ptr %2, i64 0, i64 0, !dbg !101
  %78 = call i64 @strlen(ptr noundef %77) #5, !dbg !102
  %79 = sub i64 %78, 1, !dbg !103
  %80 = trunc i64 %79 to i32, !dbg !102
  store i32 %80, ptr %7, align 4, !dbg !100
  br label %81, !dbg !104

81:                                               ; preds = %108, %76
  %82 = load i32, ptr %7, align 4, !dbg !105
  %83 = icmp sge i32 %82, 0, !dbg !107
  br i1 %83, label %84, label %111, !dbg !108

84:                                               ; preds = %81
  %85 = load i32, ptr %5, align 4, !dbg !109
  %86 = sext i32 %85 to i64, !dbg !112
  %87 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %86, !dbg !112
  %88 = load i8, ptr %87, align 1, !dbg !112
  %89 = sext i8 %88 to i32, !dbg !112
  %90 = load i32, ptr %7, align 4, !dbg !113
  %91 = sext i32 %90 to i64, !dbg !114
  %92 = getelementptr inbounds [120 x i8], ptr %2, i64 0, i64 %91, !dbg !114
  %93 = load i8, ptr %92, align 1, !dbg !114
  %94 = sext i8 %93 to i32, !dbg !114
  %95 = icmp eq i32 %89, %94, !dbg !115
  br i1 %95, label %96, label %99, !dbg !116

96:                                               ; preds = %84
  %97 = load i32, ptr %5, align 4, !dbg !117
  %98 = add nsw i32 %97, -1, !dbg !117
  store i32 %98, ptr %5, align 4, !dbg !117
...
100:                                              ; preds = %96
  %101 = load i32, ptr %4, align 4, !dbg !122
  %102 = sub nsw i32 %101, 1, !dbg !124
  %103 = load i32, ptr %5, align 4, !dbg !125
  %104 = icmp eq i32 %102, %103, !dbg !126
  br i1 %104, label %105, label %107, !dbg !127

105:                                              ; preds = %100
  %106 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !128
  store i32 0, ptr %1, align 4, !dbg !130
  br label %113, !dbg !130

107:                                              ; preds = %100
  br label %108, !dbg !131

108:                                              ; preds = %107
  %109 = load i32, ptr %7, align 4, !dbg !132
  %110 = add nsw i32 %109, -1, !dbg !132
  store i32 %110, ptr %7, align 4, !dbg !132
  br label %81, !dbg !133, !llvm.loop !134

111:                                              ; preds = %99, %81
  %112 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %113, !dbg !137

113:                                              ; preds = %111, %105, %25, %14
  %114 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %114, !dbg !138
}
