...
44:                                               ; preds = %29
  ...
  %48 = srem i32 %47, 2, !dbg !141
  %49 = icmp eq i32 %48, 0, !dbg !142
  br i1 %49, label %50, label %54, !dbg !143

50:                                               ; preds = %44
  %51 = load i32, ptr %4, align 4, !dbg !144
  %52 = sdiv i32 %51, 2, !dbg !145
  %53 = sub nsw i32 %52, 1, !dbg !146
  br label %57, !dbg !143

54:                                               ; preds = %44
  %55 = load i32, ptr %4, align 4, !dbg !147
  %56 = sdiv i32 %55, 2, !dbg !148
  br label %57, !dbg !143

57:                                               ; preds = %54, %50
  %58 = phi i32 [ %53, %50 ], [ %56, %54 ], !dbg !143
  %59 = sext i32 %58 to i64, !dbg !149
  %60 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %59, !dbg !149
  %61 = load i32, ptr %60, align 4, !dbg !149
  store i32 %61, ptr %9, align 4, !dbg !150
  store i32 0, ptr %5, align 4, !dbg !151
  br label %62, !dbg !153

62:                                               ; preds = %74, %57
  %63 = load i32, ptr %5, align 4, !dbg !154
  %64 = load i32, ptr %4, align 4, !dbg !156
  %65 = icmp slt i32 %63, %64, !dbg !157
  br i1 %65, label %66, label %77, !dbg !158

66:                                               ; preds = %62
  %67 = load i32, ptr %5, align 4, !dbg !159
  %68 = sext i32 %67 to i64, !dbg !161
  %69 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %68, !dbg !161
  %70 = load i32, ptr %69, align 4, !dbg !161
  %71 = load i32, ptr %5, align 4, !dbg !162
  %72 = sext i32 %71 to i64, !dbg !163
  %73 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %72, !dbg !163
  store i32 %70, ptr %73, align 4, !dbg !164
  br label %74, !dbg !165

74:                                               ; preds = %66
  %75 = load i32, ptr %5, align 4, !dbg !166
  %76 = add nsw i32 %75, 1, !dbg !166
  store i32 %76, ptr %5, align 4, !dbg !166
  br label %62, !dbg !167, !llvm.loop !168

77:                                               ; preds = %62
  %78 = load i32, ptr %4, align 4, !dbg !170
  %79 = sext i32 %78 to i64, !dbg !170
  call void @qsort(ptr noundef @house_sort, i64 noundef %79, i64 noundef 4, ptr noundef @qsort_comp), !dbg !171
  %80 = load i32, ptr %4, align 4, !dbg !172
  %81 = srem i32 %80, 2, !dbg !173
  %82 = icmp eq i32 %81, 0, !dbg !174
  br i1 %82, label %83, label %87, !dbg !175

83:                                               ; preds = %77
  %84 = load i32, ptr %4, align 4, !dbg !176
  %85 = sdiv i32 %84, 2, !dbg !177
  %86 = sub nsw i32 %85, 1, !dbg !178
  br label %90, !dbg !175

87:                                               ; preds = %77
  %88 = load i32, ptr %4, align 4, !dbg !179
  %89 = sdiv i32 %88, 2, !dbg !180
  br label %90, !dbg !175

90:                                               ; preds = %87, %83
  %91 = phi i32 [ %86, %83 ], [ %89, %87 ], !dbg !175
  %92 = sext i32 %91 to i64, !dbg !181
  %93 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %92, !dbg !181
  %94 = load i32, ptr %93, align 4, !dbg !181
  store i32 %94, ptr %10, align 4, !dbg !182
...
95:                                               ; preds = %126, %90
  %96 = load i32, ptr %5, align 4, !dbg !188
  %97 = load i32, ptr %4, align 4, !dbg !190
  %98 = icmp slt i32 %96, %97, !dbg !191
  br i1 %98, label %99, label %129, !dbg !192

99:                                               ; preds = %95
  %100 = load i32, ptr %5, align 4, !dbg !193
  %101 = sext i32 %100 to i64, !dbg !195
  %102 = getelementptr inbounds [100000 x i32], ptr @house_x, i64 0, i64 %101, !dbg !195
  %103 = load i32, ptr %102, align 4, !dbg !195
  %104 = load i32, ptr %9, align 4, !dbg !196
  %105 = sub nsw i32 %103, %104, !dbg !197
  %106 = call i32 @llvm.abs.i32(i32 %105, i1 true), !dbg !198
  %107 = load i32, ptr %5, align 4, !dbg !199
  %108 = sext i32 %107 to i64, !dbg !200
  %109 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %108, !dbg !200
  %110 = load i32, ptr %109, align 4, !dbg !200
  %111 = load i32, ptr %10, align 4, !dbg !201
  %112 = sub nsw i32 %110, %111, !dbg !202
  %113 = call i32 @llvm.abs.i32(i32 %112, i1 true), !dbg !203
  %114 = add nsw i32 %106, %113, !dbg !204
  %115 = sext i32 %114 to i64, !dbg !198
  store i64 %115, ptr %6, align 8, !dbg !205
  %116 = load i64, ptr %6, align 8, !dbg !206
  %117 = mul nsw i64 %116, 2, !dbg !207
  %118 = load i64, ptr %7, align 8, !dbg !208
  %119 = add nsw i64 %118, %117, !dbg !208
  store i64 %119, ptr %7, align 8, !dbg !208
  %120 = load i64, ptr %6, align 8, !dbg !209
  %121 = load i64, ptr %8, align 8, !dbg !211
  %122 = icmp sgt i64 %120, %121, !dbg !212
  br i1 %122, label %123, label %125, !dbg !213

123:                                              ; preds = %99
  %124 = load i64, ptr %6, align 8, !dbg !214
  store i64 %124, ptr %8, align 8, !dbg !215
  br label %125, !dbg !216

125:                                              ; preds = %123, %99
  br label %126, !dbg !217

126:                                              ; preds = %125
  %127 = load i32, ptr %5, align 4, !dbg !218
  %128 = add nsw i32 %127, 1, !dbg !218
  store i32 %128, ptr %5, align 4, !dbg !218
  br label %95, !dbg !219, !llvm.loop !220

129:                                              ; preds = %95
  %130 = load i64, ptr %8, align 8, !dbg !222
  %131 = load i64, ptr %7, align 8, !dbg !223
  %132 = sub nsw i64 %131, %130, !dbg !223
  store i64 %132, ptr %7, align 8, !dbg !223
  %133 = load i64, ptr %7, align 8, !dbg !224
  %134 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %133), !dbg !225
  %135 = load i32, ptr %9, align 4, !dbg !226
  %136 = load i32, ptr %10, align 4, !dbg !227
  %137 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %135, i32 noundef %136), !dbg !228
  %138 = load i32, ptr %1, align 4, !dbg !229
  ret i32 %138, !dbg !229
}
