...
5816:                                             ; preds = %5785
  br label %5817, !dbg !95

5817:                                             ; preds = %5838, %5816
  %5818 = load i32, ptr %3, align 4, !dbg !96
  %5819 = sext i32 %5818 to i64, !dbg !99
  %5820 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5819, !dbg !99
  %5821 = load i8, ptr %5820, align 1, !dbg !99
  %5822 = sext i8 %5821 to i32, !dbg !99
  %5823 = icmp eq i32 121, %5822, !dbg !100
  br i1 %5823, label %5824, label %5829, !dbg !101

5824:                                             ; preds = %5817
  %5825 = load i32, ptr %3, align 4, !dbg !102
  %5826 = icmp sgt i32 %5825, 3, !dbg !105
  br i1 %5826, label %5827, label %5828, !dbg !106

5827:                                             ; preds = %5824
  store i32 1, ptr %4, align 4, !dbg !107
  br label %5828, !dbg !109

5828:                                             ; preds = %5827, %5824
  br label %5841, !dbg !110

5829:                                             ; preds = %5817
  %5830 = load i32, ptr %3, align 4, !dbg !111
  %5831 = icmp sgt i32 %5830, 96, !dbg !113
  br i1 %5831, label %5835, label %5832, !dbg !114

5832:                                             ; preds = %5829
  %5833 = load i32, ptr %4, align 4, !dbg !115
  %5834 = icmp eq i32 %5833, 1, !dbg !116
  br i1 %5834, label %5835, label %5837, !dbg !117

5835:                                             ; preds = %5832, %5829
  %5836 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !118
  br label %5837, !dbg !120

5837:                                             ; preds = %5835, %5832
  br label %5838

5838:                                             ; preds = %5837
  %5839 = load i32, ptr %3, align 4, !dbg !121
  %5840 = add nsw i32 %5839, 1, !dbg !121
  store i32 %5840, ptr %3, align 4, !dbg !121
  br label %5817, !dbg !95, !llvm.loop !122

5841:                                             ; preds = %5828
  br label %5842, !dbg !124

5842:                                             ; preds = %5863, %5841
  %5843 = load i32, ptr %3, align 4, !dbg !125
  %5844 = sext i32 %5843 to i64, !dbg !128
  %5845 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5844, !dbg !128
  %5846 = load i8, ptr %5845, align 1, !dbg !128
  %5847 = sext i8 %5846 to i32, !dbg !128
  %5848 = icmp eq i32 101, %5847, !dbg !129
  br i1 %5848, label %5849, label %5854, !dbg !130

5849:                                             ; preds = %5842
  %5850 = load i32, ptr %3, align 4, !dbg !131
  %5851 = icmp sgt i32 %5850, 4, !dbg !134
  br i1 %5851, label %5852, label %5853, !dbg !135

5852:                                             ; preds = %5849
  store i32 1, ptr %4, align 4, !dbg !136
  br label %5853, !dbg !138

5853:                                             ; preds = %5852, %5849
  br label %5866, !dbg !139

5854:                                             ; preds = %5842
  %5855 = load i32, ptr %3, align 4, !dbg !140
  %5856 = icmp sgt i32 %5855, 97, !dbg !142
  br i1 %5856, label %5860, label %5857, !dbg !143

5857:                                             ; preds = %5854
  %5858 = load i32, ptr %4, align 4, !dbg !144
  %5859 = icmp eq i32 %5858, 1, !dbg !145
  br i1 %5859, label %5860, label %5862, !dbg !146

5860:                                             ; preds = %5857, %5854
  %5861 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !147
  br label %5862, !dbg !149

5862:                                             ; preds = %5860, %5857
  br label %5863

5863:                                             ; preds = %5862
  %5864 = load i32, ptr %3, align 4, !dbg !150
  %5865 = add nsw i32 %5864, 1, !dbg !150
  store i32 %5865, ptr %3, align 4, !dbg !150
  br label %5842, !dbg !124, !llvm.loop !151

5866:                                             ; preds = %5853
  br label %5867, !dbg !153

5867:                                             ; preds = %5888, %5866
  %5868 = load i32, ptr %3, align 4, !dbg !154
  %5869 = sext i32 %5868 to i64, !dbg !157
  %5870 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5869, !dbg !157
  %5871 = load i8, ptr %5870, align 1, !dbg !157
  %5872 = sext i8 %5871 to i32, !dbg !157
  %5873 = icmp eq i32 110, %5872, !dbg !158
  br i1 %5873, label %5874, label %5879, !dbg !159

5874:                                             ; preds = %5867
  %5875 = load i32, ptr %3, align 4, !dbg !160
  %5876 = icmp sgt i32 %5875, 5, !dbg !163
  br i1 %5876, label %5877, label %5878, !dbg !164

5877:                                             ; preds = %5874
  store i32 1, ptr %4, align 4, !dbg !165
  br label %5878, !dbg !167

5878:                                             ; preds = %5877, %5874
  br label %5891, !dbg !168

5879:                                             ; preds = %5867
  %5880 = load i32, ptr %3, align 4, !dbg !169
  %5881 = icmp sgt i32 %5880, 98, !dbg !171
  br i1 %5881, label %5885, label %5882, !dbg !172

5882:                                             ; preds = %5879
  %5883 = load i32, ptr %4, align 4, !dbg !173
  %5884 = icmp eq i32 %5883, 1, !dbg !174
  br i1 %5884, label %5885, label %5887, !dbg !175

5885:                                             ; preds = %5882, %5879
  %5886 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !176
  br label %5887, !dbg !178

5887:                                             ; preds = %5885, %5882
  br label %5888

5888:                                             ; preds = %5887
  %5889 = load i32, ptr %3, align 4, !dbg !179
  %5890 = add nsw i32 %5889, 1, !dbg !179
  store i32 %5890, ptr %3, align 4, !dbg !179
  br label %5867, !dbg !153, !llvm.loop !180

5891:                                             ; preds = %5878
  br label %5892, !dbg !182

5892:                                             ; preds = %5913, %5891
  %5893 = load i32, ptr %3, align 4, !dbg !183
  %5894 = sext i32 %5893 to i64, !dbg !186
  %5895 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5894, !dbg !186
  %5896 = load i8, ptr %5895, align 1, !dbg !186
  %5897 = sext i8 %5896 to i32, !dbg !186
  %5898 = icmp eq i32 99, %5897, !dbg !187
  br i1 %5898, label %5899, label %5904, !dbg !188

5899:                                             ; preds = %5892
  %5900 = load i32, ptr %3, align 4, !dbg !189
  %5901 = icmp sgt i32 %5900, 6, !dbg !192
  br i1 %5901, label %5902, label %5903, !dbg !193

5902:                                             ; preds = %5899
  store i32 1, ptr %4, align 4, !dbg !194
  br label %5903, !dbg !196

5903:                                             ; preds = %5902, %5899
  br label %5916, !dbg !197

5904:                                             ; preds = %5892
  %5905 = load i32, ptr %3, align 4, !dbg !198
  %5906 = icmp sgt i32 %5905, 99, !dbg !200
  br i1 %5906, label %5910, label %5907, !dbg !201

5907:                                             ; preds = %5904
  %5908 = load i32, ptr %4, align 4, !dbg !202
  %5909 = icmp eq i32 %5908, 1, !dbg !203
  br i1 %5909, label %5910, label %5912, !dbg !204

5910:                                             ; preds = %5907, %5904
  %5911 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !205
  br label %5912, !dbg !207

5912:                                             ; preds = %5910, %5907
  br label %5913

5913:                                             ; preds = %5912
  %5914 = load i32, ptr %3, align 4, !dbg !208
  %5915 = add nsw i32 %5914, 1, !dbg !208
  store i32 %5915, ptr %3, align 4, !dbg !208
  br label %5892, !dbg !182, !llvm.loop !209

5916:                                             ; preds = %5903
  br label %5917, !dbg !211

5917:                                             ; preds = %5938, %5916
  %5918 = load i32, ptr %3, align 4, !dbg !212
  %5919 = sext i32 %5918 to i64, !dbg !215
  %5920 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5919, !dbg !215
  %5921 = load i8, ptr %5920, align 1, !dbg !215
  %5922 = sext i8 %5921 to i32, !dbg !215
  %5923 = icmp eq i32 101, %5922, !dbg !216
  br i1 %5923, label %5924, label %5929, !dbg !217

5924:                                             ; preds = %5917
  %5925 = load i32, ptr %3, align 4, !dbg !218
  %5926 = icmp sgt i32 %5925, 7, !dbg !221
  br i1 %5926, label %5927, label %5928, !dbg !222

5927:                                             ; preds = %5924
  store i32 1, ptr %4, align 4, !dbg !223
  br label %5928, !dbg !225

5928:                                             ; preds = %5927, %5924
  br label %5941, !dbg !226

5929:                                             ; preds = %5917
  %5930 = load i32, ptr %3, align 4, !dbg !227
  %5931 = icmp sgt i32 %5930, 100, !dbg !229
  br i1 %5931, label %5935, label %5932, !dbg !230

5932:                                             ; preds = %5929
  %5933 = load i32, ptr %4, align 4, !dbg !231
  %5934 = icmp eq i32 %5933, 1, !dbg !232
  br i1 %5934, label %5935, label %5937, !dbg !233

5935:                                             ; preds = %5932, %5929
  %5936 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !234
  br label %5937, !dbg !236

5937:                                             ; preds = %5935, %5932
  br label %5938

5938:                                             ; preds = %5937
  %5939 = load i32, ptr %3, align 4, !dbg !237
  %5940 = add nsw i32 %5939, 1, !dbg !237
  store i32 %5940, ptr %3, align 4, !dbg !237
  br label %5917, !dbg !211, !llvm.loop !238

5941:                                             ; preds = %5928
  %5942 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !240
  ret i32 0, !dbg !241
}
