...
39:                                               ; preds = %168, %38
  ...
  br i1 %41, label %42, label %171, !dbg !96
...
148:                                              ; preds = %145
  ...
  store i32 1, ptr %10, align 4, !dbg !198
  br label %161, !dbg !199

151:                                              ; preds = %145, %142, %135
  %152 = load i32, ptr %10, align 4, !dbg !200
  %153 = icmp eq i32 %152, 1, !dbg !203
  br i1 %153, label %157, label %154, !dbg !204

154:                                              ; preds = %151
  %155 = load i32, ptr %12, align 4, !dbg !205
  %156 = icmp eq i32 %155, 0, !dbg !206
  br i1 %156, label %157, label %160, !dbg !207

157:                                              ; preds = %154, %151
  %158 = load i32, ptr %9, align 4, !dbg !208
  %159 = add nsw i32 %158, 1, !dbg !208
  store i32 %159, ptr %9, align 4, !dbg !208
  br label %160, !dbg !210

160:                                              ; preds = %157, %154
  store i32 0, ptr %10, align 4, !dbg !211
  br label %161
...
167:                                              ; preds = %166, %52
  br label %168, !dbg !212

168:                                              ; preds = %167
  %169 = load i32, ptr %12, align 4, !dbg !213
  %170 = add nsw i32 %169, 1, !dbg !213
  store i32 %170, ptr %12, align 4, !dbg !213
  br label %39, !dbg !214, !llvm.loop !215

171:                                              ; preds = %39
  %172 = load i32, ptr %2, align 4, !dbg !217
  %173 = icmp sgt i32 %172, 0, !dbg !219
  br i1 %173, label %174, label %197, !dbg !220

174:                                              ; preds = %171
  %175 = load i32, ptr %3, align 4, !dbg !221
  %176 = icmp sgt i32 %175, 0, !dbg !222
  br i1 %176, label %177, label %197, !dbg !223

177:                                              ; preds = %174
  %178 = load i32, ptr %4, align 4, !dbg !224
  %179 = icmp sgt i32 %178, 0, !dbg !225
  br i1 %179, label %180, label %197, !dbg !226

180:                                              ; preds = %177
  %181 = load i32, ptr %5, align 4, !dbg !227
  %182 = icmp sgt i32 %181, 0, !dbg !228
  br i1 %182, label %183, label %197, !dbg !229

183:                                              ; preds = %180
  %184 = load i32, ptr %6, align 4, !dbg !230
  %185 = icmp sgt i32 %184, 0, !dbg !231
  br i1 %185, label %186, label %197, !dbg !232

186:                                              ; preds = %183
  %187 = load i32, ptr %7, align 4, !dbg !233
  %188 = icmp sgt i32 %187, 0, !dbg !234
  br i1 %188, label %189, label %197, !dbg !235

189:                                              ; preds = %186
  %190 = load i32, ptr %8, align 4, !dbg !236
  %191 = icmp sgt i32 %190, 0, !dbg !237
  br i1 %191, label %192, label %197, !dbg !238

192:                                              ; preds = %189
  %193 = load i32, ptr %9, align 4, !dbg !239
  %194 = icmp slt i32 %193, 2, !dbg !240
  br i1 %194, label %195, label %197, !dbg !241

195:                                              ; preds = %192
  %196 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !242
  br label %199, !dbg !244

197:                                              ; preds = %192, %189, %186, %183, %180, %177, %174, %171
  %198 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !245
  br label %199
...
!198 = !DILocation(line: 55, column: 18, scope: !197)
!199 = !DILocation(line: 56, column: 9, scope: !197)
!200 = !DILocation(line: 58, column: 16, scope: !201)
!201 = distinct !DILexicalBlock(scope: !202, file: !2, line: 58, column: 16)
!202 = distinct !DILexicalBlock(scope: !186, file: !2, line: 57, column: 13)
!203 = !DILocation(line: 58, column: 21, scope: !201)
!204 = !DILocation(line: 58, column: 24, scope: !201)
!205 = !DILocation(line: 58, column: 26, scope: !201)
!206 = !DILocation(line: 58, column: 27, scope: !201)
!207 = !DILocation(line: 58, column: 16, scope: !202)
!208 = !DILocation(line: 59, column: 18, scope: !209)
!209 = distinct !DILexicalBlock(scope: !201, file: !2, line: 58, column: 31)
!210 = !DILocation(line: 60, column: 13, scope: !209)
!211 = !DILocation(line: 61, column: 18, scope: !202)
!212 = !DILocation(line: 63, column: 5, scope: !99)
!213 = !DILocation(line: 27, column: 20, scope: !94)
!214 = !DILocation(line: 27, column: 5, scope: !94)
!215 = distinct !{!215, !96, !216, !73}
!216 = !DILocation(line: 63, column: 5, scope: !91)
!217 = !DILocation(line: 65, column: 8, scope: !218)
!218 = distinct !DILexicalBlock(scope: !27, file: !2, line: 65, column: 8)
!219 = !DILocation(line: 65, column: 9, scope: !218)
!220 = !DILocation(line: 65, column: 12, scope: !218)
!221 = !DILocation(line: 65, column: 15, scope: !218)
!222 = !DILocation(line: 65, column: 16, scope: !218)
!223 = !DILocation(line: 65, column: 19, scope: !218)
!224 = !DILocation(line: 65, column: 22, scope: !218)
!225 = !DILocation(line: 65, column: 23, scope: !218)
!226 = !DILocation(line: 65, column: 26, scope: !218)
!227 = !DILocation(line: 65, column: 29, scope: !218)
!228 = !DILocation(line: 65, column: 30, scope: !218)
!229 = !DILocation(line: 65, column: 33, scope: !218)
!230 = !DILocation(line: 65, column: 36, scope: !218)
!231 = !DILocation(line: 65, column: 37, scope: !218)
!232 = !DILocation(line: 65, column: 40, scope: !218)
!233 = !DILocation(line: 65, column: 43, scope: !218)
!234 = !DILocation(line: 65, column: 44, scope: !218)
!235 = !DILocation(line: 65, column: 47, scope: !218)
!236 = !DILocation(line: 65, column: 50, scope: !218)
!237 = !DILocation(line: 65, column: 51, scope: !218)
!238 = !DILocation(line: 65, column: 54, scope: !218)
!239 = !DILocation(line: 65, column: 57, scope: !218)
!240 = !DILocation(line: 65, column: 58, scope: !218)
!241 = !DILocation(line: 65, column: 8, scope: !27)
!242 = !DILocation(line: 66, column: 9, scope: !243)
!243 = distinct !DILexicalBlock(scope: !218, file: !2, line: 65, column: 61)
!244 = !DILocation(line: 67, column: 5, scope: !243)
!245 = !DILocation(line: 69, column: 9, scope: !246)
!246 = distinct !DILexicalBlock(scope: !218, file: !2, line: 68, column: 9)
!247 = !DILocation(line: 71, column: 5, scope: !27)
