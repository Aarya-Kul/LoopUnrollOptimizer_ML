...
6577:                                             ; preds = %6573
  ...
  %6589 = getelementptr inbounds %struct.d, ptr %6588, i32 0, i32 0, !dbg !148
  %6590 = load i32, ptr %6589, align 8, !dbg !148
  %6591 = sext i32 %6590 to i64, !dbg !147
  %6592 = sub nsw i64 %6585, %6591, !dbg !149
  %6593 = trunc i64 %6592 to i32, !dbg !144
  %6594 = call i32 @llvm.abs.i32(i32 %6593, i1 true), !dbg !150
  %6595 = mul nsw i32 %6583, %6594, !dbg !151
  %6596 = sext i32 %6595 to i64, !dbg !142
  %6597 = add nsw i64 %6578, %6596, !dbg !152
  store i64 %6597, ptr %8, align 8, !dbg !153
  %6598 = load i64, ptr %10, align 8, !dbg !154
  %6599 = load i32, ptr %17, align 4, !dbg !155
  %6600 = sext i32 %6599 to i64, !dbg !156
  %6601 = getelementptr inbounds [10000 x %struct.d], ptr %7, i64 0, i64 %6600, !dbg !156
  %6602 = getelementptr inbounds %struct.d, ptr %6601, i32 0, i32 1, !dbg !157
  %6603 = load i32, ptr %6602, align 4, !dbg !157
  %6604 = load i32, ptr %6, align 4, !dbg !158
  %6605 = sext i32 %6604 to i64, !dbg !158
  %6606 = load i64, ptr %12, align 8, !dbg !159
  %6607 = sub nsw i64 %6605, %6606, !dbg !160
  %6608 = load i32, ptr %17, align 4, !dbg !161
  %6609 = sext i32 %6608 to i64, !dbg !162
  %6610 = getelementptr inbounds [10000 x %struct.d], ptr %7, i64 0, i64 %6609, !dbg !162
  %6611 = getelementptr inbounds %struct.d, ptr %6610, i32 0, i32 0, !dbg !163
  %6612 = load i32, ptr %6611, align 8, !dbg !163
  %6613 = sext i32 %6612 to i64, !dbg !162
  %6614 = sub nsw i64 %6607, %6613, !dbg !164
  %6615 = trunc i64 %6614 to i32, !dbg !158
  %6616 = call i32 @llvm.abs.i32(i32 %6615, i1 true), !dbg !165
  %6617 = mul nsw i32 %6603, %6616, !dbg !166
  %6618 = sext i32 %6617 to i64, !dbg !156
  %6619 = add nsw i64 %6598, %6618, !dbg !167
  store i64 %6619, ptr %9, align 8, !dbg !168
  %6620 = load i64, ptr %8, align 8, !dbg !169
  %6621 = load i64, ptr %9, align 8, !dbg !171
  %6622 = icmp sgt i64 %6620, %6621, !dbg !172
  br i1 %6622, label %6623, label %6627, !dbg !173

6623:                                             ; preds = %6577
  %6624 = load i64, ptr %8, align 8, !dbg !174
  store i64 %6624, ptr %10, align 8, !dbg !176
  %6625 = load i64, ptr %11, align 8, !dbg !177
  %6626 = add nsw i64 %6625, 1, !dbg !177
  store i64 %6626, ptr %11, align 8, !dbg !177
  br label %6631, !dbg !178

6627:                                             ; preds = %6577
  %6628 = load i64, ptr %9, align 8, !dbg !179
  store i64 %6628, ptr %10, align 8, !dbg !181
  %6629 = load i64, ptr %12, align 8, !dbg !182
  %6630 = add nsw i64 %6629, 1, !dbg !182
  store i64 %6630, ptr %12, align 8, !dbg !182
  br label %6631

6631:                                             ; preds = %6627, %6623
  %6632 = load i64, ptr %13, align 8, !dbg !183
  %6633 = load i32, ptr %17, align 4, !dbg !184
  %6634 = sext i32 %6633 to i64, !dbg !185
  %6635 = getelementptr inbounds [10000 x %struct.d], ptr %7, i64 0, i64 %6634, !dbg !185
  %6636 = getelementptr inbounds %struct.d, ptr %6635, i32 0, i32 1, !dbg !186
  %6637 = load i32, ptr %6636, align 4, !dbg !186
  %6638 = load i64, ptr %14, align 8, !dbg !187
  %6639 = add nsw i64 %6638, 1, !dbg !188
  %6640 = load i32, ptr %17, align 4, !dbg !189
  %6641 = sext i32 %6640 to i64, !dbg !190
  %6642 = getelementptr inbounds [10000 x %struct.d], ptr %7, i64 0, i64 %6641, !dbg !190
  %6643 = getelementptr inbounds %struct.d, ptr %6642, i32 0, i32 0, !dbg !191
  %6644 = load i32, ptr %6643, align 8, !dbg !191
  %6645 = sext i32 %6644 to i64, !dbg !190
  %6646 = sub nsw i64 %6639, %6645, !dbg !192
  %6647 = trunc i64 %6646 to i32, !dbg !187
  %6648 = call i32 @llvm.abs.i32(i32 %6647, i1 true), !dbg !193
  %6649 = mul nsw i32 %6637, %6648, !dbg !194
  %6650 = sext i32 %6649 to i64, !dbg !185
  %6651 = add nsw i64 %6632, %6650, !dbg !195
  store i64 %6651, ptr %8, align 8, !dbg !196
  %6652 = load i64, ptr %13, align 8, !dbg !197
  %6653 = load i32, ptr %17, align 4, !dbg !198
  %6654 = sext i32 %6653 to i64, !dbg !199
  %6655 = getelementptr inbounds [10000 x %struct.d], ptr %7, i64 0, i64 %6654, !dbg !199
  %6656 = getelementptr inbounds %struct.d, ptr %6655, i32 0, i32 1, !dbg !200
  %6657 = load i32, ptr %6656, align 4, !dbg !200
  %6658 = load i32, ptr %6, align 4, !dbg !201
  %6659 = sext i32 %6658 to i64, !dbg !201
  %6660 = load i64, ptr %15, align 8, !dbg !202
  %6661 = sub nsw i64 %6659, %6660, !dbg !203
  %6662 = load i32, ptr %17, align 4, !dbg !204
  %6663 = sext i32 %6662 to i64, !dbg !205
  %6664 = getelementptr inbounds [10000 x %struct.d], ptr %7, i64 0, i64 %6663, !dbg !205
  %6665 = getelementptr inbounds %struct.d, ptr %6664, i32 0, i32 0, !dbg !206
  %6666 = load i32, ptr %6665, align 8, !dbg !206
  %6667 = sext i32 %6666 to i64, !dbg !205
  %6668 = sub nsw i64 %6661, %6667, !dbg !207
  %6669 = trunc i64 %6668 to i32, !dbg !201
  %6670 = call i32 @llvm.abs.i32(i32 %6669, i1 true), !dbg !208
  %6671 = mul nsw i32 %6657, %6670, !dbg !209
  %6672 = sext i32 %6671 to i64, !dbg !199
  %6673 = add nsw i64 %6652, %6672, !dbg !210
  store i64 %6673, ptr %9, align 8, !dbg !211
  %6674 = load i64, ptr %8, align 8, !dbg !212
  %6675 = load i64, ptr %9, align 8, !dbg !214
  %6676 = icmp sgt i64 %6674, %6675, !dbg !215
  br i1 %6676, label %6677, label %6681, !dbg !216

6677:                                             ; preds = %6631
  %6678 = load i64, ptr %8, align 8, !dbg !217
  store i64 %6678, ptr %13, align 8, !dbg !219
  %6679 = load i64, ptr %14, align 8, !dbg !220
  %6680 = add nsw i64 %6679, 1, !dbg !220
  store i64 %6680, ptr %14, align 8, !dbg !220
  br label %6685, !dbg !221

6681:                                             ; preds = %6631
  %6682 = load i64, ptr %9, align 8, !dbg !222
  store i64 %6682, ptr %13, align 8, !dbg !224
  %6683 = load i64, ptr %15, align 8, !dbg !225
  %6684 = add nsw i64 %6683, 1, !dbg !225
  store i64 %6684, ptr %15, align 8, !dbg !225
  br label %6685

6685:                                             ; preds = %6681, %6677
  br label %6686, !dbg !226

6686:                                             ; preds = %6685
  %6687 = load i32, ptr %17, align 4, !dbg !227
  %6688 = add nsw i32 %6687, 1, !dbg !227
  store i32 %6688, ptr %17, align 4, !dbg !227
  br label %6573, !dbg !228, !llvm.loop !229

6689:                                             ; preds = %6573
  %6690 = load i64, ptr %10, align 8, !dbg !231
  %6691 = load i64, ptr %13, align 8, !dbg !233
  %6692 = icmp sgt i64 %6690, %6691, !dbg !234
  br i1 %6692, label %6693, label %6696, !dbg !235

6693:                                             ; preds = %6689
  %6694 = load i64, ptr %10, align 8, !dbg !236
  %6695 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %6694), !dbg !237
  br label %6699, !dbg !237

6696:                                             ; preds = %6689
  %6697 = load i64, ptr %13, align 8, !dbg !238
  %6698 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %6697), !dbg !239
  br label %6699

6699:                                             ; preds = %6696, %6693
  %6700 = load i32, ptr %3, align 4, !dbg !240
  ret i32 %6700, !dbg !240
}
