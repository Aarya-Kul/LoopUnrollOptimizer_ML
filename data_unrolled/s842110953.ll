...
20:                                               ; preds = %68, %16
  ...
  br i1 %23, label %24, label %71, !dbg !61
...
26:                                               ; preds = %64, %24
  ...
  br i1 %29, label %30, label %67, !dbg !72
...
57:                                               ; preds = %31
  %58 = getelementptr inbounds [128 x i8], ptr %6, i64 0, i64 0, !dbg !111
  %59 = call i32 @strcmp(ptr noundef %58, ptr noundef @.str.1) #5, !dbg !113
  %60 = icmp eq i32 %59, 0, !dbg !114
  br i1 %60, label %61, label %63, !dbg !115

61:                                               ; preds = %57
  %62 = call i32 @puts(ptr noundef @.str.2), !dbg !116
  store i32 0, ptr %1, align 4, !dbg !118
  br label %73, !dbg !118
...
64:                                               ; preds = %63
  ...
  %66 = add nsw i32 %65, 1, !dbg !120
  store i32 %66, ptr %5, align 4, !dbg !120
...
68:                                               ; preds = %67
  %69 = load i32, ptr %4, align 4, !dbg !125
  %70 = add nsw i32 %69, 1, !dbg !125
  store i32 %70, ptr %4, align 4, !dbg !125
  br label %20, !dbg !126, !llvm.loop !127

71:                                               ; preds = %20
  %72 = call i32 @puts(ptr noundef @.str.3), !dbg !129
  store i32 0, ptr %1, align 4, !dbg !130
  br label %73, !dbg !130

73:                                               ; preds = %71, %61, %14
  %74 = load i32, ptr %1, align 4, !dbg !131
  ret i32 %74, !dbg !131
}
...
!113 = !DILocation(line: 27, column: 10, scope: !112)
!114 = !DILocation(line: 27, column: 31, scope: !112)
!115 = !DILocation(line: 27, column: 10, scope: !74)
!116 = !DILocation(line: 28, column: 9, scope: !117)
!117 = distinct !DILexicalBlock(scope: !112, file: !2, line: 27, column: 35)
!118 = !DILocation(line: 29, column: 9, scope: !117)
!119 = !DILocation(line: 31, column: 5, scope: !74)
!120 = !DILocation(line: 17, column: 24, scope: !69)
!121 = !DILocation(line: 17, column: 5, scope: !69)
!122 = distinct !{!122, !72, !123, !110}
!123 = !DILocation(line: 31, column: 5, scope: !63)
!124 = !DILocation(line: 32, column: 3, scope: !64)
!125 = !DILocation(line: 16, column: 22, scope: !58)
!126 = !DILocation(line: 16, column: 3, scope: !58)
!127 = distinct !{!127, !61, !128, !110}
!128 = !DILocation(line: 32, column: 3, scope: !54)
!129 = !DILocation(line: 33, column: 3, scope: !29)
!130 = !DILocation(line: 35, column: 3, scope: !29)
!131 = !DILocation(line: 36, column: 1, scope: !29)
