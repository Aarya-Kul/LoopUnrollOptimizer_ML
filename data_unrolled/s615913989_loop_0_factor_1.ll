...
8:                                                ; preds = %40, %1
  ...
  br i1 %10, label %11, label %43, !dbg !118
...
43:                                               ; preds = %32, %8
  %44 = load i32, ptr %7, align 4, !dbg !161
  %45 = icmp eq i32 %44, 6, !dbg !163
  br i1 %45, label %46, label %48, !dbg !164

46:                                               ; preds = %43
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.14), !dbg !165
  store i32 0, ptr %2, align 4, !dbg !167
  br label %56, !dbg !167

48:                                               ; preds = %43
  %49 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 0, !dbg !168
  %50 = call i64 @strlen(ptr noundef %49) #5, !dbg !170
  %51 = icmp ult i64 %50, 7, !dbg !171
...
53:                                               ; preds = %48
  %54 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 0, !dbg !174
  %55 = call i32 @extend(ptr noundef %54), !dbg !175
  br label %56, !dbg !176

56:                                               ; preds = %53, %52, %46, %36, %23
  %57 = load i32, ptr %2, align 4, !dbg !176
  ret i32 %57, !dbg !176
}
