...
6649:                                             ; preds = %6547
  ...
  br label %6650, !dbg !312

6650:                                             ; preds = %6666, %6649
  %6651 = load i32, ptr %1, align 4, !dbg !313
  %6652 = load i32, ptr @siHCnt, align 4, !dbg !315
  %6653 = icmp sle i32 %6651, %6652, !dbg !316
  br i1 %6653, label %6654, label %6669, !dbg !317

6654:                                             ; preds = %6650
  %6655 = load i64, ptr %6, align 8, !dbg !318
  %6656 = load i32, ptr %1, align 4, !dbg !320
  %6657 = sext i32 %6656 to i64, !dbg !321
  %6658 = getelementptr inbounds [2000 x [2000 x i64]], ptr @sl2Max, i64 0, i64 %6657, !dbg !321
  %6659 = load i32, ptr @siHCnt, align 4, !dbg !322
  %6660 = load i32, ptr %1, align 4, !dbg !323
  %6661 = sub nsw i32 %6659, %6660, !dbg !324
  %6662 = sext i32 %6661 to i64, !dbg !321
  %6663 = getelementptr inbounds [2000 x i64], ptr %6658, i64 0, i64 %6662, !dbg !321
  %6664 = load i64, ptr %6663, align 8, !dbg !321
  %6665 = call i64 @fGetMax(i64 noundef %6655, i64 noundef %6664), !dbg !325
  store i64 %6665, ptr %6, align 8, !dbg !326
  br label %6666, !dbg !327

6666:                                             ; preds = %6654
  %6667 = load i32, ptr %1, align 4, !dbg !328
  %6668 = add nsw i32 %6667, 1, !dbg !328
  store i32 %6668, ptr %1, align 4, !dbg !328
  br label %6650, !dbg !329, !llvm.loop !330

6669:                                             ; preds = %6650
  %6670 = getelementptr inbounds [1024 x i8], ptr %2, i64 0, i64 0, !dbg !332
  %6671 = load i64, ptr %6, align 8, !dbg !333
  %6672 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef %6670, ptr noundef @.str.3, i64 noundef %6671) #5, !dbg !334
  %6673 = getelementptr inbounds [1024 x i8], ptr %2, i64 0, i64 0, !dbg !335
  %6674 = call i32 @fOutLine(ptr noundef %6673), !dbg !336
  ret i32 0, !dbg !337
}
