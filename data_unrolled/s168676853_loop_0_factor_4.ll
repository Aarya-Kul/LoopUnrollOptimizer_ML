...
4:                                                ; preds = %82, %0
  ...
  br i1 %6, label %7, label %85, !dbg !43
...
12:                                               ; preds = %7
  ...
  br i1 %16, label %17, label %85, !dbg !43
...
22:                                               ; preds = %17
  ...
  br i1 %26, label %27, label %85, !dbg !43
...
32:                                               ; preds = %27
  ...
  br i1 %36, label %37, label %85, !dbg !43
...
42:                                               ; preds = %37
  ...
  br i1 %46, label %47, label %85, !dbg !43
...
52:                                               ; preds = %47
  ...
  br i1 %56, label %57, label %85, !dbg !43
...
62:                                               ; preds = %57
  ...
  br i1 %66, label %67, label %85, !dbg !43
...
72:                                               ; preds = %67
  ...
  br i1 %76, label %77, label %85, !dbg !43
...
86:                                               ; preds = %113, %85
  %87 = load i32, ptr %3, align 4, !dbg !57
  %88 = icmp slt i32 %87, 3, !dbg !59
  br i1 %88, label %89, label %116, !dbg !60

89:                                               ; preds = %86
  %90 = load i32, ptr %3, align 4, !dbg !61
  %91 = sext i32 %90 to i64, !dbg !64
  %92 = getelementptr inbounds [3 x i32], ptr %2, i64 0, i64 %91, !dbg !64
  %93 = load i32, ptr %92, align 4, !dbg !64
  %94 = icmp eq i32 %93, 1, !dbg !65
  br i1 %94, label %95, label %97, !dbg !66

95:                                               ; preds = %89
  %96 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9), !dbg !67
  br label %112, !dbg !69

97:                                               ; preds = %89
  %98 = load i32, ptr %3, align 4, !dbg !70
  %99 = sext i32 %98 to i64, !dbg !72
  %100 = getelementptr inbounds [3 x i32], ptr %2, i64 0, i64 %99, !dbg !72
  %101 = load i32, ptr %100, align 4, !dbg !72
  %102 = icmp eq i32 %101, 9, !dbg !73
  br i1 %102, label %103, label %105, !dbg !74

103:                                              ; preds = %97
  %104 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1), !dbg !75
  br label %111, !dbg !77

105:                                              ; preds = %97
  %106 = load i32, ptr %3, align 4, !dbg !78
  %107 = sext i32 %106 to i64, !dbg !80
  %108 = getelementptr inbounds [3 x i32], ptr %2, i64 0, i64 %107, !dbg !80
  %109 = load i32, ptr %108, align 4, !dbg !80
  %110 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %109), !dbg !81
  br label %111
...
113:                                              ; preds = %112
  %114 = load i32, ptr %3, align 4, !dbg !83
  %115 = add nsw i32 %114, 1, !dbg !83
  store i32 %115, ptr %3, align 4, !dbg !83
  br label %86, !dbg !84, !llvm.loop !85

116:                                              ; preds = %86
  %117 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !87
  ret i32 0, !dbg !88
}
