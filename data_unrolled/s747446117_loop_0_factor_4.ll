...
144:                                              ; preds = %124, %107, %90, %73, %56, %39, %22, %7
  %145 = load ptr, ptr %4, align 8, !dbg !59
  %146 = load i32, ptr %6, align 4, !dbg !61
  %147 = sext i32 %146 to i64, !dbg !62
  %148 = getelementptr inbounds i8, ptr %145, i64 %147, !dbg !62
  %149 = load ptr, ptr %5, align 8, !dbg !63
  %150 = load i32, ptr %6, align 4, !dbg !64
  %151 = sext i32 %150 to i64, !dbg !65
  %152 = getelementptr inbounds i8, ptr %149, i64 %151, !dbg !65
  %153 = call ptr @strstr(ptr noundef %148, ptr noundef %152) #4, !dbg !66
  %154 = icmp ne ptr %153, null, !dbg !66
  br i1 %154, label %155, label %156, !dbg !67
...
157:                                              ; preds = %156, %155
  %158 = load i32, ptr %3, align 4, !dbg !70
  ret i32 %158, !dbg !70
}
