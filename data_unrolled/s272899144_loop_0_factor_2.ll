...
13:                                               ; preds = %96, %0
  ...
  br i1 %17, label %18, label %99, !dbg !59
...
70:                                               ; preds = %69
  ...
  br i1 %76, label %77, label %99, !dbg !59
...
99:                                               ; preds = %70, %68, %67, %33, %13
  %100 = load i32, ptr %4, align 4, !dbg !123
  %101 = icmp eq i32 %100, 0, !dbg !125
  br i1 %101, label %102, label %104, !dbg !126

102:                                              ; preds = %99
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !127
  br label %106, !dbg !129

104:                                              ; preds = %99
  %105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !130
  br label %106
