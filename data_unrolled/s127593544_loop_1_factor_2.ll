...
5515:                                             ; preds = %5511
  ...
  %5525 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !237
  %5526 = fptosi double %5525 to i64, !dbg !238
  %5527 = add nsw i64 %5524, %5526, !dbg !239
  %5528 = sub nsw i64 %5527, 1, !dbg !240
  %5529 = sdiv i64 %5528, 2, !dbg !241
  ...
  %5539 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !248
  %5540 = fptosi double %5539 to i64, !dbg !249
  %5541 = add nsw i64 %5538, %5540, !dbg !250
  %5542 = sub nsw i64 %5541, 1, !dbg !251
  %5543 = sdiv i64 %5542, 2, !dbg !252
...
5629:                                             ; preds = %5619, %5613
  ...
  %5634 = icmp eq i32 %5633, 1, !dbg !340
