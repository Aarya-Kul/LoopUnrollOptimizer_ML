...
8:                                                ; preds = %35, %0
  ...
  br i1 %10, label %11, label %38, !dbg !34
...
38:                                               ; preds = %8
  ...
  %39 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 0, !dbg !60
  %40 = call i32 @atoi(ptr noundef %39) #4, !dbg !61
  store i32 %40, ptr %4, align 4, !dbg !59
  %41 = load i32, ptr %4, align 4, !dbg !62
  %42 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %41), !dbg !63
  ret i32 0, !dbg !64
}
