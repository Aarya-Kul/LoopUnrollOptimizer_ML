...
6584:                                             ; preds = %6563
  %6585 = load i32, ptr %3, align 4, !dbg !107
  %6586 = sext i32 %6585 to i64, !dbg !109
  %6587 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %6586, !dbg !109
  %6588 = load i32, ptr %4, align 4, !dbg !110
  %6589 = add nsw i32 %6588, 1, !dbg !111
  %6590 = sext i32 %6589 to i64, !dbg !112
  %6591 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %6590, !dbg !112
  %6592 = call ptr @strstr(ptr noundef %6587, ptr noundef %6591) #5, !dbg !113
  store ptr %6592, ptr %7, align 8, !dbg !114
  %6593 = icmp ne ptr %6592, null, !dbg !115
  br i1 %6593, label %6594, label %6595, !dbg !116

6594:                                             ; preds = %6584
  store i32 1, ptr %2, align 4, !dbg !117
  br label %6595, !dbg !118

6595:                                             ; preds = %6594, %6584
  %6596 = load i32, ptr %2, align 4, !dbg !119
  %6597 = icmp ne i32 %6596, 0, !dbg !119
  br i1 %6597, label %6598, label %6600, !dbg !121

6598:                                             ; preds = %6595
  %6599 = call i32 @puts(ptr noundef @.str.1), !dbg !122
  br label %6602, !dbg !122

6600:                                             ; preds = %6595
  %6601 = call i32 @puts(ptr noundef @.str.2), !dbg !123
  br label %6602

6602:                                             ; preds = %6600, %6598
  ret i32 0, !dbg !124
}
