...
743:                                              ; preds = %800, %742
  ...
  br i1 %746, label %747, label %803, !dbg !144
...
747:                                              ; preds = %743
  ...
  %753 = call i32 @llvm.abs.i32(i32 %752, i1 true), !dbg !151
  %754 = load i32, ptr %12, align 4, !dbg !152
  %755 = load i64, ptr %7, align 8, !dbg !153
  %756 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %755, !dbg !154
  %757 = load i32, ptr %756, align 4, !dbg !154
  %758 = sub nsw i32 %754, %757, !dbg !155
  %759 = call i32 @llvm.abs.i32(i32 %758, i1 true), !dbg !156
  %760 = icmp sgt i32 %753, %759, !dbg !157
  br i1 %760, label %761, label %780, !dbg !158

761:                                              ; preds = %747
  %762 = load i64, ptr %9, align 8, !dbg !159
  %763 = load i64, ptr %7, align 8, !dbg !161
  %764 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %763, !dbg !162
  %765 = load i32, ptr %764, align 4, !dbg !162
  %766 = load i32, ptr %13, align 4, !dbg !163
  %767 = sub nsw i32 %765, %766, !dbg !164
  %768 = call i32 @llvm.abs.i32(i32 %767, i1 true), !dbg !165
  %769 = sext i32 %768 to i64, !dbg !165
  %770 = load i64, ptr %7, align 8, !dbg !166
  %771 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %770, !dbg !167
  %772 = load i32, ptr %771, align 4, !dbg !167
  %773 = sext i32 %772 to i64, !dbg !168
  %774 = getelementptr inbounds [2000 x i64], ptr %10, i64 0, i64 %773, !dbg !168
  %775 = load i64, ptr %774, align 8, !dbg !168
  %776 = mul i64 %769, %775, !dbg !169
  %777 = add i64 %762, %776, !dbg !170
  store i64 %777, ptr %9, align 8, !dbg !171
  %778 = load i32, ptr %13, align 4, !dbg !172
  %779 = add nsw i32 %778, 1, !dbg !172
  store i32 %779, ptr %13, align 4, !dbg !172
  br label %799, !dbg !173

780:                                              ; preds = %747
  %781 = load i64, ptr %9, align 8, !dbg !174
  %782 = load i32, ptr %12, align 4, !dbg !176
  %783 = load i64, ptr %7, align 8, !dbg !177
  %784 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %783, !dbg !178
  %785 = load i32, ptr %784, align 4, !dbg !178
  %786 = sub nsw i32 %782, %785, !dbg !179
  %787 = call i32 @llvm.abs.i32(i32 %786, i1 true), !dbg !180
  %788 = sext i32 %787 to i64, !dbg !180
  %789 = load i64, ptr %7, align 8, !dbg !181
  %790 = getelementptr inbounds [2000 x i32], ptr %11, i64 0, i64 %789, !dbg !182
  %791 = load i32, ptr %790, align 4, !dbg !182
  %792 = sext i32 %791 to i64, !dbg !183
  %793 = getelementptr inbounds [2000 x i64], ptr %10, i64 0, i64 %792, !dbg !183
  %794 = load i64, ptr %793, align 8, !dbg !183
  %795 = mul i64 %788, %794, !dbg !184
  %796 = add i64 %781, %795, !dbg !185
  store i64 %796, ptr %9, align 8, !dbg !186
  %797 = load i32, ptr %12, align 4, !dbg !187
  %798 = add nsw i32 %797, -1, !dbg !187
  store i32 %798, ptr %12, align 4, !dbg !187
  br label %799

799:                                              ; preds = %780, %761
  br label %800, !dbg !188

800:                                              ; preds = %799
  %801 = load i64, ptr %7, align 8, !dbg !189
  %802 = add i64 %801, 1, !dbg !189
  store i64 %802, ptr %7, align 8, !dbg !189
  br label %743, !dbg !190, !llvm.loop !191

803:                                              ; preds = %743
  %804 = load i64, ptr %9, align 8, !dbg !193
  %805 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %804), !dbg !194
  ret i32 0, !dbg !195
}
