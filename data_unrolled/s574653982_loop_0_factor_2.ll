...
76:                                               ; preds = %123, %55
  ...
  br i1 %84, label %123, label %85, !dbg !70
...
86:                                               ; preds = %120, %85
  ...
  br i1 %94, label %120, label %95, !dbg !79
...
120:                                              ; preds = %86
  %121 = load i32, ptr %10, align 4, !dbg !84
  %122 = add nsw i32 %121, -1, !dbg !84
  store i32 %122, ptr %10, align 4, !dbg !84
  br label %86, !dbg !79, !llvm.loop !85

123:                                              ; preds = %76
  %124 = load i32, ptr %9, align 4, !dbg !76
  %125 = add nsw i32 %124, 1, !dbg !76
  store i32 %125, ptr %9, align 4, !dbg !76
  br label %76, !dbg !70, !llvm.loop !77

126:                                              ; preds = %54
  %127 = load i64, ptr %7, align 8, !dbg !106
  %128 = load i32, ptr %9, align 4, !dbg !108
  %129 = sub nsw i32 %128, 1, !dbg !109
  %130 = sext i32 %129 to i64, !dbg !108
  %131 = icmp slt i64 %127, %130, !dbg !110
  br i1 %131, label %132, label %139, !dbg !111

132:                                              ; preds = %126
  %133 = load ptr, ptr %5, align 8, !dbg !112
  %134 = load ptr, ptr %6, align 8, !dbg !113
  %135 = load i64, ptr %7, align 8, !dbg !114
  %136 = load i32, ptr %9, align 4, !dbg !115
  %137 = sub nsw i32 %136, 1, !dbg !116
  %138 = sext i32 %137 to i64, !dbg !115
  call void @QuickSort(ptr noundef %133, ptr noundef %134, i64 noundef %135, i64 noundef %138), !dbg !117
  br label %139, !dbg !117

139:                                              ; preds = %132, %126
  %140 = load i32, ptr %10, align 4, !dbg !118
  %141 = add nsw i32 %140, 1, !dbg !120
  %142 = sext i32 %141 to i64, !dbg !118
  %143 = load i64, ptr %8, align 8, !dbg !121
  %144 = icmp slt i64 %142, %143, !dbg !122
  br i1 %144, label %145, label %152, !dbg !123

145:                                              ; preds = %139
  %146 = load ptr, ptr %5, align 8, !dbg !124
  %147 = load ptr, ptr %6, align 8, !dbg !125
  %148 = load i32, ptr %10, align 4, !dbg !126
  %149 = add nsw i32 %148, 1, !dbg !127
  %150 = sext i32 %149 to i64, !dbg !126
  %151 = load i64, ptr %8, align 8, !dbg !128
  call void @QuickSort(ptr noundef %146, ptr noundef %147, i64 noundef %150, i64 noundef %151), !dbg !129
  br label %152, !dbg !129
