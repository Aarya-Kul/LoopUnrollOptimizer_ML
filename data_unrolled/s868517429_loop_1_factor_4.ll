...
5781:                                             ; preds = %5780
  ...
  br i1 %5785, label %5786, label %5910, !dbg !222

5786:                                             ; preds = %5781
  store i64 0, ptr @j, align 8, !dbg !223
  br label %5787, !dbg !225

5787:                                             ; preds = %5907, %5786
  %5788 = load i64, ptr @j, align 8, !dbg !226
  %5789 = icmp slt i64 %5788, 2048, !dbg !228
  br i1 %5789, label %5902, label %5790, !dbg !229
...
5791:                                             ; preds = %5790
  ...
  br i1 %5795, label %5796, label %5910, !dbg !222
...
5801:                                             ; preds = %5800
  ...
  br i1 %5805, label %5806, label %5910, !dbg !222
...
5811:                                             ; preds = %5810
  ...
  br i1 %5815, label %5832, label %5910, !dbg !222
...
5837:                                             ; preds = %5836
  ...
  br i1 %5841, label %5842, label %5910, !dbg !222
...
5847:                                             ; preds = %5846
  ...
  br i1 %5851, label %5868, label %5910, !dbg !222
...
5873:                                             ; preds = %5872
  ...
  br i1 %5877, label %5878, label %5910, !dbg !222

5878:                                             ; preds = %5873
  store i64 0, ptr @j, align 8, !dbg !223
  br label %5879, !dbg !225

5879:                                             ; preds = %5891, %5878
  %5880 = load i64, ptr @j, align 8, !dbg !226
  %5881 = icmp slt i64 %5880, 2048, !dbg !228
  br i1 %5881, label %5886, label %5882, !dbg !229
...
5886:                                             ; preds = %5879
  %5887 = load i64, ptr @i, align 8, !dbg !230
  %5888 = getelementptr inbounds [2048 x [2048 x i64]], ptr @dp, i64 0, i64 %5887, !dbg !231
  %5889 = load i64, ptr @j, align 8, !dbg !232
  %5890 = getelementptr inbounds [2048 x i64], ptr %5888, i64 0, i64 %5889, !dbg !231
  store i64 -1, ptr %5890, align 8, !dbg !233
  br label %5891, !dbg !231

5891:                                             ; preds = %5886
  %5892 = load i64, ptr @j, align 8, !dbg !234
  %5893 = add nsw i64 %5892, 1, !dbg !234
  store i64 %5893, ptr @j, align 8, !dbg !234
  br label %5879, !dbg !235, !llvm.loop !236

5894:                                             ; preds = %5869
  %5895 = load i64, ptr @i, align 8, !dbg !230
  %5896 = getelementptr inbounds [2048 x [2048 x i64]], ptr @dp, i64 0, i64 %5895, !dbg !231
  %5897 = load i64, ptr @j, align 8, !dbg !232
  %5898 = getelementptr inbounds [2048 x i64], ptr %5896, i64 0, i64 %5897, !dbg !231
  store i64 -1, ptr %5898, align 8, !dbg !233
  br label %5899, !dbg !231

5899:                                             ; preds = %5894
  %5900 = load i64, ptr @j, align 8, !dbg !234
  %5901 = add nsw i64 %5900, 1, !dbg !234
  store i64 %5901, ptr @j, align 8, !dbg !234
  br label %5869, !dbg !235, !llvm.loop !236

5902:                                             ; preds = %5787
  %5903 = load i64, ptr @i, align 8, !dbg !230
  %5904 = getelementptr inbounds [2048 x [2048 x i64]], ptr @dp, i64 0, i64 %5903, !dbg !231
  %5905 = load i64, ptr @j, align 8, !dbg !232
  %5906 = getelementptr inbounds [2048 x i64], ptr %5904, i64 0, i64 %5905, !dbg !231
  store i64 -1, ptr %5906, align 8, !dbg !233
  br label %5907, !dbg !231

5907:                                             ; preds = %5902
  %5908 = load i64, ptr @j, align 8, !dbg !234
  %5909 = add nsw i64 %5908, 1, !dbg !234
  store i64 %5909, ptr @j, align 8, !dbg !234
  br label %5787, !dbg !235, !llvm.loop !236

5910:                                             ; preds = %5873, %5847, %5837, %5811, %5801, %5791, %5781, %5765
  %5911 = load i64, ptr @n, align 8, !dbg !242
  call void @qsort(ptr noundef @a, i64 noundef %5911, i64 noundef 16, ptr noundef @cmp), !dbg !243
  %5912 = load i64, ptr @n, align 8, !dbg !244
  %5913 = call i64 @search(i64 noundef 1, i64 noundef %5912), !dbg !245
  %5914 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %5913), !dbg !246
  ret i32 0, !dbg !247
}
