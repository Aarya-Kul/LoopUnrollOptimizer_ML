...
8:                                                ; preds = %52, %0
  ...
  br i1 %12, label %13, label %55, !dbg !54
...
29:                                               ; preds = %28
  ...
  br i1 %35, label %36, label %55, !dbg !54
...
55:                                               ; preds = %29, %8
  ...
  %57 = sext i32 %56 to i64, !dbg !72
  %58 = getelementptr inbounds [8 x i8], ptr %4, i64 0, i64 0, !dbg !74
  %59 = call i64 @strlen(ptr noundef %58) #5, !dbg !75
  %60 = icmp eq i64 %57, %59, !dbg !76
  br i1 %60, label %61, label %63, !dbg !77

61:                                               ; preds = %55
  %62 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !78
  br label %65, !dbg !80

63:                                               ; preds = %55
  %64 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !81
  br label %65
