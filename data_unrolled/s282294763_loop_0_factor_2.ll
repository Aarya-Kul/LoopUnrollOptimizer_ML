...
27:                                               ; preds = %24, %18
  ...
  br i1 %28, label %29, label %137, !dbg !67
...
86:                                               ; preds = %83, %75
  ...
  br i1 %87, label %88, label %137, !dbg !67
...
89:                                               ; preds = %134, %88
  ...
  br i1 %92, label %126, label %93, !dbg !77
...
94:                                               ; preds = %123, %93
  ...
  br i1 %101, label %110, label %102, !dbg !102
...
110:                                              ; preds = %94
  %111 = load i32, ptr %5, align 4, !dbg !103
  %112 = load i32, ptr %10, align 4, !dbg !105
  %113 = add nsw i32 %112, 1, !dbg !106
  %114 = sub nsw i32 %111, %113, !dbg !107
  %115 = sext i32 %114 to i64, !dbg !108
  %116 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %115, !dbg !108
  %117 = load i8, ptr %116, align 1, !dbg !108
  %118 = load i32, ptr %10, align 4, !dbg !109
  %119 = sub nsw i32 7, %118, !dbg !110
  %120 = sub nsw i32 %119, 1, !dbg !111
  %121 = sext i32 %120 to i64, !dbg !112
  %122 = getelementptr inbounds [8 x i8], ptr %4, i64 0, i64 %121, !dbg !112
  store i8 %117, ptr %122, align 1, !dbg !113
  br label %123, !dbg !114

123:                                              ; preds = %110
  %124 = load i32, ptr %10, align 4, !dbg !115
  %125 = add nsw i32 %124, 1, !dbg !115
  store i32 %125, ptr %10, align 4, !dbg !115
  br label %94, !dbg !116, !llvm.loop !117

126:                                              ; preds = %89
  %127 = load i32, ptr %9, align 4, !dbg !78
  %128 = sext i32 %127 to i64, !dbg !80
  %129 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %128, !dbg !80
  %130 = load i8, ptr %129, align 1, !dbg !80
  %131 = load i32, ptr %9, align 4, !dbg !81
  %132 = sext i32 %131 to i64, !dbg !82
  %133 = getelementptr inbounds [8 x i8], ptr %4, i64 0, i64 %132, !dbg !82
  store i8 %130, ptr %133, align 1, !dbg !83
  br label %134, !dbg !84

134:                                              ; preds = %126
  %135 = load i32, ptr %9, align 4, !dbg !85
  %136 = add nsw i32 %135, 1, !dbg !85
  store i32 %136, ptr %9, align 4, !dbg !85
  br label %89, !dbg !86, !llvm.loop !87

137:                                              ; preds = %86, %27
  %138 = load i32, ptr %7, align 4, !dbg !130
  %139 = icmp eq i32 %138, 1, !dbg !131
  %140 = zext i1 %139 to i64, !dbg !132
  %141 = select i1 %139, ptr @.str.1, ptr @.str.2, !dbg !132
  %142 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %141), !dbg !133
  %143 = load i32, ptr %1, align 4, !dbg !134
  ret i32 %143, !dbg !134
}
