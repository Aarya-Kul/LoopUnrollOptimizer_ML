...
18:                                               ; preds = %56, %0
  ...
  br i1 %20, label %21, label %59, !dbg !55
...
36:                                               ; preds = %35
  ...
  br i1 %40, label %41, label %59, !dbg !55
...
59:                                               ; preds = %36, %18
  ...
  %60 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 2, !dbg !76
  %61 = load i32, ptr %60, align 4, !dbg !76
  %62 = mul nsw i32 100, %61, !dbg !77
  %63 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 1, !dbg !78
  %64 = load i32, ptr %63, align 4, !dbg !78
  %65 = mul nsw i32 10, %64, !dbg !79
  %66 = add nsw i32 %62, %65, !dbg !80
  %67 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 0, !dbg !81
  %68 = load i32, ptr %67, align 4, !dbg !81
  %69 = add nsw i32 %66, %68, !dbg !82
  store i32 %69, ptr %6, align 4, !dbg !83
  %70 = load i32, ptr %6, align 4, !dbg !84
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %70), !dbg !85
  ret i32 0, !dbg !86
}
