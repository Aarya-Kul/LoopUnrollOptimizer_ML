...
13:                                               ; preds = %329, %0
  ...
  br i1 %16, label %17, label %332, !dbg !54
...
170:                                              ; preds = %169
  ...
  br i1 %175, label %176, label %332, !dbg !54
...
332:                                              ; preds = %170, %13
  %333 = load i32, ptr %5, align 4, !dbg !207
  %334 = icmp eq i32 %333, 7, !dbg !209
  br i1 %334, label %335, label %340, !dbg !210

335:                                              ; preds = %332
  %336 = load i32, ptr %4, align 4, !dbg !211
  %337 = icmp sle i32 %336, 1, !dbg !212
  br i1 %337, label %338, label %340, !dbg !213

338:                                              ; preds = %335
  %339 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !214
  br label %342, !dbg !216

340:                                              ; preds = %335, %332
  %341 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !217
  br label %342
