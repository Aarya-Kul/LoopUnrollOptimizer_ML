...
83:                                               ; preds = %157, %81
  ...
  br i1 %86, label %87, label %160, !dbg !344
...
134:                                              ; preds = %152, %133
  ...
  %141 = load i32, ptr %10, align 4, !dbg !409
  %142 = sext i32 %141 to i64, !dbg !410
  %143 = getelementptr inbounds i32, ptr %21, i64 %142, !dbg !410
  %144 = load i32, ptr %143, align 4, !dbg !410
  %145 = add nsw i32 %140, %144, !dbg !411
  %146 = call i32 @llvm.abs.i32(i32 %145, i1 true), !dbg !412
  %147 = sub nsw i32 %136, %146, !dbg !413
  %148 = sdiv i32 %147, 2, !dbg !414
  %149 = icmp slt i32 %135, %148, !dbg !415
  br i1 %149, label %150, label %155, !dbg !416

150:                                              ; preds = %134
  %151 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %152, !dbg !419

152:                                              ; preds = %150
  %153 = load i32, ptr %13, align 4, !dbg !420
  %154 = add nsw i32 %153, 1, !dbg !420
  store i32 %154, ptr %13, align 4, !dbg !420
  br label %134, !dbg !421, !llvm.loop !422

155:                                              ; preds = %134
  %156 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %157, !dbg !425

157:                                              ; preds = %155
  %158 = load i32, ptr %10, align 4, !dbg !426
  %159 = add nsw i32 %158, 1, !dbg !426
  store i32 %159, ptr %10, align 4, !dbg !426
  br label %83, !dbg !427, !llvm.loop !428

160:                                              ; preds = %83
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %161, !dbg !430

161:                                              ; preds = %160, %53
  %162 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %162), !dbg !431
  %163 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %163, !dbg !431
}
