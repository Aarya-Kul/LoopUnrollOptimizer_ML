...
239:                                              ; preds = %235
  ...
  %249 = sub nsw i64 %248, 1, !dbg !237
  %250 = sdiv i64 %249, 2, !dbg !238
  %251 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !239
  %252 = fptosi double %251 to i64, !dbg !240
  %253 = add nsw i64 %250, %252, !dbg !241
  ...
  %263 = sub nsw i64 %262, 1, !dbg !248
  %264 = sdiv i64 %263, 2, !dbg !249
  %265 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !250
  %266 = fptosi double %265 to i64, !dbg !251
  %267 = add nsw i64 %264, %266, !dbg !252
