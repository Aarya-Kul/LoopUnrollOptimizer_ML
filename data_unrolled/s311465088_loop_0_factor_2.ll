...
9:                                                ; preds = %37, %0
  ...
  br i1 %12, label %13, label %40, !dbg !148
...
22:                                               ; preds = %13
  ...
  br i1 %27, label %28, label %40, !dbg !148
...
41:                                               ; preds = %78, %40
  %42 = load i32, ptr %3, align 4, !dbg !167
  %43 = load i32, ptr @N, align 4, !dbg !169
  %44 = icmp sle i32 %42, %43, !dbg !170
  br i1 %44, label %45, label %81, !dbg !171
...
46:                                               ; preds = %74, %45
  %47 = load i32, ptr %4, align 4, !dbg !177
  %48 = load i32, ptr %3, align 4, !dbg !179
  %49 = icmp slt i32 %47, %48, !dbg !180
  br i1 %49, label %50, label %77, !dbg !181

50:                                               ; preds = %46
  %51 = load i32, ptr %4, align 4, !dbg !182
  %52 = sext i32 %51 to i64, !dbg !185
  %53 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %52, !dbg !185
  %54 = load i32, ptr %53, align 4, !dbg !185
  %55 = load i32, ptr %3, align 4, !dbg !186
  %56 = sext i32 %55 to i64, !dbg !187
  %57 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %56, !dbg !187
  %58 = load i32, ptr %57, align 4, !dbg !187
  %59 = icmp slt i32 %54, %58, !dbg !188
  br i1 %59, label %60, label %73, !dbg !189

60:                                               ; preds = %50
  %61 = load i32, ptr %3, align 4, !dbg !190
  %62 = sext i32 %61 to i64, !dbg !192
  %63 = getelementptr inbounds i32, ptr @A, i64 %62, !dbg !192
  %64 = load i32, ptr %4, align 4, !dbg !193
  %65 = sext i32 %64 to i64, !dbg !194
  %66 = getelementptr inbounds i32, ptr @A, i64 %65, !dbg !194
  call void @swap(ptr noundef %63, ptr noundef %66), !dbg !195
  %67 = load i32, ptr %3, align 4, !dbg !196
  %68 = sext i32 %67 to i64, !dbg !197
  %69 = getelementptr inbounds i32, ptr @hash, i64 %68, !dbg !197
  %70 = load i32, ptr %4, align 4, !dbg !198
  %71 = sext i32 %70 to i64, !dbg !199
  %72 = getelementptr inbounds i32, ptr @hash, i64 %71, !dbg !199
  call void @swap(ptr noundef %69, ptr noundef %72), !dbg !200
  br label %73, !dbg !201
...
74:                                               ; preds = %73
  %75 = load i32, ptr %4, align 4, !dbg !203
  %76 = add nsw i32 %75, 1, !dbg !203
  store i32 %76, ptr %4, align 4, !dbg !203
  br label %46, !dbg !204, !llvm.loop !205

77:                                               ; preds = %46
  br label %78, !dbg !207

78:                                               ; preds = %77
  %79 = load i32, ptr %3, align 4, !dbg !208
  %80 = add nsw i32 %79, 1, !dbg !208
  store i32 %80, ptr %3, align 4, !dbg !208
  br label %41, !dbg !209, !llvm.loop !210
...
82:                                               ; preds = %132, %81
  %83 = load i32, ptr %5, align 4, !dbg !217
  %84 = load i32, ptr @N, align 4, !dbg !219
  %85 = icmp sle i32 %83, %84, !dbg !220
  br i1 %85, label %86, label %135, !dbg !221

86:                                               ; preds = %82
  %87 = load i32, ptr %5, align 4, !dbg !222
  %88 = sub nsw i32 %87, 1, !dbg !224
  %89 = sext i32 %88 to i64, !dbg !225
  %90 = getelementptr inbounds [2001 x i32], ptr @DP, i64 0, i64 %89, !dbg !225
  %91 = load i32, ptr %90, align 4, !dbg !225
  %92 = load i32, ptr %5, align 4, !dbg !226
  %93 = sext i32 %92 to i64, !dbg !227
  %94 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %93, !dbg !227
  %95 = load i32, ptr %94, align 4, !dbg !227
  %96 = load i32, ptr %5, align 4, !dbg !228
  %97 = sext i32 %96 to i64, !dbg !229
  %98 = getelementptr inbounds [2001 x i32], ptr @hash, i64 0, i64 %97, !dbg !229
  %99 = load i32, ptr %98, align 4, !dbg !229
  %100 = load i32, ptr %5, align 4, !dbg !230
  %101 = sub nsw i32 %99, %100, !dbg !231
  %102 = mul nsw i32 %95, %101, !dbg !232
  %103 = add nsw i32 %91, %102, !dbg !233
  %104 = load i32, ptr %5, align 4, !dbg !234
  %105 = sext i32 %104 to i64, !dbg !235
  %106 = getelementptr inbounds [2001 x i32], ptr @DP, i64 0, i64 %105, !dbg !235
  store i32 %103, ptr %106, align 4, !dbg !236
  %107 = load i32, ptr %5, align 4, !dbg !237
  %108 = sub nsw i32 %107, 1, !dbg !238
  %109 = sext i32 %108 to i64, !dbg !239
  %110 = getelementptr inbounds [2001 x [2001 x i32]], ptr @DP, i64 0, i64 %109, !dbg !239
  %111 = getelementptr inbounds [2001 x i32], ptr %110, i64 0, i64 0, !dbg !239
  %112 = load i32, ptr %111, align 4, !dbg !239
  %113 = load i32, ptr %5, align 4, !dbg !240
  %114 = sext i32 %113 to i64, !dbg !241
  %115 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %114, !dbg !241
  %116 = load i32, ptr %115, align 4, !dbg !241
  %117 = load i32, ptr @N, align 4, !dbg !242
  %118 = add nsw i32 %117, 1, !dbg !243
  %119 = load i32, ptr %5, align 4, !dbg !244
  %120 = sub nsw i32 %118, %119, !dbg !245
  %121 = load i32, ptr %5, align 4, !dbg !246
  %122 = sext i32 %121 to i64, !dbg !247
  %123 = getelementptr inbounds [2001 x i32], ptr @hash, i64 0, i64 %122, !dbg !247
  %124 = load i32, ptr %123, align 4, !dbg !247
  %125 = sub nsw i32 %120, %124, !dbg !248
  %126 = mul nsw i32 %116, %125, !dbg !249
  %127 = add nsw i32 %112, %126, !dbg !250
  %128 = load i32, ptr %5, align 4, !dbg !251
  %129 = sext i32 %128 to i64, !dbg !252
  %130 = getelementptr inbounds [2001 x [2001 x i32]], ptr @DP, i64 0, i64 %129, !dbg !252
  %131 = getelementptr inbounds [2001 x i32], ptr %130, i64 0, i64 0, !dbg !252
  store i32 %127, ptr %131, align 4, !dbg !253
  br label %132, !dbg !254

132:                                              ; preds = %86
  %133 = load i32, ptr %5, align 4, !dbg !255
  %134 = add nsw i32 %133, 1, !dbg !255
  store i32 %134, ptr %5, align 4, !dbg !255
  br label %82, !dbg !256, !llvm.loop !257
...
136:                                              ; preds = %152, %135
  %137 = load i32, ptr %7, align 4, !dbg !266
  %138 = load i32, ptr @N, align 4, !dbg !268
  %139 = icmp sle i32 %137, %138, !dbg !269
  br i1 %139, label %140, label %155, !dbg !270

140:                                              ; preds = %136
  %141 = load i32, ptr %6, align 4, !dbg !271
  %142 = load i32, ptr %7, align 4, !dbg !272
  %143 = sext i32 %142 to i64, !dbg !273
  %144 = getelementptr inbounds [2001 x [2001 x i32]], ptr @DP, i64 0, i64 %143, !dbg !273
  %145 = load i32, ptr @N, align 4, !dbg !274
  %146 = load i32, ptr %7, align 4, !dbg !275
  %147 = sub nsw i32 %145, %146, !dbg !276
  %148 = sext i32 %147 to i64, !dbg !273
  %149 = getelementptr inbounds [2001 x i32], ptr %144, i64 0, i64 %148, !dbg !273
  %150 = load i32, ptr %149, align 4, !dbg !273
  %151 = call i32 @max(i32 noundef %141, i32 noundef %150), !dbg !277
  store i32 %151, ptr %6, align 4, !dbg !278
  br label %152, !dbg !279

152:                                              ; preds = %140
  %153 = load i32, ptr %7, align 4, !dbg !280
  %154 = add nsw i32 %153, 1, !dbg !280
  store i32 %154, ptr %7, align 4, !dbg !280
  br label %136, !dbg !281, !llvm.loop !282

155:                                              ; preds = %136
  %156 = load i32, ptr %6, align 4, !dbg !284
  %157 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %156), !dbg !285
  %158 = load i32, ptr %1, align 4, !dbg !286
  ret i32 %158, !dbg !286
}
