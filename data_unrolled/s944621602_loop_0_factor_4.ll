...
159:                                              ; preds = %155
  ...
  %160 = load ptr, ptr %7, align 8, !dbg !139
  %161 = load i32, ptr %2, align 4, !dbg !141
  %162 = sext i32 %161 to i64, !dbg !139
  %163 = getelementptr inbounds i32, ptr %160, i64 %162, !dbg !139
  %164 = load i32, ptr %163, align 4, !dbg !139
  %165 = icmp ne i32 %164, 0, !dbg !139
  br i1 %165, label %166, label %167, !dbg !142

166:                                              ; preds = %159
  br label %250, !dbg !143
...
222:                                              ; preds = %214
  ...
  %228 = load i32, ptr %2, align 4, !dbg !209
  %229 = load i32, ptr %3, align 4, !dbg !210
