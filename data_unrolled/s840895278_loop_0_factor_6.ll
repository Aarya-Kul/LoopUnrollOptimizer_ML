...
635:                                              ; preds = %728, %634
  ...
  br i1 %638, label %639, label %731, !dbg !136

639:                                              ; preds = %635
  %640 = load ptr, ptr %7, align 8, !dbg !137
  %641 = load i32, ptr %2, align 4, !dbg !140
  %642 = sext i32 %641 to i64, !dbg !137
  %643 = getelementptr inbounds i32, ptr %640, i64 %642, !dbg !137
  %644 = load i32, ptr %643, align 4, !dbg !137
  %645 = icmp ne i32 %644, 0, !dbg !137
  br i1 %645, label %646, label %647, !dbg !141

646:                                              ; preds = %639
  br label %728, !dbg !142
...
648:                                              ; preds = %671, %647
  ...
  br i1 %651, label %652, label %674, !dbg !151
...
660:                                              ; preds = %652
  ...
  %669 = sext i32 %668 to i64, !dbg !163
  %670 = mul nsw i64 %665, %669, !dbg !164
  store i64 %670, ptr %10, align 8, !dbg !165
  store i32 1, ptr %16, align 4, !dbg !166
  br label %674, !dbg !167

671:                                              ; preds = %659
  %672 = load i32, ptr %3, align 4, !dbg !168
  %673 = add nsw i32 %672, 1, !dbg !168
  store i32 %673, ptr %3, align 4, !dbg !168
  br label %648, !dbg !169, !llvm.loop !170

674:                                              ; preds = %660, %648
  %675 = load i32, ptr %16, align 4, !dbg !172
  %676 = icmp ne i32 %675, 0, !dbg !172
  br i1 %676, label %677, label %686, !dbg !174

677:                                              ; preds = %674
  %678 = load i64, ptr %9, align 8, !dbg !175
  %679 = load i64, ptr %10, align 8, !dbg !178
  %680 = icmp slt i64 %678, %679, !dbg !179
  br i1 %680, label %681, label %685, !dbg !180

681:                                              ; preds = %677
  %682 = load i32, ptr %2, align 4, !dbg !181
  store i32 %682, ptr %12, align 4, !dbg !183
  %683 = load i32, ptr %3, align 4, !dbg !184
  store i32 %683, ptr %11, align 4, !dbg !185
  %684 = load i64, ptr %10, align 8, !dbg !186
  store i64 %684, ptr %9, align 8, !dbg !187
  br label %685, !dbg !188

685:                                              ; preds = %681, %677
  br label %686, !dbg !189

686:                                              ; preds = %685, %674
  store i32 0, ptr %17, align 4, !dbg !190
  %687 = load i32, ptr %4, align 4, !dbg !191
  %688 = sub nsw i32 %687, 1, !dbg !193
  store i32 %688, ptr %3, align 4, !dbg !194
  br label %689, !dbg !195

689:                                              ; preds = %712, %686
  %690 = load i32, ptr %3, align 4, !dbg !196
  %691 = load i32, ptr %2, align 4, !dbg !198
  %692 = icmp sge i32 %690, %691, !dbg !199
  br i1 %692, label %693, label %715, !dbg !200

693:                                              ; preds = %689
  %694 = load ptr, ptr %8, align 8, !dbg !201
  %695 = load i32, ptr %3, align 4, !dbg !204
  %696 = sext i32 %695 to i64, !dbg !201
  %697 = getelementptr inbounds i32, ptr %694, i64 %696, !dbg !201
  %698 = load i32, ptr %697, align 4, !dbg !201
  %699 = icmp ne i32 %698, 0, !dbg !201
  br i1 %699, label %700, label %701, !dbg !205

700:                                              ; preds = %693
  br label %712, !dbg !206

701:                                              ; preds = %693
  %702 = load ptr, ptr %5, align 8, !dbg !207
  %703 = load i32, ptr %2, align 4, !dbg !208
  %704 = sext i32 %703 to i64, !dbg !207
  %705 = getelementptr inbounds i64, ptr %702, i64 %704, !dbg !207
  %706 = load i64, ptr %705, align 8, !dbg !207
  %707 = load i32, ptr %3, align 4, !dbg !209
  %708 = load i32, ptr %2, align 4, !dbg !210
  %709 = sub nsw i32 %707, %708, !dbg !211
  %710 = sext i32 %709 to i64, !dbg !212
  %711 = mul nsw i64 %706, %710, !dbg !213
  store i64 %711, ptr %10, align 8, !dbg !214
  store i32 1, ptr %17, align 4, !dbg !215
  br label %715, !dbg !216

712:                                              ; preds = %700
  %713 = load i32, ptr %3, align 4, !dbg !217
  %714 = add nsw i32 %713, -1, !dbg !217
  store i32 %714, ptr %3, align 4, !dbg !217
  br label %689, !dbg !218, !llvm.loop !219

715:                                              ; preds = %701, %689
  %716 = load i32, ptr %17, align 4, !dbg !221
  %717 = icmp ne i32 %716, 0, !dbg !221
  br i1 %717, label %718, label %727, !dbg !223

718:                                              ; preds = %715
  %719 = load i64, ptr %9, align 8, !dbg !224
  %720 = load i64, ptr %10, align 8, !dbg !227
  %721 = icmp slt i64 %719, %720, !dbg !228
  br i1 %721, label %722, label %726, !dbg !229

722:                                              ; preds = %718
  %723 = load i32, ptr %2, align 4, !dbg !230
  store i32 %723, ptr %12, align 4, !dbg !232
  %724 = load i32, ptr %3, align 4, !dbg !233
  store i32 %724, ptr %11, align 4, !dbg !234
  %725 = load i64, ptr %10, align 8, !dbg !235
  store i64 %725, ptr %9, align 8, !dbg !236
  br label %726, !dbg !237

726:                                              ; preds = %722, %718
  br label %727, !dbg !238

727:                                              ; preds = %726, %715
  br label %728, !dbg !239

728:                                              ; preds = %727, %646
  %729 = load i32, ptr %2, align 4, !dbg !240
  %730 = add nsw i32 %729, 1, !dbg !240
  store i32 %730, ptr %2, align 4, !dbg !240
  br label %635, !dbg !241, !llvm.loop !242

731:                                              ; preds = %635
  %732 = load i32, ptr %16, align 4, !dbg !244
  %733 = icmp ne i32 %732, 0, !dbg !244
  br i1 %733, label %737, label %734, !dbg !246

734:                                              ; preds = %731
  %735 = load i32, ptr %17, align 4, !dbg !247
  %736 = icmp ne i32 %735, 0, !dbg !247
  br i1 %736, label %737, label %753, !dbg !248

737:                                              ; preds = %734, %731
  %738 = load i32, ptr %11, align 4, !dbg !249
  %739 = load ptr, ptr %6, align 8, !dbg !251
  %740 = load i32, ptr %12, align 4, !dbg !252
  %741 = sext i32 %740 to i64, !dbg !251
  %742 = getelementptr inbounds i32, ptr %739, i64 %741, !dbg !251
  store i32 %738, ptr %742, align 4, !dbg !253
  %743 = load ptr, ptr %7, align 8, !dbg !254
  %744 = load i32, ptr %12, align 4, !dbg !255
  %745 = sext i32 %744 to i64, !dbg !254
  %746 = getelementptr inbounds i32, ptr %743, i64 %745, !dbg !254
  store i32 1, ptr %746, align 4, !dbg !256
  %747 = load ptr, ptr %8, align 8, !dbg !257
  %748 = load i32, ptr %11, align 4, !dbg !258
  %749 = sext i32 %748 to i64, !dbg !257
  %750 = getelementptr inbounds i32, ptr %747, i64 %749, !dbg !257
  store i32 1, ptr %750, align 4, !dbg !259
  %751 = load i32, ptr %13, align 4, !dbg !260
  %752 = add nsw i32 %751, 1, !dbg !260
  store i32 %752, ptr %13, align 4, !dbg !260
  br label %753, !dbg !261

753:                                              ; preds = %737, %734
  br label %754, !dbg !262

754:                                              ; preds = %753
  %755 = load i32, ptr %13, align 4, !dbg !263
  %756 = load i32, ptr %4, align 4, !dbg !264
  %757 = icmp slt i32 %755, %756, !dbg !265
  br i1 %757, label %634, label %758, !dbg !262, !llvm.loop !266

758:                                              ; preds = %754
  store i32 0, ptr %2, align 4, !dbg !268
  br label %759, !dbg !270

759:                                              ; preds = %781, %758
  %760 = load i32, ptr %2, align 4, !dbg !271
  %761 = load i32, ptr %4, align 4, !dbg !273
  %762 = icmp slt i32 %760, %761, !dbg !274
  br i1 %762, label %763, label %784, !dbg !275

763:                                              ; preds = %759
  %764 = load ptr, ptr %5, align 8, !dbg !276
  %765 = load i32, ptr %2, align 4, !dbg !278
  %766 = sext i32 %765 to i64, !dbg !276
  %767 = getelementptr inbounds i64, ptr %764, i64 %766, !dbg !276
  %768 = load i64, ptr %767, align 8, !dbg !276
  %769 = load i32, ptr %2, align 4, !dbg !279
  %770 = load ptr, ptr %6, align 8, !dbg !280
  %771 = load i32, ptr %2, align 4, !dbg !281
  %772 = sext i32 %771 to i64, !dbg !280
  %773 = getelementptr inbounds i32, ptr %770, i64 %772, !dbg !280
  %774 = load i32, ptr %773, align 4, !dbg !280
  %775 = sub nsw i32 %769, %774, !dbg !282
  %776 = call i32 @llvm.abs.i32(i32 %775, i1 true), !dbg !283
  %777 = sext i32 %776 to i64, !dbg !283
  %778 = mul nsw i64 %768, %777, !dbg !284
  %779 = load i64, ptr %14, align 8, !dbg !285
  %780 = add nsw i64 %779, %778, !dbg !285
  store i64 %780, ptr %14, align 8, !dbg !285
  br label %781, !dbg !286

781:                                              ; preds = %763
  %782 = load i32, ptr %2, align 4, !dbg !287
  %783 = add nsw i32 %782, 1, !dbg !287
  store i32 %783, ptr %2, align 4, !dbg !287
  br label %759, !dbg !288, !llvm.loop !289

784:                                              ; preds = %759
  %785 = load i64, ptr %14, align 8, !dbg !291
  %786 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %785), !dbg !292
  %787 = load ptr, ptr @stdout, align 8, !dbg !293
  %788 = call i32 @fflush(ptr noundef %787), !dbg !294
  %789 = load ptr, ptr %5, align 8, !dbg !295
  call void @free(ptr noundef %789) #6, !dbg !296
  ret i32 0, !dbg !297
}
