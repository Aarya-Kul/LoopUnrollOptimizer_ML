...
643:                                              ; preds = %639
  ...
  %646 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %645, !dbg !80
...
651:                                              ; preds = %643
  ...
  %654 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %653, !dbg !88
  %655 = load i32, ptr %654, align 4, !dbg !88
  %656 = sext i32 %655 to i64, !dbg !89
  %657 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %656, !dbg !89
...
660:                                              ; preds = %643
  ...
  %663 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %662, !dbg !92
  %664 = load i32, ptr %663, align 4, !dbg !92
  %665 = sext i32 %664 to i64, !dbg !93
  %666 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %665, !dbg !93
...
678:                                              ; preds = %675
  ...
  %682 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %681, !dbg !113
  %683 = load i32, ptr %682, align 4, !dbg !113
  %684 = icmp slt i32 %679, %683, !dbg !114
  br i1 %684, label %685, label %691, !dbg !115

685:                                              ; preds = %678
  %686 = load i32, ptr %3, align 4, !dbg !116
  %687 = sext i32 %686 to i64, !dbg !118
  %688 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %687, !dbg !118
...
691:                                              ; preds = %685, %678
  ...
  %695 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %694, !dbg !126
  %696 = load i32, ptr %695, align 4, !dbg !126
  %697 = icmp slt i32 %692, %696, !dbg !127
  br i1 %697, label %698, label %704, !dbg !128

698:                                              ; preds = %691
  %699 = load i32, ptr %3, align 4, !dbg !129
  %700 = sext i32 %699 to i64, !dbg !131
  %701 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %700, !dbg !131
...
717:                                              ; preds = %713
  ...
  %720 = getelementptr inbounds [200000 x i32], ptr %5, i64 0, i64 %719, !dbg !154
...
721:                                              ; preds = %713
  ...
  %724 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 %723, !dbg !157
...
726:                                              ; preds = %725
  br label %674, !dbg !100, !llvm.loop !161

727:                                              ; preds = %712
  call void @llvm.dbg.declare(metadata ptr %11, metadata !163, metadata !DIExpression()), !dbg !164
  %728 = load i32, ptr %2, align 4, !dbg !165
  %729 = load i32, ptr %8, align 4, !dbg !166
  %730 = sub nsw i32 %728, %729, !dbg !167
  %731 = load i32, ptr %7, align 4, !dbg !168
  %732 = sub nsw i32 %730, %731, !dbg !169
  store i32 %732, ptr %11, align 4, !dbg !164
  %733 = load i32, ptr %11, align 4, !dbg !170
  %734 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %733), !dbg !171
  ret i32 0, !dbg !172
}
