...
148:                                              ; preds = %145
  ...
  br label %158, !dbg !199

151:                                              ; preds = %145, %142, %135
  %152 = load i32, ptr %10, align 4, !dbg !200
  %153 = icmp eq i32 %152, 1, !dbg !203
  br i1 %153, label %154, label %157, !dbg !204

154:                                              ; preds = %151
  %155 = load i32, ptr %9, align 4, !dbg !205
  %156 = add nsw i32 %155, 1, !dbg !205
  store i32 %156, ptr %9, align 4, !dbg !205
  br label %157, !dbg !207
...
164:                                              ; preds = %163, %52
  br label %165, !dbg !209

165:                                              ; preds = %164
  %166 = load i32, ptr %12, align 4, !dbg !210
  %167 = add nsw i32 %166, 1, !dbg !210
  store i32 %167, ptr %12, align 4, !dbg !210
  br label %39, !dbg !211, !llvm.loop !212

168:                                              ; preds = %39
  %169 = load i32, ptr %2, align 4, !dbg !214
  %170 = icmp sgt i32 %169, 0, !dbg !216
  br i1 %170, label %171, label %194, !dbg !217

171:                                              ; preds = %168
  %172 = load i32, ptr %3, align 4, !dbg !218
  %173 = icmp sgt i32 %172, 0, !dbg !219
  br i1 %173, label %174, label %194, !dbg !220

174:                                              ; preds = %171
  %175 = load i32, ptr %4, align 4, !dbg !221
  %176 = icmp sgt i32 %175, 0, !dbg !222
  br i1 %176, label %177, label %194, !dbg !223

177:                                              ; preds = %174
  %178 = load i32, ptr %5, align 4, !dbg !224
  %179 = icmp sgt i32 %178, 0, !dbg !225
  br i1 %179, label %180, label %194, !dbg !226

180:                                              ; preds = %177
  %181 = load i32, ptr %6, align 4, !dbg !227
  %182 = icmp sgt i32 %181, 0, !dbg !228
  br i1 %182, label %183, label %194, !dbg !229

183:                                              ; preds = %180
  %184 = load i32, ptr %7, align 4, !dbg !230
  %185 = icmp sgt i32 %184, 0, !dbg !231
  br i1 %185, label %186, label %194, !dbg !232

186:                                              ; preds = %183
  %187 = load i32, ptr %8, align 4, !dbg !233
  %188 = icmp sgt i32 %187, 0, !dbg !234
  br i1 %188, label %189, label %194, !dbg !235

189:                                              ; preds = %186
  %190 = load i32, ptr %9, align 4, !dbg !236
  %191 = icmp slt i32 %190, 2, !dbg !237
  br i1 %191, label %192, label %194, !dbg !238

192:                                              ; preds = %189
  %193 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !239
  br label %196, !dbg !241

194:                                              ; preds = %189, %186, %183, %180, %177, %174, %171, %168
  %195 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !242
  br label %196
...
!204 = !DILocation(line: 58, column: 16, scope: !202)
!205 = !DILocation(line: 59, column: 18, scope: !206)
!206 = distinct !DILexicalBlock(scope: !201, file: !2, line: 58, column: 25)
!207 = !DILocation(line: 60, column: 13, scope: !206)
!208 = !DILocation(line: 61, column: 18, scope: !202)
!209 = !DILocation(line: 63, column: 5, scope: !99)
!210 = !DILocation(line: 27, column: 20, scope: !94)
!211 = !DILocation(line: 27, column: 5, scope: !94)
!212 = distinct !{!212, !96, !213, !73}
!213 = !DILocation(line: 63, column: 5, scope: !91)
