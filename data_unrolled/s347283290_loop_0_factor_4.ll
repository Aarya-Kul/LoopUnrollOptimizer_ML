...
184:                                              ; preds = %204, %183
  ...
  %186 = icmp sgt i32 %185, 0, !dbg !57
  br i1 %186, label %187, label %207, !dbg !55

187:                                              ; preds = %184
  %188 = load i32, ptr %4, align 4, !dbg !58
  %189 = srem i32 %188, 10, !dbg !60
  store i32 %189, ptr %2, align 4, !dbg !61
  %190 = load i32, ptr %2, align 4, !dbg !62
  %191 = icmp eq i32 %190, 1, !dbg !64
  br i1 %191, label %192, label %195, !dbg !65

192:                                              ; preds = %187
  %193 = load i32, ptr %3, align 4, !dbg !66
  %194 = add nsw i32 %193, 1, !dbg !66
  store i32 %194, ptr %3, align 4, !dbg !66
  br label %198, !dbg !67

195:                                              ; preds = %187
  %196 = load i32, ptr %3, align 4, !dbg !68
  %197 = add nsw i32 %196, 9, !dbg !68
  store i32 %197, ptr %3, align 4, !dbg !68
  br label %198

198:                                              ; preds = %195, %192
  %199 = load i32, ptr %3, align 4, !dbg !69
  %200 = icmp slt i32 %199, 100, !dbg !71
  br i1 %200, label %201, label %204, !dbg !72

201:                                              ; preds = %198
  %202 = load i32, ptr %3, align 4, !dbg !73
  %203 = mul nsw i32 %202, 10, !dbg !73
  store i32 %203, ptr %3, align 4, !dbg !73
  br label %204, !dbg !74

204:                                              ; preds = %201, %198
  %205 = load i32, ptr %4, align 4, !dbg !75
  %206 = sdiv i32 %205, 10, !dbg !75
  store i32 %206, ptr %4, align 4, !dbg !75
  br label %184, !dbg !55, !llvm.loop !76

207:                                              ; preds = %184
  %208 = load i32, ptr %3, align 4, !dbg !78
  %209 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %208), !dbg !79
  %210 = load i32, ptr %1, align 4, !dbg !80
  ret i32 %210, !dbg !80
}
