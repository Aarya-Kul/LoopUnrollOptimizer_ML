...
799:                                              ; preds = %795
  ...
  %809 = sub nsw i64 %808, 1, !dbg !237
  %810 = sdiv i64 %809, 2, !dbg !238
  %811 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !239
  %812 = fptosi double %811 to i64, !dbg !240
  %813 = add nsw i64 %810, %812, !dbg !241
  ...
  %823 = sub nsw i64 %822, 1, !dbg !248
  %824 = sdiv i64 %823, 2, !dbg !249
  %825 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !250
  %826 = fptosi double %825 to i64, !dbg !251
  %827 = add nsw i64 %824, %826, !dbg !252
