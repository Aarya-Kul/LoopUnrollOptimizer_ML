...
12063:                                            ; preds = %12062
  ...
  br i1 %12066, label %11943, label %12067, !dbg !262, !llvm.loop !266

12067:                                            ; preds = %12063
  store i32 0, ptr %2, align 4, !dbg !268
  br label %12068, !dbg !270

12068:                                            ; preds = %12090, %12067
  %12069 = load i32, ptr %2, align 4, !dbg !271
  %12070 = load i32, ptr %4, align 4, !dbg !273
  %12071 = icmp slt i32 %12069, %12070, !dbg !274
  br i1 %12071, label %12072, label %12093, !dbg !275

12072:                                            ; preds = %12068
  %12073 = load ptr, ptr %5, align 8, !dbg !276
  %12074 = load i32, ptr %2, align 4, !dbg !278
  %12075 = sext i32 %12074 to i64, !dbg !276
  %12076 = getelementptr inbounds i64, ptr %12073, i64 %12075, !dbg !276
  %12077 = load i64, ptr %12076, align 8, !dbg !276
  %12078 = load i32, ptr %2, align 4, !dbg !279
  %12079 = load ptr, ptr %6, align 8, !dbg !280
  %12080 = load i32, ptr %2, align 4, !dbg !281
  %12081 = sext i32 %12080 to i64, !dbg !280
  %12082 = getelementptr inbounds i32, ptr %12079, i64 %12081, !dbg !280
  %12083 = load i32, ptr %12082, align 4, !dbg !280
  %12084 = sub nsw i32 %12078, %12083, !dbg !282
  %12085 = call i32 @llvm.abs.i32(i32 %12084, i1 true), !dbg !283
  %12086 = sext i32 %12085 to i64, !dbg !283
  %12087 = mul nsw i64 %12077, %12086, !dbg !284
  %12088 = load i64, ptr %14, align 8, !dbg !285
  %12089 = add nsw i64 %12088, %12087, !dbg !285
  store i64 %12089, ptr %14, align 8, !dbg !285
  br label %12090, !dbg !286

12090:                                            ; preds = %12072
  %12091 = load i32, ptr %2, align 4, !dbg !287
  %12092 = add nsw i32 %12091, 1, !dbg !287
  store i32 %12092, ptr %2, align 4, !dbg !287
  br label %12068, !dbg !288, !llvm.loop !289

12093:                                            ; preds = %12068
  %12094 = load i64, ptr %14, align 8, !dbg !291
  %12095 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %12094), !dbg !292
  %12096 = load ptr, ptr @stdout, align 8, !dbg !293
  %12097 = call i32 @fflush(ptr noundef %12096), !dbg !294
  %12098 = load ptr, ptr %5, align 8, !dbg !295
  call void @free(ptr noundef %12098) #6, !dbg !296
  ret i32 0, !dbg !297
}
