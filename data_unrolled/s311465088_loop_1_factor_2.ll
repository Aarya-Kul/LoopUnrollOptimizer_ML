...
5808:                                             ; preds = %5807
  ...
  br i1 %5813, label %5814, label %5850, !dbg !171
...
5823:                                             ; preds = %5815
  %5824 = load i32, ptr %4, align 4, !dbg !182
  %5825 = sext i32 %5824 to i64, !dbg !185
  %5826 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %5825, !dbg !185
  %5827 = load i32, ptr %5826, align 4, !dbg !185
  %5828 = load i32, ptr %3, align 4, !dbg !186
  %5829 = sext i32 %5828 to i64, !dbg !187
  %5830 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %5829, !dbg !187
  %5831 = load i32, ptr %5830, align 4, !dbg !187
  %5832 = icmp slt i32 %5827, %5831, !dbg !188
  br i1 %5832, label %5833, label %5846, !dbg !189

5833:                                             ; preds = %5823
  %5834 = load i32, ptr %3, align 4, !dbg !190
  %5835 = sext i32 %5834 to i64, !dbg !192
  %5836 = getelementptr inbounds i32, ptr @A, i64 %5835, !dbg !192
  %5837 = load i32, ptr %4, align 4, !dbg !193
  %5838 = sext i32 %5837 to i64, !dbg !194
  %5839 = getelementptr inbounds i32, ptr @A, i64 %5838, !dbg !194
  call void @swap(ptr noundef %5836, ptr noundef %5839), !dbg !195
  %5840 = load i32, ptr %3, align 4, !dbg !196
  %5841 = sext i32 %5840 to i64, !dbg !197
  %5842 = getelementptr inbounds i32, ptr @hash, i64 %5841, !dbg !197
  %5843 = load i32, ptr %4, align 4, !dbg !198
  %5844 = sext i32 %5843 to i64, !dbg !199
  %5845 = getelementptr inbounds i32, ptr @hash, i64 %5844, !dbg !199
  call void @swap(ptr noundef %5842, ptr noundef %5845), !dbg !200
  br label %5846, !dbg !201

5846:                                             ; preds = %5833, %5823
  br label %5847, !dbg !202

5847:                                             ; preds = %5846
  %5848 = load i32, ptr %4, align 4, !dbg !203
  %5849 = add nsw i32 %5848, 1, !dbg !203
  store i32 %5849, ptr %4, align 4, !dbg !203
  br label %5815, !dbg !204, !llvm.loop !205

5850:                                             ; preds = %5808, %5771
  ...
  br label %5851, !dbg !216

5851:                                             ; preds = %5901, %5850
  %5852 = load i32, ptr %5, align 4, !dbg !217
  %5853 = load i32, ptr @N, align 4, !dbg !219
  %5854 = icmp sle i32 %5852, %5853, !dbg !220
  br i1 %5854, label %5855, label %5904, !dbg !221

5855:                                             ; preds = %5851
  %5856 = load i32, ptr %5, align 4, !dbg !222
  %5857 = sub nsw i32 %5856, 1, !dbg !224
  %5858 = sext i32 %5857 to i64, !dbg !225
  %5859 = getelementptr inbounds [2001 x i32], ptr @DP, i64 0, i64 %5858, !dbg !225
  %5860 = load i32, ptr %5859, align 4, !dbg !225
  %5861 = load i32, ptr %5, align 4, !dbg !226
  %5862 = sext i32 %5861 to i64, !dbg !227
  %5863 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %5862, !dbg !227
  %5864 = load i32, ptr %5863, align 4, !dbg !227
  %5865 = load i32, ptr %5, align 4, !dbg !228
  %5866 = sext i32 %5865 to i64, !dbg !229
  %5867 = getelementptr inbounds [2001 x i32], ptr @hash, i64 0, i64 %5866, !dbg !229
  %5868 = load i32, ptr %5867, align 4, !dbg !229
  %5869 = load i32, ptr %5, align 4, !dbg !230
  %5870 = sub nsw i32 %5868, %5869, !dbg !231
  %5871 = mul nsw i32 %5864, %5870, !dbg !232
  %5872 = add nsw i32 %5860, %5871, !dbg !233
  %5873 = load i32, ptr %5, align 4, !dbg !234
  %5874 = sext i32 %5873 to i64, !dbg !235
  %5875 = getelementptr inbounds [2001 x i32], ptr @DP, i64 0, i64 %5874, !dbg !235
  store i32 %5872, ptr %5875, align 4, !dbg !236
  %5876 = load i32, ptr %5, align 4, !dbg !237
  %5877 = sub nsw i32 %5876, 1, !dbg !238
  %5878 = sext i32 %5877 to i64, !dbg !239
  %5879 = getelementptr inbounds [2001 x [2001 x i32]], ptr @DP, i64 0, i64 %5878, !dbg !239
  %5880 = getelementptr inbounds [2001 x i32], ptr %5879, i64 0, i64 0, !dbg !239
  %5881 = load i32, ptr %5880, align 4, !dbg !239
  %5882 = load i32, ptr %5, align 4, !dbg !240
  %5883 = sext i32 %5882 to i64, !dbg !241
  %5884 = getelementptr inbounds [2001 x i32], ptr @A, i64 0, i64 %5883, !dbg !241
  %5885 = load i32, ptr %5884, align 4, !dbg !241
  %5886 = load i32, ptr @N, align 4, !dbg !242
  %5887 = add nsw i32 %5886, 1, !dbg !243
  %5888 = load i32, ptr %5, align 4, !dbg !244
  %5889 = sub nsw i32 %5887, %5888, !dbg !245
  %5890 = load i32, ptr %5, align 4, !dbg !246
  %5891 = sext i32 %5890 to i64, !dbg !247
  %5892 = getelementptr inbounds [2001 x i32], ptr @hash, i64 0, i64 %5891, !dbg !247
  %5893 = load i32, ptr %5892, align 4, !dbg !247
  %5894 = sub nsw i32 %5889, %5893, !dbg !248
  %5895 = mul nsw i32 %5885, %5894, !dbg !249
  %5896 = add nsw i32 %5881, %5895, !dbg !250
  %5897 = load i32, ptr %5, align 4, !dbg !251
  %5898 = sext i32 %5897 to i64, !dbg !252
  %5899 = getelementptr inbounds [2001 x [2001 x i32]], ptr @DP, i64 0, i64 %5898, !dbg !252
  %5900 = getelementptr inbounds [2001 x i32], ptr %5899, i64 0, i64 0, !dbg !252
  store i32 %5896, ptr %5900, align 4, !dbg !253
  br label %5901, !dbg !254

5901:                                             ; preds = %5855
  %5902 = load i32, ptr %5, align 4, !dbg !255
  %5903 = add nsw i32 %5902, 1, !dbg !255
  store i32 %5903, ptr %5, align 4, !dbg !255
  br label %5851, !dbg !256, !llvm.loop !257
...
5904:                                             ; preds = %5851
  ...
  br label %5905, !dbg !265

5905:                                             ; preds = %5921, %5904
  %5906 = load i32, ptr %7, align 4, !dbg !266
  %5907 = load i32, ptr @N, align 4, !dbg !268
  %5908 = icmp sle i32 %5906, %5907, !dbg !269
  br i1 %5908, label %5909, label %5924, !dbg !270

5909:                                             ; preds = %5905
  %5910 = load i32, ptr %6, align 4, !dbg !271
  %5911 = load i32, ptr %7, align 4, !dbg !272
  %5912 = sext i32 %5911 to i64, !dbg !273
  %5913 = getelementptr inbounds [2001 x [2001 x i32]], ptr @DP, i64 0, i64 %5912, !dbg !273
  %5914 = load i32, ptr @N, align 4, !dbg !274
  %5915 = load i32, ptr %7, align 4, !dbg !275
  %5916 = sub nsw i32 %5914, %5915, !dbg !276
  %5917 = sext i32 %5916 to i64, !dbg !273
  %5918 = getelementptr inbounds [2001 x i32], ptr %5913, i64 0, i64 %5917, !dbg !273
  %5919 = load i32, ptr %5918, align 4, !dbg !273
  %5920 = call i32 @max(i32 noundef %5910, i32 noundef %5919), !dbg !277
  store i32 %5920, ptr %6, align 4, !dbg !278
  br label %5921, !dbg !279

5921:                                             ; preds = %5909
  %5922 = load i32, ptr %7, align 4, !dbg !280
  %5923 = add nsw i32 %5922, 1, !dbg !280
  store i32 %5923, ptr %7, align 4, !dbg !280
  br label %5905, !dbg !281, !llvm.loop !282

5924:                                             ; preds = %5905
  %5925 = load i32, ptr %6, align 4, !dbg !284
  %5926 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5925), !dbg !285
  %5927 = load i32, ptr %1, align 4, !dbg !286
  ret i32 %5927, !dbg !286
}
