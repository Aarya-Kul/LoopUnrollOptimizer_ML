...
3844:                                             ; preds = %3989, %3843
  ...
  br i1 %3855, label %3856, label %3990, !dbg !57
...
3862:                                             ; preds = %3983, %3965, %3947, %3929, %3911, %3893, %3875, %3856
...
3863:                                             ; preds = %3856
  ...
  br i1 %3874, label %3875, label %3990, !dbg !57
...
3881:                                             ; preds = %3875
  ...
  br i1 %3892, label %3893, label %3990, !dbg !57
...
3899:                                             ; preds = %3893
  ...
  br i1 %3910, label %3911, label %3990, !dbg !57
...
3917:                                             ; preds = %3911
  ...
  br i1 %3928, label %3929, label %3990, !dbg !57
...
3935:                                             ; preds = %3929
  ...
  br i1 %3946, label %3947, label %3990, !dbg !57
...
3953:                                             ; preds = %3947
  ...
  br i1 %3964, label %3965, label %3990, !dbg !57
...
3971:                                             ; preds = %3965
  ...
  br i1 %3982, label %3983, label %3990, !dbg !57
...
3990:                                             ; preds = %3971, %3953, %3935, %3917, %3899, %3881, %3863, %3862, %3844
  %3991 = load i32, ptr @s, align 4, !dbg !74
  %3992 = add nsw i32 %3991, -1, !dbg !74
  store i32 %3992, ptr @s, align 4, !dbg !74
  br label %3993, !dbg !75

3993:                                             ; preds = %4017, %3990
  %3994 = load i32, ptr @s, align 4, !dbg !76
  %3995 = load i32, ptr @r, align 4, !dbg !77
  %3996 = sub nsw i32 %3994, %3995, !dbg !78
  %3997 = sext i32 %3996 to i64, !dbg !79
  %3998 = getelementptr inbounds [101 x i8], ptr @S, i64 0, i64 %3997, !dbg !79
  %3999 = load i8, ptr %3998, align 1, !dbg !79
  %4000 = sext i8 %3999 to i32, !dbg !79
  %4001 = load i32, ptr @r, align 4, !dbg !80
  %4002 = sub nsw i32 6, %4001, !dbg !81
  %4003 = sext i32 %4002 to i64, !dbg !82
  %4004 = getelementptr inbounds [7 x i8], ptr @T, i64 0, i64 %4003, !dbg !82
  %4005 = load i8, ptr %4004, align 1, !dbg !82
  %4006 = sext i8 %4005 to i32, !dbg !82
  %4007 = icmp eq i32 %4000, %4006, !dbg !83
  br i1 %4007, label %4008, label %4018, !dbg !75

4008:                                             ; preds = %3993
  %4009 = load i32, ptr @r, align 4, !dbg !84
  %4010 = add nsw i32 %4009, 1, !dbg !84
  store i32 %4010, ptr @r, align 4, !dbg !84
  %4011 = load i32, ptr @l, align 4, !dbg !86
  %4012 = load i32, ptr @r, align 4, !dbg !88
  %4013 = add nsw i32 %4011, %4012, !dbg !89
  %4014 = load i32, ptr @s, align 4, !dbg !90
  %4015 = icmp sge i32 %4013, %4014, !dbg !91
  br i1 %4015, label %4016, label %4017, !dbg !92

4016:                                             ; preds = %4008
  br label %4018, !dbg !93

4017:                                             ; preds = %4008
  br label %3993, !dbg !75, !llvm.loop !95

4018:                                             ; preds = %4016, %3993
  %4019 = load i32, ptr @l, align 4, !dbg !97
  %4020 = load i32, ptr @r, align 4, !dbg !99
  %4021 = add nsw i32 %4019, %4020, !dbg !100
  %4022 = icmp sge i32 %4021, 7, !dbg !101
  br i1 %4022, label %4023, label %4025, !dbg !102

4023:                                             ; preds = %4018
  %4024 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !103
  br label %4027, !dbg !105

4025:                                             ; preds = %4018
  %4026 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !106
  br label %4027

4027:                                             ; preds = %4025, %4023
  ret i32 0, !dbg !108
}
