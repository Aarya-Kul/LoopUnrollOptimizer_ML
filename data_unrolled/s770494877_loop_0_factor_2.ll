...
84:                                               ; preds = %122, %81
  ...
  br i1 %87, label %88, label %125, !dbg !118
...
102:                                              ; preds = %101
  ...
  br i1 %107, label %108, label %125, !dbg !118
...
126:                                              ; preds = %125, %80
  %127 = load i32, ptr %6, align 4, !dbg !143
  %128 = xor i32 %127, -1, !dbg !144
  %129 = load i32, ptr %4, align 4, !dbg !145
  %130 = sext i32 %129 to i64, !dbg !146
  %131 = getelementptr inbounds [512 x [512 x i32]], ptr @memo, i64 0, i64 %130, !dbg !146
  %132 = load i32, ptr %5, align 4, !dbg !147
  %133 = sext i32 %132 to i64, !dbg !146
  %134 = getelementptr inbounds [512 x i32], ptr %131, i64 0, i64 %133, !dbg !146
  store i32 %128, ptr %134, align 4, !dbg !148
  %135 = xor i32 %128, -1, !dbg !149
  store i32 %135, ptr %3, align 4, !dbg !150
  br label %136, !dbg !150

136:                                              ; preds = %126, %51, %27, %21, %15
  %137 = load i32, ptr %3, align 4, !dbg !151
  ret i32 %137, !dbg !151
}
