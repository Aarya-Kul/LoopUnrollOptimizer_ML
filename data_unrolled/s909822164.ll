...
2:                                                ; preds = %7, %0
  ...
  br i1 %6, label %7, label %13, !dbg !44
...
14:                                               ; preds = %33, %13
  %15 = load i32, ptr @l, align 4, !dbg !58
  %16 = sext i32 %15 to i64, !dbg !59
  %17 = getelementptr inbounds [101 x i8], ptr @S, i64 0, i64 %16, !dbg !59
  %18 = load i8, ptr %17, align 1, !dbg !59
  %19 = sext i8 %18 to i32, !dbg !59
  %20 = load i32, ptr @l, align 4, !dbg !60
  %21 = sext i32 %20 to i64, !dbg !61
  %22 = getelementptr inbounds [7 x i8], ptr @T, i64 0, i64 %21, !dbg !61
...
26:                                               ; preds = %14
  %27 = load i32, ptr @l, align 4, !dbg !63
  %28 = add nsw i32 %27, 1, !dbg !63
  store i32 %28, ptr @l, align 4, !dbg !63
  %29 = load i32, ptr @l, align 4, !dbg !65
  %30 = load i32, ptr @s, align 4, !dbg !67
  %31 = icmp sge i32 %29, %30, !dbg !68
  br i1 %31, label %32, label %33, !dbg !69

32:                                               ; preds = %26
  br label %34, !dbg !70

33:                                               ; preds = %26
  br label %14, !dbg !57, !llvm.loop !72

34:                                               ; preds = %32, %14
  %35 = load i32, ptr @s, align 4, !dbg !74
  %36 = add nsw i32 %35, -1, !dbg !74
  store i32 %36, ptr @s, align 4, !dbg !74
  br label %37, !dbg !75

37:                                               ; preds = %61, %34
  %38 = load i32, ptr @s, align 4, !dbg !76
  %39 = load i32, ptr @r, align 4, !dbg !77
  %40 = sub nsw i32 %38, %39, !dbg !78
  %41 = sext i32 %40 to i64, !dbg !79
  %42 = getelementptr inbounds [101 x i8], ptr @S, i64 0, i64 %41, !dbg !79
  %43 = load i8, ptr %42, align 1, !dbg !79
  %44 = sext i8 %43 to i32, !dbg !79
  %45 = load i32, ptr @r, align 4, !dbg !80
  %46 = sub nsw i32 6, %45, !dbg !81
  %47 = sext i32 %46 to i64, !dbg !82
  %48 = getelementptr inbounds [7 x i8], ptr @T, i64 0, i64 %47, !dbg !82
  %49 = load i8, ptr %48, align 1, !dbg !82
  %50 = sext i8 %49 to i32, !dbg !82
  %51 = icmp eq i32 %44, %50, !dbg !83
  br i1 %51, label %52, label %62, !dbg !75

52:                                               ; preds = %37
  %53 = load i32, ptr @r, align 4, !dbg !84
  %54 = add nsw i32 %53, 1, !dbg !84
  store i32 %54, ptr @r, align 4, !dbg !84
  %55 = load i32, ptr @l, align 4, !dbg !86
  %56 = load i32, ptr @r, align 4, !dbg !88
  %57 = add nsw i32 %55, %56, !dbg !89
  %58 = load i32, ptr @s, align 4, !dbg !90
  %59 = icmp sge i32 %57, %58, !dbg !91
...
61:                                               ; preds = %52
  br label %37, !dbg !75, !llvm.loop !95

62:                                               ; preds = %60, %37
  %63 = load i32, ptr @l, align 4, !dbg !97
  %64 = load i32, ptr @r, align 4, !dbg !99
  %65 = add nsw i32 %63, %64, !dbg !100
  %66 = icmp sge i32 %65, 7, !dbg !101
  br i1 %66, label %67, label %69, !dbg !102

67:                                               ; preds = %62
  %68 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !103
  br label %71, !dbg !105

69:                                               ; preds = %62
  %70 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !106
  br label %71
