...
1063:                                             ; preds = %1038, %1016, %994, %972, %950, %928, %906, %884, %862, %840, %818, %796, %774, %752, %730, %708, %686, %664, %642, %620, %598, %576, %554, %532, %510, %488, %466, %444, %422, %400, %378, %356, %334, %312, %290, %268, %246, %224, %202, %180, %158, %136, %114, %92, %70, %48, %26, %6
  ...
  br label %1064, !dbg !55

1064:                                             ; preds = %1084, %1063
  %1065 = load i32, ptr %4, align 4, !dbg !56
  %1066 = icmp sgt i32 %1065, 0, !dbg !57
  br i1 %1066, label %1067, label %1087, !dbg !55

1067:                                             ; preds = %1064
  %1068 = load i32, ptr %4, align 4, !dbg !58
  %1069 = srem i32 %1068, 10, !dbg !60
  store i32 %1069, ptr %2, align 4, !dbg !61
  %1070 = load i32, ptr %2, align 4, !dbg !62
  %1071 = icmp eq i32 %1070, 1, !dbg !64
  br i1 %1071, label %1072, label %1075, !dbg !65

1072:                                             ; preds = %1067
  %1073 = load i32, ptr %3, align 4, !dbg !66
  %1074 = add nsw i32 %1073, 1, !dbg !66
  store i32 %1074, ptr %3, align 4, !dbg !66
  br label %1078, !dbg !67

1075:                                             ; preds = %1067
  %1076 = load i32, ptr %3, align 4, !dbg !68
  %1077 = add nsw i32 %1076, 9, !dbg !68
  store i32 %1077, ptr %3, align 4, !dbg !68
  br label %1078

1078:                                             ; preds = %1075, %1072
  %1079 = load i32, ptr %3, align 4, !dbg !69
  %1080 = icmp slt i32 %1079, 100, !dbg !71
  br i1 %1080, label %1081, label %1084, !dbg !72

1081:                                             ; preds = %1078
  %1082 = load i32, ptr %3, align 4, !dbg !73
  %1083 = mul nsw i32 %1082, 10, !dbg !73
  store i32 %1083, ptr %3, align 4, !dbg !73
  br label %1084, !dbg !74

1084:                                             ; preds = %1081, %1078
  %1085 = load i32, ptr %4, align 4, !dbg !75
  %1086 = sdiv i32 %1085, 10, !dbg !75
  store i32 %1086, ptr %4, align 4, !dbg !75
  br label %1064, !dbg !55, !llvm.loop !76

1087:                                             ; preds = %1064
  %1088 = load i32, ptr %3, align 4, !dbg !78
  %1089 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %1088), !dbg !79
  %1090 = load i32, ptr %1, align 4, !dbg !80
  ret i32 %1090, !dbg !80
}
