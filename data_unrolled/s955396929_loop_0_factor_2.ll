...
69:                                               ; preds = %115, %67
  ...
  br i1 %72, label %73, label %118, !dbg !104
...
91:                                               ; preds = %89
  ...
  br i1 %96, label %97, label %118, !dbg !104
...
118:                                              ; preds = %91, %69
  %119 = load i32, ptr %6, align 4, !dbg !127
  %120 = load i32, ptr %4, align 4, !dbg !128
  %121 = sext i32 %120 to i64, !dbg !129
  %122 = getelementptr inbounds [300 x [300 x i32]], ptr @T, i64 0, i64 %121, !dbg !129
  %123 = load i32, ptr %5, align 4, !dbg !130
  %124 = sext i32 %123 to i64, !dbg !129
  %125 = getelementptr inbounds [300 x i32], ptr %122, i64 0, i64 %124, !dbg !129
  store i32 %119, ptr %125, align 4, !dbg !131
  store i32 %119, ptr %3, align 4, !dbg !132
  br label %126, !dbg !132

126:                                              ; preds = %118, %55, %43, %18
  %127 = load i32, ptr %3, align 4, !dbg !133
  ret i32 %127, !dbg !133
}
