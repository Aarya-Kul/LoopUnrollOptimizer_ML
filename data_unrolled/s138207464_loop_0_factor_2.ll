...
10:                                               ; preds = %130, %0
  ...
  br i1 %17, label %18, label %133, !dbg !57
...
70:                                               ; preds = %69, %43
  ...
  br i1 %79, label %80, label %133, !dbg !57
...
133:                                              ; preds = %70, %42, %21, %10
  store i32 1, ptr %4, align 4, !dbg !112
  br i1 true, label %134, label %136, !dbg !114

134:                                              ; preds = %133
  %135 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !115
  br label %138, !dbg !115

136:                                              ; preds = %133
  %137 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !116
  br label %138
