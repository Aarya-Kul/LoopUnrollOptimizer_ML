...
10:                                               ; preds = %204, %0
  ...
  br i1 %13, label %14, label %362, !dbg !43
...
180:                                              ; preds = %35
  ...
  br i1 %189, label %190, label %362, !dbg !43
...
194:                                              ; preds = %359, %193
  ...
  br i1 %197, label %353, label %198, !dbg !61
...
201:                                              ; preds = %225, %198
  ...
  br i1 %203, label %211, label %204, !dbg !83
...
211:                                              ; preds = %201
  %212 = load i32, ptr %7, align 4, !dbg !84
  %213 = sext i32 %212 to i64, !dbg !86
  %214 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %213, !dbg !86
  %215 = load i32, ptr %7, align 4, !dbg !87
  %216 = sext i32 %215 to i64, !dbg !86
  %217 = getelementptr inbounds [301 x i32], ptr %214, i64 0, i64 %216, !dbg !86
  store i32 0, ptr %217, align 4, !dbg !88
  call void @llvm.dbg.declare(metadata ptr %8, metadata !89, metadata !DIExpression()), !dbg !91
  %218 = load i32, ptr %7, align 4, !dbg !92
  %219 = add nsw i32 %218, 1, !dbg !93
  store i32 %219, ptr %8, align 4, !dbg !91
  br label %220, !dbg !94

220:                                              ; preds = %298, %211
  %221 = load i32, ptr %8, align 4, !dbg !95
  %222 = load i32, ptr %2, align 4, !dbg !97
  %223 = icmp slt i32 %221, %222, !dbg !98
  br i1 %223, label %228, label %224, !dbg !99

224:                                              ; preds = %220
  br label %225, !dbg !193

225:                                              ; preds = %224
  %226 = load i32, ptr %7, align 4, !dbg !194
  %227 = add nsw i32 %226, -1, !dbg !194
  store i32 %227, ptr %7, align 4, !dbg !194
  br label %201, !dbg !195, !llvm.loop !196

228:                                              ; preds = %220
  %229 = load i32, ptr %8, align 4, !dbg !100
  %230 = load i32, ptr %7, align 4, !dbg !103
  %231 = add nsw i32 %230, 1, !dbg !104
  %232 = icmp eq i32 %229, %231, !dbg !105
  br i1 %232, label %233, label %245, !dbg !106

233:                                              ; preds = %228
  %234 = load i32, ptr %7, align 4, !dbg !107
  %235 = sext i32 %234 to i64, !dbg !108
  %236 = getelementptr inbounds [300 x i32], ptr %3, i64 0, i64 %235, !dbg !108
  %237 = load i32, ptr %236, align 4, !dbg !108
  %238 = load i32, ptr %8, align 4, !dbg !109
  %239 = sext i32 %238 to i64, !dbg !110
  %240 = getelementptr inbounds [300 x i32], ptr %3, i64 0, i64 %239, !dbg !110
  %241 = load i32, ptr %240, align 4, !dbg !110
  %242 = sub nsw i32 %237, %241, !dbg !111
  %243 = call i32 @llvm.abs.i32(i32 %242, i1 true), !dbg !112
  %244 = icmp sle i32 %243, 1, !dbg !113
  br i1 %244, label %284, label %245, !dbg !114

245:                                              ; preds = %233, %228
  %246 = load i32, ptr %7, align 4, !dbg !119
  %247 = sext i32 %246 to i64, !dbg !121
  %248 = getelementptr inbounds [300 x i32], ptr %3, i64 0, i64 %247, !dbg !121
  %249 = load i32, ptr %248, align 4, !dbg !121
  %250 = load i32, ptr %8, align 4, !dbg !122
  %251 = sext i32 %250 to i64, !dbg !123
  %252 = getelementptr inbounds [300 x i32], ptr %3, i64 0, i64 %251, !dbg !123
  %253 = load i32, ptr %252, align 4, !dbg !123
  %254 = sub nsw i32 %249, %253, !dbg !124
  %255 = call i32 @llvm.abs.i32(i32 %254, i1 true), !dbg !125
  %256 = icmp sle i32 %255, 1, !dbg !126
  br i1 %256, label %257, label %283, !dbg !127

257:                                              ; preds = %245
  %258 = load i32, ptr %7, align 4, !dbg !128
  %259 = add nsw i32 %258, 1, !dbg !129
  %260 = sext i32 %259 to i64, !dbg !130
  %261 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %260, !dbg !130
  %262 = load i32, ptr %8, align 4, !dbg !131
  %263 = sub nsw i32 %262, 1, !dbg !132
  %264 = sext i32 %263 to i64, !dbg !130
  %265 = getelementptr inbounds [301 x i32], ptr %261, i64 0, i64 %264, !dbg !130
  %266 = load i32, ptr %265, align 4, !dbg !130
  %267 = load i32, ptr %8, align 4, !dbg !133
  %268 = load i32, ptr %7, align 4, !dbg !134
  %269 = sub nsw i32 %267, %268, !dbg !135
  %270 = sub nsw i32 %269, 1, !dbg !136
  %271 = icmp eq i32 %266, %270, !dbg !137
  br i1 %271, label %272, label %283, !dbg !138

272:                                              ; preds = %257
  %273 = load i32, ptr %8, align 4, !dbg !139
  %274 = load i32, ptr %7, align 4, !dbg !140
  %275 = sub nsw i32 %273, %274, !dbg !141
  %276 = add nsw i32 %275, 1, !dbg !142
  %277 = load i32, ptr %7, align 4, !dbg !143
  %278 = sext i32 %277 to i64, !dbg !144
  %279 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %278, !dbg !144
  %280 = load i32, ptr %8, align 4, !dbg !145
  %281 = sext i32 %280 to i64, !dbg !144
  %282 = getelementptr inbounds [301 x i32], ptr %279, i64 0, i64 %281, !dbg !144
  store i32 %276, ptr %282, align 4, !dbg !146
  br label %283, !dbg !144

283:                                              ; preds = %272, %257, %245
  br label %291

284:                                              ; preds = %233
  %285 = load i32, ptr %7, align 4, !dbg !115
  %286 = sext i32 %285 to i64, !dbg !116
  %287 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %286, !dbg !116
  %288 = load i32, ptr %8, align 4, !dbg !117
  %289 = sext i32 %288 to i64, !dbg !116
  %290 = getelementptr inbounds [301 x i32], ptr %287, i64 0, i64 %289, !dbg !116
  store i32 2, ptr %290, align 4, !dbg !118
  br label %291, !dbg !116

291:                                              ; preds = %284, %283
  call void @llvm.dbg.declare(metadata ptr %9, metadata !147, metadata !DIExpression()), !dbg !149
  %292 = load i32, ptr %8, align 4, !dbg !150
  store i32 %292, ptr %9, align 4, !dbg !149
  br label %293, !dbg !151

293:                                              ; preds = %350, %291
  %294 = load i32, ptr %9, align 4, !dbg !152
  %295 = load i32, ptr %2, align 4, !dbg !154
  %296 = icmp slt i32 %294, %295, !dbg !155
  br i1 %296, label %301, label %297, !dbg !156

297:                                              ; preds = %293
  br label %298, !dbg !188

298:                                              ; preds = %297
  %299 = load i32, ptr %8, align 4, !dbg !189
  %300 = add nsw i32 %299, 1, !dbg !189
  store i32 %300, ptr %8, align 4, !dbg !189
  br label %220, !dbg !190, !llvm.loop !191

301:                                              ; preds = %293
  %302 = load i32, ptr %7, align 4, !dbg !157
  %303 = sext i32 %302 to i64, !dbg !159
  %304 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %303, !dbg !159
  %305 = load i32, ptr %9, align 4, !dbg !160
  %306 = sext i32 %305 to i64, !dbg !159
  %307 = getelementptr inbounds [301 x i32], ptr %304, i64 0, i64 %306, !dbg !159
  %308 = load i32, ptr %307, align 4, !dbg !159
  %309 = load i32, ptr %7, align 4, !dbg !161
  %310 = sext i32 %309 to i64, !dbg !162
  %311 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %310, !dbg !162
  %312 = load i32, ptr %8, align 4, !dbg !163
  %313 = sub nsw i32 %312, 1, !dbg !164
  %314 = sext i32 %313 to i64, !dbg !162
  %315 = getelementptr inbounds [301 x i32], ptr %311, i64 0, i64 %314, !dbg !162
  %316 = load i32, ptr %315, align 4, !dbg !162
  %317 = load i32, ptr %8, align 4, !dbg !165
  %318 = sext i32 %317 to i64, !dbg !166
  %319 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %318, !dbg !166
  %320 = load i32, ptr %9, align 4, !dbg !167
  %321 = sext i32 %320 to i64, !dbg !166
  %322 = getelementptr inbounds [301 x i32], ptr %319, i64 0, i64 %321, !dbg !166
  %323 = load i32, ptr %322, align 4, !dbg !166
  %324 = add nsw i32 %316, %323, !dbg !168
  %325 = icmp slt i32 %308, %324, !dbg !169
  br i1 %325, label %326, label %349, !dbg !170

326:                                              ; preds = %301
  %327 = load i32, ptr %7, align 4, !dbg !171
  %328 = sext i32 %327 to i64, !dbg !172
  %329 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %328, !dbg !172
  %330 = load i32, ptr %8, align 4, !dbg !173
  %331 = sub nsw i32 %330, 1, !dbg !174
  %332 = sext i32 %331 to i64, !dbg !172
  %333 = getelementptr inbounds [301 x i32], ptr %329, i64 0, i64 %332, !dbg !172
  %334 = load i32, ptr %333, align 4, !dbg !172
  %335 = load i32, ptr %8, align 4, !dbg !175
  %336 = sext i32 %335 to i64, !dbg !176
  %337 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %336, !dbg !176
  %338 = load i32, ptr %9, align 4, !dbg !177
  %339 = sext i32 %338 to i64, !dbg !176
  %340 = getelementptr inbounds [301 x i32], ptr %337, i64 0, i64 %339, !dbg !176
  %341 = load i32, ptr %340, align 4, !dbg !176
  %342 = add nsw i32 %334, %341, !dbg !178
  %343 = load i32, ptr %7, align 4, !dbg !179
  %344 = sext i32 %343 to i64, !dbg !180
  %345 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %344, !dbg !180
  %346 = load i32, ptr %9, align 4, !dbg !181
  %347 = sext i32 %346 to i64, !dbg !180
  %348 = getelementptr inbounds [301 x i32], ptr %345, i64 0, i64 %347, !dbg !180
  store i32 %342, ptr %348, align 4, !dbg !182
  br label %349, !dbg !180

349:                                              ; preds = %326, %301
  br label %350, !dbg !183

350:                                              ; preds = %349
  %351 = load i32, ptr %9, align 4, !dbg !184
  %352 = add nsw i32 %351, 1, !dbg !184
  store i32 %352, ptr %9, align 4, !dbg !184
  br label %293, !dbg !185, !llvm.loop !186

353:                                              ; preds = %194
  %354 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %4), !dbg !62
  %355 = load i32, ptr %4, align 4, !dbg !64
  %356 = load i32, ptr %6, align 4, !dbg !65
  %357 = sext i32 %356 to i64, !dbg !66
  %358 = getelementptr inbounds [300 x i32], ptr %3, i64 0, i64 %357, !dbg !66
  store i32 %355, ptr %358, align 4, !dbg !67
  br label %359, !dbg !68

359:                                              ; preds = %353
  %360 = load i32, ptr %6, align 4, !dbg !69
  %361 = add nsw i32 %360, 1, !dbg !69
  store i32 %361, ptr %6, align 4, !dbg !69
