...
8563:                                             ; preds = %8562
  ...
  br i1 %8567, label %8568, label %8623, !dbg !226
...
8599:                                             ; preds = %8579
  %8600 = load i32, ptr %7, align 4, !dbg !250
  %8601 = sext i32 %8600 to i64, !dbg !252
  %8602 = getelementptr inbounds [100000 x i64], ptr @hxs, i64 0, i64 %8601, !dbg !252
  %8603 = load i64, ptr %8602, align 8, !dbg !252
  %8604 = load i32, ptr %7, align 4, !dbg !253
  %8605 = sext i32 %8604 to i64, !dbg !254
  %8606 = getelementptr inbounds [100000 x i64], ptr @hys, i64 0, i64 %8605, !dbg !254
  %8607 = load i64, ptr %8606, align 8, !dbg !254
  %8608 = load i64, ptr %22, align 8, !dbg !255
  %8609 = load i64, ptr %23, align 8, !dbg !256
  %8610 = call i64 @distxy(i64 noundef %8603, i64 noundef %8607, i64 noundef %8608, i64 noundef %8609), !dbg !257
  store i64 %8610, ptr %11, align 8, !dbg !258
  %8611 = load i64, ptr %11, align 8, !dbg !259
  %8612 = load i64, ptr %20, align 8, !dbg !260
  %8613 = add nsw i64 %8612, %8611, !dbg !260
  store i64 %8613, ptr %20, align 8, !dbg !260
  %8614 = load i64, ptr %21, align 8, !dbg !261
  %8615 = load i64, ptr %11, align 8, !dbg !263
  %8616 = icmp slt i64 %8614, %8615, !dbg !264
  br i1 %8616, label %8617, label %8619, !dbg !265

8617:                                             ; preds = %8599
  %8618 = load i64, ptr %11, align 8, !dbg !266
  store i64 %8618, ptr %21, align 8, !dbg !267
  br label %8619, !dbg !268

8619:                                             ; preds = %8617, %8599
  br label %8620, !dbg !269

8620:                                             ; preds = %8619
  %8621 = load i32, ptr %7, align 4, !dbg !270
  %8622 = add nsw i32 %8621, 1, !dbg !270
  store i32 %8622, ptr %7, align 4, !dbg !270
  br label %8579, !dbg !271, !llvm.loop !272

8623:                                             ; preds = %8563, %8508
  %8624 = load i64, ptr %15, align 8, !dbg !297
  %8625 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i64 noundef %8624), !dbg !298
  %8626 = load i64, ptr %13, align 8, !dbg !299
  %8627 = load i64, ptr %14, align 8, !dbg !300
  %8628 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %8626, i64 noundef %8627), !dbg !301
  ret i32 0, !dbg !302
}
