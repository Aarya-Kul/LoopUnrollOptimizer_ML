...
22:                                               ; preds = %108, %6
  ...
  br i1 %25, label %26, label %111, !dbg !74
...
31:                                               ; preds = %26
  ...
  br i1 %36, label %37, label %111, !dbg !74
...
42:                                               ; preds = %37
  ...
  br i1 %47, label %48, label %111, !dbg !74
...
53:                                               ; preds = %48
  ...
  br i1 %58, label %59, label %111, !dbg !74
...
75:                                               ; preds = %70
  ...
  br i1 %80, label %81, label %111, !dbg !74
...
86:                                               ; preds = %81
  ...
  br i1 %91, label %92, label %111, !dbg !74
...
97:                                               ; preds = %92
  ...
  br i1 %102, label %103, label %111, !dbg !74
...
111:                                              ; preds = %97, %86, %75, %64, %53, %42, %31, %22
  call void @llvm.dbg.declare(metadata ptr %15, metadata !83, metadata !DIExpression()), !dbg !85
  %112 = load i32, ptr %7, align 4, !dbg !86
  store i32 %112, ptr %15, align 4, !dbg !85
  br label %113, !dbg !87

113:                                              ; preds = %128, %111
  %114 = load i32, ptr %15, align 4, !dbg !88
  %115 = load i32, ptr %8, align 4, !dbg !90
  %116 = icmp sle i32 %114, %115, !dbg !91
  br i1 %116, label %117, label %131, !dbg !92

117:                                              ; preds = %113
  %118 = load ptr, ptr %13, align 8, !dbg !93
  %119 = load ptr, ptr %10, align 8, !dbg !95
  %120 = load i32, ptr %15, align 4, !dbg !96
  %121 = sext i32 %120 to i64, !dbg !95
  %122 = getelementptr inbounds i32, ptr %119, i64 %121, !dbg !95
  %123 = load i32, ptr %122, align 4, !dbg !95
  %124 = sext i32 %123 to i64, !dbg !93
  %125 = getelementptr inbounds i32, ptr %118, i64 %124, !dbg !93
  %126 = load i32, ptr %125, align 4, !dbg !97
  %127 = add nsw i32 %126, 1, !dbg !97
  store i32 %127, ptr %125, align 4, !dbg !97
  br label %128, !dbg !98

128:                                              ; preds = %117
  %129 = load i32, ptr %15, align 4, !dbg !99
  %130 = add nsw i32 %129, 1, !dbg !99
  store i32 %130, ptr %15, align 4, !dbg !99
...
132:                                              ; preds = %155, %131
  %133 = load i32, ptr %16, align 4, !dbg !107
  %134 = load i32, ptr %9, align 4, !dbg !109
  %135 = icmp sle i32 %133, %134, !dbg !110
  br i1 %135, label %136, label %158, !dbg !111

136:                                              ; preds = %132
  %137 = load ptr, ptr %12, align 8, !dbg !112
  %138 = load i32, ptr %137, align 4, !dbg !115
  %139 = load ptr, ptr %13, align 8, !dbg !116
  %140 = load i32, ptr %16, align 4, !dbg !117
  %141 = sext i32 %140 to i64, !dbg !116
  %142 = getelementptr inbounds i32, ptr %139, i64 %141, !dbg !116
  %143 = load i32, ptr %142, align 4, !dbg !116
  %144 = icmp slt i32 %138, %143, !dbg !118
  br i1 %144, label %145, label %154, !dbg !119

145:                                              ; preds = %136
  %146 = load ptr, ptr %13, align 8, !dbg !120
  %147 = load i32, ptr %16, align 4, !dbg !122
  %148 = sext i32 %147 to i64, !dbg !120
  %149 = getelementptr inbounds i32, ptr %146, i64 %148, !dbg !120
  %150 = load i32, ptr %149, align 4, !dbg !120
  %151 = load ptr, ptr %12, align 8, !dbg !123
  store i32 %150, ptr %151, align 4, !dbg !124
  %152 = load i32, ptr %16, align 4, !dbg !125
  %153 = load ptr, ptr %11, align 8, !dbg !126
  store i32 %152, ptr %153, align 4, !dbg !127
  br label %154, !dbg !128

154:                                              ; preds = %145, %136
  br label %155, !dbg !129

155:                                              ; preds = %154
  %156 = load i32, ptr %16, align 4, !dbg !130
  %157 = add nsw i32 %156, 1, !dbg !130
  store i32 %157, ptr %16, align 4, !dbg !130
  br label %132, !dbg !131, !llvm.loop !132

158:                                              ; preds = %132
  %159 = load ptr, ptr %13, align 8, !dbg !134
  call void @free(ptr noundef %159) #6, !dbg !135
  ret void, !dbg !136
}
