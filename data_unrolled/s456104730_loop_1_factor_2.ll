...
182:                                              ; preds = %332, %179
  ...
  br i1 %186, label %317, label %187, !dbg !153
...
188:                                              ; preds = %210, %187
  ...
  br i1 %191, label %201, label %192, !dbg !176
...
201:                                              ; preds = %188
  store i32 0, ptr %9, align 4, !dbg !177
  br label %202, !dbg !180

202:                                              ; preds = %239, %201
  %203 = load i32, ptr %9, align 4, !dbg !181
  %204 = load i32, ptr %6, align 4, !dbg !183
  %205 = load i32, ptr %8, align 4, !dbg !184
  %206 = sub nsw i32 %204, %205, !dbg !185
  %207 = add nsw i32 %206, 1, !dbg !186
  %208 = icmp slt i32 %203, %207, !dbg !187
  br i1 %208, label %213, label %209, !dbg !188

209:                                              ; preds = %202
  br label %210, !dbg !242

210:                                              ; preds = %209
  %211 = load i32, ptr %8, align 4, !dbg !243
  %212 = add nsw i32 %211, 1, !dbg !243
  store i32 %212, ptr %8, align 4, !dbg !243
  br label %188, !dbg !244, !llvm.loop !245

213:                                              ; preds = %202
  %214 = load i32, ptr %9, align 4, !dbg !189
  %215 = load i32, ptr %8, align 4, !dbg !191
  %216 = add nsw i32 %214, %215, !dbg !192
  %217 = sub nsw i32 %216, 1, !dbg !193
  store i32 %217, ptr %10, align 4, !dbg !194
  call void @llvm.dbg.declare(metadata ptr %11, metadata !195, metadata !DIExpression()), !dbg !196
  %218 = load i32, ptr %8, align 4, !dbg !197
  %219 = sub nsw i32 %218, 1, !dbg !198
  %220 = sext i32 %219 to i64, !dbg !199
  %221 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %220, !dbg !199
  %222 = load i32, ptr %9, align 4, !dbg !200
  %223 = sext i32 %222 to i64, !dbg !199
  %224 = getelementptr inbounds [301 x i32], ptr %221, i64 0, i64 %223, !dbg !199
  %225 = load i32, ptr %224, align 4, !dbg !199
  store i32 %225, ptr %11, align 4, !dbg !196
  call void @llvm.dbg.declare(metadata ptr %12, metadata !201, metadata !DIExpression()), !dbg !202
  %226 = load i32, ptr %9, align 4, !dbg !203
  store i32 %226, ptr %12, align 4, !dbg !205
  br label %227, !dbg !206

227:                                              ; preds = %314, %213
  %228 = load i32, ptr %12, align 4, !dbg !207
  %229 = load i32, ptr %10, align 4, !dbg !209
  %230 = icmp slt i32 %228, %229, !dbg !210
  br i1 %230, label %242, label %231, !dbg !211

231:                                              ; preds = %227
  %232 = load i32, ptr %11, align 4, !dbg !232
  %233 = load i32, ptr %8, align 4, !dbg !233
  %234 = sext i32 %233 to i64, !dbg !234
  %235 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %234, !dbg !234
  %236 = load i32, ptr %9, align 4, !dbg !235
  %237 = sext i32 %236 to i64, !dbg !234
  %238 = getelementptr inbounds [301 x i32], ptr %235, i64 0, i64 %237, !dbg !234
  store i32 %232, ptr %238, align 4, !dbg !236
  br label %239, !dbg !237

239:                                              ; preds = %231
  %240 = load i32, ptr %9, align 4, !dbg !238
  %241 = add nsw i32 %240, 1, !dbg !238
  store i32 %241, ptr %9, align 4, !dbg !238
  br label %202, !dbg !239, !llvm.loop !240

242:                                              ; preds = %227
  call void @llvm.dbg.declare(metadata ptr %13, metadata !212, metadata !DIExpression()), !dbg !214
  %243 = load i32, ptr %10, align 4, !dbg !215
  %244 = load i32, ptr %12, align 4, !dbg !216
  %245 = sub nsw i32 %243, %244, !dbg !217
  %246 = sub nsw i32 %245, 1, !dbg !218
  store i32 %246, ptr %13, align 4, !dbg !214
  call void @llvm.dbg.declare(metadata ptr %14, metadata !219, metadata !DIExpression()), !dbg !220
  %247 = load i32, ptr %13, align 4, !dbg !221
  %248 = sext i32 %247 to i64, !dbg !222
  %249 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %248, !dbg !222
  %250 = load i32, ptr %12, align 4, !dbg !223
  %251 = add nsw i32 %250, 1, !dbg !224
  %252 = sext i32 %251 to i64, !dbg !222
  %253 = getelementptr inbounds [301 x i32], ptr %249, i64 0, i64 %252, !dbg !222
  %254 = load i32, ptr %253, align 4, !dbg !222
  store i32 %254, ptr %14, align 4, !dbg !220
  %255 = load i32, ptr %12, align 4, !dbg !225
  %256 = load i32, ptr %9, align 4, !dbg !225
  %257 = sub nsw i32 %255, %256, !dbg !225
  %258 = sext i32 %257 to i64, !dbg !225
  %259 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %258, !dbg !225
  %260 = load i32, ptr %9, align 4, !dbg !225
  %261 = sext i32 %260 to i64, !dbg !225
  %262 = getelementptr inbounds [301 x i32], ptr %259, i64 0, i64 %261, !dbg !225
  %263 = load i32, ptr %262, align 4, !dbg !225
  %264 = load i32, ptr %14, align 4, !dbg !225
  %265 = add nsw i32 %263, %264, !dbg !225
  %266 = load i32, ptr %14, align 4, !dbg !225
  %267 = load i32, ptr %13, align 4, !dbg !225
  %268 = icmp eq i32 %266, %267, !dbg !225
  %269 = zext i1 %268 to i32, !dbg !225
  %270 = load i32, ptr %12, align 4, !dbg !225
  %271 = sext i32 %270 to i64, !dbg !225
  %272 = getelementptr inbounds [301 x i32], ptr %7, i64 0, i64 %271, !dbg !225
  %273 = load i32, ptr %272, align 4, !dbg !225
  %274 = load i32, ptr %10, align 4, !dbg !225
  %275 = sext i32 %274 to i64, !dbg !225
  %276 = getelementptr inbounds [301 x i32], ptr %7, i64 0, i64 %275, !dbg !225
  %277 = load i32, ptr %276, align 4, !dbg !225
  %278 = call i32 @drop_point(i32 noundef %273, i32 noundef %277), !dbg !225
  %279 = mul nsw i32 %269, %278, !dbg !225
  %280 = add nsw i32 %265, %279, !dbg !225
  %281 = load i32, ptr %11, align 4, !dbg !225
  %282 = icmp sgt i32 %280, %281, !dbg !225
  br i1 %282, label %285, label %283, !dbg !225

283:                                              ; preds = %242
  %284 = load i32, ptr %11, align 4, !dbg !225
  br label %312, !dbg !225

285:                                              ; preds = %242
  %286 = load i32, ptr %12, align 4, !dbg !225
  %287 = load i32, ptr %9, align 4, !dbg !225
  %288 = sub nsw i32 %286, %287, !dbg !225
  %289 = sext i32 %288 to i64, !dbg !225
  %290 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 %289, !dbg !225
  %291 = load i32, ptr %9, align 4, !dbg !225
  %292 = sext i32 %291 to i64, !dbg !225
  %293 = getelementptr inbounds [301 x i32], ptr %290, i64 0, i64 %292, !dbg !225
  %294 = load i32, ptr %293, align 4, !dbg !225
  %295 = load i32, ptr %14, align 4, !dbg !225
  %296 = add nsw i32 %294, %295, !dbg !225
  %297 = load i32, ptr %14, align 4, !dbg !225
  %298 = load i32, ptr %13, align 4, !dbg !225
  %299 = icmp eq i32 %297, %298, !dbg !225
  %300 = zext i1 %299 to i32, !dbg !225
  %301 = load i32, ptr %12, align 4, !dbg !225
  %302 = sext i32 %301 to i64, !dbg !225
  %303 = getelementptr inbounds [301 x i32], ptr %7, i64 0, i64 %302, !dbg !225
  %304 = load i32, ptr %303, align 4, !dbg !225
  %305 = load i32, ptr %10, align 4, !dbg !225
  %306 = sext i32 %305 to i64, !dbg !225
  %307 = getelementptr inbounds [301 x i32], ptr %7, i64 0, i64 %306, !dbg !225
  %308 = load i32, ptr %307, align 4, !dbg !225
  %309 = call i32 @drop_point(i32 noundef %304, i32 noundef %308), !dbg !225
  %310 = mul nsw i32 %300, %309, !dbg !225
  %311 = add nsw i32 %296, %310, !dbg !225
  br label %312, !dbg !225

312:                                              ; preds = %285, %283
  %313 = phi i32 [ %311, %285 ], [ %284, %283 ], !dbg !225
  store i32 %313, ptr %11, align 4, !dbg !226
  br label %314, !dbg !227

314:                                              ; preds = %312
  %315 = load i32, ptr %12, align 4, !dbg !228
  %316 = add nsw i32 %315, 1, !dbg !228
  store i32 %316, ptr %12, align 4, !dbg !228
  br label %227, !dbg !229, !llvm.loop !230

317:                                              ; preds = %182
  %318 = load i32, ptr %4, align 4, !dbg !154
  %319 = sext i32 %318 to i64, !dbg !156
  %320 = getelementptr inbounds [301 x i32], ptr %7, i64 0, i64 %319, !dbg !156
  %321 = load i32, ptr %320, align 4, !dbg !156
  %322 = load i32, ptr %4, align 4, !dbg !157
  %323 = add nsw i32 %322, 1, !dbg !158
  %324 = sext i32 %323 to i64, !dbg !159
  %325 = getelementptr inbounds [301 x i32], ptr %7, i64 0, i64 %324, !dbg !159
  %326 = load i32, ptr %325, align 4, !dbg !159
  %327 = call i32 @drop_point(i32 noundef %321, i32 noundef %326), !dbg !160
  %328 = getelementptr inbounds [301 x [301 x i32]], ptr %5, i64 0, i64 2, !dbg !161
  %329 = load i32, ptr %4, align 4, !dbg !162
  %330 = sext i32 %329 to i64, !dbg !161
  %331 = getelementptr inbounds [301 x i32], ptr %328, i64 0, i64 %330, !dbg !161
  store i32 %327, ptr %331, align 4, !dbg !163
  br label %332, !dbg !164

332:                                              ; preds = %317
  %333 = load i32, ptr %4, align 4, !dbg !165
  %334 = add nsw i32 %333, 1, !dbg !165
  store i32 %334, ptr %4, align 4, !dbg !165
  br label %182, !dbg !166, !llvm.loop !167

335:                                              ; preds = %19
  store i32 0, ptr %4, align 4, !dbg !254
  br label %336, !dbg !256

336:                                              ; preds = %346, %335
  %337 = load i32, ptr %4, align 4, !dbg !257
  %338 = load i32, ptr %3, align 4, !dbg !259
  %339 = icmp slt i32 %337, %338, !dbg !260
  br i1 %339, label %340, label %349, !dbg !261

340:                                              ; preds = %336
  %341 = load i32, ptr %4, align 4, !dbg !262
  %342 = sext i32 %341 to i64, !dbg !264
  %343 = getelementptr inbounds [50 x i32], ptr %2, i64 0, i64 %342, !dbg !264
  %344 = load i32, ptr %343, align 4, !dbg !264
  %345 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %344), !dbg !265
  br label %346, !dbg !266

346:                                              ; preds = %340
  %347 = load i32, ptr %4, align 4, !dbg !267
  %348 = add nsw i32 %347, 1, !dbg !267
  store i32 %348, ptr %4, align 4, !dbg !267
  br label %336, !dbg !268, !llvm.loop !269
