...
14:                                               ; preds = %157, %0
  ...
  br i1 %17, label %18, label %160, !dbg !648
...
72:                                               ; preds = %.loopexit, %67
  ...
  br i1 %74, label %.loopexit2, label %76, !dbg !714
...
85:                                               ; preds = %84
  ...
  br i1 %90, label %91, label %160, !dbg !648
...
148:                                              ; preds = %147, %.loopexit.1
  ...
  br i1 %150, label %.loopexit3, label %151, !dbg !714
...
161:                                              ; preds = %75
  ...
  %162 = call i32 @puts(ptr noundef @.str), !dbg !734
  store i64 0, ptr %1, align 8, !dbg !735
  br label %165, !dbg !735

163:                                              ; preds = %160
  call void @llvm.dbg.label(metadata !736), !dbg !737
  %164 = call i32 @puts(ptr noundef @.str.1), !dbg !738
  store i64 1, ptr %1, align 8, !dbg !739
  br label %165, !dbg !739

165:                                              ; preds = %163, %161
  %166 = load i64, ptr %1, align 8, !dbg !740
  ret i64 %166, !dbg !740
}
