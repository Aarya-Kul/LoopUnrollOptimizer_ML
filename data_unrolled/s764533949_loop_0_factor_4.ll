...
308:                                              ; preds = %268, %231, %194, %157, %120, %83, %46, %43, %10
  ...
  br i1 %312, label %313, label %318, !dbg !97

313:                                              ; preds = %308
  %314 = load i32, ptr %3, align 4, !dbg !98
  %315 = icmp ne i32 %314, 2, !dbg !99
  br i1 %315, label %316, label %318, !dbg !100

316:                                              ; preds = %313
  %317 = call i32 @puts(ptr noundef @.str.1), !dbg !101
  br label %320, !dbg !103

318:                                              ; preds = %313, %308
  %319 = call i32 @puts(ptr noundef @.str.2), !dbg !104
  br label %320
