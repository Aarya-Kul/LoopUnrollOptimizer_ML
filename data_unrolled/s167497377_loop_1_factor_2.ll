...
8490:                                             ; preds = %8504, %8475
  br label %8529, !dbg !111
...
8498:                                             ; preds = %8497
  ...
  br i1 %8503, label %8504, label %8529, !dbg !99
...
8529:                                             ; preds = %8498, %8490, %8471
  store i32 0, ptr %4, align 4, !dbg !125
  br label %8530, !dbg !127

8530:                                             ; preds = %8552, %8529
  %8531 = load i32, ptr %4, align 4, !dbg !128
  %8532 = sext i32 %8531 to i64, !dbg !128
  %8533 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 0, !dbg !130
  %8534 = call i64 @strlen(ptr noundef %8533) #5, !dbg !131
  %8535 = icmp ult i64 %8532, %8534, !dbg !132
  br i1 %8535, label %8536, label %8555, !dbg !133

8536:                                             ; preds = %8530
  %8537 = load i32, ptr %4, align 4, !dbg !134
  %8538 = sext i32 %8537 to i64, !dbg !137
  %8539 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %8538, !dbg !137
  %8540 = load i8, ptr %8539, align 1, !dbg !137
  %8541 = sext i8 %8540 to i32, !dbg !137
  %8542 = load i32, ptr %4, align 4, !dbg !138
  %8543 = sext i32 %8542 to i64, !dbg !139
  %8544 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %8543, !dbg !139
  %8545 = load i8, ptr %8544, align 1, !dbg !139
  %8546 = sext i8 %8545 to i32, !dbg !139
  %8547 = icmp eq i32 %8541, %8546, !dbg !140
  br i1 %8547, label %8548, label %8550, !dbg !141

8548:                                             ; preds = %8536
  %8549 = load i32, ptr %4, align 4, !dbg !142
  store i32 %8549, ptr %3, align 4, !dbg !144
  br label %8551, !dbg !145

8550:                                             ; preds = %8536
  br label %8555, !dbg !146

8551:                                             ; preds = %8548
  br label %8552, !dbg !147

8552:                                             ; preds = %8551
  %8553 = load i32, ptr %4, align 4, !dbg !148
  %8554 = add nsw i32 %8553, 1, !dbg !148
  store i32 %8554, ptr %4, align 4, !dbg !148
  br label %8530, !dbg !149, !llvm.loop !150

8555:                                             ; preds = %8550, %8530
  %8556 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 0, !dbg !152
  %8557 = call i64 @strlen(ptr noundef %8556) #5, !dbg !154
  %8558 = load i32, ptr %3, align 4, !dbg !155
  %8559 = sext i32 %8558 to i64, !dbg !155
  %8560 = sub i64 %8557, %8559, !dbg !156
  %8561 = sub i64 %8560, 2, !dbg !157
  %8562 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %8561, !dbg !158
  %8563 = load i32, ptr %4, align 4, !dbg !159
  %8564 = sext i32 %8563 to i64, !dbg !160
  %8565 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %8564, !dbg !160
  %8566 = call ptr @strstr(ptr noundef %8562, ptr noundef %8565) #5, !dbg !161
  store ptr %8566, ptr %7, align 8, !dbg !162
  %8567 = icmp ne ptr %8566, null, !dbg !163
  br i1 %8567, label %8568, label %8569, !dbg !164

8568:                                             ; preds = %8555
  store i32 1, ptr %2, align 4, !dbg !165
  br label %8569, !dbg !166

8569:                                             ; preds = %8568, %8555
  %8570 = load i32, ptr %2, align 4, !dbg !167
  %8571 = icmp ne i32 %8570, 0, !dbg !167
  br i1 %8571, label %8572, label %8574, !dbg !169

8572:                                             ; preds = %8569
  %8573 = call i32 @puts(ptr noundef @.str.2), !dbg !170
  br label %8576, !dbg !170

8574:                                             ; preds = %8569
  %8575 = call i32 @puts(ptr noundef @.str.1), !dbg !171
  br label %8576

8576:                                             ; preds = %8574, %8572
  store i32 0, ptr %1, align 4, !dbg !172
  br label %8577, !dbg !172

8577:                                             ; preds = %8576, %15
  %8578 = load i32, ptr %1, align 4, !dbg !173
  ret i32 %8578, !dbg !173
}
