...
120:                                              ; preds = %154, %117
  ...
  br i1 %131, label %151, label %132, !dbg !115
...
151:                                              ; preds = %120
  %152 = load i32, ptr %3, align 4, !dbg !116
  %153 = add nsw i32 %152, 1, !dbg !116
  store i32 %153, ptr %3, align 4, !dbg !116
  br label %154, !dbg !118

154:                                              ; preds = %151
  %155 = load i32, ptr %4, align 4, !dbg !120
  %156 = add nsw i32 %155, 1, !dbg !120
  store i32 %156, ptr %4, align 4, !dbg !120
  br label %120, !dbg !121, !llvm.loop !122

157:                                              ; preds = %87, %83
  %158 = load i32, ptr %2, align 4, !dbg !147
  %159 = icmp ne i32 %158, 0, !dbg !147
  br i1 %159, label %160, label %162, !dbg !149

160:                                              ; preds = %157
  %161 = call i32 @puts(ptr noundef @.str.1), !dbg !150
  br label %164, !dbg !150

162:                                              ; preds = %157
  %163 = call i32 @puts(ptr noundef @.str.2), !dbg !151
  br label %164
