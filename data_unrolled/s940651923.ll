...
27:                                               ; preds = %52, %0
  ...
  br i1 %29, label %30, label %55, !dbg !58
...
55:                                               ; preds = %27
  %56 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 0, !dbg !82
  %57 = load i32, ptr %56, align 4, !dbg !82
  %58 = mul nsw i32 %57, 100, !dbg !83
  %59 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 1, !dbg !84
  %60 = load i32, ptr %59, align 4, !dbg !84
  %61 = mul nsw i32 %60, 10, !dbg !85
  %62 = add nsw i32 %58, %61, !dbg !86
  %63 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !87
  %64 = load i32, ptr %63, align 4, !dbg !87
  %65 = add nsw i32 %62, %64, !dbg !88
  store i32 %65, ptr %4, align 4, !dbg !89
  %66 = load i32, ptr %4, align 4, !dbg !90
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %66), !dbg !91
  ret i32 0, !dbg !92
}
