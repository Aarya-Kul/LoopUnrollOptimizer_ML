...
14:                                               ; preds = %123, %0
  ...
  br i1 %16, label %17, label %129, !dbg !119
...
69:                                               ; preds = %66
  ...
  br i1 %73, label %74, label %129, !dbg !119
...
92:                                               ; preds = %80, %76
  ...
  br i1 %93, label %126, label %94, !dbg !124
...
126:                                              ; preds = %92
  %127 = load i32, ptr %5, align 4, !dbg !135
  %128 = add nsw i32 %127, 1, !dbg !135
  store i32 %128, ptr %5, align 4, !dbg !135
  br label %76, !dbg !124, !llvm.loop !137

129:                                              ; preds = %69, %14
  %130 = load i32, ptr %6, align 4, !dbg !166
  %131 = icmp sge i32 %130, 0, !dbg !168
  br i1 %131, label %132, label %134, !dbg !169

132:                                              ; preds = %129
  %133 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !170
  br label %136, !dbg !170

134:                                              ; preds = %129
  %135 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !171
  br label %136
