...
8866:                                             ; preds = %8861, %8849
  ...
  br i1 %8867, label %8868, label %8896, !dbg !73
...
8889:                                             ; preds = %8884, %8868
  ...
  br i1 %8890, label %8891, label %8896, !dbg !73
...
8896:                                             ; preds = %8889, %8866
  %8897 = load i32, ptr %3, align 4, !dbg !88
  %8898 = sext i32 %8897 to i64, !dbg !88
  %8899 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !90
  %8900 = call i64 @strlen(ptr noundef %8899) #5, !dbg !91
  %8901 = icmp eq i64 %8898, %8900, !dbg !92
  br i1 %8901, label %8902, label %8904, !dbg !93

8902:                                             ; preds = %8896
  %8903 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !94
  br label %8906, !dbg !94

8904:                                             ; preds = %8896
  %8905 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !95
  br label %8906

8906:                                             ; preds = %8904, %8902
  ret i32 0, !dbg !96
}
