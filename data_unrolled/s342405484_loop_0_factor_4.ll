...
26:                                               ; preds = %200, %2
  ...
  br i1 %29, label %30, label %203, !dbg !162
...
46:                                               ; preds = %30
  ...
  br i1 %51, label %52, label %203, !dbg !162
...
68:                                               ; preds = %52
  ...
  br i1 %73, label %74, label %203, !dbg !162
...
90:                                               ; preds = %74
  ...
  br i1 %95, label %96, label %203, !dbg !162
...
112:                                              ; preds = %96
  ...
  br i1 %117, label %118, label %203, !dbg !162
...
134:                                              ; preds = %118
  ...
  br i1 %139, label %140, label %203, !dbg !162
...
156:                                              ; preds = %140
  ...
  br i1 %161, label %162, label %203, !dbg !162
...
178:                                              ; preds = %162
  ...
  br i1 %183, label %184, label %203, !dbg !162
...
203:                                              ; preds = %178, %156, %134, %112, %90, %68, %46, %26
  %204 = load i32, ptr %9, align 4, !dbg !189
  %205 = sext i32 %204 to i64, !dbg !189
  call void @qsort(ptr noundef @hsxs, i64 noundef %205, i64 noundef 8, ptr noundef @compll), !dbg !190
  %206 = load i32, ptr %9, align 4, !dbg !191
  %207 = sext i32 %206 to i64, !dbg !191
  call void @qsort(ptr noundef @hsys, i64 noundef %207, i64 noundef 8, ptr noundef @compll), !dbg !192
  %208 = load i32, ptr %9, align 4, !dbg !193
  %209 = sub nsw i32 %208, 1, !dbg !194
  %210 = sdiv i32 %209, 2, !dbg !195
  %211 = sext i32 %210 to i64, !dbg !196
  %212 = getelementptr inbounds [100000 x i64], ptr @hsxs, i64 0, i64 %211, !dbg !196
  %213 = load i64, ptr %212, align 8, !dbg !196
  %214 = getelementptr inbounds [2 x i64], ptr %16, i64 0, i64 0, !dbg !197
  store i64 %213, ptr %214, align 16, !dbg !198
  %215 = load i32, ptr %9, align 4, !dbg !199
  %216 = sub nsw i32 %215, 1, !dbg !200
  %217 = sdiv i32 %216, 2, !dbg !201
  %218 = sext i32 %217 to i64, !dbg !202
  %219 = getelementptr inbounds [100000 x i64], ptr @hsys, i64 0, i64 %218, !dbg !202
  %220 = load i64, ptr %219, align 8, !dbg !202
  %221 = getelementptr inbounds [2 x i64], ptr %17, i64 0, i64 0, !dbg !203
  store i64 %220, ptr %221, align 16, !dbg !204
  %222 = load i32, ptr %9, align 4, !dbg !205
  %223 = add nsw i32 %222, 1, !dbg !206
  %224 = sdiv i32 %223, 2, !dbg !207
  %225 = sext i32 %224 to i64, !dbg !208
  %226 = getelementptr inbounds [100000 x i64], ptr @hsxs, i64 0, i64 %225, !dbg !208
  %227 = load i64, ptr %226, align 8, !dbg !208
  %228 = getelementptr inbounds [2 x i64], ptr %16, i64 0, i64 1, !dbg !209
  store i64 %227, ptr %228, align 8, !dbg !210
  %229 = load i32, ptr %9, align 4, !dbg !211
  %230 = add nsw i32 %229, 1, !dbg !212
  %231 = sdiv i32 %230, 2, !dbg !213
  %232 = sext i32 %231 to i64, !dbg !214
  %233 = getelementptr inbounds [100000 x i64], ptr @hsys, i64 0, i64 %232, !dbg !214
  %234 = load i64, ptr %233, align 8, !dbg !214
  %235 = getelementptr inbounds [2 x i64], ptr %17, i64 0, i64 1, !dbg !215
  store i64 %234, ptr %235, align 8, !dbg !216
...
236:                                              ; preds = %291, %203
  %237 = load i32, ptr %8, align 4, !dbg !223
  %238 = icmp slt i32 %237, 4, !dbg !225
  br i1 %238, label %239, label %294, !dbg !226
...
239:                                              ; preds = %236
  ...
  %240 = load i32, ptr %8, align 4, !dbg !234
  %241 = sdiv i32 %240, 2, !dbg !235
  %242 = sext i32 %241 to i64, !dbg !236
  %243 = getelementptr inbounds [2 x i64], ptr %16, i64 0, i64 %242, !dbg !236
  %244 = load i64, ptr %243, align 8, !dbg !236
  store i64 %244, ptr %22, align 8, !dbg !233
  call void @llvm.dbg.declare(metadata ptr %23, metadata !237, metadata !DIExpression()), !dbg !238
  %245 = load i32, ptr %8, align 4, !dbg !239
  %246 = srem i32 %245, 2, !dbg !240
  %247 = sext i32 %246 to i64, !dbg !241
  %248 = getelementptr inbounds [2 x i64], ptr %17, i64 0, i64 %247, !dbg !241
  %249 = load i64, ptr %248, align 8, !dbg !241
  store i64 %249, ptr %23, align 8, !dbg !238
  store i32 0, ptr %7, align 4, !dbg !242
  br label %250, !dbg !244

250:                                              ; preds = %275, %239
  %251 = load i32, ptr %7, align 4, !dbg !245
  %252 = load i32, ptr %9, align 4, !dbg !247
  %253 = icmp slt i32 %251, %252, !dbg !248
  br i1 %253, label %254, label %278, !dbg !249

254:                                              ; preds = %250
  %255 = load i32, ptr %7, align 4, !dbg !250
  %256 = sext i32 %255 to i64, !dbg !252
  %257 = getelementptr inbounds [100000 x i64], ptr @hxs, i64 0, i64 %256, !dbg !252
  %258 = load i64, ptr %257, align 8, !dbg !252
  %259 = load i32, ptr %7, align 4, !dbg !253
  %260 = sext i32 %259 to i64, !dbg !254
  %261 = getelementptr inbounds [100000 x i64], ptr @hys, i64 0, i64 %260, !dbg !254
  %262 = load i64, ptr %261, align 8, !dbg !254
  %263 = load i64, ptr %22, align 8, !dbg !255
  %264 = load i64, ptr %23, align 8, !dbg !256
  %265 = call i64 @distxy(i64 noundef %258, i64 noundef %262, i64 noundef %263, i64 noundef %264), !dbg !257
  store i64 %265, ptr %11, align 8, !dbg !258
  %266 = load i64, ptr %11, align 8, !dbg !259
  %267 = load i64, ptr %20, align 8, !dbg !260
  %268 = add nsw i64 %267, %266, !dbg !260
  store i64 %268, ptr %20, align 8, !dbg !260
  %269 = load i64, ptr %21, align 8, !dbg !261
  %270 = load i64, ptr %11, align 8, !dbg !263
  %271 = icmp slt i64 %269, %270, !dbg !264
  br i1 %271, label %272, label %274, !dbg !265

272:                                              ; preds = %254
  %273 = load i64, ptr %11, align 8, !dbg !266
  store i64 %273, ptr %21, align 8, !dbg !267
  br label %274, !dbg !268

274:                                              ; preds = %272, %254
  br label %275, !dbg !269

275:                                              ; preds = %274
  %276 = load i32, ptr %7, align 4, !dbg !270
  %277 = add nsw i32 %276, 1, !dbg !270
  store i32 %277, ptr %7, align 4, !dbg !270
  br label %250, !dbg !271, !llvm.loop !272

278:                                              ; preds = %250
  %279 = load i64, ptr %20, align 8, !dbg !274
  %280 = mul nsw i64 %279, 2, !dbg !275
  %281 = load i64, ptr %21, align 8, !dbg !276
  %282 = sub nsw i64 %280, %281, !dbg !277
  store i64 %282, ptr %20, align 8, !dbg !278
  %283 = load i64, ptr %15, align 8, !dbg !279
  %284 = load i64, ptr %20, align 8, !dbg !281
  %285 = icmp sgt i64 %283, %284, !dbg !282
  br i1 %285, label %286, label %290, !dbg !283

286:                                              ; preds = %278
  %287 = load i64, ptr %20, align 8, !dbg !284
  store i64 %287, ptr %15, align 8, !dbg !286
  %288 = load i64, ptr %22, align 8, !dbg !287
  store i64 %288, ptr %13, align 8, !dbg !288
  %289 = load i64, ptr %23, align 8, !dbg !289
  store i64 %289, ptr %14, align 8, !dbg !290
  br label %290, !dbg !291

290:                                              ; preds = %286, %278
  br label %291, !dbg !292

291:                                              ; preds = %290
  %292 = load i32, ptr %8, align 4, !dbg !293
  %293 = add nsw i32 %292, 1, !dbg !293
  store i32 %293, ptr %8, align 4, !dbg !293
  br label %236, !dbg !294, !llvm.loop !295

294:                                              ; preds = %236
  %295 = load i64, ptr %15, align 8, !dbg !297
  %296 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i64 noundef %295), !dbg !298
  %297 = load i64, ptr %13, align 8, !dbg !299
  %298 = load i64, ptr %14, align 8, !dbg !300
  %299 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %297, i64 noundef %298), !dbg !301
  ret i32 0, !dbg !302
}
