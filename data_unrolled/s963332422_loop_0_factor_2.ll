...
13:                                               ; preds = %363, %0
  ...
  br i1 %16, label %17, label %366, !dbg !54
...
187:                                              ; preds = %186
  ...
  br i1 %192, label %193, label %366, !dbg !54
...
366:                                              ; preds = %187, %13
  %367 = load i32, ptr %5, align 4, !dbg !226
  %368 = icmp eq i32 %367, 7, !dbg !228
  br i1 %368, label %369, label %374, !dbg !229

369:                                              ; preds = %366
  %370 = load i32, ptr %4, align 4, !dbg !230
  %371 = icmp sle i32 %370, 1, !dbg !231
  br i1 %371, label %372, label %374, !dbg !232

372:                                              ; preds = %369
  %373 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !233
  br label %376, !dbg !235

374:                                              ; preds = %369, %366
  %375 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !236
  br label %376
