...
18:                                               ; preds = %15, %10
  ...
  br i1 %19, label %20, label %96, !dbg !59
...
61:                                               ; preds = %58, %51
  ...
  br i1 %62, label %63, label %96, !dbg !59
...
96:                                               ; preds = %61, %48, %18
  %97 = getelementptr inbounds [8 x i8], ptr %5, i64 0, i64 0, !dbg !97
  %98 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 0, !dbg !99
  %99 = call i32 @strcmp(ptr noundef %97, ptr noundef %98) #5, !dbg !100
  %100 = icmp eq i32 %99, 0, !dbg !101
  br i1 %100, label %101, label %106, !dbg !102

101:                                              ; preds = %96
  %102 = load i32, ptr %3, align 4, !dbg !103
  %103 = icmp ne i32 %102, 3, !dbg !104
  br i1 %103, label %104, label %106, !dbg !105

104:                                              ; preds = %101
  %105 = call i32 @puts(ptr noundef @.str.1), !dbg !106
  br label %108, !dbg !108

106:                                              ; preds = %101, %96
  %107 = call i32 @puts(ptr noundef @.str.2), !dbg !109
  br label %108
