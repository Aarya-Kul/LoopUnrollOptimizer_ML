...
5459:                                             ; preds = %5409
  %5460 = load i32, ptr %6, align 4, !dbg !158
  %5461 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %5460), !dbg !159
  call void @llvm.dbg.declare(metadata ptr %9, metadata !160, metadata !DIExpression()), !dbg !162
  store i32 1, ptr %9, align 4, !dbg !162
  br label %5462, !dbg !163

5462:                                             ; preds = %5468, %5459
  %5463 = load i32, ptr %9, align 4, !dbg !164
  %5464 = load i32, ptr %6, align 4, !dbg !166
  %5465 = icmp slt i32 %5463, %5464, !dbg !167
  br i1 %5465, label %5466, label %5471, !dbg !168

5466:                                             ; preds = %5462
  %5467 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !169
  br label %5468, !dbg !169

5468:                                             ; preds = %5466
  %5469 = load i32, ptr %9, align 4, !dbg !170
  %5470 = add nsw i32 %5469, 1, !dbg !170
  store i32 %5470, ptr %9, align 4, !dbg !170
  br label %5462, !dbg !171, !llvm.loop !172

5471:                                             ; preds = %5462
  %5472 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !174
  call void @llvm.dbg.declare(metadata ptr %10, metadata !175, metadata !DIExpression()), !dbg !177
  store i32 0, ptr %10, align 4, !dbg !177
  br label %5473, !dbg !178

5473:                                             ; preds = %5583, %5471
  %5474 = load i32, ptr %10, align 4, !dbg !179
  %5475 = load i32, ptr %2, align 4, !dbg !181
  %5476 = icmp slt i32 %5474, %5475, !dbg !182
  br i1 %5476, label %5477, label %5586, !dbg !183
...
5478:                                             ; preds = %5496, %5477
  %5479 = load i32, ptr %11, align 4, !dbg !189
  %5480 = load i32, ptr %6, align 4, !dbg !191
  %5481 = load i32, ptr %10, align 4, !dbg !192
  %5482 = sext i32 %5481 to i64, !dbg !193
  %5483 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %5482, !dbg !193
  %5484 = load i32, ptr %5483, align 4, !dbg !193
  %5485 = call i32 @llvm.abs.i32(i32 %5484, i1 true), !dbg !194
  %5486 = sub nsw i32 %5480, %5485, !dbg !195
  %5487 = load i32, ptr %10, align 4, !dbg !196
  %5488 = sext i32 %5487 to i64, !dbg !197
  %5489 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %5488, !dbg !197
  %5490 = load i32, ptr %5489, align 4, !dbg !197
  %5491 = call i32 @llvm.abs.i32(i32 %5490, i1 true), !dbg !198
  %5492 = sub nsw i32 %5486, %5491, !dbg !199
  %5493 = icmp slt i32 %5479, %5492, !dbg !200
  br i1 %5493, label %5494, label %5499, !dbg !201

5494:                                             ; preds = %5478
  %5495 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !202
  br label %5496, !dbg !202

5496:                                             ; preds = %5494
  %5497 = load i32, ptr %11, align 4, !dbg !203
  %5498 = add nsw i32 %5497, 2, !dbg !203
  store i32 %5498, ptr %11, align 4, !dbg !203
  br label %5478, !dbg !204, !llvm.loop !205

5499:                                             ; preds = %5478
  %5500 = load i32, ptr %10, align 4, !dbg !207
  %5501 = sext i32 %5500 to i64, !dbg !209
  %5502 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %5501, !dbg !209
  %5503 = load i32, ptr %5502, align 4, !dbg !209
  %5504 = icmp sgt i32 %5503, 0, !dbg !210
  br i1 %5504, label %5505, label %5519, !dbg !211

5505:                                             ; preds = %5499
  call void @llvm.dbg.declare(metadata ptr %12, metadata !212, metadata !DIExpression()), !dbg !214
  store i32 0, ptr %12, align 4, !dbg !214
  br label %5506, !dbg !215

5506:                                             ; preds = %5515, %5505
  %5507 = load i32, ptr %12, align 4, !dbg !216
  %5508 = load i32, ptr %10, align 4, !dbg !218
  %5509 = sext i32 %5508 to i64, !dbg !219
  %5510 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %5509, !dbg !219
  %5511 = load i32, ptr %5510, align 4, !dbg !219
  %5512 = icmp slt i32 %5507, %5511, !dbg !220
  br i1 %5512, label %5513, label %5518, !dbg !221

5513:                                             ; preds = %5506
  %5514 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !222
  br label %5515, !dbg !222

5515:                                             ; preds = %5513
  %5516 = load i32, ptr %12, align 4, !dbg !223
  %5517 = add nsw i32 %5516, 1, !dbg !223
  store i32 %5517, ptr %12, align 4, !dbg !223
  br label %5506, !dbg !224, !llvm.loop !225

5518:                                             ; preds = %5506
  br label %5519, !dbg !226

5519:                                             ; preds = %5518, %5499
  %5520 = load i32, ptr %10, align 4, !dbg !227
  %5521 = sext i32 %5520 to i64, !dbg !229
  %5522 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %5521, !dbg !229
  %5523 = load i32, ptr %5522, align 4, !dbg !229
  %5524 = icmp slt i32 %5523, 0, !dbg !230
  br i1 %5524, label %5525, label %5540, !dbg !231

5525:                                             ; preds = %5519
  call void @llvm.dbg.declare(metadata ptr %13, metadata !232, metadata !DIExpression()), !dbg !234
  store i32 0, ptr %13, align 4, !dbg !234
  br label %5526, !dbg !235

5526:                                             ; preds = %5536, %5525
  %5527 = load i32, ptr %13, align 4, !dbg !236
  %5528 = load i32, ptr %10, align 4, !dbg !238
  %5529 = sext i32 %5528 to i64, !dbg !239
  %5530 = getelementptr inbounds [1000 x i32], ptr %3, i64 0, i64 %5529, !dbg !239
  %5531 = load i32, ptr %5530, align 4, !dbg !239
  %5532 = sub nsw i32 0, %5531, !dbg !240
  %5533 = icmp slt i32 %5527, %5532, !dbg !241
  br i1 %5533, label %5534, label %5539, !dbg !242

5534:                                             ; preds = %5526
  %5535 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !243
  br label %5536, !dbg !243

5536:                                             ; preds = %5534
  %5537 = load i32, ptr %13, align 4, !dbg !244
  %5538 = add nsw i32 %5537, 1, !dbg !244
  store i32 %5538, ptr %13, align 4, !dbg !244
  br label %5526, !dbg !245, !llvm.loop !246

5539:                                             ; preds = %5526
  br label %5540, !dbg !247

5540:                                             ; preds = %5539, %5519
  %5541 = load i32, ptr %10, align 4, !dbg !248
  %5542 = sext i32 %5541 to i64, !dbg !250
  %5543 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %5542, !dbg !250
  %5544 = load i32, ptr %5543, align 4, !dbg !250
  %5545 = icmp sgt i32 %5544, 0, !dbg !251
  br i1 %5545, label %5546, label %5560, !dbg !252
...
5547:                                             ; preds = %5556, %5546
  %5548 = load i32, ptr %14, align 4, !dbg !257
  %5549 = load i32, ptr %10, align 4, !dbg !259
  %5550 = sext i32 %5549 to i64, !dbg !260
  %5551 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %5550, !dbg !260
  %5552 = load i32, ptr %5551, align 4, !dbg !260
  %5553 = icmp slt i32 %5548, %5552, !dbg !261
  br i1 %5553, label %5554, label %5559, !dbg !262

5554:                                             ; preds = %5547
  %5555 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !263
  br label %5556, !dbg !263

5556:                                             ; preds = %5554
  %5557 = load i32, ptr %14, align 4, !dbg !264
  %5558 = add nsw i32 %5557, 1, !dbg !264
  store i32 %5558, ptr %14, align 4, !dbg !264
  br label %5547, !dbg !265, !llvm.loop !266

5559:                                             ; preds = %5547
  br label %5560, !dbg !267

5560:                                             ; preds = %5559, %5540
  %5561 = load i32, ptr %10, align 4, !dbg !268
  %5562 = sext i32 %5561 to i64, !dbg !270
  %5563 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %5562, !dbg !270
  %5564 = load i32, ptr %5563, align 4, !dbg !270
  %5565 = icmp slt i32 %5564, 0, !dbg !271
  br i1 %5565, label %5566, label %5581, !dbg !272

5566:                                             ; preds = %5560
  call void @llvm.dbg.declare(metadata ptr %15, metadata !273, metadata !DIExpression()), !dbg !275
  store i32 0, ptr %15, align 4, !dbg !275
  br label %5567, !dbg !276

5567:                                             ; preds = %5577, %5566
  %5568 = load i32, ptr %15, align 4, !dbg !277
  %5569 = load i32, ptr %10, align 4, !dbg !279
  %5570 = sext i32 %5569 to i64, !dbg !280
  %5571 = getelementptr inbounds [1000 x i32], ptr %4, i64 0, i64 %5570, !dbg !280
  %5572 = load i32, ptr %5571, align 4, !dbg !280
  %5573 = sub nsw i32 0, %5572, !dbg !281
  %5574 = icmp slt i32 %5568, %5573, !dbg !282
  br i1 %5574, label %5575, label %5580, !dbg !283

5575:                                             ; preds = %5567
  %5576 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !284
  br label %5577, !dbg !284

5577:                                             ; preds = %5575
  %5578 = load i32, ptr %15, align 4, !dbg !285
  %5579 = add nsw i32 %5578, 1, !dbg !285
  store i32 %5579, ptr %15, align 4, !dbg !285
  br label %5567, !dbg !286, !llvm.loop !287

5580:                                             ; preds = %5567
  br label %5581, !dbg !288

5581:                                             ; preds = %5580, %5560
  %5582 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !289
  br label %5583, !dbg !290

5583:                                             ; preds = %5581
  %5584 = load i32, ptr %10, align 4, !dbg !291
  %5585 = add nsw i32 %5584, 1, !dbg !291
  store i32 %5585, ptr %10, align 4, !dbg !291
  br label %5473, !dbg !292, !llvm.loop !293

5586:                                             ; preds = %5473
  store i32 0, ptr %1, align 4, !dbg !295
  br label %5587, !dbg !295

5587:                                             ; preds = %5586, %5453
  %5588 = load i32, ptr %1, align 4, !dbg !296
  ret i32 %5588, !dbg !296
}
