...
113:                                              ; preds = %187, %111
  ...
  br i1 %116, label %117, label %190, !dbg !344
...
164:                                              ; preds = %182, %163
  ...
  %171 = load i32, ptr %10, align 4, !dbg !409
  %172 = sext i32 %171 to i64, !dbg !410
  %173 = getelementptr inbounds i32, ptr %21, i64 %172, !dbg !410
  %174 = load i32, ptr %173, align 4, !dbg !410
  %175 = add nsw i32 %170, %174, !dbg !411
  %176 = call i32 @llvm.abs.i32(i32 %175, i1 true), !dbg !412
  %177 = sub nsw i32 %166, %176, !dbg !413
  %178 = sdiv i32 %177, 2, !dbg !414
  %179 = icmp slt i32 %165, %178, !dbg !415
  br i1 %179, label %180, label %185, !dbg !416

180:                                              ; preds = %164
  %181 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %182, !dbg !419

182:                                              ; preds = %180
  %183 = load i32, ptr %13, align 4, !dbg !420
  %184 = add nsw i32 %183, 1, !dbg !420
  store i32 %184, ptr %13, align 4, !dbg !420
  br label %164, !dbg !421, !llvm.loop !422

185:                                              ; preds = %164
  %186 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %187, !dbg !425

187:                                              ; preds = %185
  %188 = load i32, ptr %10, align 4, !dbg !426
  %189 = add nsw i32 %188, 1, !dbg !426
  store i32 %189, ptr %10, align 4, !dbg !426
  br label %113, !dbg !427, !llvm.loop !428

190:                                              ; preds = %113
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %191, !dbg !430

191:                                              ; preds = %190, %51
  %192 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %192), !dbg !431
  %193 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %193, !dbg !431
}
