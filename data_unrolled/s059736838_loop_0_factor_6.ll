...
1547:                                             ; preds = %1512, %1480, %1448, %1416, %1384, %1352, %1320, %1288, %1256, %1224, %1192, %1160, %1128, %1096, %1064, %1032, %1000, %968, %936, %904, %872, %840, %808, %776, %744, %712, %680, %648, %616, %584, %552, %520, %488, %456, %424, %392, %360, %328, %296, %264, %232, %200, %168, %136, %104, %72, %40, %10
  ...
  br label %1548, !dbg !86

1548:                                             ; preds = %1567, %1547
  %1549 = load i32, ptr %2, align 4, !dbg !87
  %1550 = icmp slt i32 %1549, 7, !dbg !89
  br i1 %1550, label %1551, label %1570, !dbg !90

1551:                                             ; preds = %1548
  %1552 = load i32, ptr %2, align 4, !dbg !91
  %1553 = sext i32 %1552 to i64, !dbg !94
  %1554 = getelementptr inbounds [7 x i32], ptr %5, i64 0, i64 %1553, !dbg !94
  %1555 = load i32, ptr %1554, align 4, !dbg !94
  %1556 = load i32, ptr %2, align 4, !dbg !95
  %1557 = sub nsw i32 %1556, 1, !dbg !96
  %1558 = sext i32 %1557 to i64, !dbg !97
  %1559 = getelementptr inbounds [7 x i32], ptr %5, i64 0, i64 %1558, !dbg !97
  %1560 = load i32, ptr %1559, align 4, !dbg !97
  %1561 = sub nsw i32 %1555, %1560, !dbg !98
  %1562 = icmp sgt i32 %1561, 1, !dbg !99
  br i1 %1562, label %1563, label %1566, !dbg !100

1563:                                             ; preds = %1551
  %1564 = load i32, ptr %4, align 4, !dbg !101
  %1565 = add nsw i32 %1564, 1, !dbg !101
  store i32 %1565, ptr %4, align 4, !dbg !101
  br label %1566, !dbg !102

1566:                                             ; preds = %1563, %1551
  br label %1567, !dbg !103

1567:                                             ; preds = %1566
  %1568 = load i32, ptr %2, align 4, !dbg !104
  %1569 = add nsw i32 %1568, 1, !dbg !104
  store i32 %1569, ptr %2, align 4, !dbg !104
  br label %1548, !dbg !105, !llvm.loop !106

1570:                                             ; preds = %1548
  %1571 = load i32, ptr %3, align 4, !dbg !108
  %1572 = icmp sge i32 %1571, 7, !dbg !110
  br i1 %1572, label %1573, label %1578, !dbg !111

1573:                                             ; preds = %1570
  %1574 = load i32, ptr %4, align 4, !dbg !112
  %1575 = icmp sle i32 %1574, 1, !dbg !113
  br i1 %1575, label %1576, label %1578, !dbg !114

1576:                                             ; preds = %1573
  %1577 = call i32 @puts(ptr noundef @.str.1), !dbg !115
  br label %1580, !dbg !117

1578:                                             ; preds = %1573, %1570
  %1579 = call i32 @puts(ptr noundef @.str.2), !dbg !118
  br label %1580
