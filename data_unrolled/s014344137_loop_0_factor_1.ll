...
22:                                               ; preds = %54, %0
  ...
  br i1 %25, label %26, label %57, !dbg !279
...
57:                                               ; preds = %22
  %58 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !310
  %59 = load i32, ptr %58, align 16, !dbg !310
  %60 = getelementptr inbounds i32, ptr %21, i64 0, !dbg !311
  %61 = load i32, ptr %60, align 16, !dbg !311
  %62 = add nsw i32 %59, %61, !dbg !312
  %63 = call i32 @llvm.abs.i32(i32 %62, i1 true), !dbg !313
  %64 = srem i32 %63, 2, !dbg !314
  %65 = load i32, ptr %3, align 4, !dbg !315
  %66 = sub nsw i32 %65, %64, !dbg !315
  store i32 %66, ptr %3, align 4, !dbg !315
  %67 = load i32, ptr %3, align 4, !dbg !316
  %68 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %67), !dbg !317
  call void @llvm.dbg.declare(metadata ptr %9, metadata !318, metadata !DIExpression()), !dbg !320
  store i32 0, ptr %9, align 4, !dbg !320
  br label %69, !dbg !321

69:                                               ; preds = %76, %57
  %70 = load i32, ptr %9, align 4, !dbg !322
  %71 = load i32, ptr %3, align 4, !dbg !324
  %72 = sub nsw i32 %71, 1, !dbg !325
  %73 = icmp slt i32 %70, %72, !dbg !326
  br i1 %73, label %74, label %79, !dbg !327

74:                                               ; preds = %69
  %75 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !328
  br label %76, !dbg !330

76:                                               ; preds = %74
  %77 = load i32, ptr %9, align 4, !dbg !331
  %78 = add nsw i32 %77, 1, !dbg !331
  store i32 %78, ptr %9, align 4, !dbg !331
  br label %69, !dbg !332, !llvm.loop !333

79:                                               ; preds = %69
  %80 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !335
  call void @llvm.dbg.declare(metadata ptr %10, metadata !336, metadata !DIExpression()), !dbg !338
  store i32 0, ptr %10, align 4, !dbg !338
  br label %81, !dbg !339

81:                                               ; preds = %157, %79
  %82 = load i32, ptr %10, align 4, !dbg !340
  %83 = load i32, ptr %2, align 4, !dbg !342
  %84 = icmp slt i32 %82, %83, !dbg !343
  br i1 %84, label %85, label %160, !dbg !344
...
86:                                               ; preds = %105, %85
  %87 = load i32, ptr %11, align 4, !dbg !350
  %88 = load i32, ptr %10, align 4, !dbg !352
  %89 = sext i32 %88 to i64, !dbg !353
  %90 = getelementptr inbounds i32, ptr %18, i64 %89, !dbg !353
  %91 = load i32, ptr %90, align 4, !dbg !353
  %92 = call i32 @llvm.abs.i32(i32 %91, i1 true), !dbg !354
  %93 = icmp slt i32 %87, %92, !dbg !355
  br i1 %93, label %94, label %108, !dbg !356

94:                                               ; preds = %86
  %95 = load i32, ptr %10, align 4, !dbg !357
  %96 = sext i32 %95 to i64, !dbg !360
  %97 = getelementptr inbounds i32, ptr %18, i64 %96, !dbg !360
  %98 = load i32, ptr %97, align 4, !dbg !360
  %99 = icmp sgt i32 %98, 0, !dbg !361
  br i1 %99, label %100, label %102, !dbg !362

100:                                              ; preds = %94
  %101 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !363
  br label %104, !dbg !365

102:                                              ; preds = %94
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !366
  br label %104
...
105:                                              ; preds = %104
  %106 = load i32, ptr %11, align 4, !dbg !369
  %107 = add nsw i32 %106, 1, !dbg !369
  store i32 %107, ptr %11, align 4, !dbg !369
  br label %86, !dbg !370, !llvm.loop !371
...
109:                                              ; preds = %128, %108
  %110 = load i32, ptr %12, align 4, !dbg !377
  %111 = load i32, ptr %10, align 4, !dbg !379
  %112 = sext i32 %111 to i64, !dbg !380
  %113 = getelementptr inbounds i32, ptr %21, i64 %112, !dbg !380
  %114 = load i32, ptr %113, align 4, !dbg !380
  %115 = call i32 @llvm.abs.i32(i32 %114, i1 true), !dbg !381
  %116 = icmp slt i32 %110, %115, !dbg !382
  br i1 %116, label %117, label %131, !dbg !383

117:                                              ; preds = %109
  %118 = load i32, ptr %10, align 4, !dbg !384
  %119 = sext i32 %118 to i64, !dbg !387
  %120 = getelementptr inbounds i32, ptr %21, i64 %119, !dbg !387
  %121 = load i32, ptr %120, align 4, !dbg !387
  %122 = icmp sgt i32 %121, 0, !dbg !388
  br i1 %122, label %123, label %125, !dbg !389

123:                                              ; preds = %117
  %124 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !390
  br label %127, !dbg !392

125:                                              ; preds = %117
  %126 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !393
  br label %127

127:                                              ; preds = %125, %123
  br label %128, !dbg !395

128:                                              ; preds = %127
  %129 = load i32, ptr %12, align 4, !dbg !396
  %130 = add nsw i32 %129, 1, !dbg !396
  store i32 %130, ptr %12, align 4, !dbg !396
  br label %109, !dbg !397, !llvm.loop !398

131:                                              ; preds = %109
  call void @llvm.dbg.declare(metadata ptr %13, metadata !400, metadata !DIExpression()), !dbg !402
  store i32 0, ptr %13, align 4, !dbg !402
  br label %132, !dbg !403

132:                                              ; preds = %152, %131
  %133 = load i32, ptr %13, align 4, !dbg !404
  %134 = load i32, ptr %3, align 4, !dbg !406
  %135 = load i32, ptr %10, align 4, !dbg !407
  %136 = sext i32 %135 to i64, !dbg !408
  %137 = getelementptr inbounds i32, ptr %18, i64 %136, !dbg !408
  %138 = load i32, ptr %137, align 4, !dbg !408
  %139 = call i32 @llvm.abs.i32(i32 %138, i1 true), !dbg !409
  %140 = load i32, ptr %10, align 4, !dbg !410
  %141 = sext i32 %140 to i64, !dbg !411
  %142 = getelementptr inbounds i32, ptr %21, i64 %141, !dbg !411
  %143 = load i32, ptr %142, align 4, !dbg !411
  %144 = call i32 @llvm.abs.i32(i32 %143, i1 true), !dbg !412
  %145 = add nsw i32 %139, %144, !dbg !413
  %146 = call i32 @llvm.abs.i32(i32 %145, i1 true), !dbg !414
  %147 = sub nsw i32 %134, %146, !dbg !415
  %148 = sdiv i32 %147, 2, !dbg !416
  %149 = icmp slt i32 %133, %148, !dbg !417
  br i1 %149, label %150, label %155, !dbg !418

150:                                              ; preds = %132
  %151 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !419
  br label %152, !dbg !421

152:                                              ; preds = %150
  %153 = load i32, ptr %13, align 4, !dbg !422
  %154 = add nsw i32 %153, 1, !dbg !422
  store i32 %154, ptr %13, align 4, !dbg !422
  br label %132, !dbg !423, !llvm.loop !424

155:                                              ; preds = %132
  %156 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !426
  br label %157, !dbg !427

157:                                              ; preds = %155
  %158 = load i32, ptr %10, align 4, !dbg !428
  %159 = add nsw i32 %158, 1, !dbg !428
  store i32 %159, ptr %10, align 4, !dbg !428
  br label %81, !dbg !429, !llvm.loop !430

160:                                              ; preds = %81
  store i32 0, ptr %1, align 4, !dbg !432
  store i32 1, ptr %8, align 4
  br label %161, !dbg !432

161:                                              ; preds = %160, %51
  %162 = load ptr, ptr %4, align 8, !dbg !433
  call void @llvm.stackrestore.p0(ptr %162), !dbg !433
  %163 = load i32, ptr %1, align 4, !dbg !433
  ret i32 %163, !dbg !433
}
