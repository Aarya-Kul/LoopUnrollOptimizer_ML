...
14:                                               ; preds = %125, %0
  ...
  br i1 %16, label %17, label %131, !dbg !119
...
70:                                               ; preds = %67
  ...
  br i1 %74, label %75, label %131, !dbg !119
...
93:                                               ; preds = %81, %77
  ...
  br i1 %94, label %128, label %95, !dbg !124
...
128:                                              ; preds = %93
  %129 = load i32, ptr %5, align 4, !dbg !135
  %130 = add nsw i32 %129, 1, !dbg !135
  store i32 %130, ptr %5, align 4, !dbg !135
  br label %77, !dbg !124, !llvm.loop !137

131:                                              ; preds = %70, %14
  %132 = load i32, ptr %6, align 4, !dbg !166
  %133 = icmp sge i32 %132, 0, !dbg !168
  br i1 %133, label %134, label %136, !dbg !169

134:                                              ; preds = %131
  %135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !170
  br label %138, !dbg !170

136:                                              ; preds = %131
  %137 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !171
  br label %138
