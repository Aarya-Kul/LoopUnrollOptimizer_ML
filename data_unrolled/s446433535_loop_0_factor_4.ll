...
9:                                                ; preds = %330, %0
  ...
  br i1 %15, label %16, label %333, !dbg !216
...
48:                                               ; preds = %322, %282, %242, %202, %162, %122, %82, %41
  br label %333, !dbg !249
...
50:                                               ; preds = %49
  ...
  br i1 %58, label %59, label %333, !dbg !216
...
90:                                               ; preds = %89
  ...
  br i1 %98, label %99, label %333, !dbg !216
...
130:                                              ; preds = %129
  ...
  br i1 %138, label %139, label %333, !dbg !216
...
170:                                              ; preds = %169
  ...
  br i1 %178, label %179, label %333, !dbg !216
...
210:                                              ; preds = %209
  ...
  br i1 %218, label %219, label %333, !dbg !216
...
250:                                              ; preds = %249
  ...
  br i1 %258, label %259, label %333, !dbg !216
...
290:                                              ; preds = %289
  ...
  br i1 %298, label %299, label %333, !dbg !216
...
333:                                              ; preds = %290, %250, %210, %170, %130, %90, %50, %48, %9
  %334 = load i32, ptr %4, align 4, !dbg !257
  %335 = sext i32 %334 to i64, !dbg !258
  %336 = getelementptr inbounds [100 x i8], ptr %3, i64 0, i64 %335, !dbg !258
  %337 = load i8, ptr %336, align 1, !dbg !258
  %338 = sext i8 %337 to i32, !dbg !258
  %339 = icmp eq i32 %338, 0, !dbg !259
  %340 = zext i1 %339 to i64, !dbg !258
  %341 = select i1 %339, ptr @.str.3, ptr @.str.4, !dbg !258
  %342 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %341), !dbg !260
  store i32 0, ptr %1, align 4, !dbg !261
  br label %343, !dbg !261

343:                                              ; preds = %333, %31
  %344 = load i32, ptr %1, align 4, !dbg !262
  ret i32 %344, !dbg !262
}
