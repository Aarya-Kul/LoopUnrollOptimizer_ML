...
8077:                                             ; preds = %8102, %8076
  %8078 = load i32, ptr %7, align 4, !dbg !76
  %8079 = icmp slt i32 %8078, 7, !dbg !78
  br i1 %8079, label %8080, label %8105, !dbg !79

8080:                                             ; preds = %8077
  %8081 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 0, !dbg !80
  %8082 = call i64 @strlen(ptr noundef %8081) #5, !dbg !83
  %8083 = load i32, ptr %7, align 4, !dbg !84
  %8084 = add nsw i32 1, %8083, !dbg !85
  %8085 = sext i32 %8084 to i64, !dbg !86
  %8086 = sub i64 %8082, %8085, !dbg !87
  %8087 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %8086, !dbg !88
  %8088 = load i8, ptr %8087, align 1, !dbg !88
  %8089 = sext i8 %8088 to i32, !dbg !88
  %8090 = load i32, ptr %7, align 4, !dbg !89
  %8091 = sub nsw i32 6, %8090, !dbg !90
  %8092 = sext i32 %8091 to i64, !dbg !91
  %8093 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 %8092, !dbg !91
  %8094 = load i8, ptr %8093, align 1, !dbg !91
  %8095 = sext i8 %8094 to i32, !dbg !91
  %8096 = icmp eq i32 %8089, %8095, !dbg !92
  br i1 %8096, label %8097, label %8100, !dbg !93

8097:                                             ; preds = %8080
  %8098 = load i32, ptr %5, align 4, !dbg !94
  %8099 = add nsw i32 %8098, 1, !dbg !94
  store i32 %8099, ptr %5, align 4, !dbg !94
  br label %8101, !dbg !96

8100:                                             ; preds = %8080
  br label %8105, !dbg !97

8101:                                             ; preds = %8097
  br label %8102, !dbg !99

8102:                                             ; preds = %8101
  %8103 = load i32, ptr %7, align 4, !dbg !100
  %8104 = add nsw i32 %8103, 1, !dbg !100
  store i32 %8104, ptr %7, align 4, !dbg !100
  br label %8077, !dbg !101, !llvm.loop !102

8105:                                             ; preds = %8100, %8077
  %8106 = load i32, ptr %4, align 4, !dbg !104
  %8107 = load i32, ptr %5, align 4, !dbg !106
  %8108 = add nsw i32 %8106, %8107, !dbg !107
  %8109 = icmp sge i32 %8108, 7, !dbg !108
  br i1 %8109, label %8110, label %8112, !dbg !109

8110:                                             ; preds = %8105
  %8111 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !110
  br label %8114, !dbg !110

8112:                                             ; preds = %8105
  %8113 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !111
  br label %8114

8114:                                             ; preds = %8112, %8110
  ret i32 0, !dbg !112
}
