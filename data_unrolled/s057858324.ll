...
28:                                               ; preds = %6
  %29 = getelementptr inbounds [3 x i8], ptr %2, i64 0, i64 0, !dbg !61
  %30 = call i32 @atoi(ptr noundef %29) #5, !dbg !62
  %31 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %30), !dbg !63
  ret i32 0, !dbg !64
}
