...
5410:                                             ; preds = %5409
  ...
  br i1 %5414, label %5415, label %5440, !dbg !69
...
5440:                                             ; preds = %5410, %5385
  %5441 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 2, !dbg !92
  %5442 = load i32, ptr %5441, align 8, !dbg !92
  %5443 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 1, !dbg !93
  %5444 = load i32, ptr %5443, align 4, !dbg !93
  %5445 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 0, !dbg !94
  %5446 = load i32, ptr %5445, align 16, !dbg !94
  %5447 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5442, i32 noundef %5444, i32 noundef %5446), !dbg !95
  ret i32 0, !dbg !96
}
