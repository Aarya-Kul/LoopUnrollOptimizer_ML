...
7713:                                             ; preds = %7697, %7694
  ...
  br i1 %7714, label %7715, label %7719, !dbg !85
...
7719:                                             ; preds = %7713
  %7720 = load i32, ptr %2, align 4, !dbg !90
  %7721 = load i32, ptr %3, align 4, !dbg !92
  %7722 = add nsw i32 %7720, %7721, !dbg !93
  %7723 = icmp sge i32 %7722, 7, !dbg !94
  br i1 %7723, label %7724, label %7726, !dbg !95

7724:                                             ; preds = %7719
  %7725 = call i32 @puts(ptr noundef @.str.1), !dbg !96
  br label %7728, !dbg !96

7726:                                             ; preds = %7719
  %7727 = call i32 @puts(ptr noundef @.str.2), !dbg !97
  br label %7728

7728:                                             ; preds = %7726, %7724
  ret i32 0, !dbg !98
}
