...
3465:                                             ; preds = %3494, %3464
  %3466 = load i32, ptr %4, align 4, !dbg !83
  %3467 = icmp sle i32 %3466, 7, !dbg !85
  br i1 %3467, label %3468, label %3497, !dbg !86

3468:                                             ; preds = %3465
  %3469 = getelementptr inbounds [8 x i8], ptr %1, i64 0, i64 0, !dbg !87
  %3470 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 0, !dbg !90
  %3471 = load i32, ptr %4, align 4, !dbg !91
  %3472 = call i32 @equal(ptr noundef %3469, ptr noundef %3470, i32 noundef %3471), !dbg !92
  %3473 = icmp ne i32 %3472, 0, !dbg !92
  br i1 %3473, label %3474, label %3493, !dbg !93

3474:                                             ; preds = %3468
  %3475 = getelementptr inbounds [8 x i8], ptr %1, i64 0, i64 0, !dbg !94
  %3476 = load i32, ptr %4, align 4, !dbg !95
  %3477 = sext i32 %3476 to i64, !dbg !96
  %3478 = getelementptr inbounds i8, ptr %3475, i64 %3477, !dbg !96
  %3479 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 0, !dbg !97
  %3480 = load i32, ptr %3, align 4, !dbg !98
  %3481 = sext i32 %3480 to i64, !dbg !99
  %3482 = getelementptr inbounds i8, ptr %3479, i64 %3481, !dbg !99
  %3483 = getelementptr inbounds i8, ptr %3482, i64 -7, !dbg !100
  %3484 = load i32, ptr %4, align 4, !dbg !101
  %3485 = sext i32 %3484 to i64, !dbg !102
  %3486 = getelementptr inbounds i8, ptr %3483, i64 %3485, !dbg !102
  %3487 = load i32, ptr %4, align 4, !dbg !103
  %3488 = sub nsw i32 7, %3487, !dbg !104
  %3489 = call i32 @equal(ptr noundef %3478, ptr noundef %3486, i32 noundef %3488), !dbg !105
  %3490 = icmp ne i32 %3489, 0, !dbg !105
  br i1 %3490, label %3491, label %3493, !dbg !106

3491:                                             ; preds = %3474
  %3492 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !107
  br label %3499, !dbg !109

3493:                                             ; preds = %3474, %3468
  br label %3494, !dbg !110

3494:                                             ; preds = %3493
  %3495 = load i32, ptr %4, align 4, !dbg !111
  %3496 = add nsw i32 %3495, 1, !dbg !111
  store i32 %3496, ptr %4, align 4, !dbg !111
  br label %3465, !dbg !112, !llvm.loop !113

3497:                                             ; preds = %3465
  %3498 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !115
  br label %3499, !dbg !116

3499:                                             ; preds = %3497, %3491
  ret void, !dbg !116
}
