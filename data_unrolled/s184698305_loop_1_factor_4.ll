...
4641:                                             ; preds = %4640
  ...
  br i1 %4645, label %4646, label %4833, !dbg !57
...
4668:                                             ; preds = %4667
  ...
  br i1 %4672, label %4673, label %4833, !dbg !57
...
4695:                                             ; preds = %4694
  ...
  br i1 %4699, label %4700, label %4833, !dbg !57
...
4722:                                             ; preds = %4721
  ...
  br i1 %4726, label %4727, label %4833, !dbg !57
...
4749:                                             ; preds = %4748
  ...
  br i1 %4753, label %4754, label %4833, !dbg !57
...
4776:                                             ; preds = %4775
  ...
  br i1 %4780, label %4781, label %4833, !dbg !57
...
4803:                                             ; preds = %4802
  ...
  br i1 %4807, label %4808, label %4833, !dbg !57
...
4833:                                             ; preds = %4803, %4776, %4749, %4722, %4695, %4668, %4641, %4616
  store i32 0, ptr %3, align 4, !dbg !80
  br label %4834, !dbg !82

4834:                                             ; preds = %4843, %4833
  %4835 = load i32, ptr %3, align 4, !dbg !83
  %4836 = icmp slt i32 %4835, 3, !dbg !85
  br i1 %4836, label %4837, label %4846, !dbg !86

4837:                                             ; preds = %4834
  %4838 = load i32, ptr %3, align 4, !dbg !87
  %4839 = sext i32 %4838 to i64, !dbg !89
  %4840 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %4839, !dbg !89
  %4841 = load i32, ptr %4840, align 4, !dbg !89
  %4842 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4841), !dbg !90
  br label %4843, !dbg !91

4843:                                             ; preds = %4837
  %4844 = load i32, ptr %3, align 4, !dbg !92
  %4845 = add nsw i32 %4844, 1, !dbg !92
  store i32 %4845, ptr %3, align 4, !dbg !92
  br label %4834, !dbg !93, !llvm.loop !94

4846:                                             ; preds = %4834
  %4847 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !96
  ret i32 0, !dbg !97
}
