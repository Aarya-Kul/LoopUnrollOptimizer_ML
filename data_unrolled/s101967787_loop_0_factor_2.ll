...
110:                                              ; preds = %58, %54, %10
  ...
  %112 = icmp sle i32 %111, 1, !dbg !103
  br i1 %112, label %113, label %121, !dbg !104

113:                                              ; preds = %110
  %114 = load i32, ptr %4, align 4, !dbg !105
  %115 = sext i32 %114 to i64, !dbg !105
  %116 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 0, !dbg !106
  %117 = call i64 @strlen(ptr noundef %116) #5, !dbg !107
  %118 = icmp eq i64 %115, %117, !dbg !108
  br i1 %118, label %119, label %121, !dbg !109

119:                                              ; preds = %113
  %120 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !110
  br label %123, !dbg !110

121:                                              ; preds = %113, %110
  %122 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !111
  br label %123
