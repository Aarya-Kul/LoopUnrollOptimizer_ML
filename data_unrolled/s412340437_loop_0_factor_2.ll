...
27:                                               ; preds = %53, %4
  ...
  br i1 %30, label %31, label %56, !dbg !316
...
39:                                               ; preds = %31
  ...
  br i1 %44, label %45, label %56, !dbg !316
...
56:                                               ; preds = %39, %27
  %57 = load i32, ptr %8, align 4, !dbg !328
  %58 = sext i32 %57 to i64, !dbg !329
  %59 = getelementptr inbounds %struct.POINT, ptr %26, i64 %58, !dbg !329
  %60 = getelementptr inbounds %struct.POINT, ptr %26, i64 0, !dbg !330
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %59, ptr align 16 %60, i64 16, i1 false), !dbg !330
  store i32 0, ptr %10, align 4, !dbg !331
  br label %61, !dbg !333

61:                                               ; preds = %85, %56
  %62 = load i32, ptr %10, align 4, !dbg !334
  %63 = load i32, ptr %8, align 4, !dbg !336
  %64 = icmp slt i32 %62, %63, !dbg !337
  br i1 %64, label %65, label %88, !dbg !338

65:                                               ; preds = %61
  %66 = load i32, ptr %10, align 4, !dbg !339
  %67 = sext i32 %66 to i64, !dbg !342
  %68 = getelementptr inbounds %struct.POINT, ptr %26, i64 %67, !dbg !342
  %69 = getelementptr inbounds %struct.POINT, ptr %68, i32 0, i32 0, !dbg !343
  %70 = load double, ptr %69, align 16, !dbg !343
  %71 = getelementptr inbounds %struct.POINT, ptr %6, i32 0, i32 0, !dbg !344
  %72 = load double, ptr %71, align 8, !dbg !344
  %73 = fcmp oeq double %70, %72, !dbg !345
  br i1 %73, label %74, label %84, !dbg !346

74:                                               ; preds = %65
  %75 = load i32, ptr %10, align 4, !dbg !347
  %76 = sext i32 %75 to i64, !dbg !348
  %77 = getelementptr inbounds %struct.POINT, ptr %26, i64 %76, !dbg !348
  %78 = getelementptr inbounds %struct.POINT, ptr %77, i32 0, i32 1, !dbg !349
  %79 = load double, ptr %78, align 8, !dbg !349
  %80 = getelementptr inbounds %struct.POINT, ptr %6, i32 0, i32 1, !dbg !350
  %81 = load double, ptr %80, align 8, !dbg !350
  %82 = fcmp oeq double %79, %81, !dbg !351
  br i1 %82, label %83, label %84, !dbg !352

83:                                               ; preds = %74
  store i32 1, ptr %9, align 4, !dbg !353
  store i32 1, ptr %5, align 4, !dbg !355
  store i32 1, ptr %15, align 4
  br label %204, !dbg !355

84:                                               ; preds = %74, %65
  br label %85, !dbg !356

85:                                               ; preds = %84
  %86 = load i32, ptr %10, align 4, !dbg !357
  %87 = add nsw i32 %86, 1, !dbg !357
  store i32 %87, ptr %10, align 4, !dbg !357
  br label %61, !dbg !358, !llvm.loop !359
...
89:                                               ; preds = %193, %88
  %90 = load i32, ptr %10, align 4, !dbg !364
  %91 = load i32, ptr %8, align 4, !dbg !366
  %92 = icmp slt i32 %90, %91, !dbg !367
  br i1 %92, label %93, label %196, !dbg !368

93:                                               ; preds = %89
  %94 = load i32, ptr %10, align 4, !dbg !369
  %95 = sext i32 %94 to i64, !dbg !371
  %96 = getelementptr inbounds %struct.POINT, ptr %26, i64 %95, !dbg !371
  %97 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !372
  %98 = load double, ptr %97, align 8, !dbg !372
  %99 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !372
  %100 = load double, ptr %99, align 8, !dbg !372
  %101 = getelementptr inbounds { double, double }, ptr %96, i32 0, i32 0, !dbg !372
  %102 = load double, ptr %101, align 16, !dbg !372
  %103 = getelementptr inbounds { double, double }, ptr %96, i32 0, i32 1, !dbg !372
  %104 = load double, ptr %103, align 8, !dbg !372
  %105 = call { double, double } @make_vec(double %98, double %100, double %102, double %104), !dbg !372
  %106 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !372
  %107 = extractvalue { double, double } %105, 0, !dbg !372
  store double %107, ptr %106, align 8, !dbg !372
  %108 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !372
  %109 = extractvalue { double, double } %105, 1, !dbg !372
  store double %109, ptr %108, align 8, !dbg !372
  %110 = load i32, ptr %10, align 4, !dbg !373
  %111 = add nsw i32 %110, 1, !dbg !374
  %112 = sext i32 %111 to i64, !dbg !375
  %113 = getelementptr inbounds %struct.POINT, ptr %26, i64 %112, !dbg !375
  %114 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !376
  %115 = load double, ptr %114, align 8, !dbg !376
  %116 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !376
  %117 = load double, ptr %116, align 8, !dbg !376
  %118 = getelementptr inbounds { double, double }, ptr %113, i32 0, i32 0, !dbg !376
  %119 = load double, ptr %118, align 16, !dbg !376
  %120 = getelementptr inbounds { double, double }, ptr %113, i32 0, i32 1, !dbg !376
  %121 = load double, ptr %120, align 8, !dbg !376
  %122 = call { double, double } @make_vec(double %115, double %117, double %119, double %121), !dbg !376
  %123 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !376
  %124 = extractvalue { double, double } %122, 0, !dbg !376
  store double %124, ptr %123, align 8, !dbg !376
  %125 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !376
  %126 = extractvalue { double, double } %122, 1, !dbg !376
  store double %126, ptr %125, align 8, !dbg !376
  %127 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !377
  %128 = load double, ptr %127, align 8, !dbg !377
  %129 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !377
  %130 = load double, ptr %129, align 8, !dbg !377
  %131 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !377
  %132 = load double, ptr %131, align 8, !dbg !377
  %133 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !377
  %134 = load double, ptr %133, align 8, !dbg !377
  %135 = call double @cross(double %128, double %130, double %132, double %134), !dbg !377
  %136 = load i32, ptr %10, align 4, !dbg !378
  %137 = sext i32 %136 to i64, !dbg !379
  %138 = getelementptr inbounds %struct.POINT, ptr %26, i64 %137, !dbg !379
  %139 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !380
  %140 = load double, ptr %139, align 8, !dbg !380
  %141 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !380
  %142 = load double, ptr %141, align 8, !dbg !380
  %143 = getelementptr inbounds { double, double }, ptr %138, i32 0, i32 0, !dbg !380
  %144 = load double, ptr %143, align 16, !dbg !380
  %145 = getelementptr inbounds { double, double }, ptr %138, i32 0, i32 1, !dbg !380
  %146 = load double, ptr %145, align 8, !dbg !380
  %147 = call { double, double } @make_vec(double %140, double %142, double %144, double %146), !dbg !380
  %148 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !380
  %149 = extractvalue { double, double } %147, 0, !dbg !380
  store double %149, ptr %148, align 8, !dbg !380
  %150 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !380
  %151 = extractvalue { double, double } %147, 1, !dbg !380
  store double %151, ptr %150, align 8, !dbg !380
  %152 = load i32, ptr %10, align 4, !dbg !381
  %153 = add nsw i32 %152, 1, !dbg !382
  %154 = sext i32 %153 to i64, !dbg !383
  %155 = getelementptr inbounds %struct.POINT, ptr %26, i64 %154, !dbg !383
  %156 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !384
  %157 = load double, ptr %156, align 8, !dbg !384
  %158 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !384
  %159 = load double, ptr %158, align 8, !dbg !384
  %160 = getelementptr inbounds { double, double }, ptr %155, i32 0, i32 0, !dbg !384
  %161 = load double, ptr %160, align 16, !dbg !384
  %162 = getelementptr inbounds { double, double }, ptr %155, i32 0, i32 1, !dbg !384
  %163 = load double, ptr %162, align 8, !dbg !384
  %164 = call { double, double } @make_vec(double %157, double %159, double %161, double %163), !dbg !384
  %165 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !384
  %166 = extractvalue { double, double } %164, 0, !dbg !384
  store double %166, ptr %165, align 8, !dbg !384
  %167 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !384
  %168 = extractvalue { double, double } %164, 1, !dbg !384
  store double %168, ptr %167, align 8, !dbg !384
  %169 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !385
  %170 = load double, ptr %169, align 8, !dbg !385
  %171 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !385
  %172 = load double, ptr %171, align 8, !dbg !385
  %173 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !385
  %174 = load double, ptr %173, align 8, !dbg !385
  %175 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !385
  %176 = load double, ptr %175, align 8, !dbg !385
  %177 = call double @dot(double %170, double %172, double %174, double %176), !dbg !385
  %178 = call double @atan2(double noundef %135, double noundef %177) #6, !dbg !386
  store double %178, ptr %13, align 8, !dbg !387
  %179 = load double, ptr %13, align 8, !dbg !388
  %180 = load double, ptr %14, align 8, !dbg !389
  %181 = fadd double %180, %179, !dbg !389
  store double %181, ptr %14, align 8, !dbg !389
  %182 = load double, ptr %13, align 8, !dbg !390
  %183 = fsub double %182, 0x400921FB54442D18, !dbg !392
  %184 = call double @llvm.fabs.f64(double %183), !dbg !393
  %185 = fcmp ole double %184, 0x3EB0C6F7A0B5ED8D, !dbg !394
  br i1 %185, label %191, label %186, !dbg !395

186:                                              ; preds = %93
  %187 = load double, ptr %13, align 8, !dbg !396
  %188 = fadd double %187, 0x400921FB54442D18, !dbg !397
  %189 = call double @llvm.fabs.f64(double %188), !dbg !398
  %190 = fcmp ole double %189, 0x3EB0C6F7A0B5ED8D, !dbg !399
  br i1 %190, label %191, label %192, !dbg !400

191:                                              ; preds = %186, %93
  store i32 1, ptr %9, align 4, !dbg !401
  store i32 1, ptr %5, align 4, !dbg !402
  store i32 1, ptr %15, align 4
  br label %204, !dbg !402

192:                                              ; preds = %186
  br label %193, !dbg !403

193:                                              ; preds = %192
  %194 = load i32, ptr %10, align 4, !dbg !404
  %195 = add nsw i32 %194, 1, !dbg !404
  store i32 %195, ptr %10, align 4, !dbg !404
  br label %89, !dbg !405, !llvm.loop !406

196:                                              ; preds = %89
  %197 = load double, ptr %14, align 8, !dbg !408
  %198 = fsub double %197, 0x401921FB54442D18, !dbg !410
  %199 = call double @llvm.fabs.f64(double %198), !dbg !411
  %200 = fcmp ole double %199, 0x3EB0C6F7A0B5ED8D, !dbg !412
  br i1 %200, label %201, label %202, !dbg !413

201:                                              ; preds = %196
  store i32 2, ptr %9, align 4, !dbg !414
  store i32 2, ptr %5, align 4, !dbg !416
  store i32 1, ptr %15, align 4
  br label %204, !dbg !416

202:                                              ; preds = %196
  %203 = load i32, ptr %9, align 4, !dbg !417
  store i32 %203, ptr %5, align 4, !dbg !418
  store i32 1, ptr %15, align 4
  br label %204, !dbg !418

204:                                              ; preds = %202, %201, %191, %83
  %205 = load ptr, ptr %11, align 8, !dbg !419
  call void @llvm.stackrestore.p0(ptr %205), !dbg !419
