...
9:                                                ; preds = %111, %0
  ...
  br i1 %12, label %13, label %114, !dbg !161
...
20:                                               ; preds = %13
  ...
  br i1 %25, label %26, label %114, !dbg !161
...
33:                                               ; preds = %26
  ...
  br i1 %38, label %39, label %114, !dbg !161
...
46:                                               ; preds = %39
  ...
  br i1 %51, label %52, label %114, !dbg !161
...
59:                                               ; preds = %52
  ...
  br i1 %64, label %65, label %114, !dbg !161
...
72:                                               ; preds = %65
  ...
  br i1 %77, label %78, label %114, !dbg !161
...
85:                                               ; preds = %78
  ...
  br i1 %90, label %91, label %114, !dbg !161
...
98:                                               ; preds = %91
  ...
  br i1 %103, label %104, label %114, !dbg !161
...
114:                                              ; preds = %98, %85, %72, %59, %46, %33, %20, %9
  ...
  br label %115, !dbg !179

115:                                              ; preds = %146, %114
  %116 = load i64, ptr %3, align 8, !dbg !180
  %117 = load i64, ptr @N, align 8, !dbg !182
  %118 = icmp sle i64 %116, %117, !dbg !183
  br i1 %118, label %119, label %149, !dbg !184

119:                                              ; preds = %115
  call void @llvm.dbg.declare(metadata ptr %4, metadata !185, metadata !DIExpression()), !dbg !188
  store i64 1, ptr %4, align 8, !dbg !188
  br label %120, !dbg !189

120:                                              ; preds = %142, %119
  %121 = load i64, ptr %4, align 8, !dbg !190
  %122 = load i64, ptr %3, align 8, !dbg !192
  %123 = icmp slt i64 %121, %122, !dbg !193
  br i1 %123, label %124, label %145, !dbg !194

124:                                              ; preds = %120
  %125 = load i64, ptr %4, align 8, !dbg !195
  %126 = getelementptr inbounds [2001 x i64], ptr @A, i64 0, i64 %125, !dbg !198
  %127 = load i64, ptr %126, align 8, !dbg !198
  %128 = load i64, ptr %3, align 8, !dbg !199
  %129 = getelementptr inbounds [2001 x i64], ptr @A, i64 0, i64 %128, !dbg !200
  %130 = load i64, ptr %129, align 8, !dbg !200
  %131 = icmp slt i64 %127, %130, !dbg !201
  br i1 %131, label %132, label %141, !dbg !202

132:                                              ; preds = %124
  %133 = load i64, ptr %3, align 8, !dbg !203
  %134 = getelementptr inbounds i64, ptr @A, i64 %133, !dbg !205
  %135 = load i64, ptr %4, align 8, !dbg !206
  %136 = getelementptr inbounds i64, ptr @A, i64 %135, !dbg !207
  call void @swap(ptr noundef %134, ptr noundef %136), !dbg !208
  %137 = load i64, ptr %3, align 8, !dbg !209
  %138 = getelementptr inbounds i64, ptr @hash, i64 %137, !dbg !210
  %139 = load i64, ptr %4, align 8, !dbg !211
  %140 = getelementptr inbounds i64, ptr @hash, i64 %139, !dbg !212
  call void @swap(ptr noundef %138, ptr noundef %140), !dbg !213
  br label %141, !dbg !214

141:                                              ; preds = %132, %124
  br label %142, !dbg !215

142:                                              ; preds = %141
  %143 = load i64, ptr %4, align 8, !dbg !216
  %144 = add nsw i64 %143, 1, !dbg !216
  store i64 %144, ptr %4, align 8, !dbg !216
  br label %120, !dbg !217, !llvm.loop !218

145:                                              ; preds = %120
  br label %146, !dbg !220

146:                                              ; preds = %145
  %147 = load i64, ptr %3, align 8, !dbg !221
  %148 = add nsw i64 %147, 1, !dbg !221
  store i64 %148, ptr %3, align 8, !dbg !221
  br label %115, !dbg !222, !llvm.loop !223
...
149:                                              ; preds = %115
  ...
  br label %150, !dbg !230

150:                                              ; preds = %192, %149
  %151 = load i64, ptr %5, align 8, !dbg !231
  %152 = load i64, ptr @N, align 8, !dbg !233
  %153 = icmp sle i64 %151, %152, !dbg !234
  br i1 %153, label %154, label %195, !dbg !235

154:                                              ; preds = %150
  %155 = load i64, ptr %5, align 8, !dbg !236
  %156 = sub nsw i64 %155, 1, !dbg !238
  %157 = getelementptr inbounds [2001 x i64], ptr @DP, i64 0, i64 %156, !dbg !239
  %158 = load i64, ptr %157, align 8, !dbg !239
  %159 = load i64, ptr %5, align 8, !dbg !240
  %160 = getelementptr inbounds [2001 x i64], ptr @A, i64 0, i64 %159, !dbg !241
  %161 = load i64, ptr %160, align 8, !dbg !241
  %162 = load i64, ptr %5, align 8, !dbg !242
  %163 = getelementptr inbounds [2001 x i64], ptr @hash, i64 0, i64 %162, !dbg !243
  %164 = load i64, ptr %163, align 8, !dbg !243
  %165 = load i64, ptr %5, align 8, !dbg !244
  %166 = sub nsw i64 %164, %165, !dbg !245
  %167 = mul nsw i64 %161, %166, !dbg !246
  %168 = add nsw i64 %158, %167, !dbg !247
  %169 = load i64, ptr %5, align 8, !dbg !248
  %170 = getelementptr inbounds [2001 x i64], ptr @DP, i64 0, i64 %169, !dbg !249
  store i64 %168, ptr %170, align 8, !dbg !250
  %171 = load i64, ptr %5, align 8, !dbg !251
  %172 = sub nsw i64 %171, 1, !dbg !252
  %173 = getelementptr inbounds [2001 x [2001 x i64]], ptr @DP, i64 0, i64 %172, !dbg !253
  %174 = getelementptr inbounds [2001 x i64], ptr %173, i64 0, i64 0, !dbg !253
  %175 = load i64, ptr %174, align 8, !dbg !253
  %176 = load i64, ptr %5, align 8, !dbg !254
  %177 = getelementptr inbounds [2001 x i64], ptr @A, i64 0, i64 %176, !dbg !255
  %178 = load i64, ptr %177, align 8, !dbg !255
  %179 = load i64, ptr @N, align 8, !dbg !256
  %180 = add nsw i64 %179, 1, !dbg !257
  %181 = load i64, ptr %5, align 8, !dbg !258
  %182 = sub nsw i64 %180, %181, !dbg !259
  %183 = load i64, ptr %5, align 8, !dbg !260
  %184 = getelementptr inbounds [2001 x i64], ptr @hash, i64 0, i64 %183, !dbg !261
  %185 = load i64, ptr %184, align 8, !dbg !261
  %186 = sub nsw i64 %182, %185, !dbg !262
  %187 = mul nsw i64 %178, %186, !dbg !263
  %188 = add nsw i64 %175, %187, !dbg !264
  %189 = load i64, ptr %5, align 8, !dbg !265
  %190 = getelementptr inbounds [2001 x [2001 x i64]], ptr @DP, i64 0, i64 %189, !dbg !266
  %191 = getelementptr inbounds [2001 x i64], ptr %190, i64 0, i64 0, !dbg !266
  store i64 %188, ptr %191, align 8, !dbg !267
  br label %192, !dbg !268

192:                                              ; preds = %154
  %193 = load i64, ptr %5, align 8, !dbg !269
  %194 = add nsw i64 %193, 1, !dbg !269
  store i64 %194, ptr %5, align 8, !dbg !269
  br label %150, !dbg !270, !llvm.loop !271
...
195:                                              ; preds = %150
  ...
  br label %196, !dbg !279

196:                                              ; preds = %210, %195
  %197 = load i64, ptr %7, align 8, !dbg !280
  %198 = load i64, ptr @N, align 8, !dbg !282
  %199 = icmp sle i64 %197, %198, !dbg !283
  br i1 %199, label %200, label %213, !dbg !284

200:                                              ; preds = %196
  %201 = load i64, ptr %6, align 8, !dbg !285
  %202 = load i64, ptr %7, align 8, !dbg !286
  %203 = getelementptr inbounds [2001 x [2001 x i64]], ptr @DP, i64 0, i64 %202, !dbg !287
  %204 = load i64, ptr @N, align 8, !dbg !288
  %205 = load i64, ptr %7, align 8, !dbg !289
  %206 = sub nsw i64 %204, %205, !dbg !290
  %207 = getelementptr inbounds [2001 x i64], ptr %203, i64 0, i64 %206, !dbg !287
  %208 = load i64, ptr %207, align 8, !dbg !287
  %209 = call i64 @max(i64 noundef %201, i64 noundef %208), !dbg !291
  store i64 %209, ptr %6, align 8, !dbg !292
  br label %210, !dbg !293

210:                                              ; preds = %200
  %211 = load i64, ptr %7, align 8, !dbg !294
  %212 = add nsw i64 %211, 1, !dbg !294
  store i64 %212, ptr %7, align 8, !dbg !294
  br label %196, !dbg !295, !llvm.loop !296

213:                                              ; preds = %196
  %214 = load i64, ptr %6, align 8, !dbg !298
  %215 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %214), !dbg !299
  %216 = load i64, ptr %1, align 8, !dbg !300
  ret i64 %216, !dbg !300
}
