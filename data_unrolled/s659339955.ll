...
239:                                              ; preds = %86
  ...
  %241 = getelementptr inbounds ptr, ptr %240, i64 0, !dbg !242
  %242 = load ptr, ptr %241, align 8, !dbg !242
  %243 = load i32, ptr %2, align 4, !dbg !243
  %244 = sext i32 %243 to i64, !dbg !242
  %245 = getelementptr inbounds i32, ptr %242, i64 %244, !dbg !242
  %246 = load i32, ptr %245, align 4, !dbg !242
  %247 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %246), !dbg !244
  %248 = load ptr, ptr %3, align 8, !dbg !245
  call void @free(ptr noundef %248) #6, !dbg !246
