...
12451:                                            ; preds = %12469, %12450
  ...
  %12458 = load i32, ptr %10, align 4, !dbg !409
  %12459 = sext i32 %12458 to i64, !dbg !410
  %12460 = getelementptr inbounds i32, ptr %21, i64 %12459, !dbg !410
  %12461 = load i32, ptr %12460, align 4, !dbg !410
  %12462 = add nsw i32 %12457, %12461, !dbg !411
  %12463 = call i32 @llvm.abs.i32(i32 %12462, i1 true), !dbg !412
  %12464 = sub nsw i32 %12453, %12463, !dbg !413
  %12465 = sdiv i32 %12464, 2, !dbg !414
  %12466 = icmp slt i32 %12452, %12465, !dbg !415
  br i1 %12466, label %12467, label %12472, !dbg !416

12467:                                            ; preds = %12451
  %12468 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %12469, !dbg !419

12469:                                            ; preds = %12467
  %12470 = load i32, ptr %13, align 4, !dbg !420
  %12471 = add nsw i32 %12470, 1, !dbg !420
  store i32 %12471, ptr %13, align 4, !dbg !420
  br label %12451, !dbg !421, !llvm.loop !422

12472:                                            ; preds = %12451
  %12473 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %12474, !dbg !425

12474:                                            ; preds = %12472
  %12475 = load i32, ptr %10, align 4, !dbg !426
  %12476 = add nsw i32 %12475, 1, !dbg !426
  store i32 %12476, ptr %10, align 4, !dbg !426
  br label %12400, !dbg !427, !llvm.loop !428

12477:                                            ; preds = %12400
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %12478, !dbg !430

12478:                                            ; preds = %12477, %51
  %12479 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %12479), !dbg !431
  %12480 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %12480, !dbg !431
}
