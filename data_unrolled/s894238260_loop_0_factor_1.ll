...
37:                                               ; preds = %18
  %38 = load i64, ptr %7, align 8, !dbg !90
  %39 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %38), !dbg !91
  store i64 0, ptr %9, align 8, !dbg !92
  store i64 0, ptr %12, align 8, !dbg !93
  br label %40, !dbg !94

40:                                               ; preds = %59, %37
  %41 = load i64, ptr %12, align 8, !dbg !95
  store i64 %41, ptr %13, align 8, !dbg !97
  %42 = load i64, ptr %12, align 8, !dbg !98
  %43 = and i64 %42, 1, !dbg !100
  %44 = icmp ne i64 %43, 0, !dbg !100
  br i1 %44, label %45, label %49, !dbg !101

45:                                               ; preds = %40
  %46 = load i64, ptr %12, align 8, !dbg !102
  %47 = sub nsw i64 %46, 1, !dbg !104
  %48 = ashr i64 %47, 1, !dbg !105
  store i64 %48, ptr %12, align 8, !dbg !106
  br label %56, !dbg !107

49:                                               ; preds = %40
  %50 = load i64, ptr %12, align 8, !dbg !108
  %51 = ashr i64 %50, 1, !dbg !110
  %52 = load i64, ptr %6, align 8, !dbg !111
  %53 = sub nsw i64 %52, 1, !dbg !112
  %54 = shl i64 1, %53, !dbg !113
  %55 = add nsw i64 %51, %54, !dbg !114
  store i64 %55, ptr %12, align 8, !dbg !115
  br label %56

56:                                               ; preds = %49, %45
  %57 = load i64, ptr %9, align 8, !dbg !116
  %58 = add nsw i64 %57, 1, !dbg !116
  store i64 %58, ptr %9, align 8, !dbg !116
  br label %59, !dbg !117

59:                                               ; preds = %56
  %60 = load i64, ptr %12, align 8, !dbg !118
  %61 = icmp ne i64 %60, 0, !dbg !119
  br i1 %61, label %40, label %62, !dbg !117, !llvm.loop !120

62:                                               ; preds = %59
  %63 = load i64, ptr %9, align 8, !dbg !122
  store i64 %63, ptr %11, align 8, !dbg !123
  store i64 0, ptr %14, align 8, !dbg !124
  br label %64, !dbg !126

64:                                               ; preds = %110, %62
  %65 = load i64, ptr %14, align 8, !dbg !127
  %66 = load i64, ptr %7, align 8, !dbg !129
  %67 = icmp sle i64 %65, %66, !dbg !130
  br i1 %67, label %68, label %113, !dbg !131

68:                                               ; preds = %64
  store i64 0, ptr %9, align 8, !dbg !132
  %69 = load i64, ptr %14, align 8, !dbg !134
  store i64 %69, ptr %12, align 8, !dbg !135
  br label %70, !dbg !136

70:                                               ; preds = %97, %68
  %71 = load i64, ptr %12, align 8, !dbg !137
  store i64 %71, ptr %13, align 8, !dbg !139
  %72 = load i64, ptr %12, align 8, !dbg !140
  %73 = and i64 %72, 1, !dbg !142
  %74 = icmp ne i64 %73, 0, !dbg !142
  br i1 %74, label %75, label %79, !dbg !143

75:                                               ; preds = %70
  %76 = load i64, ptr %12, align 8, !dbg !144
  %77 = sub nsw i64 %76, 1, !dbg !146
  %78 = ashr i64 %77, 1, !dbg !147
  store i64 %78, ptr %12, align 8, !dbg !148
  br label %86, !dbg !149

79:                                               ; preds = %70
  %80 = load i64, ptr %12, align 8, !dbg !150
  %81 = ashr i64 %80, 1, !dbg !152
  %82 = load i64, ptr %6, align 8, !dbg !153
  %83 = sub nsw i64 %82, 1, !dbg !154
  %84 = shl i64 1, %83, !dbg !155
  %85 = add nsw i64 %81, %84, !dbg !156
  store i64 %85, ptr %12, align 8, !dbg !157
  br label %86

86:                                               ; preds = %79, %75
  %87 = load i64, ptr %9, align 8, !dbg !158
  %88 = add nsw i64 %87, 1, !dbg !158
  store i64 %88, ptr %9, align 8, !dbg !158
  br label %89, !dbg !159

89:                                               ; preds = %86
  %90 = load i64, ptr %12, align 8, !dbg !160
  %91 = load i64, ptr %14, align 8, !dbg !161
  %92 = icmp ne i64 %90, %91, !dbg !162
  br i1 %92, label %93, label %97, !dbg !163

93:                                               ; preds = %89
  %94 = load i64, ptr %13, align 8, !dbg !164
  %95 = load i64, ptr %12, align 8, !dbg !165
  %96 = icmp ne i64 %94, %95, !dbg !166
  br label %97

97:                                               ; preds = %93, %89
  %98 = phi i1 [ false, %89 ], [ %96, %93 ], !dbg !167
  br i1 %98, label %70, label %99, !dbg !159, !llvm.loop !168

99:                                               ; preds = %97
  %100 = load i64, ptr %13, align 8, !dbg !170
  %101 = load i64, ptr %12, align 8, !dbg !172
  %102 = icmp ne i64 %100, %101, !dbg !173
  br i1 %102, label %103, label %109, !dbg !174

103:                                              ; preds = %99
  %104 = load i64, ptr %11, align 8, !dbg !175
  %105 = load i64, ptr %9, align 8, !dbg !178
  %106 = icmp ne i64 %104, %105, !dbg !179
  br i1 %106, label %107, label %108, !dbg !180
...
110:                                              ; preds = %109
  %111 = load i64, ptr %14, align 8, !dbg !184
  %112 = add nsw i64 %111, 1, !dbg !184
  store i64 %112, ptr %14, align 8, !dbg !184
  br label %64, !dbg !185, !llvm.loop !186

113:                                              ; preds = %107, %64
  %114 = load i64, ptr %11, align 8, !dbg !188
  %115 = load i64, ptr %14, align 8, !dbg !189
  %116 = mul nsw i64 %114, %115, !dbg !190
  %117 = load i64, ptr %9, align 8, !dbg !191
  %118 = add nsw i64 %116, %117, !dbg !192
  %119 = load i64, ptr %7, align 8, !dbg !193
  %120 = load i64, ptr %14, align 8, !dbg !194
  %121 = add nsw i64 %120, 1, !dbg !195
  %122 = sdiv i64 %119, %121, !dbg !196
  %123 = mul nsw i64 %118, %122, !dbg !197
  %124 = load i64, ptr %11, align 8, !dbg !198
  %125 = load i64, ptr %7, align 8, !dbg !199
  %126 = add nsw i64 %125, 1, !dbg !200
  %127 = load i64, ptr %7, align 8, !dbg !201
  %128 = load i64, ptr %14, align 8, !dbg !202
  %129 = add nsw i64 %128, 1, !dbg !203
  %130 = sdiv i64 %127, %129, !dbg !204
  %131 = load i64, ptr %14, align 8, !dbg !205
  %132 = add nsw i64 %131, 1, !dbg !206
  %133 = mul nsw i64 %130, %132, !dbg !207
  %134 = sub nsw i64 %126, %133, !dbg !208
  %135 = mul nsw i64 %124, %134, !dbg !209
  %136 = add nsw i64 %123, %135, !dbg !210
  store i64 %136, ptr %10, align 8, !dbg !211
  %137 = load i64, ptr %10, align 8, !dbg !212
  %138 = srem i64 %137, 998244353, !dbg !213
  %139 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %138), !dbg !214
  ret i32 0, !dbg !215
}
