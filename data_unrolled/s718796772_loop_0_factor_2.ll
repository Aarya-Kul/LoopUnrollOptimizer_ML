...
7:                                                ; preds = %56, %6
  ...
  br i1 %10, label %11, label %59, !dbg !185
...
31:                                               ; preds = %18
  ...
  br i1 %36, label %37, label %59, !dbg !185
...
59:                                               ; preds = %31, %7
  %60 = load i32, ptr @N, align 4, !dbg !210
  %61 = sext i32 %60 to i64, !dbg !210
  call void @qsort(ptr noundef @h, i64 noundef %61, i64 noundef 8, ptr noundef @cmp), !dbg !211
  %62 = call i64 @search(i32 noundef 0, i32 noundef 0), !dbg !212
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %62), !dbg !213
  store i32 0, ptr %1, align 4, !dbg !214
  br label %64, !dbg !214

64:                                               ; preds = %59, %17, %5
  %65 = load i32, ptr %1, align 4, !dbg !215
  ret i32 %65, !dbg !215
}
