...
25:                                               ; preds = %47, %0
  ...
  br i1 %31, label %32, label %50, !dbg !73
...
35:                                               ; preds = %32
  ...
  br i1 %43, label %44, label %50, !dbg !73
...
51:                                               ; preds = %67, %50
  %52 = load i32, ptr %15, align 4, !dbg !86
  %53 = sext i32 %52 to i64, !dbg !86
  %54 = load i64, ptr %11, align 8, !dbg !88
  %55 = icmp slt i64 %53, %54, !dbg !89
  br i1 %55, label %56, label %70, !dbg !90

56:                                               ; preds = %51
  %57 = load i64, ptr %11, align 8, !dbg !91
  %58 = sub nsw i64 %57, 1, !dbg !93
  %59 = load i32, ptr %15, align 4, !dbg !94
  %60 = sext i32 %59 to i64, !dbg !94
  %61 = sub nsw i64 %58, %60, !dbg !95
  %62 = getelementptr inbounds [1000005 x i8], ptr %12, i64 0, i64 %61, !dbg !96
  %63 = load i8, ptr %62, align 1, !dbg !96
  %64 = load i32, ptr %15, align 4, !dbg !97
  %65 = sext i32 %64 to i64, !dbg !98
  %66 = getelementptr inbounds [1000005 x i8], ptr %13, i64 0, i64 %65, !dbg !98
  store i8 %63, ptr %66, align 1, !dbg !99
  br label %67, !dbg !100

67:                                               ; preds = %56
  %68 = load i32, ptr %15, align 4, !dbg !101
  %69 = add nsw i32 %68, 1, !dbg !101
  store i32 %69, ptr %15, align 4, !dbg !101
  br label %51, !dbg !102, !llvm.loop !103
...
71:                                               ; preds = %93, %70
  %72 = load i32, ptr %16, align 4, !dbg !109
  %73 = sext i32 %72 to i64, !dbg !109
  %74 = load i64, ptr %11, align 8, !dbg !111
  %75 = icmp slt i64 %73, %74, !dbg !112
  br i1 %75, label %76, label %96, !dbg !113

76:                                               ; preds = %71
  %77 = load i32, ptr %16, align 4, !dbg !114
  %78 = sext i32 %77 to i64, !dbg !117
  %79 = getelementptr inbounds [1000005 x i8], ptr %13, i64 0, i64 %78, !dbg !117
  %80 = load i8, ptr %79, align 1, !dbg !117
  %81 = sext i8 %80 to i32, !dbg !117
  %82 = icmp eq i32 %81, 48, !dbg !118
  br i1 %82, label %83, label %84, !dbg !119
...
85:                                               ; preds = %84, %83
  %86 = load i64, ptr %4, align 8, !dbg !125
  %87 = load i64, ptr %6, align 8, !dbg !126
  %88 = load i64, ptr %5, align 8, !dbg !127
  %89 = mul nsw i64 %87, %88, !dbg !128
  %90 = add nsw i64 %86, %89, !dbg !129
  store i64 %90, ptr %4, align 8, !dbg !130
  %91 = load i64, ptr %5, align 8, !dbg !131
  %92 = mul nsw i64 %91, 2, !dbg !132
  store i64 %92, ptr %5, align 8, !dbg !133
  br label %93, !dbg !134

93:                                               ; preds = %85
  %94 = load i32, ptr %16, align 4, !dbg !135
  %95 = add nsw i32 %94, 1, !dbg !135
  store i32 %95, ptr %16, align 4, !dbg !135
  br label %71, !dbg !136, !llvm.loop !137

96:                                               ; preds = %71
  %97 = load i64, ptr %7, align 8, !dbg !139
  %98 = trunc i64 %97 to i32, !dbg !140
  %99 = shl i32 1, %98, !dbg !140
  %100 = sext i32 %99 to i64, !dbg !141
  store i64 %100, ptr %9, align 8, !dbg !142
...
101:                                              ; preds = %143, %96
  %102 = load i32, ptr %17, align 4, !dbg !147
  %103 = sext i32 %102 to i64, !dbg !147
  %104 = load i64, ptr %4, align 8, !dbg !149
  %105 = icmp sle i64 %103, %104, !dbg !150
  br i1 %105, label %106, label %146, !dbg !151
...
106:                                              ; preds = %101
  ...
  store i64 %108, ptr %18, align 8, !dbg !154
  ...
  br label %109, !dbg !160

109:                                              ; preds = %137, %106
  %110 = load i64, ptr %18, align 8, !dbg !161
  %111 = srem i64 %110, 2, !dbg !164
  %112 = icmp eq i64 %111, 0, !dbg !165
  br i1 %112, label %113, label %126, !dbg !166

113:                                              ; preds = %109
  %114 = load i64, ptr %18, align 8, !dbg !167
  %115 = ashr i64 %114, 1, !dbg !169
  %116 = load i64, ptr %9, align 8, !dbg !170
  %117 = add nsw i64 %115, %116, !dbg !171
  store i64 %117, ptr %18, align 8, !dbg !172
  %118 = load i64, ptr %19, align 8, !dbg !173
  %119 = add nsw i64 %118, 1, !dbg !173
  store i64 %119, ptr %19, align 8, !dbg !173
  %120 = load i64, ptr %18, align 8, !dbg !174
  %121 = load i32, ptr %17, align 4, !dbg !176
  %122 = sext i32 %121 to i64, !dbg !176
  %123 = icmp eq i64 %120, %122, !dbg !177
  br i1 %123, label %124, label %125, !dbg !178

124:                                              ; preds = %113
  br label %138, !dbg !179

125:                                              ; preds = %113
  br label %137, !dbg !181

126:                                              ; preds = %109
  %127 = load i64, ptr %18, align 8, !dbg !182
  %128 = ashr i64 %127, 1, !dbg !184
  store i64 %128, ptr %18, align 8, !dbg !185
  %129 = load i64, ptr %19, align 8, !dbg !186
  %130 = add nsw i64 %129, 1, !dbg !186
  store i64 %130, ptr %19, align 8, !dbg !186
  %131 = load i64, ptr %18, align 8, !dbg !187
  %132 = load i32, ptr %17, align 4, !dbg !189
  %133 = sext i32 %132 to i64, !dbg !189
  %134 = icmp eq i64 %131, %133, !dbg !190
  br i1 %134, label %135, label %136, !dbg !191

135:                                              ; preds = %126
  br label %138, !dbg !192

136:                                              ; preds = %126
  br label %137

137:                                              ; preds = %136, %125
  br label %109, !dbg !160, !llvm.loop !194

138:                                              ; preds = %135, %124
  %139 = load i64, ptr %10, align 8, !dbg !196
  %140 = load i64, ptr %19, align 8, !dbg !197
  %141 = add nsw i64 %139, %140, !dbg !198
  %142 = srem i64 %141, 998244353, !dbg !199
  store i64 %142, ptr %10, align 8, !dbg !200
  br label %143, !dbg !201

143:                                              ; preds = %138
  %144 = load i32, ptr %17, align 4, !dbg !202
  %145 = add nsw i32 %144, 1, !dbg !202
  store i32 %145, ptr %17, align 4, !dbg !202
  br label %101, !dbg !203, !llvm.loop !204

146:                                              ; preds = %101
  %147 = load i64, ptr %10, align 8, !dbg !206
  %148 = srem i64 %147, 998244353, !dbg !207
  %149 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %148), !dbg !208
  ret i32 0, !dbg !209
}
