...
15412:                                            ; preds = %15387
  %15413 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %15414, !dbg !137

15414:                                            ; preds = %15412, %15406
  %15415 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %15415, !dbg !138
}
