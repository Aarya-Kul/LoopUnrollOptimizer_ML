...
3866:                                             ; preds = %3854, %3851
  ...
  br i1 %3867, label %3868, label %4012, !dbg !76
...
3886:                                             ; preds = %3874, %3869
  ...
  br i1 %3887, label %3888, label %4012, !dbg !76
...
3906:                                             ; preds = %3894, %3889
  ...
  br i1 %3907, label %3908, label %4012, !dbg !76
...
3926:                                             ; preds = %3914, %3909
  ...
  br i1 %3927, label %3928, label %4012, !dbg !76
...
3946:                                             ; preds = %3934, %3929
  ...
  br i1 %3947, label %3948, label %4012, !dbg !76
...
3966:                                             ; preds = %3954, %3949
  ...
  br i1 %3967, label %3968, label %4012, !dbg !76
...
3986:                                             ; preds = %3974, %3969
  ...
  br i1 %3987, label %3988, label %4012, !dbg !76
...
4006:                                             ; preds = %3994, %3989
  ...
  br i1 %4007, label %4008, label %4012, !dbg !76
...
4012:                                             ; preds = %4006, %3986, %3966, %3946, %3926, %3906, %3886, %3866
  store i32 0, ptr %4, align 4, !dbg !81
  br label %4013, !dbg !83

4013:                                             ; preds = %4035, %4012
  %4014 = load i32, ptr %4, align 4, !dbg !84
  %4015 = icmp slt i32 %4014, 7, !dbg !86
  br i1 %4015, label %4016, label %4032, !dbg !87

4016:                                             ; preds = %4013
  %4017 = load i32, ptr %2, align 4, !dbg !88
  %4018 = sub nsw i32 %4017, 1, !dbg !89
  %4019 = load i32, ptr %4, align 4, !dbg !90
  %4020 = sub nsw i32 %4018, %4019, !dbg !91
  %4021 = sext i32 %4020 to i64, !dbg !92
  %4022 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %4021, !dbg !92
  %4023 = load i8, ptr %4022, align 1, !dbg !92
  %4024 = sext i8 %4023 to i32, !dbg !92
  %4025 = load i32, ptr %4, align 4, !dbg !93
  %4026 = sub nsw i32 6, %4025, !dbg !94
  %4027 = sext i32 %4026 to i64, !dbg !95
  %4028 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %4027, !dbg !95
  %4029 = load i8, ptr %4028, align 1, !dbg !95
  %4030 = sext i8 %4029 to i32, !dbg !95
  %4031 = icmp eq i32 %4024, %4030, !dbg !96
  br label %4032

4032:                                             ; preds = %4016, %4013
  %4033 = phi i1 [ false, %4013 ], [ %4031, %4016 ], !dbg !97
  br i1 %4033, label %4034, label %4038, !dbg !98

4034:                                             ; preds = %4032
  br label %4035, !dbg !98

4035:                                             ; preds = %4034
  %4036 = load i32, ptr %4, align 4, !dbg !99
  %4037 = add nsw i32 %4036, 1, !dbg !99
  store i32 %4037, ptr %4, align 4, !dbg !99
  br label %4013, !dbg !100, !llvm.loop !101

4038:                                             ; preds = %4032
  %4039 = load i32, ptr %3, align 4, !dbg !103
  %4040 = load i32, ptr %4, align 4, !dbg !105
  %4041 = add nsw i32 %4039, %4040, !dbg !106
  %4042 = icmp sge i32 %4041, 7, !dbg !107
  br i1 %4042, label %4043, label %4045, !dbg !108

4043:                                             ; preds = %4038
  %4044 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !109
  br label %4047, !dbg !111

4045:                                             ; preds = %4038
  %4046 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !112
  br label %4047
