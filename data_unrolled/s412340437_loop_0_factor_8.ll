...
5413:                                             ; preds = %5409
  ...
  %5417 = getelementptr inbounds %struct.POINT, ptr %5416, i32 0, i32 0, !dbg !343
  %5418 = load double, ptr %5417, align 16, !dbg !343
  %5419 = getelementptr inbounds %struct.POINT, ptr %6, i32 0, i32 0, !dbg !344
  %5420 = load double, ptr %5419, align 8, !dbg !344
  %5421 = fcmp oeq double %5418, %5420, !dbg !345
  br i1 %5421, label %5422, label %5432, !dbg !346

5422:                                             ; preds = %5413
  %5423 = load i32, ptr %10, align 4, !dbg !347
  %5424 = sext i32 %5423 to i64, !dbg !348
  %5425 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5424, !dbg !348
  %5426 = getelementptr inbounds %struct.POINT, ptr %5425, i32 0, i32 1, !dbg !349
  %5427 = load double, ptr %5426, align 8, !dbg !349
  %5428 = getelementptr inbounds %struct.POINT, ptr %6, i32 0, i32 1, !dbg !350
  %5429 = load double, ptr %5428, align 8, !dbg !350
  %5430 = fcmp oeq double %5427, %5429, !dbg !351
  br i1 %5430, label %5431, label %5432, !dbg !352

5431:                                             ; preds = %5422
  store i32 1, ptr %9, align 4, !dbg !353
  store i32 1, ptr %5, align 4, !dbg !355
  store i32 1, ptr %15, align 4
  br label %5552, !dbg !355

5432:                                             ; preds = %5422, %5413
  br label %5433, !dbg !356

5433:                                             ; preds = %5432
  %5434 = load i32, ptr %10, align 4, !dbg !357
  %5435 = add nsw i32 %5434, 1, !dbg !357
  store i32 %5435, ptr %10, align 4, !dbg !357
  br label %5409, !dbg !358, !llvm.loop !359

5436:                                             ; preds = %5409
  store i32 0, ptr %10, align 4, !dbg !361
  br label %5437, !dbg !363

5437:                                             ; preds = %5541, %5436
  %5438 = load i32, ptr %10, align 4, !dbg !364
  %5439 = load i32, ptr %8, align 4, !dbg !366
  %5440 = icmp slt i32 %5438, %5439, !dbg !367
  br i1 %5440, label %5441, label %5544, !dbg !368

5441:                                             ; preds = %5437
  %5442 = load i32, ptr %10, align 4, !dbg !369
  %5443 = sext i32 %5442 to i64, !dbg !371
  %5444 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5443, !dbg !371
  %5445 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !372
  %5446 = load double, ptr %5445, align 8, !dbg !372
  %5447 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !372
  %5448 = load double, ptr %5447, align 8, !dbg !372
  %5449 = getelementptr inbounds { double, double }, ptr %5444, i32 0, i32 0, !dbg !372
  %5450 = load double, ptr %5449, align 16, !dbg !372
  %5451 = getelementptr inbounds { double, double }, ptr %5444, i32 0, i32 1, !dbg !372
  %5452 = load double, ptr %5451, align 8, !dbg !372
  %5453 = call { double, double } @make_vec(double %5446, double %5448, double %5450, double %5452), !dbg !372
  %5454 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !372
  %5455 = extractvalue { double, double } %5453, 0, !dbg !372
  store double %5455, ptr %5454, align 8, !dbg !372
  %5456 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !372
  %5457 = extractvalue { double, double } %5453, 1, !dbg !372
  store double %5457, ptr %5456, align 8, !dbg !372
  %5458 = load i32, ptr %10, align 4, !dbg !373
  %5459 = add nsw i32 %5458, 1, !dbg !374
  %5460 = sext i32 %5459 to i64, !dbg !375
  %5461 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5460, !dbg !375
  %5462 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !376
  %5463 = load double, ptr %5462, align 8, !dbg !376
  %5464 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !376
  %5465 = load double, ptr %5464, align 8, !dbg !376
  %5466 = getelementptr inbounds { double, double }, ptr %5461, i32 0, i32 0, !dbg !376
  %5467 = load double, ptr %5466, align 16, !dbg !376
  %5468 = getelementptr inbounds { double, double }, ptr %5461, i32 0, i32 1, !dbg !376
  %5469 = load double, ptr %5468, align 8, !dbg !376
  %5470 = call { double, double } @make_vec(double %5463, double %5465, double %5467, double %5469), !dbg !376
  %5471 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !376
  %5472 = extractvalue { double, double } %5470, 0, !dbg !376
  store double %5472, ptr %5471, align 8, !dbg !376
  %5473 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !376
  %5474 = extractvalue { double, double } %5470, 1, !dbg !376
  store double %5474, ptr %5473, align 8, !dbg !376
  %5475 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !377
  %5476 = load double, ptr %5475, align 8, !dbg !377
  %5477 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !377
  %5478 = load double, ptr %5477, align 8, !dbg !377
  %5479 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !377
  %5480 = load double, ptr %5479, align 8, !dbg !377
  %5481 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !377
  %5482 = load double, ptr %5481, align 8, !dbg !377
  %5483 = call double @cross(double %5476, double %5478, double %5480, double %5482), !dbg !377
  %5484 = load i32, ptr %10, align 4, !dbg !378
  %5485 = sext i32 %5484 to i64, !dbg !379
  %5486 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5485, !dbg !379
  %5487 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !380
  %5488 = load double, ptr %5487, align 8, !dbg !380
  %5489 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !380
  %5490 = load double, ptr %5489, align 8, !dbg !380
  %5491 = getelementptr inbounds { double, double }, ptr %5486, i32 0, i32 0, !dbg !380
  %5492 = load double, ptr %5491, align 16, !dbg !380
  %5493 = getelementptr inbounds { double, double }, ptr %5486, i32 0, i32 1, !dbg !380
  %5494 = load double, ptr %5493, align 8, !dbg !380
  %5495 = call { double, double } @make_vec(double %5488, double %5490, double %5492, double %5494), !dbg !380
  %5496 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !380
  %5497 = extractvalue { double, double } %5495, 0, !dbg !380
  store double %5497, ptr %5496, align 8, !dbg !380
  %5498 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !380
  %5499 = extractvalue { double, double } %5495, 1, !dbg !380
  store double %5499, ptr %5498, align 8, !dbg !380
  %5500 = load i32, ptr %10, align 4, !dbg !381
  %5501 = add nsw i32 %5500, 1, !dbg !382
  %5502 = sext i32 %5501 to i64, !dbg !383
  %5503 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5502, !dbg !383
  %5504 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !384
  %5505 = load double, ptr %5504, align 8, !dbg !384
  %5506 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !384
  %5507 = load double, ptr %5506, align 8, !dbg !384
  %5508 = getelementptr inbounds { double, double }, ptr %5503, i32 0, i32 0, !dbg !384
  %5509 = load double, ptr %5508, align 16, !dbg !384
  %5510 = getelementptr inbounds { double, double }, ptr %5503, i32 0, i32 1, !dbg !384
  %5511 = load double, ptr %5510, align 8, !dbg !384
  %5512 = call { double, double } @make_vec(double %5505, double %5507, double %5509, double %5511), !dbg !384
  %5513 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !384
  %5514 = extractvalue { double, double } %5512, 0, !dbg !384
  store double %5514, ptr %5513, align 8, !dbg !384
  %5515 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !384
  %5516 = extractvalue { double, double } %5512, 1, !dbg !384
  store double %5516, ptr %5515, align 8, !dbg !384
  %5517 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !385
  %5518 = load double, ptr %5517, align 8, !dbg !385
  %5519 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !385
  %5520 = load double, ptr %5519, align 8, !dbg !385
  %5521 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !385
  %5522 = load double, ptr %5521, align 8, !dbg !385
  %5523 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !385
  %5524 = load double, ptr %5523, align 8, !dbg !385
  %5525 = call double @dot(double %5518, double %5520, double %5522, double %5524), !dbg !385
  %5526 = call double @atan2(double noundef %5483, double noundef %5525) #6, !dbg !386
  store double %5526, ptr %13, align 8, !dbg !387
  %5527 = load double, ptr %13, align 8, !dbg !388
  %5528 = load double, ptr %14, align 8, !dbg !389
  %5529 = fadd double %5528, %5527, !dbg !389
  store double %5529, ptr %14, align 8, !dbg !389
  %5530 = load double, ptr %13, align 8, !dbg !390
  %5531 = fsub double %5530, 0x400921FB54442D18, !dbg !392
  %5532 = call double @llvm.fabs.f64(double %5531), !dbg !393
  %5533 = fcmp ole double %5532, 0x3EB0C6F7A0B5ED8D, !dbg !394
  br i1 %5533, label %5539, label %5534, !dbg !395

5534:                                             ; preds = %5441
  %5535 = load double, ptr %13, align 8, !dbg !396
  %5536 = fadd double %5535, 0x400921FB54442D18, !dbg !397
  %5537 = call double @llvm.fabs.f64(double %5536), !dbg !398
  %5538 = fcmp ole double %5537, 0x3EB0C6F7A0B5ED8D, !dbg !399
  br i1 %5538, label %5539, label %5540, !dbg !400

5539:                                             ; preds = %5534, %5441
  store i32 1, ptr %9, align 4, !dbg !401
  store i32 1, ptr %5, align 4, !dbg !402
  store i32 1, ptr %15, align 4
  br label %5552, !dbg !402

5540:                                             ; preds = %5534
  br label %5541, !dbg !403

5541:                                             ; preds = %5540
  %5542 = load i32, ptr %10, align 4, !dbg !404
  %5543 = add nsw i32 %5542, 1, !dbg !404
  store i32 %5543, ptr %10, align 4, !dbg !404
  br label %5437, !dbg !405, !llvm.loop !406

5544:                                             ; preds = %5437
  %5545 = load double, ptr %14, align 8, !dbg !408
  %5546 = fsub double %5545, 0x401921FB54442D18, !dbg !410
  %5547 = call double @llvm.fabs.f64(double %5546), !dbg !411
  %5548 = fcmp ole double %5547, 0x3EB0C6F7A0B5ED8D, !dbg !412
  br i1 %5548, label %5549, label %5550, !dbg !413

5549:                                             ; preds = %5544
  store i32 2, ptr %9, align 4, !dbg !414
  store i32 2, ptr %5, align 4, !dbg !416
  store i32 1, ptr %15, align 4
  br label %5552, !dbg !416

5550:                                             ; preds = %5544
  %5551 = load i32, ptr %9, align 4, !dbg !417
  store i32 %5551, ptr %5, align 4, !dbg !418
  store i32 1, ptr %15, align 4
  br label %5552, !dbg !418

5552:                                             ; preds = %5550, %5549, %5539, %5431
  %5553 = load ptr, ptr %11, align 8, !dbg !419
  call void @llvm.stackrestore.p0(ptr %5553), !dbg !419
  %5554 = load i32, ptr %5, align 4, !dbg !419
  ret i32 %5554, !dbg !419
}
