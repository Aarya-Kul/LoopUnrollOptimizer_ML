...
10:                                               ; preds = %73, %3
  ...
  br i1 %12, label %13, label %121, !dbg !32
...
63:                                               ; preds = %62
  ...
  br i1 %67, label %68, label %121, !dbg !32
...
69:                                               ; preds = %88, %68
  ...
  br i1 %71, label %76, label %72, !dbg !41
...
76:                                               ; preds = %69
  %77 = load ptr, ptr %6, align 8, !dbg !42
  %78 = load i32, ptr %7, align 4, !dbg !44
  %79 = sext i32 %78 to i64, !dbg !42
  %80 = getelementptr inbounds [2 x i32], ptr %77, i64 %79, !dbg !42
  %81 = load i32, ptr %8, align 4, !dbg !45
  %82 = sext i32 %81 to i64, !dbg !42
  %83 = getelementptr inbounds [2 x i32], ptr %80, i64 0, i64 %82, !dbg !42
  store i32 0, ptr %83, align 4, !dbg !46
  call void @llvm.dbg.declare(metadata ptr %9, metadata !47, metadata !DIExpression()), !dbg !49
  store i32 0, ptr %9, align 4, !dbg !49
  br label %84, !dbg !50

84:                                               ; preds = %118, %76
  %85 = load i32, ptr %9, align 4, !dbg !51
  %86 = icmp slt i32 %85, 2, !dbg !53
  br i1 %86, label %91, label %87, !dbg !54

87:                                               ; preds = %84
  br label %88, !dbg !73

88:                                               ; preds = %87
  %89 = load i32, ptr %8, align 4, !dbg !74
  %90 = add nsw i32 %89, 1, !dbg !74
  store i32 %90, ptr %8, align 4, !dbg !74
  br label %69, !dbg !75, !llvm.loop !76

91:                                               ; preds = %84
  %92 = load ptr, ptr %4, align 8, !dbg !55
  %93 = load i32, ptr %7, align 4, !dbg !57
  %94 = sext i32 %93 to i64, !dbg !55
  %95 = getelementptr inbounds [2 x i32], ptr %92, i64 %94, !dbg !55
  %96 = load i32, ptr %9, align 4, !dbg !58
  %97 = sext i32 %96 to i64, !dbg !55
  %98 = getelementptr inbounds [2 x i32], ptr %95, i64 0, i64 %97, !dbg !55
  %99 = load i32, ptr %98, align 4, !dbg !55
  %100 = load ptr, ptr %5, align 8, !dbg !59
  %101 = load i32, ptr %9, align 4, !dbg !60
  %102 = sext i32 %101 to i64, !dbg !59
  %103 = getelementptr inbounds [2 x i32], ptr %100, i64 %102, !dbg !59
  %104 = load i32, ptr %8, align 4, !dbg !61
  %105 = sext i32 %104 to i64, !dbg !59
  %106 = getelementptr inbounds [2 x i32], ptr %103, i64 0, i64 %105, !dbg !59
  %107 = load i32, ptr %106, align 4, !dbg !59
  %108 = mul nsw i32 %99, %107, !dbg !62
  %109 = load ptr, ptr %6, align 8, !dbg !63
  %110 = load i32, ptr %7, align 4, !dbg !64
  %111 = sext i32 %110 to i64, !dbg !63
  %112 = getelementptr inbounds [2 x i32], ptr %109, i64 %111, !dbg !63
  %113 = load i32, ptr %8, align 4, !dbg !65
  %114 = sext i32 %113 to i64, !dbg !63
  %115 = getelementptr inbounds [2 x i32], ptr %112, i64 0, i64 %114, !dbg !63
  %116 = load i32, ptr %115, align 4, !dbg !66
  %117 = add nsw i32 %116, %108, !dbg !66
  store i32 %117, ptr %115, align 4, !dbg !66
  br label %118, !dbg !67

118:                                              ; preds = %91
  %119 = load i32, ptr %9, align 4, !dbg !68
  %120 = add nsw i32 %119, 1, !dbg !68
  store i32 %120, ptr %9, align 4, !dbg !68
  br label %84, !dbg !69, !llvm.loop !70
