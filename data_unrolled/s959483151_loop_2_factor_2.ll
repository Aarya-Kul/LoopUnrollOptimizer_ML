...
12300:                                            ; preds = %12288
  ...
  %12303 = load i32, ptr %4, align 4, !dbg !178
  %12304 = load i32, ptr @N, align 4, !dbg !180
  %12305 = icmp slt i32 %12303, %12304, !dbg !181
  br i1 %12305, label %12306, label %12321, !dbg !182

12306:                                            ; preds = %12300
  %12307 = load i32, ptr %4, align 4, !dbg !183
  %12308 = sext i32 %12307 to i64, !dbg !185
  %12309 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %12308, !dbg !185
  %12310 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.1, ptr noundef %12309), !dbg !186
  %12311 = load i32, ptr %4, align 4, !dbg !187
  %12312 = add nsw i32 %12311, 1, !dbg !188
  %12313 = sext i32 %12312 to i64, !dbg !187
  %12314 = load i32, ptr %4, align 4, !dbg !189
  %12315 = sext i32 %12314 to i64, !dbg !190
  %12316 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %12315, !dbg !190
  %12317 = getelementptr inbounds %struct.Child, ptr %12316, i32 0, i32 1, !dbg !191
  store i64 %12313, ptr %12317, align 8, !dbg !192
  br label %12318, !dbg !193

12318:                                            ; preds = %12306
  %12319 = load i32, ptr %4, align 4, !dbg !194
  %12320 = add nsw i32 %12319, 1, !dbg !194
  store i32 %12320, ptr %4, align 4, !dbg !194
  br label %12284, !dbg !195, !llvm.loop !196

12321:                                            ; preds = %12300, %12284
  %12322 = load i32, ptr @N, align 4, !dbg !198
  %12323 = sext i32 %12322 to i64, !dbg !198
  call void @qsort(ptr noundef @A, i64 noundef %12323, i64 noundef 16, ptr noundef @ascend), !dbg !199
  %12324 = load i32, ptr @N, align 4, !dbg !200
  %12325 = sext i32 %12324 to i64, !dbg !200
  %12326 = call i64 @assign(i64 noundef 1, i64 noundef %12325), !dbg !201
  %12327 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %12326), !dbg !202
  ret i32 0, !dbg !203
}
