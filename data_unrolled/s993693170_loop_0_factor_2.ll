...
5:                                                ; preds = %53, %0
  ...
  br i1 %11, label %12, label %56, !dbg !41
...
28:                                               ; preds = %27
  ...
  br i1 %36, label %37, label %56, !dbg !41
...
56:                                               ; preds = %28, %5
  %57 = load i8, ptr @n, align 1, !dbg !63
  %58 = sext i8 %57 to i32, !dbg !63
  %59 = sub nsw i32 %58, 48, !dbg !64
  %60 = mul nsw i32 %59, 100, !dbg !65
  %61 = load i8, ptr getelementptr inbounds ([3 x i8], ptr @n, i64 0, i64 1), align 1, !dbg !66
  %62 = sext i8 %61 to i32, !dbg !66
  %63 = sub nsw i32 %62, 48, !dbg !67
  %64 = mul nsw i32 %63, 10, !dbg !68
  %65 = add nsw i32 %60, %64, !dbg !69
  %66 = load i8, ptr getelementptr inbounds ([3 x i8], ptr @n, i64 0, i64 2), align 1, !dbg !70
  %67 = sext i8 %66 to i32, !dbg !70
  %68 = sub nsw i32 %67, 48, !dbg !71
  %69 = add nsw i32 %65, %68, !dbg !72
  store i32 %69, ptr %3, align 4, !dbg !73
  %70 = load i32, ptr %3, align 4, !dbg !74
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %70), !dbg !75
  ret i32 0, !dbg !76
}
