...
7:                                                ; preds = %31, %6
  ...
  br i1 %10, label %11, label %34, !dbg !185
...
34:                                               ; preds = %7
  %35 = load i32, ptr @N, align 4, !dbg !210
  %36 = sext i32 %35 to i64, !dbg !210
  call void @qsort(ptr noundef @h, i64 noundef %36, i64 noundef 8, ptr noundef @cmp), !dbg !211
  %37 = call i64 @search(i32 noundef 0, i32 noundef 0), !dbg !212
  %38 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %37), !dbg !213
  store i32 0, ptr %1, align 4, !dbg !214
  br label %39, !dbg !214

39:                                               ; preds = %34, %17, %5
  %40 = load i32, ptr %1, align 4, !dbg !215
  ret i32 %40, !dbg !215
}
