...
17:                                               ; preds = %159, %0
  ...
  br i1 %19, label %20, label %162, !dbg !83
...
87:                                               ; preds = %86
  ...
  br i1 %91, label %92, label %162, !dbg !83
...
162:                                              ; preds = %87, %17
  %163 = load i8, ptr %7, align 1, !dbg !178
  %164 = trunc i8 %163 to i1, !dbg !178
  %165 = zext i1 %164 to i64, !dbg !178
  %166 = select i1 %164, ptr @.str.1, ptr @.str.2, !dbg !178
  %167 = call i32 @puts(ptr noundef %166), !dbg !179
  ret i32 0, !dbg !180
}
