...
13213:                                            ; preds = %13212
  ...
  br i1 %13218, label %13219, label %13327, !dbg !163
...
13327:                                            ; preds = %13213, %13104
  %13328 = load i64, ptr %10, align 8, !dbg !256
  %13329 = load i64, ptr %13, align 8, !dbg !258
  %13330 = icmp sgt i64 %13328, %13329, !dbg !259
  br i1 %13330, label %13331, label %13334, !dbg !260

13331:                                            ; preds = %13327
  %13332 = load i64, ptr %10, align 8, !dbg !261
  %13333 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %13332), !dbg !262
  br label %13337, !dbg !262

13334:                                            ; preds = %13327
  %13335 = load i64, ptr %13, align 8, !dbg !263
  %13336 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %13335), !dbg !264
  br label %13337

13337:                                            ; preds = %13334, %13331
  %13338 = load i32, ptr %3, align 4, !dbg !265
  ret i32 %13338, !dbg !265
}
