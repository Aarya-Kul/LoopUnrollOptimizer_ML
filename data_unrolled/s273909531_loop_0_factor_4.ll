...
267:                                              ; preds = %232, %200, %168, %136, %104, %72, %40, %10
  %268 = load i32, ptr %3, align 4, !dbg !84
  %269 = icmp sge i32 %268, 7, !dbg !86
  br i1 %269, label %270, label %280, !dbg !87

270:                                              ; preds = %267
  %271 = getelementptr inbounds [7 x i32], ptr %5, i64 0, i64 6, !dbg !88
  %272 = load i32, ptr %271, align 8, !dbg !88
  %273 = load i32, ptr %2, align 4, !dbg !91
  %274 = sub nsw i32 %273, 1, !dbg !92
  %275 = icmp slt i32 %272, %274, !dbg !93
  br i1 %275, label %276, label %279, !dbg !94

276:                                              ; preds = %270
  %277 = load i32, ptr %4, align 4, !dbg !95
  %278 = add nsw i32 %277, 1, !dbg !95
  store i32 %278, ptr %4, align 4, !dbg !95
  br label %279, !dbg !96
...
280:                                              ; preds = %279, %267
  ...
  br label %281, !dbg !100

281:                                              ; preds = %300, %280
  %282 = load i32, ptr %2, align 4, !dbg !101
  %283 = icmp slt i32 %282, 7, !dbg !103
  br i1 %283, label %284, label %303, !dbg !104

284:                                              ; preds = %281
  %285 = load i32, ptr %2, align 4, !dbg !105
  %286 = sext i32 %285 to i64, !dbg !108
  %287 = getelementptr inbounds [7 x i32], ptr %5, i64 0, i64 %286, !dbg !108
  %288 = load i32, ptr %287, align 4, !dbg !108
  %289 = load i32, ptr %2, align 4, !dbg !109
  %290 = sub nsw i32 %289, 1, !dbg !110
  %291 = sext i32 %290 to i64, !dbg !111
  %292 = getelementptr inbounds [7 x i32], ptr %5, i64 0, i64 %291, !dbg !111
  %293 = load i32, ptr %292, align 4, !dbg !111
  %294 = sub nsw i32 %288, %293, !dbg !112
  %295 = icmp sgt i32 %294, 1, !dbg !113
  br i1 %295, label %296, label %299, !dbg !114

296:                                              ; preds = %284
  %297 = load i32, ptr %4, align 4, !dbg !115
  %298 = add nsw i32 %297, 1, !dbg !115
  store i32 %298, ptr %4, align 4, !dbg !115
  br label %299, !dbg !116

299:                                              ; preds = %296, %284
  br label %300, !dbg !117

300:                                              ; preds = %299
  %301 = load i32, ptr %2, align 4, !dbg !118
  %302 = add nsw i32 %301, 1, !dbg !118
  store i32 %302, ptr %2, align 4, !dbg !118
  br label %281, !dbg !119, !llvm.loop !120

303:                                              ; preds = %281
  %304 = load i32, ptr %3, align 4, !dbg !122
  %305 = icmp sge i32 %304, 7, !dbg !124
  br i1 %305, label %306, label %311, !dbg !125

306:                                              ; preds = %303
  %307 = load i32, ptr %4, align 4, !dbg !126
  %308 = icmp sle i32 %307, 1, !dbg !127
  br i1 %308, label %309, label %311, !dbg !128

309:                                              ; preds = %306
  %310 = call i32 @puts(ptr noundef @.str.1), !dbg !129
  br label %313, !dbg !131

311:                                              ; preds = %306, %303
  %312 = call i32 @puts(ptr noundef @.str.2), !dbg !132
  br label %313
