...
7:                                                ; preds = %42, %0
  ...
  br i1 %13, label %14, label %45, !dbg !47
...
24:                                               ; preds = %23
  ...
  br i1 %32, label %33, label %45, !dbg !47
...
45:                                               ; preds = %24, %21, %7
  ...
  %47 = icmp eq i32 %46, 1, !dbg !66
  br i1 %47, label %48, label %50, !dbg !67

48:                                               ; preds = %45
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !68
  store i32 0, ptr %1, align 4, !dbg !70
  br label %215, !dbg !70

50:                                               ; preds = %45
  %51 = load i32, ptr %4, align 4, !dbg !71
  store i32 %51, ptr %4, align 4, !dbg !73
  br label %52, !dbg !74

52:                                               ; preds = %69, %50
  %53 = load i32, ptr %4, align 4, !dbg !75
  %54 = sext i32 %53 to i64, !dbg !77
  %55 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %54, !dbg !77
  %56 = load i8, ptr %55, align 1, !dbg !77
  %57 = sext i8 %56 to i32, !dbg !77
  %58 = icmp ne i32 %57, 0, !dbg !78
  br i1 %58, label %59, label %72, !dbg !79

59:                                               ; preds = %52
  %60 = load i32, ptr %4, align 4, !dbg !80
  %61 = sext i32 %60 to i64, !dbg !83
  %62 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %61, !dbg !83
  %63 = load i8, ptr %62, align 1, !dbg !83
  %64 = sext i8 %63 to i32, !dbg !83
  %65 = icmp eq i32 %64, 101, !dbg !84
  br i1 %65, label %66, label %67, !dbg !85
...
69:                                               ; preds = %68
  %70 = load i32, ptr %4, align 4, !dbg !91
  %71 = add nsw i32 %70, 1, !dbg !91
  store i32 %71, ptr %4, align 4, !dbg !91
  br label %52, !dbg !92, !llvm.loop !93

72:                                               ; preds = %66, %52
  %73 = load i32, ptr %3, align 4, !dbg !95
  %74 = icmp eq i32 %73, 1, !dbg !97
  br i1 %74, label %75, label %77, !dbg !98

75:                                               ; preds = %72
  %76 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !99
  store i32 0, ptr %1, align 4, !dbg !101
  br label %215, !dbg !101

77:                                               ; preds = %72
  %78 = load i32, ptr %4, align 4, !dbg !102
  store i32 %78, ptr %4, align 4, !dbg !104
  br label %79, !dbg !105

79:                                               ; preds = %96, %77
  %80 = load i32, ptr %4, align 4, !dbg !106
  %81 = sext i32 %80 to i64, !dbg !108
  %82 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %81, !dbg !108
  %83 = load i8, ptr %82, align 1, !dbg !108
  %84 = sext i8 %83 to i32, !dbg !108
  %85 = icmp ne i32 %84, 0, !dbg !109
  br i1 %85, label %86, label %99, !dbg !110

86:                                               ; preds = %79
  %87 = load i32, ptr %4, align 4, !dbg !111
  %88 = sext i32 %87 to i64, !dbg !114
  %89 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %88, !dbg !114
  %90 = load i8, ptr %89, align 1, !dbg !114
  %91 = sext i8 %90 to i32, !dbg !114
  %92 = icmp eq i32 %91, 121, !dbg !115
  br i1 %92, label %93, label %94, !dbg !116
...
96:                                               ; preds = %95
  %97 = load i32, ptr %4, align 4, !dbg !122
  %98 = add nsw i32 %97, 1, !dbg !122
  store i32 %98, ptr %4, align 4, !dbg !122
  br label %79, !dbg !123, !llvm.loop !124

99:                                               ; preds = %93, %79
  %100 = load i32, ptr %3, align 4, !dbg !126
  %101 = icmp eq i32 %100, 1, !dbg !128
  br i1 %101, label %102, label %104, !dbg !129

102:                                              ; preds = %99
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !130
  store i32 0, ptr %1, align 4, !dbg !132
  br label %215, !dbg !132

104:                                              ; preds = %99
  %105 = load i32, ptr %4, align 4, !dbg !133
  store i32 %105, ptr %4, align 4, !dbg !135
  br label %106, !dbg !136

106:                                              ; preds = %123, %104
  %107 = load i32, ptr %4, align 4, !dbg !137
  %108 = sext i32 %107 to i64, !dbg !139
  %109 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %108, !dbg !139
  %110 = load i8, ptr %109, align 1, !dbg !139
  %111 = sext i8 %110 to i32, !dbg !139
  %112 = icmp ne i32 %111, 0, !dbg !140
  br i1 %112, label %113, label %126, !dbg !141

113:                                              ; preds = %106
  %114 = load i32, ptr %4, align 4, !dbg !142
  %115 = sext i32 %114 to i64, !dbg !145
  %116 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %115, !dbg !145
  %117 = load i8, ptr %116, align 1, !dbg !145
  %118 = sext i8 %117 to i32, !dbg !145
  %119 = icmp eq i32 %118, 101, !dbg !146
  br i1 %119, label %120, label %121, !dbg !147

120:                                              ; preds = %113
  store i32 0, ptr %3, align 4, !dbg !148
  br label %126, !dbg !150
...
123:                                              ; preds = %122
  %124 = load i32, ptr %4, align 4, !dbg !153
  %125 = add nsw i32 %124, 1, !dbg !153
  store i32 %125, ptr %4, align 4, !dbg !153
  br label %106, !dbg !154, !llvm.loop !155

126:                                              ; preds = %120, %106
  %127 = load i32, ptr %3, align 4, !dbg !157
  %128 = icmp eq i32 %127, 1, !dbg !159
  br i1 %128, label %129, label %131, !dbg !160

129:                                              ; preds = %126
  %130 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !161
  store i32 0, ptr %1, align 4, !dbg !163
  br label %215, !dbg !163

131:                                              ; preds = %126
  %132 = load i32, ptr %4, align 4, !dbg !164
  store i32 %132, ptr %4, align 4, !dbg !166
  br label %133, !dbg !167

133:                                              ; preds = %150, %131
  %134 = load i32, ptr %4, align 4, !dbg !168
  %135 = sext i32 %134 to i64, !dbg !170
  %136 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %135, !dbg !170
  %137 = load i8, ptr %136, align 1, !dbg !170
  %138 = sext i8 %137 to i32, !dbg !170
  %139 = icmp ne i32 %138, 0, !dbg !171
  br i1 %139, label %140, label %153, !dbg !172

140:                                              ; preds = %133
  %141 = load i32, ptr %4, align 4, !dbg !173
  %142 = sext i32 %141 to i64, !dbg !176
  %143 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %142, !dbg !176
  %144 = load i8, ptr %143, align 1, !dbg !176
  %145 = sext i8 %144 to i32, !dbg !176
  %146 = icmp eq i32 %145, 110, !dbg !177
  br i1 %146, label %147, label %148, !dbg !178
...
150:                                              ; preds = %149
  %151 = load i32, ptr %4, align 4, !dbg !184
  %152 = add nsw i32 %151, 1, !dbg !184
  store i32 %152, ptr %4, align 4, !dbg !184
  br label %133, !dbg !185, !llvm.loop !186

153:                                              ; preds = %147, %133
  %154 = load i32, ptr %3, align 4, !dbg !188
  %155 = icmp eq i32 %154, 1, !dbg !190
  br i1 %155, label %156, label %158, !dbg !191

156:                                              ; preds = %153
  %157 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !192
  store i32 0, ptr %1, align 4, !dbg !194
  br label %215, !dbg !194

158:                                              ; preds = %153
  %159 = load i32, ptr %4, align 4, !dbg !195
  store i32 %159, ptr %4, align 4, !dbg !197
  br label %160, !dbg !198

160:                                              ; preds = %177, %158
  %161 = load i32, ptr %4, align 4, !dbg !199
  %162 = sext i32 %161 to i64, !dbg !201
  %163 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %162, !dbg !201
  %164 = load i8, ptr %163, align 1, !dbg !201
  %165 = sext i8 %164 to i32, !dbg !201
  %166 = icmp ne i32 %165, 0, !dbg !202
  br i1 %166, label %167, label %180, !dbg !203

167:                                              ; preds = %160
  %168 = load i32, ptr %4, align 4, !dbg !204
  %169 = sext i32 %168 to i64, !dbg !207
  %170 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %169, !dbg !207
  %171 = load i8, ptr %170, align 1, !dbg !207
  %172 = sext i8 %171 to i32, !dbg !207
  %173 = icmp eq i32 %172, 99, !dbg !208
  br i1 %173, label %174, label %175, !dbg !209

174:                                              ; preds = %167
  store i32 0, ptr %3, align 4, !dbg !210
  br label %180, !dbg !212
...
176:                                              ; preds = %175
  br label %177, !dbg !214

177:                                              ; preds = %176
  %178 = load i32, ptr %4, align 4, !dbg !215
  %179 = add nsw i32 %178, 1, !dbg !215
  store i32 %179, ptr %4, align 4, !dbg !215
  br label %160, !dbg !216, !llvm.loop !217

180:                                              ; preds = %174, %160
  %181 = load i32, ptr %3, align 4, !dbg !219
  %182 = icmp eq i32 %181, 1, !dbg !221
  br i1 %182, label %183, label %185, !dbg !222

183:                                              ; preds = %180
  %184 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !223
  store i32 0, ptr %1, align 4, !dbg !225
  br label %215, !dbg !225

185:                                              ; preds = %180
  %186 = load i32, ptr %4, align 4, !dbg !226
  store i32 %186, ptr %4, align 4, !dbg !228
  br label %187, !dbg !229

187:                                              ; preds = %204, %185
  %188 = load i32, ptr %4, align 4, !dbg !230
  %189 = sext i32 %188 to i64, !dbg !232
  %190 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %189, !dbg !232
  %191 = load i8, ptr %190, align 1, !dbg !232
  %192 = sext i8 %191 to i32, !dbg !232
  %193 = icmp ne i32 %192, 0, !dbg !233
  br i1 %193, label %194, label %207, !dbg !234

194:                                              ; preds = %187
  %195 = load i32, ptr %4, align 4, !dbg !235
  %196 = sext i32 %195 to i64, !dbg !238
  %197 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %196, !dbg !238
  %198 = load i8, ptr %197, align 1, !dbg !238
  %199 = sext i8 %198 to i32, !dbg !238
  %200 = icmp eq i32 %199, 101, !dbg !239
  br i1 %200, label %201, label %202, !dbg !240
...
204:                                              ; preds = %203
  %205 = load i32, ptr %4, align 4, !dbg !246
  %206 = add nsw i32 %205, 1, !dbg !246
  store i32 %206, ptr %4, align 4, !dbg !246
  br label %187, !dbg !247, !llvm.loop !248

207:                                              ; preds = %201, %187
  %208 = load i32, ptr %3, align 4, !dbg !250
  %209 = icmp eq i32 %208, 0, !dbg !252
  br i1 %209, label %210, label %212, !dbg !253

210:                                              ; preds = %207
  %211 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !254
  br label %214, !dbg !254

212:                                              ; preds = %207
  %213 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !255
  br label %214
...
215:                                              ; preds = %214, %183, %156, %129, %102, %75, %48
  %216 = load i32, ptr %1, align 4, !dbg !257
  ret i32 %216, !dbg !257
}
