...
12325:                                            ; preds = %12332, %12313
  ...
  br i1 %12329, label %12330, label %12335, !dbg !327
...
12335:                                            ; preds = %12325
  %12336 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !335
  call void @llvm.dbg.declare(metadata ptr %10, metadata !336, metadata !DIExpression()), !dbg !338
  store i32 0, ptr %10, align 4, !dbg !338
  br label %12337, !dbg !339

12337:                                            ; preds = %12413, %12335
  %12338 = load i32, ptr %10, align 4, !dbg !340
  %12339 = load i32, ptr %2, align 4, !dbg !342
  %12340 = icmp slt i32 %12338, %12339, !dbg !343
  br i1 %12340, label %12341, label %12416, !dbg !344

12341:                                            ; preds = %12337
  call void @llvm.dbg.declare(metadata ptr %11, metadata !345, metadata !DIExpression()), !dbg !348
  store i32 0, ptr %11, align 4, !dbg !348
  br label %12342, !dbg !349

12342:                                            ; preds = %12361, %12341
  %12343 = load i32, ptr %11, align 4, !dbg !350
  %12344 = load i32, ptr %10, align 4, !dbg !352
  %12345 = sext i32 %12344 to i64, !dbg !353
  %12346 = getelementptr inbounds i32, ptr %18, i64 %12345, !dbg !353
  %12347 = load i32, ptr %12346, align 4, !dbg !353
  %12348 = call i32 @llvm.abs.i32(i32 %12347, i1 true), !dbg !354
  %12349 = icmp slt i32 %12343, %12348, !dbg !355
  br i1 %12349, label %12350, label %12364, !dbg !356

12350:                                            ; preds = %12342
  %12351 = load i32, ptr %10, align 4, !dbg !357
  %12352 = sext i32 %12351 to i64, !dbg !360
  %12353 = getelementptr inbounds i32, ptr %18, i64 %12352, !dbg !360
  %12354 = load i32, ptr %12353, align 4, !dbg !360
  %12355 = icmp sgt i32 %12354, 0, !dbg !361
  br i1 %12355, label %12356, label %12358, !dbg !362

12356:                                            ; preds = %12350
  %12357 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !363
  br label %12360, !dbg !365

12358:                                            ; preds = %12350
  %12359 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !366
  br label %12360

12360:                                            ; preds = %12358, %12356
  br label %12361, !dbg !368

12361:                                            ; preds = %12360
  %12362 = load i32, ptr %11, align 4, !dbg !369
  %12363 = add nsw i32 %12362, 1, !dbg !369
  store i32 %12363, ptr %11, align 4, !dbg !369
  br label %12342, !dbg !370, !llvm.loop !371

12364:                                            ; preds = %12342
  call void @llvm.dbg.declare(metadata ptr %12, metadata !373, metadata !DIExpression()), !dbg !375
  store i32 0, ptr %12, align 4, !dbg !375
  br label %12365, !dbg !376

12365:                                            ; preds = %12384, %12364
  %12366 = load i32, ptr %12, align 4, !dbg !377
  %12367 = load i32, ptr %10, align 4, !dbg !379
  %12368 = sext i32 %12367 to i64, !dbg !380
  %12369 = getelementptr inbounds i32, ptr %21, i64 %12368, !dbg !380
  %12370 = load i32, ptr %12369, align 4, !dbg !380
  %12371 = call i32 @llvm.abs.i32(i32 %12370, i1 true), !dbg !381
  %12372 = icmp slt i32 %12366, %12371, !dbg !382
  br i1 %12372, label %12373, label %12387, !dbg !383

12373:                                            ; preds = %12365
  %12374 = load i32, ptr %10, align 4, !dbg !384
  %12375 = sext i32 %12374 to i64, !dbg !387
  %12376 = getelementptr inbounds i32, ptr %21, i64 %12375, !dbg !387
  %12377 = load i32, ptr %12376, align 4, !dbg !387
  %12378 = icmp sgt i32 %12377, 0, !dbg !388
  br i1 %12378, label %12379, label %12381, !dbg !389

12379:                                            ; preds = %12373
  %12380 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !390
  br label %12383, !dbg !392

12381:                                            ; preds = %12373
  %12382 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !393
  br label %12383

12383:                                            ; preds = %12381, %12379
  br label %12384, !dbg !395

12384:                                            ; preds = %12383
  %12385 = load i32, ptr %12, align 4, !dbg !396
  %12386 = add nsw i32 %12385, 1, !dbg !396
  store i32 %12386, ptr %12, align 4, !dbg !396
  br label %12365, !dbg !397, !llvm.loop !398

12387:                                            ; preds = %12365
  call void @llvm.dbg.declare(metadata ptr %13, metadata !400, metadata !DIExpression()), !dbg !402
  store i32 0, ptr %13, align 4, !dbg !402
  br label %12388, !dbg !403

12388:                                            ; preds = %12408, %12387
  %12389 = load i32, ptr %13, align 4, !dbg !404
  %12390 = load i32, ptr %3, align 4, !dbg !406
  %12391 = load i32, ptr %10, align 4, !dbg !407
  %12392 = sext i32 %12391 to i64, !dbg !408
  %12393 = getelementptr inbounds i32, ptr %18, i64 %12392, !dbg !408
  %12394 = load i32, ptr %12393, align 4, !dbg !408
  %12395 = call i32 @llvm.abs.i32(i32 %12394, i1 true), !dbg !409
  %12396 = load i32, ptr %10, align 4, !dbg !410
  %12397 = sext i32 %12396 to i64, !dbg !411
  %12398 = getelementptr inbounds i32, ptr %21, i64 %12397, !dbg !411
  %12399 = load i32, ptr %12398, align 4, !dbg !411
  %12400 = call i32 @llvm.abs.i32(i32 %12399, i1 true), !dbg !412
  %12401 = add nsw i32 %12395, %12400, !dbg !413
  %12402 = call i32 @llvm.abs.i32(i32 %12401, i1 true), !dbg !414
  %12403 = sub nsw i32 %12390, %12402, !dbg !415
  %12404 = sdiv i32 %12403, 2, !dbg !416
  %12405 = icmp slt i32 %12389, %12404, !dbg !417
  br i1 %12405, label %12406, label %12411, !dbg !418

12406:                                            ; preds = %12388
  %12407 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !419
  br label %12408, !dbg !421

12408:                                            ; preds = %12406
  %12409 = load i32, ptr %13, align 4, !dbg !422
  %12410 = add nsw i32 %12409, 1, !dbg !422
  store i32 %12410, ptr %13, align 4, !dbg !422
  br label %12388, !dbg !423, !llvm.loop !424

12411:                                            ; preds = %12388
  %12412 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !426
  br label %12413, !dbg !427

12413:                                            ; preds = %12411
  %12414 = load i32, ptr %10, align 4, !dbg !428
  %12415 = add nsw i32 %12414, 1, !dbg !428
  store i32 %12415, ptr %10, align 4, !dbg !428
  br label %12337, !dbg !429, !llvm.loop !430

12416:                                            ; preds = %12337
  store i32 0, ptr %1, align 4, !dbg !432
  store i32 1, ptr %8, align 4
  br label %12417, !dbg !432

12417:                                            ; preds = %12416, %51
  %12418 = load ptr, ptr %4, align 8, !dbg !433
  call void @llvm.stackrestore.p0(ptr %12418), !dbg !433
  %12419 = load i32, ptr %1, align 4, !dbg !433
  ret i32 %12419, !dbg !433
}
