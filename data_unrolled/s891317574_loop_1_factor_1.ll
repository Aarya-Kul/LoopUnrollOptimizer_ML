...
5413:                                             ; preds = %5385
  %5414 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 2, !dbg !92
  %5415 = load i32, ptr %5414, align 8, !dbg !92
  %5416 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 1, !dbg !93
  %5417 = load i32, ptr %5416, align 4, !dbg !93
  %5418 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 0, !dbg !94
  %5419 = load i32, ptr %5418, align 16, !dbg !94
  %5420 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5415, i32 noundef %5417, i32 noundef %5419), !dbg !95
  ret i32 0, !dbg !96
}
