...
10:                                               ; preds = %46, %0
  ...
  br i1 %14, label %15, label %49, !dbg !55
...
49:                                               ; preds = %43, %10
  %50 = getelementptr inbounds [8 x i8], ptr %5, i64 0, i64 0, !dbg !92
  %51 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 0, !dbg !94
  %52 = call i32 @strcmp(ptr noundef %50, ptr noundef %51) #5, !dbg !95
  %53 = icmp eq i32 %52, 0, !dbg !96
  br i1 %53, label %54, label %59, !dbg !97

54:                                               ; preds = %49
  %55 = load i32, ptr %3, align 4, !dbg !98
  %56 = icmp ne i32 %55, 2, !dbg !99
  br i1 %56, label %57, label %59, !dbg !100

57:                                               ; preds = %54
  %58 = call i32 @puts(ptr noundef @.str.1), !dbg !101
  br label %61, !dbg !103

59:                                               ; preds = %54, %49
  %60 = call i32 @puts(ptr noundef @.str.2), !dbg !104
  br label %61
