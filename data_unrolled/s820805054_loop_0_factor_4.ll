...
13:                                               ; preds = %10, %7
  ...
  br i1 %14, label %15, label %152, !dbg !37
...
31:                                               ; preds = %28, %15
  ...
  br i1 %32, label %33, label %152, !dbg !37
...
49:                                               ; preds = %46, %33
  ...
  br i1 %50, label %51, label %152, !dbg !37
...
67:                                               ; preds = %64, %51
  ...
  br i1 %68, label %69, label %152, !dbg !37
...
85:                                               ; preds = %82, %69
  ...
  br i1 %86, label %87, label %152, !dbg !37
...
103:                                              ; preds = %100, %87
  ...
  br i1 %104, label %105, label %152, !dbg !37
...
121:                                              ; preds = %118, %105
  ...
  br i1 %122, label %123, label %152, !dbg !37
...
139:                                              ; preds = %136, %123
  ...
  br i1 %140, label %141, label %152, !dbg !37
...
152:                                              ; preds = %139, %121, %103, %85, %67, %49, %31, %13
  store i32 0, ptr %4, align 4, !dbg !59
  br label %153, !dbg !61

153:                                              ; preds = %178, %152
  %154 = load i32, ptr %4, align 4, !dbg !62
  %155 = icmp slt i32 %154, 3, !dbg !64
  br i1 %155, label %156, label %181, !dbg !65

156:                                              ; preds = %153
  %157 = load i32, ptr %4, align 4, !dbg !66
  %158 = sext i32 %157 to i64, !dbg !69
  %159 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %158, !dbg !69
  %160 = load i32, ptr %159, align 4, !dbg !69
  %161 = icmp eq i32 %160, 1, !dbg !70
  br i1 %161, label %162, label %166, !dbg !71

162:                                              ; preds = %156
  %163 = load i32, ptr %4, align 4, !dbg !72
  %164 = sext i32 %163 to i64, !dbg !74
  %165 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %164, !dbg !74
  store i32 9, ptr %165, align 4, !dbg !75
  br label %177, !dbg !76

166:                                              ; preds = %156
  %167 = load i32, ptr %4, align 4, !dbg !77
  %168 = sext i32 %167 to i64, !dbg !79
  %169 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %168, !dbg !79
  %170 = load i32, ptr %169, align 4, !dbg !79
  %171 = icmp eq i32 %170, 9, !dbg !80
  br i1 %171, label %172, label %176, !dbg !81

172:                                              ; preds = %166
  %173 = load i32, ptr %4, align 4, !dbg !82
  %174 = sext i32 %173 to i64, !dbg !84
  %175 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %174, !dbg !84
  store i32 1, ptr %175, align 4, !dbg !85
  br label %176, !dbg !86
...
178:                                              ; preds = %177
  %179 = load i32, ptr %4, align 4, !dbg !88
  %180 = add nsw i32 %179, 1, !dbg !88
  store i32 %180, ptr %4, align 4, !dbg !88
  br label %153, !dbg !89, !llvm.loop !90

181:                                              ; preds = %153
  %182 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 0, !dbg !92
  %183 = load i32, ptr %182, align 4, !dbg !92
  %184 = mul nsw i32 %183, 100, !dbg !93
  %185 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 1, !dbg !94
  %186 = load i32, ptr %185, align 4, !dbg !94
  %187 = mul nsw i32 %186, 10, !dbg !95
  %188 = add nsw i32 %184, %187, !dbg !96
  %189 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !97
  %190 = load i32, ptr %189, align 4, !dbg !97
  %191 = add nsw i32 %188, %190, !dbg !98
  store i32 %191, ptr %2, align 4, !dbg !99
  %192 = load i32, ptr %2, align 4, !dbg !100
  %193 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %192), !dbg !101
  ret i32 0, !dbg !102
}
