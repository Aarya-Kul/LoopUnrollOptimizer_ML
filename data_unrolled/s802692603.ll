...
17:                                               ; preds = %35, %0
  ...
  br i1 %19, label %20, label %38, !dbg !54
...
38:                                               ; preds = %17
  %39 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 2, !dbg !75
  %40 = load i32, ptr %39, align 4, !dbg !75
  %41 = mul nsw i32 100, %40, !dbg !76
  %42 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 1, !dbg !77
  %43 = load i32, ptr %42, align 4, !dbg !77
  %44 = mul nsw i32 10, %43, !dbg !78
  %45 = add nsw i32 %41, %44, !dbg !79
  %46 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 0, !dbg !80
  %47 = load i32, ptr %46, align 4, !dbg !80
  %48 = add nsw i32 %45, %47, !dbg !81
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !82
  ret i32 0, !dbg !83
}
