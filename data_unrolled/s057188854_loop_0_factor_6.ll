...
8610:                                             ; preds = %8430, %8251, %8072, %7893, %7714, %7535, %7356, %7177, %6998, %6819, %6640, %6461, %6282, %6103, %5924, %5745, %5566, %5387, %5208, %5029, %4850, %4671, %4492, %4313, %4134, %3955, %3776, %3597, %3418, %3239, %3060, %2881, %2702, %2523, %2344, %2165, %1986, %1807, %1628, %1449, %1270, %1091, %912, %733, %554, %375, %196, %195, %189, %164, %139, %114, %89, %64, %39, %9
  ...
  br i1 %8613, label %8614, label %8620, !dbg !259

8614:                                             ; preds = %8610
  %8615 = load i8, ptr %5, align 1, !dbg !260
  %8616 = sext i8 %8615 to i32, !dbg !260
  %8617 = icmp eq i32 %8616, 7, !dbg !261
  br i1 %8617, label %8618, label %8620, !dbg !262

8618:                                             ; preds = %8614
  %8619 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !263
  br label %8622, !dbg !263

8620:                                             ; preds = %8614, %8610
  %8621 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !264
  br label %8622

8622:                                             ; preds = %8620, %8618
  ret i32 0, !dbg !265
}
