...
81:                                               ; preds = %101, %76
  ...
  br i1 %83, label %84, label %104, !dbg !108
...
101:                                              ; preds = %100
  %102 = load i32, ptr %7, align 4, !dbg !123
  %103 = add nsw i32 %102, -1, !dbg !123
  store i32 %103, ptr %7, align 4, !dbg !123
  br label %81, !dbg !124, !llvm.loop !125

104:                                              ; preds = %99, %81
  %105 = load i32, ptr %4, align 4, !dbg !127
  %106 = sub nsw i32 %105, 1, !dbg !129
  %107 = load i32, ptr %5, align 4, !dbg !130
  %108 = icmp eq i32 %106, %107, !dbg !131
  br i1 %108, label %109, label %111, !dbg !132

109:                                              ; preds = %104
  %110 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !133
  br label %113, !dbg !135
...
113:                                              ; preds = %111, %109
  ...
  br label %114, !dbg !138

114:                                              ; preds = %113, %25, %14
  %115 = load i32, ptr %1, align 4, !dbg !139
  ret i32 %115, !dbg !139
}
