...
5432:                                             ; preds = %5431
  ...
  br i1 %5437, label %5438, label %5459, !dbg !117
...
5459:                                             ; preds = %5432, %5408
  %5460 = load i32, ptr %3, align 4, !dbg !140
  %5461 = icmp eq i32 %5460, 0, !dbg !142
  br i1 %5461, label %5462, label %5493, !dbg !143

5462:                                             ; preds = %5459
  %5463 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef 32), !dbg !144
  call void @llvm.dbg.declare(metadata ptr %14, metadata !146, metadata !DIExpression()), !dbg !148
  store i32 0, ptr %14, align 4, !dbg !148
  br label %5464, !dbg !149

5464:                                             ; preds = %5474, %5462
  %5465 = load i32, ptr %14, align 4, !dbg !150
  %5466 = load i32, ptr %2, align 4, !dbg !152
  %5467 = icmp slt i32 %5465, %5466, !dbg !153
  br i1 %5467, label %5468, label %5477, !dbg !154

5468:                                             ; preds = %5464
  %5469 = load i32, ptr %14, align 4, !dbg !155
  %5470 = sext i32 %5469 to i64, !dbg !157
  %5471 = getelementptr inbounds [1000 x i64], ptr %6, i64 0, i64 %5470, !dbg !157
  %5472 = load i64, ptr %5471, align 8, !dbg !158
  %5473 = sub nsw i64 %5472, 1, !dbg !158
  store i64 %5473, ptr %5471, align 8, !dbg !158
  br label %5474, !dbg !159

5474:                                             ; preds = %5468
  %5475 = load i32, ptr %14, align 4, !dbg !160
  %5476 = add nsw i32 %5475, 1, !dbg !160
  store i32 %5476, ptr %14, align 4, !dbg !160
  br label %5464, !dbg !161, !llvm.loop !162

5477:                                             ; preds = %5464
  %5478 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef 1), !dbg !164
  call void @llvm.dbg.declare(metadata ptr %15, metadata !165, metadata !DIExpression()), !dbg !167
  store i32 0, ptr %15, align 4, !dbg !167
  br label %5479, !dbg !168

5479:                                             ; preds = %5488, %5477
  %5480 = load i32, ptr %15, align 4, !dbg !169
  %5481 = icmp slt i32 %5480, 31, !dbg !171
  br i1 %5481, label %5482, label %5491, !dbg !172

5482:                                             ; preds = %5479
  %5483 = load i32, ptr %15, align 4, !dbg !173
  %5484 = sitofp i32 %5483 to double, !dbg !173
  %5485 = call double @pow(double noundef 2.000000e+00, double noundef %5484) #4, !dbg !175
  %5486 = fptosi double %5485 to i64, !dbg !176
  %5487 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %5486), !dbg !177
  br label %5488, !dbg !178

5488:                                             ; preds = %5482
  %5489 = load i32, ptr %15, align 4, !dbg !179
  %5490 = add nsw i32 %5489, 1, !dbg !179
  store i32 %5490, ptr %15, align 4, !dbg !179
  br label %5479, !dbg !180, !llvm.loop !181

5491:                                             ; preds = %5479
  %5492 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !183
  br label %5509, !dbg !184

5493:                                             ; preds = %5459
  %5494 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef 31), !dbg !185
  call void @llvm.dbg.declare(metadata ptr %16, metadata !187, metadata !DIExpression()), !dbg !189
  store i32 0, ptr %16, align 4, !dbg !189
  br label %5495, !dbg !190

5495:                                             ; preds = %5504, %5493
  %5496 = load i32, ptr %16, align 4, !dbg !191
  %5497 = icmp slt i32 %5496, 31, !dbg !193
  br i1 %5497, label %5498, label %5507, !dbg !194

5498:                                             ; preds = %5495
  %5499 = load i32, ptr %16, align 4, !dbg !195
  %5500 = sitofp i32 %5499 to double, !dbg !195
  %5501 = call double @pow(double noundef 2.000000e+00, double noundef %5500) #4, !dbg !197
  %5502 = fptosi double %5501 to i32, !dbg !198
  %5503 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %5502), !dbg !199
  br label %5504, !dbg !200

5504:                                             ; preds = %5498
  %5505 = load i32, ptr %16, align 4, !dbg !201
  %5506 = add nsw i32 %5505, 1, !dbg !201
  store i32 %5506, ptr %16, align 4, !dbg !201
  br label %5495, !dbg !202, !llvm.loop !203

5507:                                             ; preds = %5495
  %5508 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !205
  br label %5509

5509:                                             ; preds = %5507, %5491
  call void @llvm.dbg.declare(metadata ptr %17, metadata !206, metadata !DIExpression()), !dbg !208
  store i32 0, ptr %17, align 4, !dbg !208
  br label %5510, !dbg !209

5510:                                             ; preds = %5669, %5509
  %5511 = load i32, ptr %17, align 4, !dbg !210
  %5512 = load i32, ptr %2, align 4, !dbg !212
  %5513 = icmp slt i32 %5511, %5512, !dbg !213
  br i1 %5513, label %5514, label %5672, !dbg !214

5514:                                             ; preds = %5510
  %5515 = load i32, ptr %17, align 4, !dbg !215
  %5516 = sext i32 %5515 to i64, !dbg !217
  %5517 = getelementptr inbounds [1000 x i64], ptr %6, i64 0, i64 %5516, !dbg !217
  %5518 = load i64, ptr %5517, align 8, !dbg !217
  %5519 = load i32, ptr %17, align 4, !dbg !218
  %5520 = sext i32 %5519 to i64, !dbg !219
  %5521 = getelementptr inbounds [1000 x i64], ptr %7, i64 0, i64 %5520, !dbg !219
  %5522 = load i64, ptr %5521, align 8, !dbg !219
  %5523 = add nsw i64 %5518, %5522, !dbg !220
  %5524 = sub nsw i64 %5523, 1, !dbg !221
  %5525 = sdiv i64 %5524, 2, !dbg !222
  %5526 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !223
  %5527 = fptosi double %5526 to i64, !dbg !224
  %5528 = add nsw i64 %5525, %5527, !dbg !225
  store i64 %5528, ptr %9, align 8, !dbg !226
  %5529 = load i32, ptr %17, align 4, !dbg !227
  %5530 = sext i32 %5529 to i64, !dbg !228
  %5531 = getelementptr inbounds [1000 x i64], ptr %6, i64 0, i64 %5530, !dbg !228
  %5532 = load i64, ptr %5531, align 8, !dbg !228
  %5533 = load i32, ptr %17, align 4, !dbg !229
  %5534 = sext i32 %5533 to i64, !dbg !230
  %5535 = getelementptr inbounds [1000 x i64], ptr %7, i64 0, i64 %5534, !dbg !230
  %5536 = load i64, ptr %5535, align 8, !dbg !230
  %5537 = sub nsw i64 %5532, %5536, !dbg !231
  %5538 = sub nsw i64 %5537, 1, !dbg !232
  %5539 = sdiv i64 %5538, 2, !dbg !233
  %5540 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !234
  %5541 = fptosi double %5540 to i64, !dbg !235
  %5542 = add nsw i64 %5539, %5541, !dbg !236
  store i64 %5542, ptr %10, align 8, !dbg !237
  call void @llvm.dbg.declare(metadata ptr %18, metadata !238, metadata !DIExpression()), !dbg !240
  store i32 30, ptr %18, align 4, !dbg !240
  br label %5543, !dbg !241

5543:                                             ; preds = %5656, %5514
  %5544 = load i32, ptr %18, align 4, !dbg !242
  %5545 = icmp sge i32 %5544, 0, !dbg !244
  br i1 %5545, label %5546, label %5659, !dbg !245

5546:                                             ; preds = %5543
  %5547 = load i64, ptr %9, align 8, !dbg !246
  %5548 = load i32, ptr %18, align 4, !dbg !249
  %5549 = sitofp i32 %5548 to double, !dbg !249
  %5550 = call double @pow(double noundef 2.000000e+00, double noundef %5549) #4, !dbg !250
  %5551 = fptosi double %5550 to i64, !dbg !251
  %5552 = icmp sge i64 %5547, %5551, !dbg !252
  br i1 %5552, label %5553, label %5563, !dbg !253

5553:                                             ; preds = %5546
  %5554 = load i32, ptr %18, align 4, !dbg !254
  %5555 = sext i32 %5554 to i64, !dbg !256
  %5556 = getelementptr inbounds [31 x i32], ptr %4, i64 0, i64 %5555, !dbg !256
  store i32 1, ptr %5556, align 4, !dbg !257
  %5557 = load i32, ptr %18, align 4, !dbg !258
  %5558 = sitofp i32 %5557 to double, !dbg !258
  %5559 = call double @pow(double noundef 2.000000e+00, double noundef %5558) #4, !dbg !259
  %5560 = fptosi double %5559 to i64, !dbg !260
  %5561 = load i64, ptr %9, align 8, !dbg !261
  %5562 = sub nsw i64 %5561, %5560, !dbg !261
  store i64 %5562, ptr %9, align 8, !dbg !261
  br label %5567, !dbg !262

5563:                                             ; preds = %5546
  %5564 = load i32, ptr %18, align 4, !dbg !263
  %5565 = sext i32 %5564 to i64, !dbg !265
  %5566 = getelementptr inbounds [31 x i32], ptr %4, i64 0, i64 %5565, !dbg !265
  store i32 0, ptr %5566, align 4, !dbg !266
  br label %5567

5567:                                             ; preds = %5563, %5553
  %5568 = load i64, ptr %10, align 8, !dbg !267
  %5569 = load i32, ptr %18, align 4, !dbg !269
  %5570 = sitofp i32 %5569 to double, !dbg !269
  %5571 = call double @pow(double noundef 2.000000e+00, double noundef %5570) #4, !dbg !270
  %5572 = fptosi double %5571 to i64, !dbg !271
  %5573 = icmp sge i64 %5568, %5572, !dbg !272
  br i1 %5573, label %5574, label %5584, !dbg !273

5574:                                             ; preds = %5567
  %5575 = load i32, ptr %18, align 4, !dbg !274
  %5576 = sext i32 %5575 to i64, !dbg !276
  %5577 = getelementptr inbounds [31 x i32], ptr %5, i64 0, i64 %5576, !dbg !276
  store i32 1, ptr %5577, align 4, !dbg !277
  %5578 = load i32, ptr %18, align 4, !dbg !278
  %5579 = sitofp i32 %5578 to double, !dbg !278
  %5580 = call double @pow(double noundef 2.000000e+00, double noundef %5579) #4, !dbg !279
  %5581 = fptosi double %5580 to i64, !dbg !280
  %5582 = load i64, ptr %10, align 8, !dbg !281
  %5583 = sub nsw i64 %5582, %5581, !dbg !281
  store i64 %5583, ptr %10, align 8, !dbg !281
  br label %5588, !dbg !282

5584:                                             ; preds = %5567
  %5585 = load i32, ptr %18, align 4, !dbg !283
  %5586 = sext i32 %5585 to i64, !dbg !285
  %5587 = getelementptr inbounds [31 x i32], ptr %5, i64 0, i64 %5586, !dbg !285
  store i32 0, ptr %5587, align 4, !dbg !286
  br label %5588

5588:                                             ; preds = %5584, %5574
  %5589 = load i32, ptr %18, align 4, !dbg !287
  %5590 = sext i32 %5589 to i64, !dbg !289
  %5591 = getelementptr inbounds [31 x i32], ptr %4, i64 0, i64 %5590, !dbg !289
  %5592 = load i32, ptr %5591, align 4, !dbg !289
  %5593 = icmp eq i32 %5592, 1, !dbg !290
  br i1 %5593, label %5594, label %5604, !dbg !291

5594:                                             ; preds = %5588
  %5595 = load i32, ptr %18, align 4, !dbg !292
  %5596 = sext i32 %5595 to i64, !dbg !293
  %5597 = getelementptr inbounds [31 x i32], ptr %5, i64 0, i64 %5596, !dbg !293
  %5598 = load i32, ptr %5597, align 4, !dbg !293
  %5599 = icmp eq i32 %5598, 1, !dbg !294
  br i1 %5599, label %5600, label %5604, !dbg !295

5600:                                             ; preds = %5594
  %5601 = load i32, ptr %18, align 4, !dbg !296
  %5602 = sext i32 %5601 to i64, !dbg !298
  %5603 = getelementptr inbounds [31 x i8], ptr %11, i64 0, i64 %5602, !dbg !298
  store i8 82, ptr %5603, align 1, !dbg !299
  br label %5655, !dbg !300

5604:                                             ; preds = %5594, %5588
  %5605 = load i32, ptr %18, align 4, !dbg !301
  %5606 = sext i32 %5605 to i64, !dbg !303
  %5607 = getelementptr inbounds [31 x i32], ptr %4, i64 0, i64 %5606, !dbg !303
  %5608 = load i32, ptr %5607, align 4, !dbg !303
  %5609 = icmp eq i32 %5608, 1, !dbg !304
  br i1 %5609, label %5610, label %5620, !dbg !305

5610:                                             ; preds = %5604
  %5611 = load i32, ptr %18, align 4, !dbg !306
  %5612 = sext i32 %5611 to i64, !dbg !307
  %5613 = getelementptr inbounds [31 x i32], ptr %5, i64 0, i64 %5612, !dbg !307
  %5614 = load i32, ptr %5613, align 4, !dbg !307
  %5615 = icmp eq i32 %5614, 0, !dbg !308
  br i1 %5615, label %5616, label %5620, !dbg !309

5616:                                             ; preds = %5610
  %5617 = load i32, ptr %18, align 4, !dbg !310
  %5618 = sext i32 %5617 to i64, !dbg !312
  %5619 = getelementptr inbounds [31 x i8], ptr %11, i64 0, i64 %5618, !dbg !312
  store i8 85, ptr %5619, align 1, !dbg !313
  br label %5654, !dbg !314

5620:                                             ; preds = %5610, %5604
  %5621 = load i32, ptr %18, align 4, !dbg !315
  %5622 = sext i32 %5621 to i64, !dbg !317
  %5623 = getelementptr inbounds [31 x i32], ptr %4, i64 0, i64 %5622, !dbg !317
  %5624 = load i32, ptr %5623, align 4, !dbg !317
  %5625 = icmp eq i32 %5624, 0, !dbg !318
  br i1 %5625, label %5626, label %5636, !dbg !319

5626:                                             ; preds = %5620
  %5627 = load i32, ptr %18, align 4, !dbg !320
  %5628 = sext i32 %5627 to i64, !dbg !321
  %5629 = getelementptr inbounds [31 x i32], ptr %5, i64 0, i64 %5628, !dbg !321
  %5630 = load i32, ptr %5629, align 4, !dbg !321
  %5631 = icmp eq i32 %5630, 1, !dbg !322
  br i1 %5631, label %5632, label %5636, !dbg !323

5632:                                             ; preds = %5626
  %5633 = load i32, ptr %18, align 4, !dbg !324
  %5634 = sext i32 %5633 to i64, !dbg !326
  %5635 = getelementptr inbounds [31 x i8], ptr %11, i64 0, i64 %5634, !dbg !326
  store i8 68, ptr %5635, align 1, !dbg !327
  br label %5653, !dbg !328

5636:                                             ; preds = %5626, %5620
  %5637 = load i32, ptr %18, align 4, !dbg !329
  %5638 = sext i32 %5637 to i64, !dbg !331
  %5639 = getelementptr inbounds [31 x i32], ptr %4, i64 0, i64 %5638, !dbg !331
  %5640 = load i32, ptr %5639, align 4, !dbg !331
  %5641 = icmp eq i32 %5640, 0, !dbg !332
  br i1 %5641, label %5642, label %5652, !dbg !333

5642:                                             ; preds = %5636
  %5643 = load i32, ptr %18, align 4, !dbg !334
  %5644 = sext i32 %5643 to i64, !dbg !335
  %5645 = getelementptr inbounds [31 x i32], ptr %5, i64 0, i64 %5644, !dbg !335
  %5646 = load i32, ptr %5645, align 4, !dbg !335
  %5647 = icmp eq i32 %5646, 0, !dbg !336
  br i1 %5647, label %5648, label %5652, !dbg !337

5648:                                             ; preds = %5642
  %5649 = load i32, ptr %18, align 4, !dbg !338
  %5650 = sext i32 %5649 to i64, !dbg !340
  %5651 = getelementptr inbounds [31 x i8], ptr %11, i64 0, i64 %5650, !dbg !340
  store i8 76, ptr %5651, align 1, !dbg !341
  br label %5652, !dbg !342

5652:                                             ; preds = %5648, %5642, %5636
  br label %5653

5653:                                             ; preds = %5652, %5632
  br label %5654

5654:                                             ; preds = %5653, %5616
  br label %5655

5655:                                             ; preds = %5654, %5600
  br label %5656, !dbg !343

5656:                                             ; preds = %5655
  %5657 = load i32, ptr %18, align 4, !dbg !344
  %5658 = add nsw i32 %5657, -1, !dbg !344
  store i32 %5658, ptr %18, align 4, !dbg !344
  br label %5543, !dbg !345, !llvm.loop !346

5659:                                             ; preds = %5543
  %5660 = load i32, ptr %3, align 4, !dbg !348
  %5661 = icmp eq i32 %5660, 1, !dbg !350
  br i1 %5661, label %5662, label %5665, !dbg !351

5662:                                             ; preds = %5659
  %5663 = getelementptr inbounds [31 x i8], ptr %11, i64 0, i64 0, !dbg !352
  %5664 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, ptr noundef %5663), !dbg !354
  br label %5668, !dbg !355

5665:                                             ; preds = %5659
  %5666 = getelementptr inbounds [31 x i8], ptr %11, i64 0, i64 0, !dbg !356
  %5667 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, ptr noundef %5666), !dbg !358
  br label %5668

5668:                                             ; preds = %5665, %5662
  br label %5669, !dbg !359

5669:                                             ; preds = %5668
  %5670 = load i32, ptr %17, align 4, !dbg !360
  %5671 = add nsw i32 %5670, 1, !dbg !360
  store i32 %5671, ptr %17, align 4, !dbg !360
  br label %5510, !dbg !361, !llvm.loop !362

5672:                                             ; preds = %5510
  store i32 0, ptr %1, align 4, !dbg !364
  br label %5673, !dbg !364

5673:                                             ; preds = %5672, %5429
  %5674 = load i32, ptr %1, align 4, !dbg !365
  ret i32 %5674, !dbg !365
}
