...
6543:                                             ; preds = %6718, %6540
  ...
  br i1 %6547, label %6548, label %6721, !dbg !98
...
6721:                                             ; preds = %6543
  %6722 = load i64, ptr %3, align 8, !dbg !254
  %6723 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %6722), !dbg !255
  %6724 = load i32, ptr %1, align 4, !dbg !256
  ret i32 %6724, !dbg !256
}
