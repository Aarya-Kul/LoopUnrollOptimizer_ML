...
8866:                                             ; preds = %8861, %8849
  ...
  br i1 %8867, label %8868, label %8873, !dbg !73
...
8873:                                             ; preds = %8866
  %8874 = load i32, ptr %3, align 4, !dbg !88
  %8875 = sext i32 %8874 to i64, !dbg !88
  %8876 = getelementptr inbounds [102 x i8], ptr %2, i64 0, i64 0, !dbg !90
  %8877 = call i64 @strlen(ptr noundef %8876) #5, !dbg !91
  %8878 = icmp eq i64 %8875, %8877, !dbg !92
  br i1 %8878, label %8879, label %8881, !dbg !93

8879:                                             ; preds = %8873
  %8880 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !94
  br label %8883, !dbg !94

8881:                                             ; preds = %8873
  %8882 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !95
  br label %8883

8883:                                             ; preds = %8881, %8879
  ret i32 0, !dbg !96
}
