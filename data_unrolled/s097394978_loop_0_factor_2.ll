...
23:                                               ; preds = %127, %0
  ...
  br i1 %26, label %27, label %168, !dbg !62
...
93:                                               ; preds = %92
  ...
  br i1 %98, label %99, label %168, !dbg !62
...
106:                                              ; preds = %165, %105
  ...
  br i1 %109, label %147, label %110, !dbg !86
...
114:                                              ; preds = %144, %110
  ...
  br i1 %117, label %130, label %118, !dbg !121
...
130:                                              ; preds = %114
  %131 = load i32, ptr %12, align 4, !dbg !122
  %132 = sext i32 %131 to i64, !dbg !124
  %133 = getelementptr inbounds [105 x i8], ptr %8, i64 0, i64 %132, !dbg !124
  %134 = load i8, ptr %133, align 1, !dbg !124
  %135 = sext i8 %134 to i32, !dbg !124
  %136 = load i32, ptr %12, align 4, !dbg !125
  %137 = sext i32 %136 to i64, !dbg !126
  %138 = getelementptr inbounds [8 x i8], ptr %4, i64 0, i64 %137, !dbg !126
  %139 = load i8, ptr %138, align 1, !dbg !126
  %140 = sext i8 %139 to i32, !dbg !126
  %141 = icmp ne i32 %135, %140, !dbg !127
  br i1 %141, label %142, label %143, !dbg !128
...
143:                                              ; preds = %142, %130
  br label %144, !dbg !131

144:                                              ; preds = %143
  %145 = load i32, ptr %12, align 4, !dbg !132
  %146 = add nsw i32 %145, 1, !dbg !132
  store i32 %146, ptr %12, align 4, !dbg !132
  br label %114, !dbg !133, !llvm.loop !134

147:                                              ; preds = %106
  %148 = load i32, ptr %10, align 4, !dbg !87
  %149 = load i32, ptr %6, align 4, !dbg !90
  %150 = icmp sge i32 %148, %149, !dbg !91
  br i1 %150, label %151, label %155, !dbg !92

151:                                              ; preds = %147
  %152 = load i32, ptr %10, align 4, !dbg !93
  %153 = load i32, ptr %7, align 4, !dbg !94
  %154 = icmp slt i32 %152, %153, !dbg !95
  br i1 %154, label %164, label %155, !dbg !96

155:                                              ; preds = %151, %147
  %156 = load i32, ptr %10, align 4, !dbg !98
  %157 = sext i32 %156 to i64, !dbg !99
  %158 = getelementptr inbounds [105 x i8], ptr %2, i64 0, i64 %157, !dbg !99
  %159 = load i8, ptr %158, align 1, !dbg !99
  %160 = load i32, ptr %9, align 4, !dbg !100
  %161 = add nsw i32 %160, 1, !dbg !100
  store i32 %161, ptr %9, align 4, !dbg !100
  %162 = sext i32 %160 to i64, !dbg !101
  %163 = getelementptr inbounds [105 x i8], ptr %8, i64 0, i64 %162, !dbg !101
  store i8 %159, ptr %163, align 1, !dbg !102
  br label %165, !dbg !103

164:                                              ; preds = %151
  br label %165, !dbg !97

165:                                              ; preds = %164, %155
  %166 = load i32, ptr %10, align 4, !dbg !104
  %167 = add nsw i32 %166, 1, !dbg !104
  store i32 %167, ptr %10, align 4, !dbg !104
  br label %106, !dbg !105, !llvm.loop !106

168:                                              ; preds = %93, %23
  %169 = load i32, ptr %5, align 4, !dbg !151
  %170 = icmp ne i32 %169, 0, !dbg !151
  %171 = zext i1 %170 to i64, !dbg !151
  %172 = select i1 %170, ptr @.str.3, ptr @.str.4, !dbg !151
  %173 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %172), !dbg !152
  ret i32 0, !dbg !153
}
