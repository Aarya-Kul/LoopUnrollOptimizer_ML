...
538:                                              ; preds = %613, %535
  ...
  br i1 %541, label %542, label %616, !dbg !151
...
543:                                              ; preds = %609, %542
  ...
  br i1 %546, label %547, label %612, !dbg !160
...
547:                                              ; preds = %543
  ...
  br i1 %557, label %558, label %608, !dbg !171
...
558:                                              ; preds = %547
  ...
  br i1 %562, label %563, label %608, !dbg !175

563:                                              ; preds = %558
  %564 = load i64, ptr %4, align 8, !dbg !176
  %565 = getelementptr inbounds i64, ptr %24, i64 %564, !dbg !178
  %566 = load i64, ptr %565, align 8, !dbg !179
  %567 = add nsw i64 %566, 1, !dbg !179
  store i64 %567, ptr %565, align 8, !dbg !179
  call void @llvm.dbg.declare(metadata ptr %13, metadata !180, metadata !DIExpression()), !dbg !181
  %568 = load i64, ptr %4, align 8, !dbg !182
  %569 = load i64, ptr %12, align 8, !dbg !183
  %570 = sub nsw i64 %568, %569, !dbg !184
  store i64 %570, ptr %13, align 8, !dbg !181
  call void @llvm.dbg.declare(metadata ptr %14, metadata !185, metadata !DIExpression()), !dbg !186
  %571 = load i64, ptr %11, align 8, !dbg !187
  %572 = load i64, ptr %4, align 8, !dbg !188
  %573 = sub nsw i64 %571, %572, !dbg !189
  store i64 %573, ptr %14, align 8, !dbg !186
  %574 = load i64, ptr %13, align 8, !dbg !190
  %575 = load i64, ptr %14, align 8, !dbg !192
  %576 = icmp slt i64 %574, %575, !dbg !193
  br i1 %576, label %577, label %592, !dbg !194

577:                                              ; preds = %563
  %578 = load i64, ptr %4, align 8, !dbg !195
  %579 = getelementptr inbounds i64, ptr %19, i64 %578, !dbg !197
  %580 = load i64, ptr %579, align 8, !dbg !197
  %581 = load i64, ptr %14, align 8, !dbg !198
  %582 = mul nsw i64 %580, %581, !dbg !199
  %583 = load i64, ptr %5, align 8, !dbg !200
  %584 = add nsw i64 %583, %582, !dbg !200
  store i64 %584, ptr %5, align 8, !dbg !200
  %585 = load i64, ptr %4, align 8, !dbg !201
  %586 = getelementptr inbounds i64, ptr %19, i64 %585, !dbg !202
  %587 = load i64, ptr %586, align 8, !dbg !202
  %588 = load i64, ptr %11, align 8, !dbg !203
  %589 = getelementptr inbounds i64, ptr %27, i64 %588, !dbg !204
  store i64 %587, ptr %589, align 8, !dbg !205
  %590 = load i64, ptr %11, align 8, !dbg !206
  %591 = add nsw i64 %590, -1, !dbg !206
  store i64 %591, ptr %11, align 8, !dbg !206
  br label %607, !dbg !207

592:                                              ; preds = %563
  %593 = load i64, ptr %4, align 8, !dbg !208
  %594 = getelementptr inbounds i64, ptr %19, i64 %593, !dbg !210
  %595 = load i64, ptr %594, align 8, !dbg !210
  %596 = load i64, ptr %13, align 8, !dbg !211
  %597 = mul nsw i64 %595, %596, !dbg !212
  %598 = load i64, ptr %5, align 8, !dbg !213
  %599 = add nsw i64 %598, %597, !dbg !213
  store i64 %599, ptr %5, align 8, !dbg !213
  %600 = load i64, ptr %4, align 8, !dbg !214
  %601 = getelementptr inbounds i64, ptr %19, i64 %600, !dbg !215
  %602 = load i64, ptr %601, align 8, !dbg !215
  %603 = load i64, ptr %12, align 8, !dbg !216
  %604 = getelementptr inbounds i64, ptr %27, i64 %603, !dbg !217
  store i64 %602, ptr %604, align 8, !dbg !218
  %605 = load i64, ptr %12, align 8, !dbg !219
  %606 = add nsw i64 %605, 1, !dbg !219
  store i64 %606, ptr %12, align 8, !dbg !219
  br label %607

607:                                              ; preds = %592, %577
  br label %608, !dbg !220

608:                                              ; preds = %607, %558, %547
  br label %609, !dbg !221

609:                                              ; preds = %608
  %610 = load i64, ptr %4, align 8, !dbg !222
  %611 = add nsw i64 %610, 1, !dbg !222
  store i64 %611, ptr %4, align 8, !dbg !222
  br label %543, !dbg !223, !llvm.loop !224

612:                                              ; preds = %543
  br label %613, !dbg !226

613:                                              ; preds = %612
  %614 = load i64, ptr %3, align 8, !dbg !227
  %615 = add nsw i64 %614, 1, !dbg !227
  store i64 %615, ptr %3, align 8, !dbg !227
  br label %538, !dbg !228, !llvm.loop !229

616:                                              ; preds = %538
  %617 = load i64, ptr %5, align 8, !dbg !231
  %618 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %617), !dbg !232
  store i32 0, ptr %1, align 4, !dbg !233
  %619 = load ptr, ptr %6, align 8, !dbg !234
  call void @llvm.stackrestore.p0(ptr %619), !dbg !234
  %620 = load i32, ptr %1, align 4, !dbg !234
  ret i32 %620, !dbg !234
}
