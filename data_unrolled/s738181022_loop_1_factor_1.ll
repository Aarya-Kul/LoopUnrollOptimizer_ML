...
4479:                                             ; preds = %4242
  %4480 = load i64, ptr %13, align 8, !dbg !305
  %4481 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %4480), !dbg !306
  %4482 = load ptr, ptr @stdout, align 8, !dbg !307
  %4483 = call i32 @fflush(ptr noundef %4482), !dbg !308
  ret i32 0, !dbg !309
}
