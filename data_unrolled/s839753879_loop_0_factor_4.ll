...
14:                                               ; preds = %459, %0
  ...
  br i1 %16, label %17, label %471, !dbg !119
...
69:                                               ; preds = %66
  ...
  br i1 %73, label %74, label %471, !dbg !119
...
92:                                               ; preds = %80, %76
  ...
  br i1 %93, label %468, label %94, !dbg !124
...
123:                                              ; preds = %120
  ...
  br i1 %127, label %128, label %471, !dbg !119
...
177:                                              ; preds = %174
  ...
  br i1 %181, label %182, label %471, !dbg !119
...
231:                                              ; preds = %228
  ...
  br i1 %235, label %242, label %471, !dbg !119
...
291:                                              ; preds = %288
  ...
  br i1 %295, label %296, label %471, !dbg !119
...
345:                                              ; preds = %342
  ...
  br i1 %349, label %356, label %471, !dbg !119
...
374:                                              ; preds = %362, %358
  ...
  br i1 %375, label %465, label %376, !dbg !124
...
405:                                              ; preds = %402
  ...
  br i1 %409, label %410, label %471, !dbg !119
...
428:                                              ; preds = %416, %412
  ...
  br i1 %429, label %462, label %430, !dbg !124
...
462:                                              ; preds = %428
  %463 = load i32, ptr %5, align 4, !dbg !135
  %464 = add nsw i32 %463, 1, !dbg !135
  store i32 %464, ptr %5, align 4, !dbg !135
  br label %412, !dbg !124, !llvm.loop !137

465:                                              ; preds = %374
  %466 = load i32, ptr %5, align 4, !dbg !135
  %467 = add nsw i32 %466, 1, !dbg !135
  store i32 %467, ptr %5, align 4, !dbg !135
  br label %358, !dbg !124, !llvm.loop !137

468:                                              ; preds = %92
  %469 = load i32, ptr %5, align 4, !dbg !135
  %470 = add nsw i32 %469, 1, !dbg !135
  store i32 %470, ptr %5, align 4, !dbg !135
  br label %76, !dbg !124, !llvm.loop !137

471:                                              ; preds = %405, %345, %291, %231, %177, %123, %69, %14
  %472 = load i32, ptr %6, align 4, !dbg !166
  %473 = icmp sge i32 %472, 0, !dbg !168
  br i1 %473, label %474, label %476, !dbg !169

474:                                              ; preds = %471
  %475 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !170
  br label %478, !dbg !170

476:                                              ; preds = %471
  %477 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !171
  br label %478
