...
11:                                               ; preds = %130, %0
  ...
  br i1 %15, label %16, label %133, !dbg !59
...
70:                                               ; preds = %69
  ...
  br i1 %76, label %77, label %133, !dbg !59
...
133:                                              ; preds = %70, %67, %11
  %134 = load i32, ptr %5, align 4, !dbg !120
  %135 = icmp eq i32 %134, 7, !dbg !122
  br i1 %135, label %136, label %138, !dbg !123

136:                                              ; preds = %133
  %137 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !124
  br label %140, !dbg !124

138:                                              ; preds = %133
  %139 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !125
  br label %140

140:                                              ; preds = %138, %136
  %141 = load i32, ptr %1, align 4, !dbg !126
  ret i32 %141, !dbg !126
}
