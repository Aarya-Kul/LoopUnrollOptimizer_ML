...
8894:                                             ; preds = %8893
  ...
  br i1 %8898, label %8899, label %8923, !dbg !108
...
8923:                                             ; preds = %8894, %8885, %8867
  %8924 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %8925, !dbg !137

8925:                                             ; preds = %8923, %8891, %25, %14
  %8926 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %8926, !dbg !138
}
