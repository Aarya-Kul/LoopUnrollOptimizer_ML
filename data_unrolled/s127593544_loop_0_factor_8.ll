...
5503:                                             ; preds = %5499
  ...
  %5513 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !237
  %5514 = fptosi double %5513 to i64, !dbg !238
  %5515 = add nsw i64 %5512, %5514, !dbg !239
  %5516 = sub nsw i64 %5515, 1, !dbg !240
  %5517 = sdiv i64 %5516, 2, !dbg !241
  ...
  %5527 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !248
  %5528 = fptosi double %5527 to i64, !dbg !249
  %5529 = add nsw i64 %5526, %5528, !dbg !250
  %5530 = sub nsw i64 %5529, 1, !dbg !251
  %5531 = sdiv i64 %5530, 2, !dbg !252
...
5617:                                             ; preds = %5607, %5601
  ...
  %5622 = icmp eq i32 %5621, 1, !dbg !340
