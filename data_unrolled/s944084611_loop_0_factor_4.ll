...
62:                                               ; preds = %196, %59
  ...
  br i1 %66, label %67, label %199, !dbg !130
...
77:                                               ; preds = %67
  ...
  br i1 %83, label %84, label %199, !dbg !130
...
94:                                               ; preds = %84
  ...
  br i1 %100, label %101, label %199, !dbg !130
...
111:                                              ; preds = %101
  ...
  br i1 %117, label %118, label %199, !dbg !130
...
128:                                              ; preds = %118
  ...
  br i1 %134, label %135, label %199, !dbg !130
...
145:                                              ; preds = %135
  ...
  br i1 %151, label %152, label %199, !dbg !130
...
162:                                              ; preds = %152
  ...
  br i1 %168, label %169, label %199, !dbg !130
...
179:                                              ; preds = %169
  ...
  br i1 %185, label %186, label %199, !dbg !130
...
199:                                              ; preds = %179, %162, %145, %128, %111, %94, %77, %62
  %200 = load i32, ptr %6, align 4, !dbg !148
  %201 = load i32, ptr %4, align 4, !dbg !149
  %202 = sext i32 %201 to i64, !dbg !150
  %203 = getelementptr inbounds [301 x [301 x i32]], ptr @dp, i64 0, i64 %202, !dbg !150
  %204 = load i32, ptr %5, align 4, !dbg !151
  %205 = sext i32 %204 to i64, !dbg !150
  %206 = getelementptr inbounds [301 x i32], ptr %203, i64 0, i64 %205, !dbg !150
  store i32 %200, ptr %206, align 4, !dbg !152
  store i32 %200, ptr %3, align 4, !dbg !153
  br label %207, !dbg !153

207:                                              ; preds = %199, %30, %16
  %208 = load i32, ptr %3, align 4, !dbg !154
  ret i32 %208, !dbg !154
}
