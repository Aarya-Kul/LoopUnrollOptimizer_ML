...
12811:                                            ; preds = %12829, %12810
  ...
  %12818 = load i32, ptr %10, align 4, !dbg !409
  %12819 = sext i32 %12818 to i64, !dbg !410
  %12820 = getelementptr inbounds i32, ptr %21, i64 %12819, !dbg !410
  %12821 = load i32, ptr %12820, align 4, !dbg !410
  %12822 = add nsw i32 %12817, %12821, !dbg !411
  %12823 = call i32 @llvm.abs.i32(i32 %12822, i1 true), !dbg !412
  %12824 = sub nsw i32 %12813, %12823, !dbg !413
  %12825 = sdiv i32 %12824, 2, !dbg !414
  %12826 = icmp slt i32 %12812, %12825, !dbg !415
  br i1 %12826, label %12827, label %12832, !dbg !416

12827:                                            ; preds = %12811
  %12828 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %12829, !dbg !419

12829:                                            ; preds = %12827
  %12830 = load i32, ptr %13, align 4, !dbg !420
  %12831 = add nsw i32 %12830, 1, !dbg !420
  store i32 %12831, ptr %13, align 4, !dbg !420
  br label %12811, !dbg !421, !llvm.loop !422

12832:                                            ; preds = %12811
  %12833 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %12834, !dbg !425

12834:                                            ; preds = %12832
  %12835 = load i32, ptr %10, align 4, !dbg !426
  %12836 = add nsw i32 %12835, 1, !dbg !426
  store i32 %12836, ptr %10, align 4, !dbg !426
  br label %12760, !dbg !427, !llvm.loop !428

12837:                                            ; preds = %12760
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %12838, !dbg !430

12838:                                            ; preds = %12837, %51
  %12839 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %12839), !dbg !431
  %12840 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %12840, !dbg !431
}
