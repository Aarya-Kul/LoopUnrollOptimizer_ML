...
13:                                               ; preds = %158, %0
  ...
  br i1 %15, label %16, label %161, !dbg !57
...
28:                                               ; preds = %145, %127, %109, %91, %73, %55, %37, %16
...
32:                                               ; preds = %31
  ...
  br i1 %36, label %37, label %161, !dbg !57
...
50:                                               ; preds = %49
  ...
  br i1 %54, label %55, label %161, !dbg !57
...
68:                                               ; preds = %67
  ...
  br i1 %72, label %73, label %161, !dbg !57
...
86:                                               ; preds = %85
  ...
  br i1 %90, label %91, label %161, !dbg !57
...
104:                                              ; preds = %103
  ...
  br i1 %108, label %109, label %161, !dbg !57
...
122:                                              ; preds = %121
  ...
  br i1 %126, label %127, label %161, !dbg !57
...
140:                                              ; preds = %139
  ...
  br i1 %144, label %145, label %161, !dbg !57
...
161:                                              ; preds = %140, %122, %104, %86, %68, %50, %32, %28, %13
  call void @llvm.dbg.declare(metadata ptr %7, metadata !77, metadata !DIExpression()), !dbg !79
  store i32 0, ptr %7, align 4, !dbg !79
  br label %162, !dbg !80

162:                                              ; preds = %185, %161
  %163 = load i32, ptr %7, align 4, !dbg !81
  %164 = load i32, ptr %4, align 4, !dbg !83
  %165 = icmp slt i32 %163, %164, !dbg !84
  br i1 %165, label %166, label %188, !dbg !85

166:                                              ; preds = %162
  %167 = load i32, ptr %5, align 4, !dbg !86
  %168 = load i32, ptr %7, align 4, !dbg !89
  %169 = sub nsw i32 %167, %168, !dbg !90
  %170 = sub nsw i32 %169, 1, !dbg !91
  %171 = sext i32 %170 to i64, !dbg !92
  %172 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %171, !dbg !92
  %173 = load i8, ptr %172, align 1, !dbg !92
  %174 = sext i8 %173 to i32, !dbg !92
  %175 = load i32, ptr %7, align 4, !dbg !93
  %176 = sub nsw i32 6, %175, !dbg !94
  %177 = sext i32 %176 to i64, !dbg !95
  %178 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 %177, !dbg !95
  %179 = load i8, ptr %178, align 1, !dbg !95
  %180 = sext i8 %179 to i32, !dbg !95
  %181 = icmp ne i32 %174, %180, !dbg !96
  br i1 %181, label %182, label %184, !dbg !97

182:                                              ; preds = %166
  %183 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !98
  store i32 0, ptr %1, align 4, !dbg !100
  br label %190, !dbg !100

184:                                              ; preds = %166
  br label %185, !dbg !101

185:                                              ; preds = %184
  %186 = load i32, ptr %7, align 4, !dbg !102
  %187 = add nsw i32 %186, 1, !dbg !102
  store i32 %187, ptr %7, align 4, !dbg !102
  br label %162, !dbg !103, !llvm.loop !104

188:                                              ; preds = %162
  %189 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !106
  store i32 0, ptr %1, align 4, !dbg !107
  br label %190, !dbg !107

190:                                              ; preds = %188, %182
  %191 = load i32, ptr %1, align 4, !dbg !108
  ret i32 %191, !dbg !108
}
