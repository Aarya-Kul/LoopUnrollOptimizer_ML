...
5022:                                             ; preds = %5008
  %5023 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !95
  %5024 = call i32 @strcmp(ptr noundef %5023, ptr noundef @.str) #4, !dbg !97
  %5025 = icmp eq i32 %5024, 0, !dbg !98
  br i1 %5025, label %5026, label %5027, !dbg !99

5026:                                             ; preds = %5022
  store i32 1, ptr %5, align 4, !dbg !100
  br label %5027, !dbg !101

5027:                                             ; preds = %5026, %5022
  %5028 = load i32, ptr %4, align 4, !dbg !102
  %5029 = sub nsw i32 %5028, 1, !dbg !103
  %5030 = sext i32 %5029 to i64, !dbg !104
  %5031 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5030, !dbg !104
  %5032 = load i8, ptr %5031, align 1, !dbg !104
  %5033 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 6, !dbg !105
  store i8 %5032, ptr %5033, align 1, !dbg !106
  %5034 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !107
  %5035 = call i32 @strcmp(ptr noundef %5034, ptr noundef @.str) #4, !dbg !109
  %5036 = icmp eq i32 %5035, 0, !dbg !110
  br i1 %5036, label %5037, label %5038, !dbg !111

5037:                                             ; preds = %5027
  store i32 1, ptr %5, align 4, !dbg !112
  br label %5038, !dbg !113

5038:                                             ; preds = %5037, %5027
  %5039 = load i32, ptr %4, align 4, !dbg !114
  %5040 = sub nsw i32 %5039, 2, !dbg !115
  %5041 = sext i32 %5040 to i64, !dbg !116
  %5042 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5041, !dbg !116
  %5043 = load i8, ptr %5042, align 1, !dbg !116
  %5044 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 5, !dbg !117
  store i8 %5043, ptr %5044, align 1, !dbg !118
  %5045 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !119
  %5046 = call i32 @strcmp(ptr noundef %5045, ptr noundef @.str) #4, !dbg !121
  %5047 = icmp eq i32 %5046, 0, !dbg !122
  br i1 %5047, label %5048, label %5049, !dbg !123

5048:                                             ; preds = %5038
  store i32 1, ptr %5, align 4, !dbg !124
  br label %5049, !dbg !125

5049:                                             ; preds = %5048, %5038
  %5050 = load i32, ptr %4, align 4, !dbg !126
  %5051 = sub nsw i32 %5050, 3, !dbg !127
  %5052 = sext i32 %5051 to i64, !dbg !128
  %5053 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5052, !dbg !128
  %5054 = load i8, ptr %5053, align 1, !dbg !128
  %5055 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 4, !dbg !129
  store i8 %5054, ptr %5055, align 1, !dbg !130
  %5056 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !131
  %5057 = call i32 @strcmp(ptr noundef %5056, ptr noundef @.str) #4, !dbg !133
  %5058 = icmp eq i32 %5057, 0, !dbg !134
  br i1 %5058, label %5059, label %5060, !dbg !135

5059:                                             ; preds = %5049
  store i32 1, ptr %5, align 4, !dbg !136
  br label %5060, !dbg !137

5060:                                             ; preds = %5059, %5049
  %5061 = load i32, ptr %4, align 4, !dbg !138
  %5062 = sub nsw i32 %5061, 4, !dbg !139
  %5063 = sext i32 %5062 to i64, !dbg !140
  %5064 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5063, !dbg !140
  %5065 = load i8, ptr %5064, align 1, !dbg !140
  %5066 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 3, !dbg !141
  store i8 %5065, ptr %5066, align 1, !dbg !142
  %5067 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !143
  %5068 = call i32 @strcmp(ptr noundef %5067, ptr noundef @.str) #4, !dbg !145
  %5069 = icmp eq i32 %5068, 0, !dbg !146
  br i1 %5069, label %5070, label %5071, !dbg !147

5070:                                             ; preds = %5060
  store i32 1, ptr %5, align 4, !dbg !148
  br label %5071, !dbg !149

5071:                                             ; preds = %5070, %5060
  %5072 = load i32, ptr %4, align 4, !dbg !150
  %5073 = sub nsw i32 %5072, 5, !dbg !151
  %5074 = sext i32 %5073 to i64, !dbg !152
  %5075 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5074, !dbg !152
  %5076 = load i8, ptr %5075, align 1, !dbg !152
  %5077 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 2, !dbg !153
  store i8 %5076, ptr %5077, align 1, !dbg !154
  %5078 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !155
  %5079 = call i32 @strcmp(ptr noundef %5078, ptr noundef @.str) #4, !dbg !157
  %5080 = icmp eq i32 %5079, 0, !dbg !158
  br i1 %5080, label %5081, label %5082, !dbg !159

5081:                                             ; preds = %5071
  store i32 1, ptr %5, align 4, !dbg !160
  br label %5082, !dbg !161

5082:                                             ; preds = %5081, %5071
  %5083 = load i32, ptr %4, align 4, !dbg !162
  %5084 = sub nsw i32 %5083, 6, !dbg !163
  %5085 = sext i32 %5084 to i64, !dbg !164
  %5086 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5085, !dbg !164
  %5087 = load i8, ptr %5086, align 1, !dbg !164
  %5088 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 1, !dbg !165
  store i8 %5087, ptr %5088, align 1, !dbg !166
  %5089 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !167
  %5090 = call i32 @strcmp(ptr noundef %5089, ptr noundef @.str) #4, !dbg !169
  %5091 = icmp eq i32 %5090, 0, !dbg !170
  br i1 %5091, label %5092, label %5093, !dbg !171

5092:                                             ; preds = %5082
  store i32 1, ptr %5, align 4, !dbg !172
  br label %5093, !dbg !173

5093:                                             ; preds = %5092, %5082
  %5094 = load i32, ptr %4, align 4, !dbg !174
  %5095 = sub nsw i32 %5094, 7, !dbg !175
  %5096 = sext i32 %5095 to i64, !dbg !176
  %5097 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5096, !dbg !176
  %5098 = load i8, ptr %5097, align 1, !dbg !176
  %5099 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !177
  store i8 %5098, ptr %5099, align 1, !dbg !178
  %5100 = getelementptr inbounds [7 x i8], ptr %3, i64 0, i64 0, !dbg !179
  %5101 = call i32 @strcmp(ptr noundef %5100, ptr noundef @.str) #4, !dbg !181
  %5102 = icmp eq i32 %5101, 0, !dbg !182
  br i1 %5102, label %5103, label %5104, !dbg !183

5103:                                             ; preds = %5093
  store i32 1, ptr %5, align 4, !dbg !184
  br label %5104, !dbg !185

5104:                                             ; preds = %5103, %5093
  %5105 = load i32, ptr %5, align 4, !dbg !186
  %5106 = icmp eq i32 %5105, 1, !dbg !188
  br i1 %5106, label %5107, label %5109, !dbg !189

5107:                                             ; preds = %5104
  %5108 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef @.str.2), !dbg !190
  br label %5111, !dbg !190

5109:                                             ; preds = %5104
  %5110 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef @.str.3), !dbg !191
  br label %5111
