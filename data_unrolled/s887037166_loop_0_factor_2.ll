...
14:                                               ; preds = %128, %0
  ...
  br i1 %17, label %18, label %150, !dbg !63
...
80:                                               ; preds = %79, %46
  ...
  br i1 %85, label %86, label %150, !dbg !63
...
87:                                               ; preds = %147, %86
  ...
  br i1 %90, label %131, label %91, !dbg !73
...
131:                                              ; preds = %87
  %132 = load i32, ptr %5, align 4, !dbg !74
  %133 = sext i32 %132 to i64, !dbg !77
  %134 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %133, !dbg !77
  %135 = load i8, ptr %134, align 1, !dbg !77
  %136 = sext i8 %135 to i32, !dbg !77
  %137 = load i32, ptr %6, align 4, !dbg !78
  %138 = sext i32 %137 to i64, !dbg !79
  %139 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 %138, !dbg !79
  %140 = load i8, ptr %139, align 1, !dbg !79
  %141 = sext i8 %140 to i32, !dbg !79
  %142 = icmp eq i32 %136, %141, !dbg !80
  br i1 %142, label %143, label %146, !dbg !81

143:                                              ; preds = %131
  %144 = load i32, ptr %6, align 4, !dbg !82
  %145 = add nsw i32 %144, 1, !dbg !82
  store i32 %145, ptr %6, align 4, !dbg !82
  br label %146, !dbg !83
...
147:                                              ; preds = %146
  ...
  %149 = add nsw i32 %148, 1, !dbg !85
  store i32 %149, ptr %5, align 4, !dbg !85
  br label %87, !dbg !86, !llvm.loop !87

150:                                              ; preds = %80, %78, %14
  %151 = load i32, ptr %4, align 4, !dbg !134
  %152 = load i32, ptr %8, align 4, !dbg !135
  %153 = icmp eq i32 %151, %152, !dbg !136
  %154 = zext i1 %153 to i64, !dbg !134
  %155 = select i1 %153, ptr @.str.2, ptr @.str.3, !dbg !134
  %156 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %155), !dbg !137
  %157 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %157, !dbg !138
}
