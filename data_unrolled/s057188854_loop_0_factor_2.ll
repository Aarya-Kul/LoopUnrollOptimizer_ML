...
376:                                              ; preds = %196, %195, %189, %164, %139, %114, %89, %64, %39, %9
  ...
  br i1 %379, label %380, label %386, !dbg !259

380:                                              ; preds = %376
  %381 = load i8, ptr %5, align 1, !dbg !260
  %382 = sext i8 %381 to i32, !dbg !260
  %383 = icmp eq i32 %382, 7, !dbg !261
  br i1 %383, label %384, label %386, !dbg !262

384:                                              ; preds = %380
  %385 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !263
  br label %388, !dbg !263

386:                                              ; preds = %380, %376
  %387 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !264
  br label %388
