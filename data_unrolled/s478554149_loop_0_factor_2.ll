...
10:                                               ; preds = %99, %0
  ...
  br i1 %14, label %15, label %102, !dbg !56
...
54:                                               ; preds = %53
  ...
  br i1 %60, label %61, label %102, !dbg !56
...
102:                                              ; preds = %54, %50, %10
  %103 = load i32, ptr %5, align 4, !dbg !100
  %104 = icmp sge i32 %103, 7, !dbg !102
  br i1 %104, label %105, label %107, !dbg !103

105:                                              ; preds = %102
  %106 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !104
  br label %109, !dbg !106

107:                                              ; preds = %102
  %108 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !107
  br label %109
