...
5776:                                             ; preds = %5783, %5769
  br label %5801, !dbg !64
...
5801:                                             ; preds = %5776
  br label %5802, !dbg !76

5802:                                             ; preds = %5816, %5801
  %5803 = load i32, ptr %3, align 4, !dbg !77
  %5804 = sext i32 %5803 to i64, !dbg !80
  %5805 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5804, !dbg !80
  %5806 = load i8, ptr %5805, align 1, !dbg !80
  %5807 = sext i8 %5806 to i32, !dbg !80
  %5808 = icmp eq i32 121, %5807, !dbg !81
  br i1 %5808, label %5809, label %5810, !dbg !82

5809:                                             ; preds = %5802
  br label %5819, !dbg !83

5810:                                             ; preds = %5802
  %5811 = load i32, ptr %3, align 4, !dbg !85
  %5812 = icmp sgt i32 %5811, 95, !dbg !87
  br i1 %5812, label %5813, label %5815, !dbg !88

5813:                                             ; preds = %5810
  %5814 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !89
  br label %5815, !dbg !91

5815:                                             ; preds = %5813, %5810
  br label %5816

5816:                                             ; preds = %5815
  %5817 = load i32, ptr %3, align 4, !dbg !92
  %5818 = add nsw i32 %5817, 1, !dbg !92
  store i32 %5818, ptr %3, align 4, !dbg !92
  br label %5802, !dbg !76, !llvm.loop !93

5819:                                             ; preds = %5809
  br label %5820, !dbg !95

5820:                                             ; preds = %5834, %5819
  %5821 = load i32, ptr %3, align 4, !dbg !96
  %5822 = sext i32 %5821 to i64, !dbg !99
  %5823 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5822, !dbg !99
  %5824 = load i8, ptr %5823, align 1, !dbg !99
  %5825 = sext i8 %5824 to i32, !dbg !99
  %5826 = icmp eq i32 101, %5825, !dbg !100
  br i1 %5826, label %5827, label %5828, !dbg !101

5827:                                             ; preds = %5820
  br label %5837, !dbg !102

5828:                                             ; preds = %5820
  %5829 = load i32, ptr %3, align 4, !dbg !104
  %5830 = icmp sgt i32 %5829, 96, !dbg !106
  br i1 %5830, label %5831, label %5833, !dbg !107

5831:                                             ; preds = %5828
  %5832 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !108
  br label %5833, !dbg !110

5833:                                             ; preds = %5831, %5828
  br label %5834

5834:                                             ; preds = %5833
  %5835 = load i32, ptr %3, align 4, !dbg !111
  %5836 = add nsw i32 %5835, 1, !dbg !111
  store i32 %5836, ptr %3, align 4, !dbg !111
  br label %5820, !dbg !95, !llvm.loop !112

5837:                                             ; preds = %5827
  br label %5838, !dbg !114

5838:                                             ; preds = %5852, %5837
  %5839 = load i32, ptr %3, align 4, !dbg !115
  %5840 = sext i32 %5839 to i64, !dbg !118
  %5841 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5840, !dbg !118
  %5842 = load i8, ptr %5841, align 1, !dbg !118
  %5843 = sext i8 %5842 to i32, !dbg !118
  %5844 = icmp eq i32 110, %5843, !dbg !119
  br i1 %5844, label %5845, label %5846, !dbg !120

5845:                                             ; preds = %5838
  br label %5855, !dbg !121

5846:                                             ; preds = %5838
  %5847 = load i32, ptr %3, align 4, !dbg !123
  %5848 = icmp sgt i32 %5847, 97, !dbg !125
  br i1 %5848, label %5849, label %5851, !dbg !126

5849:                                             ; preds = %5846
  %5850 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !127
  br label %5851, !dbg !129

5851:                                             ; preds = %5849, %5846
  br label %5852

5852:                                             ; preds = %5851
  %5853 = load i32, ptr %3, align 4, !dbg !130
  %5854 = add nsw i32 %5853, 1, !dbg !130
  store i32 %5854, ptr %3, align 4, !dbg !130
  br label %5838, !dbg !114, !llvm.loop !131

5855:                                             ; preds = %5845
  br label %5856, !dbg !133

5856:                                             ; preds = %5870, %5855
  %5857 = load i32, ptr %3, align 4, !dbg !134
  %5858 = sext i32 %5857 to i64, !dbg !137
  %5859 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5858, !dbg !137
  %5860 = load i8, ptr %5859, align 1, !dbg !137
  %5861 = sext i8 %5860 to i32, !dbg !137
  %5862 = icmp eq i32 99, %5861, !dbg !138
  br i1 %5862, label %5863, label %5864, !dbg !139

5863:                                             ; preds = %5856
  br label %5873, !dbg !140

5864:                                             ; preds = %5856
  %5865 = load i32, ptr %3, align 4, !dbg !142
  %5866 = icmp sgt i32 %5865, 99, !dbg !144
  br i1 %5866, label %5867, label %5869, !dbg !145

5867:                                             ; preds = %5864
  %5868 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !146
  br label %5869, !dbg !148

5869:                                             ; preds = %5867, %5864
  br label %5870

5870:                                             ; preds = %5869
  %5871 = load i32, ptr %3, align 4, !dbg !149
  %5872 = add nsw i32 %5871, 1, !dbg !149
  store i32 %5872, ptr %3, align 4, !dbg !149
  br label %5856, !dbg !133, !llvm.loop !150

5873:                                             ; preds = %5863
  br label %5874, !dbg !152

5874:                                             ; preds = %5888, %5873
  %5875 = load i32, ptr %3, align 4, !dbg !153
  %5876 = sext i32 %5875 to i64, !dbg !156
  %5877 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 %5876, !dbg !156
  %5878 = load i8, ptr %5877, align 1, !dbg !156
  %5879 = sext i8 %5878 to i32, !dbg !156
  %5880 = icmp eq i32 101, %5879, !dbg !157
  br i1 %5880, label %5881, label %5882, !dbg !158

5881:                                             ; preds = %5874
  br label %5891, !dbg !159

5882:                                             ; preds = %5874
  %5883 = load i32, ptr %3, align 4, !dbg !161
  %5884 = icmp sgt i32 %5883, 100, !dbg !163
  br i1 %5884, label %5885, label %5887, !dbg !164

5885:                                             ; preds = %5882
  %5886 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !165
  br label %5887, !dbg !167

5887:                                             ; preds = %5885, %5882
  br label %5888

5888:                                             ; preds = %5887
  %5889 = load i32, ptr %3, align 4, !dbg !168
  %5890 = add nsw i32 %5889, 1, !dbg !168
  store i32 %5890, ptr %3, align 4, !dbg !168
  br label %5874, !dbg !152, !llvm.loop !169

5891:                                             ; preds = %5881
  %5892 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !171
  ret i32 0, !dbg !172
}
