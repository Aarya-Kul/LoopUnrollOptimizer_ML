...
155:                                              ; preds = %151
  ...
  %165 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !237
  %166 = fptosi double %165 to i64, !dbg !238
  %167 = add nsw i64 %164, %166, !dbg !239
  %168 = sub nsw i64 %167, 1, !dbg !240
  %169 = sdiv i64 %168, 2, !dbg !241
  ...
  %179 = call double @pow(double noundef 2.000000e+00, double noundef 3.100000e+01) #4, !dbg !248
  %180 = fptosi double %179 to i64, !dbg !249
  %181 = add nsw i64 %178, %180, !dbg !250
  %182 = sub nsw i64 %181, 1, !dbg !251
  %183 = sdiv i64 %182, 2, !dbg !252
