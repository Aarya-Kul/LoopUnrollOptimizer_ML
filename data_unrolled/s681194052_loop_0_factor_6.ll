...
884:                                              ; preds = %903, %883
  %885 = load i64, ptr %12, align 8, !dbg !93
  store i64 %885, ptr %13, align 8, !dbg !95
  %886 = load i64, ptr %12, align 8, !dbg !96
  %887 = and i64 %886, 1, !dbg !98
  %888 = icmp ne i64 %887, 0, !dbg !98
  br i1 %888, label %889, label %893, !dbg !99

889:                                              ; preds = %884
  %890 = load i64, ptr %12, align 8, !dbg !100
  %891 = sub nsw i64 %890, 1, !dbg !102
  %892 = ashr i64 %891, 1, !dbg !103
  store i64 %892, ptr %12, align 8, !dbg !104
  br label %900, !dbg !105

893:                                              ; preds = %884
  %894 = load i64, ptr %12, align 8, !dbg !106
  %895 = ashr i64 %894, 1, !dbg !108
  %896 = load i64, ptr %6, align 8, !dbg !109
  %897 = sub nsw i64 %896, 1, !dbg !110
  %898 = shl i64 1, %897, !dbg !111
  %899 = add nsw i64 %895, %898, !dbg !112
  store i64 %899, ptr %12, align 8, !dbg !113
  br label %900

900:                                              ; preds = %893, %889
  %901 = load i64, ptr %9, align 8, !dbg !114
  %902 = add nsw i64 %901, 1, !dbg !114
  store i64 %902, ptr %9, align 8, !dbg !114
  br label %903, !dbg !115

903:                                              ; preds = %900
  %904 = load i64, ptr %12, align 8, !dbg !116
  %905 = icmp ne i64 %904, 0, !dbg !117
  br i1 %905, label %884, label %906, !dbg !115, !llvm.loop !118

906:                                              ; preds = %903
  %907 = load i64, ptr %9, align 8, !dbg !120
  store i64 %907, ptr %11, align 8, !dbg !121
  store i64 0, ptr %14, align 8, !dbg !122
  br label %908, !dbg !124

908:                                              ; preds = %954, %906
  %909 = load i64, ptr %14, align 8, !dbg !125
  %910 = load i64, ptr %7, align 8, !dbg !127
  %911 = icmp sle i64 %909, %910, !dbg !128
  br i1 %911, label %912, label %957, !dbg !129

912:                                              ; preds = %908
  store i64 0, ptr %9, align 8, !dbg !130
  %913 = load i64, ptr %14, align 8, !dbg !132
  store i64 %913, ptr %12, align 8, !dbg !133
  br label %914, !dbg !134

914:                                              ; preds = %941, %912
  %915 = load i64, ptr %12, align 8, !dbg !135
  store i64 %915, ptr %13, align 8, !dbg !137
  %916 = load i64, ptr %12, align 8, !dbg !138
  %917 = and i64 %916, 1, !dbg !140
  %918 = icmp ne i64 %917, 0, !dbg !140
  br i1 %918, label %919, label %923, !dbg !141

919:                                              ; preds = %914
  %920 = load i64, ptr %12, align 8, !dbg !142
  %921 = sub nsw i64 %920, 1, !dbg !144
  %922 = ashr i64 %921, 1, !dbg !145
  store i64 %922, ptr %12, align 8, !dbg !146
  br label %930, !dbg !147

923:                                              ; preds = %914
  %924 = load i64, ptr %12, align 8, !dbg !148
  %925 = ashr i64 %924, 1, !dbg !150
  %926 = load i64, ptr %6, align 8, !dbg !151
  %927 = sub nsw i64 %926, 1, !dbg !152
  %928 = shl i64 1, %927, !dbg !153
  %929 = add nsw i64 %925, %928, !dbg !154
  store i64 %929, ptr %12, align 8, !dbg !155
  br label %930

930:                                              ; preds = %923, %919
  %931 = load i64, ptr %9, align 8, !dbg !156
  %932 = add nsw i64 %931, 1, !dbg !156
  store i64 %932, ptr %9, align 8, !dbg !156
  br label %933, !dbg !157

933:                                              ; preds = %930
  %934 = load i64, ptr %12, align 8, !dbg !158
  %935 = load i64, ptr %14, align 8, !dbg !159
  %936 = icmp ne i64 %934, %935, !dbg !160
  br i1 %936, label %937, label %941, !dbg !161

937:                                              ; preds = %933
  %938 = load i64, ptr %13, align 8, !dbg !162
  %939 = load i64, ptr %12, align 8, !dbg !163
  %940 = icmp ne i64 %938, %939, !dbg !164
  br label %941

941:                                              ; preds = %937, %933
  %942 = phi i1 [ false, %933 ], [ %940, %937 ], !dbg !165
  br i1 %942, label %914, label %943, !dbg !157, !llvm.loop !166

943:                                              ; preds = %941
  %944 = load i64, ptr %13, align 8, !dbg !168
  %945 = load i64, ptr %12, align 8, !dbg !170
  %946 = icmp ne i64 %944, %945, !dbg !171
  br i1 %946, label %947, label %953, !dbg !172

947:                                              ; preds = %943
  %948 = load i64, ptr %11, align 8, !dbg !173
  %949 = load i64, ptr %9, align 8, !dbg !176
  %950 = icmp ne i64 %948, %949, !dbg !177
  br i1 %950, label %951, label %952, !dbg !178

951:                                              ; preds = %947
  br label %957, !dbg !179

952:                                              ; preds = %947
  br label %953, !dbg !180

953:                                              ; preds = %952, %943
  br label %954, !dbg !181

954:                                              ; preds = %953
  %955 = load i64, ptr %14, align 8, !dbg !182
  %956 = add nsw i64 %955, 1, !dbg !182
  store i64 %956, ptr %14, align 8, !dbg !182
  br label %908, !dbg !183, !llvm.loop !184

957:                                              ; preds = %951, %908
  %958 = load i64, ptr %11, align 8, !dbg !186
  %959 = load i64, ptr %14, align 8, !dbg !187
  %960 = mul nsw i64 %958, %959, !dbg !188
  %961 = load i64, ptr %9, align 8, !dbg !189
  %962 = add nsw i64 %960, %961, !dbg !190
  %963 = load i64, ptr %7, align 8, !dbg !191
  %964 = load i64, ptr %14, align 8, !dbg !192
  %965 = add nsw i64 %964, 1, !dbg !193
  %966 = sdiv i64 %963, %965, !dbg !194
  %967 = mul nsw i64 %962, %966, !dbg !195
  %968 = load i64, ptr %11, align 8, !dbg !196
  %969 = load i64, ptr %7, align 8, !dbg !197
  %970 = add nsw i64 %969, 1, !dbg !198
  %971 = load i64, ptr %7, align 8, !dbg !199
  %972 = load i64, ptr %14, align 8, !dbg !200
  %973 = add nsw i64 %972, 1, !dbg !201
  %974 = sdiv i64 %971, %973, !dbg !202
  %975 = load i64, ptr %14, align 8, !dbg !203
  %976 = add nsw i64 %975, 1, !dbg !204
  %977 = mul nsw i64 %974, %976, !dbg !205
  %978 = sub nsw i64 %970, %977, !dbg !206
  %979 = mul nsw i64 %968, %978, !dbg !207
  %980 = add nsw i64 %967, %979, !dbg !208
  store i64 %980, ptr %10, align 8, !dbg !209
  %981 = load i64, ptr %10, align 8, !dbg !210
  %982 = srem i64 %981, 998244353, !dbg !211
  %983 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %982), !dbg !212
  ret i32 0, !dbg !213
}
