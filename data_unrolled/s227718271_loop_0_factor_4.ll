...
257:                                              ; preds = %224, %194, %164, %134, %104, %74, %44, %41, %15
  %258 = load i8, ptr %7, align 1, !dbg !127
  %259 = trunc i8 %258 to i1, !dbg !127
  %260 = zext i1 %259 to i64, !dbg !127
  %261 = select i1 %259, ptr @.str.1, ptr @.str.2, !dbg !127
  %262 = call i32 @puts(ptr noundef %261), !dbg !128
  ret i32 0, !dbg !129
}
