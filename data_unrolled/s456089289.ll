...
343:                                              ; preds = %281, %274
  ...
  br i1 %349, label %350, label %412, !dbg !332
...
353:                                              ; preds = %408, %350
  ...
  br i1 %357, label %358, label %411, !dbg !344
...
417:                                              ; preds = %416, %66
  %418 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !385
  store i32 0, ptr %1, align 4, !dbg !386
  br label %419, !dbg !386

419:                                              ; preds = %417, %405, %336, %267, %198, %129, %60, %16
  %420 = load i32, ptr %1, align 4, !dbg !387
  ret i32 %420, !dbg !387
}
