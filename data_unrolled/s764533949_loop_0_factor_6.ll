...
1788:                                             ; preds = %1748, %1711, %1674, %1637, %1600, %1563, %1526, %1489, %1452, %1415, %1378, %1341, %1304, %1267, %1230, %1193, %1156, %1119, %1082, %1045, %1008, %971, %934, %897, %860, %823, %786, %749, %712, %675, %638, %601, %564, %527, %490, %453, %416, %379, %342, %305, %268, %231, %194, %157, %120, %83, %46, %43, %10
  ...
  br i1 %1792, label %1793, label %1798, !dbg !97

1793:                                             ; preds = %1788
  %1794 = load i32, ptr %3, align 4, !dbg !98
  %1795 = icmp ne i32 %1794, 2, !dbg !99
  br i1 %1795, label %1796, label %1798, !dbg !100

1796:                                             ; preds = %1793
  %1797 = call i32 @puts(ptr noundef @.str.1), !dbg !101
  br label %1800, !dbg !103

1798:                                             ; preds = %1793, %1788
  %1799 = call i32 @puts(ptr noundef @.str.2), !dbg !104
  br label %1800
