...
5587:                                             ; preds = %5583
  ...
  %5597 = sub nsw i64 %5596, 1, !dbg !237
  %5598 = sdiv i64 %5597, 2, !dbg !238
  %5599 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !239
  %5600 = fptosi double %5599 to i64, !dbg !240
  %5601 = add nsw i64 %5598, %5600, !dbg !241
  ...
  %5611 = sub nsw i64 %5610, 1, !dbg !248
  %5612 = sdiv i64 %5611, 2, !dbg !249
  %5613 = call double @pow(double noundef 2.000000e+00, double noundef 3.000000e+01) #4, !dbg !250
  %5614 = fptosi double %5613 to i64, !dbg !251
  %5615 = add nsw i64 %5612, %5614, !dbg !252
...
5701:                                             ; preds = %5691, %5685
  ...
  %5706 = icmp eq i32 %5705, 0, !dbg !340
