...
10:                                               ; preds = %248, %0
  ...
  br i1 %14, label %15, label %251, !dbg !131
...
38:                                               ; preds = %37
  ...
  br i1 %44, label %45, label %251, !dbg !131
...
68:                                               ; preds = %67
  ...
  br i1 %74, label %75, label %251, !dbg !131
...
98:                                               ; preds = %97
  ...
  br i1 %104, label %105, label %251, !dbg !131
...
128:                                              ; preds = %127
  ...
  br i1 %134, label %135, label %251, !dbg !131
...
158:                                              ; preds = %157
  ...
  br i1 %164, label %165, label %251, !dbg !131
...
188:                                              ; preds = %187
  ...
  br i1 %194, label %195, label %251, !dbg !131
...
218:                                              ; preds = %217
  ...
  br i1 %224, label %225, label %251, !dbg !131
...
251:                                              ; preds = %218, %188, %158, %128, %98, %68, %38, %10
  %252 = load i32, ptr %2, align 4, !dbg !159
  %253 = icmp eq i32 %252, 7, !dbg !161
  br i1 %253, label %254, label %259, !dbg !162

254:                                              ; preds = %251
  %255 = load i32, ptr %4, align 4, !dbg !163
  %256 = icmp sle i32 %255, 1, !dbg !164
  br i1 %256, label %257, label %259, !dbg !165

257:                                              ; preds = %254
  %258 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !166
  br label %261, !dbg !168

259:                                              ; preds = %254, %251
  %260 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !169
  br label %261
