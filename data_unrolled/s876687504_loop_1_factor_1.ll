...
7329:                                             ; preds = %7313, %7310
  ...
  br i1 %7330, label %7331, label %7334, !dbg !62
...
7334:                                             ; preds = %7329
  %7335 = load i32, ptr %2, align 4, !dbg !77
  %7336 = load i32, ptr %3, align 4, !dbg !79
  %7337 = add nsw i32 %7335, %7336, !dbg !80
  %7338 = icmp sge i32 %7337, 7, !dbg !81
  br i1 %7338, label %7339, label %7341, !dbg !82

7339:                                             ; preds = %7334
  %7340 = call i32 @puts(ptr noundef @.str.1), !dbg !83
  br label %7343, !dbg !83

7341:                                             ; preds = %7334
  %7342 = call i32 @puts(ptr noundef @.str.2), !dbg !84
  br label %7343

7343:                                             ; preds = %7341, %7339
  %7344 = load i32, ptr %1, align 4, !dbg !85
  ret i32 %7344, !dbg !85
}
