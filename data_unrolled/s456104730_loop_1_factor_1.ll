...
177:                                              ; preds = %187, %176
  %178 = load i32, ptr %4, align 4, !dbg !257
  %179 = load i32, ptr %3, align 4, !dbg !259
  %180 = icmp slt i32 %178, %179, !dbg !260
  br i1 %180, label %181, label %190, !dbg !261

181:                                              ; preds = %177
  %182 = load i32, ptr %4, align 4, !dbg !262
  %183 = sext i32 %182 to i64, !dbg !264
  %184 = getelementptr inbounds [50 x i32], ptr %2, i64 0, i64 %183, !dbg !264
  %185 = load i32, ptr %184, align 4, !dbg !264
  %186 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %185), !dbg !265
  br label %187, !dbg !266

187:                                              ; preds = %181
  %188 = load i32, ptr %4, align 4, !dbg !267
  %189 = add nsw i32 %188, 1, !dbg !267
  store i32 %189, ptr %4, align 4, !dbg !267
  br label %177, !dbg !268, !llvm.loop !269
