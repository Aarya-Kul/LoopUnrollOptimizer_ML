...
70:                                               ; preds = %.loopexit1, %34
  %71 = load i8, ptr %4, align 1, !dbg !108
  %72 = trunc i8 %71 to i1, !dbg !108
  %73 = zext i1 %72 to i32, !dbg !108
  %74 = icmp eq i32 %73, 1, !dbg !110
  br i1 %74, label %75, label %77, !dbg !111

75:                                               ; preds = %70
  %76 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !112
  br label %79, !dbg !112

77:                                               ; preds = %70
  %78 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !113
  br label %79

79:                                               ; preds = %77, %75
  %80 = load i32, ptr %1, align 4, !dbg !114
  ret i32 %80, !dbg !114
}
