...
8104:                                             ; preds = %8099, %8077
  %8105 = load i32, ptr %4, align 4, !dbg !103
  %8106 = load i32, ptr %5, align 4, !dbg !105
  %8107 = add nsw i32 %8105, %8106, !dbg !106
  %8108 = icmp sge i32 %8107, 7, !dbg !107
  br i1 %8108, label %8109, label %8111, !dbg !108

8109:                                             ; preds = %8104
  %8110 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !109
  br label %8113, !dbg !109

8111:                                             ; preds = %8104
  %8112 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !110
  br label %8113

8113:                                             ; preds = %8111, %8109
  ret i32 0, !dbg !111
}
