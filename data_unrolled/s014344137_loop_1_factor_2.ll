...
12397:                                            ; preds = %12417, %12396
  ...
  %12404 = call i32 @llvm.abs.i32(i32 %12403, i1 true), !dbg !409
  %12405 = load i32, ptr %10, align 4, !dbg !410
  %12406 = sext i32 %12405 to i64, !dbg !411
  %12407 = getelementptr inbounds i32, ptr %21, i64 %12406, !dbg !411
  %12408 = load i32, ptr %12407, align 4, !dbg !411
  %12409 = call i32 @llvm.abs.i32(i32 %12408, i1 true), !dbg !412
  %12410 = add nsw i32 %12404, %12409, !dbg !413
  %12411 = call i32 @llvm.abs.i32(i32 %12410, i1 true), !dbg !414
  %12412 = sub nsw i32 %12399, %12411, !dbg !415
  %12413 = sdiv i32 %12412, 2, !dbg !416
  %12414 = icmp slt i32 %12398, %12413, !dbg !417
  br i1 %12414, label %12415, label %12420, !dbg !418

12415:                                            ; preds = %12397
  %12416 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !419
  br label %12417, !dbg !421

12417:                                            ; preds = %12415
  %12418 = load i32, ptr %13, align 4, !dbg !422
  %12419 = add nsw i32 %12418, 1, !dbg !422
  store i32 %12419, ptr %13, align 4, !dbg !422
  br label %12397, !dbg !423, !llvm.loop !424

12420:                                            ; preds = %12397
  %12421 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !426
  br label %12422, !dbg !427

12422:                                            ; preds = %12420
  %12423 = load i32, ptr %10, align 4, !dbg !428
  %12424 = add nsw i32 %12423, 1, !dbg !428
  store i32 %12424, ptr %10, align 4, !dbg !428
  br label %12346, !dbg !429, !llvm.loop !430

12425:                                            ; preds = %12346
  store i32 0, ptr %1, align 4, !dbg !432
  store i32 1, ptr %8, align 4
  br label %12426, !dbg !432

12426:                                            ; preds = %12425, %51
  %12427 = load ptr, ptr %4, align 8, !dbg !433
  call void @llvm.stackrestore.p0(ptr %12427), !dbg !433
  %12428 = load i32, ptr %1, align 4, !dbg !433
  ret i32 %12428, !dbg !433
}
