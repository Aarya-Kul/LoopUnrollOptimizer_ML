...
5434:                                             ; preds = %5409
  ...
  br label %5435, !dbg !363

5435:                                             ; preds = %5539, %5434
  %5436 = load i32, ptr %10, align 4, !dbg !364
  %5437 = load i32, ptr %8, align 4, !dbg !366
  %5438 = icmp slt i32 %5436, %5437, !dbg !367
  br i1 %5438, label %5439, label %5542, !dbg !368

5439:                                             ; preds = %5435
  %5440 = load i32, ptr %10, align 4, !dbg !369
  %5441 = sext i32 %5440 to i64, !dbg !371
  %5442 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5441, !dbg !371
  %5443 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !372
  %5444 = load double, ptr %5443, align 8, !dbg !372
  %5445 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !372
  %5446 = load double, ptr %5445, align 8, !dbg !372
  %5447 = getelementptr inbounds { double, double }, ptr %5442, i32 0, i32 0, !dbg !372
  %5448 = load double, ptr %5447, align 16, !dbg !372
  %5449 = getelementptr inbounds { double, double }, ptr %5442, i32 0, i32 1, !dbg !372
  %5450 = load double, ptr %5449, align 8, !dbg !372
  %5451 = call { double, double } @make_vec(double %5444, double %5446, double %5448, double %5450), !dbg !372
  %5452 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !372
  %5453 = extractvalue { double, double } %5451, 0, !dbg !372
  store double %5453, ptr %5452, align 8, !dbg !372
  %5454 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !372
  %5455 = extractvalue { double, double } %5451, 1, !dbg !372
  store double %5455, ptr %5454, align 8, !dbg !372
  %5456 = load i32, ptr %10, align 4, !dbg !373
  %5457 = add nsw i32 %5456, 1, !dbg !374
  %5458 = sext i32 %5457 to i64, !dbg !375
  %5459 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5458, !dbg !375
  %5460 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !376
  %5461 = load double, ptr %5460, align 8, !dbg !376
  %5462 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !376
  %5463 = load double, ptr %5462, align 8, !dbg !376
  %5464 = getelementptr inbounds { double, double }, ptr %5459, i32 0, i32 0, !dbg !376
  %5465 = load double, ptr %5464, align 16, !dbg !376
  %5466 = getelementptr inbounds { double, double }, ptr %5459, i32 0, i32 1, !dbg !376
  %5467 = load double, ptr %5466, align 8, !dbg !376
  %5468 = call { double, double } @make_vec(double %5461, double %5463, double %5465, double %5467), !dbg !376
  %5469 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !376
  %5470 = extractvalue { double, double } %5468, 0, !dbg !376
  store double %5470, ptr %5469, align 8, !dbg !376
  %5471 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !376
  %5472 = extractvalue { double, double } %5468, 1, !dbg !376
  store double %5472, ptr %5471, align 8, !dbg !376
  %5473 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 0, !dbg !377
  %5474 = load double, ptr %5473, align 8, !dbg !377
  %5475 = getelementptr inbounds { double, double }, ptr %16, i32 0, i32 1, !dbg !377
  %5476 = load double, ptr %5475, align 8, !dbg !377
  %5477 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 0, !dbg !377
  %5478 = load double, ptr %5477, align 8, !dbg !377
  %5479 = getelementptr inbounds { double, double }, ptr %17, i32 0, i32 1, !dbg !377
  %5480 = load double, ptr %5479, align 8, !dbg !377
  %5481 = call double @cross(double %5474, double %5476, double %5478, double %5480), !dbg !377
  %5482 = load i32, ptr %10, align 4, !dbg !378
  %5483 = sext i32 %5482 to i64, !dbg !379
  %5484 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5483, !dbg !379
  %5485 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !380
  %5486 = load double, ptr %5485, align 8, !dbg !380
  %5487 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !380
  %5488 = load double, ptr %5487, align 8, !dbg !380
  %5489 = getelementptr inbounds { double, double }, ptr %5484, i32 0, i32 0, !dbg !380
  %5490 = load double, ptr %5489, align 16, !dbg !380
  %5491 = getelementptr inbounds { double, double }, ptr %5484, i32 0, i32 1, !dbg !380
  %5492 = load double, ptr %5491, align 8, !dbg !380
  %5493 = call { double, double } @make_vec(double %5486, double %5488, double %5490, double %5492), !dbg !380
  %5494 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !380
  %5495 = extractvalue { double, double } %5493, 0, !dbg !380
  store double %5495, ptr %5494, align 8, !dbg !380
  %5496 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !380
  %5497 = extractvalue { double, double } %5493, 1, !dbg !380
  store double %5497, ptr %5496, align 8, !dbg !380
  %5498 = load i32, ptr %10, align 4, !dbg !381
  %5499 = add nsw i32 %5498, 1, !dbg !382
  %5500 = sext i32 %5499 to i64, !dbg !383
  %5501 = getelementptr inbounds %struct.POINT, ptr %26, i64 %5500, !dbg !383
  %5502 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 0, !dbg !384
  %5503 = load double, ptr %5502, align 8, !dbg !384
  %5504 = getelementptr inbounds { double, double }, ptr %6, i32 0, i32 1, !dbg !384
  %5505 = load double, ptr %5504, align 8, !dbg !384
  %5506 = getelementptr inbounds { double, double }, ptr %5501, i32 0, i32 0, !dbg !384
  %5507 = load double, ptr %5506, align 16, !dbg !384
  %5508 = getelementptr inbounds { double, double }, ptr %5501, i32 0, i32 1, !dbg !384
  %5509 = load double, ptr %5508, align 8, !dbg !384
  %5510 = call { double, double } @make_vec(double %5503, double %5505, double %5507, double %5509), !dbg !384
  %5511 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !384
  %5512 = extractvalue { double, double } %5510, 0, !dbg !384
  store double %5512, ptr %5511, align 8, !dbg !384
  %5513 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !384
  %5514 = extractvalue { double, double } %5510, 1, !dbg !384
  store double %5514, ptr %5513, align 8, !dbg !384
  %5515 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 0, !dbg !385
  %5516 = load double, ptr %5515, align 8, !dbg !385
  %5517 = getelementptr inbounds { double, double }, ptr %18, i32 0, i32 1, !dbg !385
  %5518 = load double, ptr %5517, align 8, !dbg !385
  %5519 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 0, !dbg !385
  %5520 = load double, ptr %5519, align 8, !dbg !385
  %5521 = getelementptr inbounds { double, double }, ptr %19, i32 0, i32 1, !dbg !385
  %5522 = load double, ptr %5521, align 8, !dbg !385
  %5523 = call double @dot(double %5516, double %5518, double %5520, double %5522), !dbg !385
  %5524 = call double @atan2(double noundef %5481, double noundef %5523) #6, !dbg !386
  store double %5524, ptr %13, align 8, !dbg !387
  %5525 = load double, ptr %13, align 8, !dbg !388
  %5526 = load double, ptr %14, align 8, !dbg !389
  %5527 = fadd double %5526, %5525, !dbg !389
  store double %5527, ptr %14, align 8, !dbg !389
  %5528 = load double, ptr %13, align 8, !dbg !390
  %5529 = fsub double %5528, 0x400921FB54442D18, !dbg !392
  %5530 = call double @llvm.fabs.f64(double %5529), !dbg !393
  %5531 = fcmp ole double %5530, 0x3EB0C6F7A0B5ED8D, !dbg !394
  br i1 %5531, label %5537, label %5532, !dbg !395

5532:                                             ; preds = %5439
  %5533 = load double, ptr %13, align 8, !dbg !396
  %5534 = fadd double %5533, 0x400921FB54442D18, !dbg !397
  %5535 = call double @llvm.fabs.f64(double %5534), !dbg !398
  %5536 = fcmp ole double %5535, 0x3EB0C6F7A0B5ED8D, !dbg !399
  br i1 %5536, label %5537, label %5538, !dbg !400

5537:                                             ; preds = %5532, %5439
  store i32 1, ptr %9, align 4, !dbg !401
  store i32 1, ptr %5, align 4, !dbg !402
  store i32 1, ptr %15, align 4
  br label %5550, !dbg !402

5538:                                             ; preds = %5532
  br label %5539, !dbg !403

5539:                                             ; preds = %5538
  %5540 = load i32, ptr %10, align 4, !dbg !404
  %5541 = add nsw i32 %5540, 1, !dbg !404
  store i32 %5541, ptr %10, align 4, !dbg !404
  br label %5435, !dbg !405, !llvm.loop !406

5542:                                             ; preds = %5435
  %5543 = load double, ptr %14, align 8, !dbg !408
  %5544 = fsub double %5543, 0x401921FB54442D18, !dbg !410
  %5545 = call double @llvm.fabs.f64(double %5544), !dbg !411
  %5546 = fcmp ole double %5545, 0x3EB0C6F7A0B5ED8D, !dbg !412
  br i1 %5546, label %5547, label %5548, !dbg !413

5547:                                             ; preds = %5542
  store i32 2, ptr %9, align 4, !dbg !414
  store i32 2, ptr %5, align 4, !dbg !416
  store i32 1, ptr %15, align 4
  br label %5550, !dbg !416

5548:                                             ; preds = %5542
  %5549 = load i32, ptr %9, align 4, !dbg !417
  store i32 %5549, ptr %5, align 4, !dbg !418
  store i32 1, ptr %15, align 4
  br label %5550, !dbg !418

5550:                                             ; preds = %5548, %5547, %5537, %5429
  %5551 = load ptr, ptr %11, align 8, !dbg !419
  call void @llvm.stackrestore.p0(ptr %5551), !dbg !419
  %5552 = load i32, ptr %5, align 4, !dbg !419
  ret i32 %5552, !dbg !419
}
