...
4264:                                             ; preds = %4253
  ...
  br i1 %4269, label %4270, label %4284, !dbg !92
...
4284:                                             ; preds = %4264, %4249
  call void @llvm.dbg.declare(metadata ptr %16, metadata !103, metadata !DIExpression()), !dbg !105
  store i32 0, ptr %16, align 4, !dbg !105
  br label %4285, !dbg !106

4285:                                             ; preds = %4308, %4284
  %4286 = load i32, ptr %16, align 4, !dbg !107
  %4287 = load i32, ptr %9, align 4, !dbg !109
  %4288 = icmp sle i32 %4286, %4287, !dbg !110
  br i1 %4288, label %4289, label %4311, !dbg !111

4289:                                             ; preds = %4285
  %4290 = load ptr, ptr %12, align 8, !dbg !112
  %4291 = load i32, ptr %4290, align 4, !dbg !115
  %4292 = load ptr, ptr %13, align 8, !dbg !116
  %4293 = load i32, ptr %16, align 4, !dbg !117
  %4294 = sext i32 %4293 to i64, !dbg !116
  %4295 = getelementptr inbounds i32, ptr %4292, i64 %4294, !dbg !116
  %4296 = load i32, ptr %4295, align 4, !dbg !116
  %4297 = icmp slt i32 %4291, %4296, !dbg !118
  br i1 %4297, label %4298, label %4307, !dbg !119

4298:                                             ; preds = %4289
  %4299 = load ptr, ptr %13, align 8, !dbg !120
  %4300 = load i32, ptr %16, align 4, !dbg !122
  %4301 = sext i32 %4300 to i64, !dbg !120
  %4302 = getelementptr inbounds i32, ptr %4299, i64 %4301, !dbg !120
  %4303 = load i32, ptr %4302, align 4, !dbg !120
  %4304 = load ptr, ptr %12, align 8, !dbg !123
  store i32 %4303, ptr %4304, align 4, !dbg !124
  %4305 = load i32, ptr %16, align 4, !dbg !125
  %4306 = load ptr, ptr %11, align 8, !dbg !126
  store i32 %4305, ptr %4306, align 4, !dbg !127
  br label %4307, !dbg !128

4307:                                             ; preds = %4298, %4289
  br label %4308, !dbg !129

4308:                                             ; preds = %4307
  %4309 = load i32, ptr %16, align 4, !dbg !130
  %4310 = add nsw i32 %4309, 1, !dbg !130
  store i32 %4310, ptr %16, align 4, !dbg !130
  br label %4285, !dbg !131, !llvm.loop !132

4311:                                             ; preds = %4285
  %4312 = load ptr, ptr %13, align 8, !dbg !134
  call void @free(ptr noundef %4312) #6, !dbg !135
  ret void, !dbg !136
}
