...
8:                                                ; preds = %243, %1
  ...
  br i1 %10, label %11, label %246, !dbg !118
...
40:                                               ; preds = %39
  ...
  br i1 %44, label %45, label %246, !dbg !118
...
69:                                               ; preds = %68
  ...
  br i1 %73, label %74, label %246, !dbg !118
...
98:                                               ; preds = %97
  ...
  br i1 %102, label %103, label %246, !dbg !118
...
127:                                              ; preds = %126
  ...
  br i1 %131, label %132, label %246, !dbg !118
...
156:                                              ; preds = %155
  ...
  br i1 %160, label %161, label %246, !dbg !118
...
185:                                              ; preds = %184
  ...
  br i1 %189, label %190, label %246, !dbg !118
...
214:                                              ; preds = %213
  ...
  br i1 %218, label %219, label %246, !dbg !118
...
246:                                              ; preds = %214, %185, %156, %127, %98, %69, %40, %32, %8
  %247 = load i32, ptr %7, align 4, !dbg !161
  %248 = icmp eq i32 %247, 6, !dbg !163
  br i1 %248, label %249, label %251, !dbg !164

249:                                              ; preds = %246
  %250 = call i32 (ptr, ...) @printf(ptr noundef @.str.14), !dbg !165
  store i32 0, ptr %2, align 4, !dbg !167
  br label %259, !dbg !167

251:                                              ; preds = %246
  %252 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 0, !dbg !168
  %253 = call i64 @strlen(ptr noundef %252) #5, !dbg !170
  %254 = icmp ult i64 %253, 7, !dbg !171
  br i1 %254, label %255, label %256, !dbg !172

255:                                              ; preds = %251
  store i32 0, ptr %2, align 4, !dbg !173
  br label %259, !dbg !173

256:                                              ; preds = %251
  %257 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 0, !dbg !174
  %258 = call i32 @extend(ptr noundef %257), !dbg !175
  br label %259, !dbg !176

259:                                              ; preds = %256, %255, %249, %36, %23
  %260 = load i32, ptr %2, align 4, !dbg !176
  ret i32 %260, !dbg !176
}
