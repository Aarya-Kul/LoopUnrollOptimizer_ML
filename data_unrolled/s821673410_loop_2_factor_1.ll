...
9279:                                             ; preds = %9265
  %9280 = getelementptr inbounds [1000 x i8], ptr %3, i64 0, i64 0, !dbg !141
  %9281 = call i64 @strlen(ptr noundef %9280) #8, !dbg !143
  %9282 = load i32, ptr %2, align 4, !dbg !144
  %9283 = sext i32 %9282 to i64, !dbg !144
  %9284 = icmp ne i64 %9281, %9283, !dbg !145
  br i1 %9284, label %9285, label %9286, !dbg !146

9285:                                             ; preds = %9279
  store i32 0, ptr %1, align 4, !dbg !147
  br label %9335, !dbg !147

9286:                                             ; preds = %9279
  store i32 0, ptr %5, align 4, !dbg !149
  br label %9287, !dbg !151

9287:                                             ; preds = %9328, %9286
  %9288 = load i32, ptr %5, align 4, !dbg !152
  %9289 = load i32, ptr %4, align 4, !dbg !154
  %9290 = add nsw i32 %9289, 1, !dbg !155
  %9291 = icmp slt i32 %9288, %9290, !dbg !156
  br i1 %9291, label %9292, label %9331, !dbg !157

9292:                                             ; preds = %9287
  %9293 = load i32, ptr %5, align 4, !dbg !158
  store i32 %9293, ptr %7, align 4, !dbg !160
  store i32 0, ptr %13, align 4, !dbg !161
  br label %9294, !dbg !163

9294:                                             ; preds = %9321, %9292
  %9295 = load i32, ptr %6, align 4, !dbg !164
  %9296 = load i32, ptr %5, align 4, !dbg !166
  %9297 = icmp ne i32 %9295, %9296, !dbg !167
  br i1 %9297, label %9298, label %9324, !dbg !168

9298:                                             ; preds = %9294
  %9299 = load i32, ptr %13, align 4, !dbg !169
  %9300 = icmp ne i32 %9299, 0, !dbg !172
  br i1 %9300, label %9301, label %9303, !dbg !173

9301:                                             ; preds = %9298
  %9302 = load i32, ptr %6, align 4, !dbg !174
  store i32 %9302, ptr %7, align 4, !dbg !176
  br label %9303, !dbg !177

9303:                                             ; preds = %9301, %9298
  %9304 = load i32, ptr %7, align 4, !dbg !178
  %9305 = srem i32 %9304, 2, !dbg !180
  %9306 = icmp ne i32 %9305, 0, !dbg !181
  br i1 %9306, label %9307, label %9311, !dbg !182

9307:                                             ; preds = %9303
  %9308 = load i32, ptr %7, align 4, !dbg !183
  %9309 = sub nsw i32 %9308, 1, !dbg !185
  %9310 = sdiv i32 %9309, 2, !dbg !186
  store i32 %9310, ptr %6, align 4, !dbg !187
  br label %9320, !dbg !188

9311:                                             ; preds = %9303
  %9312 = load i32, ptr %7, align 4, !dbg !189
  %9313 = sdiv i32 %9312, 2, !dbg !191
  %9314 = load i32, ptr %2, align 4, !dbg !192
  %9315 = sub nsw i32 %9314, 1, !dbg !193
  %9316 = sitofp i32 %9315 to double, !dbg !192
  %9317 = call double @pow(double noundef 2.000000e+00, double noundef %9316) #7, !dbg !194
  %9318 = fptosi double %9317 to i32, !dbg !195
  %9319 = add nsw i32 %9313, %9318, !dbg !196
  store i32 %9319, ptr %6, align 4, !dbg !197
  br label %9320

9320:                                             ; preds = %9311, %9307
  br label %9321, !dbg !198

9321:                                             ; preds = %9320
  %9322 = load i32, ptr %13, align 4, !dbg !199
  %9323 = add nsw i32 %9322, 1, !dbg !199
  store i32 %9323, ptr %13, align 4, !dbg !199
  br label %9294, !dbg !200, !llvm.loop !201

9324:                                             ; preds = %9294
  %9325 = load i32, ptr %13, align 4, !dbg !203
  %9326 = load i32, ptr %14, align 4, !dbg !204
  %9327 = add nsw i32 %9326, %9325, !dbg !204
  store i32 %9327, ptr %14, align 4, !dbg !204
  br label %9328, !dbg !205

9328:                                             ; preds = %9324
  %9329 = load i32, ptr %5, align 4, !dbg !206
  %9330 = add nsw i32 %9329, 1, !dbg !206
  store i32 %9330, ptr %5, align 4, !dbg !206
  br label %9287, !dbg !207, !llvm.loop !208

9331:                                             ; preds = %9287
  %9332 = load i32, ptr %14, align 4, !dbg !210
  %9333 = srem i32 %9332, 998244353, !dbg !211
  %9334 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %9333), !dbg !212
  store i32 0, ptr %1, align 4, !dbg !213
  br label %9335, !dbg !213

9335:                                             ; preds = %9331, %9285
  %9336 = load i32, ptr %1, align 4, !dbg !214
  ret i32 %9336, !dbg !214
}
