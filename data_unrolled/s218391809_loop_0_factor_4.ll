...
239:                                              ; preds = %207, %178, %149, %120, %91, %62, %33, %6
  %240 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 0, !dbg !66
  %241 = load i8, ptr %240, align 1, !dbg !66
  %242 = sext i8 %241 to i32, !dbg !66
  %243 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 1, !dbg !67
  %244 = load i8, ptr %243, align 1, !dbg !67
  %245 = sext i8 %244 to i32, !dbg !67
  %246 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 2, !dbg !68
  %247 = load i8, ptr %246, align 1, !dbg !68
  %248 = sext i8 %247 to i32, !dbg !68
  %249 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %242, i32 noundef %245, i32 noundef %248), !dbg !69
  ret i32 0, !dbg !70
}
