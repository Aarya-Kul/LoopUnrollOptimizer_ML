...
13:                                               ; preds = %186, %0
  ...
  br i1 %16, label %17, label %189, !dbg !54
...
189:                                              ; preds = %13
  %190 = load i32, ptr %5, align 4, !dbg !224
  %191 = icmp eq i32 %190, 7, !dbg !226
  br i1 %191, label %192, label %197, !dbg !227

192:                                              ; preds = %189
  %193 = load i32, ptr %4, align 4, !dbg !228
  %194 = icmp sle i32 %193, 1, !dbg !229
  br i1 %194, label %195, label %197, !dbg !230

195:                                              ; preds = %192
  %196 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !231
  br label %199, !dbg !233

197:                                              ; preds = %192, %189
  %198 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !234
  br label %199
