...
138:                                              ; preds = %213, %135
  ...
  br i1 %141, label %142, label %216, !dbg !151
...
143:                                              ; preds = %209, %142
  ...
  br i1 %146, label %147, label %212, !dbg !160
...
147:                                              ; preds = %143
  ...
  br i1 %157, label %158, label %208, !dbg !171
...
158:                                              ; preds = %147
  ...
  br i1 %162, label %163, label %208, !dbg !175

163:                                              ; preds = %158
  %164 = load i64, ptr %4, align 8, !dbg !176
  %165 = getelementptr inbounds i64, ptr %24, i64 %164, !dbg !178
  %166 = load i64, ptr %165, align 8, !dbg !179
  %167 = add nsw i64 %166, 1, !dbg !179
  store i64 %167, ptr %165, align 8, !dbg !179
  call void @llvm.dbg.declare(metadata ptr %13, metadata !180, metadata !DIExpression()), !dbg !181
  %168 = load i64, ptr %4, align 8, !dbg !182
  %169 = load i64, ptr %12, align 8, !dbg !183
  %170 = sub nsw i64 %168, %169, !dbg !184
  store i64 %170, ptr %13, align 8, !dbg !181
  call void @llvm.dbg.declare(metadata ptr %14, metadata !185, metadata !DIExpression()), !dbg !186
  %171 = load i64, ptr %11, align 8, !dbg !187
  %172 = load i64, ptr %4, align 8, !dbg !188
  %173 = sub nsw i64 %171, %172, !dbg !189
  store i64 %173, ptr %14, align 8, !dbg !186
  %174 = load i64, ptr %13, align 8, !dbg !190
  %175 = load i64, ptr %14, align 8, !dbg !192
  %176 = icmp slt i64 %174, %175, !dbg !193
  br i1 %176, label %177, label %192, !dbg !194

177:                                              ; preds = %163
  %178 = load i64, ptr %4, align 8, !dbg !195
  %179 = getelementptr inbounds i64, ptr %19, i64 %178, !dbg !197
  %180 = load i64, ptr %179, align 8, !dbg !197
  %181 = load i64, ptr %14, align 8, !dbg !198
  %182 = mul nsw i64 %180, %181, !dbg !199
  %183 = load i64, ptr %5, align 8, !dbg !200
  %184 = add nsw i64 %183, %182, !dbg !200
  store i64 %184, ptr %5, align 8, !dbg !200
  %185 = load i64, ptr %4, align 8, !dbg !201
  %186 = getelementptr inbounds i64, ptr %19, i64 %185, !dbg !202
  %187 = load i64, ptr %186, align 8, !dbg !202
  %188 = load i64, ptr %11, align 8, !dbg !203
  %189 = getelementptr inbounds i64, ptr %27, i64 %188, !dbg !204
  store i64 %187, ptr %189, align 8, !dbg !205
  %190 = load i64, ptr %11, align 8, !dbg !206
  %191 = add nsw i64 %190, -1, !dbg !206
  store i64 %191, ptr %11, align 8, !dbg !206
  br label %207, !dbg !207

192:                                              ; preds = %163
  %193 = load i64, ptr %4, align 8, !dbg !208
  %194 = getelementptr inbounds i64, ptr %19, i64 %193, !dbg !210
  %195 = load i64, ptr %194, align 8, !dbg !210
  %196 = load i64, ptr %13, align 8, !dbg !211
  %197 = mul nsw i64 %195, %196, !dbg !212
  %198 = load i64, ptr %5, align 8, !dbg !213
  %199 = add nsw i64 %198, %197, !dbg !213
  store i64 %199, ptr %5, align 8, !dbg !213
  %200 = load i64, ptr %4, align 8, !dbg !214
  %201 = getelementptr inbounds i64, ptr %19, i64 %200, !dbg !215
  %202 = load i64, ptr %201, align 8, !dbg !215
  %203 = load i64, ptr %12, align 8, !dbg !216
  %204 = getelementptr inbounds i64, ptr %27, i64 %203, !dbg !217
  store i64 %202, ptr %204, align 8, !dbg !218
  %205 = load i64, ptr %12, align 8, !dbg !219
  %206 = add nsw i64 %205, 1, !dbg !219
  store i64 %206, ptr %12, align 8, !dbg !219
  br label %207

207:                                              ; preds = %192, %177
  br label %208, !dbg !220

208:                                              ; preds = %207, %158, %147
  br label %209, !dbg !221

209:                                              ; preds = %208
  %210 = load i64, ptr %4, align 8, !dbg !222
  %211 = add nsw i64 %210, 1, !dbg !222
  store i64 %211, ptr %4, align 8, !dbg !222
  br label %143, !dbg !223, !llvm.loop !224

212:                                              ; preds = %143
  br label %213, !dbg !226

213:                                              ; preds = %212
  %214 = load i64, ptr %3, align 8, !dbg !227
  %215 = add nsw i64 %214, 1, !dbg !227
  store i64 %215, ptr %3, align 8, !dbg !227
  br label %138, !dbg !228, !llvm.loop !229

216:                                              ; preds = %138
  %217 = load i64, ptr %5, align 8, !dbg !231
  %218 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %217), !dbg !232
  store i32 0, ptr %1, align 4, !dbg !233
  %219 = load ptr, ptr %6, align 8, !dbg !234
  call void @llvm.stackrestore.p0(ptr %219), !dbg !234
  %220 = load i32, ptr %1, align 4, !dbg !234
  ret i32 %220, !dbg !234
}
