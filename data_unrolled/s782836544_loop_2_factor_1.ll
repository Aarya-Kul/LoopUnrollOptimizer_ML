...
6165:                                             ; preds = %6296, %6164
  ...
  br i1 %6169, label %6170, label %6299, !dbg !97
...
6299:                                             ; preds = %6165
  %6300 = load i32, ptr %2, align 4, !dbg !218
  %6301 = icmp sgt i32 %6300, 0, !dbg !220
  br i1 %6301, label %6302, label %6325, !dbg !221

6302:                                             ; preds = %6299
  %6303 = load i32, ptr %3, align 4, !dbg !222
  %6304 = icmp sgt i32 %6303, 0, !dbg !223
  br i1 %6304, label %6305, label %6325, !dbg !224

6305:                                             ; preds = %6302
  %6306 = load i32, ptr %4, align 4, !dbg !225
  %6307 = icmp sgt i32 %6306, 0, !dbg !226
  br i1 %6307, label %6308, label %6325, !dbg !227

6308:                                             ; preds = %6305
  %6309 = load i32, ptr %5, align 4, !dbg !228
  %6310 = icmp sgt i32 %6309, 0, !dbg !229
  br i1 %6310, label %6311, label %6325, !dbg !230

6311:                                             ; preds = %6308
  %6312 = load i32, ptr %6, align 4, !dbg !231
  %6313 = icmp sgt i32 %6312, 0, !dbg !232
  br i1 %6313, label %6314, label %6325, !dbg !233

6314:                                             ; preds = %6311
  %6315 = load i32, ptr %7, align 4, !dbg !234
  %6316 = icmp sgt i32 %6315, 0, !dbg !235
  br i1 %6316, label %6317, label %6325, !dbg !236

6317:                                             ; preds = %6314
  %6318 = load i32, ptr %8, align 4, !dbg !237
  %6319 = icmp sgt i32 %6318, 0, !dbg !238
  br i1 %6319, label %6320, label %6325, !dbg !239

6320:                                             ; preds = %6317
  %6321 = load i32, ptr %9, align 4, !dbg !240
  %6322 = icmp slt i32 %6321, 2, !dbg !241
  br i1 %6322, label %6323, label %6325, !dbg !242

6323:                                             ; preds = %6320
  %6324 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !243
  br label %6327, !dbg !245

6325:                                             ; preds = %6320, %6317, %6314, %6311, %6308, %6305, %6302, %6299
  %6326 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !246
  br label %6327
