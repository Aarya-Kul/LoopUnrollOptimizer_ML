...
3857:                                             ; preds = %3872, %3851
  ...
  br i1 %3867, label %3868, label %3875, !dbg !64
...
3875:                                             ; preds = %3857
  ...
  br label %3876, !dbg !83

3876:                                             ; preds = %3894, %3875
  %3877 = load ptr, ptr %7, align 8, !dbg !84
  %3878 = getelementptr inbounds i8, ptr %3877, i32 -1, !dbg !84
  store ptr %3878, ptr %7, align 8, !dbg !84
  %3879 = load i8, ptr %3877, align 1, !dbg !85
  %3880 = sext i8 %3879 to i32, !dbg !85
  %3881 = load i32, ptr %9, align 4, !dbg !86
  %3882 = sext i32 %3881 to i64, !dbg !87
  %3883 = getelementptr inbounds [8 x i8], ptr %2, i64 0, i64 %3882, !dbg !87
  %3884 = load i8, ptr %3883, align 1, !dbg !87
  %3885 = sext i8 %3884 to i32, !dbg !87
  %3886 = icmp eq i32 %3880, %3885, !dbg !88
  br i1 %3886, label %3887, label %3897, !dbg !83

3887:                                             ; preds = %3876
  %3888 = load i32, ptr %8, align 4, !dbg !89
  %3889 = sub nsw i32 7, %3888, !dbg !92
  %3890 = load i32, ptr %9, align 4, !dbg !93
  %3891 = sub nsw i32 7, %3890, !dbg !94
  %3892 = icmp eq i32 %3889, %3891, !dbg !95
  br i1 %3892, label %3893, label %3894, !dbg !96

3893:                                             ; preds = %3887
  store i32 1, ptr %4, align 4, !dbg !97
  br label %3894, !dbg !99

3894:                                             ; preds = %3893, %3887
  %3895 = load i32, ptr %9, align 4, !dbg !100
  %3896 = add nsw i32 %3895, -1, !dbg !100
  store i32 %3896, ptr %9, align 4, !dbg !100
  br label %3876, !dbg !83, !llvm.loop !101

3897:                                             ; preds = %3876
  %3898 = load i32, ptr %4, align 4, !dbg !103
  %3899 = icmp sgt i32 %3898, 0, !dbg !104
  br i1 %3899, label %3900, label %3902, !dbg !103

3900:                                             ; preds = %3897
  %3901 = call i32 @puts(ptr noundef @.str), !dbg !105
  br label %3904, !dbg !103

3902:                                             ; preds = %3897
  %3903 = call i32 @puts(ptr noundef @.str.1), !dbg !106
  br label %3904, !dbg !103

3904:                                             ; preds = %3902, %3900
  %3905 = phi i32 [ %3901, %3900 ], [ %3903, %3902 ], !dbg !103
  ret i32 0, !dbg !107
}
