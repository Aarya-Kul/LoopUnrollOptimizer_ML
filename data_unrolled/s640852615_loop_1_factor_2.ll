...
3874:                                             ; preds = %3873
  ...
  br i1 %3878, label %3879, label %3906, !dbg !57
...
3906:                                             ; preds = %3874, %3847
  %3907 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 0, !dbg !84
  %3908 = load i8, ptr %3907, align 16, !dbg !84
  %3909 = sext i8 %3908 to i32, !dbg !84
  %3910 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 1, !dbg !85
  %3911 = load i8, ptr %3910, align 1, !dbg !85
  %3912 = sext i8 %3911 to i32, !dbg !85
  %3913 = getelementptr inbounds [100 x i8], ptr %2, i64 0, i64 2, !dbg !86
  %3914 = load i8, ptr %3913, align 2, !dbg !86
  %3915 = sext i8 %3914 to i32, !dbg !86
  %3916 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %3909, i32 noundef %3912, i32 noundef %3915), !dbg !87
  %3917 = load i32, ptr %1, align 4, !dbg !88
  ret i32 %3917, !dbg !88
}
