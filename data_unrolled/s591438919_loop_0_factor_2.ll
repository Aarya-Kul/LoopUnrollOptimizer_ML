...
16:                                               ; preds = %134, %0
  ...
  br i1 %18, label %19, label %158, !dbg !121
...
85:                                               ; preds = %84, %49
  ...
  br i1 %89, label %90, label %158, !dbg !121
...
91:                                               ; preds = %155, %90
  ...
  br i1 %94, label %137, label %95, !dbg !133
...
137:                                              ; preds = %91
  %138 = load i32, ptr %9, align 4, !dbg !134
  %139 = sext i32 %138 to i64, !dbg !137
  %140 = getelementptr inbounds [101 x i8], ptr %2, i64 0, i64 %139, !dbg !137
  %141 = load i8, ptr %140, align 1, !dbg !137
  %142 = sext i8 %141 to i32, !dbg !137
  %143 = load i32, ptr %7, align 4, !dbg !138
  %144 = sext i32 %143 to i64, !dbg !139
  %145 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 %144, !dbg !139
  %146 = load i8, ptr %145, align 1, !dbg !139
  %147 = sext i8 %146 to i32, !dbg !139
  %148 = icmp eq i32 %142, %147, !dbg !140
  br i1 %148, label %149, label %152, !dbg !141

149:                                              ; preds = %137
  %150 = load i32, ptr %6, align 4, !dbg !142
  %151 = add nsw i32 %150, 1, !dbg !142
  store i32 %151, ptr %6, align 4, !dbg !142
  br label %152, !dbg !144

152:                                              ; preds = %149, %137
  %153 = load i32, ptr %7, align 4, !dbg !145
  %154 = add nsw i32 %153, 1, !dbg !145
  store i32 %154, ptr %7, align 4, !dbg !145
  br label %155, !dbg !146

155:                                              ; preds = %152
  %156 = load i32, ptr %9, align 4, !dbg !147
  %157 = add nsw i32 %156, 1, !dbg !147
  store i32 %157, ptr %9, align 4, !dbg !147
  br label %91, !dbg !148, !llvm.loop !149

158:                                              ; preds = %85, %83, %16
  %159 = load i32, ptr %5, align 4, !dbg !200
  %160 = icmp eq i32 %159, 1, !dbg !202
  br i1 %160, label %161, label %163, !dbg !203

161:                                              ; preds = %158
  %162 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !204
  br label %165, !dbg !204

163:                                              ; preds = %158
  %164 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !205
  br label %165
