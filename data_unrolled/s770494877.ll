...
84:                                               ; preds = %102, %81
  ...
  br i1 %87, label %88, label %105, !dbg !118
...
106:                                              ; preds = %105, %80
  %107 = load i32, ptr %6, align 4, !dbg !143
  %108 = xor i32 %107, -1, !dbg !144
  %109 = load i32, ptr %4, align 4, !dbg !145
  %110 = sext i32 %109 to i64, !dbg !146
  %111 = getelementptr inbounds [512 x [512 x i32]], ptr @memo, i64 0, i64 %110, !dbg !146
  %112 = load i32, ptr %5, align 4, !dbg !147
  %113 = sext i32 %112 to i64, !dbg !146
  %114 = getelementptr inbounds [512 x i32], ptr %111, i64 0, i64 %113, !dbg !146
  store i32 %108, ptr %114, align 4, !dbg !148
  %115 = xor i32 %108, -1, !dbg !149
  store i32 %115, ptr %3, align 4, !dbg !150
  br label %116, !dbg !150

116:                                              ; preds = %106, %51, %27, %21, %15
  %117 = load i32, ptr %3, align 4, !dbg !151
  ret i32 %117, !dbg !151
}
