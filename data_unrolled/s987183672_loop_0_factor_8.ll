...
10898:                                            ; preds = %10820
  ...
  br label %10899, !dbg !276

10899:                                            ; preds = %10922, %10898
  %10900 = load i32, ptr %4, align 4, !dbg !277
  %10901 = icmp sge i32 %10900, 0, !dbg !279
  br i1 %10901, label %10902, label %10925, !dbg !280

10902:                                            ; preds = %10899
  %10903 = load i64, ptr %11, align 8, !dbg !281
  %10904 = load i32, ptr %4, align 4, !dbg !284
  %10905 = sext i32 %10904 to i64, !dbg !285
  %10906 = getelementptr inbounds [5 x i64], ptr %12, i64 0, i64 %10905, !dbg !285
  %10907 = load i64, ptr %10906, align 8, !dbg !285
  %10908 = icmp eq i64 %10903, %10907, !dbg !286
  br i1 %10908, label %10909, label %10921, !dbg !287

10909:                                            ; preds = %10902
  %10910 = load i64, ptr %11, align 8, !dbg !288
  %10911 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %10910), !dbg !290
  %10912 = load i32, ptr %4, align 4, !dbg !291
  %10913 = sext i32 %10912 to i64, !dbg !292
  %10914 = getelementptr inbounds [5 x i32], ptr @x3, i64 0, i64 %10913, !dbg !292
  %10915 = load i32, ptr %10914, align 4, !dbg !292
  %10916 = load i32, ptr %4, align 4, !dbg !293
  %10917 = sext i32 %10916 to i64, !dbg !294
  %10918 = getelementptr inbounds [5 x i32], ptr @y3, i64 0, i64 %10917, !dbg !294
  %10919 = load i32, ptr %10918, align 4, !dbg !294
  %10920 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %10915, i32 noundef %10919), !dbg !295
  br label %10925, !dbg !296

10921:                                            ; preds = %10902
  br label %10922, !dbg !297

10922:                                            ; preds = %10921
  %10923 = load i32, ptr %4, align 4, !dbg !298
  %10924 = add nsw i32 %10923, -1, !dbg !298
  store i32 %10924, ptr %4, align 4, !dbg !298
  br label %10899, !dbg !299, !llvm.loop !300

10925:                                            ; preds = %10909, %10899
  ret i32 0, !dbg !302
}
