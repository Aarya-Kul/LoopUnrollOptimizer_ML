...
81:                                               ; preds = %155, %79
  ...
  br i1 %84, label %85, label %158, !dbg !344
...
132:                                              ; preds = %150, %131
  ...
  %139 = load i32, ptr %10, align 4, !dbg !409
  %140 = sext i32 %139 to i64, !dbg !410
  %141 = getelementptr inbounds i32, ptr %21, i64 %140, !dbg !410
  %142 = load i32, ptr %141, align 4, !dbg !410
  %143 = add nsw i32 %138, %142, !dbg !411
  %144 = call i32 @llvm.abs.i32(i32 %143, i1 true), !dbg !412
  %145 = sub nsw i32 %134, %144, !dbg !413
  %146 = sdiv i32 %145, 2, !dbg !414
  %147 = icmp slt i32 %133, %146, !dbg !415
  br i1 %147, label %148, label %153, !dbg !416

148:                                              ; preds = %132
  %149 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !417
  br label %150, !dbg !419

150:                                              ; preds = %148
  %151 = load i32, ptr %13, align 4, !dbg !420
  %152 = add nsw i32 %151, 1, !dbg !420
  store i32 %152, ptr %13, align 4, !dbg !420
  br label %132, !dbg !421, !llvm.loop !422

153:                                              ; preds = %132
  %154 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !424
  br label %155, !dbg !425

155:                                              ; preds = %153
  %156 = load i32, ptr %10, align 4, !dbg !426
  %157 = add nsw i32 %156, 1, !dbg !426
  store i32 %157, ptr %10, align 4, !dbg !426
  br label %81, !dbg !427, !llvm.loop !428

158:                                              ; preds = %81
  store i32 0, ptr %1, align 4, !dbg !430
  store i32 1, ptr %8, align 4
  br label %159, !dbg !430

159:                                              ; preds = %158, %51
  %160 = load ptr, ptr %4, align 8, !dbg !431
  call void @llvm.stackrestore.p0(ptr %160), !dbg !431
  %161 = load i32, ptr %1, align 4, !dbg !431
  ret i32 %161, !dbg !431
}
