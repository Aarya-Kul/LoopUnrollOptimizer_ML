...
3:                                                ; preds = %16, %0
  ...
  br i1 %6, label %7, label %19, !dbg !199
...
20:                                               ; preds = %36, %19
  %21 = load i64, ptr @i, align 8, !dbg !219
  %22 = icmp slt i64 %21, 2048, !dbg !221
  br i1 %22, label %23, label %39, !dbg !222
...
24:                                               ; preds = %32, %23
  %25 = load i64, ptr @j, align 8, !dbg !226
  %26 = icmp slt i64 %25, 2048, !dbg !228
  br i1 %26, label %27, label %35, !dbg !229

27:                                               ; preds = %24
  %28 = load i64, ptr @i, align 8, !dbg !230
  %29 = getelementptr inbounds [2048 x [2048 x i64]], ptr @dp, i64 0, i64 %28, !dbg !231
  %30 = load i64, ptr @j, align 8, !dbg !232
  %31 = getelementptr inbounds [2048 x i64], ptr %29, i64 0, i64 %30, !dbg !231
  store i64 -1, ptr %31, align 8, !dbg !233
  br label %32, !dbg !231

32:                                               ; preds = %27
  %33 = load i64, ptr @j, align 8, !dbg !234
  %34 = add nsw i64 %33, 1, !dbg !234
  store i64 %34, ptr @j, align 8, !dbg !234
  br label %24, !dbg !235, !llvm.loop !236

35:                                               ; preds = %24
  br label %36, !dbg !237

36:                                               ; preds = %35
  %37 = load i64, ptr @i, align 8, !dbg !238
  %38 = add nsw i64 %37, 1, !dbg !238
  store i64 %38, ptr @i, align 8, !dbg !238
  br label %20, !dbg !239, !llvm.loop !240

39:                                               ; preds = %20
  %40 = load i64, ptr @n, align 8, !dbg !242
  call void @qsort(ptr noundef @a, i64 noundef %40, i64 noundef 16, ptr noundef @cmp), !dbg !243
  %41 = load i64, ptr @n, align 8, !dbg !244
  %42 = call i64 @search(i64 noundef 1, i64 noundef %41), !dbg !245
  %43 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %42), !dbg !246
  ret i32 0, !dbg !247
}
