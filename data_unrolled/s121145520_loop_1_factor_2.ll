...
4311:                                             ; preds = %4310
  ...
  br i1 %4316, label %4317, label %4381, !dbg !77
...
4362:                                             ; preds = %4318
  %4363 = load i32, ptr %12, align 4, !dbg !88
  %4364 = sext i32 %4363 to i64, !dbg !91
  %4365 = getelementptr inbounds i64, ptr %17, i64 %4364, !dbg !91
  %4366 = load i64, ptr %4365, align 8, !dbg !91
  %4367 = load i32, ptr %9, align 4, !dbg !92
  %4368 = sext i32 %4367 to i64, !dbg !92
  %4369 = icmp sgt i64 %4366, %4368, !dbg !93
  br i1 %4369, label %4370, label %4377, !dbg !94

4370:                                             ; preds = %4362
  %4371 = load i32, ptr %12, align 4, !dbg !95
  %4372 = sext i32 %4371 to i64, !dbg !97
  %4373 = getelementptr inbounds i64, ptr %17, i64 %4372, !dbg !97
  %4374 = load i64, ptr %4373, align 8, !dbg !97
  %4375 = trunc i64 %4374 to i32, !dbg !97
  store i32 %4375, ptr %9, align 4, !dbg !98
  %4376 = load i32, ptr %12, align 4, !dbg !99
  store i32 %4376, ptr %10, align 4, !dbg !100
  br label %4377, !dbg !101

4377:                                             ; preds = %4370, %4362
  br label %4378, !dbg !102

4378:                                             ; preds = %4377
  %4379 = load i32, ptr %12, align 4, !dbg !103
  %4380 = add nsw i32 %4379, 1, !dbg !103
  store i32 %4380, ptr %12, align 4, !dbg !103
  br label %4318, !dbg !104, !llvm.loop !105

4381:                                             ; preds = %4311, %4246
  %4382 = load i64, ptr %6, align 8, !dbg !147
  %4383 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %4382), !dbg !148
  %4384 = load ptr, ptr %3, align 8, !dbg !149
  call void @llvm.stackrestore.p0(ptr %4384), !dbg !149
  %4385 = load i32, ptr %1, align 4, !dbg !149
  ret i32 %4385, !dbg !149
}
