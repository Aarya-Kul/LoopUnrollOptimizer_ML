...
25:                                               ; preds = %18, %11
  ...
  br i1 %26, label %27, label %100, !dbg !51
...
69:                                               ; preds = %62, %55
  ...
  br i1 %70, label %71, label %100, !dbg !51
...
100:                                              ; preds = %69, %25
  %101 = load i32, ptr %4, align 4, !dbg !87
  %102 = icmp eq i32 %101, 7, !dbg !89
  br i1 %102, label %103, label %108, !dbg !90

103:                                              ; preds = %100
  %104 = load i32, ptr %5, align 4, !dbg !91
  %105 = icmp slt i32 %104, 2, !dbg !92
  br i1 %105, label %106, label %108, !dbg !93

106:                                              ; preds = %103
  %107 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !94
  br label %110, !dbg !96

108:                                              ; preds = %103, %100
  %109 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !97
  br label %110
