...
24:                                               ; preds = %17, %10
  ...
  br i1 %25, label %26, label %135, !dbg !62
...
87:                                               ; preds = %80, %71
  ...
  br i1 %88, label %89, label %135, !dbg !62
...
135:                                              ; preds = %87, %24
  %136 = load i32, ptr %4, align 4, !dbg !104
  %137 = icmp sle i32 %136, 5, !dbg !106
  br i1 %137, label %138, label %140, !dbg !107

138:                                              ; preds = %135
  %139 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !108
  store i32 0, ptr %1, align 4, !dbg !110
  br label %142, !dbg !110

140:                                              ; preds = %135
  %141 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !111
  br label %142, !dbg !112

142:                                              ; preds = %140, %138, %68
  %143 = load i32, ptr %1, align 4, !dbg !112
  ret i32 %143, !dbg !112
}
