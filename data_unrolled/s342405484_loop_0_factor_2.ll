...
26:                                               ; preds = %68, %2
  ...
  br i1 %29, label %30, label %71, !dbg !162
...
46:                                               ; preds = %30
  ...
  br i1 %51, label %52, label %71, !dbg !162
...
71:                                               ; preds = %46, %26
  %72 = load i32, ptr %9, align 4, !dbg !189
  %73 = sext i32 %72 to i64, !dbg !189
  call void @qsort(ptr noundef @hsxs, i64 noundef %73, i64 noundef 8, ptr noundef @compll), !dbg !190
  %74 = load i32, ptr %9, align 4, !dbg !191
  %75 = sext i32 %74 to i64, !dbg !191
  call void @qsort(ptr noundef @hsys, i64 noundef %75, i64 noundef 8, ptr noundef @compll), !dbg !192
  %76 = load i32, ptr %9, align 4, !dbg !193
  %77 = sub nsw i32 %76, 1, !dbg !194
  %78 = sdiv i32 %77, 2, !dbg !195
  %79 = sext i32 %78 to i64, !dbg !196
  %80 = getelementptr inbounds [100000 x i64], ptr @hsxs, i64 0, i64 %79, !dbg !196
  %81 = load i64, ptr %80, align 8, !dbg !196
  %82 = getelementptr inbounds [2 x i64], ptr %16, i64 0, i64 0, !dbg !197
  store i64 %81, ptr %82, align 16, !dbg !198
  %83 = load i32, ptr %9, align 4, !dbg !199
  %84 = sub nsw i32 %83, 1, !dbg !200
  %85 = sdiv i32 %84, 2, !dbg !201
  %86 = sext i32 %85 to i64, !dbg !202
  %87 = getelementptr inbounds [100000 x i64], ptr @hsys, i64 0, i64 %86, !dbg !202
  %88 = load i64, ptr %87, align 8, !dbg !202
  %89 = getelementptr inbounds [2 x i64], ptr %17, i64 0, i64 0, !dbg !203
  store i64 %88, ptr %89, align 16, !dbg !204
  %90 = load i32, ptr %9, align 4, !dbg !205
  %91 = add nsw i32 %90, 1, !dbg !206
  %92 = sdiv i32 %91, 2, !dbg !207
  %93 = sext i32 %92 to i64, !dbg !208
  %94 = getelementptr inbounds [100000 x i64], ptr @hsxs, i64 0, i64 %93, !dbg !208
  %95 = load i64, ptr %94, align 8, !dbg !208
  %96 = getelementptr inbounds [2 x i64], ptr %16, i64 0, i64 1, !dbg !209
  store i64 %95, ptr %96, align 8, !dbg !210
  %97 = load i32, ptr %9, align 4, !dbg !211
  %98 = add nsw i32 %97, 1, !dbg !212
  %99 = sdiv i32 %98, 2, !dbg !213
  %100 = sext i32 %99 to i64, !dbg !214
  %101 = getelementptr inbounds [100000 x i64], ptr @hsys, i64 0, i64 %100, !dbg !214
  %102 = load i64, ptr %101, align 8, !dbg !214
  %103 = getelementptr inbounds [2 x i64], ptr %17, i64 0, i64 1, !dbg !215
  store i64 %102, ptr %103, align 8, !dbg !216
  ...
  br label %104, !dbg !222

104:                                              ; preds = %159, %71
  %105 = load i32, ptr %8, align 4, !dbg !223
  %106 = icmp slt i32 %105, 4, !dbg !225
  br i1 %106, label %107, label %162, !dbg !226
...
107:                                              ; preds = %104
  ...
  %108 = load i32, ptr %8, align 4, !dbg !234
  %109 = sdiv i32 %108, 2, !dbg !235
  %110 = sext i32 %109 to i64, !dbg !236
  %111 = getelementptr inbounds [2 x i64], ptr %16, i64 0, i64 %110, !dbg !236
  %112 = load i64, ptr %111, align 8, !dbg !236
  store i64 %112, ptr %22, align 8, !dbg !233
  call void @llvm.dbg.declare(metadata ptr %23, metadata !237, metadata !DIExpression()), !dbg !238
  %113 = load i32, ptr %8, align 4, !dbg !239
  %114 = srem i32 %113, 2, !dbg !240
  %115 = sext i32 %114 to i64, !dbg !241
  %116 = getelementptr inbounds [2 x i64], ptr %17, i64 0, i64 %115, !dbg !241
  %117 = load i64, ptr %116, align 8, !dbg !241
  store i64 %117, ptr %23, align 8, !dbg !238
  store i32 0, ptr %7, align 4, !dbg !242
  br label %118, !dbg !244

118:                                              ; preds = %143, %107
  %119 = load i32, ptr %7, align 4, !dbg !245
  %120 = load i32, ptr %9, align 4, !dbg !247
  %121 = icmp slt i32 %119, %120, !dbg !248
  br i1 %121, label %122, label %146, !dbg !249

122:                                              ; preds = %118
  %123 = load i32, ptr %7, align 4, !dbg !250
  %124 = sext i32 %123 to i64, !dbg !252
  %125 = getelementptr inbounds [100000 x i64], ptr @hxs, i64 0, i64 %124, !dbg !252
  %126 = load i64, ptr %125, align 8, !dbg !252
  %127 = load i32, ptr %7, align 4, !dbg !253
  %128 = sext i32 %127 to i64, !dbg !254
  %129 = getelementptr inbounds [100000 x i64], ptr @hys, i64 0, i64 %128, !dbg !254
  %130 = load i64, ptr %129, align 8, !dbg !254
  %131 = load i64, ptr %22, align 8, !dbg !255
  %132 = load i64, ptr %23, align 8, !dbg !256
  %133 = call i64 @distxy(i64 noundef %126, i64 noundef %130, i64 noundef %131, i64 noundef %132), !dbg !257
  store i64 %133, ptr %11, align 8, !dbg !258
  %134 = load i64, ptr %11, align 8, !dbg !259
  %135 = load i64, ptr %20, align 8, !dbg !260
  %136 = add nsw i64 %135, %134, !dbg !260
  store i64 %136, ptr %20, align 8, !dbg !260
  %137 = load i64, ptr %21, align 8, !dbg !261
  %138 = load i64, ptr %11, align 8, !dbg !263
  %139 = icmp slt i64 %137, %138, !dbg !264
  br i1 %139, label %140, label %142, !dbg !265

140:                                              ; preds = %122
  %141 = load i64, ptr %11, align 8, !dbg !266
  store i64 %141, ptr %21, align 8, !dbg !267
...
143:                                              ; preds = %142
  %144 = load i32, ptr %7, align 4, !dbg !270
  %145 = add nsw i32 %144, 1, !dbg !270
  store i32 %145, ptr %7, align 4, !dbg !270
  br label %118, !dbg !271, !llvm.loop !272

146:                                              ; preds = %118
  %147 = load i64, ptr %20, align 8, !dbg !274
  %148 = mul nsw i64 %147, 2, !dbg !275
  %149 = load i64, ptr %21, align 8, !dbg !276
  %150 = sub nsw i64 %148, %149, !dbg !277
  store i64 %150, ptr %20, align 8, !dbg !278
  %151 = load i64, ptr %15, align 8, !dbg !279
  %152 = load i64, ptr %20, align 8, !dbg !281
  %153 = icmp sgt i64 %151, %152, !dbg !282
  br i1 %153, label %154, label %158, !dbg !283

154:                                              ; preds = %146
  %155 = load i64, ptr %20, align 8, !dbg !284
  store i64 %155, ptr %15, align 8, !dbg !286
  %156 = load i64, ptr %22, align 8, !dbg !287
  store i64 %156, ptr %13, align 8, !dbg !288
  %157 = load i64, ptr %23, align 8, !dbg !289
  store i64 %157, ptr %14, align 8, !dbg !290
  br label %158, !dbg !291

158:                                              ; preds = %154, %146
  br label %159, !dbg !292

159:                                              ; preds = %158
  %160 = load i32, ptr %8, align 4, !dbg !293
  %161 = add nsw i32 %160, 1, !dbg !293
  store i32 %161, ptr %8, align 4, !dbg !293
  br label %104, !dbg !294, !llvm.loop !295

162:                                              ; preds = %104
  %163 = load i64, ptr %15, align 8, !dbg !297
  %164 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i64 noundef %163), !dbg !298
  %165 = load i64, ptr %13, align 8, !dbg !299
  %166 = load i64, ptr %14, align 8, !dbg !300
  %167 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %165, i64 noundef %166), !dbg !301
  ret i32 0, !dbg !302
}
