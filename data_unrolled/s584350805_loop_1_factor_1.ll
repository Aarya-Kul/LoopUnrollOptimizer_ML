...
9649:                                             ; preds = %9641, %9625
  %9650 = load i32, ptr %7, align 4, !dbg !120
  %9651 = icmp eq i32 %9650, 1, !dbg !122
  br i1 %9651, label %9652, label %9654, !dbg !123

9652:                                             ; preds = %9649
  %9653 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !124
  br label %9656, !dbg !126

9654:                                             ; preds = %9649
  %9655 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !127
  br label %9656

9656:                                             ; preds = %9654, %9652
  ret i32 0, !dbg !129
}
