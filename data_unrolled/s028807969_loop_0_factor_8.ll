...
5406:                                             ; preds = %5391
  ...
  %5410 = srem i32 %5409, 2, !dbg !141
  %5411 = icmp eq i32 %5410, 0, !dbg !142
  br i1 %5411, label %5412, label %5416, !dbg !143

5412:                                             ; preds = %5406
  %5413 = load i32, ptr %4, align 4, !dbg !144
  %5414 = sdiv i32 %5413, 2, !dbg !145
  %5415 = sub nsw i32 %5414, 1, !dbg !146
  br label %5419, !dbg !143

5416:                                             ; preds = %5406
  %5417 = load i32, ptr %4, align 4, !dbg !147
  %5418 = sdiv i32 %5417, 2, !dbg !148
  br label %5419, !dbg !143

5419:                                             ; preds = %5416, %5412
  %5420 = phi i32 [ %5415, %5412 ], [ %5418, %5416 ], !dbg !143
  %5421 = sext i32 %5420 to i64, !dbg !149
  %5422 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %5421, !dbg !149
  %5423 = load i32, ptr %5422, align 4, !dbg !149
  store i32 %5423, ptr %9, align 4, !dbg !150
  store i32 0, ptr %5, align 4, !dbg !151
  br label %5424, !dbg !153

5424:                                             ; preds = %5436, %5419
  %5425 = load i32, ptr %5, align 4, !dbg !154
  %5426 = load i32, ptr %4, align 4, !dbg !156
  %5427 = icmp slt i32 %5425, %5426, !dbg !157
  br i1 %5427, label %5428, label %5439, !dbg !158

5428:                                             ; preds = %5424
  %5429 = load i32, ptr %5, align 4, !dbg !159
  %5430 = sext i32 %5429 to i64, !dbg !161
  %5431 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %5430, !dbg !161
  %5432 = load i32, ptr %5431, align 4, !dbg !161
  %5433 = load i32, ptr %5, align 4, !dbg !162
  %5434 = sext i32 %5433 to i64, !dbg !163
  %5435 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %5434, !dbg !163
  store i32 %5432, ptr %5435, align 4, !dbg !164
  br label %5436, !dbg !165

5436:                                             ; preds = %5428
  %5437 = load i32, ptr %5, align 4, !dbg !166
  %5438 = add nsw i32 %5437, 1, !dbg !166
  store i32 %5438, ptr %5, align 4, !dbg !166
  br label %5424, !dbg !167, !llvm.loop !168

5439:                                             ; preds = %5424
  %5440 = load i32, ptr %4, align 4, !dbg !170
  %5441 = sext i32 %5440 to i64, !dbg !170
  call void @qsort(ptr noundef @house_sort, i64 noundef %5441, i64 noundef 4, ptr noundef @qsort_comp), !dbg !171
  %5442 = load i32, ptr %4, align 4, !dbg !172
  %5443 = srem i32 %5442, 2, !dbg !173
  %5444 = icmp eq i32 %5443, 0, !dbg !174
  br i1 %5444, label %5445, label %5449, !dbg !175

5445:                                             ; preds = %5439
  %5446 = load i32, ptr %4, align 4, !dbg !176
  %5447 = sdiv i32 %5446, 2, !dbg !177
  %5448 = sub nsw i32 %5447, 1, !dbg !178
  br label %5452, !dbg !175

5449:                                             ; preds = %5439
  %5450 = load i32, ptr %4, align 4, !dbg !179
  %5451 = sdiv i32 %5450, 2, !dbg !180
  br label %5452, !dbg !175

5452:                                             ; preds = %5449, %5445
  %5453 = phi i32 [ %5448, %5445 ], [ %5451, %5449 ], !dbg !175
  %5454 = sext i32 %5453 to i64, !dbg !181
  %5455 = getelementptr inbounds [100000 x i32], ptr @house_sort, i64 0, i64 %5454, !dbg !181
  %5456 = load i32, ptr %5455, align 4, !dbg !181
  store i32 %5456, ptr %10, align 4, !dbg !182
  store i64 0, ptr %7, align 8, !dbg !183
  store i64 0, ptr %8, align 8, !dbg !184
  store i32 0, ptr %5, align 4, !dbg !185
  br label %5457, !dbg !187

5457:                                             ; preds = %5488, %5452
  %5458 = load i32, ptr %5, align 4, !dbg !188
  %5459 = load i32, ptr %4, align 4, !dbg !190
  %5460 = icmp slt i32 %5458, %5459, !dbg !191
  br i1 %5460, label %5461, label %5491, !dbg !192

5461:                                             ; preds = %5457
  %5462 = load i32, ptr %5, align 4, !dbg !193
  %5463 = sext i32 %5462 to i64, !dbg !195
  %5464 = getelementptr inbounds [100000 x i32], ptr @house_x, i64 0, i64 %5463, !dbg !195
  %5465 = load i32, ptr %5464, align 4, !dbg !195
  %5466 = load i32, ptr %9, align 4, !dbg !196
  %5467 = sub nsw i32 %5465, %5466, !dbg !197
  %5468 = call i32 @llvm.abs.i32(i32 %5467, i1 true), !dbg !198
  %5469 = load i32, ptr %5, align 4, !dbg !199
  %5470 = sext i32 %5469 to i64, !dbg !200
  %5471 = getelementptr inbounds [100000 x i32], ptr @house_y, i64 0, i64 %5470, !dbg !200
  %5472 = load i32, ptr %5471, align 4, !dbg !200
  %5473 = load i32, ptr %10, align 4, !dbg !201
  %5474 = sub nsw i32 %5472, %5473, !dbg !202
  %5475 = call i32 @llvm.abs.i32(i32 %5474, i1 true), !dbg !203
  %5476 = add nsw i32 %5468, %5475, !dbg !204
  %5477 = sext i32 %5476 to i64, !dbg !198
  store i64 %5477, ptr %6, align 8, !dbg !205
  %5478 = load i64, ptr %6, align 8, !dbg !206
  %5479 = mul nsw i64 %5478, 2, !dbg !207
  %5480 = load i64, ptr %7, align 8, !dbg !208
  %5481 = add nsw i64 %5480, %5479, !dbg !208
  store i64 %5481, ptr %7, align 8, !dbg !208
  %5482 = load i64, ptr %6, align 8, !dbg !209
  %5483 = load i64, ptr %8, align 8, !dbg !211
  %5484 = icmp sgt i64 %5482, %5483, !dbg !212
  br i1 %5484, label %5485, label %5487, !dbg !213

5485:                                             ; preds = %5461
  %5486 = load i64, ptr %6, align 8, !dbg !214
  store i64 %5486, ptr %8, align 8, !dbg !215
  br label %5487, !dbg !216

5487:                                             ; preds = %5485, %5461
  br label %5488, !dbg !217

5488:                                             ; preds = %5487
  %5489 = load i32, ptr %5, align 4, !dbg !218
  %5490 = add nsw i32 %5489, 1, !dbg !218
  store i32 %5490, ptr %5, align 4, !dbg !218
  br label %5457, !dbg !219, !llvm.loop !220

5491:                                             ; preds = %5457
  %5492 = load i64, ptr %8, align 8, !dbg !222
  %5493 = load i64, ptr %7, align 8, !dbg !223
  %5494 = sub nsw i64 %5493, %5492, !dbg !223
  store i64 %5494, ptr %7, align 8, !dbg !223
  %5495 = load i64, ptr %7, align 8, !dbg !224
  %5496 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %5495), !dbg !225
  %5497 = load i32, ptr %9, align 4, !dbg !226
  %5498 = load i32, ptr %10, align 4, !dbg !227
  %5499 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %5497, i32 noundef %5498), !dbg !228
  %5500 = load i32, ptr %1, align 4, !dbg !229
  ret i32 %5500, !dbg !229
}
