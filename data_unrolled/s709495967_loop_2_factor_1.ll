...
11552:                                            ; preds = %11536, %11533
  ...
  br i1 %11553, label %11554, label %11558, !dbg !98
...
11558:                                            ; preds = %11552
  %11559 = load i32, ptr %3, align 4, !dbg !103
  %11560 = load i32, ptr %4, align 4, !dbg !105
  %11561 = add nsw i32 %11559, %11560, !dbg !106
  %11562 = icmp sge i32 %11561, 7, !dbg !107
  br i1 %11562, label %11563, label %11565, !dbg !108

11563:                                            ; preds = %11558
  %11564 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !109
  br label %11567, !dbg !111

11565:                                            ; preds = %11558
  %11566 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !112
  br label %11567

11567:                                            ; preds = %11565, %11563
  ret i32 0, !dbg !114
}
