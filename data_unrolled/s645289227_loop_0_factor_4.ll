...
74:                                               ; preds = %203, %73
  ...
  br i1 %76, label %77, label %206, !dbg !93
...
183:                                              ; preds = %180
  ...
  br label %196, !dbg !196

186:                                              ; preds = %180, %177, %170
  %187 = load i32, ptr %10, align 4, !dbg !197
  %188 = icmp eq i32 %187, 1, !dbg !200
  br i1 %188, label %192, label %189, !dbg !201

189:                                              ; preds = %186
  %190 = load i32, ptr %12, align 4, !dbg !202
  %191 = icmp eq i32 %190, 0, !dbg !203
  br i1 %191, label %192, label %195, !dbg !204

192:                                              ; preds = %189, %186
  %193 = load i32, ptr %9, align 4, !dbg !205
  %194 = add nsw i32 %193, 1, !dbg !205
  store i32 %194, ptr %9, align 4, !dbg !205
  br label %195, !dbg !207
...
202:                                              ; preds = %201, %87
  br label %203, !dbg !209

203:                                              ; preds = %202
  %204 = load i32, ptr %12, align 4, !dbg !210
  %205 = add nsw i32 %204, 1, !dbg !210
  store i32 %205, ptr %12, align 4, !dbg !210
  br label %74, !dbg !211, !llvm.loop !212

206:                                              ; preds = %74
  %207 = load i32, ptr %2, align 4, !dbg !214
  %208 = icmp sgt i32 %207, 0, !dbg !216
  br i1 %208, label %209, label %232, !dbg !217

209:                                              ; preds = %206
  %210 = load i32, ptr %3, align 4, !dbg !218
  %211 = icmp sgt i32 %210, 0, !dbg !219
  br i1 %211, label %212, label %232, !dbg !220

212:                                              ; preds = %209
  %213 = load i32, ptr %4, align 4, !dbg !221
  %214 = icmp sgt i32 %213, 0, !dbg !222
  br i1 %214, label %215, label %232, !dbg !223

215:                                              ; preds = %212
  %216 = load i32, ptr %5, align 4, !dbg !224
  %217 = icmp sgt i32 %216, 0, !dbg !225
  br i1 %217, label %218, label %232, !dbg !226

218:                                              ; preds = %215
  %219 = load i32, ptr %6, align 4, !dbg !227
  %220 = icmp sgt i32 %219, 0, !dbg !228
  br i1 %220, label %221, label %232, !dbg !229

221:                                              ; preds = %218
  %222 = load i32, ptr %7, align 4, !dbg !230
  %223 = icmp sgt i32 %222, 0, !dbg !231
  br i1 %223, label %224, label %232, !dbg !232

224:                                              ; preds = %221
  %225 = load i32, ptr %8, align 4, !dbg !233
  %226 = icmp sgt i32 %225, 0, !dbg !234
  br i1 %226, label %227, label %232, !dbg !235

227:                                              ; preds = %224
  %228 = load i32, ptr %9, align 4, !dbg !236
  %229 = icmp slt i32 %228, 2, !dbg !237
  br i1 %229, label %230, label %232, !dbg !238

230:                                              ; preds = %227
  %231 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !239
  br label %234, !dbg !241

232:                                              ; preds = %227, %224, %221, %218, %215, %212, %209, %206
  %233 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !242
  br label %234
