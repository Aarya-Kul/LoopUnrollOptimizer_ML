; ModuleID = 'data_unrolled/s682979499.ll'
...
26:                                               ; preds = %528, %11
  ...
  br i1 %29, label %30, label %531, !dbg !91
...
87:                                               ; preds = %86
  ...
  br i1 %92, label %93, label %531, !dbg !91
...
150:                                              ; preds = %149
  ...
  br i1 %155, label %156, label %531, !dbg !91
...
213:                                              ; preds = %212
  ...
  br i1 %218, label %219, label %531, !dbg !91
...
276:                                              ; preds = %275
  ...
  br i1 %281, label %282, label %531, !dbg !91
...
339:                                              ; preds = %338
  ...
  br i1 %344, label %345, label %531, !dbg !91
...
402:                                              ; preds = %401
  ...
  br i1 %407, label %408, label %531, !dbg !91
...
465:                                              ; preds = %464
  ...
  br i1 %470, label %471, label %531, !dbg !91
...
531:                                              ; preds = %465, %402, %339, %276, %213, %150, %87, %26
  ...
  br label %532, !dbg !134

532:                                              ; preds = %544, %531
  %533 = load i32, ptr %5, align 4, !dbg !135
  %534 = load i32, ptr %4, align 4, !dbg !137
  %535 = icmp slt i32 %533, %534, !dbg !138
  br i1 %535, label %536, label %547, !dbg !139

536:                                              ; preds = %532
  %537 = load ptr, ptr %3, align 8, !dbg !140
  %538 = load i32, ptr %5, align 4, !dbg !141
  %539 = sext i32 %538 to i64, !dbg !140
  %540 = getelementptr inbounds %struct.data, ptr %537, i64 %539, !dbg !140
  %541 = load i32, ptr %5, align 4, !dbg !142
  %542 = sext i32 %541 to i64, !dbg !143
  %543 = getelementptr inbounds [2001 x %struct.data], ptr @merge_sort.y, i64 0, i64 %542, !dbg !143
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %540, ptr align 8 %543, i64 8, i1 false), !dbg !143
  br label %544, !dbg !140

544:                                              ; preds = %536
  %545 = load i32, ptr %5, align 4, !dbg !144
  %546 = add nsw i32 %545, 1, !dbg !144
  store i32 %546, ptr %5, align 4, !dbg !144
  br label %532, !dbg !145, !llvm.loop !146
