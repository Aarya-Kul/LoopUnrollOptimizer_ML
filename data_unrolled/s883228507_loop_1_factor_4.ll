...
6563:                                             ; preds = %6666, %6649, %6632, %6615, %6598, %6581, %6564, %6548
  br label %6686, !dbg !101
...
6686:                                             ; preds = %6563
  %6687 = load i32, ptr %3, align 4, !dbg !107
  %6688 = sext i32 %6687 to i64, !dbg !109
  %6689 = getelementptr inbounds [101 x i8], ptr %5, i64 0, i64 %6688, !dbg !109
  %6690 = load i32, ptr %4, align 4, !dbg !110
  %6691 = add nsw i32 %6690, 1, !dbg !111
  %6692 = sext i32 %6691 to i64, !dbg !112
  %6693 = getelementptr inbounds [8 x i8], ptr %6, i64 0, i64 %6692, !dbg !112
  %6694 = call ptr @strstr(ptr noundef %6689, ptr noundef %6693) #5, !dbg !113
  store ptr %6694, ptr %7, align 8, !dbg !114
  %6695 = icmp ne ptr %6694, null, !dbg !115
  br i1 %6695, label %6696, label %6697, !dbg !116

6696:                                             ; preds = %6686
  store i32 1, ptr %2, align 4, !dbg !117
  br label %6697, !dbg !118

6697:                                             ; preds = %6696, %6686
  %6698 = load i32, ptr %2, align 4, !dbg !119
  %6699 = icmp ne i32 %6698, 0, !dbg !119
  br i1 %6699, label %6700, label %6702, !dbg !121

6700:                                             ; preds = %6697
  %6701 = call i32 @puts(ptr noundef @.str.1), !dbg !122
  br label %6704, !dbg !122

6702:                                             ; preds = %6697
  %6703 = call i32 @puts(ptr noundef @.str.2), !dbg !123
  br label %6704

6704:                                             ; preds = %6702, %6700
  ret i32 0, !dbg !124
}
