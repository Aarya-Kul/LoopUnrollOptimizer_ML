...
22:                                               ; preds = %54, %0
  ...
  br i1 %25, label %26, label %57, !dbg !83
...
57:                                               ; preds = %22
  %58 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !114
  %59 = load i32, ptr %58, align 16, !dbg !114
  %60 = getelementptr inbounds i32, ptr %21, i64 0, !dbg !115
  %61 = load i32, ptr %60, align 16, !dbg !115
  %62 = add nsw i32 %59, %61, !dbg !116
  %63 = call i32 @llvm.abs.i32(i32 %62, i1 true), !dbg !117
  %64 = srem i32 %63, 2, !dbg !118
  %65 = load i32, ptr %3, align 4, !dbg !119
  %66 = sub nsw i32 %65, %64, !dbg !119
  store i32 %66, ptr %3, align 4, !dbg !119
  %67 = load i32, ptr %3, align 4, !dbg !120
  %68 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %67), !dbg !121
  call void @llvm.dbg.declare(metadata ptr %9, metadata !122, metadata !DIExpression()), !dbg !124
  store i32 0, ptr %9, align 4, !dbg !124
  br label %69, !dbg !125

69:                                               ; preds = %76, %57
  %70 = load i32, ptr %9, align 4, !dbg !126
  %71 = load i32, ptr %3, align 4, !dbg !128
  %72 = sub nsw i32 %71, 1, !dbg !129
  %73 = icmp slt i32 %70, %72, !dbg !130
  br i1 %73, label %74, label %79, !dbg !131

74:                                               ; preds = %69
  %75 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !132
  br label %76, !dbg !134

76:                                               ; preds = %74
  %77 = load i32, ptr %9, align 4, !dbg !135
  %78 = add nsw i32 %77, 1, !dbg !135
  store i32 %78, ptr %9, align 4, !dbg !135
  br label %69, !dbg !136, !llvm.loop !137

79:                                               ; preds = %69
  %80 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !139
  call void @llvm.dbg.declare(metadata ptr %10, metadata !140, metadata !DIExpression()), !dbg !142
  store i32 0, ptr %10, align 4, !dbg !142
  br label %81, !dbg !143

81:                                               ; preds = %156, %79
  %82 = load i32, ptr %10, align 4, !dbg !144
  %83 = load i32, ptr %2, align 4, !dbg !146
  %84 = icmp slt i32 %82, %83, !dbg !147
  br i1 %84, label %85, label %159, !dbg !148
...
86:                                               ; preds = %105, %85
  %87 = load i32, ptr %11, align 4, !dbg !154
  %88 = load i32, ptr %10, align 4, !dbg !156
  %89 = sext i32 %88 to i64, !dbg !157
  %90 = getelementptr inbounds i32, ptr %18, i64 %89, !dbg !157
  %91 = load i32, ptr %90, align 4, !dbg !157
  %92 = call i32 @llvm.abs.i32(i32 %91, i1 true), !dbg !158
  %93 = icmp slt i32 %87, %92, !dbg !159
  br i1 %93, label %94, label %108, !dbg !160

94:                                               ; preds = %86
  %95 = load i32, ptr %10, align 4, !dbg !161
  %96 = sext i32 %95 to i64, !dbg !164
  %97 = getelementptr inbounds i32, ptr %18, i64 %96, !dbg !164
  %98 = load i32, ptr %97, align 4, !dbg !164
  %99 = icmp sgt i32 %98, 0, !dbg !165
  br i1 %99, label %100, label %102, !dbg !166

100:                                              ; preds = %94
  %101 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !167
  br label %104, !dbg !169

102:                                              ; preds = %94
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !170
  br label %104
...
105:                                              ; preds = %104
  %106 = load i32, ptr %11, align 4, !dbg !173
  %107 = add nsw i32 %106, 1, !dbg !173
  store i32 %107, ptr %11, align 4, !dbg !173
  br label %86, !dbg !174, !llvm.loop !175
...
109:                                              ; preds = %128, %108
  %110 = load i32, ptr %12, align 4, !dbg !181
  %111 = load i32, ptr %10, align 4, !dbg !183
  %112 = sext i32 %111 to i64, !dbg !184
  %113 = getelementptr inbounds i32, ptr %21, i64 %112, !dbg !184
  %114 = load i32, ptr %113, align 4, !dbg !184
  %115 = call i32 @llvm.abs.i32(i32 %114, i1 true), !dbg !185
  %116 = icmp slt i32 %110, %115, !dbg !186
  br i1 %116, label %117, label %131, !dbg !187

117:                                              ; preds = %109
  %118 = load i32, ptr %10, align 4, !dbg !188
  %119 = sext i32 %118 to i64, !dbg !191
  %120 = getelementptr inbounds i32, ptr %21, i64 %119, !dbg !191
  %121 = load i32, ptr %120, align 4, !dbg !191
  %122 = icmp sgt i32 %121, 0, !dbg !192
  br i1 %122, label %123, label %125, !dbg !193

123:                                              ; preds = %117
  %124 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !194
  br label %127, !dbg !196

125:                                              ; preds = %117
  %126 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !197
  br label %127
...
128:                                              ; preds = %127
  %129 = load i32, ptr %12, align 4, !dbg !200
  %130 = add nsw i32 %129, 1, !dbg !200
  store i32 %130, ptr %12, align 4, !dbg !200
  br label %109, !dbg !201, !llvm.loop !202
...
132:                                              ; preds = %151, %131
  %133 = load i32, ptr %13, align 4, !dbg !208
  %134 = load i32, ptr %3, align 4, !dbg !210
  %135 = load i32, ptr %10, align 4, !dbg !211
  %136 = sext i32 %135 to i64, !dbg !212
  %137 = getelementptr inbounds i32, ptr %18, i64 %136, !dbg !212
  %138 = load i32, ptr %137, align 4, !dbg !212
  %139 = call i32 @llvm.abs.i32(i32 %138, i1 true), !dbg !213
  %140 = sub nsw i32 %134, %139, !dbg !214
  %141 = load i32, ptr %10, align 4, !dbg !215
  %142 = sext i32 %141 to i64, !dbg !216
  %143 = getelementptr inbounds i32, ptr %21, i64 %142, !dbg !216
  %144 = load i32, ptr %143, align 4, !dbg !216
  %145 = call i32 @llvm.abs.i32(i32 %144, i1 true), !dbg !217
  %146 = sub nsw i32 %140, %145, !dbg !218
  %147 = sdiv i32 %146, 2, !dbg !219
  %148 = icmp slt i32 %133, %147, !dbg !220
  br i1 %148, label %149, label %154, !dbg !221

149:                                              ; preds = %132
  %150 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !222
  br label %151, !dbg !224

151:                                              ; preds = %149
  %152 = load i32, ptr %13, align 4, !dbg !225
  %153 = add nsw i32 %152, 1, !dbg !225
  store i32 %153, ptr %13, align 4, !dbg !225
  br label %132, !dbg !226, !llvm.loop !227

154:                                              ; preds = %132
  %155 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !229
  br label %156, !dbg !230

156:                                              ; preds = %154
  %157 = load i32, ptr %10, align 4, !dbg !231
  %158 = add nsw i32 %157, 1, !dbg !231
  store i32 %158, ptr %10, align 4, !dbg !231
  br label %81, !dbg !232, !llvm.loop !233

159:                                              ; preds = %81
  store i32 0, ptr %1, align 4, !dbg !235
  store i32 1, ptr %8, align 4
  br label %160, !dbg !235

160:                                              ; preds = %159, %51
  %161 = load ptr, ptr %4, align 8, !dbg !236
  call void @llvm.stackrestore.p0(ptr %161), !dbg !236
  %162 = load i32, ptr %1, align 4, !dbg !236
  ret i32 %162, !dbg !236
}
