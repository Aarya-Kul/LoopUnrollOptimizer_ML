...
4805:                                             ; preds = %4649
  %4806 = load i32, ptr %10, align 4, !dbg !279
  %4807 = icmp sgt i32 %4806, 0, !dbg !281
  br i1 %4807, label %4808, label %4810, !dbg !282

4808:                                             ; preds = %4805
  %4809 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !283
  br label %4812, !dbg !285

4810:                                             ; preds = %4805
  %4811 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !286
  br label %4812

4812:                                             ; preds = %4810, %4808
  br label %4813

4813:                                             ; preds = %4812, %4647
  ret i32 0, !dbg !288
}
