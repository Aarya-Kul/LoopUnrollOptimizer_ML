...
16:                                               ; preds = %293, %2
  ...
  br i1 %18, label %19, label %371, !dbg !111
...
60:                                               ; preds = %59
  ...
  br i1 %64, label %65, label %371, !dbg !111
...
66:                                               ; preds = %368, %65
  ...
  br i1 %69, label %360, label %70, !dbg !120
...
72:                                               ; preds = %357, %70
  ...
  br i1 %74, label %346, label %75, !dbg !139
...
79:                                               ; preds = %78
  ...
  br i1 %83, label %84, label %371, !dbg !111
...
98:                                               ; preds = %97
  ...
  br i1 %102, label %103, label %371, !dbg !111
...
117:                                              ; preds = %116
  ...
  br i1 %121, label %172, label %371, !dbg !111
...
186:                                              ; preds = %185
  ...
  br i1 %190, label %191, label %371, !dbg !111
...
205:                                              ; preds = %204
  ...
  br i1 %209, label %260, label %371, !dbg !111
...
261:                                              ; preds = %343, %260
  ...
  br i1 %264, label %335, label %265, !dbg !120
...
267:                                              ; preds = %332, %265
  ...
  br i1 %269, label %321, label %270, !dbg !139
...
274:                                              ; preds = %273
  ...
  br i1 %278, label %279, label %371, !dbg !111
...
280:                                              ; preds = %318, %279
  ...
  br i1 %283, label %310, label %284, !dbg !120
...
286:                                              ; preds = %307, %284
  ...
  br i1 %288, label %296, label %289, !dbg !139
...
296:                                              ; preds = %286
  %297 = load i32, ptr %7, align 4, !dbg !140
  %298 = load i32, ptr %9, align 4, !dbg !142
  %299 = add nsw i32 %297, %298, !dbg !143
  %300 = sub nsw i32 %299, 7, !dbg !144
  %301 = sext i32 %300 to i64, !dbg !145
  %302 = getelementptr inbounds [200 x i8], ptr %6, i64 0, i64 %301, !dbg !145
  %303 = load i8, ptr %302, align 1, !dbg !145
  %304 = load i32, ptr %9, align 4, !dbg !146
  %305 = sext i32 %304 to i64, !dbg !147
  %306 = getelementptr inbounds [7 x i8], ptr %10, i64 0, i64 %305, !dbg !147
  store i8 %303, ptr %306, align 1, !dbg !148
  br label %307, !dbg !149

307:                                              ; preds = %296
  %308 = load i32, ptr %9, align 4, !dbg !150
  %309 = add nsw i32 %308, 1, !dbg !150
  store i32 %309, ptr %9, align 4, !dbg !150
  br label %286, !dbg !151, !llvm.loop !152

310:                                              ; preds = %280
  %311 = load i32, ptr %9, align 4, !dbg !121
  %312 = sext i32 %311 to i64, !dbg !123
  %313 = getelementptr inbounds [200 x i8], ptr %6, i64 0, i64 %312, !dbg !123
  %314 = load i8, ptr %313, align 1, !dbg !123
  %315 = load i32, ptr %9, align 4, !dbg !124
  %316 = sext i32 %315 to i64, !dbg !125
  %317 = getelementptr inbounds [7 x i8], ptr %10, i64 0, i64 %316, !dbg !125
  store i8 %314, ptr %317, align 1, !dbg !126
  br label %318, !dbg !127

318:                                              ; preds = %310
  %319 = load i32, ptr %9, align 4, !dbg !128
  %320 = add nsw i32 %319, 1, !dbg !128
  store i32 %320, ptr %9, align 4, !dbg !128
  br label %280, !dbg !129, !llvm.loop !130

321:                                              ; preds = %267
  %322 = load i32, ptr %7, align 4, !dbg !140
  %323 = load i32, ptr %9, align 4, !dbg !142
  %324 = add nsw i32 %322, %323, !dbg !143
  %325 = sub nsw i32 %324, 7, !dbg !144
  %326 = sext i32 %325 to i64, !dbg !145
  %327 = getelementptr inbounds [200 x i8], ptr %6, i64 0, i64 %326, !dbg !145
  %328 = load i8, ptr %327, align 1, !dbg !145
  %329 = load i32, ptr %9, align 4, !dbg !146
  %330 = sext i32 %329 to i64, !dbg !147
  %331 = getelementptr inbounds [7 x i8], ptr %10, i64 0, i64 %330, !dbg !147
  store i8 %328, ptr %331, align 1, !dbg !148
  br label %332, !dbg !149

332:                                              ; preds = %321
  %333 = load i32, ptr %9, align 4, !dbg !150
  %334 = add nsw i32 %333, 1, !dbg !150
  store i32 %334, ptr %9, align 4, !dbg !150
  br label %267, !dbg !151, !llvm.loop !152

335:                                              ; preds = %261
  %336 = load i32, ptr %9, align 4, !dbg !121
  %337 = sext i32 %336 to i64, !dbg !123
  %338 = getelementptr inbounds [200 x i8], ptr %6, i64 0, i64 %337, !dbg !123
  %339 = load i8, ptr %338, align 1, !dbg !123
  %340 = load i32, ptr %9, align 4, !dbg !124
  %341 = sext i32 %340 to i64, !dbg !125
  %342 = getelementptr inbounds [7 x i8], ptr %10, i64 0, i64 %341, !dbg !125
  store i8 %339, ptr %342, align 1, !dbg !126
  br label %343, !dbg !127

343:                                              ; preds = %335
  %344 = load i32, ptr %9, align 4, !dbg !128
  %345 = add nsw i32 %344, 1, !dbg !128
  store i32 %345, ptr %9, align 4, !dbg !128
  br label %261, !dbg !129, !llvm.loop !130

346:                                              ; preds = %72
  %347 = load i32, ptr %7, align 4, !dbg !140
  %348 = load i32, ptr %9, align 4, !dbg !142
  %349 = add nsw i32 %347, %348, !dbg !143
  %350 = sub nsw i32 %349, 7, !dbg !144
  %351 = sext i32 %350 to i64, !dbg !145
  %352 = getelementptr inbounds [200 x i8], ptr %6, i64 0, i64 %351, !dbg !145
  %353 = load i8, ptr %352, align 1, !dbg !145
  %354 = load i32, ptr %9, align 4, !dbg !146
  %355 = sext i32 %354 to i64, !dbg !147
  %356 = getelementptr inbounds [7 x i8], ptr %10, i64 0, i64 %355, !dbg !147
  store i8 %353, ptr %356, align 1, !dbg !148
  br label %357, !dbg !149

357:                                              ; preds = %346
  %358 = load i32, ptr %9, align 4, !dbg !150
  %359 = add nsw i32 %358, 1, !dbg !150
  store i32 %359, ptr %9, align 4, !dbg !150
  br label %72, !dbg !151, !llvm.loop !152

360:                                              ; preds = %66
  %361 = load i32, ptr %9, align 4, !dbg !121
  %362 = sext i32 %361 to i64, !dbg !123
  %363 = getelementptr inbounds [200 x i8], ptr %6, i64 0, i64 %362, !dbg !123
  %364 = load i8, ptr %363, align 1, !dbg !123
  %365 = load i32, ptr %9, align 4, !dbg !124
  %366 = sext i32 %365 to i64, !dbg !125
  %367 = getelementptr inbounds [7 x i8], ptr %10, i64 0, i64 %366, !dbg !125
  store i8 %364, ptr %367, align 1, !dbg !126
  br label %368, !dbg !127

368:                                              ; preds = %360
  %369 = load i32, ptr %9, align 4, !dbg !128
  %370 = add nsw i32 %369, 1, !dbg !128
  store i32 %370, ptr %9, align 4, !dbg !128
  br label %66, !dbg !129, !llvm.loop !130

371:                                              ; preds = %274, %205, %186, %117, %98, %79, %60, %16
  %372 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !166
  store i32 0, ptr %3, align 4, !dbg !167
  br label %373, !dbg !167

373:                                              ; preds = %371, %57
  %374 = load i32, ptr %3, align 4, !dbg !168
  ret i32 %374, !dbg !168
}
