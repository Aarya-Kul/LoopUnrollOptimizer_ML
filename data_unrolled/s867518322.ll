...
53:                                               ; preds = %209, %52
  ...
  br i1 %55, label %56, label %212, !dbg !124
...
89:                                               ; preds = %205, %88
  ...
  br i1 %93, label %94, label %208, !dbg !174
...
200:                                              ; preds = %197, %194, %191, %184
  %201 = load i32, ptr %10, align 4, !dbg !268
  %202 = icmp eq i32 %201, 0, !dbg !270
  br i1 %202, label %203, label %204, !dbg !271
...
203:                                              ; preds = %200
  ...
  br label %204, !dbg !279

204:                                              ; preds = %203, %200
  br label %205, !dbg !280

205:                                              ; preds = %204
  %206 = load i32, ptr %3, align 4, !dbg !281
  %207 = add nsw i32 %206, 1, !dbg !281
  store i32 %207, ptr %3, align 4, !dbg !281
...
209:                                              ; preds = %208
  %210 = load i32, ptr %2, align 4, !dbg !286
  %211 = add nsw i32 %210, 1, !dbg !286
  store i32 %211, ptr %2, align 4, !dbg !286
  br label %53, !dbg !287, !llvm.loop !288

212:                                              ; preds = %53
  %213 = load i32, ptr %10, align 4, !dbg !290
  %214 = icmp sgt i32 %213, 0, !dbg !292
  br i1 %214, label %215, label %217, !dbg !293

215:                                              ; preds = %212
  %216 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !294
  br label %219, !dbg !296

217:                                              ; preds = %212
  %218 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !297
  br label %219
