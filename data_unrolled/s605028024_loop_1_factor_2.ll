...
3857:                                             ; preds = %3889, %3851
  ...
  br i1 %3867, label %3868, label %3892, !dbg !64
...
3872:                                             ; preds = %3871, %3868
  ...
  br i1 %3884, label %3885, label %3892, !dbg !64
...
3893:                                             ; preds = %3911, %3892
  %3894 = load ptr, ptr %7, align 8, !dbg !84
  %3895 = getelementptr inbounds i8, ptr %3894, i32 -1, !dbg !84
  store ptr %3895, ptr %7, align 8, !dbg !84
  %3896 = load i8, ptr %3894, align 1, !dbg !85
  %3897 = sext i8 %3896 to i32, !dbg !85
  %3898 = load i32, ptr %9, align 4, !dbg !86
  %3899 = sext i32 %3898 to i64, !dbg !87
  %3900 = getelementptr inbounds [8 x i8], ptr %2, i64 0, i64 %3899, !dbg !87
  %3901 = load i8, ptr %3900, align 1, !dbg !87
  %3902 = sext i8 %3901 to i32, !dbg !87
  %3903 = icmp eq i32 %3897, %3902, !dbg !88
  br i1 %3903, label %3904, label %3914, !dbg !83

3904:                                             ; preds = %3893
  %3905 = load i32, ptr %8, align 4, !dbg !89
  %3906 = sub nsw i32 7, %3905, !dbg !92
  %3907 = load i32, ptr %9, align 4, !dbg !93
  %3908 = sub nsw i32 7, %3907, !dbg !94
  %3909 = icmp eq i32 %3906, %3908, !dbg !95
  br i1 %3909, label %3910, label %3911, !dbg !96

3910:                                             ; preds = %3904
  store i32 1, ptr %4, align 4, !dbg !97
  br label %3911, !dbg !99

3911:                                             ; preds = %3910, %3904
  %3912 = load i32, ptr %9, align 4, !dbg !100
  %3913 = add nsw i32 %3912, -1, !dbg !100
  store i32 %3913, ptr %9, align 4, !dbg !100
  br label %3893, !dbg !83, !llvm.loop !101

3914:                                             ; preds = %3893
  %3915 = load i32, ptr %4, align 4, !dbg !103
  %3916 = icmp sgt i32 %3915, 0, !dbg !104
  br i1 %3916, label %3917, label %3919, !dbg !103

3917:                                             ; preds = %3914
  %3918 = call i32 @puts(ptr noundef @.str), !dbg !105
  br label %3921, !dbg !103

3919:                                             ; preds = %3914
  %3920 = call i32 @puts(ptr noundef @.str.1), !dbg !106
  br label %3921, !dbg !103

3921:                                             ; preds = %3919, %3917
  %3922 = phi i32 [ %3918, %3917 ], [ %3920, %3919 ], !dbg !103
  ret i32 0, !dbg !107
}
