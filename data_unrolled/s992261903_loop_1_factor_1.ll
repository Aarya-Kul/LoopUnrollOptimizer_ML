...
8466:                                             ; preds = %8482, %8464
  ...
  br i1 %8471, label %8472, label %8485, !dbg !93
...
8485:                                             ; preds = %8466
  ...
  store i32 %8486, ptr %5, align 4, !dbg !106
  %8487 = load ptr, ptr %6, align 8, !dbg !107
  %8488 = call i64 @strlen(ptr noundef %8487) #5, !dbg !109
  %8489 = load i32, ptr %2, align 4, !dbg !110
  %8490 = sext i32 %8489 to i64, !dbg !110
  %8491 = sub i64 %8488, %8490, !dbg !111
  %8492 = trunc i64 %8491 to i32, !dbg !109
  store i32 %8492, ptr %3, align 4, !dbg !112
  br label %8493, !dbg !113

8493:                                             ; preds = %8515, %8485
  %8494 = load i32, ptr %3, align 4, !dbg !114
  %8495 = icmp sge i32 %8494, 1, !dbg !116
  br i1 %8495, label %8496, label %8518, !dbg !117

8496:                                             ; preds = %8493
  %8497 = load i32, ptr %4, align 4, !dbg !118
  %8498 = load i32, ptr %3, align 4, !dbg !121
  %8499 = sub nsw i32 %8497, %8498, !dbg !122
  %8500 = sext i32 %8499 to i64, !dbg !123
  %8501 = getelementptr inbounds [100 x i8], ptr %7, i64 0, i64 %8500, !dbg !123
  %8502 = load i8, ptr %8501, align 1, !dbg !123
  %8503 = sext i8 %8502 to i32, !dbg !123
  %8504 = load ptr, ptr %6, align 8, !dbg !124
  %8505 = load i32, ptr %5, align 4, !dbg !125
  %8506 = add nsw i32 %8505, 1, !dbg !125
  store i32 %8506, ptr %5, align 4, !dbg !125
  %8507 = sext i32 %8505 to i64, !dbg !124
  %8508 = getelementptr inbounds i8, ptr %8504, i64 %8507, !dbg !124
  %8509 = load i8, ptr %8508, align 1, !dbg !124
  %8510 = sext i8 %8509 to i32, !dbg !124
  %8511 = icmp ne i32 %8503, %8510, !dbg !126
  br i1 %8511, label %8512, label %8514, !dbg !127

8512:                                             ; preds = %8496
  %8513 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !128
  store i32 0, ptr %1, align 4, !dbg !130
  br label %8520, !dbg !130

8514:                                             ; preds = %8496
  br label %8515, !dbg !131

8515:                                             ; preds = %8514
  %8516 = load i32, ptr %3, align 4, !dbg !132
  %8517 = add nsw i32 %8516, -1, !dbg !132
  store i32 %8517, ptr %3, align 4, !dbg !132
  br label %8493, !dbg !133, !llvm.loop !134

8518:                                             ; preds = %8493
  %8519 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %8520, !dbg !137

8520:                                             ; preds = %8518, %8512
  %8521 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %8521, !dbg !138
}
