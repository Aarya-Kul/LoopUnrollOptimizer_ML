...
4630:                                             ; preds = %4640, %4629
  ...
  br i1 %4637, label %4638, label %4643, !dbg !91
...
4643:                                             ; preds = %4630
  %4644 = load i32, ptr %12, align 4, !dbg !100
  %4645 = icmp eq i32 %4644, 0, !dbg !102
  br i1 %4645, label %4646, label %4656, !dbg !103

4646:                                             ; preds = %4643
  %4647 = getelementptr inbounds [1000 x i8], ptr %3, i64 0, i64 0, !dbg !104
  %4648 = load ptr, ptr %15, align 8, !dbg !106
  %4649 = load i32, ptr %8, align 4, !dbg !107
  %4650 = sext i32 %4649 to i64, !dbg !106
  %4651 = getelementptr inbounds i8, ptr %4648, i64 %4650, !dbg !106
  %4652 = load i32, ptr %9, align 4, !dbg !108
  %4653 = add nsw i32 %4652, 1, !dbg !109
  %4654 = sext i32 %4653 to i64, !dbg !108
  %4655 = call ptr @strncpy(ptr noundef %4647, ptr noundef %4651, i64 noundef %4654) #7, !dbg !110
  br label %4666, !dbg !111

4656:                                             ; preds = %4643
  %4657 = getelementptr inbounds [1000 x i8], ptr %3, i64 0, i64 0, !dbg !112
  %4658 = load ptr, ptr %15, align 8, !dbg !114
  %4659 = load i32, ptr %8, align 4, !dbg !115
  %4660 = add nsw i32 %4659, 1, !dbg !116
  %4661 = sext i32 %4660 to i64, !dbg !114
  %4662 = getelementptr inbounds i8, ptr %4658, i64 %4661, !dbg !114
  %4663 = load i32, ptr %9, align 4, !dbg !117
  %4664 = sext i32 %4663 to i64, !dbg !117
  %4665 = call ptr @strncpy(ptr noundef %4657, ptr noundef %4662, i64 noundef %4664) #7, !dbg !118
  br label %4666

4666:                                             ; preds = %4656, %4646
  %4667 = getelementptr inbounds [1000 x i8], ptr %3, i64 0, i64 0, !dbg !119
  %4668 = call i32 @atoi(ptr noundef %4667) #8, !dbg !120
  store i32 %4668, ptr %11, align 4, !dbg !121
  br label %4669, !dbg !122

4669:                                             ; preds = %4672, %4666
  %4670 = load i32, ptr %11, align 4, !dbg !123
  %4671 = icmp sgt i32 %4670, 0, !dbg !124
  br i1 %4671, label %4672, label %4683, !dbg !122

4672:                                             ; preds = %4669
  %4673 = load i32, ptr %4, align 4, !dbg !125
  %4674 = load i32, ptr %11, align 4, !dbg !127
  %4675 = srem i32 %4674, 10, !dbg !128
  %4676 = load i32, ptr %10, align 4, !dbg !129
  %4677 = mul nsw i32 %4675, %4676, !dbg !130
  %4678 = add nsw i32 %4673, %4677, !dbg !131
  store i32 %4678, ptr %4, align 4, !dbg !132
  %4679 = load i32, ptr %11, align 4, !dbg !133
  %4680 = sdiv i32 %4679, 10, !dbg !134
  store i32 %4680, ptr %11, align 4, !dbg !135
  %4681 = load i32, ptr %10, align 4, !dbg !136
  %4682 = mul nsw i32 %4681, 2, !dbg !137
  store i32 %4682, ptr %10, align 4, !dbg !138
  br label %4669, !dbg !122, !llvm.loop !139

4683:                                             ; preds = %4669
  %4684 = getelementptr inbounds [1000 x i8], ptr %3, i64 0, i64 0, !dbg !141
  %4685 = call i64 @strlen(ptr noundef %4684) #8, !dbg !143
  %4686 = load i32, ptr %2, align 4, !dbg !144
  %4687 = sext i32 %4686 to i64, !dbg !144
  %4688 = icmp ne i64 %4685, %4687, !dbg !145
  br i1 %4688, label %4689, label %4690, !dbg !146

4689:                                             ; preds = %4683
  store i32 0, ptr %1, align 4, !dbg !147
  br label %4739, !dbg !147

4690:                                             ; preds = %4683
  store i32 0, ptr %5, align 4, !dbg !149
  br label %4691, !dbg !151

4691:                                             ; preds = %4732, %4690
  %4692 = load i32, ptr %5, align 4, !dbg !152
  %4693 = load i32, ptr %4, align 4, !dbg !154
  %4694 = add nsw i32 %4693, 1, !dbg !155
  %4695 = icmp slt i32 %4692, %4694, !dbg !156
  br i1 %4695, label %4696, label %4735, !dbg !157

4696:                                             ; preds = %4691
  %4697 = load i32, ptr %5, align 4, !dbg !158
  store i32 %4697, ptr %7, align 4, !dbg !160
  store i32 0, ptr %13, align 4, !dbg !161
  br label %4698, !dbg !163

4698:                                             ; preds = %4725, %4696
  %4699 = load i32, ptr %6, align 4, !dbg !164
  %4700 = load i32, ptr %5, align 4, !dbg !166
  %4701 = icmp ne i32 %4699, %4700, !dbg !167
  br i1 %4701, label %4702, label %4728, !dbg !168

4702:                                             ; preds = %4698
  %4703 = load i32, ptr %13, align 4, !dbg !169
  %4704 = icmp ne i32 %4703, 0, !dbg !172
  br i1 %4704, label %4705, label %4707, !dbg !173

4705:                                             ; preds = %4702
  %4706 = load i32, ptr %6, align 4, !dbg !174
  store i32 %4706, ptr %7, align 4, !dbg !176
  br label %4707, !dbg !177

4707:                                             ; preds = %4705, %4702
  %4708 = load i32, ptr %7, align 4, !dbg !178
  %4709 = srem i32 %4708, 2, !dbg !180
  %4710 = icmp ne i32 %4709, 0, !dbg !181
  br i1 %4710, label %4711, label %4715, !dbg !182

4711:                                             ; preds = %4707
  %4712 = load i32, ptr %7, align 4, !dbg !183
  %4713 = sub nsw i32 %4712, 1, !dbg !185
  %4714 = sdiv i32 %4713, 2, !dbg !186
  store i32 %4714, ptr %6, align 4, !dbg !187
  br label %4724, !dbg !188

4715:                                             ; preds = %4707
  %4716 = load i32, ptr %7, align 4, !dbg !189
  %4717 = sdiv i32 %4716, 2, !dbg !191
  %4718 = load i32, ptr %2, align 4, !dbg !192
  %4719 = sub nsw i32 %4718, 1, !dbg !193
  %4720 = sitofp i32 %4719 to double, !dbg !192
  %4721 = call double @pow(double noundef 2.000000e+00, double noundef %4720) #7, !dbg !194
  %4722 = fptosi double %4721 to i32, !dbg !195
  %4723 = add nsw i32 %4717, %4722, !dbg !196
  store i32 %4723, ptr %6, align 4, !dbg !197
  br label %4724

4724:                                             ; preds = %4715, %4711
  br label %4725, !dbg !198

4725:                                             ; preds = %4724
  %4726 = load i32, ptr %13, align 4, !dbg !199
  %4727 = add nsw i32 %4726, 1, !dbg !199
  store i32 %4727, ptr %13, align 4, !dbg !199
  br label %4698, !dbg !200, !llvm.loop !201

4728:                                             ; preds = %4698
  %4729 = load i32, ptr %13, align 4, !dbg !203
  %4730 = load i32, ptr %14, align 4, !dbg !204
  %4731 = add nsw i32 %4730, %4729, !dbg !204
  store i32 %4731, ptr %14, align 4, !dbg !204
  br label %4732, !dbg !205

4732:                                             ; preds = %4728
  %4733 = load i32, ptr %5, align 4, !dbg !206
  %4734 = add nsw i32 %4733, 1, !dbg !206
  store i32 %4734, ptr %5, align 4, !dbg !206
  br label %4691, !dbg !207, !llvm.loop !208

4735:                                             ; preds = %4691
  %4736 = load i32, ptr %14, align 4, !dbg !210
  %4737 = srem i32 %4736, 998244353, !dbg !211
  %4738 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %4737), !dbg !212
  store i32 0, ptr %1, align 4, !dbg !213
  br label %4739, !dbg !213

4739:                                             ; preds = %4735, %4689
  %4740 = load i32, ptr %1, align 4, !dbg !214
  ret i32 %4740, !dbg !214
}
