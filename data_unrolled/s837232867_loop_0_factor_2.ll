...
20:                                               ; preds = %98, %0
  ...
  br i1 %23, label %24, label %101, !dbg !81
...
58:                                               ; preds = %52
  ...
  br i1 %63, label %64, label %101, !dbg !81
...
101:                                              ; preds = %58, %20
  %102 = load i32, ptr %11, align 4, !dbg !118
  %103 = sext i32 %102 to i64, !dbg !118
  %104 = load i64, ptr %2, align 8, !dbg !119
  %105 = sub i64 %104, %103, !dbg !119
  store i64 %105, ptr %2, align 8, !dbg !119
  br label %106, !dbg !120

106:                                              ; preds = %199, %101
  store i32 0, ptr %9, align 4, !dbg !121
  br label %107, !dbg !124

107:                                              ; preds = %192, %106
  %108 = load i32, ptr %9, align 4, !dbg !125
  %109 = icmp slt i32 %108, 4, !dbg !127
  br i1 %109, label %110, label %195, !dbg !128

110:                                              ; preds = %107
  store i32 0, ptr %11, align 4, !dbg !129
  store i64 0, ptr %3, align 8, !dbg !131
  store i32 0, ptr %10, align 4, !dbg !132
  br label %111, !dbg !134

111:                                              ; preds = %151, %110
  %112 = load i32, ptr %10, align 4, !dbg !135
  %113 = load i32, ptr %8, align 4, !dbg !137
  %114 = icmp slt i32 %112, %113, !dbg !138
  br i1 %114, label %115, label %154, !dbg !139

115:                                              ; preds = %111
  %116 = load i32, ptr %13, align 4, !dbg !140
  %117 = load i32, ptr %9, align 4, !dbg !142
  %118 = sext i32 %117 to i64, !dbg !143
  %119 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 %118, !dbg !143
  %120 = load i32, ptr %119, align 4, !dbg !143
  %121 = add nsw i32 %116, %120, !dbg !144
  %122 = load i32, ptr %10, align 4, !dbg !145
  %123 = sext i32 %122 to i64, !dbg !146
  %124 = getelementptr inbounds [100000 x i32], ptr @dx, i64 0, i64 %123, !dbg !146
  %125 = load i32, ptr %124, align 4, !dbg !146
  %126 = sub nsw i32 %121, %125, !dbg !147
  %127 = call i32 @llvm.abs.i32(i32 %126, i1 true), !dbg !148
  %128 = load i32, ptr %14, align 4, !dbg !149
  %129 = load i32, ptr %9, align 4, !dbg !150
  %130 = sext i32 %129 to i64, !dbg !151
  %131 = getelementptr inbounds [4 x i32], ptr %5, i64 0, i64 %130, !dbg !151
  %132 = load i32, ptr %131, align 4, !dbg !151
  %133 = add nsw i32 %128, %132, !dbg !152
  %134 = load i32, ptr %10, align 4, !dbg !153
  %135 = sext i32 %134 to i64, !dbg !154
  %136 = getelementptr inbounds [100000 x i32], ptr @dy, i64 0, i64 %135, !dbg !154
  %137 = load i32, ptr %136, align 4, !dbg !154
  %138 = sub nsw i32 %133, %137, !dbg !155
  %139 = call i32 @llvm.abs.i32(i32 %138, i1 true), !dbg !156
  %140 = add nsw i32 %127, %139, !dbg !157
  store i32 %140, ptr %12, align 4, !dbg !158
  %141 = load i32, ptr %11, align 4, !dbg !159
  %142 = load i32, ptr %12, align 4, !dbg !161
  %143 = icmp slt i32 %141, %142, !dbg !162
  br i1 %143, label %144, label %146, !dbg !163

144:                                              ; preds = %115
  %145 = load i32, ptr %12, align 4, !dbg !164
  store i32 %145, ptr %11, align 4, !dbg !165
  br label %146, !dbg !166

146:                                              ; preds = %144, %115
  %147 = load i32, ptr %12, align 4, !dbg !167
  %148 = sext i32 %147 to i64, !dbg !167
  %149 = load i64, ptr %3, align 8, !dbg !168
  %150 = add i64 %149, %148, !dbg !168
  store i64 %150, ptr %3, align 8, !dbg !168
  br label %151, !dbg !169

151:                                              ; preds = %146
  %152 = load i32, ptr %10, align 4, !dbg !170
  %153 = add nsw i32 %152, 1, !dbg !170
  store i32 %153, ptr %10, align 4, !dbg !170
  br label %111, !dbg !171, !llvm.loop !172

154:                                              ; preds = %111
  %155 = load i64, ptr %2, align 8, !dbg !174
  %156 = load i64, ptr %3, align 8, !dbg !176
  %157 = mul i64 %156, 2, !dbg !177
  %158 = load i32, ptr %11, align 4, !dbg !178
  %159 = sext i32 %158 to i64, !dbg !178
  %160 = sub i64 %157, %159, !dbg !179
  %161 = icmp ugt i64 %155, %160, !dbg !180
  br i1 %161, label %173, label %162, !dbg !181

162:                                              ; preds = %154
  %163 = load i64, ptr %2, align 8, !dbg !182
  %164 = load i64, ptr %3, align 8, !dbg !183
  %165 = mul i64 %164, 2, !dbg !184
  %166 = load i32, ptr %11, align 4, !dbg !185
  %167 = sext i32 %166 to i64, !dbg !185
  %168 = sub i64 %165, %167, !dbg !186
  %169 = icmp uge i64 %163, %168, !dbg !187
  br i1 %169, label %170, label %191, !dbg !188

170:                                              ; preds = %162
  %171 = load i32, ptr %9, align 4, !dbg !189
  %172 = icmp sgt i32 %171, 1, !dbg !190
  br i1 %172, label %173, label %191, !dbg !191

173:                                              ; preds = %170, %154
  %174 = load i64, ptr %3, align 8, !dbg !192
  %175 = mul i64 %174, 2, !dbg !194
  %176 = load i32, ptr %11, align 4, !dbg !195
  %177 = sext i32 %176 to i64, !dbg !195
  %178 = sub i64 %175, %177, !dbg !196
  store i64 %178, ptr %2, align 8, !dbg !197
  %179 = load i32, ptr %9, align 4, !dbg !198
  %180 = sext i32 %179 to i64, !dbg !199
  %181 = getelementptr inbounds [4 x i32], ptr %4, i64 0, i64 %180, !dbg !199
  %182 = load i32, ptr %181, align 4, !dbg !199
  %183 = load i32, ptr %13, align 4, !dbg !200
  %184 = add nsw i32 %183, %182, !dbg !200
  store i32 %184, ptr %13, align 4, !dbg !200
  %185 = load i32, ptr %9, align 4, !dbg !201
  %186 = sext i32 %185 to i64, !dbg !202
  %187 = getelementptr inbounds [4 x i32], ptr %5, i64 0, i64 %186, !dbg !202
  %188 = load i32, ptr %187, align 4, !dbg !202
  %189 = load i32, ptr %14, align 4, !dbg !203
  %190 = add nsw i32 %189, %188, !dbg !203
  store i32 %190, ptr %14, align 4, !dbg !203
  br label %195, !dbg !204

191:                                              ; preds = %170, %162
  br label %192, !dbg !205

192:                                              ; preds = %191
  %193 = load i32, ptr %9, align 4, !dbg !206
  %194 = add nsw i32 %193, 1, !dbg !206
  store i32 %194, ptr %9, align 4, !dbg !206
  br label %107, !dbg !207, !llvm.loop !208

195:                                              ; preds = %173, %107
  %196 = load i32, ptr %9, align 4, !dbg !210
  %197 = icmp eq i32 %196, 4, !dbg !212
  br i1 %197, label %198, label %199, !dbg !213

198:                                              ; preds = %195
  br label %200, !dbg !214

199:                                              ; preds = %195
  br label %106, !dbg !120, !llvm.loop !215

200:                                              ; preds = %198
  %201 = load i64, ptr %2, align 8, !dbg !217
  %202 = load i32, ptr %13, align 4, !dbg !218
  %203 = load i32, ptr %14, align 4, !dbg !219
  %204 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %201, i32 noundef %202, i32 noundef %203), !dbg !220
  ret i32 0, !dbg !221
}
