...
2481:                                             ; preds = %2478
  ...
  br label %2491, !dbg !195

2484:                                             ; preds = %2478, %2475, %2468
  %2485 = load i32, ptr %10, align 4, !dbg !196
  %2486 = icmp eq i32 %2485, 1, !dbg !199
  br i1 %2486, label %2487, label %2490, !dbg !200

2487:                                             ; preds = %2484
  %2488 = load i32, ptr %9, align 4, !dbg !201
  %2489 = add nsw i32 %2488, 1, !dbg !201
  store i32 %2489, ptr %9, align 4, !dbg !201
  br label %2490, !dbg !203

2490:                                             ; preds = %2487, %2484
  store i32 0, ptr %10, align 4, !dbg !204
  br label %2491

2491:                                             ; preds = %2490, %2481
  br label %2492

2492:                                             ; preds = %2491, %2465
  br label %2493

2493:                                             ; preds = %2492, %2449
  br label %2494

2494:                                             ; preds = %2493, %2433
  br label %2495

2495:                                             ; preds = %2494, %2417
  br label %2496

2496:                                             ; preds = %2495, %2401
  br label %2497

2497:                                             ; preds = %2496, %2385
  br label %2498, !dbg !205

2498:                                             ; preds = %2497
  %2499 = load i32, ptr %12, align 4, !dbg !206
  %2500 = add nsw i32 %2499, 1, !dbg !206
  store i32 %2500, ptr %12, align 4, !dbg !206
  br label %2372, !dbg !207, !llvm.loop !208

2501:                                             ; preds = %2372
  %2502 = load i32, ptr %2, align 4, !dbg !210
  %2503 = icmp sgt i32 %2502, 0, !dbg !212
  br i1 %2503, label %2504, label %2527, !dbg !213

2504:                                             ; preds = %2501
  %2505 = load i32, ptr %3, align 4, !dbg !214
  %2506 = icmp sgt i32 %2505, 0, !dbg !215
  br i1 %2506, label %2507, label %2527, !dbg !216

2507:                                             ; preds = %2504
  %2508 = load i32, ptr %4, align 4, !dbg !217
  %2509 = icmp sgt i32 %2508, 0, !dbg !218
  br i1 %2509, label %2510, label %2527, !dbg !219

2510:                                             ; preds = %2507
  %2511 = load i32, ptr %5, align 4, !dbg !220
  %2512 = icmp sgt i32 %2511, 0, !dbg !221
  br i1 %2512, label %2513, label %2527, !dbg !222

2513:                                             ; preds = %2510
  %2514 = load i32, ptr %6, align 4, !dbg !223
  %2515 = icmp sgt i32 %2514, 0, !dbg !224
  br i1 %2515, label %2516, label %2527, !dbg !225

2516:                                             ; preds = %2513
  %2517 = load i32, ptr %7, align 4, !dbg !226
  %2518 = icmp sgt i32 %2517, 0, !dbg !227
  br i1 %2518, label %2519, label %2527, !dbg !228

2519:                                             ; preds = %2516
  %2520 = load i32, ptr %8, align 4, !dbg !229
  %2521 = icmp sgt i32 %2520, 0, !dbg !230
  br i1 %2521, label %2522, label %2527, !dbg !231

2522:                                             ; preds = %2519
  %2523 = load i32, ptr %9, align 4, !dbg !232
  %2524 = icmp slt i32 %2523, 2, !dbg !233
  br i1 %2524, label %2525, label %2527, !dbg !234

2525:                                             ; preds = %2522
  %2526 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !235
  br label %2529, !dbg !237

2527:                                             ; preds = %2522, %2519, %2516, %2513, %2510, %2507, %2504, %2501
  %2528 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !238
  br label %2529
