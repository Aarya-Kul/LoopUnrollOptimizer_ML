...
8:                                                ; preds = %94, %0
  ...
  br i1 %10, label %11, label %97, !dbg !85
...
17:                                               ; preds = %11
  ...
  br i1 %21, label %22, label %97, !dbg !85
...
28:                                               ; preds = %22
  ...
  br i1 %32, label %33, label %97, !dbg !85
...
39:                                               ; preds = %33
  ...
  br i1 %43, label %44, label %97, !dbg !85
...
50:                                               ; preds = %44
  ...
  br i1 %54, label %55, label %97, !dbg !85
...
61:                                               ; preds = %55
  ...
  br i1 %65, label %66, label %97, !dbg !85
...
72:                                               ; preds = %66
  ...
  br i1 %76, label %77, label %97, !dbg !85
...
83:                                               ; preds = %77
  ...
  br i1 %87, label %88, label %97, !dbg !85
...
97:                                               ; preds = %83, %72, %61, %50, %39, %28, %17, %8
  %98 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %3), !dbg !99
  store i64 1, ptr %2, align 8, !dbg !100
  br label %99, !dbg !102

99:                                               ; preds = %112, %97
  %100 = load i64, ptr %2, align 8, !dbg !103
  %101 = load i64, ptr %3, align 8, !dbg !105
  %102 = icmp sle i64 %100, %101, !dbg !106
  br i1 %102, label %103, label %115, !dbg !107

103:                                              ; preds = %99
  %104 = load i64, ptr %2, align 8, !dbg !108
  %105 = load i64, ptr %2, align 8, !dbg !110
  %106 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %105, !dbg !111
  %107 = getelementptr inbounds [2 x i64], ptr %106, i64 0, i64 1, !dbg !111
  store i64 %104, ptr %107, align 8, !dbg !112
  %108 = load i64, ptr %2, align 8, !dbg !113
  %109 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %108, !dbg !114
  %110 = getelementptr inbounds [2 x i64], ptr %109, i64 0, i64 0, !dbg !114
  %111 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %110), !dbg !115
  br label %112, !dbg !116

112:                                              ; preds = %103
  %113 = load i64, ptr %2, align 8, !dbg !117
  %114 = add nsw i64 %113, 1, !dbg !117
  store i64 %114, ptr %2, align 8, !dbg !117
  br label %99, !dbg !118, !llvm.loop !119

115:                                              ; preds = %99
  %116 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 0, !dbg !121
  %117 = load i64, ptr %3, align 8, !dbg !122
  call void @qsort(ptr noundef %116, i64 noundef %117, i64 noundef 16, ptr noundef @compare_int), !dbg !123
  store i64 0, ptr %4, align 8, !dbg !124
  %118 = load i64, ptr %3, align 8, !dbg !125
  %119 = add nsw i64 %118, 1, !dbg !126
  store i64 %119, ptr %5, align 8, !dbg !127
  store i64 1, ptr %2, align 8, !dbg !128
  br label %120, !dbg !130

120:                                              ; preds = %168, %115
  %121 = load i64, ptr %2, align 8, !dbg !131
  %122 = load i64, ptr %3, align 8, !dbg !133
  %123 = icmp sle i64 %121, %122, !dbg !134
  br i1 %123, label %124, label %171, !dbg !135

124:                                              ; preds = %120
  %125 = load i64, ptr %4, align 8, !dbg !136
  %126 = load i64, ptr %5, align 8, !dbg !139
  %127 = load i64, ptr %2, align 8, !dbg !140
  %128 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %127, !dbg !141
  %129 = getelementptr inbounds [2 x i64], ptr %128, i64 0, i64 1, !dbg !141
  %130 = load i64, ptr %129, align 8, !dbg !141
  %131 = call i32 @LorR(i64 noundef %125, i64 noundef %126, i64 noundef %130), !dbg !142
  %132 = icmp eq i32 %131, 1, !dbg !143
  br i1 %132, label %133, label %150, !dbg !144

133:                                              ; preds = %124
  %134 = load i64, ptr %2, align 8, !dbg !145
  %135 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %134, !dbg !147
  %136 = getelementptr inbounds [2 x i64], ptr %135, i64 0, i64 0, !dbg !147
  %137 = load i64, ptr %136, align 16, !dbg !147
  %138 = load i64, ptr %5, align 8, !dbg !148
  %139 = sub nsw i64 %138, 1, !dbg !149
  %140 = load i64, ptr %2, align 8, !dbg !150
  %141 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %140, !dbg !151
  %142 = getelementptr inbounds [2 x i64], ptr %141, i64 0, i64 1, !dbg !151
  %143 = load i64, ptr %142, align 8, !dbg !151
  %144 = sub nsw i64 %139, %143, !dbg !152
  %145 = mul nsw i64 %137, %144, !dbg !153
  %146 = load i64, ptr %7, align 8, !dbg !154
  %147 = add nsw i64 %146, %145, !dbg !154
  store i64 %147, ptr %7, align 8, !dbg !154
  %148 = load i64, ptr %5, align 8, !dbg !155
  %149 = add nsw i64 %148, -1, !dbg !155
  store i64 %149, ptr %5, align 8, !dbg !155
  br label %167, !dbg !156

150:                                              ; preds = %124
  %151 = load i64, ptr %2, align 8, !dbg !157
  %152 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %151, !dbg !159
  %153 = getelementptr inbounds [2 x i64], ptr %152, i64 0, i64 0, !dbg !159
  %154 = load i64, ptr %153, align 16, !dbg !159
  %155 = load i64, ptr %2, align 8, !dbg !160
  %156 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %155, !dbg !161
  %157 = getelementptr inbounds [2 x i64], ptr %156, i64 0, i64 1, !dbg !161
  %158 = load i64, ptr %157, align 8, !dbg !161
  %159 = load i64, ptr %4, align 8, !dbg !162
  %160 = sub nsw i64 %158, %159, !dbg !163
  %161 = add nsw i64 %160, 1, !dbg !164
  %162 = mul nsw i64 %154, %161, !dbg !165
  %163 = load i64, ptr %7, align 8, !dbg !166
  %164 = add nsw i64 %163, %162, !dbg !166
  store i64 %164, ptr %7, align 8, !dbg !166
  %165 = load i64, ptr %4, align 8, !dbg !167
  %166 = add nsw i64 %165, 1, !dbg !167
  store i64 %166, ptr %4, align 8, !dbg !167
  br label %167
...
168:                                              ; preds = %167
  %169 = load i64, ptr %2, align 8, !dbg !169
  %170 = add nsw i64 %169, 1, !dbg !169
  store i64 %170, ptr %2, align 8, !dbg !169
  br label %120, !dbg !170, !llvm.loop !171

171:                                              ; preds = %120
  %172 = load i64, ptr %7, align 8, !dbg !173
  %173 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %172), !dbg !174
  %174 = load i32, ptr %1, align 4, !dbg !175
  ret i32 %174, !dbg !175
}
