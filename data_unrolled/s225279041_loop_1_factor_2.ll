...
5481:                                             ; preds = %5480
  ...
  br i1 %5485, label %5486, label %5542, !dbg !225
...
5517:                                             ; preds = %5487
  %5518 = load i32, ptr %2, align 4, !dbg !237
  %5519 = sdiv i32 %5518, 2, !dbg !239
  %5520 = sext i32 %5519 to i64, !dbg !240
  %5521 = getelementptr inbounds [2 x i64], ptr %7, i64 0, i64 %5520, !dbg !240
  %5522 = load i64, ptr %5521, align 8, !dbg !240
  %5523 = load i32, ptr %2, align 4, !dbg !241
  %5524 = srem i32 %5523, 2, !dbg !242
  %5525 = sext i32 %5524 to i64, !dbg !243
  %5526 = getelementptr inbounds [2 x i64], ptr %8, i64 0, i64 %5525, !dbg !243
  %5527 = load i64, ptr %5526, align 8, !dbg !243
  %5528 = load i32, ptr %3, align 4, !dbg !244
  %5529 = sext i32 %5528 to i64, !dbg !245
  %5530 = getelementptr inbounds [100000 x i64], ptr @main.mx, i64 0, i64 %5529, !dbg !245
  %5531 = load i64, ptr %5530, align 8, !dbg !245
  %5532 = load i32, ptr %3, align 4, !dbg !246
  %5533 = sext i32 %5532 to i64, !dbg !247
  %5534 = getelementptr inbounds [100000 x i64], ptr @main.my, i64 0, i64 %5533, !dbg !247
  %5535 = load i64, ptr %5534, align 8, !dbg !247
  %5536 = call i64 @dist(i64 noundef %5522, i64 noundef %5527, i64 noundef %5531, i64 noundef %5535), !dbg !248
  %5537 = load i64, ptr %10, align 8, !dbg !249
  %5538 = add nsw i64 %5537, %5536, !dbg !249
  store i64 %5538, ptr %10, align 8, !dbg !249
  br label %5539, !dbg !250

5539:                                             ; preds = %5517
  %5540 = load i32, ptr %3, align 4, !dbg !251
  %5541 = add nsw i32 %5540, 1, !dbg !251
  store i32 %5541, ptr %3, align 4, !dbg !251
  br label %5487, !dbg !252, !llvm.loop !253

5542:                                             ; preds = %5481, %5425
  %5543 = load i64, ptr %9, align 8, !dbg !282
  %5544 = load i64, ptr %11, align 8, !dbg !283
  %5545 = load i64, ptr %12, align 8, !dbg !284
  %5546 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i64 noundef %5543, i64 noundef %5544, i64 noundef %5545), !dbg !285
  ret i32 0, !dbg !286
}
