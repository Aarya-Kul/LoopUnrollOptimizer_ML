...
5021:                                             ; preds = %5079, %5020
  ...
  br i1 %5025, label %5026, label %5108, !dbg !95
...
5062:                                             ; preds = %5058
  ...
  br i1 %5068, label %5069, label %5108, !dbg !95
...
5082:                                             ; preds = %5071
  %5083 = load i32, ptr %10, align 4, !dbg !107
  %5084 = icmp ne i32 %5083, 0, !dbg !110
  br i1 %5084, label %5085, label %5087, !dbg !111

5085:                                             ; preds = %5082
  %5086 = load i32, ptr %7, align 4, !dbg !112
  store i32 %5086, ptr %8, align 4, !dbg !114
  br label %5087, !dbg !115

5087:                                             ; preds = %5085, %5082
  %5088 = load i32, ptr %8, align 4, !dbg !116
  %5089 = srem i32 %5088, 2, !dbg !118
  %5090 = icmp ne i32 %5089, 0, !dbg !119
  br i1 %5090, label %5100, label %5091, !dbg !120

5091:                                             ; preds = %5087
  %5092 = load i32, ptr %8, align 4, !dbg !127
  %5093 = sdiv i32 %5092, 2, !dbg !129
  %5094 = load i32, ptr %2, align 4, !dbg !130
  %5095 = sub nsw i32 %5094, 1, !dbg !131
  %5096 = sitofp i32 %5095 to double, !dbg !130
  %5097 = call double @pow(double noundef 2.000000e+00, double noundef %5096) #7, !dbg !132
  %5098 = fptosi double %5097 to i32, !dbg !133
  %5099 = add nsw i32 %5093, %5098, !dbg !134
  store i32 %5099, ptr %7, align 4, !dbg !135
  br label %5104

5100:                                             ; preds = %5087
  %5101 = load i32, ptr %8, align 4, !dbg !121
  %5102 = sub nsw i32 %5101, 1, !dbg !123
  %5103 = sdiv i32 %5102, 2, !dbg !124
  store i32 %5103, ptr %7, align 4, !dbg !125
  br label %5104, !dbg !126

5104:                                             ; preds = %5100, %5091
  br label %5105, !dbg !136

5105:                                             ; preds = %5104
  %5106 = load i32, ptr %10, align 4, !dbg !137
  %5107 = add nsw i32 %5106, 1, !dbg !137
  store i32 %5107, ptr %10, align 4, !dbg !137
  br label %5071, !dbg !138, !llvm.loop !139

5108:                                             ; preds = %5062, %5021
  %5109 = load i32, ptr %11, align 4, !dbg !148
  %5110 = srem i32 %5109, 998244353, !dbg !149
  %5111 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5110), !dbg !150
  store i32 0, ptr %1, align 4, !dbg !151
  br label %5112, !dbg !151

5112:                                             ; preds = %5108, %5019
  %5113 = load i32, ptr %1, align 4, !dbg !152
  ret i32 %5113, !dbg !152
}
