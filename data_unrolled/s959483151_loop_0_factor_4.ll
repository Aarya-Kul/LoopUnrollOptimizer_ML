...
6:                                                ; preds = %134, %0
  ...
  br i1 %8, label %9, label %167, !dbg !152
...
24:                                               ; preds = %23
  ...
  br i1 %28, label %29, label %167, !dbg !152
...
30:                                               ; preds = %164, %29
  ...
  br i1 %32, label %157, label %33, !dbg !160
...
34:                                               ; preds = %33
  ...
  br i1 %38, label %39, label %167, !dbg !152
...
44:                                               ; preds = %43
  ...
  br i1 %48, label %49, label %167, !dbg !152
...
54:                                               ; preds = %53
  ...
  br i1 %58, label %79, label %167, !dbg !152
...
84:                                               ; preds = %83
  ...
  br i1 %88, label %89, label %167, !dbg !152
...
94:                                               ; preds = %93
  ...
  br i1 %98, label %119, label %167, !dbg !152
...
120:                                              ; preds = %154, %119
  ...
  br i1 %122, label %147, label %123, !dbg !160
...
124:                                              ; preds = %123
  ...
  br i1 %128, label %129, label %167, !dbg !152
...
130:                                              ; preds = %144, %129
  ...
  br i1 %132, label %137, label %133, !dbg !160
...
137:                                              ; preds = %130
  %138 = load i32, ptr %2, align 4, !dbg !161
  %139 = sext i32 %138 to i64, !dbg !162
  %140 = getelementptr inbounds [2048 x [2048 x i64]], ptr @DP, i64 0, i64 %139, !dbg !162
  %141 = load i32, ptr %3, align 4, !dbg !163
  %142 = sext i32 %141 to i64, !dbg !162
  %143 = getelementptr inbounds [2048 x i64], ptr %140, i64 0, i64 %142, !dbg !162
  store i64 -1, ptr %143, align 8, !dbg !164
  br label %144, !dbg !162

144:                                              ; preds = %137
  %145 = load i32, ptr %3, align 4, !dbg !165
  %146 = add nsw i32 %145, 1, !dbg !165
  store i32 %146, ptr %3, align 4, !dbg !165
  br label %130, !dbg !166, !llvm.loop !167

147:                                              ; preds = %120
  %148 = load i32, ptr %2, align 4, !dbg !161
  %149 = sext i32 %148 to i64, !dbg !162
  %150 = getelementptr inbounds [2048 x [2048 x i64]], ptr @DP, i64 0, i64 %149, !dbg !162
  %151 = load i32, ptr %3, align 4, !dbg !163
  %152 = sext i32 %151 to i64, !dbg !162
  %153 = getelementptr inbounds [2048 x i64], ptr %150, i64 0, i64 %152, !dbg !162
  store i64 -1, ptr %153, align 8, !dbg !164
  br label %154, !dbg !162

154:                                              ; preds = %147
  %155 = load i32, ptr %3, align 4, !dbg !165
  %156 = add nsw i32 %155, 1, !dbg !165
  store i32 %156, ptr %3, align 4, !dbg !165
...
167:                                              ; preds = %124, %94, %84, %54, %44, %34, %24, %6
  call void @llvm.dbg.declare(metadata ptr %4, metadata !174, metadata !DIExpression()), !dbg !176
  store i32 0, ptr %4, align 4, !dbg !176
  br label %168, !dbg !177

168:                                              ; preds = %185, %167
  %169 = load i32, ptr %4, align 4, !dbg !178
  %170 = load i32, ptr @N, align 4, !dbg !180
  %171 = icmp slt i32 %169, %170, !dbg !181
  br i1 %171, label %172, label %188, !dbg !182

172:                                              ; preds = %168
  %173 = load i32, ptr %4, align 4, !dbg !183
  %174 = sext i32 %173 to i64, !dbg !185
  %175 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %174, !dbg !185
  %176 = getelementptr inbounds %struct.Child, ptr %175, i32 0, i32 0, !dbg !186
  %177 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.1, ptr noundef %176), !dbg !187
  %178 = load i32, ptr %4, align 4, !dbg !188
  %179 = add nsw i32 %178, 1, !dbg !189
  %180 = sext i32 %179 to i64, !dbg !188
  %181 = load i32, ptr %4, align 4, !dbg !190
  %182 = sext i32 %181 to i64, !dbg !191
  %183 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %182, !dbg !191
  %184 = getelementptr inbounds %struct.Child, ptr %183, i32 0, i32 1, !dbg !192
  store i64 %180, ptr %184, align 8, !dbg !193
  br label %185, !dbg !194

185:                                              ; preds = %172
  %186 = load i32, ptr %4, align 4, !dbg !195
  %187 = add nsw i32 %186, 1, !dbg !195
  store i32 %187, ptr %4, align 4, !dbg !195
  br label %168, !dbg !196, !llvm.loop !197

188:                                              ; preds = %168
  %189 = load i32, ptr @N, align 4, !dbg !199
  %190 = sext i32 %189 to i64, !dbg !199
  call void @qsort(ptr noundef @A, i64 noundef %190, i64 noundef 16, ptr noundef @ascend), !dbg !200
  %191 = load i32, ptr @N, align 4, !dbg !201
  %192 = sext i32 %191 to i64, !dbg !201
  %193 = call i64 @assign(i64 noundef 1, i64 noundef %192), !dbg !202
  %194 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %193), !dbg !203
  ret i32 0, !dbg !204
}
