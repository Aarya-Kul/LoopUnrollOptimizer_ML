...
67:                                               ; preds = %27
  ...
  br i1 %69, label %70, label %404, !dbg !279
...
118:                                              ; preds = %400, %116
  ...
  br i1 %121, label %122, label %403, !dbg !331
...
256:                                              ; preds = %395, %255
  ...
  br i1 %258, label %259, label %398, !dbg !455
...
259:                                              ; preds = %256
  ...
  %301 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %300, !dbg !486
  %302 = load i32, ptr %301, align 4, !dbg !486
  %303 = load i32, ptr %3, align 4, !dbg !487
  %304 = sub nsw i32 %303, 1, !dbg !488
  %305 = sext i32 %304 to i64, !dbg !489
  %306 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %305, !dbg !489
  %307 = load i32, ptr %306, align 4, !dbg !489
  %308 = icmp sgt i32 %302, %307, !dbg !490
  br i1 %308, label %309, label %322, !dbg !491

309:                                              ; preds = %259
  %310 = load i32, ptr %3, align 4, !dbg !492
  %311 = sext i32 %310 to i64, !dbg !493
  %312 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %311, !dbg !493
  %313 = load i32, ptr %312, align 4, !dbg !493
  %314 = load i32, ptr %3, align 4, !dbg !494
  %315 = sub nsw i32 %314, 1, !dbg !495
  %316 = sext i32 %315 to i64, !dbg !496
  %317 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %316, !dbg !496
  %318 = load i32, ptr %317, align 4, !dbg !496
  %319 = icmp sgt i32 %313, %318, !dbg !497
  br i1 %319, label %320, label %322, !dbg !498

320:                                              ; preds = %309
  %321 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !499
  br label %322, !dbg !499

322:                                              ; preds = %320, %309, %259
  %323 = load i32, ptr %3, align 4, !dbg !500
  %324 = sext i32 %323 to i64, !dbg !502
  %325 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %324, !dbg !502
  ...
  %330 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %329, !dbg !505
  %331 = load i32, ptr %330, align 4, !dbg !505
  %332 = icmp sgt i32 %326, %331, !dbg !506
  br i1 %332, label %333, label %346, !dbg !507

333:                                              ; preds = %322
  %334 = load i32, ptr %3, align 4, !dbg !508
  %335 = sext i32 %334 to i64, !dbg !509
  %336 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %335, !dbg !509
  %337 = load i32, ptr %336, align 4, !dbg !509
  %338 = load i32, ptr %3, align 4, !dbg !510
  %339 = sub nsw i32 %338, 1, !dbg !511
  %340 = sext i32 %339 to i64, !dbg !512
  %341 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %340, !dbg !512
  %342 = load i32, ptr %341, align 4, !dbg !512
  %343 = icmp slt i32 %337, %342, !dbg !513
  br i1 %343, label %344, label %346, !dbg !514

344:                                              ; preds = %333
  %345 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !515
  br label %346, !dbg !515

346:                                              ; preds = %344, %333, %322
  %347 = load i32, ptr %3, align 4, !dbg !516
  %348 = sext i32 %347 to i64, !dbg !518
  %349 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %348, !dbg !518
  %350 = load i32, ptr %349, align 4, !dbg !518
  %351 = load i32, ptr %3, align 4, !dbg !519
  %352 = sub nsw i32 %351, 1, !dbg !520
  %353 = sext i32 %352 to i64, !dbg !521
  %354 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %353, !dbg !521
  %355 = load i32, ptr %354, align 4, !dbg !521
  %356 = icmp slt i32 %350, %355, !dbg !522
  br i1 %356, label %357, label %370, !dbg !523

357:                                              ; preds = %346
  %358 = load i32, ptr %3, align 4, !dbg !524
  %359 = sext i32 %358 to i64, !dbg !525
  %360 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %359, !dbg !525
  %361 = load i32, ptr %360, align 4, !dbg !525
  %362 = load i32, ptr %3, align 4, !dbg !526
  %363 = sub nsw i32 %362, 1, !dbg !527
  %364 = sext i32 %363 to i64, !dbg !528
  %365 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %364, !dbg !528
  %366 = load i32, ptr %365, align 4, !dbg !528
  %367 = icmp sgt i32 %361, %366, !dbg !529
  br i1 %367, label %368, label %370, !dbg !530

368:                                              ; preds = %357
  %369 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !531
  br label %370, !dbg !531

370:                                              ; preds = %368, %357, %346
  %371 = load i32, ptr %3, align 4, !dbg !532
  %372 = sext i32 %371 to i64, !dbg !534
  %373 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %372, !dbg !534
  %374 = load i32, ptr %373, align 4, !dbg !534
  %375 = load i32, ptr %3, align 4, !dbg !535
  %376 = sub nsw i32 %375, 1, !dbg !536
  %377 = sext i32 %376 to i64, !dbg !537
  %378 = getelementptr inbounds [32 x i32], ptr %13, i64 0, i64 %377, !dbg !537
  %379 = load i32, ptr %378, align 4, !dbg !537
  %380 = icmp slt i32 %374, %379, !dbg !538
  br i1 %380, label %381, label %394, !dbg !539

381:                                              ; preds = %370
  %382 = load i32, ptr %3, align 4, !dbg !540
  %383 = sext i32 %382 to i64, !dbg !541
  %384 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %383, !dbg !541
  %385 = load i32, ptr %384, align 4, !dbg !541
  %386 = load i32, ptr %3, align 4, !dbg !542
  %387 = sub nsw i32 %386, 1, !dbg !543
  %388 = sext i32 %387 to i64, !dbg !544
  %389 = getelementptr inbounds [32 x i32], ptr %14, i64 0, i64 %388, !dbg !544
  %390 = load i32, ptr %389, align 4, !dbg !544
  %391 = icmp slt i32 %385, %390, !dbg !545
  br i1 %391, label %392, label %394, !dbg !546

392:                                              ; preds = %381
  %393 = call i32 (ptr, ...) @printf(ptr noundef @.str.12), !dbg !547
  br label %394, !dbg !547

394:                                              ; preds = %392, %381, %370
  br label %395, !dbg !548

395:                                              ; preds = %394
  %396 = load i32, ptr %3, align 4, !dbg !549
  %397 = add nsw i32 %396, 1, !dbg !549
  store i32 %397, ptr %3, align 4, !dbg !549
  br label %256, !dbg !550, !llvm.loop !551

398:                                              ; preds = %256
  %399 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !553
  br label %400, !dbg !554

400:                                              ; preds = %398
  %401 = load i32, ptr %2, align 4, !dbg !333
  %402 = add nsw i32 %401, 1, !dbg !333
  store i32 %402, ptr %2, align 4, !dbg !333
  br label %118, !dbg !333, !llvm.loop !555

403:                                              ; preds = %118
  br label %404, !dbg !557

404:                                              ; preds = %403, %67
  %405 = load i32, ptr %8, align 4, !dbg !558
  %406 = icmp eq i32 %405, 1, !dbg !560
  br i1 %406, label %407, label %409, !dbg !561

407:                                              ; preds = %404
  %408 = load i32, ptr %6, align 4, !dbg !562
  call void @print(i32 noundef %408), !dbg !563
  br label %409, !dbg !563

409:                                              ; preds = %407, %404
  store i32 0, ptr %1, align 4, !dbg !564
  %410 = load ptr, ptr %9, align 8, !dbg !565
  call void @llvm.stackrestore.p0(ptr %410), !dbg !565
  %411 = load i32, ptr %1, align 4, !dbg !565
  ret i32 %411, !dbg !565
}
