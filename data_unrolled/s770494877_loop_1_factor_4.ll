...
9:                                                ; preds = %6, %3
  ...
  br i1 %10, label %11, label %229, !dbg !157
...
16:                                               ; preds = %12
  ...
  br i1 %21, label %.loopexit.loopexit, label %23, !dbg !179

.loopexit.loopexit:                               ; preds = %16
  br label %.loopexit, !dbg !180

.loopexit.loopexit2:                              ; preds = %99
  br label %.loopexit, !dbg !180

.loopexit.loopexit4:                              ; preds = %155
  br label %.loopexit, !dbg !180

.loopexit.loopexit6:                              ; preds = %209
  br label %.loopexit, !dbg !180

.loopexit:                                        ; preds = %.loopexit.loopexit6, %.loopexit.loopexit4, %.loopexit.loopexit2, %.loopexit.loopexit
  br label %22, !dbg !180

.loopexit1.loopexit:                              ; preds = %219
  br label %.loopexit1, !dbg !180

.loopexit1.loopexit3:                             ; preds = %89
  br label %.loopexit1, !dbg !180

.loopexit1.loopexit5:                             ; preds = %145
  br label %.loopexit1, !dbg !180

.loopexit1.loopexit7:                             ; preds = %199
  br label %.loopexit1, !dbg !180
...
38:                                               ; preds = %35, %27
  ...
  br i1 %39, label %40, label %229, !dbg !157
...
41:                                               ; preds = %226, %40
  ...
  br i1 %44, label %219, label %45, !dbg !172
...
56:                                               ; preds = %53, %45
  ...
  br i1 %57, label %58, label %229, !dbg !157
...
74:                                               ; preds = %71, %63
  ...
  br i1 %75, label %76, label %229, !dbg !157
...
89:                                               ; preds = %77
  ...
  br i1 %94, label %.loopexit1.loopexit3, label %95, !dbg !179
...
99:                                               ; preds = %59
  ...
  br i1 %104, label %.loopexit.loopexit2, label %105, !dbg !179
...
112:                                              ; preds = %109, %81
  ...
  br i1 %113, label %114, label %229, !dbg !157
...
130:                                              ; preds = %127, %119
  ...
  br i1 %131, label %132, label %229, !dbg !157
...
145:                                              ; preds = %133
  ...
  br i1 %150, label %.loopexit1.loopexit5, label %151, !dbg !179
...
155:                                              ; preds = %115
  ...
  br i1 %160, label %.loopexit.loopexit4, label %161, !dbg !179
...
168:                                              ; preds = %165, %137
  ...
  br i1 %169, label %170, label %229, !dbg !157
...
171:                                              ; preds = %216, %170
  ...
  br i1 %174, label %209, label %175, !dbg !172
...
186:                                              ; preds = %183, %175
  ...
  br i1 %187, label %188, label %229, !dbg !157
...
189:                                              ; preds = %206, %188
  ...
  br i1 %192, label %199, label %193, !dbg !172
...
199:                                              ; preds = %189
  %200 = load i32, ptr %2, align 4, !dbg !173
  %201 = sext i32 %200 to i64, !dbg !176
  %202 = getelementptr inbounds [300 x i32], ptr @w, i64 0, i64 %201, !dbg !176
  %203 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %202), !dbg !177
  %204 = icmp ne i32 %203, 1, !dbg !178
  br i1 %204, label %.loopexit1.loopexit7, label %205, !dbg !179

205:                                              ; preds = %199
  br label %206, !dbg !181

206:                                              ; preds = %205
  %207 = load i32, ptr %2, align 4, !dbg !182
  %208 = add nsw i32 %207, 1, !dbg !182
  store i32 %208, ptr %2, align 4, !dbg !182
  br label %189, !dbg !183, !llvm.loop !184

209:                                              ; preds = %171
  %210 = load i32, ptr %2, align 4, !dbg !173
  %211 = sext i32 %210 to i64, !dbg !176
  %212 = getelementptr inbounds [300 x i32], ptr @w, i64 0, i64 %211, !dbg !176
  %213 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %212), !dbg !177
  %214 = icmp ne i32 %213, 1, !dbg !178
  br i1 %214, label %.loopexit.loopexit6, label %215, !dbg !179

215:                                              ; preds = %209
  br label %216, !dbg !181

216:                                              ; preds = %215
  %217 = load i32, ptr %2, align 4, !dbg !182
  %218 = add nsw i32 %217, 1, !dbg !182
  store i32 %218, ptr %2, align 4, !dbg !182
  br label %171, !dbg !183, !llvm.loop !184

219:                                              ; preds = %41
  %220 = load i32, ptr %2, align 4, !dbg !173
  %221 = sext i32 %220 to i64, !dbg !176
  %222 = getelementptr inbounds [300 x i32], ptr @w, i64 0, i64 %221, !dbg !176
  %223 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %222), !dbg !177
  %224 = icmp ne i32 %223, 1, !dbg !178
  br i1 %224, label %.loopexit1.loopexit, label %225, !dbg !179

225:                                              ; preds = %219
  br label %226, !dbg !181

226:                                              ; preds = %225
  %227 = load i32, ptr %2, align 4, !dbg !182
  %228 = add nsw i32 %227, 1, !dbg !182
  store i32 %228, ptr %2, align 4, !dbg !182
  br label %41, !dbg !183, !llvm.loop !184

229:                                              ; preds = %186, %168, %130, %112, %74, %56, %38, %9
  store i32 0, ptr %1, align 4, !dbg !194
  br label %230, !dbg !194

230:                                              ; preds = %229, %22
  %231 = load i32, ptr %1, align 4, !dbg !195
  ret i32 %231, !dbg !195
}
