...
5025:                                             ; preds = %5004
  %5026 = getelementptr inbounds [3 x i32], ptr %5, i64 0, i64 0, !dbg !85
  %5027 = load i32, ptr %5026, align 4, !dbg !85
  %5028 = mul nsw i32 %5027, 100, !dbg !86
  %5029 = getelementptr inbounds [3 x i32], ptr %5, i64 0, i64 1, !dbg !87
  %5030 = load i32, ptr %5029, align 4, !dbg !87
  %5031 = mul nsw i32 %5030, 10, !dbg !88
  %5032 = add nsw i32 %5028, %5031, !dbg !89
  %5033 = getelementptr inbounds [3 x i32], ptr %5, i64 0, i64 2, !dbg !90
  %5034 = load i32, ptr %5033, align 4, !dbg !90
  %5035 = add nsw i32 %5032, %5034, !dbg !91
  %5036 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5035), !dbg !92
  ret i32 0, !dbg !93
}
