...
824:                                              ; preds = %804, %787, %770, %753, %736, %719, %702, %685, %668, %651, %634, %617, %600, %583, %566, %549, %532, %515, %498, %481, %464, %447, %430, %413, %396, %379, %362, %345, %328, %311, %294, %277, %260, %243, %226, %209, %192, %175, %158, %141, %124, %107, %90, %73, %56, %39, %22, %7
  %825 = load ptr, ptr %4, align 8, !dbg !59
  %826 = load i32, ptr %6, align 4, !dbg !61
  %827 = sext i32 %826 to i64, !dbg !62
  %828 = getelementptr inbounds i8, ptr %825, i64 %827, !dbg !62
  %829 = load ptr, ptr %5, align 8, !dbg !63
  %830 = load i32, ptr %6, align 4, !dbg !64
  %831 = sext i32 %830 to i64, !dbg !65
  %832 = getelementptr inbounds i8, ptr %829, i64 %831, !dbg !65
  %833 = call ptr @strstr(ptr noundef %828, ptr noundef %832) #4, !dbg !66
  %834 = icmp ne ptr %833, null, !dbg !66
  br i1 %834, label %835, label %836, !dbg !67
...
837:                                              ; preds = %836, %835
  %838 = load i32, ptr %3, align 4, !dbg !70
  ret i32 %838, !dbg !70
}
