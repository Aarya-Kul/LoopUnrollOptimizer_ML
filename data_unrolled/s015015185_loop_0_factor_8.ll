...
8163:                                             ; preds = %8097
  %8164 = load i64, ptr %8, align 8, !dbg !189
  %8165 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %8164), !dbg !190
  store i32 0, ptr %1, align 4, !dbg !191
  %8166 = load ptr, ptr %3, align 8, !dbg !192
  call void @llvm.stackrestore.p0(ptr %8166), !dbg !192
  %8167 = load i32, ptr %1, align 4, !dbg !192
  ret i32 %8167, !dbg !192
}
