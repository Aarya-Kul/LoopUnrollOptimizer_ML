...
27:                                               ; preds = %67, %0
  ...
  br i1 %30, label %31, label %70, !dbg !85
...
46:                                               ; preds = %31
  ...
  br i1 %51, label %52, label %70, !dbg !85
...
70:                                               ; preds = %46, %27
  ...
  %71 = load i32, ptr %2, align 4, !dbg !110
  %72 = sub nsw i32 %71, 1, !dbg !111
  store i32 %72, ptr %10, align 4, !dbg !109
  %73 = load i32, ptr %2, align 4, !dbg !112
  %74 = sext i32 %73 to i64, !dbg !112
  call void @qsort(ptr noundef %23, i64 noundef %74, i64 noundef 8, ptr noundef @cmp), !dbg !113
  call void @llvm.dbg.declare(metadata ptr %11, metadata !114, metadata !DIExpression()), !dbg !116
  store i32 0, ptr %11, align 4, !dbg !116
  br label %75, !dbg !117

75:                                               ; preds = %138, %70
  %76 = load i32, ptr %11, align 4, !dbg !118
  %77 = load i32, ptr %2, align 4, !dbg !120
  %78 = icmp slt i32 %76, %77, !dbg !121
  br i1 %78, label %79, label %141, !dbg !122
...
80:                                               ; preds = %134, %79
  %81 = load i32, ptr %12, align 4, !dbg !128
  %82 = load i32, ptr %2, align 4, !dbg !130
  %83 = icmp slt i32 %81, %82, !dbg !131
  br i1 %83, label %84, label %137, !dbg !132

84:                                               ; preds = %80
  call void @llvm.dbg.declare(metadata ptr %13, metadata !133, metadata !DIExpression()), !dbg !135
  %85 = load i32, ptr %2, align 4, !dbg !136
  %86 = load i32, ptr %11, align 4, !dbg !137
  %87 = sub nsw i32 %85, %86, !dbg !138
  %88 = sub nsw i32 %87, 1, !dbg !139
  %89 = sext i32 %88 to i64, !dbg !140
  %90 = getelementptr inbounds i64, ptr %23, i64 %89, !dbg !140
  %91 = load i64, ptr %90, align 8, !dbg !140
  store i64 %91, ptr %13, align 8, !dbg !135
  %92 = load i32, ptr %12, align 4, !dbg !141
  %93 = sext i32 %92 to i64, !dbg !143
  %94 = getelementptr inbounds i64, ptr %20, i64 %93, !dbg !143
  %95 = load i64, ptr %94, align 8, !dbg !143
  %96 = load i64, ptr %13, align 8, !dbg !144
  %97 = icmp eq i64 %95, %96, !dbg !145
  br i1 %97, label %98, label %133, !dbg !146

98:                                               ; preds = %84
  call void @llvm.dbg.declare(metadata ptr %14, metadata !147, metadata !DIExpression()), !dbg !149
  %99 = load i32, ptr %12, align 4, !dbg !150
  %100 = load i32, ptr %9, align 4, !dbg !151
  %101 = sub nsw i32 %99, %100, !dbg !152
  store i32 %101, ptr %14, align 4, !dbg !149
  call void @llvm.dbg.declare(metadata ptr %15, metadata !153, metadata !DIExpression()), !dbg !154
  %102 = load i32, ptr %10, align 4, !dbg !155
  %103 = load i32, ptr %12, align 4, !dbg !156
  %104 = sub nsw i32 %102, %103, !dbg !157
  store i32 %104, ptr %15, align 4, !dbg !154
  %105 = load i32, ptr %14, align 4, !dbg !158
  %106 = load i32, ptr %15, align 4, !dbg !160
  %107 = icmp slt i32 %105, %106, !dbg !161
  br i1 %107, label %108, label %120, !dbg !162

108:                                              ; preds = %98
  %109 = load i32, ptr %15, align 4, !dbg !163
  %110 = sext i32 %109 to i64, !dbg !163
  %111 = load i32, ptr %12, align 4, !dbg !165
  %112 = sext i32 %111 to i64, !dbg !166
  %113 = getelementptr inbounds i64, ptr %20, i64 %112, !dbg !166
  %114 = load i64, ptr %113, align 8, !dbg !166
  %115 = mul nsw i64 %110, %114, !dbg !167
  %116 = load i64, ptr %8, align 8, !dbg !168
  %117 = add nsw i64 %116, %115, !dbg !168
  store i64 %117, ptr %8, align 8, !dbg !168
  %118 = load i32, ptr %10, align 4, !dbg !169
  %119 = add nsw i32 %118, -1, !dbg !169
  store i32 %119, ptr %10, align 4, !dbg !169
  br label %132, !dbg !170

120:                                              ; preds = %98
  %121 = load i32, ptr %14, align 4, !dbg !171
  %122 = sext i32 %121 to i64, !dbg !171
  %123 = load i32, ptr %12, align 4, !dbg !173
  %124 = sext i32 %123 to i64, !dbg !174
  %125 = getelementptr inbounds i64, ptr %20, i64 %124, !dbg !174
  %126 = load i64, ptr %125, align 8, !dbg !174
  %127 = mul nsw i64 %122, %126, !dbg !175
  %128 = load i64, ptr %8, align 8, !dbg !176
  %129 = add nsw i64 %128, %127, !dbg !176
  store i64 %129, ptr %8, align 8, !dbg !176
  %130 = load i32, ptr %9, align 4, !dbg !177
  %131 = add nsw i32 %130, 1, !dbg !177
  store i32 %131, ptr %9, align 4, !dbg !177
  br label %132

132:                                              ; preds = %120, %108
  br label %133, !dbg !178

133:                                              ; preds = %132, %84
  br label %134, !dbg !179

134:                                              ; preds = %133
  %135 = load i32, ptr %12, align 4, !dbg !180
  %136 = add nsw i32 %135, 1, !dbg !180
  store i32 %136, ptr %12, align 4, !dbg !180
  br label %80, !dbg !181, !llvm.loop !182

137:                                              ; preds = %80
  br label %138, !dbg !184

138:                                              ; preds = %137
  %139 = load i32, ptr %11, align 4, !dbg !185
  %140 = add nsw i32 %139, 1, !dbg !185
  store i32 %140, ptr %11, align 4, !dbg !185
  br label %75, !dbg !186, !llvm.loop !187

141:                                              ; preds = %75
  %142 = load i64, ptr %8, align 8, !dbg !189
  %143 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %142), !dbg !190
  store i32 0, ptr %1, align 4, !dbg !191
  %144 = load ptr, ptr %3, align 8, !dbg !192
  call void @llvm.stackrestore.p0(ptr %144), !dbg !192
  %145 = load i32, ptr %1, align 4, !dbg !192
  ret i32 %145, !dbg !192
}
