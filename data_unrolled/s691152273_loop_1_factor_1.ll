...
8890:                                             ; preds = %8885, %8867
  %8891 = load i32, ptr %4, align 4, !dbg !127
  %8892 = sub nsw i32 %8891, 1, !dbg !129
  %8893 = load i32, ptr %5, align 4, !dbg !130
  %8894 = icmp eq i32 %8892, %8893, !dbg !131
  br i1 %8894, label %8895, label %8897, !dbg !132

8895:                                             ; preds = %8890
  %8896 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !133
  br label %8899, !dbg !135

8897:                                             ; preds = %8890
  %8898 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !136
  br label %8899

8899:                                             ; preds = %8897, %8895
  store i32 0, ptr %1, align 4, !dbg !138
  br label %8900, !dbg !138

8900:                                             ; preds = %8899, %25, %14
  %8901 = load i32, ptr %1, align 4, !dbg !139
  ret i32 %8901, !dbg !139
}
