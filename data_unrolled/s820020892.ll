...
22:                                               ; preds = %56, %0
  ...
  br i1 %25, label %26, label %59, !dbg !83
...
26:                                               ; preds = %22
  ...
  %45 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !98
  %46 = load i32, ptr %45, align 16, !dbg !98
  %47 = getelementptr inbounds i32, ptr %21, i64 0, !dbg !99
  %48 = load i32, ptr %47, align 16, !dbg !99
  %49 = add nsw i32 %46, %48, !dbg !100
  %50 = call i32 @llvm.abs.i32(i32 %49, i1 true), !dbg !101
  %51 = srem i32 %50, 2, !dbg !102
  %52 = icmp ne i32 %44, %51, !dbg !103
  br i1 %52, label %53, label %55, !dbg !104

53:                                               ; preds = %26
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !105
  store i32 0, ptr %1, align 4, !dbg !107
  store i32 1, ptr %8, align 4
  br label %162, !dbg !107

55:                                               ; preds = %26
  br label %56, !dbg !108

56:                                               ; preds = %55
  %57 = load i32, ptr %7, align 4, !dbg !109
  %58 = add nsw i32 %57, 1, !dbg !109
  store i32 %58, ptr %7, align 4, !dbg !109
  br label %22, !dbg !110, !llvm.loop !111

59:                                               ; preds = %22
  %60 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !114
  %61 = load i32, ptr %60, align 16, !dbg !114
  %62 = getelementptr inbounds i32, ptr %21, i64 0, !dbg !115
  %63 = load i32, ptr %62, align 16, !dbg !115
  %64 = add nsw i32 %61, %63, !dbg !116
  %65 = call i32 @llvm.abs.i32(i32 %64, i1 true), !dbg !117
  %66 = srem i32 %65, 2, !dbg !118
  %67 = load i32, ptr %3, align 4, !dbg !119
  %68 = sub nsw i32 %67, %66, !dbg !119
  store i32 %68, ptr %3, align 4, !dbg !119
  %69 = load i32, ptr %3, align 4, !dbg !120
  %70 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %69), !dbg !121
  call void @llvm.dbg.declare(metadata ptr %9, metadata !122, metadata !DIExpression()), !dbg !124
  store i32 0, ptr %9, align 4, !dbg !124
  br label %71, !dbg !125

71:                                               ; preds = %78, %59
  %72 = load i32, ptr %9, align 4, !dbg !126
  %73 = load i32, ptr %3, align 4, !dbg !128
  %74 = sub nsw i32 %73, 1, !dbg !129
  %75 = icmp slt i32 %72, %74, !dbg !130
  br i1 %75, label %76, label %81, !dbg !131

76:                                               ; preds = %71
  %77 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !132
  br label %78, !dbg !134

78:                                               ; preds = %76
  %79 = load i32, ptr %9, align 4, !dbg !135
  %80 = add nsw i32 %79, 1, !dbg !135
  store i32 %80, ptr %9, align 4, !dbg !135
  br label %71, !dbg !136, !llvm.loop !137

81:                                               ; preds = %71
  %82 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !139
  call void @llvm.dbg.declare(metadata ptr %10, metadata !140, metadata !DIExpression()), !dbg !142
  store i32 0, ptr %10, align 4, !dbg !142
  br label %83, !dbg !143

83:                                               ; preds = %158, %81
  %84 = load i32, ptr %10, align 4, !dbg !144
  %85 = load i32, ptr %2, align 4, !dbg !146
  %86 = icmp slt i32 %84, %85, !dbg !147
  br i1 %86, label %87, label %161, !dbg !148
...
88:                                               ; preds = %107, %87
  %89 = load i32, ptr %11, align 4, !dbg !154
  %90 = load i32, ptr %10, align 4, !dbg !156
  %91 = sext i32 %90 to i64, !dbg !157
  %92 = getelementptr inbounds i32, ptr %18, i64 %91, !dbg !157
  %93 = load i32, ptr %92, align 4, !dbg !157
  %94 = call i32 @llvm.abs.i32(i32 %93, i1 true), !dbg !158
  %95 = icmp slt i32 %89, %94, !dbg !159
  br i1 %95, label %96, label %110, !dbg !160

96:                                               ; preds = %88
  %97 = load i32, ptr %10, align 4, !dbg !161
  %98 = sext i32 %97 to i64, !dbg !164
  %99 = getelementptr inbounds i32, ptr %18, i64 %98, !dbg !164
  %100 = load i32, ptr %99, align 4, !dbg !164
  %101 = icmp sgt i32 %100, 0, !dbg !165
  br i1 %101, label %102, label %104, !dbg !166

102:                                              ; preds = %96
  %103 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !167
  br label %106, !dbg !169

104:                                              ; preds = %96
  %105 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !170
  br label %106
...
107:                                              ; preds = %106
  %108 = load i32, ptr %11, align 4, !dbg !173
  %109 = add nsw i32 %108, 1, !dbg !173
  store i32 %109, ptr %11, align 4, !dbg !173
  br label %88, !dbg !174, !llvm.loop !175

110:                                              ; preds = %88
  call void @llvm.dbg.declare(metadata ptr %12, metadata !177, metadata !DIExpression()), !dbg !179
  store i32 0, ptr %12, align 4, !dbg !179
  br label %111, !dbg !180

111:                                              ; preds = %130, %110
  %112 = load i32, ptr %12, align 4, !dbg !181
  %113 = load i32, ptr %10, align 4, !dbg !183
  %114 = sext i32 %113 to i64, !dbg !184
  %115 = getelementptr inbounds i32, ptr %21, i64 %114, !dbg !184
  %116 = load i32, ptr %115, align 4, !dbg !184
  %117 = call i32 @llvm.abs.i32(i32 %116, i1 true), !dbg !185
  %118 = icmp slt i32 %112, %117, !dbg !186
  br i1 %118, label %119, label %133, !dbg !187

119:                                              ; preds = %111
  %120 = load i32, ptr %10, align 4, !dbg !188
  %121 = sext i32 %120 to i64, !dbg !191
  %122 = getelementptr inbounds i32, ptr %21, i64 %121, !dbg !191
  %123 = load i32, ptr %122, align 4, !dbg !191
  %124 = icmp sgt i32 %123, 0, !dbg !192
  br i1 %124, label %125, label %127, !dbg !193

125:                                              ; preds = %119
  %126 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !194
  br label %129, !dbg !196

127:                                              ; preds = %119
  %128 = call i32 (ptr, ...) @printf(ptr noundef @.str.9), !dbg !197
  br label %129
...
130:                                              ; preds = %129
  %131 = load i32, ptr %12, align 4, !dbg !200
  %132 = add nsw i32 %131, 1, !dbg !200
  store i32 %132, ptr %12, align 4, !dbg !200
  br label %111, !dbg !201, !llvm.loop !202
...
134:                                              ; preds = %153, %133
  %135 = load i32, ptr %13, align 4, !dbg !208
  %136 = load i32, ptr %3, align 4, !dbg !210
  %137 = load i32, ptr %10, align 4, !dbg !211
  %138 = sext i32 %137 to i64, !dbg !212
  %139 = getelementptr inbounds i32, ptr %18, i64 %138, !dbg !212
  %140 = load i32, ptr %139, align 4, !dbg !212
  %141 = call i32 @llvm.abs.i32(i32 %140, i1 true), !dbg !213
  %142 = sub nsw i32 %136, %141, !dbg !214
  %143 = load i32, ptr %10, align 4, !dbg !215
  %144 = sext i32 %143 to i64, !dbg !216
  %145 = getelementptr inbounds i32, ptr %21, i64 %144, !dbg !216
  %146 = load i32, ptr %145, align 4, !dbg !216
  %147 = call i32 @llvm.abs.i32(i32 %146, i1 true), !dbg !217
  %148 = sub nsw i32 %142, %147, !dbg !218
  %149 = sdiv i32 %148, 2, !dbg !219
  %150 = icmp slt i32 %135, %149, !dbg !220
  br i1 %150, label %151, label %156, !dbg !221

151:                                              ; preds = %134
  %152 = call i32 (ptr, ...) @printf(ptr noundef @.str.10), !dbg !222
  br label %153, !dbg !224

153:                                              ; preds = %151
  %154 = load i32, ptr %13, align 4, !dbg !225
  %155 = add nsw i32 %154, 1, !dbg !225
  store i32 %155, ptr %13, align 4, !dbg !225
  br label %134, !dbg !226, !llvm.loop !227

156:                                              ; preds = %134
  %157 = call i32 (ptr, ...) @printf(ptr noundef @.str.11), !dbg !229
  br label %158, !dbg !230

158:                                              ; preds = %156
  %159 = load i32, ptr %10, align 4, !dbg !231
  %160 = add nsw i32 %159, 1, !dbg !231
  store i32 %160, ptr %10, align 4, !dbg !231
  br label %83, !dbg !232, !llvm.loop !233
...
162:                                              ; preds = %161, %53
  %163 = load ptr, ptr %4, align 8, !dbg !236
  call void @llvm.stackrestore.p0(ptr %163), !dbg !236
  %164 = load i32, ptr %1, align 4, !dbg !236
  ret i32 %164, !dbg !236
}
