...
61:                                               ; preds = %54, %10
  ...
  %63 = icmp sle i32 %62, 1, !dbg !102
  br i1 %63, label %64, label %72, !dbg !103

64:                                               ; preds = %61
  %65 = load i32, ptr %4, align 4, !dbg !104
  %66 = sext i32 %65 to i64, !dbg !104
  %67 = getelementptr inbounds [8 x i8], ptr %3, i64 0, i64 0, !dbg !105
  %68 = call i64 @strlen(ptr noundef %67) #5, !dbg !106
  %69 = icmp eq i64 %66, %68, !dbg !107
  br i1 %69, label %70, label %72, !dbg !108

70:                                               ; preds = %64
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !109
  br label %74, !dbg !109

72:                                               ; preds = %64, %61
  %73 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !110
  br label %74
