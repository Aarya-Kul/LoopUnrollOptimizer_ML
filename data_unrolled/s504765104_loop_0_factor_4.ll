...
219:                                              ; preds = %246, %214
  ...
  br i1 %221, label %222, label %249, !dbg !108
...
237:                                              ; preds = %222
  br label %249, !dbg !120

238:                                              ; preds = %234
  %239 = load i32, ptr %4, align 4, !dbg !122
  %240 = sub nsw i32 %239, 1, !dbg !124
  %241 = load i32, ptr %5, align 4, !dbg !125
  %242 = icmp eq i32 %240, %241, !dbg !126
  br i1 %242, label %243, label %245, !dbg !127

243:                                              ; preds = %238
  %244 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !128
  store i32 0, ptr %1, align 4, !dbg !130
  br label %251, !dbg !130

245:                                              ; preds = %238
  br label %246, !dbg !131

246:                                              ; preds = %245
  %247 = load i32, ptr %7, align 4, !dbg !132
  %248 = add nsw i32 %247, -1, !dbg !132
  store i32 %248, ptr %7, align 4, !dbg !132
  br label %219, !dbg !133, !llvm.loop !134

249:                                              ; preds = %237, %219
  %250 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !136
  store i32 0, ptr %1, align 4, !dbg !137
  br label %251, !dbg !137

251:                                              ; preds = %249, %243, %25, %14
  %252 = load i32, ptr %1, align 4, !dbg !138
  ret i32 %252, !dbg !138
}
