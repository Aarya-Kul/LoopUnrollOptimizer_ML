...
5387:                                             ; preds = %5384
  ...
  %5393 = zext i1 %5392 to i64, !dbg !67
  %5394 = select i1 %5392, i32 9, i32 1, !dbg !67
  %5395 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5394), !dbg !68
  br label %5396, !dbg !69

5396:                                             ; preds = %5387
  %5397 = load i32, ptr %2, align 4, !dbg !70
  %5398 = add nsw i32 %5397, 1, !dbg !70
  store i32 %5398, ptr %2, align 4, !dbg !70
  br label %5384, !dbg !71, !llvm.loop !72

5399:                                             ; preds = %5384
  %5400 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !74
  ret i32 0, !dbg !75
}
