...
12288:                                            ; preds = %12284
  ...
  %12292 = getelementptr inbounds %struct.Child, ptr %12291, i32 0, i32 0, !dbg !186
  %12293 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str.1, ptr noundef %12292), !dbg !187
  %12294 = load i32, ptr %4, align 4, !dbg !188
  %12295 = add nsw i32 %12294, 1, !dbg !189
  %12296 = sext i32 %12295 to i64, !dbg !188
  %12297 = load i32, ptr %4, align 4, !dbg !190
  %12298 = sext i32 %12297 to i64, !dbg !191
  %12299 = getelementptr inbounds [2048 x %struct.Child], ptr @A, i64 0, i64 %12298, !dbg !191
  %12300 = getelementptr inbounds %struct.Child, ptr %12299, i32 0, i32 1, !dbg !192
  store i64 %12296, ptr %12300, align 8, !dbg !193
  br label %12301, !dbg !194

12301:                                            ; preds = %12288
  %12302 = load i32, ptr %4, align 4, !dbg !195
  %12303 = add nsw i32 %12302, 1, !dbg !195
  store i32 %12303, ptr %4, align 4, !dbg !195
  br label %12284, !dbg !196, !llvm.loop !197

12304:                                            ; preds = %12284
  %12305 = load i32, ptr @N, align 4, !dbg !199
  %12306 = sext i32 %12305 to i64, !dbg !199
  call void @qsort(ptr noundef @A, i64 noundef %12306, i64 noundef 16, ptr noundef @ascend), !dbg !200
  %12307 = load i32, ptr @N, align 4, !dbg !201
  %12308 = sext i32 %12307 to i64, !dbg !201
  %12309 = call i64 @assign(i64 noundef 1, i64 noundef %12308), !dbg !202
  %12310 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %12309), !dbg !203
  ret i32 0, !dbg !204
}
