...
4235:                                             ; preds = %4248, %4233
  ...
  br i1 %4238, label %4239, label %4251, !dbg !112
...
4239:                                             ; preds = %4235
  ...
  %4246 = getelementptr inbounds [2 x i64], ptr %4245, i64 0, i64 0, !dbg !119
  %4247 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %4246), !dbg !120
  br label %4248, !dbg !121

4248:                                             ; preds = %4239
  %4249 = load i64, ptr %2, align 8, !dbg !122
  %4250 = add nsw i64 %4249, 1, !dbg !122
  store i64 %4250, ptr %2, align 8, !dbg !122
  br label %4235, !dbg !123, !llvm.loop !124

4251:                                             ; preds = %4235
  %4252 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 0, !dbg !126
  %4253 = load i64, ptr %3, align 8, !dbg !127
  call void @qsort(ptr noundef %4252, i64 noundef %4253, i64 noundef 16, ptr noundef @compare_int), !dbg !128
  store i64 0, ptr %4, align 8, !dbg !129
  %4254 = load i64, ptr %3, align 8, !dbg !130
  %4255 = add nsw i64 %4254, 1, !dbg !131
  store i64 %4255, ptr %5, align 8, !dbg !132
  store i64 1, ptr %2, align 8, !dbg !133
  br label %4256, !dbg !135

4256:                                             ; preds = %4304, %4251
  %4257 = load i64, ptr %2, align 8, !dbg !136
  %4258 = load i64, ptr %3, align 8, !dbg !138
  %4259 = icmp sle i64 %4257, %4258, !dbg !139
  br i1 %4259, label %4260, label %4307, !dbg !140

4260:                                             ; preds = %4256
  %4261 = load i64, ptr %4, align 8, !dbg !141
  %4262 = load i64, ptr %5, align 8, !dbg !144
  %4263 = load i64, ptr %2, align 8, !dbg !145
  %4264 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4263, !dbg !146
  %4265 = getelementptr inbounds [2 x i64], ptr %4264, i64 0, i64 1, !dbg !146
  %4266 = load i64, ptr %4265, align 8, !dbg !146
  %4267 = call i32 @LorR(i64 noundef %4261, i64 noundef %4262, i64 noundef %4266), !dbg !147
  %4268 = icmp eq i32 %4267, 1, !dbg !148
  br i1 %4268, label %4269, label %4286, !dbg !149

4269:                                             ; preds = %4260
  %4270 = load i64, ptr %2, align 8, !dbg !150
  %4271 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4270, !dbg !152
  %4272 = getelementptr inbounds [2 x i64], ptr %4271, i64 0, i64 0, !dbg !152
  %4273 = load i64, ptr %4272, align 16, !dbg !152
  %4274 = load i64, ptr %5, align 8, !dbg !153
  %4275 = sub nsw i64 %4274, 1, !dbg !154
  %4276 = load i64, ptr %2, align 8, !dbg !155
  %4277 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4276, !dbg !156
  %4278 = getelementptr inbounds [2 x i64], ptr %4277, i64 0, i64 1, !dbg !156
  %4279 = load i64, ptr %4278, align 8, !dbg !156
  %4280 = sub nsw i64 %4275, %4279, !dbg !157
  %4281 = mul nsw i64 %4273, %4280, !dbg !158
  %4282 = load i64, ptr %7, align 8, !dbg !159
  %4283 = add nsw i64 %4282, %4281, !dbg !159
  store i64 %4283, ptr %7, align 8, !dbg !159
  %4284 = load i64, ptr %5, align 8, !dbg !160
  %4285 = add nsw i64 %4284, -1, !dbg !160
  store i64 %4285, ptr %5, align 8, !dbg !160
  br label %4303, !dbg !161

4286:                                             ; preds = %4260
  %4287 = load i64, ptr %2, align 8, !dbg !162
  %4288 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4287, !dbg !164
  %4289 = getelementptr inbounds [2 x i64], ptr %4288, i64 0, i64 0, !dbg !164
  %4290 = load i64, ptr %4289, align 16, !dbg !164
  %4291 = load i64, ptr %2, align 8, !dbg !165
  %4292 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4291, !dbg !166
  %4293 = getelementptr inbounds [2 x i64], ptr %4292, i64 0, i64 1, !dbg !166
  %4294 = load i64, ptr %4293, align 8, !dbg !166
  %4295 = load i64, ptr %4, align 8, !dbg !167
  %4296 = sub nsw i64 %4294, %4295, !dbg !168
  %4297 = add nsw i64 %4296, 1, !dbg !169
  %4298 = mul nsw i64 %4290, %4297, !dbg !170
  %4299 = load i64, ptr %7, align 8, !dbg !171
  %4300 = add nsw i64 %4299, %4298, !dbg !171
  store i64 %4300, ptr %7, align 8, !dbg !171
  %4301 = load i64, ptr %4, align 8, !dbg !172
  %4302 = add nsw i64 %4301, 1, !dbg !172
  store i64 %4302, ptr %4, align 8, !dbg !172
  br label %4303

4303:                                             ; preds = %4286, %4269
  br label %4304, !dbg !173

4304:                                             ; preds = %4303
  %4305 = load i64, ptr %2, align 8, !dbg !174
  %4306 = add nsw i64 %4305, 1, !dbg !174
  store i64 %4306, ptr %2, align 8, !dbg !174
  br label %4256, !dbg !175, !llvm.loop !176

4307:                                             ; preds = %4256
  %4308 = load i64, ptr %7, align 8, !dbg !178
  %4309 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %4308), !dbg !179
  %4310 = load i32, ptr %1, align 4, !dbg !180
  ret i32 %4310, !dbg !180
}
