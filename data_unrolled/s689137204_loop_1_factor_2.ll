...
4247:                                             ; preds = %4239
  ...
  br i1 %4252, label %4253, label %4264, !dbg !112
...
4264:                                             ; preds = %4247, %4235
  %4265 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 0, !dbg !126
  %4266 = load i64, ptr %3, align 8, !dbg !127
  call void @qsort(ptr noundef %4265, i64 noundef %4266, i64 noundef 16, ptr noundef @compare_int), !dbg !128
  store i64 0, ptr %4, align 8, !dbg !129
  %4267 = load i64, ptr %3, align 8, !dbg !130
  %4268 = add nsw i64 %4267, 1, !dbg !131
  store i64 %4268, ptr %5, align 8, !dbg !132
  store i64 1, ptr %2, align 8, !dbg !133
  br label %4269, !dbg !135

4269:                                             ; preds = %4317, %4264
  %4270 = load i64, ptr %2, align 8, !dbg !136
  %4271 = load i64, ptr %3, align 8, !dbg !138
  %4272 = icmp sle i64 %4270, %4271, !dbg !139
  br i1 %4272, label %4273, label %4320, !dbg !140

4273:                                             ; preds = %4269
  %4274 = load i64, ptr %4, align 8, !dbg !141
  %4275 = load i64, ptr %5, align 8, !dbg !144
  %4276 = load i64, ptr %2, align 8, !dbg !145
  %4277 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4276, !dbg !146
  %4278 = getelementptr inbounds [2 x i64], ptr %4277, i64 0, i64 1, !dbg !146
  %4279 = load i64, ptr %4278, align 8, !dbg !146
  %4280 = call i32 @LorR(i64 noundef %4274, i64 noundef %4275, i64 noundef %4279), !dbg !147
  %4281 = icmp eq i32 %4280, 1, !dbg !148
  br i1 %4281, label %4282, label %4299, !dbg !149

4282:                                             ; preds = %4273
  %4283 = load i64, ptr %2, align 8, !dbg !150
  %4284 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4283, !dbg !152
  %4285 = getelementptr inbounds [2 x i64], ptr %4284, i64 0, i64 0, !dbg !152
  %4286 = load i64, ptr %4285, align 16, !dbg !152
  %4287 = load i64, ptr %5, align 8, !dbg !153
  %4288 = sub nsw i64 %4287, 1, !dbg !154
  %4289 = load i64, ptr %2, align 8, !dbg !155
  %4290 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4289, !dbg !156
  %4291 = getelementptr inbounds [2 x i64], ptr %4290, i64 0, i64 1, !dbg !156
  %4292 = load i64, ptr %4291, align 8, !dbg !156
  %4293 = sub nsw i64 %4288, %4292, !dbg !157
  %4294 = mul nsw i64 %4286, %4293, !dbg !158
  %4295 = load i64, ptr %7, align 8, !dbg !159
  %4296 = add nsw i64 %4295, %4294, !dbg !159
  store i64 %4296, ptr %7, align 8, !dbg !159
  %4297 = load i64, ptr %5, align 8, !dbg !160
  %4298 = add nsw i64 %4297, -1, !dbg !160
  store i64 %4298, ptr %5, align 8, !dbg !160
  br label %4316, !dbg !161

4299:                                             ; preds = %4273
  %4300 = load i64, ptr %2, align 8, !dbg !162
  %4301 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4300, !dbg !164
  %4302 = getelementptr inbounds [2 x i64], ptr %4301, i64 0, i64 0, !dbg !164
  %4303 = load i64, ptr %4302, align 16, !dbg !164
  %4304 = load i64, ptr %2, align 8, !dbg !165
  %4305 = getelementptr inbounds [2020 x [2 x i64]], ptr %6, i64 0, i64 %4304, !dbg !166
  %4306 = getelementptr inbounds [2 x i64], ptr %4305, i64 0, i64 1, !dbg !166
  %4307 = load i64, ptr %4306, align 8, !dbg !166
  %4308 = load i64, ptr %4, align 8, !dbg !167
  %4309 = sub nsw i64 %4307, %4308, !dbg !168
  %4310 = add nsw i64 %4309, 1, !dbg !169
  %4311 = mul nsw i64 %4303, %4310, !dbg !170
  %4312 = load i64, ptr %7, align 8, !dbg !171
  %4313 = add nsw i64 %4312, %4311, !dbg !171
  store i64 %4313, ptr %7, align 8, !dbg !171
  %4314 = load i64, ptr %4, align 8, !dbg !172
  %4315 = add nsw i64 %4314, 1, !dbg !172
  store i64 %4315, ptr %4, align 8, !dbg !172
  br label %4316

4316:                                             ; preds = %4299, %4282
  br label %4317, !dbg !173

4317:                                             ; preds = %4316
  %4318 = load i64, ptr %2, align 8, !dbg !174
  %4319 = add nsw i64 %4318, 1, !dbg !174
  store i64 %4319, ptr %2, align 8, !dbg !174
  br label %4269, !dbg !175, !llvm.loop !176

4320:                                             ; preds = %4269
  %4321 = load i64, ptr %7, align 8, !dbg !178
  %4322 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %4321), !dbg !179
  %4323 = load i32, ptr %1, align 4, !dbg !180
  ret i32 %4323, !dbg !180
}
