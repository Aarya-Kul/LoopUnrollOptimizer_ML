...
10:                                               ; preds = %75, %0
  ...
  br i1 %14, label %15, label %113, !dbg !52
...
50:                                               ; preds = %23
  ...
  br i1 %52, label %.loopexit, label %55, !dbg !108
...
60:                                               ; preds = %59
  ...
  br i1 %66, label %67, label %113, !dbg !52
...
69:                                               ; preds = %88, %67
  ...
  br i1 %73, label %78, label %74, !dbg !63
...
79:                                               ; preds = %110, %78
  %80 = load i32, ptr %7, align 4, !dbg !76
  %81 = sext i32 %80 to i64, !dbg !76
  %82 = call i64 @strlen(ptr noundef %2) #4, !dbg !78
  %83 = icmp ult i64 %81, %82, !dbg !79
  br i1 %83, label %91, label %84, !dbg !80

84:                                               ; preds = %79
  %85 = call i32 @strncmp(ptr noundef %5, ptr noundef @.str.1, i64 noundef 7) #4, !dbg !105
  %86 = icmp eq i32 %85, 0, !dbg !107
  br i1 %86, label %.loopexit1, label %87, !dbg !108

87:                                               ; preds = %84
  br label %88, !dbg !112

88:                                               ; preds = %87
  %89 = load i32, ptr %4, align 4, !dbg !113
  %90 = add nsw i32 %89, 1, !dbg !113
  store i32 %90, ptr %4, align 4, !dbg !113
  br label %69, !dbg !114, !llvm.loop !115

91:                                               ; preds = %79
  %92 = load i32, ptr %3, align 4, !dbg !81
  %93 = load i32, ptr %7, align 4, !dbg !84
  %94 = icmp sle i32 %92, %93, !dbg !85
  br i1 %94, label %95, label %99, !dbg !86

95:                                               ; preds = %91
  %96 = load i32, ptr %7, align 4, !dbg !87
  %97 = load i32, ptr %4, align 4, !dbg !88
  %98 = icmp slt i32 %96, %97, !dbg !89
  br i1 %98, label %109, label %99, !dbg !90

99:                                               ; preds = %95, %91
  %100 = load i32, ptr %7, align 4, !dbg !93
  %101 = sext i32 %100 to i64, !dbg !94
  %102 = getelementptr inbounds [110 x i8], ptr %2, i64 0, i64 %101, !dbg !94
  %103 = load i8, ptr %102, align 1, !dbg !94
  %104 = load i32, ptr %6, align 4, !dbg !95
  %105 = sext i32 %104 to i64, !dbg !96
  %106 = getelementptr inbounds [100 x i8], ptr %5, i64 0, i64 %105, !dbg !96
  store i8 %103, ptr %106, align 1, !dbg !97
  %107 = load i32, ptr %6, align 4, !dbg !98
  %108 = add nsw i32 %107, 1, !dbg !98
  store i32 %108, ptr %6, align 4, !dbg !98
  br label %110, !dbg !99
...
110:                                              ; preds = %109, %99
  %111 = load i32, ptr %7, align 4, !dbg !100
  %112 = add nsw i32 %111, 1, !dbg !100
  store i32 %112, ptr %7, align 4, !dbg !100
  br label %79, !dbg !101, !llvm.loop !102

113:                                              ; preds = %60, %10
  %114 = call i32 (ptr, ...) @printf(ptr noundef @.str.3), !dbg !122
  store i32 0, ptr %1, align 4, !dbg !123
  br label %115, !dbg !123

115:                                              ; preds = %113, %53
  %116 = load i32, ptr %1, align 4, !dbg !124
  ret i32 %116, !dbg !124
}
