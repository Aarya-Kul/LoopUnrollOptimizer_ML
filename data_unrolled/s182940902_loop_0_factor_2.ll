...
10:                                               ; preds = %112, %0
  ...
  br i1 %15, label %16, label %115, !dbg !59
...
61:                                               ; preds = %60
  ...
  br i1 %68, label %69, label %115, !dbg !59
...
115:                                              ; preds = %61, %10
  %116 = load i32, ptr %4, align 4, !dbg !101
  %117 = icmp sle i32 %116, 5, !dbg !103
  br i1 %117, label %118, label %120, !dbg !104

118:                                              ; preds = %115
  %119 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !105
  store i32 0, ptr %1, align 4, !dbg !107
  br label %122, !dbg !107

120:                                              ; preds = %115
  %121 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !108
  br label %122, !dbg !109

122:                                              ; preds = %120, %118, %58
  %123 = load i32, ptr %1, align 4, !dbg !109
  ret i32 %123, !dbg !109
}
