...
175:                                              ; preds = %151, %130, %109, %88, %67, %46, %25, %6
  %176 = getelementptr inbounds [3 x i8], ptr %2, i64 0, i64 0, !dbg !61
  %177 = call i32 @atoi(ptr noundef %176) #5, !dbg !62
  %178 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %177), !dbg !63
  ret i32 0, !dbg !64
}
