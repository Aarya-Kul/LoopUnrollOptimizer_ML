...
141:                                              ; preds = %138
  ...
  br label %151, !dbg !196

144:                                              ; preds = %138, %135, %128
  %145 = load i32, ptr %10, align 4, !dbg !197
  %146 = icmp eq i32 %145, 1, !dbg !200
  br i1 %146, label %147, label %150, !dbg !201

147:                                              ; preds = %144
  %148 = load i32, ptr %9, align 4, !dbg !202
  %149 = add nsw i32 %148, 1, !dbg !202
  store i32 %149, ptr %9, align 4, !dbg !202
  br label %150, !dbg !204
...
157:                                              ; preds = %156, %45
  br label %158, !dbg !206

158:                                              ; preds = %157
  %159 = load i32, ptr %12, align 4, !dbg !207
  %160 = add nsw i32 %159, 1, !dbg !207
  store i32 %160, ptr %12, align 4, !dbg !207
  br label %32, !dbg !208, !llvm.loop !209

161:                                              ; preds = %32
  %162 = load i32, ptr %2, align 4, !dbg !211
  %163 = icmp sgt i32 %162, 0, !dbg !213
  br i1 %163, label %164, label %187, !dbg !214

164:                                              ; preds = %161
  %165 = load i32, ptr %3, align 4, !dbg !215
  %166 = icmp sgt i32 %165, 0, !dbg !216
  br i1 %166, label %167, label %187, !dbg !217

167:                                              ; preds = %164
  %168 = load i32, ptr %4, align 4, !dbg !218
  %169 = icmp sgt i32 %168, 0, !dbg !219
  br i1 %169, label %170, label %187, !dbg !220

170:                                              ; preds = %167
  %171 = load i32, ptr %5, align 4, !dbg !221
  %172 = icmp sgt i32 %171, 0, !dbg !222
  br i1 %172, label %173, label %187, !dbg !223

173:                                              ; preds = %170
  %174 = load i32, ptr %6, align 4, !dbg !224
  %175 = icmp sgt i32 %174, 0, !dbg !225
  br i1 %175, label %176, label %187, !dbg !226

176:                                              ; preds = %173
  %177 = load i32, ptr %7, align 4, !dbg !227
  %178 = icmp sgt i32 %177, 0, !dbg !228
  br i1 %178, label %179, label %187, !dbg !229

179:                                              ; preds = %176
  %180 = load i32, ptr %8, align 4, !dbg !230
  %181 = icmp sgt i32 %180, 0, !dbg !231
  br i1 %181, label %182, label %187, !dbg !232

182:                                              ; preds = %179
  %183 = load i32, ptr %9, align 4, !dbg !233
  %184 = icmp slt i32 %183, 2, !dbg !234
  br i1 %184, label %185, label %187, !dbg !235

185:                                              ; preds = %182
  %186 = call i32 (ptr, ...) @printf(ptr noundef @.str.1), !dbg !236
  br label %189, !dbg !238

187:                                              ; preds = %182, %179, %176, %173, %170, %167, %164, %161
  %188 = call i32 (ptr, ...) @printf(ptr noundef @.str.2), !dbg !239
  br label %189
