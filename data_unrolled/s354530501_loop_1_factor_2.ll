...
12398:                                            ; preds = %12396
  ...
  br i1 %12403, label %12404, label %12477, !dbg !325
...
12405:                                            ; preds = %12474, %12404
  ...
  br i1 %12412, label %12463, label %12413, !dbg !337
...
12414:                                            ; preds = %12460, %12413
  ...
  br i1 %12421, label %12449, label %12422, !dbg !364
...
12423:                                            ; preds = %12446, %12422
  ...
  br i1 %12438, label %12444, label %12439, !dbg !397
...
12444:                                            ; preds = %12423
  %12445 = call i32 (ptr, ...) @printf(ptr noundef @.str.8), !dbg !398
  br label %12446, !dbg !400

12446:                                            ; preds = %12444
  %12447 = load i32, ptr %12, align 4, !dbg !401
  %12448 = add nsw i32 %12447, 1, !dbg !401
  store i32 %12448, ptr %12, align 4, !dbg !401
  br label %12423, !dbg !402, !llvm.loop !403

12449:                                            ; preds = %12414
  %12450 = load i32, ptr %9, align 4, !dbg !365
  %12451 = sext i32 %12450 to i64, !dbg !368
  %12452 = getelementptr inbounds i32, ptr %20, i64 %12451, !dbg !368
  %12453 = load i32, ptr %12452, align 4, !dbg !368
  %12454 = icmp sgt i32 %12453, 0, !dbg !369
  br i1 %12454, label %12457, label %12455, !dbg !370

12455:                                            ; preds = %12449
  %12456 = call i32 (ptr, ...) @printf(ptr noundef @.str.7), !dbg !374
  br label %12459

12457:                                            ; preds = %12449
  %12458 = call i32 (ptr, ...) @printf(ptr noundef @.str.6), !dbg !371
  br label %12459, !dbg !373

12459:                                            ; preds = %12457, %12455
  br label %12460, !dbg !376

12460:                                            ; preds = %12459
  %12461 = load i32, ptr %11, align 4, !dbg !377
  %12462 = add nsw i32 %12461, 1, !dbg !377
  store i32 %12462, ptr %11, align 4, !dbg !377
  br label %12414, !dbg !378, !llvm.loop !379

12463:                                            ; preds = %12405
  %12464 = load i32, ptr %9, align 4, !dbg !338
  %12465 = sext i32 %12464 to i64, !dbg !341
  %12466 = getelementptr inbounds i32, ptr %17, i64 %12465, !dbg !341
  %12467 = load i32, ptr %12466, align 4, !dbg !341
  %12468 = icmp sgt i32 %12467, 0, !dbg !342
  br i1 %12468, label %12471, label %12469, !dbg !343

12469:                                            ; preds = %12463
  %12470 = call i32 (ptr, ...) @printf(ptr noundef @.str.5), !dbg !347
  br label %12473

12471:                                            ; preds = %12463
  %12472 = call i32 (ptr, ...) @printf(ptr noundef @.str.4), !dbg !344
  br label %12473, !dbg !346

12473:                                            ; preds = %12471, %12469
  br label %12474, !dbg !349

12474:                                            ; preds = %12473
  %12475 = load i32, ptr %10, align 4, !dbg !350
  %12476 = add nsw i32 %12475, 1, !dbg !350
  store i32 %12476, ptr %10, align 4, !dbg !350
  br label %12405, !dbg !351, !llvm.loop !352

12477:                                            ; preds = %12398, %12324
  store i32 0, ptr %1, align 4, !dbg !411
  store i32 1, ptr %8, align 4
  br label %12478, !dbg !411

12478:                                            ; preds = %12477, %50
  %12479 = load ptr, ptr %4, align 8, !dbg !412
  call void @llvm.stackrestore.p0(ptr %12479), !dbg !412
  %12480 = load i32, ptr %1, align 4, !dbg !412
  ret i32 %12480, !dbg !412
}
