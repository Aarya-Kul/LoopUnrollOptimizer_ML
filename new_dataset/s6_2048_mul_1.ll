; ModuleID = 'new_dataset/s6_2048_mul_1.c'
source_filename = "new_dataset/s6_2048_mul_1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@in1 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !0
@in2 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !17
@out = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out, i64 1, i64 0)), !dbg !67
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @in1, i64 1, i64 0)), !dbg !68
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @in2, i64 1, i64 0)), !dbg !69
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 524288, !dbg !86
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out, i64 1, i64 0)), !dbg !81
...
!3 = !DIFile(filename: "new_dataset/s6_2048_mul_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "b86216762c5b94315306ac9e131fbfd0")
!4 = !{!5, !11, !0, !17}
...
!52 = !DILocation(line: 36, column: 25, scope: !37)
