; ModuleID = 'new_dataset/s12_512_2_2_short_a_assign.c'
source_filename = "new_dataset/s12_512_2_2_short_a_assign.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !0
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([512 x i32], ptr @assign, i64 1, i64 0)), !dbg !80
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @assign), !dbg !93
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @assign), !dbg !98
  br label %18, !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([512 x i32], ptr @assign, i64 1, i64 0)), !dbg !93
...
!3 = !DIFile(filename: "new_dataset/s12_512_2_2_short_a_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "5632be36045985f67586b4a4f1d1414a")
!4 = !{!5}
