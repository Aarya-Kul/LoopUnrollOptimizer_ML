; ModuleID = 'new_dataset/s12n_1024_2_input1_assign1.c'
source_filename = "new_dataset/s12n_1024_2_input1_assign1.c"
...
10:                                               ; preds = %34, %4
  ...
  %12 = icmp slt i32 %11, 1024, !dbg !55
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @assign1, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @assign2, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([1024 x i16], ptr @input1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([1024 x i16], ptr @input2, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @assign1, ptr noundef @assign2), !dbg !101
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 2097152, !dbg !106
  br i1 %16, label %17, label %21, !dbg !105

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @assign1, ptr noundef @assign2), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @assign1, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @assign2, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_1024_2_input1_assign1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "331a8ee53db7adb22b783579d8e8aa24")
!4 = !{!5}
...
!58 = distinct !DILexicalBlock(scope: !54, file: !3, line: 35, column: 31)
...
!64 = !DILocation(line: 37, column: 24, scope: !58)
!65 = !DILocation(line: 37, column: 31, scope: !58)
!66 = !DILocation(line: 37, column: 18, scope: !58)
!67 = !DILocation(line: 37, column: 5, scope: !58)
!68 = !DILocation(line: 37, column: 13, scope: !58)
!69 = !DILocation(line: 37, column: 16, scope: !58)
!70 = !DILocation(line: 38, column: 3, scope: !58)
!71 = !DILocation(line: 35, column: 26, scope: !54)
