; ModuleID = 'new_dataset/s15_128_128_add_4.c'
source_filename = "new_dataset/s15_128_128_add_4.c"
...
@op1 = dso_local global [128 x [128 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [128 x [128 x i32]] zeroinitializer, align 16, !dbg !17
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([128 x i32], ptr @op1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([128 x i32], ptr @op2, i64 1, i64 0)), !dbg !98
...
!3 = !DIFile(filename: "new_dataset/s15_128_128_add_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "fd173af870b419caa0b6e614f0f1f9ae")
!4 = !{!5, !0, !11, !17}
...
!52 = !DILocalVariable(name: "sum_add", scope: !53, file: !3, line: 35, type: !14)
