; ModuleID = 'new_dataset/s15_2048_64_mul_1.c'
source_filename = "new_dataset/s15_2048_64_mul_1.c"
...
@in1 = dso_local global [2048 x [64 x i32]] zeroinitializer, align 16, !dbg !11
@in2 = dso_local global [2048 x [64 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([64 x i32], ptr @in1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([64 x i32], ptr @in2, i64 1, i64 0)), !dbg !99
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16384, !dbg !116
...
!3 = !DIFile(filename: "new_dataset/s15_2048_64_mul_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "4193f7ad6bb07a587645779111a4200c")
!4 = !{!5, !0, !11, !18}
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 4194304, elements: !15)
