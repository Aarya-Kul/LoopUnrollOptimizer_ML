; ModuleID = 'new_dataset/s10_256_add_2.c'
source_filename = "new_dataset/s10_256_add_2.c"
...
@in2 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !61 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([256 x i32], ptr @in1, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([256 x i32], ptr @in2, i64 1, i64 0)), !dbg !73
...
15:                                               ; preds = %19, %2
  ...
  %17 = icmp slt i32 %16, 8388608, !dbg !90
...
!1 = distinct !DIGlobalVariable(name: "in1", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s10_256_add_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f4eca5f76da2efde342cad71bb3f2725")
!4 = !{!5, !0, !11}
...
!12 = distinct !DIGlobalVariable(name: "in2", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true)
...
!35 = !DILocalVariable(name: "output", scope: !25, file: !3, line: 36, type: !14)
...
!45 = distinct !DILexicalBlock(scope: !41, file: !3, line: 37, column: 29)
!46 = !DILocation(line: 38, column: 16, scope: !45)
!47 = !DILocation(line: 38, column: 28, scope: !45)
!48 = !DILocation(line: 38, column: 24, scope: !45)
!49 = !DILocation(line: 38, column: 23, scope: !45)
!50 = !DILocation(line: 38, column: 12, scope: !45)
!51 = !DILocation(line: 39, column: 3, scope: !45)
!52 = !DILocation(line: 37, column: 25, scope: !41)
