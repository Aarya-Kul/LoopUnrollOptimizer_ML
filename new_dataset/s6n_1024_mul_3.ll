; ModuleID = 'new_dataset/s6n_1024_mul_3.c'
source_filename = "new_dataset/s6n_1024_mul_3.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@i1 = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !0
@i2 = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !17
@o = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [1024 x i32], ptr @o, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([1024 x i32], ptr @o, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @i1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @i1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @i2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @i2, i64 1, i64 0)), !dbg !79
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([1024 x i32], ptr @o, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "new_dataset/s6n_1024_mul_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "11fb87d8bf4a8a12ea4a69df6ccea529")
!4 = !{!5, !11, !0, !17}
...
!12 = distinct !DIGlobalVariable(name: "o", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true, align: 128)
...
!42 = !DILocation(line: 37, column: 18, scope: !41)
!43 = !DILocation(line: 37, column: 14, scope: !41)
!44 = !DILocation(line: 37, column: 26, scope: !41)
!45 = !DILocation(line: 37, column: 27, scope: !41)
!46 = !DILocation(line: 37, column: 23, scope: !41)
...
!51 = !DILocation(line: 38, column: 17, scope: !41)
!52 = !DILocation(line: 38, column: 14, scope: !41)
!53 = !DILocation(line: 38, column: 24, scope: !41)
!54 = !DILocation(line: 38, column: 25, scope: !41)
!55 = !DILocation(line: 38, column: 21, scope: !41)
!56 = !DILocation(line: 38, column: 20, scope: !41)
