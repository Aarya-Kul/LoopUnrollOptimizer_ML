; ModuleID = 'new_dataset/s2_16384_2_z_out.c'
source_filename = "new_dataset/s2_16384_2_z_out.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out, i64 1, i64 0)), !dbg !59
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 131072, !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "new_dataset/s2_16384_2_z_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "87359ed8e13adf5cee46cab0366f7143")
!4 = !{!5, !0}
...
!44 = !DILocation(line: 34, column: 26, scope: !35)
