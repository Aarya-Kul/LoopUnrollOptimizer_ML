; ModuleID = 'new_dataset/s12nn_2048_short_a_out1.c'
source_filename = "new_dataset/s12nn_2048_short_a_out1.c"
...
@out2 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !26
@short_a = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !13
@short_b = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !19
@short_c = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([2048 x i16], ptr @short_a, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([2048 x i16], ptr @short_b, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @short_c, ptr noundef getelementptr inbounds ([2048 x i16], ptr @short_c, i64 1, i64 0)), !dbg !105
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_2048_short_a_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "aa48547be4d47e952632816b796c4f41")
!4 = !{!5}
