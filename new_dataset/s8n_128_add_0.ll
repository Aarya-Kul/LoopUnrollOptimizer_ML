; ModuleID = 'new_dataset/s8n_128_add_0.c'
source_filename = "new_dataset/s8n_128_add_0.c"
...
9:                                                ; preds = %4
  ...
  %14 = getelementptr inbounds [128 x i32], ptr @b, i64 0, i64 %13, !dbg !46
  %15 = load i32, ptr %14, align 4, !dbg !46
  %16 = load i32, ptr %3, align 4, !dbg !47
  %17 = sext i32 %16 to i64, !dbg !48
  %18 = getelementptr inbounds [128 x i32], ptr @a, i64 0, i64 %17, !dbg !48
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !57 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([128 x i32], ptr @a, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([128 x i32], ptr @b, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4194304, !dbg !84
...
!3 = !DIFile(filename: "new_dataset/s8n_128_add_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "002e4b9699d258ad87117c13f12dbe23")
!4 = !{!5, !11, !0}
...
!38 = !DILocation(line: 35, column: 20, scope: !37)
!39 = !DILocation(line: 35, column: 19, scope: !37)
!40 = !DILocation(line: 35, column: 15, scope: !37)
!41 = !DILocation(line: 35, column: 4, scope: !34)
!42 = !DILocation(line: 36, column: 17, scope: !43)
!43 = distinct !DILexicalBlock(scope: !37, file: !3, line: 35, column: 27)
...
!51 = !DILocation(line: 35, column: 24, scope: !37)
