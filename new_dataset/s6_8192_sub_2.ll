; ModuleID = 'new_dataset/s6_8192_sub_2.c'
source_filename = "new_dataset/s6_8192_sub_2.c"
...
@output = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([8192 x i32], ptr @output, i64 1, i64 0)), !dbg !67
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([8192 x i32], ptr @input1, i64 1, i64 0)), !dbg !68
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @input2, i64 1, i64 0)), !dbg !69
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 131072, !dbg !86
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([8192 x i32], ptr @output, i64 1, i64 0)), !dbg !81
...
!3 = !DIFile(filename: "new_dataset/s6_8192_sub_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "c48bfd643edefa94d3a73ea06d0206ae")
!4 = !{!5, !11, !0, !17}
