; ModuleID = 'new_dataset/s17_16384_sub_0.c'
source_filename = "new_dataset/s17_16384_sub_0.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([16384 x i32], ptr @ia, i64 1, i64 0)), !dbg !67
  ...
  call void @example21(ptr noundef @ia, i32 noundef 16384), !dbg !79
...
17:                                               ; preds = %14
  call void @example21(ptr noundef @ia, i32 noundef 16384), !dbg !84
  br label %18, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([16384 x i32], ptr @ia, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s17_16384_sub_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "02a97e140c4a5d7d46979b05d1726c80")
!4 = !{!5, !0}
