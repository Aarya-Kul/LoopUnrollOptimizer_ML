; ModuleID = 'new_dataset/s12_4096_short_a_result.c'
source_filename = "new_dataset/s12_4096_short_a_result.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !0
@short_a = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([4096 x i16], ptr @short_a, i64 1, i64 0)), !dbg !73
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @result), !dbg !85
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @result), !dbg !90
  br label %18, !dbg !90
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s12_4096_short_a_result.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "0277421986e2ea49c4dae96d298f0616")
!4 = !{!5}
