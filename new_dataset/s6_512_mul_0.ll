; ModuleID = 'new_dataset/s6_512_mul_0.c'
source_filename = "new_dataset/s6_512_mul_0.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@b = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !0
@c = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !17
@a = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([512 x i32], ptr @a, i64 1, i64 0)), !dbg !67
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([512 x i32], ptr @b, i64 1, i64 0)), !dbg !68
  call void @init_memory(ptr noundef @c, ptr noundef getelementptr inbounds ([512 x i32], ptr @c, i64 1, i64 0)), !dbg !69
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 2097152, !dbg !86
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([512 x i32], ptr @a, i64 1, i64 0)), !dbg !81
...
!3 = !DIFile(filename: "new_dataset/s6_512_mul_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1b389cd4568c8d5930341c91070418b7")
!4 = !{!5, !11, !0, !17}
