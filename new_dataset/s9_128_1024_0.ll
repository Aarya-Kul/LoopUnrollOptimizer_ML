; ModuleID = 'new_dataset/s9_128_1024_0.c'
source_filename = "new_dataset/s9_128_1024_0.c"
...
9:                                                ; preds = %20, %8
  ...
  %11 = icmp slt i32 %10, 1024, !dbg !47
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([1024 x i32], ptr @G, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([1024 x i32], ptr @G, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_128_1024_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1b12e7f89300710f8929a34f530f43a2")
!4 = !{!5, !0}
