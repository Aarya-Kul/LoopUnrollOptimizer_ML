; ModuleID = 'new_dataset/s6n_1024_add_1.c'
source_filename = "new_dataset/s6n_1024_add_1.c"
...
@out = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [1024 x i32], ptr @out, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([1024 x i32], ptr @out, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in2, i64 1, i64 0)), !dbg !79
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !96
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([1024 x i32], ptr @out, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "new_dataset/s6n_1024_add_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "96b6276111e2c84f02139acbdcbe6ced")
!4 = !{!5, !11, !0, !17}
...
!41 = distinct !DILexicalBlock(scope: !37, file: !3, line: 36, column: 29)
...
!62 = !DILocation(line: 36, column: 25, scope: !37)
