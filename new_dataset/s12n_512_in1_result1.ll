; ModuleID = 'new_dataset/s12n_512_in1_result1.c'
source_filename = "new_dataset/s12n_512_in1_result1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result1 = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !0
@result2 = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !21
@in1 = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !13
@in2 = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([512 x i32], ptr @result1, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([512 x i32], ptr @result2, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([512 x i16], ptr @in1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([512 x i16], ptr @in2, i64 1, i64 0)), !dbg !89
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4194304, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([512 x i32], ptr @result1, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([512 x i32], ptr @result2, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_512_in1_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "899319fd76beab51485c5e7a1c4be467")
!4 = !{!5}
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 16384, elements: !17)
...
!58 = distinct !DILexicalBlock(scope: !54, file: !3, line: 35, column: 29)
...
!71 = !DILocation(line: 35, column: 25, scope: !54)
