; ModuleID = 'new_dataset/s15_8192_128_sub_3.c'
source_filename = "new_dataset/s15_8192_128_sub_3.c"
...
@A = dso_local global [8192 x [128 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [8192 x [128 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([128 x i32], ptr @A, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([128 x i32], ptr @B, i64 1, i64 0)), !dbg !99
...
!3 = !DIFile(filename: "new_dataset/s15_8192_128_sub_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "0c3b3e469c78c3e61ebd645f620b2ee5")
!4 = !{!5, !0, !11, !18}
