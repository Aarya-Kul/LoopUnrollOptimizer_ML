; ModuleID = 'new_dataset/s12nn_8192_2_2_short_a_out1.c'
source_filename = "new_dataset/s12nn_8192_2_2_short_a_out1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out1 = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@out2 = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !26
...
@short_c = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out1, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out2, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out3, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([8192 x i16], ptr @short_a, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([8192 x i16], ptr @short_b, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @short_c, ptr noundef getelementptr inbounds ([8192 x i16], ptr @short_c, i64 1, i64 0)), !dbg !129
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out1, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out2, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out3, i64 1, i64 0)), !dbg !141
...
!3 = !DIFile(filename: "new_dataset/s12nn_8192_2_2_short_a_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "6e0b50080248cc367aa82ed7569acbcd")
!4 = !{!5}
