; ModuleID = 'new_dataset/s12_4096_2_sa_result.c'
source_filename = "new_dataset/s12_4096_2_sa_result.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([4096 x i16], ptr @sa, i64 1, i64 0)), !dbg !73
...
!3 = !DIFile(filename: "new_dataset/s12_4096_2_sa_result.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "edcbeae41873e3b1e12f9728edd8dc82")
!4 = !{!5}
