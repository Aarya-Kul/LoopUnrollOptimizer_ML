; ModuleID = 'new_dataset/s12_2048_2_sa_out.c'
source_filename = "new_dataset/s12_2048_2_sa_out.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([2048 x i16], ptr @sa, i64 1, i64 0)), !dbg !73
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @out), !dbg !85
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !90
  br i1 %16, label %17, label %21, !dbg !89

17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @out), !dbg !90
  br label %18, !dbg !90
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s12_2048_2_sa_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "d7a8b7fb7dc8966e118f1c22d88118c5")
!4 = !{!5}
