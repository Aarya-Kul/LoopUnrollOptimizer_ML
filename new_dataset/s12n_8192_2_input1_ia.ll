; ModuleID = 'new_dataset/s12n_8192_2_input1_ia.c'
source_filename = "new_dataset/s12n_8192_2_input1_ia.c"
...
@ib = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !21
...
10:                                               ; preds = %34, %4
  ...
  %12 = icmp slt i32 %11, 8192, !dbg !55
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ib, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input2, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @ia, ptr noundef @ib), !dbg !101
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !106
  br i1 %16, label %17, label %21, !dbg !105

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @ia, ptr noundef @ib), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ib, i64 1, i64 0)), !dbg !101
...
!1 = distinct !DIGlobalVariable(name: "ia", scope: !2, file: !3, line: 29, type: !23, isLocal: false, isDefinition: true, align: 128)
...
!3 = !DIFile(filename: "new_dataset/s12n_8192_2_input1_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "6210809e3fa4b47214d094bbcb1e5f1e")
!4 = !{!5}
...
!22 = distinct !DIGlobalVariable(name: "ib", scope: !2, file: !3, line: 30, type: !23, isLocal: false, isDefinition: true, align: 128)
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 262144, elements: !17)
...
!44 = !DILocalVariable(name: "ia", arg: 3, scope: !32, file: !3, line: 33, type: !37)
!45 = !DILocation(line: 33, column: 91, scope: !32)
!46 = !DILocalVariable(name: "ib", arg: 4, scope: !32, file: !3, line: 33, type: !37)
!47 = !DILocation(line: 33, column: 113, scope: !32)
...
!59 = !DILocation(line: 36, column: 26, scope: !58)
!60 = !DILocation(line: 36, column: 13, scope: !58)
!61 = !DILocation(line: 36, column: 5, scope: !58)
!62 = !DILocation(line: 36, column: 8, scope: !58)
!63 = !DILocation(line: 36, column: 11, scope: !58)
!64 = !DILocation(line: 37, column: 19, scope: !58)
!65 = !DILocation(line: 37, column: 26, scope: !58)
!66 = !DILocation(line: 37, column: 13, scope: !58)
!67 = !DILocation(line: 37, column: 5, scope: !58)
!68 = !DILocation(line: 37, column: 8, scope: !58)
!69 = !DILocation(line: 37, column: 11, scope: !58)
