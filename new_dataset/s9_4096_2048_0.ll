; ModuleID = 'new_dataset/s9_4096_2048_0.c'
source_filename = "new_dataset/s9_4096_2048_0.c"
...
9:                                                ; preds = %20, %8
  ...
  %11 = icmp slt i32 %10, 2048, !dbg !47
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([2048 x i32], ptr @G, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([2048 x i32], ptr @G, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_4096_2048_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "e5a201e8d6490c8fdd4f7c3b046cf676")
!4 = !{!5, !0}
...
!43 = distinct !DILexicalBlock(scope: !38, file: !3, line: 33, column: 27)
...
!50 = distinct !DILexicalBlock(scope: !46, file: !3, line: 34, column: 29)
...
!56 = !DILocation(line: 34, column: 25, scope: !46)
...
!62 = !DILocation(line: 33, column: 23, scope: !38)
