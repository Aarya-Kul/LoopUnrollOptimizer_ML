; ModuleID = 'new_dataset/s12nn_8192_2_input1_result1.c'
source_filename = "new_dataset/s12nn_8192_2_input1_result1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result1 = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@result2 = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !23
@result3 = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !26
...
14:                                               ; preds = %48, %6
  ...
  %16 = icmp slt i32 %15, 8192, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([8192 x i32], ptr @result1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @result2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([8192 x i32], ptr @result3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input3, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @result1, ptr noundef @result2, ptr noundef @result3), !dbg !117
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !122
  br i1 %16, label %17, label %21, !dbg !121

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @result1, ptr noundef @result2, ptr noundef @result3), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([8192 x i32], ptr @result1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @result2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([8192 x i32], ptr @result3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_8192_2_input1_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8e0683b37b17d06746688988e97fa6bf")
!4 = !{!5}
...
!55 = !DILocation(line: 35, column: 173, scope: !36)
...
!66 = distinct !DILexicalBlock(scope: !62, file: !3, line: 37, column: 31)
!67 = !DILocation(line: 38, column: 31, scope: !66)
...
!72 = !DILocation(line: 39, column: 24, scope: !66)
!73 = !DILocation(line: 39, column: 31, scope: !66)
!74 = !DILocation(line: 39, column: 18, scope: !66)
!75 = !DILocation(line: 39, column: 5, scope: !66)
!76 = !DILocation(line: 39, column: 13, scope: !66)
!77 = !DILocation(line: 39, column: 16, scope: !66)
!78 = !DILocation(line: 40, column: 24, scope: !66)
!79 = !DILocation(line: 40, column: 31, scope: !66)
!80 = !DILocation(line: 40, column: 18, scope: !66)
!81 = !DILocation(line: 40, column: 5, scope: !66)
!82 = !DILocation(line: 40, column: 13, scope: !66)
!83 = !DILocation(line: 40, column: 16, scope: !66)
!84 = !DILocation(line: 41, column: 3, scope: !66)
!85 = !DILocation(line: 37, column: 26, scope: !62)
