; ModuleID = 'new_dataset/s12nn_128_2_short_a_result1.c'
source_filename = "new_dataset/s12nn_128_2_short_a_result1.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([128 x i32], ptr @result1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([128 x i32], ptr @result2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([128 x i32], ptr @result3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_a, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_b, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @short_c, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_c, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @short_c, ptr noundef @result1, ptr noundef @result2, ptr noundef @result3), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @short_c, ptr noundef @result1, ptr noundef @result2, ptr noundef @result3), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([128 x i32], ptr @result1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([128 x i32], ptr @result2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([128 x i32], ptr @result3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_128_2_short_a_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f9c3f90249040cbd7a6ba521e987e6e9")
!4 = !{!5}
...
!73 = !DILocation(line: 39, column: 32, scope: !66)
...
!79 = !DILocation(line: 40, column: 32, scope: !66)
