; ModuleID = 'new_dataset/s12_256_input_ia.c'
source_filename = "new_dataset/s12_256_input_ia.c"
...
@input = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @input, ptr noundef getelementptr inbounds ([256 x i16], ptr @input, i64 1, i64 0)), !dbg !73
  ...
  call void @example10b(ptr noundef @input, ptr noundef @ia), !dbg !85
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @input, ptr noundef @ia), !dbg !90
  br label %18, !dbg !90
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s12_256_input_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "fa9c660f0afd3eb42c5a36ccd57f81e0")
!4 = !{!5}
