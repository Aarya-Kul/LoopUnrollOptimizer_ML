; ModuleID = 'new_dataset/s10_128_add_1.c'
source_filename = "new_dataset/s10_128_add_1.c"
...
@in2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !61 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i32], ptr @in1, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i32], ptr @in2, i64 1, i64 0)), !dbg !73
...
15:                                               ; preds = %19, %2
  ...
  %17 = icmp slt i32 %16, 16777216, !dbg !90
...
!3 = !DIFile(filename: "new_dataset/s10_128_add_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "a8fd98edb00f38f8813dbf36c0cfb1b6")
!4 = !{!5, !0, !11}
...
!35 = !DILocalVariable(name: "res", scope: !25, file: !3, line: 36, type: !14)
...
!47 = !DILocation(line: 38, column: 25, scope: !45)
!48 = !DILocation(line: 38, column: 21, scope: !45)
