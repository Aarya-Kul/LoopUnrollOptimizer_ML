; ModuleID = 'new_dataset/s16_256_2048_4_1.c'
source_filename = "new_dataset/s16_256_2048_4_1.c"
...
@G = dso_local global [256 x [2048 x i32]] zeroinitializer, align 16, !dbg !11
@G2 = dso_local global [260 x [2048 x i32]] zeroinitializer, align 16, !dbg !18
...
19:                                               ; preds = %44, %18
  ...
  %21 = icmp slt i32 %20, 2048, !dbg !74
...
22:                                               ; preds = %19
  ...
  %28 = getelementptr inbounds [2048 x i32], ptr %23, i64 %27, !dbg !76
  %29 = load i32, ptr %8, align 4, !dbg !80
  %30 = sext i32 %29 to i64, !dbg !76
  %31 = getelementptr inbounds [2048 x i32], ptr %28, i64 0, i64 %30, !dbg !76
  ...
  %36 = getelementptr inbounds [2048 x i32], ptr %33, i64 %35, !dbg !81
  %37 = load i32, ptr %8, align 4, !dbg !83
  %38 = sext i32 %37 to i64, !dbg !81
  %39 = getelementptr inbounds [2048 x i32], ptr %36, i64 0, i64 %38, !dbg !81
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !106 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([2048 x i32], ptr @G, i64 1, i64 0)), !dbg !116
  call void @init_memory(ptr noundef @G2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @G2, i64 1, i64 0)), !dbg !117
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1024, !dbg !134
...
!3 = !DIFile(filename: "new_dataset/s16_256_2048_4_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "b79ebfccb2d73242bd5da46b88f6c0c3")
!4 = !{!5, !0, !11, !18}
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 17039360, elements: !21)
!21 = !{!22, !17}
!22 = !DISubrange(count: 260)
...
!36 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 65536, elements: !37)
!37 = !{!17}
