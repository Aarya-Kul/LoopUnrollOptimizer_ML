; ModuleID = 'new_dataset/s12_1024_2_2_sa_result.c'
source_filename = "new_dataset/s12_1024_2_2_sa_result.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result, i64 1, i64 0)), !dbg !80
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([1024 x i16], ptr @sa, i64 1, i64 0)), !dbg !81
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @result), !dbg !93
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 2097152, !dbg !98
  br i1 %16, label %17, label %21, !dbg !97

17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @result), !dbg !98
  br label %18, !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result, i64 1, i64 0)), !dbg !93
...
!3 = !DIFile(filename: "new_dataset/s12_1024_2_2_sa_result.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "9c991b400435ac7620fc9edd297e5c8b")
!4 = !{!5}
