; ModuleID = 'new_dataset/s12_2048_2_4_short_a_assign.c'
source_filename = "new_dataset/s12_2048_2_4_short_a_assign.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([2048 x i16], ptr @short_a, i64 1, i64 0)), !dbg !97
...
!3 = !DIFile(filename: "new_dataset/s12_2048_2_4_short_a_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1c2957621755751aa110a32a8a37e158")
!4 = !{!5}
