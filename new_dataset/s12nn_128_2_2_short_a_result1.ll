; ModuleID = 'new_dataset/s12nn_128_2_2_short_a_result1.c'
source_filename = "new_dataset/s12nn_128_2_2_short_a_result1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result1 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !0
@result2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !23
@result3 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !26
@short_a = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !13
@short_b = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !19
@short_c = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([128 x i32], ptr @result1, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([128 x i32], ptr @result2, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([128 x i32], ptr @result3, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_a, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_b, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @short_c, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_c, i64 1, i64 0)), !dbg !129
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @short_c, ptr noundef @result1, ptr noundef @result2, ptr noundef @result3), !dbg !141
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !146
  br i1 %16, label %17, label %21, !dbg !145

17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @short_c, ptr noundef @result1, ptr noundef @result2, ptr noundef @result3), !dbg !146
  br label %18, !dbg !146
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([128 x i32], ptr @result1, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([128 x i32], ptr @result2, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([128 x i32], ptr @result3, i64 1, i64 0)), !dbg !141
...
!1 = distinct !DIGlobalVariable(name: "result1", scope: !2, file: !3, line: 30, type: !25, isLocal: false, isDefinition: true, align: 128)
...
!3 = !DIFile(filename: "new_dataset/s12nn_128_2_2_short_a_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1e453c87967d986a14d2e84c89879086")
!4 = !{!5}
...
!24 = distinct !DIGlobalVariable(name: "result2", scope: !2, file: !3, line: 31, type: !25, isLocal: false, isDefinition: true, align: 128)
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 4096, elements: !17)
!26 = !DIGlobalVariableExpression(var: !27, expr: !DIExpression())
!27 = distinct !DIGlobalVariable(name: "result3", scope: !2, file: !3, line: 32, type: !25, isLocal: false, isDefinition: true, align: 128)
...
!50 = !DILocalVariable(name: "result1", arg: 4, scope: !36, file: !3, line: 35, type: !41)
!51 = !DILocation(line: 35, column: 122, scope: !36)
!52 = !DILocalVariable(name: "result2", arg: 5, scope: !36, file: !3, line: 35, type: !41)
!53 = !DILocation(line: 35, column: 149, scope: !36)
!54 = !DILocalVariable(name: "result3", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 176, scope: !36)
...
!65 = !DILocation(line: 38, column: 24, scope: !66)
!66 = distinct !DILexicalBlock(scope: !62, file: !3, line: 37, column: 32)
!67 = !DILocation(line: 38, column: 32, scope: !66)
!68 = !DILocation(line: 38, column: 18, scope: !66)
!69 = !DILocation(line: 38, column: 5, scope: !66)
!70 = !DILocation(line: 38, column: 13, scope: !66)
!71 = !DILocation(line: 38, column: 16, scope: !66)
!72 = !DILocation(line: 39, column: 22, scope: !66)
!73 = !DILocation(line: 39, column: 30, scope: !66)
!74 = !DILocation(line: 39, column: 31, scope: !66)
!75 = !DILocation(line: 39, column: 16, scope: !66)
!76 = !DILocation(line: 39, column: 1, scope: !66)
!77 = !DILocation(line: 39, column: 9, scope: !66)
!78 = !DILocation(line: 39, column: 10, scope: !66)
!79 = !DILocation(line: 39, column: 14, scope: !66)
!80 = !DILocation(line: 40, column: 24, scope: !66)
!81 = !DILocation(line: 40, column: 32, scope: !66)
!82 = !DILocation(line: 40, column: 18, scope: !66)
!83 = !DILocation(line: 40, column: 5, scope: !66)
!84 = !DILocation(line: 40, column: 13, scope: !66)
!85 = !DILocation(line: 40, column: 16, scope: !66)
!86 = !DILocation(line: 41, column: 22, scope: !66)
!87 = !DILocation(line: 41, column: 30, scope: !66)
!88 = !DILocation(line: 41, column: 31, scope: !66)
!89 = !DILocation(line: 41, column: 16, scope: !66)
!90 = !DILocation(line: 41, column: 1, scope: !66)
!91 = !DILocation(line: 41, column: 9, scope: !66)
!92 = !DILocation(line: 41, column: 10, scope: !66)
!93 = !DILocation(line: 41, column: 14, scope: !66)
!94 = !DILocation(line: 42, column: 24, scope: !66)
!95 = !DILocation(line: 42, column: 32, scope: !66)
!96 = !DILocation(line: 42, column: 18, scope: !66)
!97 = !DILocation(line: 42, column: 5, scope: !66)
!98 = !DILocation(line: 42, column: 13, scope: !66)
!99 = !DILocation(line: 42, column: 16, scope: !66)
!100 = !DILocation(line: 43, column: 22, scope: !66)
!101 = !DILocation(line: 43, column: 30, scope: !66)
!102 = !DILocation(line: 43, column: 31, scope: !66)
!103 = !DILocation(line: 43, column: 16, scope: !66)
!104 = !DILocation(line: 43, column: 1, scope: !66)
!105 = !DILocation(line: 43, column: 9, scope: !66)
!106 = !DILocation(line: 43, column: 10, scope: !66)
!107 = !DILocation(line: 43, column: 14, scope: !66)
!108 = !DILocation(line: 44, column: 3, scope: !66)
!109 = !DILocation(line: 37, column: 27, scope: !62)
