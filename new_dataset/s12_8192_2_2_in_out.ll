; ModuleID = 'new_dataset/s12_8192_2_2_in_out.c'
source_filename = "new_dataset/s12_8192_2_2_in_out.c"
...
@in = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out, i64 1, i64 0)), !dbg !80
  call void @init_memory(ptr noundef @in, ptr noundef getelementptr inbounds ([8192 x i16], ptr @in, i64 1, i64 0)), !dbg !81
  ...
  call void @example10b(ptr noundef @in, ptr noundef @out), !dbg !93
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !98
  br i1 %16, label %17, label %21, !dbg !97

17:                                               ; preds = %14
  call void @example10b(ptr noundef @in, ptr noundef @out), !dbg !98
  br label %18, !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out, i64 1, i64 0)), !dbg !93
...
!3 = !DIFile(filename: "new_dataset/s12_8192_2_2_in_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "9861a8654b5d57f3f6151696fd7563c1")
!4 = !{!5}
...
!14 = distinct !DIGlobalVariable(name: "in", scope: !2, file: !3, line: 27, type: !15, isLocal: false, isDefinition: true)
...
!35 = !{}
!36 = !DILocalVariable(name: "in", arg: 1, scope: !28, file: !3, line: 31, type: !31)
...
!51 = !DILocation(line: 34, column: 23, scope: !50)
...
!57 = !DILocation(line: 35, column: 21, scope: !50)
!58 = !DILocation(line: 35, column: 22, scope: !50)
