; ModuleID = 'new_dataset/s9_16384_512_1.c'
source_filename = "new_dataset/s9_16384_512_1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@Out = dso_local global [16384 x [512 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [16384 x [512 x i32]], ptr @Out, i64 0, i64 %15, !dbg !52
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([512 x i32], ptr @Out, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([512 x i32], ptr @Out, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_16384_512_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "94581fa7dbca544d00971a50556e8cb8")
!4 = !{!5, !0}
...
!50 = distinct !DILexicalBlock(scope: !46, file: !3, line: 34, column: 28)
...
!56 = !DILocation(line: 34, column: 24, scope: !46)
