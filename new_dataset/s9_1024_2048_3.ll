; ModuleID = 'new_dataset/s9_1024_2048_3.c'
source_filename = "new_dataset/s9_1024_2048_3.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_1024_2048_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8a1df438a6f77fe0b32fee0fd3de24b8")
!4 = !{!5, !0}
