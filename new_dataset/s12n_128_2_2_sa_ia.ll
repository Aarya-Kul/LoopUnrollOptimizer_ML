; ModuleID = 'new_dataset/s12n_128_2_2_sa_ia.c'
source_filename = "new_dataset/s12n_128_2_2_sa_ia.c"
...
@ib = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !21
@sa = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !13
@sb = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([128 x i32], ptr @ia, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([128 x i32], ptr @ib, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([128 x i16], ptr @sa, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @sb, ptr noundef getelementptr inbounds ([128 x i16], ptr @sb, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @ia, ptr noundef @ib), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @ia, ptr noundef @ib), !dbg !122
  br label %18, !dbg !122
...
!3 = !DIFile(filename: "new_dataset/s12n_128_2_2_sa_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "172264191f30ca271332da129d98988a")
!4 = !{!5}
...
!47 = !DILocation(line: 33, column: 105, scope: !32)
...
!59 = !DILocation(line: 36, column: 22, scope: !58)
...
!64 = !DILocation(line: 37, column: 17, scope: !58)
!65 = !DILocation(line: 37, column: 20, scope: !58)
!66 = !DILocation(line: 37, column: 21, scope: !58)
!67 = !DILocation(line: 37, column: 11, scope: !58)
!68 = !DILocation(line: 37, column: 1, scope: !58)
!69 = !DILocation(line: 37, column: 4, scope: !58)
!70 = !DILocation(line: 37, column: 5, scope: !58)
!71 = !DILocation(line: 37, column: 9, scope: !58)
!72 = !DILocation(line: 38, column: 19, scope: !58)
!73 = !DILocation(line: 38, column: 22, scope: !58)
!74 = !DILocation(line: 38, column: 13, scope: !58)
!75 = !DILocation(line: 38, column: 5, scope: !58)
!76 = !DILocation(line: 38, column: 8, scope: !58)
!77 = !DILocation(line: 38, column: 11, scope: !58)
!78 = !DILocation(line: 39, column: 17, scope: !58)
!79 = !DILocation(line: 39, column: 20, scope: !58)
!80 = !DILocation(line: 39, column: 21, scope: !58)
!81 = !DILocation(line: 39, column: 11, scope: !58)
!82 = !DILocation(line: 39, column: 1, scope: !58)
!83 = !DILocation(line: 39, column: 4, scope: !58)
!84 = !DILocation(line: 39, column: 5, scope: !58)
!85 = !DILocation(line: 39, column: 9, scope: !58)
