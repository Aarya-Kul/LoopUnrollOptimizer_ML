; ModuleID = 'new_dataset/s6n_4096_add_2.c'
source_filename = "new_dataset/s6n_4096_add_2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@input1 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !0
@input2 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !17
@output = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [4096 x i32], ptr @output, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([4096 x i32], ptr @output, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @input1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @input2, i64 1, i64 0)), !dbg !79
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([4096 x i32], ptr @output, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "new_dataset/s6n_4096_add_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "df6f90d55b39474923956aff64c4d47e")
!4 = !{!5, !11, !0, !17}
