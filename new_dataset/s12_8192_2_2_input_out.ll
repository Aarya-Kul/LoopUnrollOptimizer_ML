; ModuleID = 'new_dataset/s12_8192_2_2_input_out.c'
source_filename = "new_dataset/s12_8192_2_2_input_out.c"
...
@input = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @input, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input, i64 1, i64 0)), !dbg !81
  ...
  call void @example10b(ptr noundef @input, ptr noundef @out), !dbg !93
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @input, ptr noundef @out), !dbg !98
  br label %18, !dbg !98
...
!3 = !DIFile(filename: "new_dataset/s12_8192_2_2_input_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "5b2a895d00a1af940185fbd44408063b")
!4 = !{!5}
