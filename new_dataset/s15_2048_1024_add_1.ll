; ModuleID = 'new_dataset/s15_2048_1024_add_1.c'
source_filename = "new_dataset/s15_2048_1024_add_1.c"
...
@in1 = dso_local global [2048 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@in2 = dso_local global [2048 x [1024 x i32]] zeroinitializer, align 16, !dbg !18
...
10:                                               ; preds = %46, %3
  ...
  %12 = icmp slt i32 %11, 2048, !dbg !51
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in2, i64 1, i64 0)), !dbg !99
  ...
  call void @example13(ptr noundef @in1, ptr noundef @in2, ptr noundef @ia), !dbg !111
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1024, !dbg !116
  br i1 %16, label %17, label %21, !dbg !115

17:                                               ; preds = %14
  call void @example13(ptr noundef @in1, ptr noundef @in2, ptr noundef @ia), !dbg !116
  br label %18, !dbg !116
...
!3 = !DIFile(filename: "new_dataset/s15_2048_1024_add_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "4e303824316056d9c6adcd7d3bd63fc9")
!4 = !{!5, !0, !11, !18}
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 67108864, elements: !15)
!14 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!15 = !{!16, !17}
!16 = !DISubrange(count: 2048)
!17 = !DISubrange(count: 1024)
!18 = !DIGlobalVariableExpression(var: !19, expr: !DIExpression())
!19 = distinct !DIGlobalVariable(name: "in2", scope: !2, file: !3, line: 29, type: !13, isLocal: false, isDefinition: true)
...
!35 = !{}
!36 = !DILocalVariable(name: "in1", arg: 1, scope: !30, file: !3, line: 32, type: !33)
!37 = !DILocation(line: 32, column: 20, scope: !30)
!38 = !DILocalVariable(name: "in2", arg: 2, scope: !30, file: !3, line: 32, type: !33)
...
!53 = !DILocalVariable(name: "res", scope: !54, file: !3, line: 35, type: !14)
...
!63 = !DILocation(line: 37, column: 15, scope: !64)
!64 = distinct !DILexicalBlock(scope: !60, file: !3, line: 36, column: 33)
!65 = !DILocation(line: 37, column: 19, scope: !64)
!66 = !DILocation(line: 37, column: 22, scope: !64)
!67 = !DILocation(line: 37, column: 26, scope: !64)
!68 = !DILocation(line: 37, column: 30, scope: !64)
!69 = !DILocation(line: 37, column: 33, scope: !64)
!70 = !DILocation(line: 37, column: 25, scope: !64)
!71 = !DILocation(line: 37, column: 11, scope: !64)
