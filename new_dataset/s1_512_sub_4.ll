; ModuleID = 'new_dataset/s1_512_sub_4.c'
source_filename = "new_dataset/s1_512_sub_4.c"
...
@result = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([512 x i32], ptr @result, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([512 x i32], ptr @in1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([512 x i32], ptr @in2, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 2097152, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([512 x i32], ptr @result, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s1_512_sub_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1dd1844b3c025e126896606f1f833624")
!4 = !{!5, !11, !0, !17}
