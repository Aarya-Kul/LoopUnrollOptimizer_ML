; ModuleID = 'new_dataset/s2_1024_z_out.c'
source_filename = "new_dataset/s2_1024_z_out.c"
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [1024 x i32], ptr @out, i64 0, i64 %10, !dbg !41
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([1024 x i32], ptr @out, i64 1, i64 0)), !dbg !59
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 2097152, !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([1024 x i32], ptr @out, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "new_dataset/s2_1024_z_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "4fef55f6ae3637466a92233c19fd3a7f")
!4 = !{!5, !0}
