; ModuleID = 'new_dataset/s9_4096_64_3.c'
source_filename = "new_dataset/s9_4096_64_3.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result = dso_local global [4096 x [64 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [4096 x [64 x i32]], ptr @result, i64 0, i64 %15, !dbg !52
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([64 x i32], ptr @result, i64 1, i64 0)), !dbg !76
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4096, !dbg !93
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([64 x i32], ptr @result, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_4096_64_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "52da460bc477419e703a204353186ba7")
!4 = !{!5, !0}
...
!50 = distinct !DILexicalBlock(scope: !46, file: !3, line: 34, column: 27)
...
!56 = !DILocation(line: 34, column: 23, scope: !46)
