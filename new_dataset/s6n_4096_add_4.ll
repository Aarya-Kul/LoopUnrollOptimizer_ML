; ModuleID = 'new_dataset/s6n_4096_add_4.c'
source_filename = "new_dataset/s6n_4096_add_4.c"
...
@result = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %33 = getelementptr inbounds [4096 x i32], ptr @result, i64 0, i64 %32, !dbg !59
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !68 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result, i64 1, i64 0)), !dbg !77
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @in1, i64 1, i64 0)), !dbg !78
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @in2, i64 1, i64 0)), !dbg !79
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !96
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result, i64 1, i64 0)), !dbg !91
...
!3 = !DIFile(filename: "new_dataset/s6n_4096_add_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "6761f565be47000f234b0ca94a27dd82")
!4 = !{!5, !11, !0, !17}
...
!40 = !DILocation(line: 37, column: 23, scope: !41)
...
!44 = !DILocation(line: 37, column: 33, scope: !41)
!45 = !DILocation(line: 37, column: 34, scope: !41)
!46 = !DILocation(line: 37, column: 29, scope: !41)
!47 = !DILocation(line: 37, column: 28, scope: !41)
...
!53 = !DILocation(line: 38, column: 31, scope: !41)
!54 = !DILocation(line: 38, column: 32, scope: !41)
!55 = !DILocation(line: 38, column: 27, scope: !41)
!56 = !DILocation(line: 38, column: 26, scope: !41)
