; ModuleID = 'new_dataset/s12nn_64_2_input1_out1.c'
source_filename = "new_dataset/s12nn_64_2_input1_out1.c"
...
@out2 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !26
@input1 = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !19
@input3 = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([64 x i32], ptr @out1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([64 x i32], ptr @out2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([64 x i32], ptr @out3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([64 x i16], ptr @input1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([64 x i16], ptr @input2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([64 x i16], ptr @input3, i64 1, i64 0)), !dbg !105
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([64 x i32], ptr @out1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([64 x i32], ptr @out2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([64 x i32], ptr @out3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_64_2_input1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "16b66d9938901d9ddd082c39ac7bb082")
!4 = !{!5}
