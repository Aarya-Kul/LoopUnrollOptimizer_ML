; ModuleID = 'new_dataset/s9_64_4096_1.c'
source_filename = "new_dataset/s9_64_4096_1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@Out = dso_local global [64 x [4096 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [64 x [4096 x i32]], ptr @Out, i64 0, i64 %15, !dbg !52
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([4096 x i32], ptr @Out, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([4096 x i32], ptr @Out, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_64_4096_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "d8586a218334bdee59845f6edb4231d0")
!4 = !{!5, !0}
