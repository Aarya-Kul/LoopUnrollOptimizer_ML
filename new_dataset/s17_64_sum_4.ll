; ModuleID = 'new_dataset/s17_64_sum_4.c'
source_filename = "new_dataset/s17_64_sum_4.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([64 x i32], ptr @ia, i64 1, i64 0)), !dbg !67
  ...
  call void @example21(ptr noundef @ia, i32 noundef 64), !dbg !79
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 33554432, !dbg !84
  br i1 %16, label %17, label %21, !dbg !83

17:                                               ; preds = %14
  call void @example21(ptr noundef @ia, i32 noundef 64), !dbg !84
  br label %18, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([64 x i32], ptr @ia, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s17_64_sum_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1d83a278e0a06f31d4e24058fbf5e54d")
!4 = !{!5, !0}
