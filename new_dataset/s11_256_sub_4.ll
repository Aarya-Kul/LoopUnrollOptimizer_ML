; ModuleID = 'new_dataset/s11_256_sub_4.c'
source_filename = "new_dataset/s11_256_sub_4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@res1 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@i2 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !21
@i3 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !25
@res2 = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !11
@s2 = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !17
@s3 = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @res1, ptr noundef getelementptr inbounds ([256 x i32], ptr @res1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @i2, ptr noundef getelementptr inbounds ([256 x i32], ptr @i2, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @i3, ptr noundef getelementptr inbounds ([256 x i32], ptr @i3, i64 1, i64 0)), !dbg !99
  call void @init_memory(ptr noundef @res2, ptr noundef getelementptr inbounds ([256 x i16], ptr @res2, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @s2, ptr noundef getelementptr inbounds ([256 x i16], ptr @s2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @s3, ptr noundef getelementptr inbounds ([256 x i16], ptr @s3, i64 1, i64 0)), !dbg !102
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @res1, ptr noundef getelementptr inbounds ([256 x i32], ptr @res1, i64 1, i64 0)), !dbg !114
  %24 = call i32 @digest_memory(ptr noundef @res2, ptr noundef getelementptr inbounds ([256 x i16], ptr @res2, i64 1, i64 0)), !dbg !114
...
!3 = !DIFile(filename: "new_dataset/s11_256_sub_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8aee53459f55d1b262273d9fe29817d8")
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !24, size: 8192, elements: !15)
