; ModuleID = 'new_dataset/s16_4096_1024_4_0.c'
source_filename = "new_dataset/s16_4096_1024_4_0.c"
...
@G = dso_local global [4096 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@G2 = dso_local global [4100 x [1024 x i32]] zeroinitializer, align 16, !dbg !18
...
19:                                               ; preds = %44, %18
  ...
  %21 = icmp slt i32 %20, 1024, !dbg !74
...
22:                                               ; preds = %19
  ...
  %28 = getelementptr inbounds [1024 x i32], ptr %23, i64 %27, !dbg !76
  %29 = load i32, ptr %8, align 4, !dbg !80
  %30 = sext i32 %29 to i64, !dbg !76
  %31 = getelementptr inbounds [1024 x i32], ptr %28, i64 0, i64 %30, !dbg !76
  ...
  %36 = getelementptr inbounds [1024 x i32], ptr %33, i64 %35, !dbg !81
  %37 = load i32, ptr %8, align 4, !dbg !83
  %38 = sext i32 %37 to i64, !dbg !81
  %39 = getelementptr inbounds [1024 x i32], ptr %36, i64 0, i64 %38, !dbg !81
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !106 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([1024 x i32], ptr @G, i64 1, i64 0)), !dbg !116
  call void @init_memory(ptr noundef @G2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @G2, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s16_4096_1024_4_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "119027b69b6b139d1d95a4a4ab55d269")
!4 = !{!5, !0, !11, !18}
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 134348800, elements: !21)
!21 = !{!22, !17}
...
!36 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 32768, elements: !37)
!37 = !{!17}
