; ModuleID = 'new_dataset/s12_512_2_2_input_ia.c'
source_filename = "new_dataset/s12_512_2_2_input_ia.c"
...
@input = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([512 x i32], ptr @ia, i64 1, i64 0)), !dbg !80
  call void @init_memory(ptr noundef @input, ptr noundef getelementptr inbounds ([512 x i16], ptr @input, i64 1, i64 0)), !dbg !81
  ...
  call void @example10b(ptr noundef @input, ptr noundef @ia), !dbg !93
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4194304, !dbg !98
  br i1 %16, label %17, label %21, !dbg !97

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input, ptr noundef @ia), !dbg !98
  br label %18, !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([512 x i32], ptr @ia, i64 1, i64 0)), !dbg !93
...
!3 = !DIFile(filename: "new_dataset/s12_512_2_2_input_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "2cb54d40d1f69fa2a6f3e5ba20ddfc05")
!4 = !{!5}
...
!14 = distinct !DIGlobalVariable(name: "input", scope: !2, file: !3, line: 27, type: !15, isLocal: false, isDefinition: true)
...
!19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 16384, elements: !17)
...
!35 = !{}
!36 = !DILocalVariable(name: "input", arg: 1, scope: !28, file: !3, line: 31, type: !31)
!37 = !DILocation(line: 31, column: 37, scope: !28)
!38 = !DILocalVariable(name: "ia", arg: 2, scope: !28, file: !3, line: 31, type: !33)
!39 = !DILocation(line: 31, column: 62, scope: !28)
...
!50 = distinct !DILexicalBlock(scope: !46, file: !3, line: 33, column: 32)
...
!57 = !DILocation(line: 35, column: 23, scope: !50)
!58 = !DILocation(line: 35, column: 24, scope: !50)
...
!65 = !DILocation(line: 33, column: 27, scope: !46)
