; ModuleID = 'new_dataset/s9n_512_128_0_z.c'
source_filename = "new_dataset/s9n_512_128_0_z.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@G = dso_local global [512 x [128 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [512 x [128 x i32]], ptr @G, i64 0, i64 %15, !dbg !52
  %17 = load i32, ptr %4, align 4, !dbg !53
  %18 = sext i32 %17 to i64, !dbg !52
  %19 = getelementptr inbounds [128 x i32], ptr %16, i64 0, i64 %18, !dbg !52
  ...
  %24 = getelementptr inbounds [512 x [128 x i32]], ptr @G, i64 0, i64 %23, !dbg !58
  %25 = load i32, ptr %4, align 4, !dbg !59
  %26 = sext i32 %25 to i64, !dbg !58
  %27 = getelementptr inbounds [128 x i32], ptr %24, i64 0, i64 %26, !dbg !58
  ...
  %31 = getelementptr inbounds [512 x [128 x i32]], ptr @G, i64 0, i64 %30, !dbg !63
  %32 = load i32, ptr %4, align 4, !dbg !64
  %33 = add nsw i32 %32, 1, !dbg !65
  %34 = sext i32 %33 to i64, !dbg !63
  %35 = getelementptr inbounds [128 x i32], ptr %31, i64 0, i64 %34, !dbg !63
  ...
  %40 = getelementptr inbounds [512 x [128 x i32]], ptr @G, i64 0, i64 %39, !dbg !70
  %41 = load i32, ptr %4, align 4, !dbg !71
  %42 = add nsw i32 %41, 1, !dbg !72
  %43 = sext i32 %42 to i64, !dbg !70
  %44 = getelementptr inbounds [128 x i32], ptr %40, i64 0, i64 %43, !dbg !70
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !86 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([128 x i32], ptr @G, i64 1, i64 0)), !dbg !95
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16384, !dbg !112
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([128 x i32], ptr @G, i64 1, i64 0)), !dbg !107
...
!3 = !DIFile(filename: "new_dataset/s9n_512_128_0_z.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "872028a7be983e4b0c887536a2d0e18a")
!4 = !{!5, !0}
...
!11 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 2097152, elements: !13)
