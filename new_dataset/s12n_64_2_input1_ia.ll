; ModuleID = 'new_dataset/s12n_64_2_input1_ia.c'
source_filename = "new_dataset/s12n_64_2_input1_ia.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ia = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !0
@ib = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([64 x i32], ptr @ia, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([64 x i32], ptr @ib, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([64 x i16], ptr @input1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([64 x i16], ptr @input2, i64 1, i64 0)), !dbg !89
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([64 x i32], ptr @ia, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([64 x i32], ptr @ib, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_64_2_input1_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "60e42363bf3d0ebffca78767cf5822f8")
!4 = !{!5}
