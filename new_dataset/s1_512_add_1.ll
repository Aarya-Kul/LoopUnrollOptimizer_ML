; ModuleID = 'new_dataset/s1_512_add_1.c'
source_filename = "new_dataset/s1_512_add_1.c"
...
@out = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %17 = getelementptr inbounds [512 x i32], ptr @out, i64 0, i64 %16, !dbg !47
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([512 x i32], ptr @out, i64 1, i64 0)), !dbg !65
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([512 x i32], ptr @out, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s1_512_add_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "84431ec5bd6cb8155f47beff9d6a61cd")
!4 = !{!5, !11, !0, !17}
