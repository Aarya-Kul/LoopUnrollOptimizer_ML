; ModuleID = 'new_dataset/s12n_512_2_2_input1_out1.c'
source_filename = "new_dataset/s12n_512_2_2_input1_out1.c"
...
@out2 = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([512 x i32], ptr @out1, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([512 x i32], ptr @out2, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([512 x i16], ptr @input1, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([512 x i16], ptr @input2, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @out1, ptr noundef @out2), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @out1, ptr noundef @out2), !dbg !122
  br label %18, !dbg !122
...
!3 = !DIFile(filename: "new_dataset/s12n_512_2_2_input1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "e660f01eb547382a54492fde7c02100a")
!4 = !{!5}
...
!47 = !DILocation(line: 33, column: 115, scope: !32)
