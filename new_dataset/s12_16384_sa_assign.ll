; ModuleID = 'new_dataset/s12_16384_sa_assign.c'
source_filename = "new_dataset/s12_16384_sa_assign.c"
...
@sa = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([16384 x i16], ptr @sa, i64 1, i64 0)), !dbg !73
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @assign), !dbg !85
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @assign), !dbg !90
  br label %18, !dbg !90
...
!3 = !DIFile(filename: "new_dataset/s12_16384_sa_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "c94c05f45e42e2ad696514f949b3f47b")
!4 = !{!5}
