; ModuleID = 'new_dataset/s12n_64_2_in1_assign1.c'
source_filename = "new_dataset/s12n_64_2_in1_assign1.c"
...
@assign2 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !21
@in1 = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !13
@in2 = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign1, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign2, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([64 x i16], ptr @in1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([64 x i16], ptr @in2, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @assign1, ptr noundef @assign2), !dbg !101
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @assign1, ptr noundef @assign2), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign1, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign2, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_64_2_in1_assign1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "d5c555643d767c630e82fa08ffa777e5")
!4 = !{!5}
