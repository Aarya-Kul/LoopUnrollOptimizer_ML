; ModuleID = 'new_dataset/s12nn_8192_2_sa_ia.c'
source_filename = "new_dataset/s12nn_8192_2_sa_ia.c"
...
@sa = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !13
@sb = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !19
@sc = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ib, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ic, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([8192 x i16], ptr @sa, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @sb, ptr noundef getelementptr inbounds ([8192 x i16], ptr @sb, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @sc, ptr noundef getelementptr inbounds ([8192 x i16], ptr @sc, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @sc, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @sc, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ib, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ic, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_8192_2_sa_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "2b9701dfa96aea8be02914467a768f46")
!4 = !{!5}
...
!22 = distinct !DIGlobalVariable(name: "sc", scope: !2, file: !3, line: 29, type: !15, isLocal: false, isDefinition: true)
...
!43 = !{}
!44 = !DILocalVariable(name: "sa", arg: 1, scope: !36, file: !3, line: 35, type: !39)
!45 = !DILocation(line: 35, column: 37, scope: !36)
!46 = !DILocalVariable(name: "sb", arg: 2, scope: !36, file: !3, line: 35, type: !39)
!47 = !DILocation(line: 35, column: 61, scope: !36)
!48 = !DILocalVariable(name: "sc", arg: 3, scope: !36, file: !3, line: 35, type: !39)
!49 = !DILocation(line: 35, column: 85, scope: !36)
!50 = !DILocalVariable(name: "ia", arg: 4, scope: !36, file: !3, line: 35, type: !41)
!51 = !DILocation(line: 35, column: 107, scope: !36)
!52 = !DILocalVariable(name: "ib", arg: 5, scope: !36, file: !3, line: 35, type: !41)
!53 = !DILocation(line: 35, column: 129, scope: !36)
!54 = !DILocalVariable(name: "ic", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 151, scope: !36)
...
!67 = !DILocation(line: 38, column: 22, scope: !66)
...
!73 = !DILocation(line: 39, column: 22, scope: !66)
...
!79 = !DILocation(line: 40, column: 22, scope: !66)
