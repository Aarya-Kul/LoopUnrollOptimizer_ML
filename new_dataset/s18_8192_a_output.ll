; ModuleID = 'new_dataset/s18_8192_a_output.c'
source_filename = "new_dataset/s18_8192_a_output.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ua = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@usa = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !59 {
  ...
  call void @init_memory(ptr noundef @ua, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ua, i64 1, i64 0)), !dbg !68
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 524288, !dbg !85
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @usa, ptr noundef getelementptr inbounds ([8192 x i16], ptr @usa, i64 1, i64 0)), !dbg !80
...
!3 = !DIFile(filename: "new_dataset/s18_8192_a_output.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8c31f8ffe3cda7fb9be0c9818f628814")
!4 = !{!5, !11, !0}
...
!17 = !DICompositeType(tag: DW_TAG_array_type, baseType: !18, size: 262144, elements: !15)
...
!32 = !{}
!33 = !DILocalVariable(name: "a", arg: 1, scope: !27, file: !3, line: 30, type: !30)
!34 = !DILocation(line: 30, column: 33, scope: !27)
!35 = !DILocalVariable(name: "output", arg: 2, scope: !27, file: !3, line: 30, type: !31)
!36 = !DILocation(line: 30, column: 50, scope: !27)
...
!47 = !DILocation(line: 35, column: 19, scope: !44)
!48 = !DILocation(line: 35, column: 17, scope: !44)
!49 = !DILocation(line: 35, column: 22, scope: !44)
!50 = !DILocation(line: 35, column: 12, scope: !44)
!51 = !DILocation(line: 35, column: 15, scope: !44)
!52 = !DILocation(line: 35, column: 5, scope: !44)
!53 = !DILocation(line: 34, column: 26, scope: !44)
!54 = !DILocation(line: 34, column: 3, scope: !44)
!55 = distinct !{!55, !46, !56, !57}
!56 = !DILocation(line: 35, column: 25, scope: !41)
