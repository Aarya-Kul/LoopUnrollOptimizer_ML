; ModuleID = 'new_dataset/s8n_512_sub_5.c'
source_filename = "new_dataset/s8n_512_sub_5.c"
...
@o = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !11
...
9:                                                ; preds = %4
  ...
  %14 = getelementptr inbounds [512 x i32], ptr @i1, i64 0, i64 %13, !dbg !46
  %15 = load i32, ptr %14, align 4, !dbg !46
  %16 = load i32, ptr %3, align 4, !dbg !47
  %17 = sext i32 %16 to i64, !dbg !48
  %18 = getelementptr inbounds [512 x i32], ptr @o, i64 0, i64 %17, !dbg !48
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !57 {
  ...
  call void @init_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([512 x i32], ptr @o, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @i1, ptr noundef getelementptr inbounds ([512 x i32], ptr @i1, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @o, ptr noundef getelementptr inbounds ([512 x i32], ptr @o, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s8n_512_sub_5.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f50c911cb8703ae1f39b650da388b444")
!4 = !{!5, !11, !0}
