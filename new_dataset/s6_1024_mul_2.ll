; ModuleID = 'new_dataset/s6_1024_mul_2.c'
source_filename = "new_dataset/s6_1024_mul_2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@input1 = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !0
@input2 = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !17
@output = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([1024 x i32], ptr @output, i64 1, i64 0)), !dbg !67
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @input1, i64 1, i64 0)), !dbg !68
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @input2, i64 1, i64 0)), !dbg !69
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([1024 x i32], ptr @output, i64 1, i64 0)), !dbg !81
...
!3 = !DIFile(filename: "new_dataset/s6_1024_mul_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "e89371daae5b04987861e48b2b43a371")
!4 = !{!5, !11, !0, !17}
