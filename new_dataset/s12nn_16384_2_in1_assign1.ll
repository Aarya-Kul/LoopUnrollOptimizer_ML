; ModuleID = 'new_dataset/s12nn_16384_2_in1_assign1.c'
source_filename = "new_dataset/s12nn_16384_2_in1_assign1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign1 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !0
@assign2 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !23
@assign3 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !26
@in1 = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !13
@in2 = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !19
@in3 = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !21
...
14:                                               ; preds = %48, %6
  ...
  %16 = icmp slt i32 %15, 16384, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([16384 x i32], ptr @assign1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([16384 x i32], ptr @assign2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @assign3, ptr noundef getelementptr inbounds ([16384 x i32], ptr @assign3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([16384 x i16], ptr @in1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([16384 x i16], ptr @in2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @in3, ptr noundef getelementptr inbounds ([16384 x i16], ptr @in3, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @assign1, ptr noundef @assign2, ptr noundef @assign3), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @assign1, ptr noundef @assign2, ptr noundef @assign3), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([16384 x i32], ptr @assign1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([16384 x i32], ptr @assign2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @assign3, ptr noundef getelementptr inbounds ([16384 x i32], ptr @assign3, i64 1, i64 0)), !dbg !117
...
!1 = distinct !DIGlobalVariable(name: "assign1", scope: !2, file: !3, line: 30, type: !25, isLocal: false, isDefinition: true, align: 128)
...
!3 = !DIFile(filename: "new_dataset/s12nn_16384_2_in1_assign1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "5347de5cccf93037ecf215fd45d3b6b0")
!4 = !{!5}
...
!24 = distinct !DIGlobalVariable(name: "assign2", scope: !2, file: !3, line: 31, type: !25, isLocal: false, isDefinition: true, align: 128)
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 524288, elements: !17)
!26 = !DIGlobalVariableExpression(var: !27, expr: !DIExpression())
!27 = distinct !DIGlobalVariable(name: "assign3", scope: !2, file: !3, line: 32, type: !25, isLocal: false, isDefinition: true, align: 128)
...
!50 = !DILocalVariable(name: "assign1", arg: 4, scope: !36, file: !3, line: 35, type: !41)
!51 = !DILocation(line: 35, column: 110, scope: !36)
!52 = !DILocalVariable(name: "assign2", arg: 5, scope: !36, file: !3, line: 35, type: !41)
!53 = !DILocation(line: 35, column: 137, scope: !36)
!54 = !DILocalVariable(name: "assign3", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 164, scope: !36)
...
!67 = !DILocation(line: 38, column: 28, scope: !66)
...
!73 = !DILocation(line: 39, column: 28, scope: !66)
...
!79 = !DILocation(line: 40, column: 28, scope: !66)
...
!85 = !DILocation(line: 37, column: 27, scope: !62)
