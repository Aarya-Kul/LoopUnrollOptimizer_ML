; ModuleID = 'new_dataset/s15_1024_1024_mul_0.c'
source_filename = "new_dataset/s15_1024_1024_mul_0.c"
...
@A = dso_local global [1024 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [1024 x [1024 x i32]] zeroinitializer, align 16, !dbg !17
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([1024 x i32], ptr @A, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([1024 x i32], ptr @B, i64 1, i64 0)), !dbg !98
...
!3 = !DIFile(filename: "new_dataset/s15_1024_1024_mul_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "08bdf5908a2ef532b5d95d2aa3c3bb57")
!4 = !{!5, !0, !11, !17}
...
!38 = !DILocation(line: 32, column: 35, scope: !29)
!39 = !DILocalVariable(name: "out", arg: 3, scope: !29, file: !3, line: 32, type: !33)
!40 = !DILocation(line: 32, column: 51, scope: !29)
...
!52 = !DILocalVariable(name: "mul", scope: !53, file: !3, line: 35, type: !14)
...
!64 = !DILocation(line: 37, column: 17, scope: !63)
!65 = !DILocation(line: 37, column: 20, scope: !63)
!66 = !DILocation(line: 37, column: 24, scope: !63)
!67 = !DILocation(line: 37, column: 26, scope: !63)
!68 = !DILocation(line: 37, column: 29, scope: !63)
!69 = !DILocation(line: 37, column: 23, scope: !63)
