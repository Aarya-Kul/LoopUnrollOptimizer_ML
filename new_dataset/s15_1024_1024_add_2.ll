; ModuleID = 'new_dataset/s15_1024_1024_add_2.c'
source_filename = "new_dataset/s15_1024_1024_add_2.c"
...
@in1 = dso_local global [1024 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@in2 = dso_local global [1024 x [1024 x i32]] zeroinitializer, align 16, !dbg !17
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in2, i64 1, i64 0)), !dbg !98
...
!3 = !DIFile(filename: "new_dataset/s15_1024_1024_add_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "41168249c6e41d32b869428af36d52d8")
!4 = !{!5, !0, !11, !17}
...
!52 = !DILocalVariable(name: "output", scope: !53, file: !3, line: 35, type: !14)
...
!64 = !DILocation(line: 37, column: 22, scope: !63)
!65 = !DILocation(line: 37, column: 25, scope: !63)
!66 = !DILocation(line: 37, column: 29, scope: !63)
!67 = !DILocation(line: 37, column: 33, scope: !63)
!68 = !DILocation(line: 37, column: 36, scope: !63)
!69 = !DILocation(line: 37, column: 28, scope: !63)
