; ModuleID = 'new_dataset/s12n_256_2_2_input1_assign1.c'
source_filename = "new_dataset/s12n_256_2_2_input1_assign1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign1 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@assign2 = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([256 x i32], ptr @assign1, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([256 x i32], ptr @assign2, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([256 x i16], ptr @input1, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([256 x i16], ptr @input2, i64 1, i64 0)), !dbg !105
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([256 x i32], ptr @assign1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([256 x i32], ptr @assign2, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12n_256_2_2_input1_assign1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "6d285a460fc75e9fa29e1632a4e1fa9e")
!4 = !{!5}
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 8192, elements: !17)
