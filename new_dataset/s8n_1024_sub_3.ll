; ModuleID = 'new_dataset/s8n_1024_sub_3.c'
source_filename = "new_dataset/s8n_1024_sub_3.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@input = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !0
...
9:                                                ; preds = %4
  ...
  %14 = getelementptr inbounds [1024 x i32], ptr @input, i64 0, i64 %13, !dbg !46
  %15 = load i32, ptr %14, align 4, !dbg !46
  %16 = load i32, ptr %3, align 4, !dbg !47
  %17 = sext i32 %16 to i64, !dbg !48
  %18 = getelementptr inbounds [1024 x i32], ptr @result, i64 0, i64 %17, !dbg !48
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !57 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @input, ptr noundef getelementptr inbounds ([1024 x i32], ptr @input, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 524288, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s8n_1024_sub_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "90280ab4fbda4c634e458e7f4596823b")
!4 = !{!5, !11, !0}
