; ModuleID = 'new_dataset/s15_4096_64_mul_0.c'
source_filename = "new_dataset/s15_4096_64_mul_0.c"
...
@A = dso_local global [4096 x [64 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [4096 x [64 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([64 x i32], ptr @A, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([64 x i32], ptr @B, i64 1, i64 0)), !dbg !99
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 8192, !dbg !116
...
!3 = !DIFile(filename: "new_dataset/s15_4096_64_mul_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "d18ea90ad05042477d3476d0bc80f848")
!4 = !{!5, !0, !11, !18}
...
!39 = !DILocation(line: 32, column: 33, scope: !30)
!40 = !DILocalVariable(name: "out", arg: 3, scope: !30, file: !3, line: 32, type: !34)
!41 = !DILocation(line: 32, column: 47, scope: !30)
