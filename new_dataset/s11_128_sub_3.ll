; ModuleID = 'new_dataset/s11_128_sub_3.c'
source_filename = "new_dataset/s11_128_sub_3.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@int1 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !0
@int2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !21
@int3 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !25
@short1 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !11
@short2 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !17
@short3 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @int1, ptr noundef getelementptr inbounds ([128 x i32], ptr @int1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @int2, ptr noundef getelementptr inbounds ([128 x i32], ptr @int2, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @int3, ptr noundef getelementptr inbounds ([128 x i32], ptr @int3, i64 1, i64 0)), !dbg !99
  call void @init_memory(ptr noundef @short1, ptr noundef getelementptr inbounds ([128 x i16], ptr @short1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @short2, ptr noundef getelementptr inbounds ([128 x i16], ptr @short2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @short3, ptr noundef getelementptr inbounds ([128 x i16], ptr @short3, i64 1, i64 0)), !dbg !102
  ...
  call void @example10a(ptr noundef @short1, ptr noundef @short2, ptr noundef @short3, ptr noundef @int1, ptr noundef @int2, ptr noundef @int3), !dbg !114
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4194304, !dbg !119
  br i1 %16, label %17, label %21, !dbg !118

17:                                               ; preds = %14
  call void @example10a(ptr noundef @short1, ptr noundef @short2, ptr noundef @short3, ptr noundef @int1, ptr noundef @int2, ptr noundef @int3), !dbg !119
  br label %18, !dbg !119
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @int1, ptr noundef getelementptr inbounds ([128 x i32], ptr @int1, i64 1, i64 0)), !dbg !114
  %24 = call i32 @digest_memory(ptr noundef @short1, ptr noundef getelementptr inbounds ([128 x i16], ptr @short1, i64 1, i64 0)), !dbg !114
...
!1 = distinct !DIGlobalVariable(name: "int1", scope: !2, file: !3, line: 30, type: !23, isLocal: false, isDefinition: true, align: 128)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s11_128_sub_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8cd250b7e34e75e75b2ad621ea453909")
...
!12 = distinct !DIGlobalVariable(name: "short1", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true)
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 2048, elements: !15)
!14 = !DIBasicType(name: "short", size: 16, encoding: DW_ATE_signed)
!15 = !{!16}
!16 = !DISubrange(count: 128)
!17 = !DIGlobalVariableExpression(var: !18, expr: !DIExpression())
!18 = distinct !DIGlobalVariable(name: "short2", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true)
!19 = !DIGlobalVariableExpression(var: !20, expr: !DIExpression())
!20 = distinct !DIGlobalVariable(name: "short3", scope: !2, file: !3, line: 29, type: !13, isLocal: false, isDefinition: true)
!21 = !DIGlobalVariableExpression(var: !22, expr: !DIExpression())
!22 = distinct !DIGlobalVariable(name: "int2", scope: !2, file: !3, line: 31, type: !23, isLocal: false, isDefinition: true, align: 128)
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !24, size: 4096, elements: !15)
!24 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!25 = !DIGlobalVariableExpression(var: !26, expr: !DIExpression())
!26 = distinct !DIGlobalVariable(name: "int3", scope: !2, file: !3, line: 32, type: !23, isLocal: false, isDefinition: true, align: 128)
...
!42 = !{}
!43 = !DILocalVariable(name: "short1", arg: 1, scope: !35, file: !3, line: 35, type: !38)
!44 = !DILocation(line: 35, column: 37, scope: !35)
!45 = !DILocalVariable(name: "short2", arg: 2, scope: !35, file: !3, line: 35, type: !38)
!46 = !DILocation(line: 35, column: 65, scope: !35)
!47 = !DILocalVariable(name: "short3", arg: 3, scope: !35, file: !3, line: 35, type: !38)
!48 = !DILocation(line: 35, column: 93, scope: !35)
!49 = !DILocalVariable(name: "int1", arg: 4, scope: !35, file: !3, line: 35, type: !40)
!50 = !DILocation(line: 35, column: 119, scope: !35)
!51 = !DILocalVariable(name: "int2", arg: 5, scope: !35, file: !3, line: 35, type: !40)
!52 = !DILocation(line: 35, column: 143, scope: !35)
!53 = !DILocalVariable(name: "int3", arg: 6, scope: !35, file: !3, line: 35, type: !40)
!54 = !DILocation(line: 35, column: 167, scope: !35)
...
!66 = !DILocation(line: 38, column: 20, scope: !65)
!67 = !DILocation(line: 38, column: 25, scope: !65)
!68 = !DILocation(line: 38, column: 30, scope: !65)
!69 = !DILocation(line: 38, column: 23, scope: !65)
...
!74 = !DILocation(line: 39, column: 24, scope: !65)
!75 = !DILocation(line: 39, column: 29, scope: !65)
!76 = !DILocation(line: 39, column: 36, scope: !65)
!77 = !DILocation(line: 39, column: 27, scope: !65)
!78 = !DILocation(line: 39, column: 5, scope: !65)
!79 = !DILocation(line: 39, column: 12, scope: !65)
!80 = !DILocation(line: 39, column: 15, scope: !65)
