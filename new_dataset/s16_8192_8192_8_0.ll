; ModuleID = 'new_dataset/s16_8192_8192_8_0.c'
source_filename = "new_dataset/s16_8192_8192_8_0.c"
...
@G2 = dso_local global [8200 x [8192 x i32]] zeroinitializer, align 16, !dbg !17
...
15:                                               ; preds = %48, %14
  ...
  %17 = icmp slt i32 %16, 8192, !dbg !68
...
19:                                               ; preds = %44, %18
  ...
  %21 = icmp slt i32 %20, 8192, !dbg !75
...
22:                                               ; preds = %19
  ...
  %28 = getelementptr inbounds [8192 x i32], ptr %23, i64 %27, !dbg !77
  %29 = load i32, ptr %8, align 4, !dbg !81
  %30 = sext i32 %29 to i64, !dbg !77
  %31 = getelementptr inbounds [8192 x i32], ptr %28, i64 0, i64 %30, !dbg !77
  ...
  %36 = getelementptr inbounds [8192 x i32], ptr %33, i64 %35, !dbg !82
  %37 = load i32, ptr %8, align 4, !dbg !84
  %38 = sext i32 %37 to i64, !dbg !82
  %39 = getelementptr inbounds [8192 x i32], ptr %36, i64 0, i64 %38, !dbg !82
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !107 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([8192 x i32], ptr @G, i64 1, i64 0)), !dbg !117
  call void @init_memory(ptr noundef @G2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @G2, i64 1, i64 0)), !dbg !118
...
!3 = !DIFile(filename: "new_dataset/s16_8192_8192_8_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "97d8754d3211bc3b513ce8b578ff0600")
!4 = !{!5, !0, !11, !17}
...
!19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 2149580800, elements: !20)
!20 = !{!21, !16}
!21 = !DISubrange(count: 8200)
...
!37 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 262144, elements: !38)
!38 = !{!16}
