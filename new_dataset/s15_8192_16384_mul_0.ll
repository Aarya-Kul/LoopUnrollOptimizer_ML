; ModuleID = 'new_dataset/s15_8192_16384_mul_0.c'
source_filename = "new_dataset/s15_8192_16384_mul_0.c"
...
@A = dso_local global [8192 x [16384 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [8192 x [16384 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([16384 x i32], ptr @A, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([16384 x i32], ptr @B, i64 1, i64 0)), !dbg !99
...
!3 = !DIFile(filename: "new_dataset/s15_8192_16384_mul_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "2fd651b73a20e4833a7b0c9c8666cfdf")
!4 = !{!5, !0, !11, !18}
...
!53 = !DILocalVariable(name: "mul", scope: !54, file: !3, line: 35, type: !14)
...
!65 = !DILocation(line: 37, column: 17, scope: !64)
!66 = !DILocation(line: 37, column: 20, scope: !64)
!67 = !DILocation(line: 37, column: 24, scope: !64)
!68 = !DILocation(line: 37, column: 26, scope: !64)
!69 = !DILocation(line: 37, column: 29, scope: !64)
!70 = !DILocation(line: 37, column: 23, scope: !64)
