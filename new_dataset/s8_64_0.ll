; ModuleID = 'new_dataset/s8_64_0.c'
source_filename = "new_dataset/s8_64_0.c"
...
4:                                                ; preds = %19, %1
  ...
  %7 = sub nsw i32 64, %6, !dbg !39
  %8 = icmp slt i32 %5, %7, !dbg !40
  br i1 %8, label %9, label %22, !dbg !41
...
9:                                                ; preds = %4
  ...
  %14 = getelementptr inbounds [64 x i32], ptr @b, i64 0, i64 %13, !dbg !46
  %15 = load i32, ptr %14, align 4, !dbg !46
  %16 = load i32, ptr %3, align 4, !dbg !47
  %17 = sext i32 %16 to i64, !dbg !48
  %18 = getelementptr inbounds [64 x i32], ptr @a, i64 0, i64 %17, !dbg !48
  store i32 %15, ptr %18, align 4, !dbg !49
  br label %19, !dbg !50

19:                                               ; preds = %9
  %20 = load i32, ptr %3, align 4, !dbg !51
  %21 = add nsw i32 %20, 1, !dbg !51
  store i32 %21, ptr %3, align 4, !dbg !51
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !57 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([64 x i32], ptr @a, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([64 x i32], ptr @b, i64 1, i64 0)), !dbg !67
...
!3 = !DIFile(filename: "new_dataset/s8_64_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "272e3210c09b0f3e62fb6d9c154ae0ac")
!4 = !{!5, !11, !0}
...
!51 = !DILocation(line: 35, column: 23, scope: !37)
