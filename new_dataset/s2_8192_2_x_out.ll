; ModuleID = 'new_dataset/s2_8192_2_x_out.c'
source_filename = "new_dataset/s2_8192_2_x_out.c"
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [8192 x i32], ptr @out, i64 0, i64 %10, !dbg !41
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out, i64 1, i64 0)), !dbg !59
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([8192 x i32], ptr @out, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "new_dataset/s2_8192_2_x_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "c76abe81c56b77fbdbfd9c91b406889c")
!4 = !{!5, !0}
...
!39 = distinct !DILexicalBlock(scope: !35, file: !3, line: 34, column: 30)
...
!44 = !DILocation(line: 34, column: 25, scope: !35)
