; ModuleID = 'new_dataset/s7n_4096_4.c'
source_filename = "new_dataset/s7n_4096_4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@in = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !0
@res = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !11
...
7:                                                ; preds = %4
  ...
  %10 = getelementptr inbounds [4096 x i32], ptr @in, i64 0, i64 %9, !dbg !45
  ...
  %18 = getelementptr inbounds [4096 x i32], ptr @res, i64 0, i64 %17, !dbg !49
  ...
  %23 = getelementptr inbounds [4096 x i32], ptr @res, i64 0, i64 %22, !dbg !54
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @in, ptr noundef getelementptr inbounds ([4096 x i32], ptr @in, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @res, ptr noundef getelementptr inbounds ([4096 x i32], ptr @res, i64 1, i64 0)), !dbg !73
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 524288, !dbg !90
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @res, ptr noundef getelementptr inbounds ([4096 x i32], ptr @res, i64 1, i64 0)), !dbg !85
...
!1 = distinct !DIGlobalVariable(name: "in", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true, align: 128)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s7n_4096_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "ed1e063cfec1d1016a31c2301640bd26")
!4 = !{!5, !0, !11}
...
!12 = distinct !DIGlobalVariable(name: "res", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true, align: 128)
...
!44 = !DILocation(line: 36, column: 18, scope: !42)
!45 = !DILocation(line: 36, column: 15, scope: !42)
!46 = !DILocation(line: 37, column: 17, scope: !42)
!47 = !DILocation(line: 37, column: 19, scope: !42)
!48 = !DILocation(line: 37, column: 11, scope: !42)
!49 = !DILocation(line: 37, column: 7, scope: !42)
!50 = !DILocation(line: 37, column: 14, scope: !42)
!51 = !DILocation(line: 38, column: 18, scope: !42)
!52 = !DILocation(line: 38, column: 11, scope: !42)
!53 = !DILocation(line: 38, column: 12, scope: !42)
!54 = !DILocation(line: 38, column: 7, scope: !42)
!55 = !DILocation(line: 38, column: 16, scope: !42)
