; ModuleID = 'new_dataset/s15_1024_1024_sub_4.c'
source_filename = "new_dataset/s15_1024_1024_sub_4.c"
...
@op1 = dso_local global [1024 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [1024 x [1024 x i32]] zeroinitializer, align 16, !dbg !17
...
10:                                               ; preds = %46, %3
  ...
  %12 = icmp slt i32 %11, 1024, !dbg !50
...
14:                                               ; preds = %37, %13
  ...
  %16 = icmp slt i32 %15, 1024, !dbg !60
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [1024 x i32], ptr %18, i64 %20, !dbg !62
  %22 = load i32, ptr %8, align 4, !dbg !65
  %23 = sext i32 %22 to i64, !dbg !62
  %24 = getelementptr inbounds [1024 x i32], ptr %21, i64 0, i64 %23, !dbg !62
  ...
  %29 = getelementptr inbounds [1024 x i32], ptr %26, i64 %28, !dbg !66
  %30 = load i32, ptr %8, align 4, !dbg !68
  %31 = sext i32 %30 to i64, !dbg !66
  %32 = getelementptr inbounds [1024 x i32], ptr %29, i64 0, i64 %31, !dbg !66
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([1024 x i32], ptr @ia, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @op1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @op2, i64 1, i64 0)), !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([1024 x i32], ptr @ia, i64 1, i64 0)), !dbg !110
...
!3 = !DIFile(filename: "new_dataset/s15_1024_1024_sub_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1ee6073c76076d0ded4aa0d0a0c4795d")
!4 = !{!5, !0, !11, !17}
