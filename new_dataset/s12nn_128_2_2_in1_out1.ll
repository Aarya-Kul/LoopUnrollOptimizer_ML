; ModuleID = 'new_dataset/s12nn_128_2_2_in1_out1.c'
source_filename = "new_dataset/s12nn_128_2_2_in1_out1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out1 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !0
@out2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !26
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([128 x i32], ptr @out1, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([128 x i32], ptr @out2, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([128 x i32], ptr @out3, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i16], ptr @in1, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i16], ptr @in2, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @in3, ptr noundef getelementptr inbounds ([128 x i16], ptr @in3, i64 1, i64 0)), !dbg !129
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !141
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !146
  br label %18, !dbg !146
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([128 x i32], ptr @out1, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([128 x i32], ptr @out2, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([128 x i32], ptr @out3, i64 1, i64 0)), !dbg !141
...
!3 = !DIFile(filename: "new_dataset/s12nn_128_2_2_in1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "dd11cb99f7e957a02d0d252342f7a121")
!4 = !{!5}
...
!55 = !DILocation(line: 35, column: 158, scope: !36)
...
!67 = !DILocation(line: 38, column: 25, scope: !66)
...
!74 = !DILocation(line: 39, column: 24, scope: !66)
...
!81 = !DILocation(line: 40, column: 25, scope: !66)
...
!87 = !DILocation(line: 41, column: 23, scope: !66)
!88 = !DILocation(line: 41, column: 24, scope: !66)
...
!95 = !DILocation(line: 42, column: 25, scope: !66)
...
!101 = !DILocation(line: 43, column: 23, scope: !66)
!102 = !DILocation(line: 43, column: 24, scope: !66)
