; ModuleID = 'new_dataset/s10_16384_mul_3.c'
source_filename = "new_dataset/s10_16384_mul_3.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ub = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !0
@uc = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !61 {
  ...
  call void @init_memory(ptr noundef @ub, ptr noundef getelementptr inbounds ([16384 x i32], ptr @ub, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @uc, ptr noundef getelementptr inbounds ([16384 x i32], ptr @uc, i64 1, i64 0)), !dbg !73
...
15:                                               ; preds = %19, %2
  ...
  %17 = icmp slt i32 %16, 131072, !dbg !90
...
!1 = distinct !DIGlobalVariable(name: "ub", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s10_16384_mul_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "7a30c8dca9c96e2e0cc430625963d729")
!4 = !{!5, !0, !11}
...
!12 = distinct !DIGlobalVariable(name: "uc", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true)
...
!35 = !DILocalVariable(name: "result", scope: !25, file: !3, line: 36, type: !14)
...
!44 = !DILocation(line: 38, column: 19, scope: !45)
!45 = distinct !DILexicalBlock(scope: !41, file: !3, line: 37, column: 31)
!46 = !DILocation(line: 38, column: 16, scope: !45)
!47 = !DILocation(line: 38, column: 26, scope: !45)
!48 = !DILocation(line: 38, column: 23, scope: !45)
!49 = !DILocation(line: 38, column: 22, scope: !45)
!50 = !DILocation(line: 38, column: 12, scope: !45)
!51 = !DILocation(line: 39, column: 3, scope: !45)
!52 = !DILocation(line: 37, column: 27, scope: !41)
