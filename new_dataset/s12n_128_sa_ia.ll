; ModuleID = 'new_dataset/s12n_128_sa_ia.c'
source_filename = "new_dataset/s12n_128_sa_ia.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([128 x i32], ptr @ia, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([128 x i32], ptr @ib, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([128 x i16], ptr @sa, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @sb, ptr noundef getelementptr inbounds ([128 x i16], ptr @sb, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @ia, ptr noundef @ib), !dbg !101
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !106
  br i1 %16, label %17, label %21, !dbg !105

17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @ia, ptr noundef @ib), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([128 x i32], ptr @ia, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([128 x i32], ptr @ib, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_128_sa_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "9efbdfe1a4c129b506abca479201ca08")
!4 = !{!5}
...
!65 = !DILocation(line: 37, column: 22, scope: !58)
