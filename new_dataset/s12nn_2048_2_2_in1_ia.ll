; ModuleID = 'new_dataset/s12nn_2048_2_2_in1_ia.c'
source_filename = "new_dataset/s12nn_2048_2_2_in1_ia.c"
...
@ib = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !23
@ic = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !26
@in1 = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !13
@in2 = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !19
@in3 = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !21
...
14:                                               ; preds = %84, %6
  ...
  %16 = icmp slt i32 %15, 2047, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ib, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ic, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([2048 x i16], ptr @in1, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([2048 x i16], ptr @in2, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @in3, ptr noundef getelementptr inbounds ([2048 x i16], ptr @in3, i64 1, i64 0)), !dbg !129
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !141
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !146
  br i1 %16, label %17, label %21, !dbg !145

17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !146
  br label %18, !dbg !146
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ib, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ic, i64 1, i64 0)), !dbg !141
...
!3 = !DIFile(filename: "new_dataset/s12nn_2048_2_2_in1_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "e4d255fd696668b78c7d7aa90474c5d9")
!4 = !{!5}
...
!14 = distinct !DIGlobalVariable(name: "in1", scope: !2, file: !3, line: 27, type: !15, isLocal: false, isDefinition: true)
...
!20 = distinct !DIGlobalVariable(name: "in2", scope: !2, file: !3, line: 28, type: !15, isLocal: false, isDefinition: true)
!21 = !DIGlobalVariableExpression(var: !22, expr: !DIExpression())
!22 = distinct !DIGlobalVariable(name: "in3", scope: !2, file: !3, line: 29, type: !15, isLocal: false, isDefinition: true)
!23 = !DIGlobalVariableExpression(var: !24, expr: !DIExpression())
!24 = distinct !DIGlobalVariable(name: "ib", scope: !2, file: !3, line: 31, type: !25, isLocal: false, isDefinition: true, align: 128)
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 65536, elements: !17)
...
!43 = !{}
!44 = !DILocalVariable(name: "in1", arg: 1, scope: !36, file: !3, line: 35, type: !39)
!45 = !DILocation(line: 35, column: 37, scope: !36)
!46 = !DILocalVariable(name: "in2", arg: 2, scope: !36, file: !3, line: 35, type: !39)
!47 = !DILocation(line: 35, column: 62, scope: !36)
!48 = !DILocalVariable(name: "in3", arg: 3, scope: !36, file: !3, line: 35, type: !39)
!49 = !DILocation(line: 35, column: 87, scope: !36)
!50 = !DILocalVariable(name: "ia", arg: 4, scope: !36, file: !3, line: 35, type: !41)
!51 = !DILocation(line: 35, column: 110, scope: !36)
!52 = !DILocalVariable(name: "ib", arg: 5, scope: !36, file: !3, line: 35, type: !41)
!53 = !DILocation(line: 35, column: 132, scope: !36)
!54 = !DILocalVariable(name: "ic", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 154, scope: !36)
...
!73 = !DILocation(line: 39, column: 21, scope: !66)
!74 = !DILocation(line: 39, column: 22, scope: !66)
...
!81 = !DILocation(line: 40, column: 23, scope: !66)
...
!87 = !DILocation(line: 41, column: 21, scope: !66)
!88 = !DILocation(line: 41, column: 22, scope: !66)
...
!95 = !DILocation(line: 42, column: 23, scope: !66)
...
!101 = !DILocation(line: 43, column: 21, scope: !66)
!102 = !DILocation(line: 43, column: 22, scope: !66)
