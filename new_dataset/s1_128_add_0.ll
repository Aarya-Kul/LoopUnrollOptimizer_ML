; ModuleID = 'new_dataset/s1_128_add_0.c'
source_filename = "new_dataset/s1_128_add_0.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([128 x i32], ptr @a, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([128 x i32], ptr @b, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @c, ptr noundef getelementptr inbounds ([128 x i32], ptr @c, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([128 x i32], ptr @a, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s1_128_add_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "ba9d6d6ef76e42d329063fcdf2c1a889")
!4 = !{!5, !11, !0, !17}
