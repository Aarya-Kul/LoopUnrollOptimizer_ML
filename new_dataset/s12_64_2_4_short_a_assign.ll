; ModuleID = 'new_dataset/s12_64_2_4_short_a_assign.c'
source_filename = "new_dataset/s12_64_2_4_short_a_assign.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !0
@short_a = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([64 x i16], ptr @short_a, i64 1, i64 0)), !dbg !97
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @assign), !dbg !109
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 33554432, !dbg !114
  br i1 %16, label %17, label %21, !dbg !113

17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @assign), !dbg !114
  br label %18, !dbg !114
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign, i64 1, i64 0)), !dbg !109
...
!3 = !DIFile(filename: "new_dataset/s12_64_2_4_short_a_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "bf4cce5c5b14cbc4cfd1a1530334ff78")
!4 = !{!5}
...
!19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 2048, elements: !17)
...
!50 = distinct !DILexicalBlock(scope: !46, file: !3, line: 33, column: 31)
!51 = !DILocation(line: 34, column: 31, scope: !50)
...
!57 = !DILocation(line: 35, column: 29, scope: !50)
!58 = !DILocation(line: 35, column: 30, scope: !50)
...
!65 = !DILocation(line: 36, column: 29, scope: !50)
!66 = !DILocation(line: 36, column: 30, scope: !50)
...
!73 = !DILocation(line: 37, column: 29, scope: !50)
!74 = !DILocation(line: 37, column: 30, scope: !50)
...
!81 = !DILocation(line: 33, column: 26, scope: !46)
