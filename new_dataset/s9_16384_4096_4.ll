; ModuleID = 'new_dataset/s9_16384_4096_4.c'
source_filename = "new_dataset/s9_16384_4096_4.c"
...
9:                                                ; preds = %20, %8
  ...
  %11 = icmp slt i32 %10, 4096, !dbg !47
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([4096 x i32], ptr @assign, i64 1, i64 0)), !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([4096 x i32], ptr @assign, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_16384_4096_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "77ab5d93edbdafb399b83f53eca9bef6")
!4 = !{!5, !0}
...
!62 = !DILocation(line: 33, column: 24, scope: !38)
