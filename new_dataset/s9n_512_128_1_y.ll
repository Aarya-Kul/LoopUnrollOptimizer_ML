; ModuleID = 'new_dataset/s9n_512_128_1_y.c'
source_filename = "new_dataset/s9n_512_128_1_y.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@Out = dso_local global [512 x [128 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [512 x [128 x i32]], ptr @Out, i64 0, i64 %15, !dbg !52
  ...
  %24 = getelementptr inbounds [512 x [128 x i32]], ptr @Out, i64 0, i64 %23, !dbg !58
  ...
  %31 = getelementptr inbounds [512 x [128 x i32]], ptr @Out, i64 0, i64 %30, !dbg !63
  ...
  %40 = getelementptr inbounds [512 x [128 x i32]], ptr @Out, i64 0, i64 %39, !dbg !70
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !86 {
  ...
  call void @init_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([128 x i32], ptr @Out, i64 1, i64 0)), !dbg !95
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([128 x i32], ptr @Out, i64 1, i64 0)), !dbg !107
...
!3 = !DIFile(filename: "new_dataset/s9n_512_128_1_y.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "7027fd7b26a59e655fb8010ec8345f8a")
!4 = !{!5, !0}
