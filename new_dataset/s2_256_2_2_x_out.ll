; ModuleID = 'new_dataset/s2_256_2_2_x_out.c'
source_filename = "new_dataset/s2_256_2_2_x_out.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([256 x i32], ptr @out, i64 1, i64 0)), !dbg !65
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([256 x i32], ptr @out, i64 1, i64 0)), !dbg !77
...
!3 = !DIFile(filename: "new_dataset/s2_256_2_2_x_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "b5a895aca299c60d96165e4eb964e412")
!4 = !{!5, !0}
