; ModuleID = 'new_dataset/s15_256_8192_add_4.c'
source_filename = "new_dataset/s15_256_8192_add_4.c"
...
@op1 = dso_local global [256 x [8192 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [256 x [8192 x i32]] zeroinitializer, align 16, !dbg !18
...
14:                                               ; preds = %37, %13
  ...
  %16 = icmp slt i32 %15, 8192, !dbg !61
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [8192 x i32], ptr %18, i64 %20, !dbg !63
  %22 = load i32, ptr %8, align 4, !dbg !66
  %23 = sext i32 %22 to i64, !dbg !63
  %24 = getelementptr inbounds [8192 x i32], ptr %21, i64 0, i64 %23, !dbg !63
  ...
  %29 = getelementptr inbounds [8192 x i32], ptr %26, i64 %28, !dbg !67
  %30 = load i32, ptr %8, align 4, !dbg !69
  %31 = sext i32 %30 to i64, !dbg !67
  %32 = getelementptr inbounds [8192 x i32], ptr %29, i64 0, i64 %31, !dbg !67
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([8192 x i32], ptr @op1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([8192 x i32], ptr @op2, i64 1, i64 0)), !dbg !99
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !111
...
!3 = !DIFile(filename: "new_dataset/s15_256_8192_add_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "6185fea669e5169aee004f00969197f8")
!4 = !{!5, !0, !11, !18}
