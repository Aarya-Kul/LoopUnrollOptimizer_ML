; ModuleID = 'new_dataset/s12nn_128_in1_ia.c'
source_filename = "new_dataset/s12nn_128_in1_ia.c"
...
@ib = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !23
@ic = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !26
@in1 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !13
@in2 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !19
@in3 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([128 x i32], ptr @ia, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([128 x i32], ptr @ib, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([128 x i32], ptr @ic, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i16], ptr @in1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i16], ptr @in2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @in3, ptr noundef getelementptr inbounds ([128 x i16], ptr @in3, i64 1, i64 0)), !dbg !105
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([128 x i32], ptr @ia, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([128 x i32], ptr @ib, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([128 x i32], ptr @ic, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_128_in1_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "69ccbe91bc31dbefa87f6e110b801894")
!4 = !{!5}
...
!66 = distinct !DILexicalBlock(scope: !62, file: !3, line: 37, column: 29)
