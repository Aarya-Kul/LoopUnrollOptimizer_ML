; ModuleID = 'new_dataset/s15_4096_1024_add_4.c'
source_filename = "new_dataset/s15_4096_1024_add_4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ia = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !0
@op1 = dso_local global [4096 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [4096 x [1024 x i32]] zeroinitializer, align 16, !dbg !18
...
10:                                               ; preds = %46, %3
  ...
  %12 = icmp slt i32 %11, 4096, !dbg !51
...
14:                                               ; preds = %37, %13
  ...
  %16 = icmp slt i32 %15, 1024, !dbg !61
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [1024 x i32], ptr %18, i64 %20, !dbg !63
  %22 = load i32, ptr %8, align 4, !dbg !66
  %23 = sext i32 %22 to i64, !dbg !63
  %24 = getelementptr inbounds [1024 x i32], ptr %21, i64 0, i64 %23, !dbg !63
  ...
  %29 = getelementptr inbounds [1024 x i32], ptr %26, i64 %28, !dbg !67
  %30 = load i32, ptr %8, align 4, !dbg !69
  %31 = sext i32 %30 to i64, !dbg !67
  %32 = getelementptr inbounds [1024 x i32], ptr %29, i64 0, i64 %31, !dbg !67
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([1024 x i32], ptr @ia, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @op1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @op2, i64 1, i64 0)), !dbg !99
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([1024 x i32], ptr @ia, i64 1, i64 0)), !dbg !111
...
!3 = !DIFile(filename: "new_dataset/s15_4096_1024_add_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "69bf7b9c25ad4f4d5b1f2097b6d174ce")
!4 = !{!5, !0, !11, !18}
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 32768, elements: !21)
!21 = !{!17}
...
!39 = !DILocation(line: 32, column: 37, scope: !30)
!40 = !DILocalVariable(name: "out", arg: 3, scope: !30, file: !3, line: 32, type: !34)
!41 = !DILocation(line: 32, column: 55, scope: !30)
