; ModuleID = 'new_dataset/s12n_2048_input1_out1.c'
source_filename = "new_dataset/s12n_2048_input1_out1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out1 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !0
@out2 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !21
...
10:                                               ; preds = %34, %4
  ...
  %12 = icmp slt i32 %11, 2048, !dbg !55
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out1, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out2, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([2048 x i16], ptr @input1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([2048 x i16], ptr @input2, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @out1, ptr noundef @out2), !dbg !101
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !106
  br i1 %16, label %17, label %21, !dbg !105

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @out1, ptr noundef @out2), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out1, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @out2, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_2048_input1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "e3033b9f1227d4ba999120edc6ab43c6")
!4 = !{!5}
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 65536, elements: !17)
