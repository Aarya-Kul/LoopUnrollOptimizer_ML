; ModuleID = 'new_dataset/s12_16384_sa_result.c'
source_filename = "new_dataset/s12_16384_sa_result.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([16384 x i32], ptr @result, i64 1, i64 0)), !dbg !72
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([16384 x i32], ptr @result, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s12_16384_sa_result.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "020820e5c0cbdd55881cade9adff940b")
!4 = !{!5}
