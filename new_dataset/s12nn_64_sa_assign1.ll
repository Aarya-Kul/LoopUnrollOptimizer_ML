; ModuleID = 'new_dataset/s12nn_64_sa_assign1.c'
source_filename = "new_dataset/s12nn_64_sa_assign1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign1 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !0
@assign2 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !23
@assign3 = dso_local global [64 x i32] zeroinitializer, align 16, !dbg !26
@sa = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !13
@sb = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !19
@sc = dso_local global [64 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @assign3, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([64 x i16], ptr @sa, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @sb, ptr noundef getelementptr inbounds ([64 x i16], ptr @sb, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @sc, ptr noundef getelementptr inbounds ([64 x i16], ptr @sc, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @sc, ptr noundef @assign1, ptr noundef @assign2, ptr noundef @assign3), !dbg !117
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 33554432, !dbg !122
  br i1 %16, label %17, label %21, !dbg !121

17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @sc, ptr noundef @assign1, ptr noundef @assign2, ptr noundef @assign3), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @assign3, ptr noundef getelementptr inbounds ([64 x i32], ptr @assign3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_64_sa_assign1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "30f465662e3d68525fb670d555202118")
!4 = !{!5}
...
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 2048, elements: !17)
...
!53 = !DILocation(line: 35, column: 134, scope: !36)
!54 = !DILocalVariable(name: "assign3", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 161, scope: !36)
...
!66 = distinct !DILexicalBlock(scope: !62, file: !3, line: 37, column: 28)
...
!79 = !DILocation(line: 40, column: 27, scope: !66)
...
!85 = !DILocation(line: 37, column: 24, scope: !62)
