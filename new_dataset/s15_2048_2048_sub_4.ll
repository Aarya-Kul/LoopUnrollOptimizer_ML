; ModuleID = 'new_dataset/s15_2048_2048_sub_4.c'
source_filename = "new_dataset/s15_2048_2048_sub_4.c"
...
@op1 = dso_local global [2048 x [2048 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [2048 x [2048 x i32]] zeroinitializer, align 16, !dbg !17
...
10:                                               ; preds = %46, %3
  ...
  %12 = icmp slt i32 %11, 2048, !dbg !50
...
14:                                               ; preds = %37, %13
  ...
  %16 = icmp slt i32 %15, 2048, !dbg !60
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [2048 x i32], ptr %18, i64 %20, !dbg !62
  %22 = load i32, ptr %8, align 4, !dbg !65
  %23 = sext i32 %22 to i64, !dbg !62
  %24 = getelementptr inbounds [2048 x i32], ptr %21, i64 0, i64 %23, !dbg !62
  ...
  %29 = getelementptr inbounds [2048 x i32], ptr %26, i64 %28, !dbg !66
  %30 = load i32, ptr %8, align 4, !dbg !68
  %31 = sext i32 %30 to i64, !dbg !66
  %32 = getelementptr inbounds [2048 x i32], ptr %29, i64 0, i64 %31, !dbg !66
  %33 = load i32, ptr %32, align 4, !dbg !66
  %34 = sub nsw i32 %25, %33, !dbg !69
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @op1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @op2, i64 1, i64 0)), !dbg !98
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 512, !dbg !115
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !110
...
!3 = !DIFile(filename: "new_dataset/s15_2048_2048_sub_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8591daab173e1211f988ad8773af5dc7")
!4 = !{!5, !0, !11, !17}
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 134217728, elements: !15)
...
!19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 65536, elements: !20)
!20 = !{!16}
...
!38 = !DILocation(line: 32, column: 37, scope: !29)
!39 = !DILocalVariable(name: "out", arg: 3, scope: !29, file: !3, line: 32, type: !33)
!40 = !DILocation(line: 32, column: 55, scope: !29)
...
!52 = !DILocalVariable(name: "sum_sub", scope: !53, file: !3, line: 35, type: !14)
!53 = distinct !DILexicalBlock(scope: !49, file: !3, line: 34, column: 30)
...
!63 = distinct !DILexicalBlock(scope: !59, file: !3, line: 36, column: 33)
...
!72 = !DILocation(line: 36, column: 28, scope: !59)
