; ModuleID = 'new_dataset/s15_64_8192_mul_3.c'
source_filename = "new_dataset/s15_64_8192_mul_3.c"
...
@A = dso_local global [64 x [8192 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [64 x [8192 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([8192 x i32], ptr @A, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([8192 x i32], ptr @B, i64 1, i64 0)), !dbg !99
...
!3 = !DIFile(filename: "new_dataset/s15_64_8192_mul_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "11023c2ae13831cd5cb46634abdc075c")
!4 = !{!5, !0, !11, !18}
