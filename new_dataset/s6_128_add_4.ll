; ModuleID = 'new_dataset/s6_128_add_4.c'
source_filename = "new_dataset/s6_128_add_4.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([128 x i32], ptr @result, i64 1, i64 0)), !dbg !67
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i32], ptr @in1, i64 1, i64 0)), !dbg !68
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i32], ptr @in2, i64 1, i64 0)), !dbg !69
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([128 x i32], ptr @result, i64 1, i64 0)), !dbg !81
...
!3 = !DIFile(filename: "new_dataset/s6_128_add_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "d3f2d542ba134f1b86a40aedc827c1bc")
!4 = !{!5, !11, !0, !17}
