; ModuleID = 'new_dataset/s12_128_2_2_sa_result.c'
source_filename = "new_dataset/s12_128_2_2_sa_result.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([128 x i32], ptr @result, i64 1, i64 0)), !dbg !80
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([128 x i16], ptr @sa, i64 1, i64 0)), !dbg !81
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([128 x i32], ptr @result, i64 1, i64 0)), !dbg !93
...
!3 = !DIFile(filename: "new_dataset/s12_128_2_2_sa_result.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "2e83575e3273ef0b6387373bc64c8206")
!4 = !{!5}
