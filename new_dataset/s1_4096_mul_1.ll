; ModuleID = 'new_dataset/s1_4096_mul_1.c'
source_filename = "new_dataset/s1_4096_mul_1.c"
...
@out = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @in1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @in2, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s1_4096_mul_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "9baa98905243a3dd1f3eb8b19a810936")
!4 = !{!5, !11, !0, !17}
...
!41 = distinct !DILexicalBlock(scope: !37, file: !3, line: 34, column: 25)
...
!50 = !DILocation(line: 34, column: 22, scope: !37)
