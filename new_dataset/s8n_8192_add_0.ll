; ModuleID = 'new_dataset/s8n_8192_add_0.c'
source_filename = "new_dataset/s8n_8192_add_0.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@b = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@a = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !11
...
9:                                                ; preds = %4
  ...
  %14 = getelementptr inbounds [8192 x i32], ptr @b, i64 0, i64 %13, !dbg !46
  %15 = load i32, ptr %14, align 4, !dbg !46
  %16 = load i32, ptr %3, align 4, !dbg !47
  %17 = sext i32 %16 to i64, !dbg !48
  %18 = getelementptr inbounds [8192 x i32], ptr @a, i64 0, i64 %17, !dbg !48
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !57 {
  ...
  call void @init_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([8192 x i32], ptr @a, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([8192 x i32], ptr @b, i64 1, i64 0)), !dbg !67
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 65536, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @a, ptr noundef getelementptr inbounds ([8192 x i32], ptr @a, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s8n_8192_add_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f6f839b3748a6f96f1e19ad4b6f815d6")
!4 = !{!5, !11, !0}
...
!38 = !DILocation(line: 35, column: 21, scope: !37)
!39 = !DILocation(line: 35, column: 20, scope: !37)
!40 = !DILocation(line: 35, column: 15, scope: !37)
!41 = !DILocation(line: 35, column: 4, scope: !34)
!42 = !DILocation(line: 36, column: 17, scope: !43)
!43 = distinct !DILexicalBlock(scope: !37, file: !3, line: 35, column: 28)
!44 = !DILocation(line: 36, column: 19, scope: !43)
!45 = !DILocation(line: 36, column: 18, scope: !43)
!46 = !DILocation(line: 36, column: 15, scope: !43)
!47 = !DILocation(line: 36, column: 9, scope: !43)
!48 = !DILocation(line: 36, column: 7, scope: !43)
!49 = !DILocation(line: 36, column: 12, scope: !43)
!50 = !DILocation(line: 37, column: 4, scope: !43)
!51 = !DILocation(line: 35, column: 25, scope: !37)
