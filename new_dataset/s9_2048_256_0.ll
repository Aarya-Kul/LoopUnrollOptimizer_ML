; ModuleID = 'new_dataset/s9_2048_256_0.c'
source_filename = "new_dataset/s9_2048_256_0.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([256 x i32], ptr @G, i64 1, i64 0)), !dbg !76
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 2048, !dbg !93
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([256 x i32], ptr @G, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_2048_256_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "d2a6905b102be06a3c7106844f339ad0")
!4 = !{!5, !0}
