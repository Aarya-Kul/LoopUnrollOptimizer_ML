; ModuleID = 'new_dataset/s12_16384_2_4_in_result.c'
source_filename = "new_dataset/s12_16384_2_4_in_result.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !0
@in = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([16384 x i32], ptr @result, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @in, ptr noundef getelementptr inbounds ([16384 x i16], ptr @in, i64 1, i64 0)), !dbg !97
  ...
  call void @example10b(ptr noundef @in, ptr noundef @result), !dbg !109
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in, ptr noundef @result), !dbg !114
  br label %18, !dbg !114
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([16384 x i32], ptr @result, i64 1, i64 0)), !dbg !109
...
!3 = !DIFile(filename: "new_dataset/s12_16384_2_4_in_result.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "e367cce1629617bc893f84ad70aa1d20")
!4 = !{!5}
