; ModuleID = 'new_dataset/s12n_128_2_2_in1_assign1.c'
source_filename = "new_dataset/s12n_128_2_2_in1_assign1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign1 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !0
@assign2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([128 x i32], ptr @assign1, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([128 x i32], ptr @assign2, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i16], ptr @in1, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i16], ptr @in2, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @assign1, ptr noundef @assign2), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @assign1, ptr noundef @assign2), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign1, ptr noundef getelementptr inbounds ([128 x i32], ptr @assign1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @assign2, ptr noundef getelementptr inbounds ([128 x i32], ptr @assign2, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12n_128_2_2_in1_assign1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "04d4044105cdd68e8ed60048c8bc4b87")
!4 = !{!5}
...
!39 = !{}
!40 = !DILocalVariable(name: "in1", arg: 1, scope: !32, file: !3, line: 33, type: !35)
!41 = !DILocation(line: 33, column: 37, scope: !32)
!42 = !DILocalVariable(name: "in2", arg: 2, scope: !32, file: !3, line: 33, type: !35)
!43 = !DILocation(line: 33, column: 62, scope: !32)
!44 = !DILocalVariable(name: "assign1", arg: 3, scope: !32, file: !3, line: 33, type: !37)
!45 = !DILocation(line: 33, column: 85, scope: !32)
!46 = !DILocalVariable(name: "assign2", arg: 4, scope: !32, file: !3, line: 33, type: !37)
!47 = !DILocation(line: 33, column: 112, scope: !32)
...
!59 = !DILocation(line: 36, column: 28, scope: !58)
...
!65 = !DILocation(line: 37, column: 26, scope: !58)
!66 = !DILocation(line: 37, column: 27, scope: !58)
...
!73 = !DILocation(line: 38, column: 28, scope: !58)
...
!79 = !DILocation(line: 39, column: 26, scope: !58)
!80 = !DILocation(line: 39, column: 27, scope: !58)
