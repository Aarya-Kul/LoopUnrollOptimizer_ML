; ModuleID = 'new_dataset/s15_16384_128_add_2.c'
source_filename = "new_dataset/s15_16384_128_add_2.c"
...
@in1 = dso_local global [16384 x [128 x i32]] zeroinitializer, align 16, !dbg !11
@in2 = dso_local global [16384 x [128 x i32]] zeroinitializer, align 16, !dbg !18
...
10:                                               ; preds = %46, %3
  ...
  %12 = icmp slt i32 %11, 16384, !dbg !51
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([128 x i32], ptr @in1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([128 x i32], ptr @in2, i64 1, i64 0)), !dbg !99
...
!3 = !DIFile(filename: "new_dataset/s15_16384_128_add_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "cc26823ea44474e5cc89e44626bec749")
!4 = !{!5, !0, !11, !18}
...
!53 = !DILocalVariable(name: "output", scope: !54, file: !3, line: 35, type: !14)
!54 = distinct !DILexicalBlock(scope: !50, file: !3, line: 34, column: 31)
...
!65 = !DILocation(line: 37, column: 22, scope: !64)
!66 = !DILocation(line: 37, column: 25, scope: !64)
!67 = !DILocation(line: 37, column: 29, scope: !64)
!68 = !DILocation(line: 37, column: 33, scope: !64)
!69 = !DILocation(line: 37, column: 36, scope: !64)
!70 = !DILocation(line: 37, column: 28, scope: !64)
...
!83 = !DILocation(line: 34, column: 27, scope: !50)
