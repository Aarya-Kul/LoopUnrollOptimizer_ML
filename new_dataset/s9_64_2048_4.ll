; ModuleID = 'new_dataset/s9_64_2048_4.c'
source_filename = "new_dataset/s9_64_2048_4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign = dso_local global [64 x [2048 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [64 x [2048 x i32]], ptr @assign, i64 0, i64 %15, !dbg !52
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !67 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([2048 x i32], ptr @assign, i64 1, i64 0)), !dbg !76
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 8192, !dbg !93
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([2048 x i32], ptr @assign, i64 1, i64 0)), !dbg !88
...
!3 = !DIFile(filename: "new_dataset/s9_64_2048_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "056d24eb053d8de73ddebac75d3840b1")
!4 = !{!5, !0}
...
!43 = distinct !DILexicalBlock(scope: !38, file: !3, line: 33, column: 25)
