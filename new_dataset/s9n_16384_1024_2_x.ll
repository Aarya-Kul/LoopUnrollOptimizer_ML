; ModuleID = 'new_dataset/s9n_16384_1024_2_x.c'
source_filename = "new_dataset/s9n_16384_1024_2_x.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@Output = dso_local global [16384 x [1024 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [16384 x [1024 x i32]], ptr @Output, i64 0, i64 %15, !dbg !52
  ...
  %24 = getelementptr inbounds [16384 x [1024 x i32]], ptr @Output, i64 0, i64 %23, !dbg !58
  ...
  %31 = getelementptr inbounds [16384 x [1024 x i32]], ptr @Output, i64 0, i64 %30, !dbg !63
  ...
  %40 = getelementptr inbounds [16384 x [1024 x i32]], ptr @Output, i64 0, i64 %39, !dbg !70
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !86 {
  ...
  call void @init_memory(ptr noundef @Output, ptr noundef getelementptr inbounds ([1024 x i32], ptr @Output, i64 1, i64 0)), !dbg !95
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @Output, ptr noundef getelementptr inbounds ([1024 x i32], ptr @Output, i64 1, i64 0)), !dbg !107
...
!1 = distinct !DIGlobalVariable(name: "Output", scope: !2, file: !3, line: 27, type: !11, isLocal: false, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s9n_16384_1024_2_x.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "3a3938013dd3c950b123801515e64a38")
!4 = !{!5, !0}
...
!11 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 536870912, elements: !13)
