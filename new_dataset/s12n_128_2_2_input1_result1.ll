; ModuleID = 'new_dataset/s12n_128_2_2_input1_result1.c'
source_filename = "new_dataset/s12n_128_2_2_input1_result1.c"
...
@result2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !21
@input1 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [128 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([128 x i32], ptr @result1, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([128 x i32], ptr @result2, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([128 x i16], ptr @input1, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([128 x i16], ptr @input2, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @result1, ptr noundef @result2), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @result1, ptr noundef @result2), !dbg !122
  br label %18, !dbg !122
...
!1 = distinct !DIGlobalVariable(name: "result1", scope: !2, file: !3, line: 29, type: !23, isLocal: false, isDefinition: true, align: 128)
...
!3 = !DIFile(filename: "new_dataset/s12n_128_2_2_input1_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "9767df62acdee5121ddc6bcf4f980a7e")
!4 = !{!5}
...
!22 = distinct !DIGlobalVariable(name: "result2", scope: !2, file: !3, line: 30, type: !23, isLocal: false, isDefinition: true, align: 128)
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 4096, elements: !17)
...
!44 = !DILocalVariable(name: "result1", arg: 3, scope: !32, file: !3, line: 33, type: !37)
!45 = !DILocation(line: 33, column: 91, scope: !32)
!46 = !DILocalVariable(name: "result2", arg: 4, scope: !32, file: !3, line: 33, type: !37)
...
!58 = distinct !DILexicalBlock(scope: !54, file: !3, line: 35, column: 32)
...
!87 = !DILocation(line: 35, column: 27, scope: !54)
