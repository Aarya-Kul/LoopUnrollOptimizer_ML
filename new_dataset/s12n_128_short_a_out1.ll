; ModuleID = 'new_dataset/s12n_128_short_a_out1.c'
source_filename = "new_dataset/s12n_128_short_a_out1.c"
...
@out2 = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([128 x i32], ptr @out1, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([128 x i32], ptr @out2, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_a, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([128 x i16], ptr @short_b, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @out1, ptr noundef @out2), !dbg !101
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @out1, ptr noundef @out2), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([128 x i32], ptr @out1, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([128 x i32], ptr @out2, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_128_short_a_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "8a19aa1d59e091ebaae2d8e9c899fdbe")
!4 = !{!5}
