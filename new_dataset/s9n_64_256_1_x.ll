; ModuleID = 'new_dataset/s9n_64_256_1_x.c'
source_filename = "new_dataset/s9n_64_256_1_x.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@Out = dso_local global [64 x [256 x i32]] zeroinitializer, align 16, !dbg !0
...
12:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [64 x [256 x i32]], ptr @Out, i64 0, i64 %15, !dbg !52
  ...
  %24 = getelementptr inbounds [64 x [256 x i32]], ptr @Out, i64 0, i64 %23, !dbg !58
  ...
  %31 = getelementptr inbounds [64 x [256 x i32]], ptr @Out, i64 0, i64 %30, !dbg !63
  ...
  %40 = getelementptr inbounds [64 x [256 x i32]], ptr @Out, i64 0, i64 %39, !dbg !70
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !86 {
  ...
  call void @init_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([256 x i32], ptr @Out, i64 1, i64 0)), !dbg !95
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 65536, !dbg !112
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @Out, ptr noundef getelementptr inbounds ([256 x i32], ptr @Out, i64 1, i64 0)), !dbg !107
...
!3 = !DIFile(filename: "new_dataset/s9n_64_256_1_x.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "3bc369a1c13cf155d61e3e52f49e66c8")
!4 = !{!5, !0}
...
!11 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 524288, elements: !13)
