; ModuleID = 'new_dataset/s16_512_64_8_2.c'
source_filename = "new_dataset/s16_512_64_8_2.c"
...
@G = dso_local global [512 x [64 x i32]] zeroinitializer, align 16, !dbg !11
@G2 = dso_local global [520 x [64 x i32]] zeroinitializer, align 16, !dbg !18
...
22:                                               ; preds = %19
  ...
  %28 = getelementptr inbounds [64 x i32], ptr %23, i64 %27, !dbg !78
  %29 = load i32, ptr %8, align 4, !dbg !82
  %30 = sext i32 %29 to i64, !dbg !78
  %31 = getelementptr inbounds [64 x i32], ptr %28, i64 0, i64 %30, !dbg !78
  ...
  %36 = getelementptr inbounds [64 x i32], ptr %33, i64 %35, !dbg !83
  %37 = load i32, ptr %8, align 4, !dbg !85
  %38 = sext i32 %37 to i64, !dbg !83
  %39 = getelementptr inbounds [64 x i32], ptr %36, i64 0, i64 %38, !dbg !83
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !108 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([64 x i32], ptr @G, i64 1, i64 0)), !dbg !118
  call void @init_memory(ptr noundef @G2, ptr noundef getelementptr inbounds ([64 x i32], ptr @G2, i64 1, i64 0)), !dbg !119
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 8192, !dbg !136
...
!3 = !DIFile(filename: "new_dataset/s16_512_64_8_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "a4e9cc6e93cf57b520527d318fba5537")
!4 = !{!5, !0, !11, !18}
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 1048576, elements: !15)
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 1064960, elements: !21)
!21 = !{!22, !17}
!22 = !DISubrange(count: 520)
...
!38 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 2048, elements: !39)
!39 = !{!17}
...
!45 = !DILocation(line: 32, column: 34, scope: !34)
!46 = !DILocalVariable(name: "result", arg: 3, scope: !34, file: !3, line: 32, type: !40)
!47 = !DILocation(line: 32, column: 52, scope: !34)
