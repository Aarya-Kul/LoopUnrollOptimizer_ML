; ModuleID = 'new_dataset/s16_16384_128_2_5.c'
source_filename = "new_dataset/s16_16384_128_2_5.c"
...
@G = dso_local global [16384 x [128 x i32]] zeroinitializer, align 16, !dbg !11
@G2 = dso_local global [16386 x [128 x i32]] zeroinitializer, align 16, !dbg !18
...
22:                                               ; preds = %19
  ...
  %28 = getelementptr inbounds [128 x i32], ptr %23, i64 %27, !dbg !78
  %29 = load i32, ptr %8, align 4, !dbg !82
  %30 = sext i32 %29 to i64, !dbg !78
  %31 = getelementptr inbounds [128 x i32], ptr %28, i64 0, i64 %30, !dbg !78
  ...
  %36 = getelementptr inbounds [128 x i32], ptr %33, i64 %35, !dbg !83
  %37 = load i32, ptr %8, align 4, !dbg !85
  %38 = sext i32 %37 to i64, !dbg !83
  %39 = getelementptr inbounds [128 x i32], ptr %36, i64 0, i64 %38, !dbg !83
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !108 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([128 x i32], ptr @G, i64 1, i64 0)), !dbg !118
  call void @init_memory(ptr noundef @G2, ptr noundef getelementptr inbounds ([128 x i32], ptr @G2, i64 1, i64 0)), !dbg !119
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 512, !dbg !136
...
!3 = !DIFile(filename: "new_dataset/s16_16384_128_2_5.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "775bb872ef70efbf7e9d6142cf5f963a")
!4 = !{!5, !0, !11, !18}
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 67117056, elements: !21)
!21 = !{!22, !17}
...
!38 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 4096, elements: !39)
!39 = !{!17}
