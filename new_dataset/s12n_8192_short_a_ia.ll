; ModuleID = 'new_dataset/s12n_8192_short_a_ia.c'
source_filename = "new_dataset/s12n_8192_short_a_ia.c"
...
@short_a = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !13
@short_b = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([8192 x i16], ptr @short_a, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([8192 x i16], ptr @short_b, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @ia, ptr noundef @ib), !dbg !101
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @ia, ptr noundef @ib), !dbg !106
  br label %18, !dbg !106
...
!3 = !DIFile(filename: "new_dataset/s12n_8192_short_a_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "ccfe377bd4ee80b8c609b8418de58896")
!4 = !{!5}
...
!58 = distinct !DILexicalBlock(scope: !54, file: !3, line: 35, column: 30)
