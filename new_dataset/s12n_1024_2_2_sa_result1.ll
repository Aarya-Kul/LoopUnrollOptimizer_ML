; ModuleID = 'new_dataset/s12n_1024_2_2_sa_result1.c'
source_filename = "new_dataset/s12n_1024_2_2_sa_result1.c"
...
@result2 = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !21
@sa = dso_local global [1024 x i16] zeroinitializer, align 16, !dbg !13
@sb = dso_local global [1024 x i16] zeroinitializer, align 16, !dbg !19
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result1, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result2, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([1024 x i16], ptr @sa, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @sb, ptr noundef getelementptr inbounds ([1024 x i16], ptr @sb, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @result1, ptr noundef @result2), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @sa, ptr noundef @sb, ptr noundef @result1, ptr noundef @result2), !dbg !122
  br label %18, !dbg !122
...
!3 = !DIFile(filename: "new_dataset/s12n_1024_2_2_sa_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1f4c7526458a135428f3ff679ce35248")
!4 = !{!5}
...
!47 = !DILocation(line: 33, column: 110, scope: !32)
...
!65 = !DILocation(line: 37, column: 25, scope: !58)
!66 = !DILocation(line: 37, column: 26, scope: !58)
...
!73 = !DILocation(line: 38, column: 27, scope: !58)
...
!79 = !DILocation(line: 39, column: 25, scope: !58)
!80 = !DILocation(line: 39, column: 26, scope: !58)
