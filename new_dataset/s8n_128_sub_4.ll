; ModuleID = 'new_dataset/s8n_128_sub_4.c'
source_filename = "new_dataset/s8n_128_sub_4.c"
...
@res = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !11
...
9:                                                ; preds = %4
  ...
  %14 = getelementptr inbounds [128 x i32], ptr @in, i64 0, i64 %13, !dbg !46
  %15 = load i32, ptr %14, align 4, !dbg !46
  %16 = load i32, ptr %3, align 4, !dbg !47
  %17 = sext i32 %16 to i64, !dbg !48
  %18 = getelementptr inbounds [128 x i32], ptr @res, i64 0, i64 %17, !dbg !48
  %19 = load i32, ptr %18, align 4, !dbg !49
  %20 = sub nsw i32 %19, %15, !dbg !49
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !57 {
  ...
  call void @init_memory(ptr noundef @res, ptr noundef getelementptr inbounds ([128 x i32], ptr @res, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @in, ptr noundef getelementptr inbounds ([128 x i32], ptr @in, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @res, ptr noundef getelementptr inbounds ([128 x i32], ptr @res, i64 1, i64 0)), !dbg !79
...
!1 = distinct !DIGlobalVariable(name: "in", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true, align: 128)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s8n_128_sub_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "ac70c10e4c1167b4af08bfd61b45a4f6")
!4 = !{!5, !11, !0}
...
!12 = distinct !DIGlobalVariable(name: "res", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true, align: 128)
...
!45 = !DILocation(line: 36, column: 21, scope: !43)
!46 = !DILocation(line: 36, column: 17, scope: !43)
!47 = !DILocation(line: 36, column: 11, scope: !43)
