; ModuleID = 'new_dataset/s12nn_8192_2_2_input1_ia.c'
source_filename = "new_dataset/s12nn_8192_2_2_input1_ia.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ia = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@ib = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !23
@ic = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !26
@input1 = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !19
@input3 = dso_local global [8192 x i16] zeroinitializer, align 16, !dbg !21
...
14:                                               ; preds = %84, %6
  ...
  %16 = icmp slt i32 %15, 8191, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ib, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ic, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input1, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input2, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([8192 x i16], ptr @input3, i64 1, i64 0)), !dbg !129
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !141
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 262144, !dbg !146
  br i1 %16, label %17, label %21, !dbg !145

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !146
  br label %18, !dbg !146
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ia, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ib, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ic, i64 1, i64 0)), !dbg !141
...
!1 = distinct !DIGlobalVariable(name: "ia", scope: !2, file: !3, line: 30, type: !25, isLocal: false, isDefinition: true, align: 128)
...
!3 = !DIFile(filename: "new_dataset/s12nn_8192_2_2_input1_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "429ed0a0224d97f1ddbf320366465cb0")
!4 = !{!5}
...
!14 = distinct !DIGlobalVariable(name: "input1", scope: !2, file: !3, line: 27, type: !15, isLocal: false, isDefinition: true)
...
!20 = distinct !DIGlobalVariable(name: "input2", scope: !2, file: !3, line: 28, type: !15, isLocal: false, isDefinition: true)
!21 = !DIGlobalVariableExpression(var: !22, expr: !DIExpression())
!22 = distinct !DIGlobalVariable(name: "input3", scope: !2, file: !3, line: 29, type: !15, isLocal: false, isDefinition: true)
!23 = !DIGlobalVariableExpression(var: !24, expr: !DIExpression())
!24 = distinct !DIGlobalVariable(name: "ib", scope: !2, file: !3, line: 31, type: !25, isLocal: false, isDefinition: true, align: 128)
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 262144, elements: !17)
!26 = !DIGlobalVariableExpression(var: !27, expr: !DIExpression())
!27 = distinct !DIGlobalVariable(name: "ic", scope: !2, file: !3, line: 32, type: !25, isLocal: false, isDefinition: true, align: 128)
...
!43 = !{}
!44 = !DILocalVariable(name: "input1", arg: 1, scope: !36, file: !3, line: 35, type: !39)
!45 = !DILocation(line: 35, column: 37, scope: !36)
!46 = !DILocalVariable(name: "input2", arg: 2, scope: !36, file: !3, line: 35, type: !39)
!47 = !DILocation(line: 35, column: 65, scope: !36)
!48 = !DILocalVariable(name: "input3", arg: 3, scope: !36, file: !3, line: 35, type: !39)
!49 = !DILocation(line: 35, column: 93, scope: !36)
!50 = !DILocalVariable(name: "ia", arg: 4, scope: !36, file: !3, line: 35, type: !41)
!51 = !DILocation(line: 35, column: 119, scope: !36)
!52 = !DILocalVariable(name: "ib", arg: 5, scope: !36, file: !3, line: 35, type: !41)
!53 = !DILocation(line: 35, column: 141, scope: !36)
!54 = !DILocalVariable(name: "ic", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 163, scope: !36)
...
!65 = !DILocation(line: 38, column: 19, scope: !66)
!66 = distinct !DILexicalBlock(scope: !62, file: !3, line: 37, column: 33)
!67 = !DILocation(line: 38, column: 26, scope: !66)
!68 = !DILocation(line: 38, column: 13, scope: !66)
!69 = !DILocation(line: 38, column: 5, scope: !66)
!70 = !DILocation(line: 38, column: 8, scope: !66)
!71 = !DILocation(line: 38, column: 11, scope: !66)
!72 = !DILocation(line: 39, column: 17, scope: !66)
!73 = !DILocation(line: 39, column: 24, scope: !66)
!74 = !DILocation(line: 39, column: 25, scope: !66)
!75 = !DILocation(line: 39, column: 11, scope: !66)
!76 = !DILocation(line: 39, column: 1, scope: !66)
!77 = !DILocation(line: 39, column: 4, scope: !66)
!78 = !DILocation(line: 39, column: 5, scope: !66)
!79 = !DILocation(line: 39, column: 9, scope: !66)
!80 = !DILocation(line: 40, column: 19, scope: !66)
!81 = !DILocation(line: 40, column: 26, scope: !66)
!82 = !DILocation(line: 40, column: 13, scope: !66)
!83 = !DILocation(line: 40, column: 5, scope: !66)
!84 = !DILocation(line: 40, column: 8, scope: !66)
!85 = !DILocation(line: 40, column: 11, scope: !66)
!86 = !DILocation(line: 41, column: 17, scope: !66)
!87 = !DILocation(line: 41, column: 24, scope: !66)
!88 = !DILocation(line: 41, column: 25, scope: !66)
!89 = !DILocation(line: 41, column: 11, scope: !66)
!90 = !DILocation(line: 41, column: 1, scope: !66)
!91 = !DILocation(line: 41, column: 4, scope: !66)
!92 = !DILocation(line: 41, column: 5, scope: !66)
!93 = !DILocation(line: 41, column: 9, scope: !66)
!94 = !DILocation(line: 42, column: 19, scope: !66)
!95 = !DILocation(line: 42, column: 26, scope: !66)
!96 = !DILocation(line: 42, column: 13, scope: !66)
!97 = !DILocation(line: 42, column: 5, scope: !66)
!98 = !DILocation(line: 42, column: 8, scope: !66)
!99 = !DILocation(line: 42, column: 11, scope: !66)
!100 = !DILocation(line: 43, column: 17, scope: !66)
!101 = !DILocation(line: 43, column: 24, scope: !66)
!102 = !DILocation(line: 43, column: 25, scope: !66)
!103 = !DILocation(line: 43, column: 11, scope: !66)
!104 = !DILocation(line: 43, column: 1, scope: !66)
!105 = !DILocation(line: 43, column: 4, scope: !66)
!106 = !DILocation(line: 43, column: 5, scope: !66)
!107 = !DILocation(line: 43, column: 9, scope: !66)
