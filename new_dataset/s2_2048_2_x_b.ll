; ModuleID = 'new_dataset/s2_2048_2_x_b.c'
source_filename = "new_dataset/s2_2048_2_x_b.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@b = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !0
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [2048 x i32], ptr @b, i64 0, i64 %10, !dbg !41
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([2048 x i32], ptr @b, i64 1, i64 0)), !dbg !59
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !76
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @b, ptr noundef getelementptr inbounds ([2048 x i32], ptr @b, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "new_dataset/s2_2048_2_x_b.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "55f92124859d96cfdae1a1f40e8bf86d")
!4 = !{!5, !0}
