; ModuleID = 'new_dataset/s12n_16384_2_2_in1_out1.c'
source_filename = "new_dataset/s12n_16384_2_2_in1_out1.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !93 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([16384 x i16], ptr @in1, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([16384 x i16], ptr @in2, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @out1, ptr noundef @out2), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @out1, ptr noundef @out2), !dbg !122
  br label %18, !dbg !122
...
!3 = !DIFile(filename: "new_dataset/s12n_16384_2_2_in1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "4c5a5ff06537b53907d123f7f44b5c77")
!4 = !{!5}
...
!65 = !DILocation(line: 37, column: 23, scope: !58)
!66 = !DILocation(line: 37, column: 24, scope: !58)
...
!73 = !DILocation(line: 38, column: 25, scope: !58)
...
!79 = !DILocation(line: 39, column: 23, scope: !58)
!80 = !DILocation(line: 39, column: 24, scope: !58)
