; ModuleID = 'new_dataset/s1_16384_add_5.c'
source_filename = "new_dataset/s1_16384_add_5.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@in1 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !0
@in2 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !17
@sum = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !56 {
  ...
  call void @init_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([16384 x i32], ptr @sum, i64 1, i64 0)), !dbg !65
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([16384 x i32], ptr @in1, i64 1, i64 0)), !dbg !66
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([16384 x i32], ptr @in2, i64 1, i64 0)), !dbg !67
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @sum, ptr noundef getelementptr inbounds ([16384 x i32], ptr @sum, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s1_16384_add_5.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "7919b13ba457a5a38695314c425cc7e5")
!4 = !{!5, !11, !0, !17}
...
!41 = distinct !DILexicalBlock(scope: !37, file: !3, line: 34, column: 26)
...
!50 = !DILocation(line: 34, column: 23, scope: !37)
