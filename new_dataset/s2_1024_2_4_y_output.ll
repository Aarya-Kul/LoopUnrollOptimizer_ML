; ModuleID = 'new_dataset/s2_1024_2_4_y_output.c'
source_filename = "new_dataset/s2_1024_2_4_y_output.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@output = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !0
...
7:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [1024 x i32], ptr @output, i64 0, i64 %10, !dbg !41
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  call void @init_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([1024 x i32], ptr @output, i64 1, i64 0)), !dbg !59
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @output, ptr noundef getelementptr inbounds ([1024 x i32], ptr @output, i64 1, i64 0)), !dbg !71
...
!3 = !DIFile(filename: "new_dataset/s2_1024_2_4_y_output.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "39ab5767993c95a95e66219714d51604")
!4 = !{!5, !0}
