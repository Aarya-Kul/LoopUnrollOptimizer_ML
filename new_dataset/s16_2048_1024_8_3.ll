; ModuleID = 'new_dataset/s16_2048_1024_8_3.c'
source_filename = "new_dataset/s16_2048_1024_8_3.c"
...
@G = dso_local global [2048 x [1024 x i32]] zeroinitializer, align 16, !dbg !11
@G2 = dso_local global [2056 x [1024 x i32]] zeroinitializer, align 16, !dbg !18
...
19:                                               ; preds = %44, %18
  ...
  %21 = icmp slt i32 %20, 1024, !dbg !76
...
22:                                               ; preds = %19
  ...
  %28 = getelementptr inbounds [1024 x i32], ptr %23, i64 %27, !dbg !78
  %29 = load i32, ptr %8, align 4, !dbg !82
  %30 = sext i32 %29 to i64, !dbg !78
  %31 = getelementptr inbounds [1024 x i32], ptr %28, i64 0, i64 %30, !dbg !78
  ...
  %36 = getelementptr inbounds [1024 x i32], ptr %33, i64 %35, !dbg !83
  %37 = load i32, ptr %8, align 4, !dbg !85
  %38 = sext i32 %37 to i64, !dbg !83
  %39 = getelementptr inbounds [1024 x i32], ptr %36, i64 0, i64 %38, !dbg !83
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !108 {
  ...
  call void @init_memory(ptr noundef @G, ptr noundef getelementptr inbounds ([1024 x i32], ptr @G, i64 1, i64 0)), !dbg !118
  call void @init_memory(ptr noundef @G2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @G2, i64 1, i64 0)), !dbg !119
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 128, !dbg !136
...
!3 = !DIFile(filename: "new_dataset/s16_2048_1024_8_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "b17f20e0d18afa8af7fc2d2161d6902d")
!4 = !{!5, !0, !11, !18}
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 67371008, elements: !21)
!21 = !{!22, !17}
...
!38 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 32768, elements: !39)
!39 = !{!17}
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !14, size: 64)
!41 = !{}
!42 = !DILocalVariable(name: "A", arg: 1, scope: !34, file: !3, line: 32, type: !37)
...
!47 = !DILocation(line: 32, column: 55, scope: !34)
...
!79 = !DILocation(line: 38, column: 20, scope: !75)
!80 = !DILocation(line: 38, column: 22, scope: !75)
!81 = !DILocation(line: 38, column: 21, scope: !75)
!82 = !DILocation(line: 38, column: 25, scope: !75)
!83 = !DILocation(line: 38, column: 30, scope: !75)
!84 = !DILocation(line: 38, column: 36, scope: !75)
!85 = !DILocation(line: 38, column: 39, scope: !75)
!86 = !DILocation(line: 38, column: 28, scope: !75)
