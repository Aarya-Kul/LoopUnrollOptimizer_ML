; ModuleID = 'new_dataset/s12nn_2048_input1_result1.c'
source_filename = "new_dataset/s12nn_2048_input1_result1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result1 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !0
@result2 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !23
@result3 = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !26
@input1 = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !19
@input3 = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !21
...
14:                                               ; preds = %48, %6
  ...
  %16 = icmp slt i32 %15, 2048, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([2048 x i16], ptr @input1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([2048 x i16], ptr @input2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([2048 x i16], ptr @input3, i64 1, i64 0)), !dbg !105
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @result3, ptr noundef getelementptr inbounds ([2048 x i32], ptr @result3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_2048_input1_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "7fcbf931fc46c7712c1c546a30d4637d")
!4 = !{!5}
