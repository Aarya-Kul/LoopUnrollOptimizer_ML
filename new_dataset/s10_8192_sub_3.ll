; ModuleID = 'new_dataset/s10_8192_sub_3.c'
source_filename = "new_dataset/s10_8192_sub_3.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ub = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@uc = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !61 {
  ...
  call void @init_memory(ptr noundef @ub, ptr noundef getelementptr inbounds ([8192 x i32], ptr @ub, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @uc, ptr noundef getelementptr inbounds ([8192 x i32], ptr @uc, i64 1, i64 0)), !dbg !73
...
15:                                               ; preds = %19, %2
  ...
  %17 = icmp slt i32 %16, 262144, !dbg !90
...
!3 = !DIFile(filename: "new_dataset/s10_8192_sub_3.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "4e5a2e0dcd5eb94b70d1a021daa67624")
!4 = !{!5, !0, !11}
