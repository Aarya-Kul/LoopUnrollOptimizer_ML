; ModuleID = 'new_dataset/s6_1024_add_4.c'
source_filename = "new_dataset/s6_1024_add_4.c"
...
@result = dso_local global [1024 x i32] zeroinitializer, align 16, !dbg !11
...
5:                                                ; preds = %2
  ...
  %19 = getelementptr inbounds [1024 x i32], ptr @result, i64 0, i64 %18, !dbg !49
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result, i64 1, i64 0)), !dbg !67
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in1, i64 1, i64 0)), !dbg !68
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([1024 x i32], ptr @in2, i64 1, i64 0)), !dbg !69
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 1048576, !dbg !86
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result, ptr noundef getelementptr inbounds ([1024 x i32], ptr @result, i64 1, i64 0)), !dbg !81
...
!3 = !DIFile(filename: "new_dataset/s6_1024_add_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "5572ed9d12ad484eb0e94b80befe1c00")
!4 = !{!5, !11, !0, !17}
