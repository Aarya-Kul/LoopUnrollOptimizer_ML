; ModuleID = 'new_dataset/s11_4096_mul_2.c'
source_filename = "new_dataset/s11_4096_mul_2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@i1 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !0
@i2 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !21
@i3 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !25
@s1 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !11
@s2 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !17
@s3 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !19
...
14:                                               ; preds = %51, %6
  ...
  %16 = icmp slt i32 %15, 4096, !dbg !62
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @i1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @i1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @i2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @i2, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @i3, ptr noundef getelementptr inbounds ([4096 x i32], ptr @i3, i64 1, i64 0)), !dbg !99
  call void @init_memory(ptr noundef @s1, ptr noundef getelementptr inbounds ([4096 x i16], ptr @s1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @s2, ptr noundef getelementptr inbounds ([4096 x i16], ptr @s2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @s3, ptr noundef getelementptr inbounds ([4096 x i16], ptr @s3, i64 1, i64 0)), !dbg !102
  ...
  call void @example10a(ptr noundef @s1, ptr noundef @s2, ptr noundef @s3, ptr noundef @i1, ptr noundef @i2, ptr noundef @i3), !dbg !114
...
17:                                               ; preds = %14
  call void @example10a(ptr noundef @s1, ptr noundef @s2, ptr noundef @s3, ptr noundef @i1, ptr noundef @i2, ptr noundef @i3), !dbg !119
  br label %18, !dbg !119
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @i1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @i1, i64 1, i64 0)), !dbg !114
  %24 = call i32 @digest_memory(ptr noundef @s1, ptr noundef getelementptr inbounds ([4096 x i16], ptr @s1, i64 1, i64 0)), !dbg !114
...
!1 = distinct !DIGlobalVariable(name: "i1", scope: !2, file: !3, line: 30, type: !23, isLocal: false, isDefinition: true, align: 128)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s11_4096_mul_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "c7d14a62ee0cc03017cb8c1a909604a0")
...
!12 = distinct !DIGlobalVariable(name: "s1", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true)
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 65536, elements: !15)
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !24, size: 131072, elements: !15)
...
!42 = !{}
!43 = !DILocalVariable(name: "s1", arg: 1, scope: !35, file: !3, line: 35, type: !38)
...
!49 = !DILocalVariable(name: "i1", arg: 4, scope: !35, file: !3, line: 35, type: !40)
