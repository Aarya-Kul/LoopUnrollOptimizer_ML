; ModuleID = 'new_dataset/s12_4096_2_input_assign.c'
source_filename = "new_dataset/s12_4096_2_input_assign.c"
...
@input = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([4096 x i32], ptr @assign, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @input, ptr noundef getelementptr inbounds ([4096 x i16], ptr @input, i64 1, i64 0)), !dbg !73
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([4096 x i32], ptr @assign, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s12_4096_2_input_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f2fd2016053dfb0ca944dca6413f62cd")
!4 = !{!5}
