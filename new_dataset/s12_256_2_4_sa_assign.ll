; ModuleID = 'new_dataset/s12_256_2_4_sa_assign.c'
source_filename = "new_dataset/s12_256_2_4_sa_assign.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@assign = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@sa = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([256 x i32], ptr @assign, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([256 x i16], ptr @sa, i64 1, i64 0)), !dbg !97
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 8388608, !dbg !114
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([256 x i32], ptr @assign, i64 1, i64 0)), !dbg !109
...
!3 = !DIFile(filename: "new_dataset/s12_256_2_4_sa_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "a262440a8b6b3b687f879ce4c5b363a5")
!4 = !{!5}
