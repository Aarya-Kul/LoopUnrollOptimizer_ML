; ModuleID = 'new_dataset/s12nn_4096_input1_out1.c'
source_filename = "new_dataset/s12nn_4096_input1_out1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out1 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !0
@out2 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !26
@input1 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !19
@input3 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !21
...
14:                                               ; preds = %48, %6
  ...
  %16 = icmp slt i32 %15, 4096, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([4096 x i16], ptr @input1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([4096 x i16], ptr @input2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([4096 x i16], ptr @input3, i64 1, i64 0)), !dbg !105
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 524288, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([4096 x i32], ptr @out3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_4096_input1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "4839c769897fc40115e04d0193867596")
!4 = !{!5}
...
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 131072, elements: !17)
