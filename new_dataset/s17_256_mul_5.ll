; ModuleID = 'new_dataset/s17_256_mul_5.c'
source_filename = "new_dataset/s17_256_mul_5.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !67
  ...
  call void @example21(ptr noundef @ia, i32 noundef 256), !dbg !79
...
17:                                               ; preds = %14
  call void @example21(ptr noundef @ia, i32 noundef 256), !dbg !84
  br label %18, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s17_256_mul_5.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "1b55c6d1b693258bd1f94869bc5260b4")
!4 = !{!5, !0}
...
!46 = !DILocation(line: 34, column: 15, scope: !42)
...
!52 = !DILocation(line: 34, column: 16, scope: !37)
!53 = !{!"llvm.loop.mustprogress"}
!54 = !DILocation(line: 36, column: 11, scope: !23)
!55 = !DILocation(line: 36, column: 3, scope: !23)
!56 = !DILocation(line: 36, column: 9, scope: !23)
