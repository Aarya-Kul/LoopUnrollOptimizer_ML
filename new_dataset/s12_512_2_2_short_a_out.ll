; ModuleID = 'new_dataset/s12_512_2_2_short_a_out.c'
source_filename = "new_dataset/s12_512_2_2_short_a_out.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !0
@short_a = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !71 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([512 x i32], ptr @out, i64 1, i64 0)), !dbg !80
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([512 x i16], ptr @short_a, i64 1, i64 0)), !dbg !81
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @out), !dbg !93
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @out), !dbg !98
  br label %18, !dbg !98
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([512 x i32], ptr @out, i64 1, i64 0)), !dbg !93
...
!3 = !DIFile(filename: "new_dataset/s12_512_2_2_short_a_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "13f384fc5e166f20c5ea05331bb069a1")
!4 = !{!5}
