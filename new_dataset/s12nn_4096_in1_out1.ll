; ModuleID = 'new_dataset/s12nn_4096_in1_out1.c'
source_filename = "new_dataset/s12nn_4096_in1_out1.c"
...
@in1 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !13
@in2 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !19
@in3 = dso_local global [4096 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([4096 x i16], ptr @in1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([4096 x i16], ptr @in2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @in3, ptr noundef getelementptr inbounds ([4096 x i16], ptr @in3, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !117
...
17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @in3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !122
  br label %18, !dbg !122
...
!3 = !DIFile(filename: "new_dataset/s12nn_4096_in1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "638b7ce9f284ca659879fa77853b61ff")
!4 = !{!5}
...
!79 = !DILocation(line: 40, column: 25, scope: !66)
