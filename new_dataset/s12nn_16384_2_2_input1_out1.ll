; ModuleID = 'new_dataset/s12nn_16384_2_2_input1_out1.c'
source_filename = "new_dataset/s12nn_16384_2_2_input1_out1.c"
...
@out2 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [16384 x i32] zeroinitializer, align 16, !dbg !26
@input1 = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !19
@input3 = dso_local global [16384 x i16] zeroinitializer, align 16, !dbg !21
...
14:                                               ; preds = %84, %6
  ...
  %16 = icmp slt i32 %15, 16383, !dbg !63
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out1, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out2, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out3, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([16384 x i16], ptr @input1, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([16384 x i16], ptr @input2, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([16384 x i16], ptr @input3, i64 1, i64 0)), !dbg !129
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !141
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 131072, !dbg !146
  br i1 %16, label %17, label %21, !dbg !145

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !146
  br label %18, !dbg !146
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out1, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out2, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([16384 x i32], ptr @out3, i64 1, i64 0)), !dbg !141
...
!3 = !DIFile(filename: "new_dataset/s12nn_16384_2_2_input1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "0c54675bded786f5d96ed4b72cfccf8b")
!4 = !{!5}
...
!53 = !DILocation(line: 35, column: 143, scope: !36)
!54 = !DILocalVariable(name: "out3", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 167, scope: !36)
...
!66 = distinct !DILexicalBlock(scope: !62, file: !3, line: 37, column: 34)
...
!73 = !DILocation(line: 39, column: 26, scope: !66)
!74 = !DILocation(line: 39, column: 27, scope: !66)
...
!81 = !DILocation(line: 40, column: 28, scope: !66)
...
!87 = !DILocation(line: 41, column: 26, scope: !66)
!88 = !DILocation(line: 41, column: 27, scope: !66)
...
!95 = !DILocation(line: 42, column: 28, scope: !66)
...
!101 = !DILocation(line: 43, column: 26, scope: !66)
!102 = !DILocation(line: 43, column: 27, scope: !66)
...
!109 = !DILocation(line: 37, column: 29, scope: !62)
