; ModuleID = 'new_dataset/s15_1024_64_sub_4.c'
source_filename = "new_dataset/s15_1024_64_sub_4.c"
...
@op1 = dso_local global [1024 x [64 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [1024 x [64 x i32]] zeroinitializer, align 16, !dbg !18
...
10:                                               ; preds = %46, %3
  ...
  %12 = icmp slt i32 %11, 1024, !dbg !51
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [64 x i32], ptr %18, i64 %20, !dbg !63
  %22 = load i32, ptr %8, align 4, !dbg !66
  %23 = sext i32 %22 to i64, !dbg !63
  %24 = getelementptr inbounds [64 x i32], ptr %21, i64 0, i64 %23, !dbg !63
  ...
  %29 = getelementptr inbounds [64 x i32], ptr %26, i64 %28, !dbg !67
  %30 = load i32, ptr %8, align 4, !dbg !69
  %31 = sext i32 %30 to i64, !dbg !67
  %32 = getelementptr inbounds [64 x i32], ptr %29, i64 0, i64 %31, !dbg !67
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([64 x i32], ptr @ia, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([64 x i32], ptr @op1, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([64 x i32], ptr @op2, i64 1, i64 0)), !dbg !99
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 32768, !dbg !116
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([64 x i32], ptr @ia, i64 1, i64 0)), !dbg !111
...
!3 = !DIFile(filename: "new_dataset/s15_1024_64_sub_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "ae71394e372d451f664510c2824070ec")
!4 = !{!5, !0, !11, !18}
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 2097152, elements: !15)
...
!20 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 2048, elements: !21)
!21 = !{!17}
...
!64 = distinct !DILexicalBlock(scope: !60, file: !3, line: 36, column: 31)
...
!73 = !DILocation(line: 36, column: 26, scope: !60)
