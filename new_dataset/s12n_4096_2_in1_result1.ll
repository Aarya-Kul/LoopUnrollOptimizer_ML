; ModuleID = 'new_dataset/s12n_4096_2_in1_result1.c'
source_filename = "new_dataset/s12n_4096_2_in1_result1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@result1 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !0
@result2 = dso_local global [4096 x i32] zeroinitializer, align 16, !dbg !21
...
10:                                               ; preds = %34, %4
  ...
  %12 = icmp slt i32 %11, 4096, !dbg !55
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !77 {
  ...
  call void @init_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result1, i64 1, i64 0)), !dbg !86
  call void @init_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result2, i64 1, i64 0)), !dbg !87
  call void @init_memory(ptr noundef @in1, ptr noundef getelementptr inbounds ([4096 x i16], ptr @in1, i64 1, i64 0)), !dbg !88
  call void @init_memory(ptr noundef @in2, ptr noundef getelementptr inbounds ([4096 x i16], ptr @in2, i64 1, i64 0)), !dbg !89
  ...
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @result1, ptr noundef @result2), !dbg !101
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 524288, !dbg !106
  br i1 %16, label %17, label %21, !dbg !105

17:                                               ; preds = %14
  call void @example10b(ptr noundef @in1, ptr noundef @in2, ptr noundef @result1, ptr noundef @result2), !dbg !106
  br label %18, !dbg !106
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @result1, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result1, i64 1, i64 0)), !dbg !101
  %24 = call i32 @digest_memory(ptr noundef @result2, ptr noundef getelementptr inbounds ([4096 x i32], ptr @result2, i64 1, i64 0)), !dbg !101
...
!3 = !DIFile(filename: "new_dataset/s12n_4096_2_in1_result1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "debc75c24ef136334d17be6b3a9c2c73")
!4 = !{!5}
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 131072, elements: !17)
...
!65 = !DILocation(line: 37, column: 28, scope: !58)
