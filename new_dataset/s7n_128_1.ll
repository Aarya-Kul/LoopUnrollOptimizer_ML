; ModuleID = 'new_dataset/s7n_128_1.c'
source_filename = "new_dataset/s7n_128_1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@in = dso_local global [128 x i32] zeroinitializer, align 16, !dbg !0
...
7:                                                ; preds = %4
  ...
  %10 = getelementptr inbounds [128 x i32], ptr @in, i64 0, i64 %9, !dbg !45
  ...
  %18 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %17, !dbg !49
  ...
  %23 = getelementptr inbounds [128 x i32], ptr @out, i64 0, i64 %22, !dbg !54
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @in, ptr noundef getelementptr inbounds ([128 x i32], ptr @in, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([128 x i32], ptr @out, i64 1, i64 0)), !dbg !73
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([128 x i32], ptr @out, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s7n_128_1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "a701fe7e91c1ff8cc8cdefce77036c46")
!4 = !{!5, !0, !11}
...
!12 = distinct !DIGlobalVariable(name: "out", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true, align: 128)
...
!42 = distinct !DILexicalBlock(scope: !38, file: !3, line: 35, column: 28)
...
!57 = !DILocation(line: 35, column: 24, scope: !38)
