; ModuleID = 'new_dataset/s15_256_256_mul_4.c'
source_filename = "new_dataset/s15_256_256_mul_4.c"
...
@op1 = dso_local global [256 x [256 x i32]] zeroinitializer, align 16, !dbg !11
@op2 = dso_local global [256 x [256 x i32]] zeroinitializer, align 16, !dbg !17
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [256 x i32], ptr %18, i64 %20, !dbg !62
  %22 = load i32, ptr %8, align 4, !dbg !65
  %23 = sext i32 %22 to i64, !dbg !62
  %24 = getelementptr inbounds [256 x i32], ptr %21, i64 0, i64 %23, !dbg !62
  ...
  %29 = getelementptr inbounds [256 x i32], ptr %26, i64 %28, !dbg !66
  %30 = load i32, ptr %8, align 4, !dbg !68
  %31 = sext i32 %30 to i64, !dbg !66
  %32 = getelementptr inbounds [256 x i32], ptr %29, i64 0, i64 %31, !dbg !66
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @op1, ptr noundef getelementptr inbounds ([256 x i32], ptr @op1, i64 1, i64 0)), !dbg !97
  call void @init_memory(ptr noundef @op2, ptr noundef getelementptr inbounds ([256 x i32], ptr @op2, i64 1, i64 0)), !dbg !98
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 32768, !dbg !115
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !110
...
!3 = !DIFile(filename: "new_dataset/s15_256_256_mul_4.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "b89668173565f674ec5fed76da9e57e1")
!4 = !{!5, !0, !11, !17}
...
!19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 8192, elements: !20)
!20 = !{!16}
