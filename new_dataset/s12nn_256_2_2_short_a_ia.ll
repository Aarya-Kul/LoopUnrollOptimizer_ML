; ModuleID = 'new_dataset/s12nn_256_2_2_short_a_ia.c'
source_filename = "new_dataset/s12nn_256_2_2_short_a_ia.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ia = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@ib = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !23
@ic = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !26
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !115 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !124
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([256 x i32], ptr @ib, i64 1, i64 0)), !dbg !125
  call void @init_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([256 x i32], ptr @ic, i64 1, i64 0)), !dbg !126
  call void @init_memory(ptr noundef @short_a, ptr noundef getelementptr inbounds ([256 x i16], ptr @short_a, i64 1, i64 0)), !dbg !127
  call void @init_memory(ptr noundef @short_b, ptr noundef getelementptr inbounds ([256 x i16], ptr @short_b, i64 1, i64 0)), !dbg !128
  call void @init_memory(ptr noundef @short_c, ptr noundef getelementptr inbounds ([256 x i16], ptr @short_c, i64 1, i64 0)), !dbg !129
  ...
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @short_c, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !141
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 8388608, !dbg !146
  br i1 %16, label %17, label %21, !dbg !145

17:                                               ; preds = %14
  call void @example10b(ptr noundef @short_a, ptr noundef @short_b, ptr noundef @short_c, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !146
  br label %18, !dbg !146
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([256 x i32], ptr @ia, i64 1, i64 0)), !dbg !141
  %24 = call i32 @digest_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([256 x i32], ptr @ib, i64 1, i64 0)), !dbg !141
  %25 = add i32 %23, %24, !dbg !141
  %26 = call i32 @digest_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([256 x i32], ptr @ic, i64 1, i64 0)), !dbg !141
...
!3 = !DIFile(filename: "new_dataset/s12nn_256_2_2_short_a_ia.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "c409ac0c3e17c671790c8bba55251b45")
!4 = !{!5}
...
!53 = !DILocation(line: 35, column: 144, scope: !36)
!54 = !DILocalVariable(name: "ic", arg: 6, scope: !36, file: !3, line: 35, type: !41)
!55 = !DILocation(line: 35, column: 166, scope: !36)
...
!73 = !DILocation(line: 39, column: 25, scope: !66)
!74 = !DILocation(line: 39, column: 26, scope: !66)
...
!81 = !DILocation(line: 40, column: 27, scope: !66)
...
!87 = !DILocation(line: 41, column: 25, scope: !66)
!88 = !DILocation(line: 41, column: 26, scope: !66)
...
!95 = !DILocation(line: 42, column: 27, scope: !66)
...
!101 = !DILocation(line: 43, column: 25, scope: !66)
!102 = !DILocation(line: 43, column: 26, scope: !66)
