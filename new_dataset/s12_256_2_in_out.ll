; ModuleID = 'new_dataset/s12_256_2_in_out.c'
source_filename = "new_dataset/s12_256_2_in_out.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@in = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !63 {
  ...
  call void @init_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([256 x i32], ptr @out, i64 1, i64 0)), !dbg !72
  call void @init_memory(ptr noundef @in, ptr noundef getelementptr inbounds ([256 x i16], ptr @in, i64 1, i64 0)), !dbg !73
  ...
  call void @example10b(ptr noundef @in, ptr noundef @out), !dbg !85
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 8388608, !dbg !90
  br i1 %16, label %17, label %21, !dbg !89

17:                                               ; preds = %14
  call void @example10b(ptr noundef @in, ptr noundef @out), !dbg !90
  br label %18, !dbg !90
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out, ptr noundef getelementptr inbounds ([256 x i32], ptr @out, i64 1, i64 0)), !dbg !85
...
!3 = !DIFile(filename: "new_dataset/s12_256_2_in_out.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f71101649206032dad80261e08ae708e")
!4 = !{!5}
...
!19 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 8192, elements: !17)
