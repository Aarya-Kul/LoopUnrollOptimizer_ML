; ModuleID = 'new_dataset/s18_256_src_output.c'
source_filename = "new_dataset/s18_256_src_output.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@ua = dso_local global [256 x i32] zeroinitializer, align 16, !dbg !0
@usa = dso_local global [256 x i16] zeroinitializer, align 16, !dbg !11
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !59 {
  ...
  call void @init_memory(ptr noundef @ua, ptr noundef getelementptr inbounds ([256 x i32], ptr @ua, i64 1, i64 0)), !dbg !68
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 16777216, !dbg !85
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @usa, ptr noundef getelementptr inbounds ([256 x i16], ptr @usa, i64 1, i64 0)), !dbg !80
...
!3 = !DIFile(filename: "new_dataset/s18_256_src_output.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "fd548c95a31715e36419e413ad3b63e0")
!4 = !{!5, !11, !0}
...
!17 = !DICompositeType(tag: DW_TAG_array_type, baseType: !18, size: 8192, elements: !15)
...
!53 = !DILocation(line: 34, column: 25, scope: !44)
