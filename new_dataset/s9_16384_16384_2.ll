; ModuleID = 'new_dataset/s9_16384_16384_2.c'
source_filename = "new_dataset/s9_16384_16384_2.c"
...
9:                                                ; preds = %20, %8
  ...
  %11 = icmp slt i32 %10, 16384, !dbg !46
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !66 {
  ...
  call void @init_memory(ptr noundef @Output, ptr noundef getelementptr inbounds ([16384 x i32], ptr @Output, i64 1, i64 0)), !dbg !75
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @Output, ptr noundef getelementptr inbounds ([16384 x i32], ptr @Output, i64 1, i64 0)), !dbg !87
...
!3 = !DIFile(filename: "new_dataset/s9_16384_16384_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "46d87ab125930e5c0d6e0e6259d93198")
!4 = !{!5, !0}
...
!42 = distinct !DILexicalBlock(scope: !37, file: !3, line: 33, column: 28)
...
!49 = distinct !DILexicalBlock(scope: !45, file: !3, line: 34, column: 30)
...
!55 = !DILocation(line: 34, column: 26, scope: !45)
...
!61 = !DILocation(line: 33, column: 24, scope: !37)
