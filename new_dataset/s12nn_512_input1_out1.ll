; ModuleID = 'new_dataset/s12nn_512_input1_out1.c'
source_filename = "new_dataset/s12nn_512_input1_out1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.timeval = type { i64, i64 }

@out1 = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !0
@out2 = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !23
@out3 = dso_local global [512 x i32] zeroinitializer, align 16, !dbg !26
@input1 = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !13
@input2 = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !19
@input3 = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !21
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !91 {
  ...
  call void @init_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([512 x i32], ptr @out1, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([512 x i32], ptr @out2, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([512 x i32], ptr @out3, i64 1, i64 0)), !dbg !102
  call void @init_memory(ptr noundef @input1, ptr noundef getelementptr inbounds ([512 x i16], ptr @input1, i64 1, i64 0)), !dbg !103
  call void @init_memory(ptr noundef @input2, ptr noundef getelementptr inbounds ([512 x i16], ptr @input2, i64 1, i64 0)), !dbg !104
  call void @init_memory(ptr noundef @input3, ptr noundef getelementptr inbounds ([512 x i16], ptr @input3, i64 1, i64 0)), !dbg !105
  ...
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !117
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4194304, !dbg !122
  br i1 %16, label %17, label %21, !dbg !121

17:                                               ; preds = %14
  call void @example10b(ptr noundef @input1, ptr noundef @input2, ptr noundef @input3, ptr noundef @out1, ptr noundef @out2, ptr noundef @out3), !dbg !122
  br label %18, !dbg !122
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @out1, ptr noundef getelementptr inbounds ([512 x i32], ptr @out1, i64 1, i64 0)), !dbg !117
  %24 = call i32 @digest_memory(ptr noundef @out2, ptr noundef getelementptr inbounds ([512 x i32], ptr @out2, i64 1, i64 0)), !dbg !117
  %25 = add i32 %23, %24, !dbg !117
  %26 = call i32 @digest_memory(ptr noundef @out3, ptr noundef getelementptr inbounds ([512 x i32], ptr @out3, i64 1, i64 0)), !dbg !117
...
!3 = !DIFile(filename: "new_dataset/s12nn_512_input1_out1.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "a17a4f00a78b2bf4c390f41982718ae1")
!4 = !{!5}
...
!25 = !DICompositeType(tag: DW_TAG_array_type, baseType: !5, size: 16384, elements: !17)
