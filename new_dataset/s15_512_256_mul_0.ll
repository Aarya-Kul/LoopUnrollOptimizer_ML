; ModuleID = 'new_dataset/s15_512_256_mul_0.c'
source_filename = "new_dataset/s15_512_256_mul_0.c"
...
@A = dso_local global [512 x [256 x i32]] zeroinitializer, align 16, !dbg !11
@B = dso_local global [512 x [256 x i32]] zeroinitializer, align 16, !dbg !18
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @A, ptr noundef getelementptr inbounds ([256 x i32], ptr @A, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @B, ptr noundef getelementptr inbounds ([256 x i32], ptr @B, i64 1, i64 0)), !dbg !99
...
!3 = !DIFile(filename: "new_dataset/s15_512_256_mul_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "a1eb6077e819af6cd2adc3a9af6e11a7")
!4 = !{!5, !0, !11, !18}
...
!39 = !DILocation(line: 32, column: 34, scope: !30)
!40 = !DILocalVariable(name: "out", arg: 3, scope: !30, file: !3, line: 32, type: !34)
!41 = !DILocation(line: 32, column: 49, scope: !30)
