; ModuleID = 'new_dataset/s12_512_2_4_sa_assign.c'
source_filename = "new_dataset/s12_512_2_4_sa_assign.c"
...
@sa = dso_local global [512 x i16] zeroinitializer, align 16, !dbg !13
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !87 {
  ...
  call void @init_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([512 x i32], ptr @assign, i64 1, i64 0)), !dbg !96
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([512 x i16], ptr @sa, i64 1, i64 0)), !dbg !97
...
14:                                               ; preds = %18, %2
  ...
  %16 = icmp slt i32 %15, 4194304, !dbg !114
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @assign, ptr noundef getelementptr inbounds ([512 x i32], ptr @assign, i64 1, i64 0)), !dbg !109
...
!3 = !DIFile(filename: "new_dataset/s12_512_2_4_sa_assign.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "cebb1d4df938d9cae5981d3b3e0edeff")
!4 = !{!5}
...
!81 = !DILocation(line: 33, column: 27, scope: !46)
