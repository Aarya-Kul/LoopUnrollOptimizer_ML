; ModuleID = 'new_dataset/s11_2048_sub_0.c'
source_filename = "new_dataset/s11_2048_sub_0.c"
...
@ib = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !21
@ic = dso_local global [2048 x i32] zeroinitializer, align 16, !dbg !25
@sa = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !11
@sb = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !17
@sc = dso_local global [2048 x i16] zeroinitializer, align 16, !dbg !19
...
14:                                               ; preds = %51, %6
  ...
  %16 = icmp slt i32 %15, 2048, !dbg !62
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !88 {
  ...
  call void @init_memory(ptr noundef @ib, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ib, i64 1, i64 0)), !dbg !98
  call void @init_memory(ptr noundef @ic, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ic, i64 1, i64 0)), !dbg !99
  call void @init_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([2048 x i16], ptr @sa, i64 1, i64 0)), !dbg !100
  call void @init_memory(ptr noundef @sb, ptr noundef getelementptr inbounds ([2048 x i16], ptr @sb, i64 1, i64 0)), !dbg !101
  call void @init_memory(ptr noundef @sc, ptr noundef getelementptr inbounds ([2048 x i16], ptr @sc, i64 1, i64 0)), !dbg !102
  ...
  call void @example10a(ptr noundef @sa, ptr noundef @sb, ptr noundef @sc, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !114
...
17:                                               ; preds = %14
  call void @example10a(ptr noundef @sa, ptr noundef @sb, ptr noundef @sc, ptr noundef @ia, ptr noundef @ib, ptr noundef @ic), !dbg !119
  br label %18, !dbg !119
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !114
  %24 = call i32 @digest_memory(ptr noundef @sa, ptr noundef getelementptr inbounds ([2048 x i16], ptr @sa, i64 1, i64 0)), !dbg !114
...
!1 = distinct !DIGlobalVariable(name: "ia", scope: !2, file: !3, line: 30, type: !23, isLocal: false, isDefinition: true, align: 128)
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang version 18.1.8 (https://github.com/llvm/llvm-project.git 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "new_dataset/s11_2048_sub_0.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "765a154d73aace6b38814e2c73e0cd1c")
...
!12 = distinct !DIGlobalVariable(name: "sa", scope: !2, file: !3, line: 27, type: !13, isLocal: false, isDefinition: true)
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 32768, elements: !15)
!14 = !DIBasicType(name: "short", size: 16, encoding: DW_ATE_signed)
!15 = !{!16}
!16 = !DISubrange(count: 2048)
!17 = !DIGlobalVariableExpression(var: !18, expr: !DIExpression())
!18 = distinct !DIGlobalVariable(name: "sb", scope: !2, file: !3, line: 28, type: !13, isLocal: false, isDefinition: true)
!19 = !DIGlobalVariableExpression(var: !20, expr: !DIExpression())
!20 = distinct !DIGlobalVariable(name: "sc", scope: !2, file: !3, line: 29, type: !13, isLocal: false, isDefinition: true)
!21 = !DIGlobalVariableExpression(var: !22, expr: !DIExpression())
!22 = distinct !DIGlobalVariable(name: "ib", scope: !2, file: !3, line: 31, type: !23, isLocal: false, isDefinition: true, align: 128)
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !24, size: 65536, elements: !15)
!24 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!25 = !DIGlobalVariableExpression(var: !26, expr: !DIExpression())
!26 = distinct !DIGlobalVariable(name: "ic", scope: !2, file: !3, line: 32, type: !23, isLocal: false, isDefinition: true, align: 128)
...
!42 = !{}
!43 = !DILocalVariable(name: "sa", arg: 1, scope: !35, file: !3, line: 35, type: !38)
!44 = !DILocation(line: 35, column: 37, scope: !35)
!45 = !DILocalVariable(name: "sb", arg: 2, scope: !35, file: !3, line: 35, type: !38)
!46 = !DILocation(line: 35, column: 61, scope: !35)
!47 = !DILocalVariable(name: "sc", arg: 3, scope: !35, file: !3, line: 35, type: !38)
!48 = !DILocation(line: 35, column: 85, scope: !35)
!49 = !DILocalVariable(name: "ia", arg: 4, scope: !35, file: !3, line: 35, type: !40)
!50 = !DILocation(line: 35, column: 107, scope: !35)
!51 = !DILocalVariable(name: "ib", arg: 5, scope: !35, file: !3, line: 35, type: !40)
!52 = !DILocation(line: 35, column: 129, scope: !35)
!53 = !DILocalVariable(name: "ic", arg: 6, scope: !35, file: !3, line: 35, type: !40)
!54 = !DILocation(line: 35, column: 151, scope: !35)
...
!65 = distinct !DILexicalBlock(scope: !61, file: !3, line: 37, column: 30)
!66 = !DILocation(line: 38, column: 16, scope: !65)
!67 = !DILocation(line: 38, column: 21, scope: !65)
!68 = !DILocation(line: 38, column: 24, scope: !65)
!69 = !DILocation(line: 38, column: 19, scope: !65)
!70 = !DILocation(line: 38, column: 5, scope: !65)
!71 = !DILocation(line: 38, column: 8, scope: !65)
!72 = !DILocation(line: 38, column: 11, scope: !65)
!73 = !DILocation(line: 39, column: 13, scope: !65)
!74 = !DILocation(line: 39, column: 16, scope: !65)
!75 = !DILocation(line: 39, column: 21, scope: !65)
!76 = !DILocation(line: 39, column: 24, scope: !65)
!77 = !DILocation(line: 39, column: 19, scope: !65)
!78 = !DILocation(line: 39, column: 5, scope: !65)
!79 = !DILocation(line: 39, column: 8, scope: !65)
!80 = !DILocation(line: 39, column: 11, scope: !65)
!81 = !DILocation(line: 40, column: 3, scope: !65)
!82 = !DILocation(line: 37, column: 26, scope: !61)
