; ModuleID = 'new_dataset/s17_2048_sub_2.c'
source_filename = "new_dataset/s17_2048_sub_2.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !58 {
  ...
  call void @init_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !67
  ...
  call void @example21(ptr noundef @ia, i32 noundef 2048), !dbg !79
...
17:                                               ; preds = %14
  call void @example21(ptr noundef @ia, i32 noundef 2048), !dbg !84
  br label %18, !dbg !84
...
21:                                               ; preds = %14
  ...
  %23 = call i32 @digest_memory(ptr noundef @ia, ptr noundef getelementptr inbounds ([2048 x i32], ptr @ia, i64 1, i64 0)), !dbg !79
...
!3 = !DIFile(filename: "new_dataset/s17_2048_sub_2.c", directory: "/n/eecs583a/home/amszuch/cse583-project", checksumkind: CSK_MD5, checksum: "f105cdb2c108de2a0f4133f156f45aa6")
!4 = !{!5, !0}
...
!11 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 65536, elements: !13)
...
!52 = !DILocation(line: 34, column: 19, scope: !37)
!53 = !{!"llvm.loop.mustprogress"}
!54 = !DILocation(line: 36, column: 14, scope: !23)
!55 = !DILocation(line: 36, column: 3, scope: !23)
!56 = !DILocation(line: 36, column: 12, scope: !23)
