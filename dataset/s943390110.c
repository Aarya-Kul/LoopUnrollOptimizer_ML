...
int main()
{
    N = 131; //Fixed N to 131
    for (int i = 1; i <= N; i++) A[i] = i; //Initialized A with sample values.  Replace with your desired initialization if needed.
    ...
    //printf("%lld\n", result); //Commented out print statement as requested.
