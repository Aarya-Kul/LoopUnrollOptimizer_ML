...
int main(){
	int i,j,n=98,w=100,h=100,nx,ny,an,bn,k,ans,m;
	an=bn=0;
	for(i=0;i<n;i++){
		a[i].x = i*2; //Example values.  Replace with your desired logic if needed.
		a[i].y = i*3; //Example values.  Replace with your desired logic if needed.
